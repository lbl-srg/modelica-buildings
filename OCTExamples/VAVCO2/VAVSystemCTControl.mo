...
parameter Real scaDpFanRet_nominal = 1
  ...
  OCTExamples.VAVCO2.BaseClasses.Suite roo(
    redeclare package Medium = Medium,
    scaM_flow=scaM_flow,
    l=l) annotation (Placement(transformation(extent={{206,-92},{310,20}})));
  ...
  Buildings.Controls.OBC.CDL.Conversions.BooleanToReal booToRea(realTrue=120)
  ...
  Buildings.Controls.OBC.CDL.Continuous.SlewRateLimiter ramLim(raisingSlewRate=
        1/120) "Ramp limiter for fan control signal"
