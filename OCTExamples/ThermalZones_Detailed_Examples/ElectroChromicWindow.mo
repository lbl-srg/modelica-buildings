...
model ElectroChromicWindow
  ...
  parameter
    Buildings.HeatTransfer.Data.GlazingSystems.DoubleElectrochromicAir13Clear glaSys(
    UFra=2,
  ...
  Buildings.Fluid.Sources.Outside freshAir(redeclare package Medium = MediumA,
