within OCTExamples.VAVReheat.BaseClasses.Controls.Examples;
model OperationModes "Test model for operation modes"
    extends Modelica.Icons.Example;

  OCTExamples.VAVReheat.BaseClasses.Controls.ModeSelector operationModes
  ...
  Modelica.Blocks.Sources.RealExpression TRooSetHea(
    y=if mode.y == Integer(OCTExamples.VAVReheat.BaseClasses.Controls.OperationModes.occupied)
  ...
  OCTExamples.VAVReheat.BaseClasses.Controls.ControlBus controlBus
  ...
  Modelica.Blocks.Sources.BooleanExpression modSel(
    y=mode.y == Integer(OCTExamples.VAVReheat.BaseClasses.Controls.OperationModes.unoccupiedNightSetBack)        or
      mode.y == Integer(OCTExamples.VAVReheat.BaseClasses.Controls.OperationModes.unoccupiedWarmUp))
  ...
  Modelica.Blocks.Sources.BooleanExpression modSel1(
    y=mode.y == Integer(OCTExamples.VAVReheat.BaseClasses.Controls.OperationModes.occupied))
