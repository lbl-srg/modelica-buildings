...
model ModeSelector "Finite State Machine for the operational modes"
  ...
  State unOccOff(
    mode=OCTExamples.VAVReheat.BaseClasses.Controls.OperationModes.unoccupiedOff,
    nIn=3,
    nOut=4) "Unoccupied off mode, no coil protection"
    annotation (Placement(transformation(extent={{-20,20},{0,40}})));
  State unOccNigSetBac(
    nOut=2,
    mode=OCTExamples.VAVReheat.BaseClasses.Controls.OperationModes.unoccupiedNightSetBack,
  ...
  State morWarUp(mode=OCTExamples.VAVReheat.BaseClasses.Controls.OperationModes.unoccupiedWarmUp,
                                                                            nIn=2,
  ...
  State occ(
    mode=OCTExamples.VAVReheat.BaseClasses.Controls.OperationModes.occupied,
    nIn=3)
    "Occupied mode"
  ...
  State morPreCoo(
    nIn=1,
    mode=OCTExamples.VAVReheat.BaseClasses.Controls.OperationModes.unoccupiedPreCool,
  ...
  Buildings.Controls.OBC.CDL.Logical.And and3
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=-90,
        origin={200,-70})));
  Modelica.Blocks.Math.BooleanToInteger modIni(integerTrue=Integer(OCTExamples.VAVReheat.BaseClasses.Controls.OperationModes.unoccupiedOff))
