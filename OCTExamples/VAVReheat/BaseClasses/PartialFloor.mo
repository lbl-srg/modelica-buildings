...
partial model PartialFloor "Interface for a model of a floor of a building"
  ...
  OCTExamples.VAVReheat.BaseClasses.RoomLeakage leaSou(
  ...
  OCTExamples.VAVReheat.BaseClasses.RoomLeakage leaEas(
    redeclare package Medium = Medium,
    VRoo=VRooEas,
    s=33.27/49.91,
  ...
  OCTExamples.VAVReheat.BaseClasses.RoomLeakage leaNor(
    redeclare package Medium = Medium,
    VRoo=VRooNor,
    s=49.91/33.27,
  ...
  OCTExamples.VAVReheat.BaseClasses.RoomLeakage leaWes(
    redeclare package Medium = Medium,
    VRoo=VRooWes,
    s=33.27/49.91,
