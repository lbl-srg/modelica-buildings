within OCTExamples.VAVReheat.BaseClasses;
partial model HVACBuilding
  ...
  replaceable OCTExamples.VAVReheat.BaseClasses.PartialHVAC hvac constrainedby
    OCTExamples.VAVReheat.BaseClasses.PartialHVAC(
  ...
  replaceable OCTExamples.VAVReheat.BaseClasses.PartialFloor flo constrainedby
    OCTExamples.VAVReheat.BaseClasses.PartialFloor(redeclare final package
      Medium = MediumA) "Building"
