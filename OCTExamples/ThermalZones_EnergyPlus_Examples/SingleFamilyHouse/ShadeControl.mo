...
model ShadeControl
  ...
  inner Buildings.ThermalZones.EnergyPlus.Building building(
    ...
    showWeatherData=true) "Building model"
...
protected
  model Cooling
    ...
    Buildings.Controls.OBC.CDL.Continuous.Gain gai(k=-5000) "Gain"
      annotation (Placement(transformation(extent={{10,-10},{30,10}})));
    Buildings.Controls.OBC.CDL.Continuous.PID conPID(Ti=120, reverseActing=
          false)
      annotation (Placement(transformation(extent={{-30,-10},{-10,10}})));
    Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TSet(k=273.15 + 25)
