...
model AirHeating
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Pulse nPer(
    shift(displayUnit="h") = 25200,
    period(displayUnit="d") = 86400,
  ...
  Buildings.Controls.OBC.CDL.Continuous.Add TAirLvgSet(k1=8)
    "Set point temperature for air leaving the heater"
    annotation (Placement(transformation(extent={{40,-90},{60,-70}})));
  Buildings.Controls.OBC.CDL.Continuous.AddParameter TSupMin(p=2, k=1)
