...
model LightsControl
  ...
  Buildings.Controls.OBC.CDL.Continuous.Modulo mod1 "Output time of day"
    annotation (Placement(transformation(extent={{-100,60},{-80,80}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant day(k=24*3600)
    "Outputs one day"
  ...
  Buildings.Controls.OBC.CDL.Continuous.LessThreshold lesEquThr(t=22*3600)
    "Check whether time is earlier than 22:00"
    annotation (Placement(transformation(extent={{-60,60},{-40,80}})));
  Buildings.Controls.OBC.CDL.Continuous.Add timToSunSet(k2=-1)
    "Time to next sunset"
    annotation (Placement(transformation(extent={{-100,130},{-80,150}})));
  Buildings.Controls.OBC.CDL.Continuous.LessThreshold lesEquThr1(t=1800)
  ...
  Buildings.Controls.OBC.CDL.Conversions.BooleanToReal PLig(realTrue=1000)
    "Lighting power"
    annotation (Placement(transformation(extent={{60,100},{80,120}})));
  Buildings.Controls.OBC.CDL.Logical.Not not1 "Output true if the sun is down"
    annotation (Placement(transformation(extent={{-70,100},{-50,120}})));
  Buildings.Controls.OBC.CDL.Continuous.GreaterThreshold greEquThr(t=12*3600)
