within OCTExamples.ThermalZones_EnergyPlus_Examples.SingleFamilyHouse;
model RadiantHeatingCooling
  "Example model with one thermal zone with a radiant floor"
  extends
    OCTExamples.ThermalZones_EnergyPlus_Examples.SingleFamilyHouse.Unconditioned(
  ...
  parameter Buildings.HeatTransfer.Data.OpaqueConstructions.Generic layCei(nLay=4,
      material={Buildings.HeatTransfer.Data.Solids.Concrete(x=0.08),
        Buildings.HeatTransfer.Data.Solids.InsulationBoard(x=0.10),
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TSetRooHea(k(
      final unit="K",
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TSetRooCoo(k(
      final unit="K",
  ...
  Buildings.ThermalZones.EnergyPlus.OpaqueConstruction attFlo(surfaceName=
        "Attic:LivingFloor") "Floor of the attic above the living room"
    annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={102,90})));
  Buildings.ThermalZones.EnergyPlus.OpaqueConstruction livFlo(surfaceName=
        "Living:Floor") "Floor of the living room" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={100,-180})));
  ...
  Buildings.Controls.OBC.RadiantSystems.Heating.HighMassSupplyTemperature_TRoom
    conHea(TSupSet_max=318.15) "Controller for radiant heating system"
    annotation (Placement(transformation(rotation=0, extent={{-140,-160},{-120,
            -140}})));
