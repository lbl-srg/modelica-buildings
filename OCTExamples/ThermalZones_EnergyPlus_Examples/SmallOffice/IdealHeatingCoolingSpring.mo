within OCTExamples.ThermalZones_EnergyPlus_Examples.SmallOffice;
model IdealHeatingCoolingSpring
  "Building with constant fresh air and ideal heating/cooling that exactly meets set point"
  extends
    OCTExamples.ThermalZones_EnergyPlus_Examples.SmallOffice.IdealHeatingCoolingWinter;
  annotation (
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/EnergyPlus/Examples/SmallOffice/IdealHeatingCoolingSpring.mos" "Simulate and plot"),
    experiment(
      StartTime=7344000,
      StopTime=7776000,
      Tolerance=1e-06),
