within OCTExamples.HydronicHeating;
model TwoRoomsWithStorage
 ...
 parameter Modelica.SIunits.PressureDifference dp_nominal=
  ...
  Buildings.Controls.OBC.CDL.Continuous.MultiMax mulMax(nin=2)
    "Maximum radiator valve position"
    annotation (Placement(transformation(extent={{0,60},{20,80}})));
  Buildings.Controls.OBC.CDL.Continuous.Hysteresis hysPum(uLow=0.01, uHigh=0.5)
    "Hysteresis for pump"
  ...
  Buildings.Controls.OBC.CDL.Continuous.Gain gain(k=1/dp_nominal)
...
Changed controller to output setpoint for supply air temperature for cooling coil.
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant occ1(k=1/6/4)
    "Heat gain if occupied in room 1"
    annotation (Placement(transformation(extent={{300,590},{320,610}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant occ2(k=1/6/4)
    "Heat gain if occupied in room 2"
    annotation (Placement(transformation(extent={{300,310},{320,330}})));
  Buildings.Controls.OBC.CDL.Continuous.MovingMean aveTOut(delta=24*3600)
