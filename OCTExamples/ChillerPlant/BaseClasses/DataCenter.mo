within OCTExamples.ChillerPlant.BaseClasses;
partial model DataCenter
  ...
  OCTExamples.ChillerPlant.BaseClasses.Controls.WSEControl wseCon annotation (
  ...
  Buildings.Fluid.Actuators.Valves.TwoWayLinear val6(
    ...
    "Control valve for chilled water leaving from chiller" annotation (
      Placement(transformation(
        ...
        rotation=270,
        origin={358,40})));
  OCTExamples.ChillerPlant.BaseClasses.Controls.ChillerSwitch chiSwi(deaBan(
        displayUnit="K") = 2.2) "Control unit switching chiller on or off "
    annotation (Placement(transformation(extent={{-226,83},{-206,103}})));
  OCTExamples.ChillerPlant.BaseClasses.Controls.LinearPiecewiseTwo linPieTwo(
    x0=0,
    x2=1,
    x1=0.5,
    y11=1,
  ...
  OCTExamples.ChillerPlant.BaseClasses.Controls.KMinusU KMinusU(k=1)
