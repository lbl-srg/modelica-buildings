within OCTExamples.DualFanDualDuct;
model ClosedLoop "Closed loop model of a dual-fan dual-duct system"
  ...
  OCTExamples.DualFanDualDuct.Controls.HeatingCoilTemperatureSetpoint TSupSetHea(TOn=
        284.15, TOff=279.15) "Set point for preheat coil outlet temperature "
    annotation (Placement(transformation(extent={{-200,-110},{-180,-90}})));
  OCTExamples.VAVReheat.BaseClasses.Controls.FanVFD conFanSupHot(
  ...
  OCTExamples.VAVReheat.BaseClasses.Controls.ModeSelector modeSelector
  ...
  Buildings.Fluid.Sources.Boundary_pT souCoo(
    ...
    T=279.15) "Source for cooling coil" annotation (Placement(transformation(
        ...
        rotation=90,
        origin={380,-220})));
  OCTExamples.VAVReheat.BaseClasses.Controls.Economizer conEco(
    have_frePro=true,
  ...
  OCTExamples.VAVReheat.BaseClasses.Controls.RoomTemperatureSetpoint TSetRoo(THeaOff=
        289.15)
  ...
  OCTExamples.DualFanDualDuct.ThermalZones.SupplyBranch cor(
  ...
  OCTExamples.DualFanDualDuct.ThermalZones.SupplyBranch sou(
    redeclare package MediumA = MediumA,
  ...
  OCTExamples.DualFanDualDuct.ThermalZones.SupplyBranch wes(
    redeclare package MediumA = MediumA,
  ...
  OCTExamples.VAVReheat.BaseClasses.Controls.FanVFD conFanRet(
    xSet_nominal(displayUnit="Pa") = 30,
    initType=Modelica.Blocks.Types.Init.InitialState,
    y_start=yFan_start,
    r_N_min=0.2,
  ...
  OCTExamples.DualFanDualDuct.Controls.CoolingCoilTemperatureSetpoint TSetCoo(TOn=
        285.15, TOff=313.15) "Set point for cooling coil"
  ...
  OCTExamples.VAVReheat.BaseClasses.Floor flo(redeclare package Medium =
        MediumA)
  ...
  OCTExamples.VAVReheat.BaseClasses.Controls.FanVFD conFanSupCol(
    initType=Modelica.Blocks.Types.Init.InitialState,
    y_start=yFan_start,
    xSet_nominal(displayUnit="Pa") = 30,
