within OCTExamples.DualFanDualDuct.ThermalZones;
model SupplyBranch "Supply branch of a dual duct system"
  ...
  Buildings.Fluid.Sensors.RelativePressure senRelPreHot(redeclare package
      Medium =
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={150,0})));
  Buildings.Fluid.Sensors.RelativePressure senRelPreCol(redeclare package
      Medium =
