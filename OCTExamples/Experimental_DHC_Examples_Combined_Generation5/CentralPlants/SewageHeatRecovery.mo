within OCTExamples.Experimental_DHC_Examples_Combined_Generation5.CentralPlants;
model SewageHeatRecovery
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TSewWat(
    ...
    annotation (Placement(transformation(
        extent={{-40,-40},{40,40}},
        rotation=0,
        origin={-340,220}), iconTransformation(
        extent={{-40,-40},{40,40}},
        rotation=0,
        origin={-340,220})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput mPum_flow(
    ...
    annotation (Placement(transformation(
        extent={{-40,-40},{40,40}},
        rotation=0,
        origin={-340,140}),iconTransformation(
        extent={{-40,-40},{40,40}},
        rotation=0,
        origin={-340,140})));
  ...
  Buildings.Experimental.DHC.EnergyTransferStations.BaseClasses.Pump_m_flow pumSew(
    ...
    final allowFlowReversal=allowFlowReversal) "Sewage water pump" annotation (
