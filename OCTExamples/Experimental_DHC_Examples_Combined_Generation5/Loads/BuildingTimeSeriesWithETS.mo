within OCTExamples.Experimental_DHC_Examples_Combined_Generation5.Loads;
model BuildingTimeSeriesWithETS
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TColWat(
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-80,-120})));
  Buildings.Controls.OBC.CDL.Continuous.Gain loaHeaNor(k=1/QHea_flow_nominal)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Gain loaCooNor(k=1/QCoo_flow_nominal)
