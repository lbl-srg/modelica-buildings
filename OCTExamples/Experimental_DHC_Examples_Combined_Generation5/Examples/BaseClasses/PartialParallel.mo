within OCTExamples.Experimental_DHC_Examples_Combined_Generation5.Examples.BaseClasses;
partial model PartialParallel "Partial model for parallel network"
  ...
  inner parameter
    OCTExamples.Experimental_DHC_Examples_Combined_Generation5.Data.DesignDataParallel
  ...
  // COMPONENTS
  OCTExamples.Experimental_DHC_Examples_Combined_Generation5.ThermalStorages.BoreField
  ...
  Buildings.Experimental.DHC.EnergyTransferStations.BaseClasses.Pump_m_flow pumDis(
      redeclare final package Medium = Medium, final m_flow_nominal=datDes.mPumDis_flow_nominal)
    "Distribution pump" annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=90,
        origin={80,-60})));
  ...
  Buildings.Experimental.DHC.EnergyTransferStations.BaseClasses.Pump_m_flow pumSto(
    ...
    final allowFlowReversal=allowFlowReversalSer) "Bore field pump" annotation
    (Placement(transformation(
        extent={{10,10},{-10,-10}},
        rotation=180,
        origin={-180,-80})));
  OCTExamples.Experimental_DHC_Examples_Combined_Generation5.Networks.BaseClasses.ConnectionSeriesStandard
    conPla(
    redeclare final package Medium = Medium,
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-80,-10})));
  OCTExamples.Experimental_DHC_Examples_Combined_Generation5.Networks.UnidirectionalParallel
    dis(
    redeclare final package Medium = Medium,
    final nCon=nBui,
  ...
  OCTExamples.Experimental_DHC_Examples_Combined_Generation5.Networks.BaseClasses.ConnectionSeriesStandard
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-80,-90})));
  OCTExamples.Experimental_DHC_Examples_Combined_Generation5.CentralPlants.SewageHeatRecovery
    pla(
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TDisWatBorLvg(redeclare final
    ...
    "District water borefield leaving temperature" annotation (Placement(
        ...
        origin={-80,-40})));
  replaceable
    OCTExamples.Experimental_DHC_Examples_Combined_Generation5.Loads.BaseClasses.PartialBuildingWithETS
