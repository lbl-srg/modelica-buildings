...
partial model PartialSeries "Partial model for series network"
  ...
  inner parameter
    OCTExamples.Experimental_DHC_Examples_Combined_Generation5.Data.DesignDataSeries
  ...
  OCTExamples.Experimental_DHC_Examples_Combined_Generation5.Networks.UnidirectionalSeries
    dis(
    redeclare final package Medium = Medium,
    final nCon=nBui,
    show_TOut=true,
