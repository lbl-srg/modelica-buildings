within OCTExamples.Experimental_DHC_Examples_Combined_Generation5.Examples;
model SeriesConstantFlow
  ...
  extends BaseClasses.PartialSeries(redeclare
      OCTExamples.Experimental_DHC_Examples_Combined_Generation5.Loads.BuildingTimeSeriesWithETS
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant THotWatSupSet[nBui](k=
        fill(63 + 273.15, nBui)) "Hot water supply temperature set point"
    annotation (Placement(transformation(extent={{-190,170},{-170,190}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TColWat[nBui](k=fill(
        15 + 273.15, nBui)) "Cold water temperature"
