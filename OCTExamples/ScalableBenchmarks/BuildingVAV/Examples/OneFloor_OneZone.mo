within OCTExamples.ScalableBenchmarks.BuildingVAV.Examples;
model OneFloor_OneZone "Closed-loop model with 1 zone in 1 floor"
  ...
  OCTExamples.ScalableBenchmarks.BuildingVAV.BaseClasses.VAVBranch vavTer[nZon,nFlo]
    (
  ...
  OCTExamples.ScalableBenchmarks.BuildingVAV.ThermalZones.MultiZone buiZon(nZon=nZon,
  ...
  Buildings.Fluid.HeatExchangers.WetCoilEffectivenessNTU cooCoi[nFlo](
  ...
  OCTExamples.VAVReheat.BaseClasses.Controls.ModeSelector modeSelector[nFlo]
    "Finite State Machine for the operational modes"
    annotation (Placement(transformation(extent={{-180,40},{-164,56}})));
  OCTExamples.VAVReheat.BaseClasses.Controls.Economizer conEco[nFlo](each
      have_reset=true, each VOut_flow_min=0.3*m_flow_nominal/1.2)
  ...
  OCTExamples.VAVReheat.BaseClasses.Controls.FanVFD conFanRet[nFlo](each
      xSet_nominal(displayUnit="m3/s") = m_flow_nominal/1.2, each r_N_min=0.2)
    "Controller for fan"
    annotation (Placement(transformation(extent={{14,152},{28,166}})));
  OCTExamples.ScalableBenchmarks.BuildingVAV.BaseClasses.ControlBus controlBus[nFlo]
    "Control bus for each floor" annotation (Placement(transformation(extent={{
            -78,44},{-58,64}}), iconTransformation(extent={{-128,136},{-108,156}})));
  OCTExamples.ScalableBenchmarks.BuildingVAV.BaseClasses.HeatSetpoint TSetHea
    "Heating setpoint"
    annotation (Placement(transformation(extent={{-130,30},{-118,42}})));
  OCTExamples.ScalableBenchmarks.BuildingVAV.BaseClasses.CoolSetpoint TSetCoo1
    "Cooling setpoint"
  ...
  OCTExamples.ScalableBenchmarks.BuildingVAV.BaseClasses.FanOnOffWithDP fan_dP_On_Off[nFlo](
      each preRis=dP_pre) "controller outputs fan on or off"
