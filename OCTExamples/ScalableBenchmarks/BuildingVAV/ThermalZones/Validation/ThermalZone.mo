within OCTExamples.ScalableBenchmarks.BuildingVAV.ThermalZones.Validation;
model ThermalZone "Validation of the single zone model"
  extends Modelica.Icons.Example;
  package MediumA = Buildings.Media.Air "Medium model";

  OCTExamples.ScalableBenchmarks.BuildingVAV.ThermalZones.ThermalZone thermalZone(
      redeclare package MediumA = MediumA, gainFactor=1) "Thermal zone model"
