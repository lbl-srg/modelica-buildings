within OCTExamples.ScalableBenchmarks.BuildingVAV.ThermalZones;
model MultiZone "Multiple thermal zone models"
  ...
  OCTExamples.ScalableBenchmarks.BuildingVAV.ThermalZones.ThermalZone theZon[nZon,nFlo]
    (redeclare each package MediumA = MediumA, gainFactor={{ampFactor[i] for j
         in 1:nFlo} for i in 1:nZon}) "Thermal zone model"
