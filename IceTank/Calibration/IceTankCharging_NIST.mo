within IceTank.Calibration;
model IceTankCharging_NIST
  extends Modelica.Icons.Example;
  package Medium = Buildings.Media.Antifreeze.PropyleneGlycolWater (
    property_T=293.15,
    X_a=0.30);
  parameter String fileName=Modelica.Utilities.Files.loadResource("modelica://VirtualTestbed/Resources/data/NISTChillerTestbed/Component/Calibration/charging-chiller-ice_NIST.txt")
  "File where matrix is stored";
  parameter Modelica.SIunits.Mass mIce_max=2846.35
    "Nominal mass of ice in the tank";
  parameter Modelica.SIunits.Mass mIce_start=0.0259*mIce_max
  ...
  IceTank.IceTank iceTan(
    ...
    waiTim=0,
    m_flow_nominal=1.5,
    coeffCha=3600*{1.99930278E-5,0,0,0,0,0})
  ...
  Modelica.Blocks.Sources.CombiTimeTable dat(
    ...
    tableName="tab",
    fileName=fileName,
    columns=2:5) "Flowrate measurements"
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
    ...
    experiment(StopTime=60370, __Dymola_Algorithm="Dassl"),
    __Dymola_Commands(file=
          "modelica://VirtualTestbed/Resources/Scripts/Dymola/NISTChillerTestbed/Component/Calibration/IceTankCharging_NIST.mos"
        "Simulate and Plot"),
