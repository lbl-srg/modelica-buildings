...
model IceTankDischarging_EnergyPlus
  ...
  parameter String fileName=Modelica.Utilities.Files.loadResource("modelica://VirtualTestbed/Resources/data/NISTChillerTestbed/Component/Calibration/EnergyPlus_Discharging.txt")
