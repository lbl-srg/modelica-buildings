...
model TankTOutControl "Storage outlet temperature control"
  ...
  Modelica.Blocks.Sources.IntegerExpression dorMod(y=Integer(IceTank.Types.IceThermalStorageMode.Dormant))
    "Dormant mode"
  ...
  Modelica.Blocks.Sources.IntegerExpression chaMod(y=Integer(IceTank.Types.IceThermalStorageMode.Charging))
    "Charging mode"
  ...
  Modelica.Blocks.Sources.IntegerExpression disMod(y=Integer(IceTank.Types.IceThermalStorageMode.Discharging))
    "Discharging mode"
