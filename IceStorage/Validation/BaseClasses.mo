...
package BaseClasses "Baseclasses"
  ...
  equation
    ...
    connect(TIn.Kelvin, sou.T_in) annotation (Line(points={{-67,30},{-64,30},{
            -64,4},{-56,4}}, color={0,0,127}));
    connect(dat.y[1], TIn.Celsius) annotation (Line(points={{-79,70},{-74,70},{
            -74,48},{-96,48},{-96,30},{-90,30}}, color={0,0,127}));
    connect(dat.y[2], TOut.Celsius) annotation (Line(points={{-79,70},{-74,70},
            {-74,48},{-96,48},{-96,-40},{-82,-40}}, color={0,0,127}));
    connect(dat.y[4], sou.m_flow_in) annotation (Line(points={{-79,70},{-62,70},
            {-62,8},{-56,8}}, color={0,0,127}));
    annotation (
