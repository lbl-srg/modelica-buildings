...
model IceTankDischargingDay2_NIST
  ...
  parameter Modelica.SIunits.Mass mIce_start=0.96645368*mIce_max
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
    ...
    experiment(StartTime=0, StopTime=36890, __Dymola_Algorithm="Dassl"),
    __Dymola_Commands(file="modelica://VirtualTestbed/Resources/Scripts/Dymola/NISTChillerTestbed/Component/Calibration/IceTankDischargingDay2.mos"
        "Simulate and Plot"),
...
end IceTankDischargingDay2_NIST;
