...
model IceTankDischargingDay3_NIST
  ...
  parameter Modelica.SIunits.Mass mIce_start=0.96963383*mIce_max
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
    ...
    experiment(StartTime=0, StopTime=19950, __Dymola_Algorithm="Dassl"),
    __Dymola_Commands(file="modelica://VirtualTestbed/Resources/Scripts/Dymola/NISTChillerTestbed/Component/Calibration/IceTankDischargingDay3.mos"
        "Simulate and Plot"),
...
end IceTankDischargingDay3_NIST;
