...
model BooleanReplicator "Test model for boolean replicator"
  ...
  Districts.Utilities.Math.BooleanReplicator booRep(nout=
...
equation
  connect(booTab.y, booRep.u) annotation (Line(
      ...
      color={255,0,255},
      smooth=Smooth.None));
annotation (            __Dymola_Commands(file="modelica://Districts/Resources/Scripts/Dymola/Utilities/Math/Examples/BooleanReplicator.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This model tests the implementation of
<a href=\"modelica://Districts.Utilities.Math.BooleanReplicator\">
Districts.Utilities.Math.BooleanReplicator</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
