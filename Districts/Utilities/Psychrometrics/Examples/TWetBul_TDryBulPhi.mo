...
model TWetBul_TDryBulPhi "Model to test the wet bulb temperature computation"
 ...
 package Medium = Buildings.Media.PerfectGases.MoistAirUnsaturated
  ...
  Districts.Utilities.Psychrometrics.TWetBul_TDryBulPhi wetBulPhi(redeclare
  ...
  Modelica.Blocks.Sources.Constant TDryBul(k=283.15) "Dry bulb temperature"
            ...
            {-80,80}})));
  Districts.Utilities.Psychrometrics.TWetBul_TDryBulPhi wetBulPhiApp(redeclare
...
equation
  ...
  connect(phi.y, wetBulPhiApp.phi)
      ...
      color={0,0,127},
      smooth=Smooth.None));
    annotation (    __Dymola_Commands(file="modelica://Districts/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/TWetBul_TDryBulPhi.mos"
        "Simulate and plot"),
