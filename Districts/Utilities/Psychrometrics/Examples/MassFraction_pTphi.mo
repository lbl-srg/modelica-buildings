   ...
   package Medium2 = Buildings.Media.GasesPTDecoupled.MoistAir "Medium model";
    ...
    height=1) "Relative humidity"
                 annotation (Placement(transformation(extent={{-80,-60},{-60,-40}},
                   rotation=0)));
  Districts.Utilities.Psychrometrics.X_pTphi masFra1(           redeclare
    ...
    Modelica.Blocks.Sources.Constant P(k=101325) "Pressure"
                 annotation (Placement(transformation(extent={{-80,20},{-60,40}},
                   rotation=0)));
  Districts.Utilities.Psychrometrics.X_pTphi masFra2(           redeclare
...
equation
  ...
  connect(P.y, masFra1.p_in) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  annotation(__Dymola_Commands(file="modelica://Districts/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/MassFraction_pTphi.mos" "Simulate and plot"), Diagram(
