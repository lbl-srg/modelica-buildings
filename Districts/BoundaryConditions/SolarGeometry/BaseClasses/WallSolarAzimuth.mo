within Districts.BoundaryConditions.SolarGeometry.BaseClasses;
...
equation
  alt_c=Modelica.Math.cos(Districts.Utilities.Math.Functions.smoothLimit(
  ...
  verAzi=Modelica.Math.acos(
       Districts.Utilities.Math.Functions.smoothLimit(x=rat, l=-1+deltaX, u=1-deltaX, deltaX=deltaX/10));

  annotation (Icon(graphics={Bitmap(extent={{-92,92},{92,-92}}, fileName=
              "modelica://Districts/Resources/Images/BoundaryConditions/SolarGeometry/BaseClasses/WallSolarAzimuth.png")}),
