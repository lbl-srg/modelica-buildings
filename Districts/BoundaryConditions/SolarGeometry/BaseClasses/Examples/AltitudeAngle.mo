...
equation
  ...
  connect(zen.zen, altAng.zen) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  annotation (Diagram(graphics), __Dymola_Commands(file="modelica://Districts/Resources/Scripts/Dymola/BoundaryConditions/SolarGeometry/BaseClasses/Examples/AltitudeAngle.mos"
        "Simulate and plot"),
...
<ul>
<li>
<a href=\"modelica://Districts.BoundaryConditions.SolarGeometry.BaseClasses.Declination\">Districts.BoundaryConditions.SolarGeometry.BaseClasses.Declination</a>
</li>
<li>
<a href=\"modelica://Districts.BoundaryConditions.SolarGeometry.BaseClasses.SolarHourAngle\">Districts.BoundaryConditions.SolarGeometry.BaseClasses.SolarHourAngle</a>
</li>
<li>
<a href=\"modelica://Districts.BoundaryConditions.SolarGeometry.BaseClasses.ZenithAngle\">Districts.BoundaryConditions.SolarGeometry.BaseClasses.ZenithAngle</a>
</li>
</ul>
</p>
</html>",
