...
equation
  ...
  connect(weaBus.sol.zen, altAng.zen) annotation (Line(
      ...
      index=-1,
      extent={{-6,3},{-6,3}}));
  annotation ( __Dymola_Commands(file="modelica://Districts/Resources/Scripts/Dymola/BoundaryConditions/SolarGeometry/BaseClasses/Examples/WallSolarAzimuth.mos"
        "Simulate and plot"),
