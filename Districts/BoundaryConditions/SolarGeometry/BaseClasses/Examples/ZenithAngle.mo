...
model ZenithAngle "Test model for zenith angle"
  ...
  import Districts;
  Districts.BoundaryConditions.SolarGeometry.BaseClasses.ZenithAngle zen(lat=
...
equation
  ...
  connect(weaBus.solTim, solHouAng.solTim) annotation (Line(
      ...
      index=-1,
      extent={{-6,3},{-6,3}}));
  annotation (Diagram(graphics), __Dymola_Commands(file="modelica://Districts/Resources/Scripts/Dymola/BoundaryConditions/SolarGeometry/BaseClasses/Examples/ZenithAngle.mos"
        "Simulate and plot"));
end ZenithAngle;
