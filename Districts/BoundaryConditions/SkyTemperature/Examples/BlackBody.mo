within Districts.BoundaryConditions.SkyTemperature.Examples;
...
equation
  ...
  annotation (
    Diagram(graphics),
    __Dymola_Commands(file="modelica://Districts/Resources/Scripts/Dymola/BoundaryConditions/SkyTemperature/Examples/BlackBody.mos"
        "Simulate and plot"),
    Icon(graphics));
end BlackBody;
