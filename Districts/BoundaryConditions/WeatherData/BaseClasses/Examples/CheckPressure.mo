...
model CheckPressure "Test model for pressure check"
  ...
  Districts.BoundaryConditions.WeatherData.BaseClasses.CheckPressure chePre
...
equation
  ...
  connect(conTim.calTim, datRea.u) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  annotation (Diagram(graphics), __Dymola_Commands(file="modelica://Districts/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/CheckPressure.mos"
        "Simulate and plot"));
end CheckPressure;
