...
model ConvertRadiation "Test model for ConvertRadiation"
  ...
  import Districts;
  Districts.BoundaryConditions.WeatherData.BaseClasses.ConvertRadiation
  ...
  Districts.BoundaryConditions.WeatherData.BaseClasses.ConvertTime timCon
...
equation
  ...
  annotation (Diagram(graphics), __Dymola_Commands(file=
          "modelica://Districts/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/ConvertRadiation.mos"
        "Simulate and plot"));
