...
model ConvertRelativeHumidity
  ...
  import Districts;
  Districts.BoundaryConditions.WeatherData.BaseClasses.ConvertRelativeHumidity
...
equation
  ...
  annotation (Diagram(graphics), __Dymola_Commands(file=
          "modelica://Districts/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/ConvertRelativeHumidity.mos"
        "Simulate and plot"));
