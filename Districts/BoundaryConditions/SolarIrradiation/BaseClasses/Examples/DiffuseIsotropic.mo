...
equation
  ...
  connect(weaBus.HDifHor, HDifTilIso.HDifHor) annotation (Line(
      ...
      index=-1,
      extent={{-6,3},{-6,3}}));
  annotation (             __Dymola_Commands(file="modelica://Districts/Resources/Scripts/Dymola/BoundaryConditions/SolarIrradiation/BaseClasses/Examples/DiffuseIsotropic.mos"
        "Simulate and plot"));
