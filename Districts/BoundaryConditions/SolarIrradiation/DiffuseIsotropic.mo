within Districts.BoundaryConditions.SolarIrradiation;
block DiffuseIsotropic
  "Diffuse solar irradiation on a tilted surface with an isotropic sky model"
  extends
    Districts.BoundaryConditions.SolarIrradiation.BaseClasses.PartialSolarIrradiation;
public
...
protected
  Districts.BoundaryConditions.SolarIrradiation.BaseClasses.DiffuseIsotropic HDifTilIso(til=til,
      rho=rho)
