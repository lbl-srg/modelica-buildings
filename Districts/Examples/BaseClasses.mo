...
package BaseClasses "Model with base classes"
  extends Modelica.Icons.BasesPackage;
  model DataCenterContinuousTimeControl "Data center model"
  ...
  equation
    connect(PHVAC.y, PAC) annotation (Line(
        points={{-279,-250},{-260,-250},{-260,-220},{-130,-220}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(PIT.y, PDC) annotation (Line(
        points={{-279,-280},{-252,-280},{-252,-228},{-160,-228},{-160,-240},{
            -130,-240}},
        color={0,0,127},
        smooth=Smooth.None));
    annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-400,
          ...
          graphics={Rectangle(
            ...
            fillPattern=FillPattern.Solid), Bitmap(extent={{-88,88},{96,-78}},
              fileName=
                "modelica://Districts/Resources/Images/Examples/BaseClasses/DataCenter.png")}),
...
First implementation.
  ...
  package Examples "Package with test models"
    extends Modelica.Icons.ExamplesPackage;
    model BatteryControl "Test model for battery control"
      import Districts;
      extends Modelica.Icons.Example;
      Districts.Examples.BaseClasses.BatteryControl con "Battery control"
