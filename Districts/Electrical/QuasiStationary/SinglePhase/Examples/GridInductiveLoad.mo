...
model GridInductiveLoad
  ...
  Sensors.PowerSensor powSen1 "Power sensor"            annotation (
      Placement(transformation(
        ...
        rotation=90,
        origin={-50,20})));
  Sensors.PowerSensor powSen2 "Power sensor"            annotation (
      Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=90,
        origin={50,20})));
...
First implementation.
    ...
    Commands(file=
          "Resources/Scripts/Dymola/Electrical/QuasiStationary/SinglePhase/Examples/GridInductiveLoad.mos"
        "Simulate and plot"),
