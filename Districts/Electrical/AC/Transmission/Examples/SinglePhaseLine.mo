...
model SinglePhaseLine
  ...
  Districts.Electrical.AC.Transmission.SinglePhaseLine line2(
    P=5000,
    V=230,
  ...
  Districts.Electrical.AC.Loads.InductorResistor load2(P_nominal=5000, pf=0.9)
    annotation (Placement(transformation(extent={{-10,0},{10,20}})));
  Districts.Electrical.AC.Transmission.SinglePhaseLine line1(
    P=5000,
    V=230,
    redeclare Districts.Electrical.AC.Transmission.Materials.Copper material,
    cable=Districts.Electrical.AC.Transmission.Cables.mmq_1_0(),
