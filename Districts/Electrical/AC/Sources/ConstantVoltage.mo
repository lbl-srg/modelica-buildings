...
equation
  ...
  connect(voltageSource.pin_p, sPhasePlug.p[1]) annotation (Line(
      points={{-14,0},{-58,0},{-58,8.88178e-16},{-100,8.88178e-16}},
      color={85,170,255},
      smooth=Smooth.None));
  connect(voltageSource.pin_n, sPhasePlug.n) annotation (Line(
      points={{6,0},{20,0},{20,-20},{-60,-20},{-60,8.88178e-16},{-100,
          8.88178e-16}},
      color={85,170,255},
      smooth=Smooth.None));
