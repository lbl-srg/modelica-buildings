within Districts.Electrical.AC.AC3ph.Sensors.Examples;
model GeneralizedSensor "Example model for generalized sensor"
  import Districts;
  extends Modelica.Icons.Example;
  Districts.Electrical.AC.AC3ph.Sensors.GeneralizedSensor sen
    annotation (Placement(transformation(extent={{-20,2},{0,22}})));
  Districts.Electrical.AC.AC3ph.Loads.CapacitiveLoadP    loa(P_nominal=100)
    "Constant load"
    annotation (Placement(transformation(extent={{40,2},{60,22}})));
  Districts.Electrical.AC.AC3ph.Sources.FixedVoltage    sou(V=120)
    "Voltage source"
...
First implementation.
    ...
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,
            100}}), graphics),
Commands(file=
          "Resources/Scripts/Dymola/Electrical/AC/AC3ph/Sensors/Examples/GeneralizedSensor.mos"
        "Simulate and plot"));
