...
partial model TwoPinComponent_p
  "Component with a two pin DC connector ('positive')"
  ...
  TwoPin_p term annotation (Placement(transformation(extent={{-114,-10},{-94,10}}),
