...
partial model TwoPinComponent_n
  "Component with a two pin DC connector ('negative')"
  ...
  TwoPin_n term    annotation (Placement(transformation(extent={{-106,-10},{-86,10}}),
...
equation
  ...
  Pow = term.PhaseSystem.activePower(term.v,term.i);

  v = term.PhaseSystem.systemVoltage(term.v);
  annotation (
