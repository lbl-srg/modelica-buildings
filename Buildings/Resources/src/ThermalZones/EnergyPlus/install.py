...
def replace_table_in_mo(html, varType):
    ...
    with open(mo_name, 'r') as mo_fil:
        ...
        endStr = f"<!-- End of table of {varType} generated by install.py. Do not edit. -->"
        ...
        if count == 0:
            raise RuntimeError(f"Failed to update list of {varType} in {mo_name}. File was not modified.")
    # Write new file.
