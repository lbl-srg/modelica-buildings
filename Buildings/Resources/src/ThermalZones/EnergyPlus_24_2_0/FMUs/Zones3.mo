...
model Zones3 "Model of three thermal zones"
  ...
  parameter Modelica.Units.SI.Power South_ZN_QCooSen_flow = -1000
    "Design sensible load";
  parameter Modelica.Units.SI.Power South_ZN_QCooLat_flow = -500
    "Design latent load";
  parameter Modelica.Units.SI.Temperature South_ZN_TOutCoo = 303.15
    "Outdoor drybulb temperature at the design load";
  parameter Modelica.Units.SI.DimensionlessRatio South_ZN_XOutCoo = 0.01
    "Outdoor humidity ratio at the design load per total air mass of the zone";
  parameter Modelica.Units.SI.Time South_ZN_tCoo = 3600
    "Time at which the design load occurred";
  ...
  parameter Modelica.Units.SI.Power South_ZN_QHea_flow = 1000
    "Design heating load";
  parameter Modelica.Units.SI.Temperature South_ZN_TOutHea = 273.15 - 20
    "Outdoor drybulb temperature at the design load";
  parameter Modelica.Units.SI.DimensionlessRatio South_ZN_XOutHea = 0.001
    "Outdoor humidity ratio at the design load per total air mass of the zone";
  parameter Modelica.Units.SI.Time South_ZN_tHea = 1800
    "Time at which the design load occurred";
  ...
  parameter Modelica.Units.SI.Power North_ZN_QCooSen_flow = -1000
    "Design sensible load";
  parameter Modelica.Units.SI.Power North_ZN_QCooLat_flow = -500
    "Design latent load";
  parameter Modelica.Units.SI.Temperature North_ZN_TOutCoo = 303.15
    "Outdoor drybulb temperature at the design load";
  parameter Modelica.Units.SI.DimensionlessRatio North_ZN_XOutCoo = 0.01
    "Outdoor humidity ratio at the design load per total air mass of the zone";
  parameter Modelica.Units.SI.Time North_ZN_tCoo = 3600
    "Time at which the design load occurred";
  ...
  parameter Modelica.Units.SI.Power North_ZN_QHea_flow = 1000
    "Design heating load";
  parameter Modelica.Units.SI.Temperature North_ZN_TOutHea = 273.15 - 20
    "Outdoor drybulb temperature at the design load";
  parameter Modelica.Units.SI.DimensionlessRatio North_ZN_XOutHea = 0.001
    "Outdoor humidity ratio at the design load per total air mass of the zone";
  parameter Modelica.Units.SI.Time North_ZN_tHea = 1800
    "Time at which the design load occurred";
