...
def main():
    ...
    output_list =[
      ...
      'WATER HEATER TANK:Water Heater Temperature Node 6 [C](TimeStep)',
      'WATER HEATER TANK:Water Heater Temperature Node 7 [C](TimeStep)',
      'WATER HEATER TANK:Water Heater Temperature Node 8 [C](TimeStep)',   
      'WATER HEATER TANK:Water Heater Temperature Node 9 [C](TimeStep)',
      'WATER HEATER TANK:Water Heater Temperature Node 10 [C](TimeStep)',
      'WATER HEATER TANK:Water Heater Temperature Node 11 [C](TimeStep)',
      'WATER HEATER TANK:Water Heater Temperature Node 12 [C](TimeStep)',        
