...
copyright = u'2012-2022, The Regents of the University of California (through Lawrence Berkeley National Laboratory)'
...
latex_documents = [
  ('index', 'documentation.tex', u'Modelica Buildings Library Documentation',
