/*
 *
 * \file   isatExchangeData.c
 *
 * \brief  Function to exchange data between Modelica and ISAT based on cfdExchangeData.c
 *
 * @author
 *         Xu Han
...
#include <stdio.h>
/*
 * Exchange the data between Modelica and ISAT
 *
 * @param t0 Current time of integration for Modelica
 * @param dt Time step size for next synchronization defined by Modelica
 * @param u Pointer to the input data from Modelica to ISAT
 * @param nU Number of inputs from Modelica to ISAT
 * @param nY Number of outputs from ISAT to Modelica
 * @param y Pointer to the output data from ISAT to Modelica
 *
