...
model IntegratedPrimaryLoadSide3
...
equation
  ...
  connect(yFan.y, cooTow[1].y) annotation (Line(points={{-79,180},{54,180},{202,
          180},{202,147},{187,147}}, color={0,0,127}));
  connect(yFan.y, cooTow[2].y) annotation (Line(points={{-79,180},{70,180},{202,
          180},{202,147},{187,147}}, color={0,0,127}));
  connect(intWSEPri.TSet, CHWSTSet.y) annotation (Line(points={{124.4,42.8},{-120,
          42.8},{-120,160},{-139,160}}, color={0,0,127}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-220,-120},
    ...
    __Dymola_Commands(file=
        ...
        "Simulate and Plot"));
end IntegratedPrimaryLoadSide3;
