...
package Examples
  ...
  model ChillerStageControl
    ...
    Buildings.ChillerWSE.Examples.BaseClasses.Controls.ChillerStageControl
      chiStaCon(tWai=30) "Staging controller for chillers"
  ...
  model ConstantSpeedPumpStageControl
    ...
    Controls.ConstantSpeedPumpStageControl conSpePumSta(tWai=30)
  ...
  model CoolingTowerSpeedControl
    ...
    Buildings.ChillerWSE.Examples.BaseClasses.Controls.CoolingTowerSpeedControl
      cooTowSpeCon(controllerType=Modelica.Blocks.Types.SimpleController.PI,
        reset=Buildings.Types.Reset.Disabled) "Cooling tower speed controller"
      annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
