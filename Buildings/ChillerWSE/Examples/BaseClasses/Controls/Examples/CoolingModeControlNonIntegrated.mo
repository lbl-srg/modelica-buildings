...
model CoolingModeControlNonIntegrated
  "Example that illustrates the use of Buildings.ChillerWSE.Examples.BaseClasses.Controls.CoolingModeControlNonIntegrated"
  extends Modelica.Icons.Example;

  Buildings.ChillerWSE.Examples.BaseClasses.Controls.CoolingModeControlNonIntegrated
  cooModCon(
    tWai=30,
    deaBan=1,
    TSwi=280.15)
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
    ...
    __Dymola_Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/ChillerWSE/Examples/BaseClasses/Controls/Examples/CoolingModeControlNonIntegrated.mos"
        "Simulate and Plot"),
