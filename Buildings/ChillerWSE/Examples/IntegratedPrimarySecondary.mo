...
model IntegratedPrimarySecondary
  ...
  BaseClasses.Controls.ConstantSpeedPumpStageControl
    PriPumCon(tWai=0) "Chilled water primary pump controller"
...
equation
  ...
  connect(towTApp.y, cooModCon.towTApp) annotation (Line(points={{-169,110},{
  ...
  connect(CHWSTSet.y, cooModCon.CHWSTSet) annotation (Line(points={{-169,160},{
