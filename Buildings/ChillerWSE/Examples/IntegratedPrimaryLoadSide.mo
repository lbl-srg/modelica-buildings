...
equation
  ...
  connect(CHWST.port_b, ahu.port_a1)
    annotation (Line(
  ...
  connect(towTApp.y, cooModCon.towTApp)
    annotation (Line(points={{-169,110},{-170,110},{-168,110},{-132,110}},
      color={0,0,127}));
  ...
  connect(cooModCon.cooMod, chiStaCon.cooMod)
    annotation (Line(points={{-109,110},{-70,110},{-70,148},{-52,148}},
      color={0,0,127}));
  connect(cooModCon.cooMod,reaToBoo. u)
    annotation (Line(points={{-109,110},{-94,110},{-52,110}},
      color={0,0,127}));
  connect(cooModCon.cooMod, CWPumCon.cooMod)
    annotation (Line(points={{-109,110},{-70,110},{-70,78},{-54,78}},
      color={0,0,127}));
  ...
  connect(cooModCon.wseCHWRT, CHWRT.T)
    annotation (Line(points={{-132,102},{-150,102},{-150,200},{260,200},
      {260,20},{230,20},{230,11}},     color= {0,0,127}));
  ...
  connect(ahu.port_a2, roo.airPorts[1])
    annotation (Line(points={{174,-126},{174, -126},{194,-126},
      {194,-140},{242,-140},{242,-158},{167.85,-158}},color={0,127,255},
      thickness=0.5));
