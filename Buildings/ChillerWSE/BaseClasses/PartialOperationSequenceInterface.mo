...
partial model PartialOperationSequenceInterface
  ...
  Modelica.Blocks.Math.Feedback inv "Inversion of the control signal"
...
equation
  connect(uni.y, inv.u1) annotation (Line(points={{-47.4,94},{-12.8,94}},
        color={0,0,127}));
  connect(booToRea.y, inv.u2) annotation (Line(points={{-47.4,74},{-30,74},{-8,
          74},{-8,89.2}}, color={0,0,127}));
