...
*/
  ...
  Modelica.Blocks.Tables.CombiTable2D effTable(
    ...
    "Table that represents a set of efficiency curves 
    varying with both the firing rate (control signal) 
...
equation
  connect(effTable.u1, y) annotation (Line(points={{-76,80},{-120,80}},
                color={0,0,127}));
  connect(T_inlet, effTable.u2) annotation (Line(points={{-120,36},{-82,36},{-82,
          68},{-76,68}},
                     color={0,0,127}));
