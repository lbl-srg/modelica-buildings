...
(e.g. The efficiency of a condensing boiler is usually computed on the
higher heating value, whereas a non-condesing boiler's efficiency 
is typically on the lower heating value.) 
</p>
<p>
