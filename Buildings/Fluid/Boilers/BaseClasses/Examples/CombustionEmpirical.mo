...
model CombustionEmpirical
  ...
  Buildings.Fluid.Boilers.BaseClasses.CombustionEmpirical com(
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Boilers/BaseClasses/Examples/CombustionEmpirical.mos"
        "Simulate and plot"));
end CombustionEmpirical;
