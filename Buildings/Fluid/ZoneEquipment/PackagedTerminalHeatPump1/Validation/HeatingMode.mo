within Buildings.Fluid.ZoneEquipment.PackagedTerminalHeatPump1.Validation;
model HeatingMode
  ...
  Buildings.Fluid.ZoneEquipment.PackagedTerminalHeatPump1.Controls.CyclingFanCyclingCoil
    conCycFanCycCoi(
    final heaCoiTyp=Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.HeaSou.heaPum,

    final cooCoiTyp=Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.CooSou.heaPum,
