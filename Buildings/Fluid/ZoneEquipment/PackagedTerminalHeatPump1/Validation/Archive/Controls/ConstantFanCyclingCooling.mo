within Buildings.Fluid.ZoneEquipment.PackagedTerminalHeatPump1.Validation.Archive.Controls;
model ConstantFanCyclingCooling
  ...
  extends Buildings.Fluid.ZoneEquipment.BaseClasses1.ControllerInterfaces(
      final sysTyp=Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.pthp,
  ...
  BaseClasses1.HeatingCooling conOpeMod(conMod=false)
...
equation
  ...
  connect(uFan, conOpeMod.uFan) annotation (Line(points={{-160,120},{-60,120},{
          -60,76},{-12,76}}, color={255,0,255}));
  connect(TZon, conOpeMod.TZon) annotation (Line(points={{-160,80},{-50,80},{
          -50,72},{-12,72}}, color={0,0,127}));
  connect(uFan, conFanCyc.uFan) annotation (Line(points={{-160,120},{-60,120},{
          -60,-57.6},{69.2,-57.6}},
                              color={255,0,255}));
  ...
  connect(fanOpeMod, conFanCyc.fanOpeMod) annotation (Line(points={{-160,-80},{
          -60,-80},{-60,-74.4},{69.2,-74.4}},
                                          color={255,0,255}));
  connect(conOpeMod.yMod, conFanCyc.heaCooOpe) annotation (Line(points={{12,66},
          {40,66},{40,-63.2},{69.2,-63.2}},
                                      color={255,0,255}));
  connect(conFanCyc.yFan, yFan) annotation (Line(points={{102.8,-68.8},{120,
          -68.8},{120,-140},{160,-140}},
                               color={255,0,255}));
  connect(conFanCyc.yFanSpe, yFanSpe) annotation (Line(points={{102.8,-63.2},{
          110,-63.2},{110,-100},{160,-100}},
                                     color={0,0,127}));
  connect(conOpeMod.yEna, yCooEna) annotation (Line(points={{12,70},{100,70},{
          100,60},{160,60}},   color={255,0,255}));
  connect(conOpeMod.yCoi, yCoo) annotation (Line(points={{12,74},{80,74},{80,
          -20},{160,-20}}, color={0,0,127}));
  connect(TCooSet, conOpeMod.TZonSet) annotation (Line(points={{-160,40},{-20,
          40},{-20,68},{-12,68}},                color={0,0,127}));
  connect(TSup, conOpeMod.TSup) annotation (Line(points={{-160,-140},{-40,-140},
          {-40,64},{-12,64}},      color={0,0,127}));
