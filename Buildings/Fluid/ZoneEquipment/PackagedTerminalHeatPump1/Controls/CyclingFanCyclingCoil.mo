...
protected
  Buildings.Fluid.ZoneEquipment.BaseClasses1.HeatingCooling conHea(
  ...
  Buildings.Fluid.ZoneEquipment.BaseClasses1.CyclingFan conFanCyc(final
      tFanEnaDel=tFanEnaDel, final tFanEna=tFanEna) "Cycling fan control"
    annotation (Placement(transformation(extent={{80,-120},{100,-100}})));

  Buildings.Fluid.ZoneEquipment.BaseClasses1.HeatingCooling conCoo(
    ...
    final dTHys=dTHys,
    final conMod=false,
    final tCoiEna=tFanEna) "Cooling coil control"
