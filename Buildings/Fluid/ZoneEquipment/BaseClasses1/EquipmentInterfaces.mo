...
partial model EquipmentInterfaces
  ...
  parameter Modelica.Units.SI.MassFlowRate mHotWat_flow_nominal = 0.1
    ...
    annotation(Dialog(enable=heaCoiTyp == Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.HeaSou.hotWat,group="Heating coil parameters"));

  parameter Modelica.Units.SI.MassFlowRate mChiWat_flow_nominal = 0.1
    "Nominal mass flow rate of chilled water"
    annotation(Dialog(enable=cooCoiTyp == Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.CooSou.chiWat,
                                                                                                        group="Cooling coil parameters"));

  parameter Modelica.Units.SI.MassFlowRate mAirOut_flow_nominal
    "Nominal mass flow rate of outdoor air"
    annotation(Dialog(enable=((oaPorTyp == Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.OAPorts.oaMix)
           or (oaPorTyp == Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.OAPorts.oaPorts)),
  ...
  parameter Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.OAPorts oaPorTyp=Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.OAPorts.oaPorts
...
protected
  final parameter Boolean has_HW=(heaCoiTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.HeaSou.hotWat)
    "Does the zone equipment have a hot water heating coil?";

  final parameter Boolean has_CHW=(cooCoiTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.CooSou.chiWat)
    "Does the zone equipment have a chilled water cooling coil?";

  final parameter Boolean has_extOAPor=(oaPorTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.OAPorts.oaPorts)
    "Does the zone equipment have ports for receiving outdoor air?";

  final parameter Boolean has_ven=((oaPorTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.OAPorts.oaMix) or
    (oaPorTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.OAPorts.oaPorts))
  ...
  final parameter Boolean has_hea=not
                                     (heaCoiTyp==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.HeaSou.noHea)
    "Does the zone equipment have a heating element?";

  final parameter Boolean has_varCoo=not
                                        (cooCoiTyp==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.CooSou.eleDX)
    "Does the zone equipment have variable PLR cooling equipment?";

  final parameter Boolean has_varHea=not
                                        (heaCoiTyp==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.HeaSou.heaPum)
