...
model ExampleTestbed
  ...
  replaceable Buildings.Fluid.ZoneEquipment.BaseClasses1.EquipmentInterfaces zonHVACSys(
    redeclare package MediumA = MediumA,
    redeclare package MediumCHW = MediumW,
    redeclare package MediumHW = MediumW) "Zone HVAC system model interfaces"
  ...
  replaceable Buildings.Fluid.ZoneEquipment.BaseClasses1.ControllerInterfaces conZonHVACSys
