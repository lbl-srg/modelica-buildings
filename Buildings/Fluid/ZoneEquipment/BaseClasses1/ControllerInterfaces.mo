...
partial model ControllerInterfaces
  ...
  parameter Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes sysTyp
    "Select zonal HVAC system type"
    annotation (Dialog(group="System parameters"));

  parameter Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.HeaSou heaCoiTyp=Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.HeaSou.hotWat
    "Type of heating coil used" annotation (Dialog(group="System parameters"));

  parameter Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.CooSou cooCoiTyp=Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.CooSou.chiWat
...
protected
  final parameter Boolean has_hea=(sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.fcu)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.ptac)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.pthp)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.unitHeater)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.zoneOAUnit)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.unitVentilator)
    and not (heaCoiTyp==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.HeaSou.noHea)
    "Does the zone equipment have heating equipment?"
    annotation(Dialog(enable=false, tab="Non-configurable"));

  final parameter Boolean has_coo=(sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.fcu)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.ptac)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.pthp)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.windowAC)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.zoneOAUnit)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.unitVentilator)
    and not (cooCoiTyp==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.CooSou.noCoo)
    "Does the zone equipment have cooling equipment?"
    annotation(Dialog(enable=false, tab="Non-configurable"));

  final parameter Boolean has_varHea = (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.fcu)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.ptac)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.unitHeater)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.zoneOAUnit)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.unitVentilator)
  ...
  final parameter Boolean has_varCoo = (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.fcu)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.zoneOAUnit)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.unitVentilator)
    "Does the zone equipment have variable cooling?";

  final parameter Boolean has_varFan = (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.fcu)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.unitHeater)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.zoneOAUnit)
    or (sysTyp ==Buildings.Fluid.ZoneEquipment.BaseClasses1.Types.SystemTypes.unitVentilator)
