...
model ConstantFanVariableHeating
  ...
  Buildings.Fluid.ZoneEquipment.PackagedTerminalHeatPump.Validation.Archive.Controls.ConstantFanCyclingCooling
    conVarWatConFan(
...
protected
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant heaSetPoi(
    final k=273.15 + 23) "Heating setpoint temperature"
