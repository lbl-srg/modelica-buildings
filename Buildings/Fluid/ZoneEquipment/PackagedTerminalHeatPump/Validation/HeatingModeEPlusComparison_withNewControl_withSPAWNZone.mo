...
model HeatingModeEPlusComparison_withNewControl_withSPAWNZone
  ...
  Controls.CycleFanCyclingCoilHeating conVarWatConFan(
                                                     tFanEna=60)
  ...
  Modelica.Blocks.Math.Mean powModHeaCoi(f=1/averagingTimestep)
  ...
  Modelica.Blocks.Math.Mean QModHeaCoi(f=1/averagingTimestep)
  ...
  Modelica.Blocks.Sources.RealExpression realExpression8(y=datRea.y[17])
  ...
  Modelica.Blocks.Sources.RealExpression realExpression11(y=datRea.y[19])
    annotation (Placement(transformation(extent={{196,-64},{216,-44}})));
  Buildings.Controls.OBC.CDL.Discrete.UnitDelay PLRHeaCoiEP(samplePeriod=
        averagingTimestep)
  ...
  Modelica.Blocks.Sources.RealExpression realExpression10(y=(PTHP.HeaCoi.QSen_flow)
        /PTHP.HeaCoi.datCoi.sta[1].nomVal.Q_flow_nominal)
  ...
  Buildings.Controls.OBC.CDL.Discrete.UnitDelay QHeaCoiEPlus(samplePeriod=
        averagingTimestep)
  ...
  parameter
    HeatExchangers.DXCoils.AirSource.Data.Generic.DXCoil                 datCooCoi(sta={
        ...
        perCur=
          ...
          ffMin=0.875,
          ffMax=1.125))}, nSta=1)
    annotation (Placement(transformation(extent={{70,108},{90,128}})));
equation
  connect(datRea.y[22], div1.u1) annotation (Line(points={{-99,40},{-94,40},{-94,
          56},{-82,56}}, color={0,0,127}));
  connect(datRea.y[22], totMasAir.u) annotation (Line(points={{-99,40},{-94,40},
  ...
  connect(datRea.y[20], K2C[1].u) annotation (Line(points={{-99,40},{-94,40},{-94,
          80},{-82,80}}, color={0,0,127}));
  connect(datRea.y[26], K2C[2].u) annotation (Line(points={{-99,40},{-94,40},{-94,
          80},{-82,80}}, color={0,0,127}));
  connect(datRea.y[27], K2C[3].u) annotation (Line(points={{-99,40},{-94,40},{-94,
          80},{-82,80}}, color={0,0,127}));
  connect(datRea.y[28], K2C[4].u) annotation (Line(points={{-99,40},{-94,40},{-94,
          80},{-82,80}}, color={0,0,127}));
  connect(building.weaBus, PTHP.weaBus) annotation (Line(
      points={{52,120},{54,120},{54,88},{-11.8,88},{-11.8,14}},
      color={255,204,51},
      thickness=0.5));
  connect(conVarWatConFan.THeaSet, K2C[2].y) annotation (Line(points={{-78,-48},
          {-96,-48},{-96,-12},{-42,-12},{-42,80},{-58,80}}, color={0,0,127}));
  connect(K2C[3].y, conVarWatConFan.TCooSet) annotation (Line(points={{-58,80},{
  ...
  connect(realExpression.y,powModHeaCoi. u)
  ...
  connect(realExpression6.y, TZonAir.u)
    annotation (Line(points={{139,-84},{154,-84}}, color={0,0,127}));
  connect(damPos.y, PTHP.uEco) annotation (Line(points={{-98,10},{-38,10},{-38,14},
          {-18,14}}, color={0,0,127}));
  ...
  connect(realExpression11.y,PLRHeaCoiEP. u)
  ...
  connect(realExpression12.y,QHeaCoiEPlus. u)
    annotation (Line(points={{221,-4},{234,-4}}, color={0,0,127}));
  connect(conVarWatConFan.yHeaEna, PTHP.uHeaEna) annotation (Line(points={{-38,-32},
          {-28,-32},{-28,-21.8},{-18,-21.8}}, color={255,0,255}));
  connect(uSupHea.y, PTHP.uSupHea) annotation (Line(points={{-108,-22},{-102,-22},
          {-102,-16},{-18,-16},{-18,-18}}, color={0,0,127}));
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-140,-100},
    ...
    __Dymola_Commands(file=
        ...
        "Simulate and Plot"));
end HeatingModeEPlusComparison_withNewControl_withSPAWNZone;
