...
equation
  ...
  connect(cooSetPoi.y, conVarWatConFan.TCooSet) annotation (Line(points={{-18,90},
          {-4,90},{-4,1.76471},{8.88889,1.76471}},     color={0,0,127}));
  connect(TSup.y, conVarWatConFan.TSup) annotation (Line(points={{-18,-90},{4,
          -90},{4,-11.2941},{8.88889,-11.2941}}, color={0,0,127}));
