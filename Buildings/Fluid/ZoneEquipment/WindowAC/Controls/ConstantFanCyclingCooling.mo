...
equation
  ...
  connect(conOpeMod.yMod, conFanCyc.heaCooOpe) annotation (Line(points={{12,64},
          {40,64},{40,-62},{70,-62}}, color={255,0,255}));
  ...
  connect(conOpeMod.y, yCoo) annotation (Line(points={{12,76},{80,76},{80,20},{
