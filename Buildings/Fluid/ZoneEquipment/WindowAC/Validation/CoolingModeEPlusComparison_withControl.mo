...
equation
  ...
  connect(datRea.y[15], conVarWatConFan.TZon) annotation (Line(points={{-99,40},
          {-94,40},{-94,-32},{-78,-32}}, color={0,0,127}));
  connect(datRea.y[14], conVarWatConFan.TCooSet) annotation (Line(points={{-99,
          40},{-94,40},{-94,-40},{-78,-40}}, color={0,0,127}));
