...
block Controller_MultiSpeedCyclingFan_ConstantWaterFlowrate
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TCooSet "Measured zone temperature"
    annotation (Placement(transformation(extent={{-140,0},{-100,40}}),
        iconTransformation(extent={{-140,-20},{-100,20}})));

  Buildings.Controls.OBC.CDL.Interfaces.RealInput THeaSet "Measured zone temperature"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput yFan annotation (Placement(
        transformation(extent={{100,-80},{140,-40}}), iconTransformation(extent=
           {{100,-80},{140,-40}})));

  Buildings.Controls.OBC.CDL.Continuous.Hysteresis hys1(uLow=-0.5, uHigh=0)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Hysteresis hys2(uLow=-0.5, uHigh=0)
  ...
  Buildings.Controls.OBC.CDL.Continuous.PID conPID(reverseActing=false)
    annotation (Placement(transformation(extent={{0,-20},{20,0}})));

  Buildings.Controls.OBC.CDL.Continuous.PID conPID1(reverseActing=false)
