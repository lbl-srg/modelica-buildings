...
equation
  ...
  connect(valPos.y, fanCoiUni.uHea) annotation (Line(points={{-58,-30},{-36,-30},
          {-36,-12},{8,-12}}, color={0,0,127}));
  ...
  connect(valPos.y, fanCoiUni.uCoo) annotation (Line(points={{-58,-30},{-40,-30},
          {-40,-4},{8,-4}}, color={0,0,127}));
