...
model Controller_ConstantFan_VariableWaterFlowrate
  "Validation model for controller with variable water flow rates and constant speed fan"
    extends Modelica.Icons.Example;
  Buildings.Fluid.ZoneEquipment.FanCoilUnit.Controls.Controller_ConstantFan_VariableWaterFlowrate
    conVarWatConFan
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
        ...
        __Dymola_Commands(file= "modelica://Buildings/Resources/Scripts/Dymola/Fluid/ZoneEquipment/FanCoilUnit/Controls/Validation/Controller_ConstantFan_VariableWaterFlowrate.mos"
      "Simulate and plot"));
