...
equation
  // E+ Equ (555)
  iamBea = Buildings.Utilities.Math.Functions.smoothHeaviside(x=Modelica.Constants.pi/3 - incAng,
   delta=Modelica.Constants.pi/60)*
     Buildings.Fluid.SolarCollector.BaseClasses.IAM(
    incAng,
    B0,
    B1);
