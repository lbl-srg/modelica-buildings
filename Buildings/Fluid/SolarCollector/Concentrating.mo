...
equation
 ...
 <h4>Overview</h4>
 <p>
 This component models a concentrating solar thermal collector. The concentrating model uses ratings data based on EN12975 and by default references the concentrating collector data library.
 </p>
 <h4>Notice</h4>
 <p>
