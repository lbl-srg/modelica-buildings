...
equation
  ...
  connect(massFlowRateMultiplier.port_b, sin.ports[1])
    annotation (Line(points={{30,0},{46,0},{46,1},{60,1}},
                                                    color={0,127,255}));
  ...
  connect(massFlowRateMultiplier1.port_b, sin.ports[2]) annotation (Line(points
        ={{30,-60},{40,-60},{40,-1},{60,-1}}, color={0,127,255}));
  annotation (
