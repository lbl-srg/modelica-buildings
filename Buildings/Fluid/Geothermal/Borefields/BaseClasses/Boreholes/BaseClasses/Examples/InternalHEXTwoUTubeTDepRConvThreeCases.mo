...
equation
  ...
  connect(souFixWatWarm.ports[1], intHexFixWat.port_a2)
    annotation (Line(points={{76,60},{10,60},{10,72}}, color={0,127,255}));
  connect(souFixWatWarm.ports[2], intHexFixWat.port_a4)
    annotation (Line(points={{76,56},{20,56},{20,58},{10,58}}, color={0,127,255}));
  connect(intHexFixWat.port_b1, sinFixWat.ports[1])
    annotation (Line(points={{10,76},{92,76},{92,83}}, color={0,127,255}));
  connect(intHexFixWat.port_b2, sinFixWat.ports[2])
    annotation (Line(points={{-10,72},{-30,72},{-30,110},{92,110},{92,79}}, color={0,127,255}));
  connect(intHexFixWat.port_b3, sinFixWat.ports[3])
    annotation (Line(points={{10,64},{40,64},{40,75},{92,75}}, color={0,127,255}));
  connect(intHexFixWat.port_b4, sinFixWat.ports[4])
    annotation (Line(points={{-10,58},{-40,58},{-40,114},{92,114},{92,71}}, color={0,127,255}));
  ...
  connect(souWatWarm.ports[1], intHexWat.port_a2)
    annotation (Line(points={{76,20},{10,20},{10,32}}, color={0,127,255}));
  connect(souWatWarm.ports[2], intHexWat.port_a4)
    annotation (Line(points={{76,16},{20,16},{20,18},{10,18}}, color={0,127,255}));
  connect(intHexWat.port_b1, sinWat.ports[1])
    annotation (Line(points={{10,36},{92,36},{92,43}}, color={0,127,255}));
  connect(intHexWat.port_b2, sinWat.ports[2])
    annotation (Line(points={{-10,32},{-30,32},{-30,50},{92,50},{92,39}}, color={0,127,255}));
  connect(intHexWat.port_b3, sinWat.ports[3])
    annotation (Line(points={{10,24},{40,24},{40,35},{92,35}}, color={0,127,255}));
  connect(intHexWat.port_b4, sinWat.ports[4])
    annotation (Line(points={{-10,18},{-40,18},{-40,54},{92,54},{92,31}}, color={0,127,255}));
  ...
  connect(souFixGlyWarm.ports[1], intHexFixGly.port_a2)
    annotation (Line(points={{76,-20},{10,-20},{10,-8}}, color={0,127,255}));
  connect(souFixGlyWarm.ports[2], intHexFixGly.port_a4)
    annotation (Line(points={{76,-24},{20,-24},{20,-22},{10,-22}}, color={0,127,255}));
  connect(intHexFixGly.port_b1, sinFixGly.ports[1])
    annotation (Line(points={{10,-4},{92,-4},{92,3}}, color={0,127,255}));
  connect(intHexFixGly.port_b2, sinFixGly.ports[2])
    annotation (Line(points={{-10,-8},{-30,-8},{-30,10},{92,10},{92,-1}}, color={0,127,255}));
  connect(intHexFixGly.port_b3, sinFixGly.ports[3])
    annotation (Line(points={{10,-16},{40,-16},{40,-5},{92,-5}}, color={0,127,255}));
  connect(intHexFixGly.port_b4, sinFixGly.ports[4])
    annotation (Line(points={{-10,-22},{-40,-22},{-40,14},{92,14},{92,-9}}, color={0,127,255}));
  ...
  connect(souGlyWarm.ports[1], intHexGly.port_a2)
    annotation (Line(points={{76,-60},{10,-60},{10,-48}}, color={0,127,255}));
  connect(souGlyWarm.ports[2], intHexGly.port_a4)
    annotation (Line(points={{76,-64},{20,-64},{20,-62},{10,-62}}, color={0,127,255}));
  connect(intHexGly.port_b1, sinGly.ports[1])
    annotation (Line(points={{10,-44},{92,-44},{92,-37}}, color={0,127,255}));
  connect(intHexGly.port_b2, sinGly.ports[2])
    annotation (Line(points={{-10,-48},{-30,-48},{-30,-30},{92,-30},{92,-41}}, color={0,127,255}));
  connect(intHexGly.port_b3, sinGly.ports[3])
    annotation (Line(points={{10,-56},{40,-56},{40,-45},{92,-45}}, color={0,127,255}));
  connect(intHexGly.port_b4, sinGly.ports[4])
    annotation (Line(points={{-10,-62},{-40,-62},{-40,-26},{92,-26},{92,-49}}, color={0,127,255}));
...
resistance for water and propylene-glycol/water in a double U-tube internal
heat exchanger.
</p>
<p>
...
The model is intended to verify that the active fluid-property evaluation is
propagated to all four convection resistances.
</p>
</html>"));
