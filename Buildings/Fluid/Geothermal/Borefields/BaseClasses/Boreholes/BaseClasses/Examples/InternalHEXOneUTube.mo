...
model InternalHEXOneUTube
  ...
  Real Rb_sim(
    unit="(m.K)/W")=((senTem.T+senTem1.T)/2-intHex.port_wall.T)/max(
...
equation
  ...
  annotation (
    ...
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/Boreholes/BaseClasses/Examples/InternalHEXOneUTube.mos" "Simulate and plot"),
    Documentation(
      info="<html>
