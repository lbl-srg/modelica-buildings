...
equation
  TStep=Modelica.Math.Vectors.interpolate(
    timSer[:,1],
    timSer[:,2],
    time);
  annotation (
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/HeatTransfer/LoadAggregation/Validation/TemperatureResponseMatrix.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
