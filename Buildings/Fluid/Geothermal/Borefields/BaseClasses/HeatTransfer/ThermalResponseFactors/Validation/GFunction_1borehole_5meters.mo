...
equation
  ...
  annotation (
    experiment(
      ...
      StopTime=412000000),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/HeatTransfer/ThermalResponseFactors/Validation/GFunction_1borehole_5meters.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
