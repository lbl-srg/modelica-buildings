...
partial model PartialBorefieldWithToughCheckGround
  ...
  GroundResponse.WithGroundCheck toughRes(nSeg=nSeg)
...
equation
  ...
  connect(toughRes.TBorWal, AveTBor.u)
    annotation (Line(points={{29,58},{44,58},{44,50},{58,50}},
                                               color={0,0,127}));
  connect(toughRes.TBorWal, TemBorWal.T) annotation (Line(points={{29,58},{40,
          58},{40,20},{58,20}},
                            color={0,0,127}));
...
end PartialBorefieldWithToughCheckGround;
