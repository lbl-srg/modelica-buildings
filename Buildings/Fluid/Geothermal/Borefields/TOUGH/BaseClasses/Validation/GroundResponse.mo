within Buildings.Fluid.Geothermal.Borefields.TOUGH.BaseClasses.Validation;
...
annotation (__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/TOUGH/BaseClasses/Validation/GroundResponse.mos"
        "Simulate and plot"),
...
It assumes the response temperature increased by 0.1 &deg;C every time when invoking
