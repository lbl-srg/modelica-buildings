...
model Real_Real
  ...
  final parameter Integer nStrWri(min=0)=1
     "Number of strings to write to Python";
  parameter String  strWri[max(1, nStrWri)]={""} "String values to write"
    annotation (Dialog(enable=nStrWri>0));
...
equation
  ...
  when {sampleTrigger} then
    ...
    // Exchange data
    yR = Buildings.Utilities.IO.Python_3_12.Functions.exchange(
 ...
 Icon(coordinateSystem(
          preserveAspectRatio=false, extent={{-100,-100},{100,100}}), graphics={Bitmap(
            extent={{-88,82},{80,-78}}, fileName="modelica://Buildings/Resources/Images/Utilities/IO/Python_3_12/python.png")}),
