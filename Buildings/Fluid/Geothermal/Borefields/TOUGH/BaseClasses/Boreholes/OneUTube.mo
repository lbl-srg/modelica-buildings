within Buildings.Fluid.Geothermal.Borefields.TOUGH.BaseClasses.Boreholes;
model OneUTube "Single U-tube borehole heat exchanger"
  extends Buildings.Fluid.Geothermal.Borefields.TOUGH.BaseClasses.Boreholes.BaseClasses.PartialBorehole;

  Buildings.Fluid.Geothermal.Borefields.TOUGH.BaseClasses.Boreholes.BaseClasses.InternalHEXOneUTube
    intHex[nSeg](
...
Buildings.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.OneUTube</a>,
