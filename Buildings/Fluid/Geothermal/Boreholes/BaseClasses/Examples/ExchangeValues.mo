...
algorithm
  ...
  assert(
    abs(
      y-3) < 1E-10,
    "Error in implementation of exchangeVaules.");
  y := Buildings.Fluid.Geothermal.Boreholes.BaseClasses.exchangeValues(
    table=table,
    iX=2,
    x=4*x,
  ...
  annotation (
    experiment(
      ...
      StopTime=1),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Boreholes/BaseClasses/Examples/ExchangeValues.mos" "Simulate"),
    Documentation(
      info="<html>
<p>
