within Buildings.Fluid.Geothermal.ZonedThermalStorage.Validation;
model SteadyStateBoreholeDynamics "Description"
  ...
  Buildings.Fluid.Geothermal.ZonedThermalStorage.OneUTube borHol(
  ...
  parameter
    Buildings.Fluid.Geothermal.ZonedThermalStorage.Data.Borefield.Example
    borFieDat(
    filDat=filDat,
    soiDat=soiDat,
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/ZonedThermalStorage/Validation/SteadyStateBoreholeDynamics.mos"
        "Simulate and plot"),
  Documentation(info="<html>
<p>
This validation cases tests the independent operation of borefield zones for the
borefield configured in
<a href=\"modelica://Buildings.Fluid.Geothermal.ZonedThermalStorage.Data.Configuration.Example\">
