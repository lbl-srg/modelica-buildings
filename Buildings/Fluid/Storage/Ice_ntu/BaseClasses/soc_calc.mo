...
model soc_calc
  ...
  Modelica.Units.SI.SpecificHeatCapacity Cp_liq;
  ...
  Modelica.Blocks.Interfaces.RealOutput T_tank(unit="K",
                                      displayUnit = "degC")
...
equation
  SOC_out = SOC;
  Cp_liq = Buildings.Utilities.Math.Functions.polynomial(Tliq - 273.15, coeff_liq) * 1000;
  Ttank = T_tank;
