...
model Tank "Block to compute the tank heat transfer"
  ...
  Buildings.Fluid.Storage.Ice_ntu.BaseClasses_save.StateOfCharge SOCCalc(final
...
protected
  ...
  Buildings.Fluid.Storage.Ice_ntu.BaseClasses_save.NormalizedHeatFlowRate norQSta(
  ...
  Buildings.Fluid.Storage.Ice_ntu.BaseClasses_save.LMTDStar lmtdSta(final TFre=
