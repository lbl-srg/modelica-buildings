...
protected
  ...
  Buildings.Fluid.Storage.Ice_ntu.BaseClasses_save.QStar qStaCha(final coeff=
        coeCha, final dt=dtCha) "q* for charing mode"
    annotation (Placement(transformation(extent={{20,-16},{40,4}})));
  Buildings.Fluid.Storage.Ice_ntu.BaseClasses_save.QStar qStaDisCha(final coeff
