...
model DummyConsumer "Test model for the dummy consumer"
  ...
  Modelica.Blocks.Sources.Constant preQCooLoa_flow(k=5*4200*0.65)
...
equation
  connect(set_TRet.y, ideCon.TSet)
    annotation (Line(points={{-59,50},{-30,50},{-30,5},{-11,5}},
                                                       color={0,0,127}));
  connect(preQCooLoa_flow.y, ideCon.QCooLoa_flow)
    annotation (Line(points={{-39,90},{-20,90},{-20,9},{-11,9}},
                                                       color={0,0,127}));
