...
model Discharging3 "Validation against discharging experiment 3"
  extends Buildings.Fluid.Storage.Ice.Validation.BaseClasses.PartialExample(
    fileName=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/Data/Fluid/IceStorage/Validation/Experiment/discharging3.txt"),
    mod(k=Integer(Buildings.Fluid.Storage.Ice.Types.IceThermalStorageMode.Discharging)),
    mIce_max=2846.35,
  ...
  annotation (
    ...
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Storage/Ice/Validation/Experiment/Discharging3.mos"
        "Simulate and Plot"),
