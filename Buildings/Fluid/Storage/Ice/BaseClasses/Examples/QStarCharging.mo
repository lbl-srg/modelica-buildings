...
model QStarCharging "Example to calculate QStarCharging"
  ...
  Buildings.Fluid.Storage.Ice.BaseClasses.QStarCharging qSta(coeff=coeCha, dt=dt)
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  Controls.OBC.CDL.Logical.Sources.Constant active(k=true)
    "Outputs true to activate the component"
    annotation (Placement(transformation(extent={{-60,30},{-40,50}})));
equation
  connect(fra.y, qSta.fraCha) annotation (Line(points={{-39,4},{-12,4}},
                    color={0,0,127}));
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
    ...
    __Dymola_Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/Fluid/Storage/Ice/BaseClasses/Examples/QStarCharging.mos"
        "Simulate and Plot"),
    Documentation(info="<html>
<p>
This example is to validate the
<a href=\"modelica://Buildings.Fluid.Storage.Ice.BaseClasses.QStarCharging\">
Buildings.Fluid.Storage.Ice.BaseClasses.QStarCharging</a>.
</p>
</html>", revisions="<html>
  <ul>
  <li>
