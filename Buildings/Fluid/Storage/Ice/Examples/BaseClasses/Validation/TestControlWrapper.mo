...
model TestControlWrapper "Example model to test control modes"
  ...
  ModeWrapper modeWrapper
    annotation (Placement(transformation(extent={{-38,-48},{10,2}})));
  Modelica.Blocks.Sources.IntegerConstant integerConstant3(k=Integer(Buildings.Fluid.Storage.Ice.Examples.BaseClasses.OperationModes.HighPower))
...
equation
  connect(sine.y, controlHighPowerMode.SOC) annotation (Line(points={{-79,-70},
          {-48,-70},{-48,-82},{38,-82}},       color={0,0,127}));
  connect(sine.y, controlLowPowerMode.SOC) annotation (Line(points={{-79,-70},{
          -48,-70},{-48,-66},{24,-66},{24,-4},{38,-4},{38,-12}},     color={0,0,
          127}));
  ...
  connect(intSwi1.y, modeWrapper.demLev) annotation (Line(points={{14,70},{14,
          16},{-42,16},{-42,-2},{-40,-2}}, color={255,127,0}));
  connect(modeWrapper.SOC, controlLowPowerMode.SOC) annotation (Line(points={{
          -40,-40},{-42,-40},{-42,-66},{24,-66},{24,-4},{38,-4},{38,-12}},
        color={0,0,127}));
  connect(integerConstant3.y, modeWrapper.powMod) annotation (Line(points={{-55,
          -14},{-55,-16},{-40,-16}}, color={255,127,0}));
  annotation (
    experiment(
      StartTime=0,
      StopTime=86400,
