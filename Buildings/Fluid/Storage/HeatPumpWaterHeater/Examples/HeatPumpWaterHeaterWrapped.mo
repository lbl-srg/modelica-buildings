...
equation
  ...
  connect(heaPumWatHeaWra.port_b1, sinAir.ports[1])
    annotation (Line(points={{10,8},{16,8},{16,60},{30,60}},color={0,127,255}));

  connect(TBCSid.port, heaPumWatHeaWra.heaPorSid)
    annotation (Line(points={{-28,-42},{6,-42},{6,2}},color={191,0,0}));

  connect(TBCTop.port, heaPumWatHeaWra.heaPorTop)
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
    ...
    "Resources/Scripts/Dymola/Fluid/Storage/HeatPumpWaterHeater/Examples/HeatPumpWaterHeaterWrapped.mos"
     "Simulate and Plot"),
