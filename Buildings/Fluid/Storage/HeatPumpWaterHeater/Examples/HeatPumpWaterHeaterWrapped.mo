...
equation
  ...
  connect(TEvaIn.y, souAir.T_in) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(heaPumWatHeaWra.port_b1, sinAir.ports[1]) annotation (Line(points={{10,8},{
  ...
  connect(heaPumWatHeaWra.TWat, onOffHea.u) annotation (Line(points={{11,1},{16,
  ...
  connect(heaPumWatHeaWra.port_a1, souAir.ports[1]) annotation (Line(points={{-10,8},
