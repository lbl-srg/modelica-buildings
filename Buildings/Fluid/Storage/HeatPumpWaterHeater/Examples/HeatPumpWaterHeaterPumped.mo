...
model HeatPumpWaterHeaterPumped "Test model for pumped tank"
  ...
  table=[0,310000; 1800,310000; 1800,305000;7200,305000; 7200,310000; 10800,310000; 10800,310000])
  ...
  Modelica.Blocks.Logical.Hysteresis onOffHea(
    uLow=273.15 + 43.89 - 3.89, uHigh=273.15 + 43.89)
    "On/off controller for heat pump water heater"
...
equation
  ...
  connect(sine.y, TBCSid.T)
      annotation (Line(points={{-53,-60},{-47.5,-60},{-47.5,-42},{-41.2,-42}}, color={0,0,127}));
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)),
    ...
    <p>
    This model tests a pumped heat pump water heater. An on-off controller keeps the tank temperature in the range of 40-43.89 degC.</p>
</html>", revisions="<html>
