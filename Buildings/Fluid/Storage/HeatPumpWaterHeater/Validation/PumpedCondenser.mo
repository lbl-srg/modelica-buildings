...
model PumpedCondenser
  ...
  Buildings.Fluid.Storage.HeatPumpWaterHeater.PumpedCondenser heaPumWatHeaPum(
    ...
    datHPWH(
      ...
      datCoi=datCoi,
      redeclare
        Buildings.Fluid.Storage.HeatPumpWaterHeater.Validation.Data.Pump datPum),
...
equation
  ...
  connect(preTemSid.port, heaPumWatHeaPum.heaPorSid)
    annotation (Line(points={{-30,-60},{6,-60},{6,0}}, color={191,0,0}));

  connect(preTemTop.port, heaPumWatHeaPum.heaPorTop) annotation (Line(points={{-30,
          -90},{-6,-90},{-6,20},{0,20},{0,8}}, color={191,0,0}));
  ...
  connect(datRea.y[8], toTotAirIn.XiDry)
      annotation (Line(points={{-109,80},{-100,80},{-100,30},{-91,30}},
                                                                    color={0,0,127}));
  ...
  connect(preTemBot.port, heaPumWatHeaPum.heaPorBot)
    annotation (Line(points={{-30,-120},{0,-120},{0,-8}}, color={191,0,0}));
  ...
  connect(TWat_K.Celsius, datRea.y[2])
    annotation (Line(points={{152,-30.4},{158,-30.4},{158,80},{-109,80}},color={0,0,127}));

  connect(boundary.m_flow_in, datRea.y[3])
    annotation (Line(points={{112,-22},{120,-22},{120,80},{-109,80}},
                                                                 color={0,0,127}));
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Fluid/Storage/HeatPumpWaterHeater/Validation/PumpedCondenser.mos"
        "Simulate and Plot"),
