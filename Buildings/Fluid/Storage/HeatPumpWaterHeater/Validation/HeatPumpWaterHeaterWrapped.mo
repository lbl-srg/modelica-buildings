...
equation
  ...
  connect(TBCBot.port, heaPumWatHeaWra.heaPorBot)
    annotation (Line(points={{-36,-88},{-4,-88},{-4,-6},{10,-6}},color={191,0,0}));

  connect(datRea.y[3], boundary.m_flow_in)
    annotation (Line(points={{-89,70},{110,70},{110,4},{102,4}},color={0,0,127}));
  ...
  connect(TOut_K.Kelvin, TBCBot.T)
    annotation (Line(points={{-57,-70.2},{-58,-70.2},{-58,-70},{-54,-70},{-54,-88},{-49.2,-88}}, color={0,0,127}));
