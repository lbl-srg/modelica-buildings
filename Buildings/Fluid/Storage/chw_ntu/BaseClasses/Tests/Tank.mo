within Buildings.Fluid.Storage.chw_ntu.BaseClasses.Tests;
model Tank
  extends Modelica.Icons.Example;
  Buildings.Fluid.Storage.chw_ntu.BaseClasses.Tank tank(redeclare
      Buildings.Fluid.Storage.chw_ntu.Data.Tank.Experiment per)
