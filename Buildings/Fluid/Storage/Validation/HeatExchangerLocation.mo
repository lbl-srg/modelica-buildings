...
equation
  connect(mHex_flow1.ports[1], tan_aTop.portHex_a)
    annotation (Line(points={{-20,19},{-20,20.2},{42,20.2}},color={0,127,255}));
  ...
  connect(senTan_aTop.port_b, sin.ports[1])
    annotation (Line(points={{-10,-20},{-40,-20},{-40,-23}}, color={0,127,255}));

  connect(senTan_bTop.port_b, sin.ports[2])
    annotation (Line(points={{-10,-70},{-20,-70},{-20,-21},{-40,-21}}, color={0,127,255}));
  ...
  connect(tan_bTop.portHex_a, mHex_flow1.ports[2])
    annotation (Line(points={{40,-51.8},{30,-51.8},{30,21},{-20,21}}, color={0,127,255}));

  connect(tan_aTop.port_a, watInTan.ports[1])
    annotation (Line(points={{52,34},{38,34},{38,59},{-40,59}}, color={0,127,255}));

  connect(tan_bTop.port_a, watInTan.ports[2])
    annotation (Line(points={{50,-38},{50,-38},{34,-38},{34,61},{-40,61}}, color={0,127,255}));

  connect(mWatTanDyn_flow.ports[1], tan_aTop.port_b)
    annotation (Line(points={{74,24},{64,24},{64,14},{52,14}},color={0,127,255}));

  connect(tan_bTop.port_b, mWatTanSte_flow.ports[1])
    annotation (Line(points={{50,-58},{62,-58},{62,-48},{72,-48}},color={0,127,255}));
