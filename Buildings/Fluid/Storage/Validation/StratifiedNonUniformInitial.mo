...
equation
  connect(HIn_flow.port_b, cooTan.port_a)
    annotation (Line(points={{-42,-50},{-32,-50},{-32,-40},{-20,-40}},color={0,127,255},smooth=Smooth.None));

  connect(cooTan.port_b, HOut_flow.port_a)
    annotation (Line(points={{-20,-60},{-10,-60},{-10,-50},{2,-50}},color={0,127,255},smooth=Smooth.None));
  ...
  connect(HInEnh_flow.port_b, heaTan.port_a)
    annotation (Line(points={{-44,20},{-32,20},{-32,30},{-20,30}},color={0,127,255}));

  connect(heaTan.port_b, HOutEnh_flow.port_a)
    annotation (Line(points={{-20,10},{-10,10},{-10,20},{2,20}},color={0,127,255}));

  connect(sou_1.ports[1], HInEnh_flow.port_a)
    annotation (Line(points={{-80,-11},{-70,-11},{-70,20},{-60,20}},color={0,127,255}));

  connect(sou_1.ports[2], HIn_flow.port_a)
    annotation (Line(points={{-80,-9},{-70,-9},{-70,-50},{-58,-50}},  color={0,127,255}));
