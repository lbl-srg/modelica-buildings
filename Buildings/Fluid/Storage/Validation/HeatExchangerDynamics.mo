...
equation
  ...
  connect(watInTan.ports[1], tanSte.port_a)
    annotation (Line(points={{-40,59},{-40,59},{-22,59},{-22,0},{42,0}},  color={0,127,255}));
  ...
  connect(watInTan.ports[2], tanDyn.port_a)
    annotation (Line(points={{-40,61},{-30,61},{-20,61},{-20,40},{42,40}},color={0,127,255}));
  ...
  connect(senTanDyn.port_b, sin.ports[1])
    annotation (Line(points={{-10,10},{-20,10},{-20,-39},{-42,-39}},color={0,127,255}));

  connect(senTanSte.port_b, sin.ports[2])
    annotation (Line(points={{-10,-40},{-42,-40},{-42,-37}},color={0,127,255}));
