within Buildings.Fluid.Storage.Ice_nturef.Validation.ExperimentNIST;
model Charging "Validation against charging experiment"
  extends Buildings.Fluid.Storage.Ice_nturef.Validation.ExperimentNIST.BaseClasses.PartialChargingDischarging
                                                                                                      (fileName=
