within Buildings.Fluid.Storage.Ice_nturef.Validation.ExperimentNIST.BaseClasses;
partial model PartialChargingDischarging "Base example"
  ...
  parameter Modelica.Units.SI.PressureDifference dp_nominal=100000
    "Pressure difference";
  parameter Buildings.Fluid.Storage.Ice_nturef.Data.Tank.Generic per(
    mIce_max=2846.35,
  ...
  Buildings.Fluid.Storage.Ice_nturef.ControlledTank iceTan(
