within Buildings.Fluid.Storage.Ice_nturef;
...
protected
  Buildings.Fluid.Storage.Ice_nturef.BaseClasses.Tank tanHeaTra(
    final SOC_start=SOC_start,
    final per=per,
    final cp=cp) "Model for tank heat transfer between working fluid and ice"
