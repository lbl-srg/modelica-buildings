...
model Tank "Block to compute the tank heat transfer"
  ...
  replaceable parameter Buildings.Fluid.Storage.Ice_nturef.Data.Tank.Generic per
  ...
  Buildings.Fluid.Storage.Ice_nturef.BaseClasses.StateOfCharge SOCCalc(final
...
protected
  ...
  Buildings.Fluid.Storage.Ice_nturef.BaseClasses.NormalizedHeatFlowRate norQSta(
  ...
  Buildings.Fluid.Storage.Ice_nturef.BaseClasses.LMTDStar lmtdSta(final TFre=
        per.TFre, final dT_nominal=per.dT_nominal)
