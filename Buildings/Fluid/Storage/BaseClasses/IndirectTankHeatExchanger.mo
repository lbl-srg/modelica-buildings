...
equation
  ...
  connect(vol[1].ports[1],senMasFlo.port_b)
    annotation (Line(points={{-23,-40},{-23,-50},{-60,-50}},color={0,127,255},smooth=Smooth.None));
  ...
  connect(temSenHex.T, hAPipIns.T)
    annotation (Line(points={{-9,-70},{0,-70},{0,-76},{9,-76}},color={0,0,127},smooth=Smooth.None));
  ...
  connect(temSenSur.T, hANatCyl.TSur)
    annotation (Line(points={{20,53},{20,70},{-40,70},{-40,114},{-2,114}},color={0,0,127},smooth=Smooth.None));

  connect(hANatCyl.TFlu, temSenWat.T)
   annotation (Line(points={{-2,106},{-36,106},{-36,76},{68,76},{68,51}},color={0,0,127},smooth=Smooth.None));
  ...
  connect(vol[nSeg].ports[2], res.port_a)
    annotation (Line(points={{-21,-40},{-21,-50},{46,-50}},color={0,127,255},smooth=Smooth.None));
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-150},{100,150}}), graphics), Icon(coordinateSystem(
   preserveAspectRatio=false, extent={{-100,-150},{100,150}}), graphics={
        Rectangle(extent={{-70,64},{70,-96}},lineColor={0,0,255},pattern=LinePattern.None,fillColor={95,95,95},
          fillPattern=FillPattern.Solid),
        Rectangle(extent={{-100,5},{101,-5}},lineColor={0,0,255},pattern=LinePattern.None,fillColor={0,0,255},
          fillPattern=FillPattern.Solid),
        Rectangle(extent={{-70,-12},{70,-18}},lineColor={0,0,255},pattern=LinePattern.None,fillColor={0,0,0},
          fillPattern=FillPattern.Solid),
        Rectangle(extent={{-40,64},{-36,-96}},lineColor={0,0,255},pattern=LinePattern.None,fillColor={0,0,0},
          fillPattern=FillPattern.Solid),
        Rectangle(extent={{-2,64},{2,-96}},lineColor={0,0,255},pattern=LinePattern.None,fillColor={0,0,0},
          fillPattern=FillPattern.Solid),
        Rectangle(extent={{36,64},{40,-96}},lineColor={0,0,255},pattern=LinePattern.None,fillColor={0,0,0},
          fillPattern=FillPattern.Solid)}),
