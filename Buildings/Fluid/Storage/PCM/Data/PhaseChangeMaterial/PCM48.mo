...
record PCM48 "Properties for 48 C phase change material"
  parameter Modelica.Units.SI.Temperature TSol=273.15 + 47
    "Solidus temperature, used only for warm PCM."
    annotation (Dialog(group="Material Properties"));
  parameter Modelica.Units.SI.Temperature TLiq=273.15 + 49
    "Liquidus temperature, used only for warm PCM"
    annotation (Dialog(group="Material Properties"));
  parameter Modelica.Units.SI.SpecificEnthalpy LHea=0.8*226000
  ...
  parameter Modelica.Units.SI.SpecificHeatCapacity cPCM=3150
    ...
    annotation (Dialog(group="Material Properties"));
  parameter Modelica.Units.SI.Density dPCM=1360
