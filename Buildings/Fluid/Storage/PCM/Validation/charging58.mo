...
parameter Modelica.Units.SI.Temperature pcm_Tstart = 311.05;
  ...
  Modelica.Blocks.Sources.CombiTimeTable HPCdata(
    ...
    tableName="tab1",
    fileName=
        "C:/git/ccc-hp-plus-tes/validation_scripts/meas_58c/all-runs/58_single_3lpm_12C_65C_Run2_all.txt",
    columns={2,4,7},
    timeScale=60)
  ...
  CoilRegisterFourPort pcmFourPort(
    redeclare Buildings.Fluid.Storage.PCM.Data.PhaseChangeMaterial.PCM11
      Material,
