...
model partialUnitCellPhaseChangeTwoCircuit
  ...
  replaceable parameter Buildings.HeatTransfer.Data.SolidsPCM.Generic PCM(x=Design.sfin, k=Material.k, c=Material.c, d=Material.d, LHea=Material.LHea, TSol=Material.TSol, TLiq=Material.TLiq) "Storage material record" annotation (Placement(transformation(extent={{60,80},{80,100}})));
