within Buildings.Fluid.Storage.Ice_ntu_ini.Validation.ExperimentNIST;
model Discharging2 "Validation against discharging experiment 2"
  extends Buildings.Fluid.Storage.Ice_ntu_ini.Validation.ExperimentNIST.BaseClasses.PartialChargingDischarging
                                                                                                      (
