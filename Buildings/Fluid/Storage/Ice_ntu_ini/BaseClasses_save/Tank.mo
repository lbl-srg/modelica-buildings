...
model Tank "Block to compute the tank heat transfer"
  ...
  Buildings.Fluid.Storage.Ice_ntu_ini.BaseClasses_save.StateOfCharge SOCCalc(final
...
protected
  ...
  Buildings.Fluid.Storage.Ice_ntu_ini.BaseClasses_save.LMTDStar lmtdSta(final
