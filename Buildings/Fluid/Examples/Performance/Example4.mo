...
model Example4
  ...
  Modelica.SIunits.MassFlowRate m_condens=min(
    0,
    -vol.ports[1].m_flow*(bou.X[1]-xSat.X[1]))
...
Submitted: 11th Modelica Conference. Paris, France. Sep. 2015.
    ...
    experiment(
      ...
      StopTime=20),
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Fluid/Examples/Performance/Example4.mos" "Simulate and plot"));
end Example4;
