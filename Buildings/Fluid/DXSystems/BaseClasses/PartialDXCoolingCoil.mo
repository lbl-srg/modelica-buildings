...
partial model PartialDXCoolingCoil
  ...
  extends Buildings.Fluid.DXSystems.BaseClasses.PartialDXCoil(
    redeclare Buildings.Fluid.DXSystems.BaseClasses.DXCooling
  ...
  Buildings.Fluid.DXSystems.BaseClasses.Evaporation watVapEva(
...
protected
  Buildings.Fluid.DXSystems.BaseClasses.InputPower pwr
