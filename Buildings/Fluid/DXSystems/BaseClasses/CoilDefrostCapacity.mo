...
block CoilDefrostCapacity
  ...
  parameter Buildings.Fluid.DXSystems.BaseClasses.Types.DefrostTimeMethods defTri=
    Buildings.Fluid.DXSystems.BaseClasses.Types.DefrostTimeMethods.timed
    "Type of method to trigger the defrost cycle";

  parameter Buildings.Fluid.DXSystems.BaseClasses.Types.DefrostOperation defOpe=
    Buildings.Fluid.DXSystems.BaseClasses.Types.DefrostOperation.resistive
...
equation
  ...
  if defOpe == Buildings.Fluid.DXSystems.BaseClasses.Types.DefrostOperation.resistive then
    QDef_flow = 0;
...
calculated by <a href=\"modelica://Buildings.Fluid.DXSystems.BaseClasses.CoilDefrostTimeCalculations\">
Buildings.Fluid.DXSystems.BaseClasses.CoilDefrostTimeCalculations</a>.
</li>
<li>
