...
model PartialWaterCooledDXCoil "Base class for water source DX coils"
  ...
  // Components
  replaceable Buildings.Fluid.DXSystems.BaseClasses.PartialDXCoolingCoil eva
    constrainedby
    Buildings.Fluid.DXSystems.BaseClasses.PartialDXCoolingCoil(
      ...
      dxCoi(
      redeclare final Buildings.Fluid.DXSystems.Cooling.WaterSource.Data.Generic.Coil datCoi=datCoi,
      wetCoi(redeclare final Buildings.Fluid.DXSystems.BaseClasses.CoolingCapacityWaterCooled coiCap,
        redeclare final Buildings.Fluid.DXSystems.Cooling.WaterSource.Data.Generic.Coil datCoi=datCoi,
        appDewPt(
          redeclare final Buildings.Fluid.DXSystems.Cooling.WaterSource.Data.Generic.Coil datCoi=datCoi,
          uacp(redeclare final Buildings.Fluid.DXSystems.Cooling.WaterSource.Data.Generic.BaseClasses.NominalValues per))),
      dryCoi(
        redeclare final Buildings.Fluid.DXSystems.BaseClasses.CoolingCapacityWaterCooled coiCap,
        redeclare final Buildings.Fluid.DXSystems.Cooling.WaterSource.Data.Generic.Coil datCoi=datCoi)),
