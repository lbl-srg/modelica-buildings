...
model ApparatusDewPoint "Test model for ApparatusDewPoint"
  ...
  Buildings.Fluid.DXSystems.BaseClasses.ApparatusDewPoint adp(
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/DXSystems/BaseClasses/Examples/ApparatusDewPoint.mos"
        "Simulate and plot"),
...
Buildings.Fluid.DXSystems.BaseClasses.ApparatusDewPoint</a>.
</p>
</html>",
revisions="<html>
<ul>
