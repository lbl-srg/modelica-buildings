...
model CoolingCapacityWaterCooled "Test model for CoolingCapacityWaterCooled"
  ...
  Buildings.Fluid.DXSystems.BaseClasses.CoolingCapacityWaterCooled
    cooCap(sta={sta},
  ...
  perCur=Buildings.Fluid.DXSystems.BaseClasses.Examples.PerformanceCurves.Curve_I_WaterCooled(),
...
__Dymola_Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/Fluid/DXSystems/BaseClasses/Examples/CoolingCapacityWaterCooled.mos"
        "Simulate and plot"),
