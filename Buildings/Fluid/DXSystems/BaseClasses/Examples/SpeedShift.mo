...
model SpeedShift "Test model for SpeedShift block"
 ...
 parameter Integer nSta=4 "Number of standard compressor speeds";
  Buildings.Fluid.DXSystems.BaseClasses.SpeedShift speShi(nSta=nSta, speSet=
        datCoi.sta.spe,
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/DXSystems/BaseClasses/Examples/SpeedShift.mos"
        "Simulate and plot"),
          Documentation(info="<html>
<p>
This example illustrates working of SpeedShift block
<a href=\"modelica://Buildings.Fluid.DXSystems.BaseClasses.SpeedShift\">
Buildings.Fluid.DXSystems.BaseClasses.SpeedShift</a>.
</p>
</html>",
revisions="<html>
<ul>
