...
model EvaporationPulse "Test model for evaporation with pulse signal"
  ...
  DXSystems.BaseClasses.Evaporation evaSho(redeclare package Medium = Medium, nomVal=nomVal)
    "Evaporation model"
  ...
  DXSystems.BaseClasses.Evaporation evaNor(redeclare package Medium = Medium, nomVal=nomVal)
    "Evaporation model"
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/DXSystems/BaseClasses/Examples/EvaporationPulse.mos"
        "Simulate and plot"),
