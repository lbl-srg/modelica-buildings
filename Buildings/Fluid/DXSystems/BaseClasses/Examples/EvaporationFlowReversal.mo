...
model EvaporationFlowReversal
  ...
  DXSystems.BaseClasses.Evaporation eva(redeclare package Medium = Medium, nomVal=nomVal,
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/DXSystems/BaseClasses/Examples/EvaporationFlowReversal.mos"
        "Simulate and plot"),
