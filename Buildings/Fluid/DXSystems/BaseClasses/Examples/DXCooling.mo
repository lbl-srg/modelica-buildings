...
model DXCooling "Test model for DXCooling"
  ...
  Buildings.Fluid.DXSystems.BaseClasses.DXCooling dxCoo(
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/DXSystems/BaseClasses/Examples/DXCooling.mos"
        "Simulate and plot"),
