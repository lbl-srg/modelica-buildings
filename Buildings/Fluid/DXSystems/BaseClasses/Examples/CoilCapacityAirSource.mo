...
model CoilCapacityAirSource "Test model for CoilCapacityAirSource"
  ...
  parameter Buildings.Fluid.DXSystems.Cooling.AirSource.Data.Generic.BaseClasses.Stage sta(
   ...
   perCur = Buildings.Fluid.DXSystems.BaseClasses.Examples.PerformanceCurves.Curve_III_AirCooled(),
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/DXSystems/BaseClasses/Examples/CoilCapacityAirSource.mos"
        "Simulate and plot"),
...
to <a href=\"modelica://Buildings.Fluid.DXSystems.BaseClasses.CoilCapacityAirSource\">
Buildings.Fluid.DXSystems.BaseClasses.CoilCapacityAirSource</a>.
</li>
<li>
