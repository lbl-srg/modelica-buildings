...
block CoolingCapacityWaterCooled
  ...
  extends
    Buildings.Fluid.DXSystems.BaseClasses.PartialCoilCapacity(
...
initial algorithm
  // Verify correctness of performance curves, and write warning if error is bigger than 10%
   for iSta in 1:nSta loop
     ...
     Buildings.Fluid.DXSystems.BaseClasses.Functions.warnIfPerformanceOutOfBounds(
...
<p>
  ...
  See <a href=\"modelica://Buildings.Fluid.DXSystems.BaseClasses.PartialCoilCapacity\">
  Buildings.Fluid.DXSystems.BaseClasses.PartialCoilCapacity</a> for more information.
</p>
</html>",
revisions="<html>
<ul>
...
<a href=\"modelica://Buildings.Fluid.DXSystems.BaseClasses.PartialCoilCapacity\">
Buildings.Fluid.DXSystems.BaseClasses.PartialCoilCapacity</a>.
</li>
<li>
