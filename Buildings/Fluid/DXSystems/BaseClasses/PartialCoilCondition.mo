...
partial block PartialCoilCondition
  ...
  extends
    Buildings.Fluid.DXSystems.BaseClasses.PartialCoilInterface;

  constant Boolean variableSpeedCoil
    "Flag, set to true for coil with variable speed";

  replaceable
    Buildings.Fluid.DXSystems.BaseClasses.CoilCapacityAirSource coiCap
    constrainedby
...
protected
  DXSystems.BaseClasses.SpeedShift speShiEIR(
  ...
  DXSystems.BaseClasses.SpeedShift speShiQ_flow(
    final variableSpeedCoil=variableSpeedCoil,
    final nSta=nSta,
