...
partial block PartialSurfaceCondition
  ...
  output Modelica.Units.SI.AngularVelocity spe(displayUnit="1/min")
    "Rotational speed";
  Buildings.Fluid.DXSystems.BaseClasses.UACp uacp[nSta](
  ...
  if variableSpeedCoil or stage <> 0 then
    ...
    UAcp = if variableSpeedCoil
      then Buildings.Utilities.Math.Functions.smoothMax(
        x1=Buildings.Fluid.DXSystems.BaseClasses.Functions.speedShift(
             spe=spe,
...
<a href=\"modelica://Buildings.Fluid.DXSystems.BaseClasses.ApparatusDewPoint\">
Buildings.Fluid.DXSystems.BaseClasses.ApparatusDewPoint</a> and
...
<a href=\"modelica://Buildings.Fluid.DXSystems.BaseClasses.Functions.speedShift\">
Buildings.Fluid.DXSystems.BaseClasses.Functions.speedShift</a>
