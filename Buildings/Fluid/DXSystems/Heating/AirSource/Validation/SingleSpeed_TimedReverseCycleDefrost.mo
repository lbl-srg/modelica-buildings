...
model SingleSpeed_TimedReverseCycleDefrost
  ...
  extends
    ...
    datRea(
      final fileName=ModelicaServices.ExternalReferences.loadResource("modelica://Buildings/Resources/Data/Fluid/DXSystems/Heating/AirSource/Validation/SingleSpeedHeating_TimedReverseCycleDefrost/DXCoilSystemAuto.dat")),
    datCoi(
