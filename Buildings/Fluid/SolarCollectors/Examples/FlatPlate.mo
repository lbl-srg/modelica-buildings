...
model FlatPlate "Test model for FlatPlate"
  ...
  Sources.MassFlowSource_T            sou(
    ...
    T=273.15 + 10,
    nPorts=1,
    use_m_flow_in=true) "Inlet for water flow"
  ...
  Modelica.Blocks.Sources.Sine sine(
    freqHz=3/86400,
    amplitude=-solCol.m_flow_nominal,
    offset=0)
    annotation (Placement(transformation(extent={{-100,-20},{-80,0}})));
equation
  ...
  connect(sine.y, sou.m_flow_in) annotation (Line(points={{-79,-10},{-70,-10},{
          -70,-18},{-60,-18}}, color={0,0,127}));
  annotation (
