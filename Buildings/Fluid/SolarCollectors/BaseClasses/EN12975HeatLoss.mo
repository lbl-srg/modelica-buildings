...
initial equation
   ...
   G_nominal * y_intercept * A_c/nSeg - UA/nSeg * (dT_nominal)
     = m_flow_nominal * Cp[1] * (dT_nominal_fluid[1]);
   ...
   for i in 2:nSeg-1 loop
     ...
     +dT_nominal)= m_flow_nominal * Cp[i] * (dT_nominal_fluid[i]-
...
<p>
This component computes the heat loss from the flat plate solar collector 
