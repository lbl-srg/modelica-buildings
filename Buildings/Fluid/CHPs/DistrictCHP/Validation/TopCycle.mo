...
model TopCycle "Model validation for the topping cycle subsystem"
  ...
  Buildings.Fluid.CHPs.DistrictCHP.TopCycle topCycTab60(final per=per)
  ...
  Buildings.Fluid.CHPs.DistrictCHP.TopCycle topCycTab70(final per=per)
  ...
  Buildings.Fluid.CHPs.DistrictCHP.TopCycle topCycTab80(final per=per)
  ...
  Buildings.Fluid.CHPs.DistrictCHP.TopCycle topCycTab90(final per=per)
  ...
  Buildings.Fluid.CHPs.DistrictCHP.TopCycle topCycTab100(final per=per)
...
<p>
This validation model tests the performance of the topping cycle subsystem model in
the combined Heat and Power (CHP) system using the model
<a href=\"modelica://Buildings.Fluid.CHPs.DistrictCHP.TopCycle\">
Buildings.Fluid.CHPs.DistrictCHP.TopCycle</a>
at gas turbine load factors of 0.6, 0.7, 0.8, 0.9, and 1.0, with ambient air temperature
changes from 5°C to 35°C.
</p>
<p>
...
experiment(
  StopTime=3600,
  Tolerance=1E-6),
__Dymola_Commands(file ="modelica://Buildings/Resources/Scripts/Dymola/Fluid/CHPs/DistrictCHP/Validation/TopCycle.mos"
  "Simulate and plot"));
end TopCycle;
