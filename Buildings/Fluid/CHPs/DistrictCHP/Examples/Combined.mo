...
equation
  connect(comCyc.port_b, bou.ports[1]) annotation (Line(points={{20,0},{40,0},{
          40,-50},{60,-50}}, color={0,127,255}));
  connect(LoadProfile.y[1], comCyc.y) annotation (Line(points={{-59,70},{-40,70},
          {-40,16},{-24,16}}, color={0,0,127}));
  connect(AmbientTemperature.y[1], comCyc.TAmb)
    annotation (Line(points={{-59,8},{-24,8}}, color={0,0,127}));
  connect(comCyc.PEle, GTG_Ele.u) annotation (Line(points={{24,18},{40,18},{40,
          70},{58,70}}, color={0,0,127}));
  connect(comCyc.PEle_ST, STG_Ele.u) annotation (Line(points={{24,6},{52,6},{52,
          -10},{58,-10}}, color={0,0,127}));
  connect(comCyc.mFue, mFuel.u) annotation (Line(points={{24,12},{52,12},{52,30},
          {58,30}}, color={0,0,127}));
  connect(comCyc.port_a, sou.ports[1]) annotation (Line(points={{-20,0},{-40,0},
          {-40,-50},{-60,-50}}, color={0,127,255}));
  annotation (
    Icon(
