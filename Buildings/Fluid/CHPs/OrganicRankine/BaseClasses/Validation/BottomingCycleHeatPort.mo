...
model BottomingCycleHeatPort "Example ORC model"
...
annotation(experiment(StopTime=100, Tolerance=1e-6),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/CHPs/OrganicRankine/BaseClasses/Validation/BottomingCycleHeatPort.mos"
  "Simulate and plot"),
  Documentation(info="<html>
<p>
This model demonstrates the use of
<a href=\"modelica://Buildings.Fluid.CHPs.OrganicRankine.BaseClasses.BottomingCycleHeatPort\">
