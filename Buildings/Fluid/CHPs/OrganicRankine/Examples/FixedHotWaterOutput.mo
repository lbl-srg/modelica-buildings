...
model FixedHotWaterOutput
  ...
  Buildings.Controls.OBC.CDL.Reals.MultiplyByParameter gai(k=mCon_flow_nominal)
  ...
  Modelica.Blocks.Sources.Constant mCon_flow_min(k=mCon_flow_nominal*0.2)
...
equation
  ...
  connect(gai.y, max1.u2) annotation (Line(points={{22,-70},{30,-70},{30,-66},{38,
          -66}}, color={0,0,127}));
  connect(max1.y, souCon.m_flow_in) annotation (Line(points={{62,-60},{70,-60},{
          70,-22},{42,-22}}, color={0,0,127}));
  connect(TWatOut_set.y, conPID.u_s)
    annotation (Line(points={{-59,-70},{-42,-70}}, color={0,0,127}));
  connect(TConOut.T, conPID.u_m) annotation (Line(points={{-40,-19},{-40,-14},{-88,
          -14},{-88,-92},{-30,-92},{-30,-82}}, color={0,0,127}));
  connect(mCon_flow_min.y, max1.u1) annotation (Line(points={{9,-40},{16,-40},{16,
