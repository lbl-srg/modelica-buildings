...
equation
  connect(PStaBy.y, switch.u1) annotation (Line(points={{-49,62},{-30,62},{-30,
          38},{-22,38}},
                     color={0,0,127}));
  ...
  connect(const.y, switch1.u3)
    annotation (Line(points={{41,-30},{48,-30},{48,-8},{58,-8}},
                                                             color={0,0,127}));
  connect(PCooDow.y, switch.u3) annotation (Line(points={{-49,2},{-36,2},{-36,
