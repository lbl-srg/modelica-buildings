...
model WarmUpEngTem "Validate model WarmUp if warm-up by engine temperature"
  ...
  Buildings.Fluid.CHPs.BaseClasses.WarmUp warUp(
    final per=per) "Warm-up mode"
...
equation
  ...
  connect(runSig.y, notRun.u) annotation (Line(points={{-59,-80},{18,-80}},
          color={255,0,255}));
  connect(runSig.y, transition1.condition) annotation (Line(points={{-59,-80},{0,
          -80},{0,10},{-40,10},{-40,18}}, color={255,0,255}));
