...
equation
  ...
  connect(timer.passed,transition2.condition)
    annotation (Line(points={{22,2},{40,2},{40,30},{20,30},{20,38}},color={255,0,255}));
  annotation (
    experiment(
      StopTime=900,
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/CHPs/BaseClasses/Validation/CoolDown.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
