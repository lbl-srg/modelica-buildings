...
record Default =
  Buildings.Fluid.Dehumidifiers.Desiccant.Data.Generic (
    ...
    TProLeaCoe =          {-38.7782841989449, 2.0127655837628,
    ...
    X_w_ProLeaCoe =       {0.0148880824323806,-0.000283393198398211,
     ...
     vRegCoe =            {-4.67358908091488, 0.0654323095468338,
     ...
     QReg_flowCoe =       {-27794046.6291107, -235725.171759615,
...
This data corresponds to the default operation curves for the EnergyPlus object, 
