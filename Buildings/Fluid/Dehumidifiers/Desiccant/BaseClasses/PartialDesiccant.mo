...
equation
  ...
  connect(dehPer.X_w_ProLea, outCon.X_wSet)
    annotation (Line(points={{-37,-80},{-14,-80},
    {-14,-96},{-7,-96}}, color={0,0,127}));
  connect(VPro_flow.y, dehPer.VPro_flow)
    annotation (Line(points={{-89,-96},{-78,-96},
   {-78,-92.2},{-59,-92.2}}, color={0,0,127}));
  ...
  connect(outCon.mWat_flow, gai1.u)
    annotation (Line(points={{15,-96},{18,-96},{18,-92},
   {20,-92},{20,10},{2,10}}, color={0,0,127}));
  connect(gai1.y, vol.mWat_flow)
    annotation (Line(points={{-21,10},{-40,10},{-40,20},
    {-130,20},{-130,48},{-107,48}},color={0,0,127}));
  connect(preHeaFlo.Q_flow, gai2.y)
    annotation (Line(points={{-62,40},{-21,40}}, color={0,0,127}));
  connect(preHeaFlo.port, vol.heatPort)
    annotation (Line(points={{-82,40},{-120,40},
    {-120,56},{-105,56}}, color={191,0,0}));
  connect(gai2.u,outCon. Q_flow)
    annotation (Line(points={{2,40},{40,40},{40,-92},
    {15,-92}}, color={0,0,127}));
  connect(vol.ports[1], port_b2)
    annotation (Line(points={{-95,66},{-144,66},{-144,80},{-240,80}},
    color={0,127,255}));
  connect(mPro_flow.y, dehPer.mPro_flow)
    annotation (Line(points={{-89,-114},{-48,-114},
   {-48,-95}}, color={0,0,127}));
