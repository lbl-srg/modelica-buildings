...
equation
  ...
  connect(conDeh.y, deh.uSpe) annotation (Line(points={{-99,-80},{-92,-80},{-92,
          -42},{-106,-42},{-106,-8},{-102,-8}}, color={0,0,127}));
