...
model PlugFlowCore
  ...
  parameter Real R=1/(kIns*2*Modelica.Constants.pi/Modelica.Math.log(
    (dh/2+dIns)/(dh/2)))
...
equation
  ...
  annotation (
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Fluid/FixedResistances/BaseClasses/Validation/PlugFlowCore.mos" "Simulate and Plot"),
    experiment(
      StopTime=1000,
      Tolerance=1e-006),
    Documentation(
