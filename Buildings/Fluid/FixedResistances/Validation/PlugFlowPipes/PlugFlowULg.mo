...
model PlugFlowULg
  ...
  replaceable Data.PipeDataULg151202 pipeDataULg
    constrainedby Data.BaseClasses.PipeDataULg
  ...
  PlugFlowPipe pipe(
    ...
    R=((1/(2*pipe.kIns)*log(
      (0.0603/2+pipe.dIns)/(0.0603/2)))+1/(5*(0.0603+2*pipe.dIns)))/Modelica.Constants.pi,
    nPorts=1,
    initDelay=true,
...
<li>Januar 26, 2016 by Carles Ribas:<br/>First implementation.
    ...
    experiment(
      ...
      Tolerance=1e-006),
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PlugFlowPipes/PlugFlowULg.mos" "Simulate and plot"),
    Diagram(
      coordinateSystem(
