...
model MSLAIT2Nodes
  ...
  parameter Real R(
    unit="(m.K)/W")=1/(2*kIns*Modelica.Constants.pi)*log(
    0.18/0.0899)+1/(2*2.4*Modelica.Constants.pi)*log(
    2/0.18)
    "Thermal resistance per unit length of main pipes";
  parameter Real R80(
    unit="(m.K)/W")=1/(2*0.024*Modelica.Constants.pi)*log(
    0.07/0.0337)+1/(2*2.4*Modelica.Constants.pi)*log(
    2/0.07)
...
equation
  ...
  annotation (
    ...
    experiment(
      ...
      Tolerance=1e-006),
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PlugFlowPipes/MSLAIT2Nodes.mos" "Simulate and plot"),
    Documentation(
      info="<html>
