...
model MSLAIT
  ...
  parameter Modelica.SIunits.ThermalResistance R=1/(2*kIns*Modelica.Constants.pi)*log(
    0.18/0.0899)+1/(2*2.4*Modelica.Constants.pi)*log(
    2/0.18)
    "Thermal resistance of main pipes";
  parameter Modelica.SIunits.ThermalResistance R80=1/(2*0.024*Modelica.Constants.pi)*log(
...
equation
  ...
  annotation (
    ...
    experiment(
      ...
      Tolerance=1e-006),
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PlugFlowPipes/MSLAIT.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
