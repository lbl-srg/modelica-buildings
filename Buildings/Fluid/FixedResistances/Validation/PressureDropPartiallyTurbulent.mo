...
model PressureDropPartiallyTurbulent
 ...
 package Medium = Buildings.Media.Water "Medium model";
  ...
  Sensors.MassFlowRate senMasFlo8(redeclare package Medium = Medium)
    "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{60,-270},{80,-250}})));
equation
  connect(sou.ports[1], res11.port_a)
    annotation (Line(
      points={{-20,98.25},{-10,98.25},{-10,100},{0,100}},
      color={0,127,255}));
  ...
  connect(res12.port_a, sou.ports[2]) annotation (Line(points={{0,60},{-10,60},
          {-10,98.75},{-20,98.75}},    color={0,127,255}));
  connect(res22.port_a, sou.ports[3]) annotation (Line(points={{0,-20},{-10,-20},
          {-10,99.25},{-20,99.25}},     color={0,127,255}));
  ...
  connect(sou.ports[5], res31.port_a) annotation (Line(points={{-20,100.25},{
          -10,100.25},{-10,-120},{0,-120}},
                                         color={0,127,255}));
  connect(sou.ports[6], res32.port_a) annotation (Line(points={{-20,100.75},{
          -10,100.75},{-10,-160},{0,-160}},
                                         color={0,127,255}));
  connect(res08.port_a, sou.ports[7]) annotation (Line(points={{0,-220},{-10,
          -220},{-10,101.25},{-20,101.25}},
                                        color={0,127,255}));
