...
model PressureDropPartiallyTurbulent
  ...
  Buildings.Fluid.Sensors.MassFlowRate senMasFlo5(
    redeclare package Medium = Medium)
    "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{60,-130},{80,-110}})));

  Buildings.Fluid.Sensors.MassFlowRate senMasFlo6(
    redeclare package Medium = Medium)
    "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{60,-170},{80,-150}})));

  Buildings.Utilities.Diagnostics.AssertEquality assEqu3(
    threShold=1E-1)
    "Assert equality of the two mass flow rates"
  ...
  Buildings.Fluid.Sensors.MassFlowRate senMasFlo7(
    redeclare package Medium = Medium)
    "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{60,-230},{80,-210}})));

  Buildings.Fluid.FixedResistances.PressureDrop res9(
    redeclare package Medium = Medium,
    m_flow_nominal=2,
    dp_nominal=5000,
    linearized=true,
  ...
  Buildings.Fluid.Sensors.MassFlowRate senMasFlo8(
    redeclare package Medium = Medium)
    "Mass flow rate sensor"
...
equation
  connect(sou.ports[1], res11.port_a)
    annotation (Line(points={{-20,98.25},{-10,98.25},{-10,100},{0,100}}, color={0,127,255}));
  connect(P.y, sou.p_in)
    annotation (Line(points={{-59,108},{-42,108}}, color={0,0,127}));
  connect(senMasFlo1.m_flow, assEqu1.u1)
    annotation (Line(points={{70,111},{70,136},{118,136}}, color={0,0,127}));
  connect(senMasFlo2.m_flow, assEqu1.u2)
  ...
  connect(senMasFlo4.m_flow, assEqu2.u2)
    annotation (Line(points={{70,-49},{70,-40},{88,-40},{88,4},{118,4}}, color={0,0,127}));
  ...
  connect(res23.port_b, senMasFlo4.port_a)
    annotation (Line(points={{20,-60},{60,-60}}, color={0,127,255}));
  connect(res12.port_a, sou.ports[2])
    annotation (Line(points={{0,60},{-10,60},{-10,98.75},{-20,98.75}}, color={0,127,255}));
  connect(res22.port_a, sou.ports[3])
    annotation (Line(points={{0,-20},{-10,-20},{-10,99.25},{-20,99.25}}, color={0,127,255}));
  connect(res23.port_a, sou.ports[4])
    annotation (Line(points={{0,-60},{-10,-60},{-10,99.75},{-20,99.75}}, color={0,127,255}));
  connect(senMasFlo5.m_flow, assEqu3.u1)
    annotation (Line(points={{70,-109},{70,-84},{118,-84}}, color={0,0,127}));
  connect(senMasFlo6.m_flow, assEqu3.u2)
    annotation (Line(points={{70,-149},{70,-140},{88,-140},{88,-96},{118,-96}}, color={0,0,127}));
  ...
  connect(sou.ports[5], res31.port_a)
    annotation (Line(points={{-20,100.25},{-10,100.25},{-10,-120},{0,-120}}, color={0,127,255}));
  connect(sou.ports[6], res32.port_a)
    annotation (Line(points={{-20,100.75},{-10,100.75},{-10,-160},{0,-160}}, color={0,127,255}));
  connect(res08.port_a, sou.ports[7])
    annotation (Line(points={{0,-220},{-10,-220},{-10,101.25},{-20,101.25}}, color={0,127,255}));
  ...
  connect(senMasFlo1.port_b, sin.ports[1])
    annotation (Line(points={{80,100},{100,100},{100,98.25},{120,98.25}}, color={0,127,255}));
  connect(senMasFlo2.port_b, sin.ports[2])
    annotation (Line(points={{80,60},{100,60},{100,98.75},{120,98.75}}, color={0,127,255}));
  connect(senMasFlo3.port_b, sin.ports[3])
    annotation (Line(points={{80,-20},{100,-20},{100,99.25},{120,99.25}}, color={0,127,255}));
  connect(senMasFlo4.port_b, sin.ports[4])
    annotation (Line(points={{80,-60},{100,-60},{100,99.75},{120,99.75}}, color={0,127,255}));
  connect(senMasFlo5.port_b, sin.ports[5])
    annotation (Line(points={{80,-120},{100,-120},{100,100.25},{120,100.25}}, color={0,127,255}));
  connect(senMasFlo6.port_b, sin.ports[6])
    annotation (Line(points={{80,-160},{100,-160},{100,100.75},{120,100.75}}, color={0,127,255}));
  connect(senMasFlo7.port_b, sin.ports[7])
    annotation (Line(points={{80,-220},{100,-220},{100,101.25},{120,101.25}}, color={0,127,255}));
  connect(sou.ports[8], res9.port_a)
    annotation (Line(points={{-20,101.75},{-10,101.75},{-10,-260},{0,-260}}, color={0,127,255}));
  connect(res9.port_b, senMasFlo8.port_a)
    annotation (Line(points={{20,-260},{60,-260}}, color={0,127,255}));
  connect(senMasFlo8.port_b, sin.ports[8])
    annotation (Line(points={{80,-260},{100,-260},{100,101.75},{120,101.75}}, color={0,127,255}));
  ...
  annotation (experiment(
    ...
    Diagram(
      coordinateSystem(preserveAspectRatio=true, extent={{-120,-280},{160,160}}),
      graphics={
        Text(
          extent={{-116,92},{-56,68}},
          textColor={0,0,255},
