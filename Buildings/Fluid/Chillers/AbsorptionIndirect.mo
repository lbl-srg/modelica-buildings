...
protected
  ...
  Modelica.Blocks.Sources.RealExpression TConEnt(
   ...
   "Condenser entering water temperature"
     annotation (Placement(transformation(extent={{-100,12},{-80,30}})));
...
equation
  connect(on, perMod.on) annotation (Line(points={{-114,16},{-72,16},{-72,10},{-61,
          10}}, color={255,0,255}));
  connect(perMod.QCon_flow, preHeaFloCon.Q_flow) annotation (Line(points={{-39,18},
          {-28,18},{-28,28},{-52,28},{-52,40},{-47,40}}, color={0,0,127}));
  connect(perMod.QEva_flow, preHeaFloEva.Q_flow) annotation (Line(points={{-39,2.6},
          {-26,2.6},{-26,-30},{-1,-30}}, color={0,0,127}));
  connect(preHeaFloEva.port, vol2.heatPort)
    annotation (Line(points={{19,-30},{28,-30},{28,-60},{12,-60}},
                                  color={191,0,0}));
  connect(perMod.QEva_flow, QEva_flow) annotation (Line(points={{-39,2.6},{-26,2.6},
          {-26,-12},{88,-12},{88,-40},{110,-40}}, color={0,0,127}));
  connect(TConEnt.y, perMod.TConEnt) annotation (Line(points={{-79,21},{-70,21},
          {-70,13.4},{-61,13.4}}, color={0,0,127}));
  connect(QEva_flow_set.y, perMod.QEva_flow_set) annotation (Line(points={{-79,-6},
          {-70,-6},{-70,6.6},{-61,6.6}}, color={0,0,127}));
  connect(perMod.P, P) annotation (Line(points={{-39,13.8},{-39,14},{90,14},{90,
          20},{110,20}}, color={0,0,127}));
  connect(preHeaFloCon.port, vol1.heatPort) annotation (Line(points={{-27,40},{-20,
          40},{-20,60},{-10,60}},                                     color={
          191,0,0}));
  connect(perMod.QCon_flow, QCon_flow) annotation (Line(points={{-39,18},{86,18},
          {86,40},{110,40}}, color={0,0,127}));
  connect(perMod.QGen_flow, QGen_flow) annotation (Line(points={{-39,8},{92,8},{
  ...
  connect(TConLvg.T, perMod.TConLvg) annotation (Line(points={{-80,50},{-92,50},
          {-92,32},{-66,32},{-66,17.2},{-61,17.2}}, color={0,0,127}));
  connect(TEvaLvg.port, vol2.heatPort) annotation (Line(points={{-40,-40},{28,-40},
          {28,-60},{12,-60}}, color={191,0,0}));
  connect(TEvaLvg.T, perMod.TEvaLvg) annotation (Line(points={{-60,-40},{-66,-40},
          {-66,2.6},{-61,2.6}}, color={0,0,127}));
