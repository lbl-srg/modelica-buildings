...
model Carnot_TEva_2ndLaw
  ...
  Modelica.Blocks.Sources.Constant dTSmall(k=5) "Small temperature lift"
...
equation
  ...
  connect(add.y, add1.u1) annotation (Line(points={{-19,50},{-10,50},{-10,36},{6,
          36}},    color={0,0,127}));
  connect(dTSmall.y, add1.u2) annotation (Line(points={{-61,4},{-30,4},{-30,24},
          {6,24}},      color={0,0,127}));
...
equation
  connect(TEvaIn.y, chi_b.TEvaIn) annotation (Line(points={{-59,70},{-59,70},{
          88,70},{88,-34},{88,-74.6},{20.9231,-74.6}},          color={0,0,127}));
  connect(add.y, chi_b.TSetEvaLea) annotation (Line(points={{-19,50},{-10,50},{
          -10,-68},{-0.923077,-68}}, color={0,0,127}));
  connect(chi_b.TConIn, add1.y) annotation (Line(points={{-0.923077,-72},{-50,
          -72},{-50,-50},{30,-50},{30,30},{29,30}},
                                               color={0,0,127}));
