...
equation
  ...
  connect(absChiMod.y, realToBoolean.u)
    annotation (Line(points={{-79,0},{-54,0}}, color={0,0,127}));
  connect(absChi.on, realToBoolean.y) annotation (Line(points={{32.8182,0.1},{0,
          0.1},{0,0},{-31,0}}, color={255,0,255}));
  connect(conPum.T_in, TConEnt.y) annotation (Line(points={{-56.6,81.8},{-78,
          81.8},{-78,82},{-79,82}},
                              color={0,0,127}));
  connect(evaPum.T_in, TEvaEnt.y) annotation (Line(points={{96.4,-12.8},{108,-12.8},
          {108,-82},{87,-82}}, color={0,0,127}));
  connect(evaPum.m_flow_in, mEva_flow.y) annotation (Line(points={{96.4,-17.6},{
          104,-17.6},{104,-50},{87,-50}}, color={0,0,127}));
  connect(conPum.ports[1], absChi.port_a1) annotation (Line(points={{-28,87},{
          10,87},{10,6},{33.8182,6}},
                              color={0,127,255}));
