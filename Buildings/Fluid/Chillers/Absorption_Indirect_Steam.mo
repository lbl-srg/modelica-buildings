  ...
  Modelica.Blocks.Interfaces.RealOutput P
   "Chiller pump power"
    annotation (Placement(transformation(extent={{100,10},
            {120,30}}),     iconTransformation(extent={{100,-30},{120,-10}})));
  Modelica.Blocks.Interfaces.RealOutput QGen
   "Generator heat flow "
    annotation (
      Placement(transformation(extent={{100,-10},{120,10}}), iconTransformation(extent={{
            100,10},{120,30}})));
  Modelica.Blocks.Interfaces.RealOutput QEva
   "Evaporator heat flow "
    annotation (
      Placement(transformation(extent={{100,-30},{120,-10}}), iconTransformation(extent={
            {100,-96},{120,-76}})));
  Modelica.Blocks.Interfaces.RealOutput QCon
   "Condenser heat flow "
    annotation (
      Placement(transformation(extent={{100,28},{120,48}}), iconTransformation(extent={{100,
            74},{120,94}})));
...
equation
  ...
  connect(absBlo.QCon, QCon)
    annotation (Line(points={{-79,38},{90,38},{90,38},{110,38}},
                                color={0,0,127}));
  ...
  connect(preHeaFloEva.port, vol2.heatPort)
    annotation (Line(points={{-35,-42},{ -16,-42},{-16,-60},{12,-60}},
                                  color={191,0,0}));
  connect(absBlo.QEva, QEva)
    annotation (Line(points={{-79,24.2},{-68,24.2},{-68,-20},{110,-20}},
                                  color={0,0,127}));
  connect(absBlo.P, P)
    annotation (Line(points={{-79,33.8},{88,33.8},{88,20},{110,20}},
                                  color={0,0,127}));
  connect(absBlo.QGen, QGen)
    annotation (Line(points={{-79,30},{80,30},{80,0},{110,0}},
                                   color={0,0,127}));
