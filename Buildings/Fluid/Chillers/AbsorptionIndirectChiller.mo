...
model AbsorptionIndirectChiller
  ...
  Modelica.Blocks.Sources.RealExpression QEva_flow_set(final y=
        ...
        x2=-Q_flow_small,
        deltaX=Q_flow_small/100)) "Setpoint heat flow rate of the evaporator"
...
protected
  ...
  HeatTransfer.Sources.PrescribedHeatFlow preHeaFloEva
    "Prescribed heat flow rate for the evaporator"
     annotation (Placement(transformation(extent={{43,-52},{63,-32}})));
...
equation
  ...
  connect(absBlo.QEva_flow, preHeaFloEva.Q_flow)
    annotation (Line(points={{-37,-1.4},{-26,-1.4},{-26,-42},{43,-42}},
                                          color={0,0,127}));
  connect(preHeaFloEva.port, vol2.heatPort)
    annotation (Line(points={{63,-42},{84,-42},{84,-60},{12,-60}},
                                  color={191,0,0}));
  connect(absBlo.QEva_flow, QEva_flow)
    annotation (Line(points={{-37,-1.4},{-26,-1.4},{-26,-28},{110,-28}},
                                color={0,0,127}));
  ...
  connect(TEvaLvg.y,absBlo. TEvaLvg)
    annotation (Line(points={{-77,-24},{-66,-24},{-66,-1.4},{-59,-1.4}},
                                    color={0,0,127}));
  connect(QEva_flow_set.y, absBlo.QEva_flow_set) annotation (Line(points={{-77,
          -6},{-70,-6},{-70,2.6},{-59,2.6}}, color={0,0,127}));
  connect(TConLvg.y, absBlo.TConLvg)
    annotation (Line(points={{-77,30},{-68,30},{-68,13.2},{-59,13.2}},
                                    color={0,0,127}));
  connect(absBlo.P, P)
    annotation (Line(points={{-37,9.8},{-37,10},{-12,10},{-12,16},{110,16}},
                                                           color={0,0,127}));
  connect(absBlo.mSte, mSte)
    annotation (Line(points={{-37,3},{-18,3},{-18,-14},{110,-14}},
                      color={0,0,127}));
