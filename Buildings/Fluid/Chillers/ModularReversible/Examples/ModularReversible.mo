...
model ModularReversible
  ...
  Buildings.Fluid.Chillers.ModularReversible.ModularReversible chi(
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Chillers/ModularReversible/Examples/ModularReversible.mos"
        "Simulate and plot"),
