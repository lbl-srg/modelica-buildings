...
protected
  ...
  Modelica.Blocks.Interfaces.RealOutput h_in_a=inStream(
    port_a.h_outflow)
    "Connector for inStream value of port_a.h_outflow";
  Modelica.Blocks.Interfaces.RealOutput h_in_b=inStream(
    port_b.h_outflow)
  ...
  Modelica.Blocks.Interfaces.RealOutput[Medium.nXi] Xi_in_a=inStream(
    port_a.Xi_outflow)
    "Connector for inStream value of port_a.Xi_outflow";
  Modelica.Blocks.Interfaces.RealOutput[Medium.nXi] Xi_in_b=inStream(
    port_b.Xi_outflow)
  ...
  Modelica.Blocks.Interfaces.RealOutput[Medium.nC] C_in_a=inStream(
    port_a.C_outflow)
    "Connector for inStream value of port_a.C_outflow";
  Modelica.Blocks.Interfaces.RealOutput[Medium.nC] C_in_b=inStream(
    port_b.C_outflow)
