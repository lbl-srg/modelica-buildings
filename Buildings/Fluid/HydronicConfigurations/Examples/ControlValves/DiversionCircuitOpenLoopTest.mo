...
model DiversionCircuitOpenLoopTest
...
equation
  ...
  connect(ope.y, con.y) annotation (Line(points={{-48,40},{-40,40},{-40,20},{18,
          20}}, color={0,0,127}));
  connect(pum.port_b, ref.ports[3]) annotation (Line(points={{-50,-40},{1.33333,
          -40},{1.33333,-60}}, color={0,127,255}));
  connect(ref1.ports[1], con.port_a1) annotation (Line(points={{0,-10},{0,0},{
          24,0},{24,10}}, color={0,127,255}));
...
end DiversionCircuitOpenLoopTest;
