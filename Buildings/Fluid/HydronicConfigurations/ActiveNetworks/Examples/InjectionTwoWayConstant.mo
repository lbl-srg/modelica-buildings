...
model InjectionTwoWayConstant
  ...
  Buildings.Controls.OBC.CDL.Continuous.AddParameter T2Set(p=TLiqEnt_nominal, y(
...
equation
  connect(setOff.y[1], T2Set.u)
    annotation (Line(points={{-98,90},{-72,90}}, color={0,0,127}));
  ...
  connect(T2Set.y, con.set)
    annotation (Line(points={{-48,90},{0,90},{0,6},{18,6}}, color={0,0,127}));
