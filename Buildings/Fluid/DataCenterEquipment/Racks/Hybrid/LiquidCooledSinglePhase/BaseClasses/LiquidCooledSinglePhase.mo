within Buildings.Fluid.DataCenterEquipment.Racks.Hybrid.LiquidCooledSinglePhase.BaseClasses;
partial model LiquidCooledSinglePhase
  "Partial hybrid rack model combining liquid-cooled and air-cooled components"
...
annotation (
  ...
  Documentation(
    info="<html>
<p>
This is a partial model of a hybrid IT rack that combines liquid-cooled and air-cooled components.
...
<ul>
<li>
August 22, 2026, by Michael Wetter:<br/>
