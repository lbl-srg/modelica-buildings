...
model OutletTemperature
  "Controller for fan that regulates speed to track the rack outlet temperature set point"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TMea(
    final unit="K",
    displayUnit="degC") "Measured air temperature at rack outlet"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TSet(
    final unit="K",
    displayUnit="degC")
    "Set point for rack outlet air temperature"
...
equation
  ...
  annotation (
    ...
    Documentation(
      info="<html>
<p>
PI controller to regulate the fan to track a rack outlet temperature.
</p>
</html>",
      revisions="<html>
<ul>
