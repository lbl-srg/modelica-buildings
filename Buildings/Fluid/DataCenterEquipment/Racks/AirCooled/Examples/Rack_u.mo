within Buildings.Fluid.DataCenterEquipment.Racks.AirCooled.Examples;
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
      __Dymola_Commands(
       file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/DataCenterEquipment/Racks/AirCooled/Examples/Rack_u.mos" "Simulate and plot"),
