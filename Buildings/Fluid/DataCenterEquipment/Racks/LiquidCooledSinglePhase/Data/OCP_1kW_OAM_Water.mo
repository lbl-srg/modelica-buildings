within Buildings.Fluid.DataCenterEquipment.Racks.LiquidCooledSinglePhase.Data;
record OCP_1kW_OAM_Water
  "OpenCompute example for 1 kW OAM with DI water as working fluid"
  extends Buildings.Fluid.DataCenterEquipment.Racks.LiquidCooledSinglePhase.Data.Generic(
    theRes(
