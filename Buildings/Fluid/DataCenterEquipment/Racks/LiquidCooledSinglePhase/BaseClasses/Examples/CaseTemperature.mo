within Buildings.Fluid.DataCenterEquipment.Racks.LiquidCooledSinglePhase.BaseClasses.Examples;
...
equation
  ...
  annotation (
   experiment(
     ...
     StopTime=1),
     __Dymola_Commands(
       file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/DataCenterEquipment/Racks/LiquidCooledSinglePhase/BaseClasses/Examples/CaseTemperature.mos" "Simulate and plot"),
