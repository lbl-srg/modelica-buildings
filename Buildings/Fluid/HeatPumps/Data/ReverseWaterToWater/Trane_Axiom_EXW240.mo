...
record Trane_Axiom_EXW240 =
 Buildings.Fluid.HeatPumps.Data.ReverseWaterToWater.Generic (
    ...
    PHea=18000,
    PCoo=14244.44,
    coeLoaRatHea={-4.23,-1.24,6.28,0.01,0.08},
    coeLoaRatCoo={-5.79235417,9.83800467,-3.19795605,0.32498894,0.043752306918433},
    coePowRatHea={-5.55,5.08,1.01,-0.04,0.00},
    coePowRatCoo={-6.37109639,1.27560526,5.81780490,0.03132874,-0.082990443216406})
