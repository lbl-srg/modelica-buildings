...
model EquationFitWaterToWaterReverse
  ...
  Modelica.SIunits.SpecificEnthalpy hCooSet= Medium1.specificEnthalpy_pTX(
              ...
              X=cat( 1,
                     port_b1.Xi_outflow,
                     {1 - sum(port_b1.Xi_outflow)})) if reverseCycle
...
equation
  ...
  annotation (Line(points={{-57,-10},{-54,-10},{-54,-2.4},{-11,-2.4}},
                                  color={0,0,127}));
  connect(mLoa_flow.y, equFit.m1_flow)
  annotation (Line(points={{-57,8},{-54,8},{-54,2.2},{-11,2.2}},
                                color={0,0,127}));
  ...
  annotation (Line(points={{-120,-88},{-26,-88},{-26,-9.6},{-11,-9.6}},
                                       color={0,0,127}));
  connect(THeaLoaSet, equFit.THeaLoaSet)
  annotation (Line(points={{-120,90},{-24,90},{-24,9.8},{-11,9.8}},
                                    color={0,0,127}));
  connect(uMod, equFit.uMod)
  annotation (Line(points={{-112,0},{-11,0}}, color={255,127,0}));
  connect(equFit.assMsg, aleMes.u)
  annotation (Line(points={{11,7.4},{24,7.4},{24,
          44},{30,44}}, color={255,0,255}));
  connect(equFit.QSou_flow, preHeaFloSou.Q_flow)
  annotation (Line(points={{11,-4},
          {72,-4},{72,-32},{59,-32}}, color={0,0,127}));
  connect(vol1.heatPort, preHeaFloLoa.port) annotation (Line(points={{-10,60},{-14,
          60},{-14,22},{39,22}}, color={191,0,0}));
  connect(vol2.heatPort, preHeaFloSou.port) annotation (Line(points={{12,-60},{16,
          -60},{16,-32},{39,-32}}, color={191,0,0}));
   annotation (Placement(transformation(extent={{-124,-12},{-100,12}}),
          iconTransformation(extent={{-120,-10},{-100,10}})),
...
end EquationFitWaterToWaterReverse;
