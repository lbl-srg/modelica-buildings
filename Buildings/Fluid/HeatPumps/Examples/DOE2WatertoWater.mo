...
model DOE2WatertoWater
 extends Modelica.Icons.Example;
   ...
   Modelica.Fluid.Sources.FixedBoundary cooVol(nPorts=1, redeclare package Medium = Medium)
    ...
    offset=-1,
    startTime=0)
    "HeatPump operational mode input signal" annotation (Placement(transformation(extent={{-116,
            -10},{-96,10}})));
...
equation
  ...
  connect(reaToInt.y, heaPumDOE2.uMod) annotation (Line(points={{-39,0},{-4,0},{
