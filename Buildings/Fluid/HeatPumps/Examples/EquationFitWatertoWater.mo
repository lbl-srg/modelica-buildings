...
model EquationFitWatertoWater "example"
 ...
 package Medium = Buildings.Media.Water "Medium model";
  ...
  Sources.FixedBoundary cooling_building(nPorts=1, redeclare package Medium =
        Medium)
    annotation (Placement(transformation(extent={{-56,-90},{-40,-74}})));
...
equation
  ...
  connect(heaPum.port_a1, Con_heatingWater.ports[1])
    annotation (Line(points={{32,6},{24,6},{24,92},{-36,92}},
                                                        color={0,127,255}));
  connect(TCon_Ent.y, Con_heatingWater.T_in) annotation (Line(points={{-81.2,92},
          {-66,92},{-66,88.8},{-53.6,88.8}},
                                      color={0,0,127}));
  ...
  connect(cooling_building.ports[1], res2.port_a)
    annotation (Line(points={{-40,-82},{-10,-82}}, color={0,127,255}));
