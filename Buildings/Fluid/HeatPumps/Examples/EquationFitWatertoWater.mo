 ...
 package Medium = Buildings.Media.Water "Medium model";
  ...
  Buildings.Fluid.HeatPumps.EquationFitWaterToWater heaPum(
    ...
    massDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
      "Water to Water heatpump" annotation (Placement(transformation(extent={{32,-10},{52,10}})));

    parameter Data.EquationFitWaterToWater.Trane_Axiom_EXW240 per
       "HeatPump performance" annotation (Placement(transformation(extent={{120,80},{140,100}})));
    ...
    offset=20 + 273.15,
    startTime=0)
      "Condesner entering water temperature" annotation (Placement(transformation(extent={{-118,76},{-98,96}})));
    ...
    offset=-1,
    startTime=0)
      "HeatPump operational mode input signal" annotation (Placement(transformation(extent={{-118,
            -10},{-98,10}})));
...
equation
  ...
  connect(TEvaEnt.y, evaPum.T_in) annotation (Line(points={{81,-84},{98,-84},{98,
