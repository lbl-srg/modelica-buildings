...
model EquationFitReversible_CoolingClosedLoop
  ...
  Sources.Boundary_pT pre(
    ...
    nPorts=1)
    "Pressure source."
    annotation (Placement(transformation(extent={{10,-10},{-10,10}},rotation=0,origin={60,50})));
equation
  ...
  connect(pum.port_a,vol.ports[1])
    annotation (Line(points={{20,50},{40,50},{40,-10},{70,-10}},color={0,127,255}));
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatPumps/Examples/EquationFitReversible_CoolingClosedLoop.mos" "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=2500),
    Documentation(
