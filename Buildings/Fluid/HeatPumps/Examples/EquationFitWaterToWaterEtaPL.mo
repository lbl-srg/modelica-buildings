...
equation
  ...
  connect(conPum.T_in, TConEnt.y) annotation (Line(points={{-44,66},{-72,66}},
                  color={0,0,127}));
  connect(TEvaSet.y, heaPum.TEvaSet) annotation (Line(points={{2,-30},{14,-30},
          {14,-9},{28.5455,-9}},color={0,0,127}));
  connect(TConSet.y, heaPum.TConSet) annotation (Line(points={{2,30},{12,30},{
          12,9},{28.5455,9}},
                           color={0,0,127}));
