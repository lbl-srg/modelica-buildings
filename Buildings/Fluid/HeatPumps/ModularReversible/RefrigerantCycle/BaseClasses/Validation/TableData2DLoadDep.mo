...
equation
  connect(on.y, chiSupLvg.on) annotation (Line(points={{-58,60},{-20,60},{-20,109},
          {-2,109}},
                   color={255,0,255}));
  ...
  connect(mEva_flow.y, chiSupLvg.mLoa_flow) annotation (Line(points={{-98,-80},{
          -8,-80},{-8,93},{-2,93}},
                                 color={0,0,127}));
  connect(cp.y, chiSupLvg.cpLoa) annotation (Line(points={{-38,100},{-6,100},{-6,
          91},{-2,91}},
                   color={0,0,127}));
  connect(on.y, chiRetEnt.on) annotation (Line(points={{-58,60},{-20,60},{-20,49},
  ...
  connect(TEvaLvg.y, chiRetEnt.TLoaLvg) annotation (Line(points={{-58,-60},{-10,
          -60},{-10,35},{-2,35}},
                          color={0,0,127}));
  connect(mEva_flow.y, chiRetEnt.mLoa_flow) annotation (Line(points={{-98,-80},{
          -8,-80},{-8,33},{-2,33}},
                                 color={0,0,127}));
  connect(cp.y, chiRetEnt.cpLoa) annotation (Line(points={{-38,100},{-6,100},{-6,
          31},{-2,31}},
                   color={0,0,127}));
  connect(chiSupLvg.PLR, chiSupLvg.yMea) annotation (Line(points={{22,106},{26,106},
          {26,118},{-4,118},{-4,103},{-2,103}},  color={0,0,127}));
  connect(chiRetEnt.PLR, chiRetEnt.yMea) annotation (Line(points={{22,46},{26,46},
          {26,60},{-4,60},{-4,43},{-2,43}},    color={0,0,127}));
  connect(TEvaLvgChiSupLvg.y, chiSupLvg.TLoaLvg) annotation (Line(points={{51,100},
          {56,100},{56,80},{-10,80},{-10,95},{-2,95}}, color={0,0,127}));
  connect(TEvaEnt.y, chiSupLvg.TLoaEnt) annotation (Line(points={{-98,-40},{-12,
          -40},{-12,97},{-2,97}},  color={0,0,127}));
  connect(TEvaEntChiRetEnt.y, chiRetEnt.TLoaEnt) annotation (Line(points={{51,40},
          {56,40},{56,22},{-4,22},{-4,37},{-2,37}},    color={0,0,127}));
  connect(on.y, chiHeaSupLvg.on) annotation (Line(points={{-58,60},{-20,60},{-20,
          -11},{-2,-11}},
                       color={255,0,255}));
  connect(cp.y, chiHeaSupLvg.cpLoa) annotation (Line(points={{-38,100},{-6,100},
          {-6,-29},{-2,-29}}, color={0,0,127}));
  connect(cp.y, chiRetEnt.cpLoa) annotation (Line(points={{-38,100},{-6,100},{-6,
          31},{-2,31}},
                   color={0,0,127}));
  connect(chiHeaSupLvg.PLR, chiHeaSupLvg.yMea) annotation (Line(points={{22,-14},
          {26,-14},{26,0},{-4,0},{-4,-17},{-2,-17}},
                                                   color={0,0,127}));
  connect(coo.y, chiHeaSupLvg.coo) annotation (Line(points={{-58,20},{-22,20},{-22,
          -13},{-2,-13}},
                       color={255,0,255}));



  connect(TConLvgHpSupLvg.y, hpSupLvg.TLoaLvg) annotation (Line(points={{51,-80},
          {56,-80},{56,-100},{-4,-100},{-4,-85},{-2,-85}},             color={0,
          0,127}));
  ...
  connect(THeaWatSet.y, hpSupLvg.TSet) annotation (Line(points={{-98,40},{-32,40},
          {-32,-75},{-2,-75}},      color={0,0,127}));
  connect(hpSupLvg.PLR, hpSupLvg.yMea) annotation (Line(points={{22,-74},{26,-74},
          {26,-60},{-4,-60},{-4,-77},{-2,-77}},         color={0,0,127}));
  connect(mCon_flow.y, hpSupLvg.mLoa_flow) annotation (Line(points={{-58,-100},{
  ...
  connect(TConLvgChiHeaSupLvg.y, chiHeaSupLvg.TLoaLvg) annotation (Line(points={{51,-20},
          {56,-20},{56,-40},{-4,-40},{-4,-25},{-2,-25}},              color={0,
          0,127}));
  connect(mCon_flow.y, chiHeaSupLvg.mLoa_flow) annotation (Line(points={{-58,-100},
          {-6,-100},{-6,-27},{-2,-27}},          color={0,0,127}));
  connect(THeaWatSet.y, chiHeaSupLvg.TSet) annotation (Line(points={{-98,40},{-30,
          40},{-30,-15},{-2,-15}},      color={0,0,127}));
