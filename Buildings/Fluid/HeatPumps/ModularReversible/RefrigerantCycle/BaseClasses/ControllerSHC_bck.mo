...
block ControllerSHC_bck "Controller for modular multipipe system"
  ...
  Buildings.Controls.OBC.CDL.Logical.MultiOr sysEna(nin=3)
    "True if system has already been enabled"
...
equation
  ...
  connect(numUni.y, remUniCoo.u[1]) annotation (Line(points={{32,40},{80,40},{
          80,18},{94,18},{94,17.6667},{108,17.6667}}, color={255,127,0}));
  connect(nHea.y, remUniCoo.u[2]) annotation (Line(points={{70,80},{90,80},{90,
          20},{108,20}}, color={255,127,0}));
  connect(nShc.y, remUniCoo.u[3]) annotation (Line(points={{72,-80},{90,-80},{
          90,22.3333},{108,22.3333}}, color={255,127,0}));
  connect(idxUni.y, avaCoo.u1) annotation (Line(points={{148,140},{136,140},{
          136,-20},{132,-20}}, color={255,127,0}));
  connect(remUniCoo.y, rep.u)
    annotation (Line(points={{132,20},{138,20}}, color={255,127,0}));
  connect(rep.y, avaCoo.u2) annotation (Line(points={{162,20},{164,20},{164,-28},
          {132,-28}}, color={255,127,0}));
  connect(enaLeaCoo.y, numCoo.u1Lea)
    annotation (Line(points={{32,0},{38,0},{38,6},{48,6}}, color={255,0,255}));
  connect(avaCoo.y, numCoo.u1AvaSta) annotation (Line(points={{108,-20},{44,-20},
          {44,-6},{48,-6}}, color={255,0,255}));
  connect(numCoo.y, nUniCoo)
    annotation (Line(points={{72,0},{200,0}}, color={255,127,0}));
  connect(remUniHea.y, rep1.u)
    annotation (Line(points={{132,-60},{138,-60}}, color={255,127,0}));
  connect(numCoo.y, nUniCoo)
    annotation (Line(points={{72,0},{200,0}}, color={255,127,0}));
  connect(numUni.y, remUniHea.u[1]) annotation (Line(points={{32,40},{80,40},{
          80,-62.3333},{108,-62.3333}}, color={255,127,0}));
  connect(numCoo.y, remUniHea.u[2]) annotation (Line(points={{72,0},{100,0},{
          100,-60},{108,-60}}, color={255,127,0}));
  connect(nShc.y, remUniHea.u[3]) annotation (Line(points={{72,-80},{90,-80},{
          90,-57.6667},{108,-57.6667}}, color={255,127,0}));
  connect(idxUni.y, avaCoo2.u1) annotation (Line(points={{148,140},{136,140},{
          136,60},{132,60}}, color={255,127,0}));
  connect(rep1.y, avaCoo2.u2) annotation (Line(points={{162,-60},{166,-60},{166,
          52},{132,52}}, color={255,127,0}));
  connect(avaCoo2.y, nHea.u1AvaSta) annotation (Line(points={{108,60},{44,60},{
          44,74},{46,74}}, color={255,0,255}));
  ...
  connect(idxUni.y, avaShc.u1) annotation (Line(points={{148,140},{136,140},{
          136,-100},{132,-100}}, color={255,127,0}));
  connect(numUni.y, remUniShc.u[1]) annotation (Line(points={{32,40},{80,40},{
          80,97.6667},{108,97.6667}}, color={255,127,0}));
  connect(nHea.y, remUniShc.u[2]) annotation (Line(points={{70,80},{90,80},{90,
          100},{108,100}}, color={255,127,0}));
  connect(numCoo.y, remUniShc.u[3]) annotation (Line(points={{72,0},{100,0},{
          100,102.333},{108,102.333}}, color={255,127,0}));
  connect(remUniShc.y, rep2.u)
    annotation (Line(points={{132,100},{138,100}}, color={255,127,0}));
  connect(rep2.y, avaShc.u2) annotation (Line(points={{162,100},{168,100},{168,
  ...
  connect(nHea.y, nUniHea) annotation (Line(points={{70,80},{132,80},{132,80},{
          200,80}}, color={255,127,0}));
  ...
  connect(nUniHea, nUniTot.u[1]) annotation (Line(points={{200,80},{170,80},{
          170,-162.333},{132,-162.333}}, color={255,127,0}));
  connect(nUniCoo, nUniTot.u[2]) annotation (Line(points={{200,0},{172,0},{172,
          -160},{132,-160}}, color={255,127,0}));
  connect(nUniShc, nUniTot.u[3]) annotation (Line(points={{200,-80},{174,-80},{
          174,-157.667},{132,-157.667}}, color={255,127,0}));
  connect(nUniTot.y, noUniAva.u)
    annotation (Line(points={{108,-160},{102,-160}}, color={255,127,0}));
  connect(y1UpShcTim.passed, and2.u1) annotation (Line(points={{-148,-96},{-144,
          -96},{-144,-80},{-134,-80}}, color={255,0,255}));
  connect(noUniAva.y, and2.u2) annotation (Line(points={{78,-160},{-140,-160},{
          -140,-88},{-134,-88}}, color={255,0,255}));
  connect(and2.y, or2.u2) annotation (Line(points={{-110,-80},{-100,-80},{-100,
          -68},{-92,-68}}, color={255,0,255}));
  connect(y1DowCooTim.passed, or2.u1)
    annotation (Line(points={{-148,-60},{-92,-60}}, color={255,0,255}));
  connect(or2.y, numCoo.u1Dow) annotation (Line(points={{-68,-60},{42,-60},{42,
          -2},{48,-2}}, color={255,0,255}));
  connect(y1DowHeaTim.passed, or1.u1)
    annotation (Line(points={{-148,20},{-92,20},{-92,20}}, color={255,0,255}));
  connect(and2.y, or1.u2) annotation (Line(points={{-110,-80},{-100,-80},{-100,
          12},{-92,12}}, color={255,0,255}));
  connect(or1.y, nHea.u1Dow) annotation (Line(points={{-68,20},{42,20},{42,78},
          {46,78}}, color={255,0,255}));
  connect(enaLeaHea.y, sysEna.u[1]) annotation (Line(points={{32,80},{38,80},{
          38,-42.3333},{-6,-42.3333}}, color={255,0,255}));
  connect(enaLeaCoo.y, sysEna.u[2]) annotation (Line(points={{32,0},{38,0},{38,
          -40},{-6,-40}}, color={255,0,255}));
  connect(enaLeaShc.y, sysEna.u[3]) annotation (Line(points={{32,-80},{38,-80},
          {38,-37.6667},{-6,-37.6667}}, color={255,0,255}));
  connect(sysEna.y, pre.u)
    annotation (Line(points={{-30,-40},{-38,-40}}, color={255,0,255}));
