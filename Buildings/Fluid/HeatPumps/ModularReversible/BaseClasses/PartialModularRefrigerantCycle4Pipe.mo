...
partial model PartialModularRefrigerantCycle4Pipe
  ...
  Modelica.Blocks.Routing.Multiplex3 multiplex3_3 annotation (Placement(
        ...
        rotation=-90,
        origin={-50,-40})));
  Modelica.Blocks.Interfaces.RealOutput QCon1_flow(final unit="W")
    "Heat flow rate from the refrigerant to the condenser1 medium"
...
equation
  ...
  connect(multiplex3_1.y, swiQEva.u)
    annotation (Line(points={{-41,0},{-68,0}}, color={0,0,127}));
  connect(multiplex3_3.y, swiPEle.u)
    annotation (Line(points={{-50,-51},{-50,-58}}, color={0,0,127}));
  connect(multiplex3_2.y, swiQCon.u)
    annotation (Line(points={{41,0},{68,0}}, color={0,0,127}));
  connect(multiplex3_4.y, swiQCon1.u)
    annotation (Line(points={{50,-51},{50,-58}}, color={0,0,127}));
  connect(swiQCon1.y, QCon1_flow)
    annotation (Line(points={{50,-81},{50,-110}}, color={0,0,127}));
  connect(swiPEle.y, PEle) annotation (Line(points={{-50,-81},{-50,-110.5},{
          -49.5,-110.5}}, color={0,0,127}));
...
end PartialModularRefrigerantCycle4Pipe;
