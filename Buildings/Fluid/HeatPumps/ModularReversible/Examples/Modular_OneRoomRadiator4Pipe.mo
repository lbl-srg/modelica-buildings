...
model Modular_OneRoomRadiator4Pipe
  ...
  Modelica.Blocks.Sources.Constant temAmbBas(
    ...
    "Ambient temperature in basement of building" annotation (Placement(
        ...
        origin={70,-160})));
equation
  connect(heaPum.port_b2, sin.ports[1]) annotation (Line(points={{20,-160},{38,
          -160},{38,-200},{60,-200}},     color={0,127,255}));
  connect(heaPum.port_a2, pumHeaPumSou.port_b) annotation (Line(points={{0,-160},
          {-30,-160},{-30,-170}},       color={0,127,255}));
  connect(heaPum.port_b1, pumHeaPum.port_a) annotation (Line(points={{0,-140},{
          -70,-140},{-70,-120}},  color={0,127,255}));
  connect(heaPum.port_a1, temRet.port_b) annotation (Line(points={{20,-140},{60,
          -140},{60,-30}},     color={0,127,255}));
  connect(temAmbBas.y, heaPum.TConAmb) annotation (Line(points={{59,-160},{54,
          -160},{54,-142.9},{21.1,-142.9}},
                                          color={0,0,127}));
...
<li>
  ...
  experiment(
      ...
      StopTime=86400,
      Tolerance=1e-08));
end Modular_OneRoomRadiator4Pipe;
