...
model TableData2DLoadDepSHC1Only
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.PIDWithEnable ctlValChwByp(
    k=1,
    Ti=60,
    r=hp.dpChw_nominal,
    y_reset=1,
  ...
  Actuators.Valves.TwoWayLinear valHwByp(
    ...
    "HW minimum flow bypass valve" annotation (Placement(transformation(
        ...
        rotation=90,
        origin={40,-240})));
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.PIDWithEnable ctlValHwByp(
    k=1,
    Ti=60,
    r=hp.dpHw_nominal,
    y_reset=1,
...
equation
  ...
  connect(hp.y1ChwValIsoPumPri, staPumChwPri.u1ValOutIso) annotation (Line(
        points={{-186,-65},{-186,-66},{-156,-66},{-156,104},{-62,104}}, color={
          255,0,255}));
  ...
  connect(hp.y1HwValIsoPumPri, staPumHwPri.u1ValOutIso) annotation (Line(points
        ={{-174,-43},{-174,-38},{-138,-38},{-138,-96},{-62,-96}}, color={255,0,
          255}));
