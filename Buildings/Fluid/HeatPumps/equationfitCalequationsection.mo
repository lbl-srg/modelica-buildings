...
block equationfitCalequationsection
  ...
  Modelica.Blocks.Interfaces.IntegerInput uMod "Heating mode= 1, Off=0, Cooling mode=-1" annotation (Placement(transformation(extent={{-124,-18},{-100,6}}),
  ...
  "Evaporator heatflowQCon_heatflow_nominal input";
  ...
  */
  ...
  Modelica.Blocks.Interfaces.RealOutput QCon "Condenser heat flow rate " annotation (Placement(transformation(extent={{100,-10},{120,10}}), iconTransformation(extent={{
            100,-10},{120,10}})));
  Modelica.Blocks.Interfaces.RealOutput QEva "Evaporator heat flow rate " annotation (Placement(transformation(extent={{100,-48},{120,-28}})));
  ...
  Modelica.Blocks.Interfaces.RealInput m1_flow(final unit="kg/s") "Volume 1 massflow rate "
    annotation (Placement(transformation(extent={{-128,16},{-100,44}}), iconTransformation(extent={{-108,36},{-100,44}})));
  ...
  /*
  Modelica.Blocks.Interfaces.RealInput hCQCon_flow_seton(final unit="kJ/kg", displayUnit="kJ/kg")   "Enthalpy of heating water"
    annotation (Placement(transformation(extent={{-128,20},{-100,48}}), iconTransformation(extent={{-108,16},{-100,24}})));
  Modelica.Blocks.Interfaces.RealInput hEva(final unit="kJ/kg", displayUnit="kJ/kg") "Enthalpy of cooling water"
    annotation (Placement(transformation(extent={{-128,-54},{-100,-26}}), iconTransformation(extent={{-108,-28},{-100,-20}})));
*/
  Modelica.Blocks.Interfaces.RealOutput P1 "Compressor power" annotation (Placement(transformation(extent={{100,30},{120,50}}), iconTransformation(extent={{100,30},{120,
            50}})));
...
end equationfitCalequationsection;
