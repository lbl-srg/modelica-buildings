...
model EquationFitWaterToWater_Dynamic "example"
 ...
 package Medium = Buildings.Media.Water "Medium model";
  ...
  parameter
    ...
    per=
      Buildings.Fluid.HeatPumps.Data.EquationFitWaterToWater.Trane_Axiom_EXW240
      ();
  ...
  Controls.OBC.CDL.Continuous.Sources.Ramp TEva_ent(
    ...
    offset=12 + 273.15,
    startTime=0)
    annotation (Placement(transformation(extent={{64,-94},{78,-80}})));
  ...
  Sources.FixedBoundary cooling_building(nPorts=1, redeclare package Medium =
        Medium)
    annotation (Placement(transformation(extent={{-56,-92},{-40,-76}})));
  ...
  Controls.OBC.CDL.Continuous.Sources.Ramp ram(
    ...
    duration(displayUnit="h") = 14400,
    offset=-5,
    startTime=0)      annotation (Placement(transformation(extent={{-96,-10},{
            -82,4}})));
...
equation
  ...
  connect(heaPum.port_a1, Con_heatingWater.ports[1])
    annotation (Line(points={{32,6},{24,6},{24,92},{-36,92}},
                                                        color={0,127,255}));
  connect(TCon_Ent.y, Con_heatingWater.T_in) annotation (Line(points={{-81.2,92},{-66,92},{-66,88.8},{-53.6,88.8}},
                                      color={0,0,127}));
  connect(TEva_ent.y, Eva_chilledWater.T_in)
    annotation (Line(points={{78.7,-87},{98,-87},{98,-53.2},{79.6,-53.2}},
                                                 color={0,0,127}));
