...
<p>
This package contains performance data for fans in Englander and Norland (1992).
The figures used to extract data are provided in the documentation of each record.
