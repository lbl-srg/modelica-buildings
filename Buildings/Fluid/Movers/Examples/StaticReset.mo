...
equation
  ...
  connect(fan3.port_a, sou.ports[1]) annotation (Line(points={{-10,-20},{-18,-20},
          {-18,-81.6},{-80,-81.6}}, color={0,127,255}));
  connect(fan2.port_a, sou.ports[2]) annotation (Line(points={{-10,80},{-18,80},
          {-18,-80.8},{-80,-80.8}}, color={0,127,255}));
  connect(pDucSta3.port_b, sou.ports[3]) annotation (Line(points={{-60,-50},{-80,
          -50},{-80,-80}},               color={0,127,255},
      pattern=LinePattern.Dot));
  connect(pDucSta2.port_b, sou.ports[4]) annotation (Line(points={{-60,50},{-80,
          50},{-80,-79.2}},         color={0,127,255},
      pattern=LinePattern.Dot));
  ...
  connect(forFlo1.port_b, sin.ports[2]) annotation (Line(points={{122,180},{134,
          180},{134,-79},{140,-79}},
                                color={0,127,255}));
  connect(fan1.port_a, sou.ports[2]) annotation (Line(points={{-10,180},{-18,180},
          {-18,-80.8},{-80,-80.8}}, color={0,127,255}));
  ...
  connect(pDucSta1.port_a, dp12.port_a) annotation (Line(
      ...
      color={0,127,255},
      pattern=LinePattern.Dot));
  connect(pDucSta1.port_b, sou.ports[5]) annotation (Line(
      points={{-60,152},{-80,152},{-80,-78.4}},
      color={0,127,255},
      pattern=LinePattern.Dot));
  annotation (
