...
model CrossValidation "Power calculation comparison among three mover types"
  ...
  Buildings.Fluid.Movers.FlowMachine_Nrpm pump_Nrpm(
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
    ...
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Movers/Examples/CrossValidation.mos"
        "Simulate and plot"),
