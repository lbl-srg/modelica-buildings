...
model Pump_Nrpm_stratos "Model test using a Wilo Stratos 80/1-12 pump"
  ...
  Buildings.Fluid.Movers.SpeedControlled_Nrpm stratosPump80dash1to12_1(
  redeclare package Medium = Modelica.Media.Water.StandardWater,
  per(
    pressure=pressure,
  ...
  Buildings.Fluid.Movers.SpeedControlled_Nrpm stratosPump80dash1to12_2(
  redeclare package Medium = Modelica.Media.Water.StandardWater,
  per(
    N_nominal=N_nominal,
    pressure=pressure,
  ...
  Buildings.Fluid.Movers.SpeedControlled_Nrpm stratosPump80dash1to12_3(
  redeclare package Medium = Modelica.Media.Water.StandardWater,
  per(
    N_nominal=N_nominal,
    pressure=pressure,
  ...
  Buildings.Fluid.Movers.FlowControlled_m_flow fan3(
                                                redeclare package Medium =
        Modelica.Media.Water.StandardWater, m_flow_nominal=3)
    annotation (Placement(transformation(extent={{38,-80},{58,-60}})));
  Buildings.Fluid.Movers.SpeedControlled_Nrpm stratosPump80dash1to12_4(
  redeclare package Medium = Modelica.Media.Water.StandardWater,
  per(
    N_nominal=N_nominal,
    pressure=pressure,
  ...
  Buildings.Fluid.Movers.FlowControlled_m_flow fan4(redeclare package Medium =
        Modelica.Media.Water.StandardWater, m_flow_nominal=3)
    annotation (Placement(transformation(extent={{38,-130},{58,-110}})));
  Buildings.Fluid.Movers.SpeedControlled_Nrpm stratosPump80dash1to12_5(
  redeclare package Medium = Modelica.Media.Water.StandardWater,
  per(
    N_nominal=N_nominal,
    pressure=pressure,
