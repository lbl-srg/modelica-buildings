...
<li>
<code>GenericCurve</code> - The rated motor power input and maximum motor
efficiency are provided. The model then uses a generic motor efficiency curve
as a function of motor part load ratio generated by
