...
model WetCoilEffectivenessNTUWithRated
  "Heat exchanger with effectiveness - NTU relation and with moisture condensation.
  This model is the same as Buildings.Fluid.HeatExchangers.WetCoilEffectivenessNTU. 
  However, cooling coil performance data a rated condition rather than the overall heat transfer coefficient, i.e., UA_nominal, can be specified."
...
protected
  ...
  parameter Modelica.SIunits.ThermalConductance UA_nominal(min=0, fixed= false)
    "Thermal conductance at nominal flow, used to compute heat capacity";

initial equation
  UA_nominal=UAFroRated.UA;
...
end WetCoilEffectivenessNTUWithRated;
