...
model SingleSpeedHeating_TimedReverseCycleDefrost
  ...
  Modelica.Blocks.Sources.CombiTimeTable datRea(
    ...
    final fileName=ModelicaServices.ExternalReferences.loadResource("./Buildings/Resources/Data/Fluid/HeatExchangers/DXCoils/AirSource/Validation/SingleSpeedHeating_TimedReverseCycleDefrost/DXCoilSystemAuto.dat"),
    final columns=2:18,
