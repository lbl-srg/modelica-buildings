...
model SingleSpeedHeating_OnDemandResistiveDefrost
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.AirSource.Data.Generic.BaseClasses.Defrost datDef(
    final defOpe=Buildings.Fluid.HeatExchangers.DXCoils.BaseClasses.DefrostOperation.resistive,
  ...
  Modelica.Blocks.Sources.CombiTimeTable datRea(
    ...
    final fileName=ModelicaServices.ExternalReferences.loadResource("./Buildings/Resources/Data/Fluid/HeatExchangers/DXCoils/AirSource/Validation/SingleSpeedHeatingPLREnergyPlusDefrost_OnDemandResistive/DXCoilSystemAuto.dat"),
    final columns=2:18,
