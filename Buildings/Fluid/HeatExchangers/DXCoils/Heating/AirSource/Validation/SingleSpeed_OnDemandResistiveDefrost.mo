...
model SingleSpeed_OnDemandResistiveDefrost
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-180,-160},
            {180,160}})),
             __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/Heating/AirSource/Validation/SingleSpeed_OnDemandResistiveDefrost.mos"
        "Simulate and Plot"),
