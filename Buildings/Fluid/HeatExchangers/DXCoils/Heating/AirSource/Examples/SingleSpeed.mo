...
model SingleSpeed "Test model for single speed DX heating coil"
  ...
  parameter
    ...
    sta={
        ...
        perCur=
          Buildings.Fluid.HeatExchangers.DXCoils.Heating.AirSource.Examples.PerformanceCurves.Curve_I())},
...
equation
  ...
  annotation (__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/Heating/AirSource/Examples/SingleSpeed.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06),
