...
record Stage "Generic data record for a stage of a air source DX coil"
  ...
  replaceable parameter Buildings.Fluid.HeatExchangers.DXCoils.Heating.AirSource.Data.Generic.BaseClasses.NominalValues
    nomVal "Nominal values"
    annotation (Placement(transformation(extent={{60,60},{80,80}})));

  replaceable parameter
    Buildings.Fluid.HeatExchangers.DXCoils.Heating.AirSource.Data.Generic.BaseClasses.PerformanceCurve
...
Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.Data.Generic.Coil</a> for a description of the data. </p>
</html>",
revisions="<html>
<ul>
<li>
