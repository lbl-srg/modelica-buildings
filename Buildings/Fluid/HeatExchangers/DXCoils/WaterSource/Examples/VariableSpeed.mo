within Buildings.Fluid.HeatExchangers.DXCoils.WaterSource.Examples;
model VariableSpeed "Test model for variable speed DX coil"
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.WaterSource.VariableSpeed varSpeDX(
  ...
  parameter Buildings.Fluid.HeatExchangers.DXCoils.WaterSource.Data.Generic.DXCoil datCoi(nSta=1, sta={
   ...
   nomVal=Buildings.Fluid.HeatExchangers.DXCoils.WaterSource.Data.Generic.BaseClasses.NominalValues(
    ...
    perCur=Buildings.Fluid.HeatExchangers.DXCoils.WaterSource.Examples.PerformanceCurves.Curve_I())}) "Coil data"
...
equation
  ...
  annotation (             __Dymola_Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/WaterSource/Examples/VariableSpeed.mos"
        "Simulate and plot"),
