...
model MultiStage "Test model for multi speed water source DX coil"
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.WaterSource.MultiStage  mulSpeDX(
  ...
  parameter Buildings.Fluid.HeatExchangers.DXCoils.WaterSource.Data.Generic.DXCoil datCoi(nSta=4, sta={
...
equation
  ...
  annotation (             __Dymola_Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/WaterSource/Examples/MultiStage.mos"
        "Simulate and plot"),
    experiment(Tolerance=1e-6, StopTime=3600),
            Documentation(info="<html>
<p>
This is a test model for
<a href=\"modelica://Buildings.Fluid.HeatExchangers.DXCoils.WaterSource.MultiStage\">
Buildings.Fluid.HeatExchangers.DXCoils.WaterSource.MultiStage</a>.
