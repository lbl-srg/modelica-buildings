...
model SingleSpeedPLR
  ...
  parameter Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.Data.Generic.Coil
    datCoi(nSta=1,
    sta={
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-160,-140},
            {160,140}})),
             __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/Cooling/AirSource/Validation/SingleSpeedPLR.mos"
        "Simulate and plot"),
