...
model SpaceCooling "Space cooling with DX coils"
  ...
  parameter
    ...
    datCoi(
      sta={Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.Data.Generic.BaseClasses.Stage(
        spe=1800/60,
        ...
        perCur=Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.Examples.PerformanceCurves.Curve_I())},
      nSta=1)
  ...
  parameter
    ...
    datCoiMulSpe(
      ...
      Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.Data.Generic.BaseClasses.Stage(
        ...
        perCur=
        Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.Examples.PerformanceCurves.Curve_I()),
      Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.Data.Generic.BaseClasses.Stage(
        spe=2400/60,
        nomVal=
        Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.Data.Generic.BaseClasses.NominalValues(
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.SingleSpeed
    sinSpeDX(
    redeclare package Medium = Medium,
    final datCoi=datCoi,
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.MultiStage mulStaDX(
    redeclare package Medium = Medium,
    final dp_nominal=400,
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.VariableSpeed
    varSpeDX(
    redeclare package Medium = Medium,
    final dp_nominal=400,
    final datCoi=datCoiMulSpe,
...
<p align=\"center\">
<img alt=\"image\" src=\"modelica://Buildings/Resources/Images/Fluid/HeatExchangers/DXCoils/Cooling/AirSource/Examples/SpaceCooling.png\" />
</p>
...
First implementation.
    ...
    __Dymola_Commands(file=
     "modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/Cooling/AirSource/Examples/SpaceCooling.mos"
        "Simulate and plot"),
