...
equation
  ...
  connect(varSpeDX.TOut, TConIn.y) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  annotation (             __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/Cooling/AirSource/Examples/VariableSpeed.mos"
        "Simulate and plot"),
