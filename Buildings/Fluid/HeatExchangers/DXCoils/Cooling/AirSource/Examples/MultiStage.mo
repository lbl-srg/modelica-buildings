    ...
    datCoi(
      ...
      Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.Data.Generic.BaseClasses.Stage(
        ...
        nomVal=Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.Data.Generic.BaseClasses.NominalValues(
          ...
          SHR_nominal=0.8,
          m_flow_nominal=1.5),
        perCur=Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.Examples.PerformanceCurves.Curve_II()),
      Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.Data.Generic.BaseClasses.Stage(
        spe=2400/60,
        nomVal=Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.Data.Generic.BaseClasses.NominalValues(
          ...
          SHR_nominal=0.8,
          m_flow_nominal=1.8),
        perCur=Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.Examples.PerformanceCurves.Curve_III())})
    "Coil data"
...
equation
  ...
  connect(TConIn.y, mulStaDX.TOut) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  annotation (             __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/Cooling/AirSource/Examples/MultiStage.mos"
        "Simulate and plot"),
...
<a href=\"modelica://Buildings.Fluid.HeatExchangers.DXCoils.Cooling.AirSource.MultiStage\">AirSource.MultiStageCooling</a>.<br/>
