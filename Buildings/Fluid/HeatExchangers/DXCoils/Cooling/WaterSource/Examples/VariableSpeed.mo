...
model VariableSpeed "Test model for variable speed DX coil"
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.Cooling.WaterSource.VariableSpeed varSpeDX(
...
equation
  ...
  annotation (             __Dymola_Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/Cooling/WaterSource/Examples/VariableSpeed.mos"
        "Simulate and plot"),
