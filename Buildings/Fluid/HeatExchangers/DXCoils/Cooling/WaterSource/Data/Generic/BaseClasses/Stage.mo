...
record Stage "Generic data record for a stage of a DX coil"
  ...
  redeclare parameter Buildings.Fluid.HeatExchangers.DXCoils.Cooling.WaterSource.Data.Generic.BaseClasses.NominalValues nomVal,
  redeclare parameter Buildings.Fluid.HeatExchangers.DXCoils.Cooling.WaterSource.Data.Generic.BaseClasses.PerformanceCurve perCur);
...
Buildings.Fluid.HeatExchangers.DXCoils.Cooling.WaterSource.Data.Generic.DXCoil</a> for a description of the data.
</p>
</html>",
revisions="<html>
<ul>
