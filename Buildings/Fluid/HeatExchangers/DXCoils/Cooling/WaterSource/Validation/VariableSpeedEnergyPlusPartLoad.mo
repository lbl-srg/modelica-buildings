within Buildings.Fluid.HeatExchangers.DXCoils.Cooling.WaterSource.Validation;
model VariableSpeedEnergyPlusPartLoad
 ...
 parameter Buildings.Fluid.HeatExchangers.DXCoils.Cooling.WaterSource.Data.Generic.DXCoil datCoi(
  nSta=10,minSpeRat=0.1,
    sta={Buildings.Fluid.HeatExchangers.DXCoils.Cooling.WaterSource.Data.Generic.BaseClasses.Stage(
        spe=500/60,
      ...
      perCur=Buildings.Fluid.HeatExchangers.DXCoils.Cooling.WaterSource.Examples.PerformanceCurves.Curve_I()),
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-160,
          ...
          "modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/Cooling/WaterSource/Validation/VariableSpeedEnergyPlusPartLoad.mos"
        "Simulate and plot"),
    experiment(Tolerance=1e-6, StopTime=86400),
    Documentation(info="<html>
<p>
This model validates the model
<a href=\"modelica://Buildings.Fluid.HeatExchangers.DXCoils.Cooling.WaterSource.VariableSpeed\">
Buildings.Fluid.HeatExchangers.DXCoils.Cooling.WaterSource.VariableSpeed</a>.
</p>
<p>
