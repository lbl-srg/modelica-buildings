...
equation
  connect(u.y, watCooCon.u) annotation (Line(points={{-52.7,0},{20,0},{20,-34},{
          12,-34}}, color={0,0,127}));
  connect(mulSpeDX.port_b, port_b1) annotation (Line(points={{10,40},{80,40},{80,
          60},{100,60}}, color={0,127,255}));
  connect(mulSpeDX.port_a, port_a1) annotation (Line(points={{-10,40},{-80,40},{
  ...
  connect(mulSpeDX.QLat_flow, QEvaLat_flow) annotation (Line(points={{11,45},{54,
          45},{54,0},{110,0}}, color={0,0,127}));
  connect(mulSpeDX.stage, stage) annotation (Line(points={{-11,48},{-54,48},{-54,
