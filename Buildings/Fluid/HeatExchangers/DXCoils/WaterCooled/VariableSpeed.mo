...
model VariableSpeed "Variable speed water-cooled DX coils"
  ...
  Modelica.Blocks.Sources.RealExpression u(final y=(-varSpeDX.dxCoo.Q_flow +varSpeDX.P)
...
equation
  connect(u.y, watCooCon.u) annotation (Line(points={{-52.7,0},{20,0},{20,-34},{
          12,-34}}, color={0,0,127}));
  connect(varSpeDX.port_b, port_b1) annotation (Line(points={{10,40},{80,40},{80,
          60},{100,60}}, color={0,127,255}));
  connect(varSpeDX.port_a, port_a1) annotation (Line(points={{-10,40},{-80,40},{
  ...
  connect(senTem.port_a, port_a2) annotation (Line(points={{50,-40},{80,-40},{80,
          -60},{100,-60}}, color={0,127,255}));
  connect(senTem.T,varSpeDX. TConIn) annotation (Line(points={{40,-29},{40,-29},
          {40,0},{-20,0},{-20,43},{-11,43}},   color={0,0,127}));
  connect(mCon.y,varSpeDX. mCon_flow) annotation (Line(points={{-52.7,20},{-20,20},
          {-20,36.8},{-11,36.8}}, color={0,0,127}));
  connect(varSpeDX.P, P) annotation (Line(points={{11,49},{62,49},{62,80},{110,80}},
        color={0,0,127}));
  connect(varSpeDX.QSen_flow, QEvaSen_flow) annotation (Line(points={{11,47},{58,
          47},{58,34},{110,34}}, color={0,0,127}));
  connect(varSpeDX.QLat_flow, QEvaLat_flow) annotation (Line(points={{11,45},{54,
          45},{54,0},{110,0}}, color={0,0,127}));
  connect(varSpeDX.speRat, speRat) annotation (Line(points={{-11,48},{-56,48},{-56,
