...
partial model PartialDXCoil "Partial model for DX coil"
  ...
  replaceable Buildings.Fluid.HeatExchangers.DXCoils.BaseClasses.PartialCoilInterface dxCoiOpe(
    datCoi=datCoi,
    use_mCon_flow=use_mCon_flow)  "DX coil operation"
...
equation
  connect(m.y, dxCoiOpe.m_flow)  annotation (Line(
      points={{-69,44},{-66,44},{-66,54.4},{-21,54.4}},
      color={0,0,127},
      smooth=Smooth.None));

  connect(dxCoiOpe.EIR, pwr.EIR)  annotation (Line(
      points={{1,60},{6,60},{6,76.6},{18,76.6}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(dxCoiOpe.Q_flow, pwr.Q_flow)  annotation (Line(
  ...
  connect(pwr.P, P)    annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(dxCoiOpe.Q_flow, q.Q_flow) annotation (Line(
  ...
  connect(mCon_flow, dxCoiOpe.mCon_flow) annotation (Line(points={{-110,-30},{-24,
