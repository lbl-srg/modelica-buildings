...
model PartialWaterCooledDXCoil
  ...
  parameter MediumEva.ExtraProperty CEva_start[MediumEva.nC](
    final quantity=MediumEva.extraPropertiesNames)=fill(
    0,
    MediumEva.nC)
  ...
  parameter MediumCon.ExtraProperty CCon_start[MediumCon.nC](
    final quantity=MediumCon.extraPropertiesNames)=fill(
    0,
    MediumCon.nC)
    "Start value of trace substances"
  ...
  // Variables
  Modelica.SIunits.Temperature TConEnt=MediumCon.temperature(
  ...
  MediumCon.ThermodynamicState sta_a2=MediumCon.setState_phX(
    ...
    noEvent(
      actualStream(
        portCon_a.Xi_outflow))) if show_T
  ...
  MediumCon.ThermodynamicState sta_b2=MediumCon.setState_phX(
    ...
    noEvent(
      actualStream(
        portCon_b.Xi_outflow))) if show_T
...
protected
  ...
  parameter MediumCon.MassFlowRate mCon_flow_small(
    min=0)=1E-4*abs(
    datCoi.sta[nSta].nomVal.mCon_flow_nominal)
