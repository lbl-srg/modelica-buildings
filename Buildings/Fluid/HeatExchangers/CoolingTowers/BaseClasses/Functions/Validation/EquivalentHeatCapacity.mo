...
equation
  ...
  annotation (
    experiment(
      ...
      StopTime=20),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/CoolingTowers/BaseClasses/Functions/Validation/EquivalentHeatCapacity.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
