...
equation
  connect(weaBus.pAtm, wetBulTem.p)
   annotation (Line(points={{-60,50},{-50,50},{-50,42},{-21,42}},
      color={255,204,51}),
      Text(textString="%first",
      index=-1,
      extent={{-6,3},{-6,3}}));
  connect(weaBus.TDryBul, wetBulTem.TDryBul)
   annotation (Line(points={{-60,50},{-50,50},{-50,58},{-21,58}},
      color={255,204,51}),
      Text(textString="%first",
      index=-1,
      extent={{-6,3},{-6,3}}));
  connect(weaBus.relHum, wetBulTem.phi)
   annotation (Line(points={{-60,50},{-21,50}},color={255,204,51}),
      Text(textString="%first",
      index=-1,
      extent={{-6,3},{-6,3}}));
