...
equation
  connect(TSetLea.y,conFan.u_s)
    annotation (Line(points={{-39,-10},{-32,-10}},color={0,0,127},smooth=Smooth.None));
  connect(conFan.y,tow.y)
    annotation (Line(points={{-9,-10},{6,-10},{6,-42},{20,-42}},color={0,0,127},smooth=Smooth.None));
  connect(tow.TLvg,conFan.u_m)
    annotation (Line(points={{43,-56},{54,-56},{54,-32},{-20,-32},{-20,-22}},color={0,0,127},smooth=Smooth.None));
  ...
  annotation (
    ...
    experiment(
      ...
      StopTime=15724800),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/CoolingTowers/Examples/YorkCalc.mos" "Simulate and plot"),
    Icon(
      coordinateSystem(
        preserveAspectRatio=true,
