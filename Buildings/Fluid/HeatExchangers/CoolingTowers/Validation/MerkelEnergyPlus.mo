...
equation
  ...
  connect(datRea.y[2], TAirWB.u) annotation (Line(points={{-79,70},{-70,70},{
          -70,30},{-62,30}},
                         color={0,0,127}));
  connect(datRea.y[5], TEntWat.u) annotation (Line(points={{-79,70},{-70,70},{
          -70,-34},{-62,-34}},
                           color={0,0,127}));
  connect(datRea.y[7], souWat.m_flow_in) annotation (Line(points={{-79,70},{-70,
          70},{-70,-60},{-30,-60},{-30,-38},{-22,-38}}, color={0,0,127}));
