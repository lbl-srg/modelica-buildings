...
model CoolToolsCrossFlow
  ...
  Buildings.Fluid.HeatExchangers.CoolingTowers.Correlations.BoundsCoolToolsCrossFlow bou
...
protected
  ...
  Modelica.Units.SI.TemperatureDifference TAppCor(
    min=0,
    displayUnit="K")=
    Buildings.Fluid.HeatExchangers.CoolingTowers.Correlations.CoolToolsCrossFlow(
    TRan=TRan,
    TWetBul=TAir,
    FRWat=FRWat,
...
initial equation
  ...
  TApp_nominal = Buildings.Fluid.HeatExchangers.CoolingTowers.Correlations.CoolToolsCrossFlow(
