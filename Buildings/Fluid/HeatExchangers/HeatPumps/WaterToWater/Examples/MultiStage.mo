...
model MultiStage "Test model for multi stage water to water heat pump"
  ...
  Buildings.Fluid.HeatExchangers.HeatPumps.WaterToWater.MultiStage mulSta(
    ...
    "Multi stage water to water heat pump"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  Modelica.Blocks.Sources.IntegerTable intTabHea(table=[0,0; 600,1; 1200,2; 1800,
        0; 2400,0; 2700,0]) "Stage change, heating mode"
    annotation (Placement(transformation(extent={{-60,60},{-40,80}})));
  Modelica.Blocks.Sources.IntegerTable intTabCoo(table=[0,0; 600,0; 1200,0; 1800,
        0; 2400,1; 2700,2]) "Stage change, cooling mode"
...
equation
  ...
  connect(p2.y, sou2.p_in) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(sou1.ports[1], mulSta.port_a1)   annotation (Line(
      points={{-40,10},{-26,10},{-26,6},{-10,6}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(sin2.ports[1], mulSta.port_b2)   annotation (Line(
      points={{-40,-30},{-26,-30},{-26,-6},{-10,-6}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(mulSta.port_b1, sin1.ports[1])   annotation (Line(
      points={{10,6},{26,6},{26,10},{40,10}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(mulSta.port_a2, sou2.ports[1])   annotation (Line(
      points={{10,-6},{24,-6},{24,-30},{40,-30}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(intTabCoo.y, mulSta.cooSta)   annotation (Line(
      points={{-59,50},{-28,50},{-28,2},{-12,2}},
      color={255,127,0},
      smooth=Smooth.None));
  connect(intTabHea.y, mulSta.heaSta)   annotation (Line(
      points={{-39,70},{-20,70},{-20,10},{-12,10}},
      color={255,127,0},
      smooth=Smooth.None));
  annotation (Diagram(graphics),__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/HeatPumps/WaterToWater/Examples/MultiStage.mos"
        "Simulate and plot"),
...
Also the control inputs i.e. the stages of coil is varied along with mode of operation.
</p>
</html>",
revisions="<html>
<ul>
