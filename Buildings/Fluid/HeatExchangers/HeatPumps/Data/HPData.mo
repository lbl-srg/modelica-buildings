within Buildings.Fluid.HeatExchangers.HeatPumps.Data;
record HPData "Performance record for a heat pump with one or multiple stages"
  ...
  parameter
    Buildings.Fluid.HeatExchangers.HeatPumps.Data.BaseClasses.HeatingStage heaSta[nHeaSta]
    "Data record for heat pump performance in heating mode at each stage";

  parameter
    Buildings.Fluid.HeatExchangers.HeatPumps.Data.BaseClasses.CoolingStage cooSta[nCooSta]
