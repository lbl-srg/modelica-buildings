...
extends Modelica.Icons.Example;
  ...
  Buildings.Fluid.HeatExchangers.HeatPumps.WaterToAir.BaseClasses.DryCoil dryCoi(
...
equation
  connect(p.y, dryCoi.p)  annotation (Line(
      points={{-19,-50},{0,-50},{0,7.6},{59,7.6}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(XIn.y, dryCoi.XIn)     annotation (Line(
      points={{-19,-80},{6,-80},{6,5},{59,5}},
      color={0,0,127},
      smooth=Smooth.None));
...
file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/HeatPumps/WaterToAir/BaseClasses/Examples/DryCoil.mos"
        "Simulate and plot"),
          Documentation(info="<html>
<p>
This example illustrates working of DryCoil block 
<a href=\"modelica://Buildings.Fluid.HeatExchangers.HeatPumps.WaterToAir.BaseClasses.DryCoil\">
Buildings.Fluid.HeatExchangers.HeatPumps.WaterToAir.BaseClasses.DryCoil</a>. 
</p>
</html>",
revisions="<html>
<ul>
