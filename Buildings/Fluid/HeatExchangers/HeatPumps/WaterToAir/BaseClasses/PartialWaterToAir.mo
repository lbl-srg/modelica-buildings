...
partial model PartialWaterToAir "Partial model for water to air heat pump"
  ...
  parameter Buildings.Fluid.HeatExchangers.HeatPumps.WaterToAir.Data.HPData datHP
    "Heat pump data";
