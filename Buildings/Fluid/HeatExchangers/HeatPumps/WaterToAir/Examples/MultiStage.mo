...
model MultiStage "Test model for multi stage water to air heat pump"
  ...
  Buildings.Fluid.HeatExchangers.HeatPumps.WaterToAir.MultiStage mulSta(
    ...
    calRecoverableWasteHeat=true) "Multi stage water to air heat pump"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
  Modelica.Blocks.Sources.IntegerTable intTabHea(table=[0,0; 600,1; 1200,1;
        1800,0; 2400,0; 2700,0]) "Stage change, heating mode"
    annotation (Placement(transformation(extent={{-60,60},{-40,80}})));
  Modelica.Blocks.Sources.IntegerTable intTabCoo(table=[0,0; 600,0; 1200,0;
        1800,0; 2400,1; 2700,2]) "Stage change, cooling mode"
...
equation
  ...
  connect(intTabHea.y, mulSta.heaSta) annotation (Line(
      points={{-39,70},{-22,70},{-22,10},{-12,10}},
      color={255,127,0},
      smooth=Smooth.None));
  connect(intTabCoo.y, mulSta.cooSta) annotation (Line(
      points={{-59,50},{-32,50},{-32,2},{-12,2}},
      color={255,127,0},
      smooth=Smooth.None));
  annotation (Diagram(graphics),__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/HeatPumps/WaterToAir/Examples/MultiStage.mos"
        "Simulate and plot"),
