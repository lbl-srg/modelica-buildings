...
model SingleSpeed "Test model for single speed air to air heat pump"
  ...
  Modelica.Blocks.Sources.Ramp p2(
    ...
    offset=101325,
    startTime=60,
    height=1000) "Pressure"
    annotation (Placement(transformation(extent={{10,-10},{-10,10}},
        rotation=0,
        origin={90,-30})));
  Buildings.Fluid.HeatExchangers.HeatPumps.AirToAir.SingleSpeed sinSpe(
    ...
    homotopyInitialization=true) "Single speed water to air heat pump"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}})));
...
"modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/HeatPumps/AirToAir/Examples/SingleSpeed.mos"
        "Simulate and plot"),
          Documentation(info="<html>
<p>
This is a test model for  
<a href=\"modelica://Buildings.Fluid.HeatExchangers.HeatPumps.AirToAir.Examples.SingleSpeed\">
Buildings.Fluid.HeatExchangers.HeatPumps.AirToAir.Examples.SingleSpeed</a>. 
