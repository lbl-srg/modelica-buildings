...
model WetCoil1 "Calculates wet coil condition "
...
equation
  ...
  connect(T[2], cooCap.T2In) annotation (Line(
      points={{-110,55},{-62,55},{-62,58},{-1,58}},
      color={0,0,127},
      smooth=Smooth.None));
...
//        smooth=Smooth.None), Dialog(enable = (if (nm_flow==2) then true else false)));
  ...
  connect(speShiQ_flow.y, conRat.Q_flow) annotation (Line(
      ...
      smooth=Smooth.None));
  connect(m_flow[1], cooCap.m1_flow) annotation (Line(
      points={{-110,19},{-92,19},{-92,62},{-1,62}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(m_flow[2], cooCap.m2_flow) annotation (Line(
      points={{-110,29},{-92,29},{-92,54},{-1,54}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(m_flow[1], appDewPt.m_flow) annotation (Line(
      points={{-110,19},{-76,19},{-76,-49},{-41,-49}},
      color={0,0,127},
      smooth=Smooth.None));
