...
model WetCoil "Test model for WetCoil"
 ...
 package Medium =
      Buildings.Media.Air;
  Buildings.Fluid.HeatExchangers.HeatPumps.AirToAir.BaseClasses.WetCoil wetCoi(
...
equation
  ...
  connect(T2.y, wetCoi.T[2]) annotation (Line(
   ...
   connect(m2_flow.y, wetCoi.m_flow[2]) annotation (Line(
       ...
       color={0,0,127},
       smooth=Smooth.None));
// connect(m1_flow.y, wetCoi.m1_flow[1]) annotation (Line(
//       points={{-59,-30},{-34,-30},{-34,10},{69,10}},
//       color={0,0,127},
//       smooth=Smooth.None));
