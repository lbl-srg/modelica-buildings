...
algorithm
  ...
  //------------ Correction factor for flow rate outside of validity of data ---//
    ...
    Q_flow[iSta]     := corFac1[iSta]*cap_T[iSta]*cap_FF1[iSta]*cooSta[iSta].nomVal.Q_flow_nominal + 0*m2_flow;
    EIR[iSta]        := corFac1[iSta]*EIR_T[iSta]*EIR_FF1[iSta]/cooSta[iSta].nomVal.COP_nominal;
