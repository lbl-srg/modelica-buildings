...
model DXCooling "This block performs cooling operation "
  import Buildings;
  extends
...
parameter Buildings.Fluid.HeatExchangers.HeatPumps.AirToAir.Data.HPData
  ...
  Buildings.Fluid.HeatExchangers.HeatPumps.AirToAir.BaseClasses.WetCoil wetCoi(
    ...
    cooCap(
      nSta=datHP.nCooSta,
      cooSta=datHP.cooSta,
      m1_flow_small=datHP.m1_flow_small)) "Wet coil condition"
    annotation (Placement(transformation(extent={{-50,40},{-30,60}})));

  Buildings.Fluid.HeatExchangers.HeatPumps.AirToAir.BaseClasses.DryCoil dryCoi(
    redeclare final package Medium = Medium,
    datHP=datHP,
    cooCap(
      nSta=datHP.nCooSta,
      cooSta=datHP.cooSta,
      m1_flow_small=datHP.m1_flow_small)) "Dry coil condition"
