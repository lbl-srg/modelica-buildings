...
extends Modelica.Icons.Example;
  ...
  Buildings.Fluid.HeatExchangers.HeatPumps.BaseClasses.DryCoil dryCoi(
    ...
    datHP=datHP,
    calRecoverableWasteHeat=true) "Performs calculation for dry coil condition"
...
equation
  ...
  connect(m1_flow.y, dryCoi.m_flow[1]) annotation (Line(
      points={{-59,-22},{-44,-22},{-44,11.9},{59,11.9}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(m2_flow.y, dryCoi.m_flow[2]) annotation (Line(
      points={{-59,-56},{-44,-56},{-44,12.9},{59,12.9}},
      color={0,0,127},
      smooth=Smooth.None));
