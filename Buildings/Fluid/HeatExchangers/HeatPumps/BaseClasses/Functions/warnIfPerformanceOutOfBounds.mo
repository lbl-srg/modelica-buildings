within Buildings.Fluid.HeatExchangers.HeatPumps.BaseClasses.Functions;
...
algorithm
  ...
  if (retVal <> 0) then
      ...
      Modelica.Utilities.Streams.print("*** Warning: Heat pump performance curves at nominal conditions are outside of bounds.");
