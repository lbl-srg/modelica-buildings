...
model SixPort "Partial model with six ports"
  ...
  parameter Modelica.SIunits.SpecificEnthalpy h_outflow_a3_start = Medium3.h_default
    "Start value for enthalpy flowing out of port a3"
    annotation (Dialog(tab="Advanced", group="Initialization"));

  parameter Modelica.SIunits.SpecificEnthalpy h_outflow_b3_start = Medium3.h_default
    "Start value for enthalpy flowing out of port b3"
    annotation (Dialog(tab="Advanced", group="Initialization"));
...
<p>
This model defines an interface for components with six ports.
...
Modelica.Fluid.Interfaces.PartialTwoPort</a>, except that it has six ports.
</p>
</html>", revisions="<html>
<ul>
<li>
