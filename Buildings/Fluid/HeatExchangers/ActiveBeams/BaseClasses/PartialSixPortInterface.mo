...
partial model PartialSixPortInterface
  "Partial model transporting fluids between six ports without storing mass or energy"
  extends Buildings.Fluid.HeatExchangers.ActiveBeams.BaseClasses.SixPort;
  ...
  parameter Medium2.MassFlowRate m2_flow_small(min=0) = 1E-4*abs(m2_flow_nominal)
    "Small mass flow rate for regularization of zero flow"
    annotation(Dialog(tab = "Advanced"));
  parameter Medium3.MassFlowRate m3_flow_small(min=0) = 1E-4*abs(m2_flow_nominal)
    "Small mass flow rate for regularization of zero flow"
    annotation(Dialog(tab = "Advanced"));
  // Diagnostics
  ...
  Medium2.ThermodynamicState sta_b2=
   ...
   Medium3.ThermodynamicState sta_a3=
      Medium2.setState_phX(port_a3.p,
...
transport three fluid streams between six ports.
It is similar to
<a href=\"modelica://Buildings.Fluid.Interfaces.PartialTwoPortInterface\">
Buildings.Fluid.Interfaces.PartialTwoPortInterface</a>,
but it has six ports instead of two.
</p>
<p>
