...
equation
  ...
  connect(pum.port_b, beaCooHea.watHea_a)
    annotation (Line(points={{0,60},{15,60},{30,60}}, color={0,127,255}));
  connect(beaCooHea.watHea_b, sin_2.ports[1])
    annotation (Line(points={{50,60},{80,60}}, color={0,127,255}));
  connect(pum1.port_b, beaCooHea.watCoo_a) annotation (Line(points={{0,100},{20,
          100},{20,66},{30,66}}, color={0,127,255}));
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-120,
            -120},{120,120}})),experiment(StopTime=172800),__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/Examples/HeaAndCoo.mos"
        "Simulate and plot"),
