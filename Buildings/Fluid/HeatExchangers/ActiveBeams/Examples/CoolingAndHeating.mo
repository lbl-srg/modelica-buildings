...
model CoolingAndHeating
  ...
  Buildings.Fluid.Movers.FlowControlled_m_flow pumColWat(
    redeclare package Medium = MediumW,
    m_flow_nominal=0.094,
    addPowerToMedium=false,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
...
equation
  ...
  connect(conHea.y, pumHotWat.m_flow_in) annotation (Line(points={{-49,-10},{-40,
          -10},{-40,80},{-10.2,80},{-10.2,72}}, color={0,0,127}));
  ...
  connect(pumColWat.port_a, sou_1.ports[1])
  ...
  connect(conCoo.y, pumColWat.m_flow_in) annotation (Line(points={{-49,30},{-30,
          30},{-30,116},{-10.2,116},{-10.2,112}}, color={0,0,127}));
  connect(pumColWat.port_b, beaCooHea.watCoo_a) annotation (Line(points={{0,100},
          {8,100},{20,100},{20,66},{26,66}}, color={0,127,255}));
