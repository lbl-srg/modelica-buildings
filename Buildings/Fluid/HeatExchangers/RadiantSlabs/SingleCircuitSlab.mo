...
protected
  ...
  BaseClasses.PipeToSlabConductance fluSlaCon[nSeg](
    ...
    each final RWal=Modelica.Math.log(
      pipe.dOut/pipe.dIn)/(2*Modelica.Constants.pi*pipe.k*(length/nSeg)),
  ...
  Modelica.SIunits.MassFraction Xi_in_a[Medium.nXi]=inStream(
    port_a.Xi_outflow)
    "Inflowing mass fraction at port_a";
  Modelica.SIunits.MassFraction Xi_in_b[Medium.nXi]=inStream(
    port_b.Xi_outflow)
    "Inflowing mass fraction at port_a";
