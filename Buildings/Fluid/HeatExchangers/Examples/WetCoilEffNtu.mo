...
model WetCoilEffNtu "Example of usage of the WetCoilEffNtu model"
  ...
  Modelica.SIunits.SpecificEnthalpy hAirIn, hWatIn, hAirOut, hWatOut
    "Specific enthalpies at the various ports";

equation
  hWatIn = Medium_W.specificEnthalpy(
    Medium_W.setState_ph(
      p=wetEffNtu.port_a1.p,
      h=actualStream(wetEffNtu.port_a1.h_outflow)));
  hWatOut = Medium_W.specificEnthalpy(
    Medium_W.setState_ph(
      p=wetEffNtu.port_b1.p,
      h=actualStream(wetEffNtu.port_b1.h_outflow)));
  hAirIn = Medium_W.specificEnthalpy(
  ...
  hAirOut = Medium_W.specificEnthalpy(
    Medium_W.setState_phX(
  ...
  QTotWat = masFloWatNom * (hWatOut - hWatIn);
  QTotAir = masFloAirNom * (hAirOut - hAirIn);
