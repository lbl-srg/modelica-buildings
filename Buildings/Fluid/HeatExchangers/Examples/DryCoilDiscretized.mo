...
model DryCoilDiscretized
  ...
  Buildings.Fluid.HeatExchangers.DryCoilDiscretized hex(
    ...
    UA_nominal=m1_flow_nominal*4200*(T_a1_nominal-T_b1_nominal)/Buildings.Fluid.HeatExchangers.BaseClasses.lmtd(
      T_a1_nominal,
      T_b1_nominal,
      T_a2_nominal,
      T_b2_nominal),
...
equation
  ...
  annotation (
    experiment(
      ...
      StopTime=360),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/DryCoilDiscretized.mos" "Simulate and plot"),
    Documentation(
      revisions="<html>
<ul>
<li>
