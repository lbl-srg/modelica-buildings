...
model Wet_Retreive_Textbook_back
  ...
  UA_nominalFromOperatingCondition uA_nominalFromOperatingCondition
    annotation (Placement(transformation(extent={{104,-242},{172,-130}})));
  ...
  Modelica.Blocks.Sources.RealExpression mWatFlo(y=m1_flow_nominal)
    annotation (Placement(transformation(extent={{-130,-218},{-90,-178}})));
  Modelica.Blocks.Sources.RealExpression mAirFlo(y=m2_flow_nominal)
    annotation (Placement(transformation(extent={{-82,-204},{-42,-164}})));
equation
  ...
  connect(TDryBulIn.T, uA_nominalFromOperatingCondition.TAirIn) annotation (
      Line(
      points={{60,-69},{60,-48},{46,-48},{46,-130},{103.32,-130}},
      color={85,255,255},
      thickness=0.5,
      pattern=LinePattern.Dash));
  connect(TDryBulOut.T, uA_nominalFromOperatingCondition.TAirOut) annotation (
      Line(
      points={{-80,-51},{-80,-143.44},{103.32,-143.44}},
      color={85,255,255},
      thickness=0.5,
      pattern=LinePattern.Dash));
  ...
  connect(TWatIn.T, uA_nominalFromOperatingCondition.TWatIn) annotation (Line(
      points={{-94,9},{-94,-156},{103.32,-156},{103.32,-156.88}},
      color={85,255,255},
      thickness=0.5,
      pattern=LinePattern.Dash));
  connect(TWatOut.T, uA_nominalFromOperatingCondition.TWatOut) annotation (Line(
      points={{20,7},{22,7},{22,-170.32},{103.32,-170.32}},
      color={85,255,255},
      thickness=0.5,
      pattern=LinePattern.Dash));
  connect(mWatFlo.y, uA_nominalFromOperatingCondition.mWatFlo) annotation (Line(
      points={{-88,-198},{10,-198},{10,-197.2},{103.32,-197.2}},
      color={85,255,255},
      thickness=0.5,
      pattern=LinePattern.Dash));
  connect(mAirFlo.y, uA_nominalFromOperatingCondition.mAirFlo) annotation (Line(
      points={{-40,-184},{35,-184},{35,-183.76},{103.32,-183.76}},
      color={85,255,255},
      thickness=0.5,
      pattern=LinePattern.Dash));
  connect(senMasFraOut.X, uA_nominalFromOperatingCondition.wAirOut) annotation
    (Line(
      points={{-120,-51},{-120,-224.08},{103.32,-224.08}},
      color={85,255,255},
      thickness=0.5,
      pattern=LinePattern.Dash));
  connect(senMasFraIn.X, uA_nominalFromOperatingCondition.wAirIn) annotation (
      Line(
      points={{100,-69},{100,-60},{80,-60},{80,-210.64},{103.32,-210.64}},
      color={85,255,255},
      thickness=0.5,
      pattern=LinePattern.Dash));
...
end Wet_Retreive_Textbook_back;
