...
model WetCoilEffectivenessNTU_heating
...
equation
  ...
  experiment(
    ...
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-200,-120},{200,
            80}})),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/Validation/WetCoilEffectivenessNTU_heating.mos"
        "Simulate and plot"));
end WetCoilEffectivenessNTU_heating;
