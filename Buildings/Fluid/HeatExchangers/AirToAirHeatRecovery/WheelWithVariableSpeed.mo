...
equation
  ...
  connect(effCal.epsL, hex.epsL) annotation (Line(points={{-33,106},{-30,106},{-30,
          -4},{-12,-4}}, color={0,0,127}));
  connect(senExhFlow.port_a, port_a2) annotation (Line(points={{34,-6},{64,-6},{
          64,-60},{100,-60}}, color={0,127,255}));
  connect(senSupFlow.port_a, port_a1) annotation (Line(points={{-46,20},{-60,20},
          {-60,60},{-100,60}}, color={0,127,255}));
  connect(effCal.y, wheSpe) annotation (Line(points={{-56,118},{-74,118},{-74,0},
          {-120,0}}, color={0,0,127}));
  annotation (
