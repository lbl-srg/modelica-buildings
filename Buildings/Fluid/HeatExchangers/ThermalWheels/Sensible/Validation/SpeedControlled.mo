...
model SpeedControlled
  ...
  Buildings.Fluid.HeatExchangers.ThermalWheels.Sensible.SpeedControlled wheUseDefCur(
    redeclare package Medium = Medium,
    mSup_flow_nominal=5,
    mExh_flow_nominal=5,
    P_nominal=100,
  ...
  Buildings.Fluid.HeatExchangers.ThermalWheels.Sensible.SpeedControlled wheDefCur(
    redeclare package Medium = Medium,
    mSup_flow_nominal=5,
    mExh_flow_nominal=5,
    P_nominal=100) "Wheel with a default curve"
