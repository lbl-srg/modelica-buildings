...
model Sensible "Sensible heat wheels"
  ...
  final parameter Real[size(xSpe,1)] yeta = if per.useDefaultMotorEfficiencyCurve
    ...
    annotation (Dialog(group="Efficiency"));
  parameter Buildings.Fluid.HeatExchangers.ThermalWheels.BaseClasses.BaseClasses.Data.Generic per
...
<a href=\"modelica://Buildings.Fluid.HeatExchangers.ThermalWheels.BaseClasses.BaseClasses.Characteristics.motorEfficiencyParameters\">
Buildings.Fluid.HeatExchangers.ThermalWheels.BaseClasses.BaseClasses.Characteristics.motorEfficiencyParameters</a>).
...
dataset (see <a href=\"modelica://Buildings.Fluid.HeatExchangers.ThermalWheels.BaseClasses.BaseClasses.Characteristics.heatExchangerEffectivenessParameters\">
