...
model WetCoilCoolingFuzzy_V2_2
...
equation
  ...
  connect(ySou.y, swi.u3) annotation (Line(points={{-168,-90},{-158,-90},{-158,-68},
          {-152,-68}}, color={0,0,127}));
  connect(gai.u, swi.y) annotation (Line(points={{-122,-60},{-128,-60}}, color={0,0,127}));
  connect(con.y, swi.u1) annotation (Line(points={{-168,-30},{-158,-30},{-158,-52},
  ...
  experiment(
    ...
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-200,-140},{200,
            80}})),
    __Dymola_Commands(file="Resources/Scripts/Dymola/Fluid/HeatExchangers/Validation/WetCoilCoolingFuzzy_V2_2.mos"
        "Simulate and plot"));
end WetCoilCoolingFuzzy_V2_2;
