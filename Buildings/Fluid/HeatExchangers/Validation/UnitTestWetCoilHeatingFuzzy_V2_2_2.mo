...
model UnitTestWetCoilHeatingFuzzy_V2_2_2
...
equation
  ...
  connect(TAout.port, hexWetNtu.port_b2) annotation (Line(points={{-72,44},{0,44},
          {0,6},{18,6}}, color={0,127,255}));
  connect(hexWetNtu.port_a2, TAin.port) annotation (Line(points={{38,6},{44,6},{
          44,42},{50,42}}, color={0,127,255}));
  annotation (
  experiment(
    StopTime=2000),
    ...
    __Dymola_Commands(file="Resources/Scripts/Dymola/Fluid/HeatExchangers/Validation/UnitTestWetCoilHeating.mos"
        "Simulate and plot"));
end UnitTestWetCoilHeatingFuzzy_V2_2_2;
