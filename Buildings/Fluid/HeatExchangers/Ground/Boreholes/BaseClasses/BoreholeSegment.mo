within Buildings.Fluid.HeatExchangers.Ground.Boreholes.BaseClasses;
model BoreholeSegment "Vertical segment of a borehole"
 ...
 Buildings.Fluid.HeatExchangers.Ground.Boreholes.BaseClasses.HexInternalElement pipFil(
  ...
  Buildings.Fluid.HeatExchangers.Ground.Boreholes.BaseClasses.SingleUTubeBoundaryCondition
    TBouCon(
    final matSoi=matSoi,
    final rExt=rExt,
    final hSeg=hSeg,
...
<a href=\"modelica://Buildings.Fluid.HeatExchangers.Ground.Boreholes.BaseClasses.HexInternalElement\">
Buildings.Fluid.HeatExchangers.Ground.Boreholes.BaseClasses.HexInternalElement</a>.
</p>
<p>
...
Buildings.Fluid.HeatExchangers.Ground.Boreholes.BaseClasses.SingleUTubeBoundaryCondition</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
