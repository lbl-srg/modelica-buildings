...
model FlowSplitter_u "Flow splitter"
  ...
  FMUs.FlowSplitter_u floSpl(redeclare package Medium = Medium, use_p_in=use_p_in, allowFlowReversal=
        allowFlowReversal)
    annotation (Placement(transformation(extent={{50,-10},{70,10}})));
equation
  connect(m_flow.y, sou.m_flow_in) annotation (Line(
      points={{-49,70},{-38,70},{-38,10},{-18,10}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(sou.p_in, pIn.y) annotation (Line(
      points={{-18,4.8},{-36,4.8},{-36,6},{-42,6},{-42,40},{-49,40}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(TIn.y, sou.T_in) annotation (Line(
      points={{-49,10},{-44,10},{-44,0},{-18,0}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(C.y, sou.C_in) annotation (Line(
      points={{-49,-60},{-38,-60},{-38,-10},{-18,-10}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(X_w_in.y, sou.X_w_in) annotation (Line(
      points={{-49,-20},{-40,-20},{-40,-5},{-18,-5}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(floSpl.u[1], uSpl.y) annotation (Line(
      points={{49,7.5},{30,7.5},{30,50},{-9,50}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(floSpl.u[2], uSpl.y) annotation (Line(
      points={{49,8.5},{20,8.5},{20,50},{-9,50}},
      color={0,0,127},
      smooth=Smooth.None));
