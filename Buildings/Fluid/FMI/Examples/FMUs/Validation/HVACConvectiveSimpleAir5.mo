...
block HVACConvectiveSimpleAir5
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FMI/Examples/FMUs/Validation/HVACConvectiveSimpleAir5.mos"
        "Export FMU"));
end HVACConvectiveSimpleAir5;
