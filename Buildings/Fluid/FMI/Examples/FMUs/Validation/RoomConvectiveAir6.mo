...
block RoomConvectiveAir6 "Validation of simple thermal zone"
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FMI/Examples/FMUs/Validation/RoomConvectiveAir6.mos"
        "Export FMU"));
end RoomConvectiveAir6;
