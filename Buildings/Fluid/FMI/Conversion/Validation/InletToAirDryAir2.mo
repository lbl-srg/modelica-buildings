...
model InletToAirDryAir2
  "Validation model for inlet to air with dry air medium and CO2"
  extends Buildings.Fluid.FMI.Conversion.Validation.InletToAir2(
    redeclare package Medium = Modelica.Media.Air.SimpleAir(extraPropertiesNames={"CO2"}));
  annotation (Documentation(info="<html>
<p>
This validation test is identical to
<a href=\"modelica://Buildings.Fluid.FMI.Conversion.Validation.InletToAir2\">
Buildings.Fluid.FMI.Conversion.Validation.InletToAir2</a>
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FMI/Conversion/Validation/InletToAirDryAir2.mos"
        "Simulate and plot"),
    experiment(StopTime=1));
end InletToAirDryAir2;
