...
block HVACConvectiveAir4 "Validation model for the convective HVAC system"
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FMI/Adaptors/FMUs/Validation/HVACConvectiveAir4.mos"
        "Export FMU"));
