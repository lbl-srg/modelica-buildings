...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Validation/FMUs/HVACConvectiveSingleZoneAir1.mos"
        "Export FMU"));
end HVACConvectiveSingleZoneAir1;
