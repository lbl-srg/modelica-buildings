...
block HVACConvectiveSingleZoneSimpleAir4
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Validation/FMUs/HVACConvectiveSingleZoneSimpleAir4.mos"
        "Export FMU"));
end HVACConvectiveSingleZoneSimpleAir4;
