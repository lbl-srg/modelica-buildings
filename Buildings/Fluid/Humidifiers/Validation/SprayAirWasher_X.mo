...
model SprayAirWasher_X
  ...
  replaceable Buildings.Fluid.Humidifiers.SprayAirWasher_X hum(
    ...
    constrainedby Buildings.Fluid.HeatExchangers.BaseClasses.PartialPrescribedOutlet(
      redeclare package Medium=Medium,
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Humidifiers/Validation/SprayAirWasher_X.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
