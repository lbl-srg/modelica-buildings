...
model IndirectWet "Validation model for indirect wet evaporative cooler"
  ...
  Buildings.Fluid.Humidifiers.EvaporativePads.IndirectWet indWetEvaCoo(
  ...
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable(
    final columns=2:12,
    final fileName=ModelicaServices.ExternalReferences.loadResource("modelica://Buildings/Resources/Data/Fluid/Humidifiers/EvaporativePads/IndirectWet/IndirectWet.dat"),
...
annotation (
  ...
  __Dymola_Commands(file = "modelica://Buildings/Resources/Scripts/Dymola/Fluid/Humidifiers/EvaporativePads/Validation/IndirectWet.mos" "Simulate and plot"),
  Documentation(info = "<html>
<p>
This model validates the indirect wet evaporative cooler model
<a href=\"modelica://Buildings.Fluid.Humidifiers.EvaporativePads.IndirectWet\">
Buildings.Fluid.Humidifiers.EvaporativePads.IndirectWet</a>.
</p>
<p>
