...
model DirectCalculation "Validation of the direct evaporative pad calculation"
  ...
  Buildings.Fluid.Humidifiers.EvaporativePads.BaseClasses.DirectCalculation dirEvaPadCal(
  ...
  Buildings.Fluid.Humidifiers.EvaporativePads.BaseClasses.DirectCalculation dirEvaPadCal1(
    redeclare package Medium = Buildings.Media.Air,
    final padAre=padAre,
    redeclare Buildings.Fluid.Humidifiers.EvaporativePads.Data.Generic per)
    "Instance with time-varying wetbulb temperature signal" annotation (
      Placement(transformation(origin={30,0}, extent={{-10,-10},{10,10}})));
  Buildings.Fluid.Humidifiers.EvaporativePads.BaseClasses.DirectCalculation dirEvaPadCal2(
    redeclare package Medium = Buildings.Media.Air,
    final padAre=padAre,
    redeclare Buildings.Fluid.Humidifiers.EvaporativePads.Data.Generic per)
