...
Curve Fitting Evaporative Media</a> section of the EnergyPlus 23.1 engineering reference,
the curve fitting equation that relates the saturation efficiency of an evaporative pad &eta; to
the pad depth <i>d</i> and air velocity <i>v</i> through the pad is as follows:
</p>
<p align=\"center\">
...
<p>
Data point pairs of saturation efficiency vs. air velocity are digitized from this curve fitting equation
for a specific pad depth. Data point pairs include air velocity values between the normal domain of
<i>0 - 4.575 m/s</i>, as well as two additional air velocity values that are 10 times and 100 times of
the maximum value of the normal domain, <i>45.75 m/s</i> and <i>457.5 m/s</i>. The saturation effciency 
values from the data point pairs are limited within the range of <i>0% - 100%</i>.
</p>
<p>
The EnergyPlus 23.1 engineering reference does not specify the pressure drop through evaporative pads as a function
of air velocity and pad depth. However, an equation of the following form is used:
</p>
<p align=\"center\">
