...
equation
  ...
  connect(senTemWetBul.T, dirEvaCoo.TWetBulIn)  annotation (Line(points={{-40,11},{-40,66},{18,66}}, color={0,0,127}));
  connect(senTem.T, dirEvaCoo.TDryBulIn) annotation (Line(points={{-70,11},{-70,62},{18,62}}, color={0,0,127}));
  connect(senTem.port_b, senTemWetBul.port_a) annotation (Line(points={{-60,0},
          {-50,0}},                                                                         color={0,127,255}));
  connect(senTemWetBul.port_b,senVolFlo. port_a) annotation (Line(points={{-30,0},{-20,0}}));
  ...
  connect(senTem.port_a, senPre.port) annotation (Line(points={{-80,0},{-90,0},{-90,44}},  color={0,127,255}));
  ...
  connect(senVolFlo.port_b, res.port_a) annotation (Line(points={{0,0},{20,0}},   color={0,127,255}));
  connect(dirEvaCoo.dmWat_flow, dmWat_flow) annotation (Line(points={{42,60},{60,
...
<p>This model cools the airstream down by adiabatically increasing the humidity 
