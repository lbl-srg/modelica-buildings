...
model IndirectDry "Validation model for indirect dry evaporative cooler"
  ...
  parameter Modelica.Units.SI.MassFlowRate m_flow_nominal_AirPri= 0.002
  ...
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable(
    columns=2:12,
    fileName = ModelicaServices.ExternalReferences.loadResource("modelica://Buildings/Resources/Data/Fluid/Humidifiers/EvaporativeCoolers/IndirectDry/IndirectDry.dat"),
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem(
    ...
    annotation (Placement(visible = true, transformation(origin={10,20},     extent = {{-10, -10}, {10, 10}}, rotation = 0)));
