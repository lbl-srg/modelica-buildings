...
<ul>
<li>Time-varying inlet air dry bulb temperature <span style=\"font-family: Courier New;\">TDryBulIn</span>. </li>
<li>Time-varying inlet air wet bulb temperature <span style=\"font-family: Courier New;\">TWetBulIn</span>. </li>
<li>Time-varying inlet air volume flow rate <span style=\"font-family: Courier New;\">V_flow</span>. </li>
</ul>
<p>The pressure <span style=\"font-family: Courier New;\">p</span> is the atmospheric pressure for all the three validation instances. </p>
<p>The plots generated by the validation scripts show that the mass of water vapour added <span style=\"font-family: Courier New;\">dmWat_flow</span>, and hence the cooling rate, changes as follows. </p>
<ul>
<li>On plot 1, with constant values of <span style=\"font-family: Courier New;\">TWetBulIn</span>, <span style=\"font-family: Courier New;\">TDryBulIn</span>, and <span style=\"font-family: Courier New;\">p</span>, an increasing <span style=\"font-family: Courier New;\">V_flow</span> leads to decreasings in <span style=\"font-family: Courier New;\">eff</span> and <span style=\"font-family: Courier New;\">XiOut</span>. Sine <span style=\"font-family: Courier New;\">V_flow</span> is the dominant term in the equations, this leads to an increase in <span style=\"font-family: Courier New;\">dmWat_flow</span>. </li>
<li>On plot 2, with constant values of <span style=\"font-family: Courier New;\">TDryBulIn</span>, <span style=\"font-family: Courier New;\">p</span>, and <span style=\"font-family: Courier New;\">V_flow</span>, an increasing <span style=\"font-family: Courier New;\">TWetBulIn</span> leads to an increase in <span style=\"font-family: Courier New;\">XiIn</span>. Based on the performance curve, <span style=\"font-family: Courier New;\">TDryBulOut</span> and <span style=\"font-family: Courier New;\">XiOut</span> keep constant.This results in an increase of <span style=\"font-family: Courier New;\">dmWat_flow</span>. </li>
<li>On plot 3, with constant values of <span style=\"font-family: Courier New;\">TWetBulIn</span>, <span style=\"font-family: Courier New;\">p</span>, and <span style=\"font-family: Courier New;\">V_flow</span>, an increasing <span style=\"font-family: Courier New;\">TDryBulIn</span> leads to a decrease in <span style=\"font-family: Courier New;\">XiIn</span>. Based on the performance curve, <span style=\"font-family: Courier New;\">TDryBulOut</span> and <span style=\"font-family: Courier New;\">XiOut</span> keep constant. This results in an increase of <span style=\"font-family: Courier New;\">dmWat_flow. </span></li>
</ul>
</html>", revisions="<html>
<ul>
<li>
