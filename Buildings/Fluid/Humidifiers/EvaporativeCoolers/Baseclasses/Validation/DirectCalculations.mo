...
equation
  ...
  <ul><li>time-varying inlet air dry bulb temperature <code>TDryBulIn</code>.</li>
  ...
  <p>
  The pressure <code>p</code> is the atmospheric pressure for all the three 
  ...
  <ul>
  <li>
  It increases with an increase in <code>TDryBulIn</code>.
  </li>
  <li>
  It decreases with an increase in <code>TWetBulIn</code>.
  </li>
  <li>
  It increases with an increase in <code>V_flow</code>.
  </li>
  </ul>
</html>", revisions="<html>
<ul>
