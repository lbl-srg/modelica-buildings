...
<p>
This record declares the performance data for the air handler model. 
The performance data are structured as follows:
</p>
<pre>
    nomVal  - Nominal performance values for each component. 
       ...
       UA_nominal      - Thermal conductance at nominal flow, used to compute time constant
    ...
    perCur  - Records with performance curve for the fan in the air hanlder. 
</pre>
<p>
The data used to develop the performance curve of the fan should follow the record in 
