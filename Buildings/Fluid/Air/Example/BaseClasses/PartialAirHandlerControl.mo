...
partial model PartialAirHandlerControl
  ...
  Sensors.TemperatureTwoPort                 temSen(redeclare package Medium =
  ...
  Sensors.MassFractionTwoPort                 massFraction(redeclare package
...
equation
  ...
  connect(TWat.y,sou_1. T_in) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(temSen.port_b, massFraction.port_a)
    annotation (Line(points={{-10,10},{-26,10}}, color={0,127,255}));
  connect(massFraction.port_b, res_2.port_a)
