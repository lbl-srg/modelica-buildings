...
partial model PartialAirHandlerMassFlow
  ...
  parameter Modelica.SIunits.MassFlowRate m1_flow_nominal=2.9
    "Nominal mass flow rate medium 1";
  parameter Modelica.SIunits.MassFlowRate m2_flow_nominal=3.3
    "Nominal mass flow rate medium 1";
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-120,-100},
            {180,180}})),                                        Diagram(
        coordinateSystem(preserveAspectRatio=false, extent={{-120,-100},{180,180}})));
