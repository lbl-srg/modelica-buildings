...
model AirHandlingUnit
  ...
  extends Buildings.Fluid.Air.BaseClasses.EssentialParameter(redeclare parameter Buildings.Fluid.Air.Example.Data.Data_I dat);
 ...
 // fan parameters
  ...
  Buildings.Fluid.Movers.SpeedControlled_y fan(
    ...
    final show_T=show_T,
    final m_flow_small=m2_flow_nominal,
    final energyDynamics=energyDynamics,
...
equation
  ...
  connect(fan.port_b, port_b2)
    annotation (Line(points={{-70,-60},{-70,-60},{-100,-60}},
                                                    color={0,127,255}));
  ...
  connect(eleHea.port_b, hum.port_a)
    annotation (Line(points={{12,-44},{12,-60},{-12,-60}},color={0,127,255}));
...
connect(eleHea.u, uEleHea) annotation (Line(points={{6,-22},{6,-22},{6,0},{
        -80,0},{-80,12},{-114,12}}, color={0,0,127}));
