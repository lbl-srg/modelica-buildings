...
model MixingVolumeEvaporation_rev "Test model for heat transfer to volume"
...
replaceable package MediumWat = Buildings.Media.Water
  ...
  Buildings.Fluid.MixingVolumes.MixingVolumeEvaporation_rev volDyn(
    V=1,
  ...
  Buildings.Fluid.MixingVolumes.MixingVolumeEvaporation_rev volSte(
    V=1,
    redeclare package MediumWat = MediumWat,
    redeclare package MediumSte = MediumSte,
    m_flow_nominal=0.01,
