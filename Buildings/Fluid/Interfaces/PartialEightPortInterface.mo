...
partial model PartialEightPortInterface
  ...
  Medium3.ThermodynamicState sta_b3=Medium3.setState_phX(
    ...
    noEvent(
      actualStream(
        port_b3.Xi_outflow))) if show_T
    "Medium properties in port_b3";
  Medium4.ThermodynamicState sta_a4=Medium4.setState_phX(
    port_a4.p,
    noEvent(
      actualStream(
        port_a4.h_outflow)),
    noEvent(
      actualStream(
        port_a4.Xi_outflow))) if show_T
    "Medium properties in port_a4";
  Medium4.ThermodynamicState sta_b4=Medium4.setState_phX(
    port_b4.p,
    noEvent(
      actualStream(
        port_b4.h_outflow)),
...
protected
  ...
  Medium4.ThermodynamicState state_a4_inflow=Medium4.setState_phX(
    port_a4.p,
    inStream(
      port_a4.h_outflow),
    inStream(
  ...
  Medium4.ThermodynamicState state_b4_inflow=Medium4.setState_phX(
    port_b4.p,
    inStream(
      port_b4.h_outflow),
    inStream(
