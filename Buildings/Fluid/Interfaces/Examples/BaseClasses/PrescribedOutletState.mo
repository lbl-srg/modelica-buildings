...
partial model PrescribedOutletState "Test model for prescribed outlet state"
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort THeaHigPowOut(
    redeclare final package Medium = Medium,
    final m_flow_nominal=m_flow_nominal,
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TCooLimPowOut(
    redeclare final package Medium = Medium,
    final m_flow_nominal=m_flow_nominal,
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort THeaCooUnlOut(
    redeclare final package Medium = Medium,
    final m_flow_nominal=m_flow_nominal,
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TSteStaOut(
    redeclare final package Medium = Medium,
    final m_flow_nominal=m_flow_nominal,
