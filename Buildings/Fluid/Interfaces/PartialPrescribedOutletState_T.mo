...
partial model PartialPrescribedOutletState_T
...
protected
  ...
  parameter Boolean use_Xi=false
    "Flag, true if use mass fraction X as output state";
  ...
  Modelica.SIunits.MassFraction Xi[Medium.nXi]
    "Mass fraction of outlet state assuming unlimited capacity and taking dynamics into account";
...
end PartialPrescribedOutletState_T;
