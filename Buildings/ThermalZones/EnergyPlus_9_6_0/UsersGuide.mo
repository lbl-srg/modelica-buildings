...
<p>
Modelica tries to invoke <code>spawn-0.3.0-ee6614d522[.exe]</code> in this order:
</p>
<ol>
<li>
On Linux, it searches for
<pre>
Buildings[ x.y.z]/Resources/bin/spawn-0.3.0-ee6614d522/linux64/bin/spawn-0.3.0-ee6614d522
</pre>
and on Windows, it searches for
<pre>
Buildings[ x.y.z]/Resources/bin/spawn-0.3.0-ee6614d522/win64/bin/spawn-0.3.0-ee6614d522.exe
</pre>
...
<code>spawn-0.3.0-ee6614d522[.exe]</code>.
</li>
<li>
