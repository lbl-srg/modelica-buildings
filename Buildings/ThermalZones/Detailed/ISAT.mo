...
<p>Model derived from CFD, in which the air is computed using an self-learning regression model called
...
Fast and Self-Learning Indoor Airflow Simulation Based on In Situ Adaptive Tabulation. </a></p>
...
Optimization of Workload Distribution of Data Centers Based on a Self-Learning In Situ Adaptive Tabulation Model. </a></p>
<p>Proc. of the 16th Conference of International Building Performance Simulation Association
(Building Simulation 2019), Italy, September 2-4, Rome, 2019. </p>
</html>",   revisions="<html>
<ul>
