...
<p>Model derived from CFD, in which the air is computed using an adaptive surrogate model called in situ adaptive tabulation (ISAT). The isat model can be trained online or in a manner that combines offline pretraining with online adaptive learning.</p>
<h4>References</h4>
