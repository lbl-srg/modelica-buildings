...
model OnlyExteriorWallWithWindow "Test model with sampleModel = true"
  ...
  annotation (
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Validation/TestConditionalConstructions/SampledModel/OnlyExteriorWallWithWindow.mos"
                   "Simulate and plot"),
