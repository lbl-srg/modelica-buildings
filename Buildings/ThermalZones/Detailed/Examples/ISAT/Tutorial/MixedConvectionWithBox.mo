...
<p>
This tutorial gives step by step instructions on building and simulating a
mixed convection model. The model tests the coupled simulation of
<a href=\"modelica://Buildings.ThermalZones.Detailed.ISAT\">
Buildings.ThermalZones.Detailed.ISAT</a> with the ISAT program by simulating
ventilation with mixed convection in a room with a box.
</p>
<h4>Case Description</h4>
<p>
There are five inputs and two outputs in the ISAT model for this case. The inputs
are (1) supply air temperature, (2) supply air flow rate, (3) temperature of the box,
(4) temperature of the ceiling and walls and (5) temperature of the floor.
...
<span style=\"font-family: Courier New;\">MixedConvectionWithBox</span> model:
</li>
<li>
<ul>
<li>
<a href=\"modelica://Buildings.ThermalZones.Detailed.ISAT\">Buildings.ThermalZones.Detailed.ISAT</a>.
This model is used to implement data exchange between Modelica and ISAT.
...
Name them as <span style=\"font-family: Courier New;\">TFlo</span>
and <span style=\"font-family: Courier New;\">TOthWal</span> respectively.
Please note that it is necessary to declare <span style=\"font-family: Courier New;\">TOthWal</span>
as a vector of <i>5</i> elements.
</li>
<li>
...
<li>
<a href=\"modelica://Modelica.Blocks.Sources.Step\">Modelica.Blocks.Sources.Step</a>.
This is a step function that generates the heat source.
Name it as <span style=\"font-family: Courier New;\">step</span>.
</li>
</ul>
</li>
<li>
...
cfdFilNam = &quot;modelica://Buildings/Resources/Data/ThermalZones/Detailed/Examples/ISAT/Tutorial/MixedConvectionWithBox.ffd&quot;,
nConExt = nConExt,
nConExtWin = nConExtWin,
nConPar = nConPar,
nConBou = nConBou,
...
<li>
Note: the desired outputs of isat can be altered by changing the output sensors in
section 3 of the set.isat file. The available default sensors include:
</li>
<li><ul>
<li>
...
which outputs the temperature at a defined location (default is center of the room),
</li>
<li>
<span style=\"font-family: Courier New;\">vel_sen,</span>
which outputs the velocity at the a defined location (default is center of the room).
</li>
</ul>
</li>
</ol>
...
and <span style=\"font-family: Courier New;\">344-346</span> in
<span style=\"font-family: Courier New;\">utility_isat.c,</span>
...
<li>
Generate the input files, which by default have the names
...
<li>
Rename the files as <span style=\"font-family: Courier New;\">MixedConvectionWithBox.cfd</span>
and <span style=\"font-family: Courier New;\">MixedConvectionWithBox.dat</span>,
respectively.
</li>
</ul>
</li>
<li>
Revise the FFD parameter input file <span style=\"font-family: Courier New;\">MixedConvectionWithBox.ffd</span>
(an example file is available in <span style=\"font-family: Courier New;\">
Buildings/Resources/Data/ThermalZones/Detailed/Examples/ISAT/Tutorial/MixedConvectionWithBox/</span>):
<pre>
inpu.parameter_file_format SCI
inpu.parameter_file_name input.cfd
inpu.block_file_name zeroone.dat
...
Buildings/Resources/Data/ThermalZones/Detailed/Examples/ISAT/Tutorial/MixedConvectionWithBox/</span>.</li>
<li>
...
<li>
Post-process: the generation of FFD output file (plt or vtk) is blocked by default,
the users should revise the codes to output.
</li>
</ol>
</html>",revisions="<html>
<ul>
<li>April 5, 2020, by Xu Han, Cary Faulkner, Wangda Zuo:<br>First implementation. </li>
    ...
    __Dymola_Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Examples/ISAT/Tutorial/MixedConvectionWithBox.mos"
        "Simulate and plot"),
