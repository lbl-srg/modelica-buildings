...
<li>
Mesh files <code>*.cfd</code>  and obstacles files <code>*.dat</code> generated by the program <code>SCI_FFD</code> and located 
in the same folder as the FFD input files (<code>Buildings/Resources/Data/Rooms/FFD/</code>).
<ul>
<li>The <code>SCI_FFD</code> program is maintained at <a href=\"https://github.com/FastFluidDynamics/Mesh\">https://github.com/FastFluidDynamics/Mesh</a>.
</li>
<li>
The Mesh files <code>*.cfd</code>  and obstacles files <code>*.dat</code> must be located in the same folder as the FFD input files.
</li>
</ul>
</li>
</ul>
