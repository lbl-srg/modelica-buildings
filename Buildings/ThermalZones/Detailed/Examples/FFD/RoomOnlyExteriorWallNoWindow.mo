...
with the FFD program by simulating the natural convection in an empty room with only
exterior walls and without windows.
</p>
<p>
Figure (a) shows the schematic of the FFD simulation.
The room is <i>1</i> meter in length, width and height.
The walls are exposed to the ambient environment (cold winter night in Chicago)
and the insulation is very poor.
The initial values are for the temperatures of the walls <i>20</i>&deg;C and for
temperature of the air <i>30</i>&deg;C.
...
In the cold mid-night of Chicago, the temperature of the ceiling is the lowest and
the temperature of the ground floor is the highest.
</p>
<p align=\"center\">
