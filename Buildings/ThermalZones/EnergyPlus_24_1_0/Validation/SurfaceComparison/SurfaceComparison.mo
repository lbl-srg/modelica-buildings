...
model SurfaceComparison
  ...
  Buildings.ThermalZones.EnergyPlus_24_1_0.Validation.SurfaceComparison.BaseClasses.ReferenceSurfaces refSur
    "Building that models the envelope with EnergyPlus surfaces"
    annotation (Placement(transformation(extent={{-10,20},{10,40}})));
  Buildings.ThermalZones.EnergyPlus_24_1_0.Validation.SurfaceComparison.BaseClasses.ZoneSurfaces zonSur
  ...
  annotation (
    Documentation(
      info="<html>
<p>
This model validates that the <a href=\"modelica://Buildings.ThermalZones.EnergyPlus_24_1_0.ZoneSurface\">
Buildings.ThermalZones.EnergyPlus_24_1_0.ZoneSurface</a> objects results in similar surface heat
transfer to the equivalent EnergyPlus surface object.
</p>
<p>
It does so by comparing the temperature of the building in
<a href=\"modelica://Buildings.ThermalZones.EnergyPlus_24_1_0.Validation.SurfaceComparison.BaseClasses.ReferenceSurfaces\">
Buildings.ThermalZones.EnergyPlus_24_1_0.Validation.SurfaceComparison.BaseClasses.ReferenceSurfaces</a>
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/EnergyPlus_24_1_0/Validation/SurfaceComparison/SurfaceComparison.mos"
        "Simulate and Plot"),
    experiment(
      StopTime=2592000,
      Tolerance=1e-06));
