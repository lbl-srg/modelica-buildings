...
model ASHRAE2006Spring
  ...
  extends Buildings.ThermalZones.EnergyPlus_24_1_0.Examples.SmallOffice.ASHRAE2006Winter;
  annotation (
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/EnergyPlus_24_1_0/Examples/SmallOffice/ASHRAE2006Spring.mos" "Simulate and plot"),
    experiment(
      StartTime=7344000,
      StopTime=7776000,
      Tolerance=1e-07),
