...
model OneEnvironmentOutputVariable
  ...
  inner Building building(
    idfName=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/Data/ThermalZones/EnergyPlus/Examples/SingleFamilyHouse_TwoSpeed_ZoneAirBalance/SingleFamilyHouse_TwoSpeed_ZoneAirBalance.idf"),
  ...
  Buildings.ThermalZones.EnergyPlus.OutputVariable TEnePlu(
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/EnergyPlus/Validation/OutputVariable/OneEnvironmentOutputVariable.mos" "Simulate and plot"),
    experiment(
      StartTime=864000,
      StopTime=950400,
      Tolerance=1e-06),
