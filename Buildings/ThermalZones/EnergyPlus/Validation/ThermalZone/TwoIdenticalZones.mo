...
model TwoIdenticalZones "Validation model with two identical zones"
  ...
  equation
    ...
    connect(duc.port_a, zon.ports[1]) annotation (Line(points={{-30,-50},{
            -0.666667,-50},{-0.666667,6.9}}, color={0,127,255}));
    ...
    connect(senRelHum.port, zon.ports[3]) annotation (Line(points={{60,-50},{60,
            -60},{4.66667,-60},{4.66667,6.9}}, color={0,127,255}));
...
First implementation.
 ...
 __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/EnergyPlus/Validation/ThermalZone/TwoIdenticalZones.mos"
        "Simulate and plot"),
experiment(
      StopTime=604800,
      Tolerance=1e-06),
