...
model Infiltration
  ...
  Buildings.ThermalZones.EnergyPlus.Examples.SingleFamilyHouse.RadiantHeatingCooling_TRoom defInf(
    building(
  ...
  Buildings.ThermalZones.EnergyPlus.Examples.SingleFamilyHouse.RadiantHeatingCooling_TRoom higInf(
    building(
      idfName = Modelica.Utilities.Files.loadResource(
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/2492\">#2492</a>.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/EnergyPlus/Validation/ThermalZone/Infiltration.mos" "Simulate and plot"),
    experiment(
      StopTime=86400,
      Tolerance=1e-06));
end Infiltration;
