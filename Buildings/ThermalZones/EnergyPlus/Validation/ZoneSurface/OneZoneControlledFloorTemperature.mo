...
model OneZoneControlledFloorTemperature
  ...
  Controls.OBC.CDL.Continuous.Sources.Constant TSetRooHea(
    k(final unit="K", displayUnit="degC")=293.15,
  ...
  Controls.OBC.CDL.Continuous.Sources.Constant TSetRooCoo(
    k(final unit="K", displayUnit="degC") = 297.15,
    y(final unit="K", displayUnit="degC")) "Room temperture set point for cooling"
  ...
  Controls.OBC.CDL.Continuous.Add TFlo(y(final unit="K", displayUnit="degC"))
                                       "Floor temperature"
...
equation
  ...
  connect(conCoo.u_m, zon.TAir) annotation (Line(points={{-30,68},{-30,66},{-46,
          66},{-46,30},{52,30},{52,18},{41,18}}, color={0,0,127}));
