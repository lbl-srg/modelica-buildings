...
model TwoIdenticalOneZoneBuildings
  ...
  constant Integer n = 2 "Number of buildings";

  Zone bui[n] "Buildings"
...
First implementation.
 ...
 __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/EnergyPlus/Validation/TwoIdenticalOneZoneBuildings.mos"
        "Simulate and plot"),
experiment(
      StopTime=172800,
      Tolerance=1e-06));
