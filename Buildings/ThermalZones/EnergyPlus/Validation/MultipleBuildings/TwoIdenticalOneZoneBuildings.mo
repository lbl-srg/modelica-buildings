...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/EnergyPlus/Validation/MultipleBuildings/TwoIdenticalOneZoneBuildings.mos" "Simulate and plot"),
    experiment(
      StopTime=172800,
      Tolerance=1e-06));
