...
class SupportedActuators "Supported actuators"
  extends Modelica.Icons.Information;
...
<p>
Using the model
<a href=\"Buildings.ThermalZones.EnergyPlus.Actuator\">Buildings.ThermalZones.EnergyPlus.Actuator</a>,
the values of EnergyPlus EMS actuator object can be set from a Modelica model.
...
<p>
The table below lists the EnergyPlus EMS actuator objects. The name in the first column
...
in instances of
<a href=\"Buildings.ThermalZones.EnergyPlus.Actuator\">
Buildings.ThermalZones.EnergyPlus.Actuator</a>.
</p>
<p>
Note that some actuator names changed between EnergyPlus 9.4 and 9.5. The table below
is for EnergyPlus 9.4. It will be updated through
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/2223\">#2223</a>.
In the meantime, please get the updated names from the output of the above
<code>Output:EnergyManagementSystem</code> code.
</p>
...
<p>
To look at the examples, we suggest to look at them in the following order which
