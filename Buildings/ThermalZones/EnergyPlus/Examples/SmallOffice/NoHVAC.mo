...
equation
  ...
  connect(weaBus, bou[4].weaBus) annotation (Line(
      ...
      color={255,204,51},
      thickness=0.5));
  connect(res1[1].port_b, flo.portsSou[1]) annotation (Line(points={{24,-20},{
          51.7217,-20},{51.7217,4.46154}},
                                   color={0,127,255}));
  connect(res1[2].port_b, flo.portsEas[1]) annotation (Line(points={{24,-20},{
          78.487,-20},{78.487,12.7692}},
                                  color={0,127,255}));
  connect(res1[3].port_b, flo.portsNor[1]) annotation (Line(points={{24,-20},{
          46,-20},{46,20.6154},{51.7217,20.6154}},
                                                color={0,127,255}));
  connect(res1[4].port_b, flo.portsWes[1]) annotation (Line(points={{24,-20},{
