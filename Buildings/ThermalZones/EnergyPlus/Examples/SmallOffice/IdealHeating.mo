...
model IdealHeating "Building with constant fresh air and ideal heating/cooling that exactly meets set point"
  ...
  IdealHeater[5] hea(
    Q_flow_nominal= 750*{flo.AFloSou, flo.AFloEas, flo.AFloNor, flo.AFloWes, flo.AFloCor})
...
protected
  ...
  equation
    ...
    connect(gai.y, Q_flow) annotation (Line(points={{42,0},{56,0},{56,60},{120,60}},
          color={0,0,127}));
      annotation (
...
equation
  ...
  connect(hea[2].heaPor, flo.heaPorWes) annotation (Line(points={{10,80},{
  ...
  connect(hea[4].heaPor, flo.heaPorEas) annotation (Line(points={{10,80},{
...
but an ideal heating that exactly meets the.
</p>
</html>", revisions="<html>
<ul>
<li>
