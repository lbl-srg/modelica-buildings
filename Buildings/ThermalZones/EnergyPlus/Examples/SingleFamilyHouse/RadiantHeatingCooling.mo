...
model RadiantHeatingCooling
  ...
  OpaqueConstruction attFlo1(surfaceName="Living:Floor")
    "Floor of the attic above the living room" annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
...
equation
  ...
  connect(attFlo.heaPorFro, slaCei.surf_a) annotation (Line(points={{100,130},{
          100,140},{14,140},{14,130}},  color={191,0,0}));
  connect(slaCei.surf_b,attFlo. heaPorBac) annotation (Line(points={{14,110},{
          14,100},{100,100},{100,110.2}},color={191,0,0}));
  connect(hysHea.y, swiBoi.u2) annotation (Line(points={{-138,-130},{-132,-130},
          {-132,-170},{-122,-170}}, color={255,0,255}));
  connect(hysHea.y, swiPum.u2) annotation (Line(points={{-138,-130},{-132,-130},
          {-132,-200},{-122,-200}}, color={255,0,255}));
  ...
  connect(conHea.y, swiBoi.u1) annotation (Line(points={{-178,-130},{-170,-130},
          {-170,-162},{-122,-162}}, color={0,0,127}));
  connect(off.y, swiBoi.u3)
    annotation (Line(points={{-178,-178},{-120,-178}}, color={0,0,127}));
  connect(off.y, swiPum.u3) annotation (Line(points={{-178,-178},{-150,-178},{
          -150,-208},{-122,-208}}, color={0,0,127}));
  connect(on.y, swiPum.u1) annotation (Line(points={{-178,-210},{-160,-210},{
          -160,-192},{-122,-192}}, color={0,0,127}));
  connect(swiBoi.y, hea.u) annotation (Line(points={{-98,-170},{-50,-170},{-50,
          -254},{-42,-254}}, color={0,0,127}));
  connect(pum.y, swiPum.y) annotation (Line(points={{-70,-248},{-70,-200},{-100,
          -200}}, color={0,0,127}));
  ...
  connect(attFlo1.heaPorFro, slaFlo.surf_a) annotation (Line(points={{100,-250},
          {100,-240},{14,-240},{14,-250}}, color={191,0,0}));
  connect(slaFlo.surf_b, attFlo1.heaPorBac) annotation (Line(points={{14,-270},
          {14,-280},{100,-280},{100,-269.8}}, color={191,0,0}));
  connect(slaFlo.port_b, pre.ports[2])
    annotation (Line(points={{20,-260},{52,-260}}, color={0,127,255}));
  connect(slaFlo.port_b, pum.port_a) annotation (Line(points={{20,-260},{40,
          -260},{40,-300},{-100,-300},{-100,-260},{-80,-260}}, color={0,127,255}));
  connect(zon.TAir, conHea.u_m) annotation (Line(points={{41,18},{48,18},{48,40},
          {-210,40},{-210,-150},{-190,-150},{-190,-142}}, color={0,0,127}));
  annotation (
      __Dymola_Commands(
