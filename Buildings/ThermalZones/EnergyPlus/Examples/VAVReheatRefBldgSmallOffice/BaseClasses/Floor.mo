...
equation
  ...
  connect(cor.ports[11], senRelPre.port_a) annotation (Line(
      points={{167.636,36.9},{110,36.9},{110,250},{60,250}},
      color={0,127,255},
      smooth=Smooth.None,
      thickness=0.5));
