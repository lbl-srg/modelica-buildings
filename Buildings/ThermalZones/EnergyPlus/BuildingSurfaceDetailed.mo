...
model BuildingSurfaceDetailed
  ...
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a heaPorFro
    "Heat port for front surface" annotation (Placement(transformation(extent={{-10,90},
            {10,110}}), iconTransformation(extent={{50,90},{70,110}})));
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_b heaPorBac
    "Heat port for back surface" annotation (Placement(transformation(extent={{-10,
            -110},{10,-90}}),
                       iconTransformation(extent={{50,-108},{70,-88}})));
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/2358\">issue 2358</a>.
    ...
    Icon(graphics={
   Rectangle(
    extent={{-35,64},{35,-64}},     fillColor={175,175,175},
   fillPattern=FillPattern.Solid,    lineColor={175,175,175},
          origin={0,-37},
          rotation=90),
   Rectangle(
    extent={{-34,64},{34,-64}},     fillColor={215,215,215},
   fillPattern=FillPattern.Solid,    lineColor={175,175,175},
          origin={0,32},
          rotation=90),
   Line(points={{-91,0},{91,0}},      color = {0, 0, 0}, thickness = 0.5,
   smooth = Smooth.None,
          origin={1,-2},
          rotation=90),              Rectangle(extent={{-10,6},{10,-6}},
   lineColor = {0, 0, 0}, lineThickness =  0.5, fillColor = {255, 255, 255},
   fillPattern = FillPattern.Solid,
          origin={2,26},
          rotation=90),
   Line(points={{0,16},{0,-16}},
   color = {0, 0, 0}, thickness = 0.5, smooth = Smooth.None,
   visible=stateAtSurface_a,
          origin={-15,50},
          rotation=90),
   Line(points={{13,0},{-13,0}},          color = {0, 0, 0}, thickness = 0.5,
   smooth = Smooth.None,
   visible=stateAtSurface_a,
          origin={-31,50},
          rotation=90),
   Line(points={{7,0},{-7,0}},            color = {0, 0, 0}, thickness = 0.5,
   smooth = Smooth.None,
   visible=stateAtSurface_a,
          origin={-37,50},
          rotation=90),
