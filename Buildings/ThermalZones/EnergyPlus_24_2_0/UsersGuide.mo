...
<tr>
<td>Linux</td>
<td><a href=\"https://spawn.s3.amazonaws.com/custom/Spawn-light-0.6.0-cae9a75960-Linux.tar.gz\">
https://spawn.s3.amazonaws.com/custom/Spawn-light-0.6.0-cae9a75960-Linux.tar.gz</a>
</td>
</tr>
<tr>
<td>Windows</td>
<td><a href=\"https://spawn.s3.amazonaws.com/custom/Spawn-light-0.6.0-cae9a75960-win64.zip\">
https://spawn.s3.amazonaws.com/custom/Spawn-light-0.6.0-cae9a75960-win64.zip</a>
</td>
</tr>
</table>
<p>
...
<pre>
wget https://spawn.s3.amazonaws.com/custom/Spawn-light-0.6.0-cae9a75960-Linux.tar.gz;
tar xzf Spawn-light-0.6.0-cae9a75960-Linux.tar.gz;
export PATH=${PATH}:`pwd`/Spawn-light-0.6.0-cae9a75960-Linux/bin
</pre>
<p>
...
<li>
Unzip <code>Spawn-light-0.6.0-cae9a75960-win64.zip</code> at your desired location.
</li>
<li>
Add the directory <code>xyz/Spawn-light-0.6.0-cae9a75960-win64/bin</code>
...
<p>
Modelica tries to invoke <code>spawn-0.6.0-cae9a75960[.exe]</code> in this order:
</p>
<ol>
<li>
On Linux, it searches for
<pre>
Buildings[ x.y.z]/Resources/bin/spawn-0.6.0-cae9a75960/linux64/bin/spawn-0.6.0-cae9a75960
</pre>
and on Windows, it searches for
<pre>
Buildings[ x.y.z]/Resources/bin/spawn-0.6.0-cae9a75960/win64/bin/spawn-0.6.0-cae9a75960.exe
</pre>
...
<code>spawn-0.6.0-cae9a75960[.exe]</code>.
</li>
<li>
