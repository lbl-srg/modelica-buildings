...
<tr>
<td>Linux</td>
<td><a href=\"https://spawn.s3.amazonaws.com/custom/Spawn-light-0.6.0-f7f6d6ec0f-Linux.tar.gz\">
https://spawn.s3.amazonaws.com/custom/Spawn-light-0.6.0-f7f6d6ec0f-Linux.tar.gz</a>
</td>
</tr>
<tr>
<td>Windows</td>
<td><a href=\"https://spawn.s3.amazonaws.com/custom/Spawn-light-0.6.0-f7f6d6ec0f-win64.zip\">
https://spawn.s3.amazonaws.com/custom/Spawn-light-0.6.0-f7f6d6ec0f-win64.zip</a>
</td>
</tr>
</table>
<p>
...
<pre>
wget https://spawn.s3.amazonaws.com/custom/Spawn-light-0.6.0-f7f6d6ec0f-Linux.tar.gz;
tar xzf Spawn-light-0.6.0-f7f6d6ec0f-Linux.tar.gz;
export PATH=${PATH}:`pwd`/Spawn-light-0.6.0-f7f6d6ec0f-Linux/bin
</pre>
<p>
...
<li>
Unzip <code>Spawn-light-0.6.0-f7f6d6ec0f-win64.zip</code> at your desired location.
</li>
<li>
Add the directory <code>xyz/Spawn-light-0.6.0-f7f6d6ec0f-win64/bin</code>
...
<p>
Modelica tries to invoke <code>spawn-0.6.0-f7f6d6ec0f[.exe]</code> in this order:
</p>
<ol>
<li>
On Linux, it searches for
<pre>
Buildings[ x.y.z]/Resources/bin/spawn-0.6.0-f7f6d6ec0f/linux64/bin/spawn-0.6.0-f7f6d6ec0f
</pre>
and on Windows, it searches for
<pre>
Buildings[ x.y.z]/Resources/bin/spawn-0.6.0-f7f6d6ec0f/win64/bin/spawn-0.6.0-f7f6d6ec0f.exe
</pre>
...
<code>spawn-0.6.0-f7f6d6ec0f[.exe]</code>.
</li>
<li>
