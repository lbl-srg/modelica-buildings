...
equation
  ...
  connect(fmuZonCor.m_flow[1],mIn_flow.y)
    annotation (Line(points={{18,31.5},{-4,31.5},{-4,10},{-69,10}},
                                                               color={0,0,127}));
  ...
  connect(mOut_flow.y,fmuZonCor.m_flow[2])
    annotation (Line(points={{-19,30},{-10,30},{-10,32.5},{18,32.5}},
                                                                 color={0,0,127}));
  connect(TIn.y,fmuZonCor.TInlet)
    annotation (Line(points={{-69,-18},{6,-18},{6,28},{18,28}},color={0,0,127}));
  connect(fmuZonCor.QGaiRad_flow,QGaiRad_flow.y)
    annotation (Line(points={{18,24},{10,24},{10,-40},{-69,-40}},color={0,0,127}));
  ...
  connect(p.y, fmuZonCor.p) annotation (Line(points={{-69,-60},{14,-60},{14,20},
          {18,20}}, color={0,0,127}));
  annotation (
    Documentation(
      info="<html>
