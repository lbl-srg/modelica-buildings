...
model Floor_Autosizing "Extension of floor model with autosizing for one system"
  extends Floor(
    eas(hvacSystemName="VAV1", airChaRatInf=6.9444444444444e-05),
    sou(hvacSystemName="VAV1", airChaRatInf=6.9444444444444e-05),
    cor(hvacSystemName="VAV1"),
    nor(hvacSystemName="VAV1", airChaRatInf=6.9444444444444e-05),
    wes(hvacSystemName="VAV1", airChaRatInf=6.9444444444444e-05));
