...
model AirHeating_Autosizing
  "Example model with an air-based heating system that conditions a thermal zone in EnergyPlus and where the system sizing uses the Spawn autosize feature"
  extends Modelica.Icons.Example;
  package Medium=Buildings.Media.Air
    "Medium model";
  inner Building building(
    idfName=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/Data/ThermalZones/EnergyPlus_24_2_0/Examples/SingleFamilyHouse_TwoSpeed_ZoneAirBalance/SingleFamilyHouse_TwoSpeed_ZoneAirBalance_withSizing.idf"),
  ...
  Buildings.ThermalZones.EnergyPlus_24_2_0.ThermalZone zon(
    ...
    airChaRatInf=6.9444444444444e-05,
    nPorts=4)
    "Thermal zone"
  ...
  Buildings.Controls.OBC.CDL.Reals.Hysteresis sta1(
    uLow=0.05,
    uHigh=0.5)
    "Hysteresis to switch on stage 1"
    annotation (Placement(transformation(extent={{-80,-90},{-60,-70}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToReal mSetFan1_flow(
    realTrue=mRec_flow_nominal/2)
    "Mass flow rate for 1st stage"
    annotation (Placement(transformation(extent={{-50,-90},{-30,-70}})));
  Buildings.Controls.OBC.CDL.Reals.Hysteresis sta2(
    uLow=0.5,
    uHigh=0.75)
    "Hysteresis to switch on stage 2"
    annotation (Placement(transformation(extent={{-80,-60},{-60,-40}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToReal mSetFan2_flow(
    realTrue=mRec_flow_nominal/2)
...
<ul>
<li>
November 4, 2025, by David Blum:<br/>
First implementation.
</li>
</ul>
</html>"),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/EnergyPlus_24_2_0/Examples/SingleFamilyHouse/AirHeating_Autosizing.mos" "Simulate and plot"),
    experiment(
      StopTime=86400,
      Tolerance=1e-06),
    Diagram(
