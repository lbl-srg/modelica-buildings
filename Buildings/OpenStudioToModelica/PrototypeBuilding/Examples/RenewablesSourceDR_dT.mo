...
equation
  connect(conDR.y, bui7.dTSp) annotation (Line(points={{241,-70},{250,-70},{250,
          -90},{-110,-90},{-110,72},{220,72},{220,48.5714},{210,48.5714}},
                                                                 color={0,0,127}));
  connect(bui6.dTSp, conDR.y) annotation (Line(points={{170,48.5714},{180,
          48.5714},{180,72},{-110,72},{-110,-90},{250,-90},{250,-70},{241,-70}},
                                                                   color={0,0,
          127}));
  connect(bui5.dTSp, conDR.y) annotation (Line(points={{130,48.5714},{136,
          48.5714},{136,54},{140,54},{140,72},{-110,72},{-110,-90},{250,-90},{
          250,-70},{241,-70}},
                 color={0,0,127}));
  connect(bui4.dTSp, conDR.y) annotation (Line(points={{90,48.5714},{96,48.5714},
          {96,72},{-110,72},{-110,-90},{250,-90},{250,-70},{241,-70}},
                                                               color={0,0,127}));
  connect(conDR.y, bui3.dTSp) annotation (Line(points={{241,-70},{250,-70},{250,
          -90},{-110,-90},{-110,72},{58,72},{58,48.5714},{50,48.5714}},
                                                              color={0,0,127}));
  connect(conDR.y, bui2.dTSp) annotation (Line(points={{241,-70},{250,-70},{250,
          -90},{-110,-90},{-110,72},{18,72},{18,48.5714},{10,48.5714}},
                                                              color={0,0,127}));
  connect(conDR.y, bui1.dTSp) annotation (Line(points={{241,-70},{246,-70},{250,
          -70},{250,-90},{-110,-90},{-110,72},{-22,72},{-22,48.5714},{-30,
          48.5714}},
        color={0,0,127}));
