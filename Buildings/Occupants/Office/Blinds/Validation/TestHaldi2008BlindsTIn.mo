...
model TestHaldi2008BlindsTIn
  "To test the model Haldi2008BlindsTIn"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Blinds/Validation/TestHaldi2008BlindsTIn.mos"
                      "Simulate and plot"),
