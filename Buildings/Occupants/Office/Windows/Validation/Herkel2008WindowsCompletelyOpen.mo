...
model Herkel2008WindowsCompletelyOpen "Validating the model for window behaviors"
  ...
  Herkel2008WindowsCompletelyOpen win "Tested Windows model"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/Herkel2008WindowsCompletelyOpen.mos"
                      "Simulate and plot"),
