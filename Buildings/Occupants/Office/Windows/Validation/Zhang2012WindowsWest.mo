...
model Zhang2012WindowsWest "Validating the model for window behaviors"
  ...
  Buildings.Occupants.Office.Windows.Zhang2012WindowsWest win "Tested windows model"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/Zhang2012WindowsWest.mos"
                      "Simulate and plot"),
