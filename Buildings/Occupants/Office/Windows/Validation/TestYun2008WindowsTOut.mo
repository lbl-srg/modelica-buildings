...
model TestYun2008WindowsTOut "Validating the model for window behaviors"
...
equation
  ...
  connect(TOut.y, win.TOut) annotation (Line(points={{-59,-20},{-34,-20},{-34,-6},
          {-12,-6}}, color={0,0,127}));
annotation (
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/TestYun2008WindowsTOut.mos"
                      "Simulate and plot"),
