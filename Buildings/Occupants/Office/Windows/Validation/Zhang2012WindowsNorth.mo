...
model Zhang2012WindowsNorth "Validating the model for window behaviors"
  ...
  Buildings.Occupants.Office.Windows.Zhang2012WindowsNorth win "Tested windows model"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/Zhang2012WindowsNorth.mos"
                      "Simulate and plot"),
