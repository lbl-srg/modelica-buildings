...
model Zhang2012WindowsAll "Validating the model for window behaviors"
  ...
  Buildings.Occupants.Office.Windows.Zhang2012WindowsAll win "Tested windows model"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/Zhang2012WindowsAll.mos"
                      "Simulate and plot"),
