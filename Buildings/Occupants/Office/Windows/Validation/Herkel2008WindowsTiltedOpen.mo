...
model Herkel2008WindowsTiltedOpen "Validating the model for window behaviors"
  ...
  Buildings.Occupants.Office.Windows.Herkel2008WindowsTiltedOpen win "Tested windows model"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/Herkel2008WindowsTiltedOpen.mos"
                      "Simulate and plot"),
