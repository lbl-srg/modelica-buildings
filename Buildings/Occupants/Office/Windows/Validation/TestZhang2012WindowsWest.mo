...
model TestZhang2012WindowsWest "Validation model for Zhang2012WindowsWest"
  ...
  Zhang2012WindowsWest win "Tested Windows model"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/TestZhang2012WindowsWest.mos"
                      "Simulate and plot"),
