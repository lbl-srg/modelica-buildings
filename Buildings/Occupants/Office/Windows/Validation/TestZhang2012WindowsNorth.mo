...
model TestZhang2012WindowsNorth "Validating the model for window behaviors"
  ...
  Zhang2012WindowsNorth win "Tested Windows model"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/TestZhang2012WindowsNorth.mos"
                      "Simulate and plot"),
