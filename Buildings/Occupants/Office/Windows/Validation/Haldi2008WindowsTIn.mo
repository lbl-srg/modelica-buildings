...
model Haldi2008WindowsTIn "Validating the model for window behaviors"
...
equation
  ...
  experiment(Tolerance=1e-6, StopTime=3600.0),
      __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/Haldi2008WindowsTIn.mos"
                        "Simulate and plot"),
