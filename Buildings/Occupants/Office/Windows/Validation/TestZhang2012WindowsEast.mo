...
model TestZhang2012WindowsEast "Validation model for Zhang2012WindowsEast"
  ...
  Zhang2012WindowsEast win "Tested Windows model"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/TestZhang2012WindowsEast.mos"
                      "Simulate and plot"),
