...
model TestZhang2012WindowsSouth "Validation model for Zhang2012WindowsSouth"
  ...
  Zhang2012WindowsSouth win "Tested Windows model"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/TestZhang2012WindowsSouth.mos"
                      "Simulate and plot"),
