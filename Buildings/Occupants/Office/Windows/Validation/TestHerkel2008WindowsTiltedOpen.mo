...
model TestHerkel2008WindowsTiltedOpen "To test the model Herkel2008WindowsTiltedOpen.mo"
  ...
  Herkel2008WindowsTiltedOpen win "Tested Windows model"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/TestHerkel2008WindowsTiltedOpen.mos"
                      "Simulate and plot"),
...
end TestHerkel2008WindowsTiltedOpen;
