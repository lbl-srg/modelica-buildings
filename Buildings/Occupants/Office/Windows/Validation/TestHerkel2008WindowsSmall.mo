...
model TestHerkel2008WindowsSmall "Validating the model for window behaviors"
  ...
  Herkel2008WindowsSmall win "Tested Windows model"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/TestHerkel2008WindowsSmall.mos"
                      "Simulate and plot"),
...
end TestHerkel2008WindowsSmall;
