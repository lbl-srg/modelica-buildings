...
model TestYun2008WindowsTIn "To test the model Yun2008WindowsTIn"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/TestYun2008WindowsTIn.mos"
                      "Simulate and plot"),
