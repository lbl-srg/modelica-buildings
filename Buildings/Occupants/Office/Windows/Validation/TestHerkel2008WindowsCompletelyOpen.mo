...
model TestHerkel2008WindowsCompletelyOpen "Validating the model for window behaviors"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/TestHerkel2008WindowsCompletelyOpen.mos"
                      "Simulate and plot"),
...
end TestHerkel2008WindowsCompletelyOpen;
