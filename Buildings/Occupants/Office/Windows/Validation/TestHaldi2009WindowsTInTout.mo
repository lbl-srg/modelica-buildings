...
model TestHaldi2009WindowsTInTout "To test the model Haldi2009Windows"
  ...
  Haldi2009WindowsTInTout win "Tested Windows model"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/TestHaldi2009WindowsTInTout.mos"
                      "Simulate and plot"),
...
end TestHaldi2009WindowsTInTout;
