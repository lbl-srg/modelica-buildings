...
model Herkel2008WindowsSmall "Validating the model for window behaviors"
  ...
  Buildings.Occupants.Office.Windows.Herkel2008WindowsSmall win "Tested windows model"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/Herkel2008WindowsSmall.mos"
                      "Simulate and plot"),
