...
model Zhang2012WindowsSouth "A model to predict occupants' window behavior with outdoor temperature for South-oriented windows"
  ...
  Modelica.Blocks.Interfaces.BooleanOutput on "State of South-oriented window"
...
<h4>Outputs</h4>
<p>The state of South-oriented window: a boolean variable, true indicates the window 
