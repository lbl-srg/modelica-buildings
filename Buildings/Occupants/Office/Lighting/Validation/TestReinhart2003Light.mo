...
model TestReinhart2003Light "Validating the model for light behaviors"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Lighting/Validation/TestReinhart2003Light.mos"
                      "Simulate and plot"),
