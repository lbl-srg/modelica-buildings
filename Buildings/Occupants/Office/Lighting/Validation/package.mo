...
package Validation "Package with examples to validate models in Lighting package"
  extends Modelica.Icons.ExamplesPackage;

  model TestLove1998Light2 "Validating the model for light behaviors"
