...
model Love1998Light1 "Validating the model for light behaviors"
  extends Modelica.Icons.Example;

  Modelica.Blocks.Sources.Sine ill(
    offset=250,
    f=0.001,
    amplitude=200) "Daylight illuminance level on the deskin units of lux"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Lighting/Validation/Love1998Light1.mos"
                      "Simulate and plot"),
