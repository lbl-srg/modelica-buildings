...
model Nicol2001HeatingPakistan "Validating the model for heating behaviors"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Residential/Heating/Validation/Nicol2001HeatingPakistan.mos"
                      "Simulate and plot"),
