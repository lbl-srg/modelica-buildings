...
model Nicol2001HeatingEU "Validating the model for heating behaviors"
  ...
  Buildings.Occupants.Residential.Heating.Nicol2001HeatingEU hea "Occupancy model"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Residential/Heating/Validation/Nicol2001HeatingEU.mos"
                      "Simulate and plot"),
