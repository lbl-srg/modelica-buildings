...
model TestNicol2001HeatingPakistan "Validating the model for heating behaviors"
  ...
  Nicol2001HeatingPakistan hea "Occupancy model"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Residential/Heating/Validation/TestNicol2001HeatingPakistan.mos"
                      "Simulate and plot"),
...
end TestNicol2001HeatingPakistan;
