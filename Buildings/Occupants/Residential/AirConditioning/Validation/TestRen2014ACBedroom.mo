...
model TestRen2014ACBedroom "Validating the model for AC behaviors"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Residential/AirConditioning/Validation/TestRen2014ACBedroom.mos"
                      "Simulate and plot"),
