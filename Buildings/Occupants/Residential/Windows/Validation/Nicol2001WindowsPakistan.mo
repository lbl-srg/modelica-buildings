...
model Nicol2001WindowsPakistan "Validating the model for window behaviors"
  ...
  Buildings.Occupants.Residential.Windows.Nicol2001WindowsPakistan win "Tested windows model"
...
experiment(Tolerance=1e-6, StopTime=3600.0),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Residential/Windows/Validation/Nicol2001WindowsPakistan.mos"
                      "Simulate and plot"),
