...
model Nicol2001WindowsEU "A model to predict occupants' window behavior with outdoor temperature"
  ...
  parameter Real A = 0.104 "Slope of the logistic relation";
  parameter Real B = -2.31 "Intercept of the logistic relation";
...
initial equation
  ...
  on = Buildings.Occupants.BaseClasses.binaryVariableGeneration(p, globalSeed=integer(seed*time));
equation
