...
equation
  ...
  if Buildings.Occupants.BaseClasses.weibull1DON(x,u,L,k,dt,globalSeed=integer(seed*1E6*time)) then
    y = 1;
  else
    y = 0;
  end if;
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/BaseClasses/Validation/Weibull1DON.mos"
