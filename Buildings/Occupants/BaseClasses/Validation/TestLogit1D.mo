...
model TestLogit1D "Test model for 1D binary variable generation function"
...
equation
  ...
  if Buildings.Occupants.BaseClasses.logit1D(x,A,B,globalSeed=integer(seed*1E6*time)) then
    y = 1;
  else
    y = 0;
  end if;
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/BaseClasses/Validation/TestLogit1D.mos"
