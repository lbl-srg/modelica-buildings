...
package Validation "Package with examples to validate functions in BaseClasses package"
  extends Modelica.Icons.ExamplesPackage;


  model TestLogit2D "Test model for 2D binary variable generation function"
