...
model CouplingRCZ6Pump
  ...
  BaseClasses.BuildingRCZ6Pump bui(nPorts_a=2, nPorts_b=2)
...
equation
  ...
  Diagram(
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Applications/DHC/Loads/Validation/CouplingRCZ6Pump.mos"
        "Simulate and plot"),
    experiment(
      StopTime=604800,
      Tolerance=1e-06,
      __Dymola_Algorithm="Cvode"));
end CouplingRCZ6Pump;
