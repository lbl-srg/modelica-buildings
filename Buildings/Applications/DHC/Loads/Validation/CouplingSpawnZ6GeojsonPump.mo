...
model CouplingSpawnZ6GeojsonPump
  ...
  package Medium1 = Buildings.Media.Water
    "Source side medium";
  BaseClasses.BuildingSpawnZ6GeojsonPump bui(nPorts_a1=2, nPorts_b1=2)
...
Hidden.AvoidDoubleComputation=true")}),
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Applications/DHC/Loads/Validation/CouplingSpawnZ6GeojsonPump.mos"
        "Simulate and plot"));
