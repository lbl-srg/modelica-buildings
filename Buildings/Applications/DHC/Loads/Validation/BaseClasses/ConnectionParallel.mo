...
model ConnectionParallel
  ...
  extends
    ...
    redeclare model PipeDisModel = Fluid.FixedResistances.PressureDrop(dp_nominal=dpDis_nominal),
    redeclare model PipeConModel = Fluid.FixedResistances.PressureDrop(dp_nominal=2*dpCon_nominal));
