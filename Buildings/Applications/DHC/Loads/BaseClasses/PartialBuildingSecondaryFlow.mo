...
partial model PartialBuildingSecondaryFlow "Partial class for building model"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput Q_flow1Act[nPorts1,nLoa](each quantity="HeatFlowRate")
  ...
  Modelica.Blocks.Interfaces.RealOutput PHeaCoo(quantity="Power", final unit="W") if haveEleHeaCoo
    ...
    annotation (Placement(transformation(extent={{300,170},{340,210}}),iconTransformation(extent={{100,0},{120,20}})));
  Modelica.Blocks.Interfaces.RealOutput PFanPum(quantity="Power", final unit="W") if haveFanPum
    "Power drawn by fans and pumps"
    annotation (Placement(transformation(extent={{300,210},{340,250}}), iconTransformation(extent={{100,0},{120,20}})));
  annotation (
...
end PartialBuildingSecondaryFlow;
