...
model B5a6b99ec37f4de7f94020090_Office
  ...
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*2800.69829830438)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=25.0*325.8312635681265)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Buildings/DistrictHeatingCooling/Loads/Examples/Resources/InternalGains_B5a6b99ec37f4de7f94020090Office.mat"),
      columns={2,3,4})
...
equation
  ...
  events=false));
end B5a6b99ec37f4de7f94020090_Office;
