...
model B5a6b99ec37f4de7f94020090_ICT
  ...
  thermalZoneTwoElements(
    ...
    nOrientations=6,
    AWin={5.963815724622265, 0.0, 5.963815724622265, 0.5528095467402644, 0.0, 0.5528095467402644},
    ATransparent={5.963815724622265, 0.0, 5.963815724622265, 0.5528095467402644, 0.0, 0.5528095467402644},
    AExt={17.891447173866798, 36.46409015200001, 17.891447173866798, 1.658428640220793, 36.46409015200001, 1.658428640220793})
    "Thermal zone"
  ...
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*112.0279319321752)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=24.999999999999996*13.033250542725057)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Buildings/DistrictHeatingCooling/Loads/Examples/Resources/InternalGains_B5a6b99ec37f4de7f94020090ICT.mat"),
      columns={2,3,4})
...
equation
  ...
  events=false));
end B5a6b99ec37f4de7f94020090_ICT;
