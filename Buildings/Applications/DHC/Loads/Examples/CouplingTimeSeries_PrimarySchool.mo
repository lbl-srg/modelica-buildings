...
model CouplingTimeSeries_PrimarySchool
  ...
  Buildings.Applications.DHC.Loads.Examples.BaseClasses.BuildingTimeSeriesModified
    ...
    nPorts_aChiWat=1,
    nPorts_bHeaWat=1,
    nPorts_bChiWat=1) "School time series heating and cooling loads."
...
annotation (
   Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-160,-140},{160,140}})),
      __Dymola_Commands(
 file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DHC/Loads/Examples/CouplingTimeSeries_PrimarySchool.mos"
      "Simulate and plot"),
 experiment( Tolerance=1e-6,
              StopTime=86400),
Documentation(info="<html>
<p>
This example demonstartes the hydraluic connection between a DOE-reference primary school 
