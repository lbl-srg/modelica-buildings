...
The <code>facScaHea</code> and <code>facScaCoo</code> are assigned to 1.
</li>
<li>
...
"modelica://Buildings/Resources/Scripts/Dymola/Applications/DHC/Loads/Examples/CouplingTimeSeriesHE.mos"
"Simulate and plot"));
end CouplingTimeSeriesHE;
