...
model CouplingGeojsonRCAirFlow "Example illustrating the coupling of a multizone RC model to a fluid loop"
  import Buildings;
...
equation
  ...
  Diagram(
    ...
    __Dymola_Commands(file="Resources/Scripts/Dymola/Applications/DHC/Loads/Examples/CouplingGeojsonRCAirFlow.mos"
        "Simulate and plot"));
end CouplingGeojsonRCAirFlow;
