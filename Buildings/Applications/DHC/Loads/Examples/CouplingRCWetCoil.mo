...
model CouplingRCWetCoil "Example illustrating the coupling of a RC building model to a fluid loop"
  import Buildings;
  ...
  Buildings.Fluid.Sources.MassFlowSource_T supCoo(
    ...
    nPorts=1)             "Supply for chilled water" annotation (Placement(
        ...
        rotation=0,
        origin={-30,-90})));
  Buildings.Applications.DHC.Loads.BaseClasses.HeatingOrCoolingWetCoil
                                                                couHea(
    redeclare package Medium = Medium,
...
equation
  ...
  connect(couCoo.m_flow1Req, supCoo.m_flow_in)
    annotation (Line(points={{22,-82},{30,-82},{30,-66},{-60,-66},{-60,-82},{-42,-82}}, color={0,0,127}));
  connect(couHea.m_flow1Req, supHea.m_flow_in)
    annotation (Line(points={{22,22},{26,22},{26,60},{-60,60},{-60,38},{-44,38}}, color={0,0,127}));
  annotation (
