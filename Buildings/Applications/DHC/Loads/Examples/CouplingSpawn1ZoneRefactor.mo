...
model CouplingSpawn1ZoneRefactor
  ...
  package Medium1 = Buildings.Media.Water
    "Source side medium";
  Buildings.Applications.DHC.Loads.Examples.BaseClasses.SpawnBuilding1ZoneRefactor
    bui(nPorts1=2)
...
equation
  ...
  connect(supHea.ports[1], bui.ports_a1[1])
    annotation (Line(points={{0,10},{24,10},{24,-32},{40,-32}},
                                                              color={0,127,255}));
  connect(supCoo.ports[1], bui.ports_a1[2])
    annotation (Line(points={{0,-70},{24,-70},{24,-28},{40,-28}},
                                                              color={0,127,255}));
  connect(bui.ports_b1[1],sinHea. ports[1])
    annotation (Line(points={{60,-32},{94,-32},{94,10},{120,10}},
                                                                color={0,127,255}));
  connect(bui.ports_b1[2],sinCoo. ports[1])
    annotation (Line(points={{60,-28},{94,-28},{94,-70},{120,-70}},
                                                                color={0,127,255}));
  annotation (
  experiment(
      StopTime=800000,
