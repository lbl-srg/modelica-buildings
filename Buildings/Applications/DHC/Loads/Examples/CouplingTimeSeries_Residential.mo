...
model CouplingTimeSeries_Residential
  ...
  Buildings.Applications.DHC.Loads.Examples.BaseClasses.BuildingTimeSeriesModified
    ...
    nPorts_bHeaWat=1,
    nPorts_bChiWat=1)
    "Residential building time series heating and cooling loads."
...
annotation (
      ...
      __Dymola_Commands(
 file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DHC/Loads/Examples/CouplingTimeSeries_Residential.mos"
      "Simulate and plot"),
 experiment( Tolerance=1e-6,
              StopTime=86400),
Documentation(info="<html>
<p>
This example demonstartes the hydraluic connection between a residential building's heating 
and cooling loads provided as time seriers to infinte sources of district heating and cooling.
</p>
</html>",
revisions=
"<html>
