within Buildings.Applications.DHC.CentralPlants.Gen1st.Cooling.Subsystems.Examples;
model CoolingTowerWithBypass
  ...
  Buildings.Applications.DHC.CentralPlants.Gen1st.Cooling.Subsystems.CoolingTowerWithBypass
    cooTowPar(
    show_T=true,
...
equation
  ...
  connect(weaBus.TWetBul, cooTowPar.TWetBul) annotation (Line(
      points={{-70,90},{-70,30},{-10,30},{-10,46},{-2,46}},
      color={255,204,51},
      thickness=0.5));
