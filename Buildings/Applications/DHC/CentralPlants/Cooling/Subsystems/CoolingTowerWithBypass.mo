...
model CoolingTowerWithBypass "Cooling tower system with bypass valve"
  ...
  Buildings.Controls.OBC.CDL.Continuous.AddParameter addPar(p=dTApp, k=1)
...
equation
  ...
  connect(cooTowSpeCon.y, cooTowSys.uFanSpe) annotation (Line(points={{9,60},{
  ...
  connect(senTCWSup.T, cooTowSpeCon.u_m) annotation (Line(points={{70,-11},{70,-20},
          {34,-20},{34,40},{-2,40},{-2,48}}, color={0,0,127}));
  ...
  connect(TSetByPas.y, gre.u2) annotation (Line(points={{-69,-50},{-66,-50},{
          -66,46},{-74,46},{-74,52},{-72,52}}, color={0,0,127}));
  connect(TSetByPas.y, swi.u3) annotation (Line(points={{-69,-50},{-66,-50},{
          -66,46},{-46,46},{-46,52},{-42,52}}, color={0,0,127}));
  connect(TWetBul, addPar.u) annotation (Line(points={{-120,-20},{-86,-20},{-86,
          90},{-82,90}}, color={0,0,127}));
  connect(addPar.y, gre.u1) annotation (Line(points={{-58,90},{-50,90},{-50,76},
          {-74,76},{-74,60},{-72,60}}, color={0,0,127}));
  connect(addPar.y, swi.u1) annotation (Line(points={{-58,90},{-50,90},{-50,76},
          {-46,76},{-46,68},{-42,68}}, color={0,0,127}));
  annotation (
