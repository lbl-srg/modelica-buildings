...
model Chiller
  ...
  parameter Fluid.Chillers.Data.ElectricEIR.Generic dat(
    ...
    TEvaLvgMin=276.15,
    TEvaLvgMax=288.15,
    TConEnt_nominal=318.15,
    TConEntMin=303.15,
    TConEntMax=333.15)
    "Chiller performance data"
    annotation (Placement(transformation(extent={{-120,-120},{-100,-100}})));
  FifthGeneration.BaseClasses.Chiller chi(
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Ramp dTChiWatRet(
    ...
    height=-3,
    duration=1000,
    startTime=3000) "Chilled water return deltaT"
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Ramp dTHeaWatRet(
    ...
    height=-20,
    duration=500,
    startTime=4500) "Heating water return deltaT"
...
equation
  connect(TChiWatSupSet.y, chi.TChiWatSupSet) annotation (Line(points={{-98,0},{
          -56,0},{-56,-65},{-14,-65}}, color={0,0,127}));
  connect(THeaWatSupSet.y, chi.THeaWatSupSet) annotation (Line(points={{-98,40},
          {-56,40},{-56,-63},{-14,-63}}, color={0,0,127}));
  connect(chi.port_bHeaWat, senTHeaWatSup.port_a) annotation (Line(points={{-12,-56},
  ...
  connect(senTChiWatSup.port_a, chi.port_bChiWat) annotation (Line(points={{60,
          -40},{40,-40},{40,-56},{8,-56}}, color={0,127,255}));
  connect(conWat.ports[2], senTHeaWatRet.port_a) annotation (Line(points={{-100,
          -64},{-100,-80},{-90,-80}}, color={0,127,255}));
  connect(senTHeaWatRet.port_b, chi.port_aHeaWat) annotation (Line(points={{-70,
          -80},{-40,-80},{-40,-68},{-12,-68}}, color={0,127,255}));
  connect(chi.port_aChiWat, senTChiWatRet.port_b) annotation (Line(points={{8,
          -68},{40,-68},{40,-80},{60,-80}}, color={0,127,255}));
  ...
  connect(dTChiWatRet.y, mulSum.u[1]) annotation (Line(points={{170,-20},{162,
          -20},{162,-59},{152,-59}}, color={0,0,127}));
  connect(TChiWatRet.y, mulSum.u[2]) annotation (Line(points={{170,-60},{162,
          -60},{162,-61},{152,-61}}, color={0,0,127}));
  connect(THeaWatRet.y, mulSum1.u[1]) annotation (Line(points={{-168,-62},{-168,
          -59},{-154,-59}}, color={0,0,127}));
  connect(mulSum1.y, conWat.T_in) annotation (Line(points={{-130,-60},{-128,-60},
          {-128,-58},{-122,-58}}, color={0,0,127}));
  connect(dTHeaWatRet.y, mulSum1.u[2]) annotation (Line(points={{-168,-20},{
          -160,-20},{-160,-61},{-154,-61}}, color={0,0,127}));
  connect(uCoo.y, chi.uCoo) annotation (Line(points={{-99,80},{-24,80},{-24,-61},
          {-14,-61}}, color={255,0,255}));
  connect(uHea.y, chi.uHea) annotation (Line(points={{-99,100},{-20,100},{-20,
