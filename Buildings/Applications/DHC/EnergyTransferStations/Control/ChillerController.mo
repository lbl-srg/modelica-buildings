...
equation
  ...
  connect(PI.u_s,TSetHea)  annotation (Line(points={{-60,-162},{-78,-162},{-78,-146},{-114,-146}},
                                                    color={0,0,127}));
  connect(X1.y, mapFun.x1) annotation (Line(points={{-12,-108},{-12,-130},{0,
          -130}},     color={0,0,127}));
  connect(PI.y, mapFun.u)  annotation (Line(points={{-37,-162},{-12,-162},{-12,-138},{0,-138}},
                                                   color={0,0,127}));
  ...
  connect(valEva.y, yValEva) annotation (Line(points={{53,-260},{110,-260}}, color={0,0,127}));
  connect(TMinConEnt, valCon.u_s) annotation (Line(points={{-112,-312},{28,-312}}, color={0,0,127}));
...
annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}})),
       Diagram(
        coordinateSystem(preserveAspectRatio=false, extent={{-100,-360},{100,100}}),
        graphics={
       Rectangle(
