...
model Chiller_bck "Validation of the ETS model with heat recovery chiller"
  ...
  Fluid.Sensors.TemperatureTwoPort senTChiWatRet(redeclare final package Medium =
    ...
    "Chilled water return temperature" annotation (Placement(transformation(
        ...
        rotation=0,
        origin={70,-40})));
  Buildings.Applications.DHC.EnergyTransferStations.Combined.Generation5.Chiller_bck
                                                      ets(
