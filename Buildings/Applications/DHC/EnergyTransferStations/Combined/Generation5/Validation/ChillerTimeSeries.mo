...
model ChillerTimeSeries
  ...
  Buildings.Controls.OBC.CDL.Continuous.LessEqualThreshold noLoaCoo(threshold=0.01)
    "No cooling load"
    annotation (Placement(transformation(extent={{-232,-110},{-212,-90}})));
...
equation
  ...
  connect(TDisWatSup.y, disWat.T_in) annotation (Line(points={{-258,-140},{-192,
  ...
  connect(volHeaWat.ports[2], senTHeaWatRet.port_a) annotation (Line(points={{-121,-2},
          {-121,-40},{-90,-40}},          color={0,127,255}));
  ...
  connect(reqHea.u, truDelHea.y)
    annotation (Line(points={{-172,-20},{-178,-20}}, color={255,0,255}));
  connect(noLoaHea.y, truDelHea.u)
    annotation (Line(points={{-208,-20},{-202,-20}}, color={255,0,255}));
  connect(reqCoo.u, truDelCoo.y)
    annotation (Line(points={{-172,-100},{-178,-100}}, color={255,0,255}));
  connect(noLoaCoo.y, truDelCoo.u)
    annotation (Line(points={{-210,-100},{-202,-100}}, color={255,0,255}));
  connect(gai3.y, loaHea.Q_flow) annotation (Line(points={{-178,60},{-170,60},{-170,
          60},{-160,60}}, color={0,0,127}));
  connect(loa.y[2], gai5.u) annotation (Line(points={{-259,100},{-246,100},{-246,
          42}}, color={0,0,127}));
  connect(loa.y[2], gai3.u) annotation (Line(points={{-259,100},{-240,100},{-240,
          60},{-202,60}}, color={0,0,127}));
  connect(loa.y[1], gai6.u) annotation (Line(points={{-259,100},{-240,100},{-240,
          -58}}, color={0,0,127}));
  connect(gai6.y, noLoaCoo.u) annotation (Line(points={{-240,-82},{-240,-100},{-234,
          -100}}, color={0,0,127}));
  connect(gai5.y, noLoaHea.u) annotation (Line(points={{-246,18},{-246,-20},{-232,
          -20}}, color={0,0,127}));
  connect(gai4.y, loaCoo.Q_flow)
    annotation (Line(points={{178,60},{162,60}}, color={0,0,127}));
  connect(loa.y[1], gai4.u) annotation (Line(points={{-259,100},{-180,100},{-180,
          160},{220,160},{220,60},{202,60}}, color={0,0,127}));
  annotation (Diagram(
