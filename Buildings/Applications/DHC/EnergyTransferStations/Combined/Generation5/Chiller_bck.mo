...
equation
  ...
  connect(THeaWatSupSet, conSup.THeaWatSupPreSet) annotation (Line(points={{-320,
          -56},{-280,-56},{-280,54},{-262,54}}, color={0,0,127}));
  connect(conSup.yIsoEva_, valIsoEva.y) annotation (Line(points={{-236,42},{-200,
          42},{-200,-80},{60,-80},{60,-108}}, color={0,0,127}));
  connect(conSup.yIsoCon_, valIsoCon.y) annotation (Line(points={{-236,46},{-196,
  ...
  connect(conSup.y_[1], int.y2Sup) annotation (Line(points={{-236,50},{-180,50},
