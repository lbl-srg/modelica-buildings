...
model Chiller_trim "Chiller controller"
  ...
  Buildings.Controls.OBC.CDL.Continuous.Feedback err "Tracking error"
    annotation (Placement(transformation(extent={{-150,-130},{-130,-110}})));
  Buildings.Controls.OBC.CDL.Continuous.Gain gai(final k=1/0.5)
    "Gain to convert into number of request"
...
equation
  ...
  connect(heaOrCoo.y, conValEva.trigger) annotation (Line(points={{-78,0},{-20,0},
          {-20,-236},{52,-236},{52,-232}}, color={255,0,255}));
  connect(heaOrCoo.y, conValCon.trigger) annotation (Line(points={{-78,0},{-20,0},
          {-20,-296},{52,-296},{52,-292}}, color={255,0,255}));
  ...
  connect(swi1.y, mapFun.f1) annotation (Line(points={{-48,-80},{40,-80},{40,-116},
  ...
  connect(uHea, triRes.uDevSta) annotation (Line(points={{-180,80},{-140,80},{-140,
          -100},{-60,-100},{-60,-112},{-52,-112}}, color={255,0,255}));
  connect(THeaWatSupSet, err.u1)
    annotation (Line(points={{-180,-120},{-152,-120}}, color={0,0,127}));
  connect(THeaWatSup, err.u2) annotation (Line(points={{-180,-160},{-140,-160},
          {-140,-132}}, color={0,0,127}));
  connect(err.y, gai.u)
    annotation (Line(points={{-128,-120},{-122,-120}}, color={0,0,127}));
  connect(gai.y, reaToInt.u)
    annotation (Line(points={{-98,-120},{-92,-120}}, color={0,0,127}));
  connect(reaToInt.y, triRes.numOfReq) annotation (Line(points={{-68,-120},{-60,
          -120},{-60,-128},{-52,-128}}, color={255,127,0}));
  connect(triRes.y, mapFun.u)
    annotation (Line(points={{-28,-120},{48,-120}}, color={0,0,127}));
