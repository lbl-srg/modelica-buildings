...
equation
  ...
  connect(conHot.yCol, conCol.uCol) annotation (Line(points={{12,42},{16,42},{
          16,-30},{-16,-30},{-16,-46},{-12,-46}},
                                               color={0,0,127}));
  connect(resTSup.THeaWatSupSet, conHot.TSet) annotation (Line(points={{-58,-100},
          {-50,-100},{-50,50},{-12,50}},color={0,0,127}));
  ...
  connect(THeaWatSupPreSet, resTSup.THeaWatSupPreSet) annotation (Line(points={{-140,40},
          {-108,40},{-108,-105},{-82,-105}},           color={0,0,127}));
  connect(uHea, resTSup.uHea) annotation (Line(points={{-140,100},{-100,100},{-100,
          -94},{-82,-94}},      color={255,0,255}));
  ...
  connect(resTSup.THeaWatSupSet, THeaWatSupSet) annotation (Line(points={{-58,-100},
          {-50,-100},{-50,-20},{80,-20},{80,-40},{140,-40}},color={0,0,127}));
