...
equation
  ...
  connect(conHotSid.yAmb, max1.u1)
    annotation (Line(points={{12,49},{24,49},{24,6},{28,6}}, color={0,0,127}));
  connect(conColSid.yAmb, max1.u2) annotation (Line(points={{12,-51},{24,-51},{24,
  ...
  connect(conColSid.yIsoAmb, yIsoEva) annotation (Line(points={{12,-57},{60,-57},
          {60,40},{140,40}},    color={0,0,127}));
  connect(max1.y, yAmb) annotation (Line(points={{52,0},{140,0}},
        color={0,0,127}));
  connect(conHotSid.yIsoAmb, yIsoCon) annotation (Line(points={{12,43},{40,43},{
          40,80},{140,80}}, color={0,0,127}));
  ...
  connect(conHotSid.yHeaCoo, conColSid.uCooHea) annotation (Line(points={{12,55},
          {20,55},{20,-34},{-16,-34},{-16,-46},{-12,-46}},
                                                         color={255,0,255}));
  connect(resTSup.THeaWatSupSet, conHotSid.TSet) annotation (Line(points={{-58,-95},
          {-40,-95},{-40,50},{-12,50}}, color={0,0,127}));
  connect(resTSup.TChiWatSupSet, conColSid.TSet) annotation (Line(points={{-58,-105},
          {-32,-105},{-32,-50},{-12,-50}}, color={0,0,127}));
