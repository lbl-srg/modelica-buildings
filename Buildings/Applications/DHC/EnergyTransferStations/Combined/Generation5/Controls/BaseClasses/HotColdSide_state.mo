...
partial block HotColdSide_state
...
equation
  ...
  connect(TSet2p5THys.y, disRej.u1)
    annotation (Line(points={{-108,-240},{-42,-240}}, color={0,0,127}));
  ...
  connect(disRej.y, t6.condition) annotation (Line(points={{-18,-240},{120,-240},
