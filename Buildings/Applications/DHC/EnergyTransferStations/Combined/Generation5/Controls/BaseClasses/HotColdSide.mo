...
partial block HotColdSide "State machine enabling production and ambient source systems"
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant revAct(final k=
        reverseActing) "Output true in case of reverse acting"
...
equation
  ...
  connect(proDis.y, disHeaCoo.u2) annotation (Line(points={{-18,0},{-2,0},{-2,-8},
          {16,-8}},            color={0,0,127}));
