...
equation
  connect(THeaWatSupPreSet, swiHea.u1) annotation (Line(points={{-120,-50},{-80,
          -50},{-80,8},{-2,8}},   color={0,0,127}));
  connect(minSet.y, swiHea.u3) annotation (Line(points={{-28,-20},{-20,-20},{-20,
          -8},{-2,-8}},
                    color={0,0,127}));
  connect(uHea, swiHea.u2) annotation (Line(points={{-120,60},{-60,60},{-60,0},{
          -2,0}},   color={255,0,255}));
