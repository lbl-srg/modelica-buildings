...
equation
  ...
  connect(greEquThr.y, and2.u2) annotation (Line(points={{-138,40},{-130,40},{
          -130,32},{-82,32}},
                         color={255,0,255}));
  connect(and2.y, conPum2.trigger) annotation (Line(points={{-58,40},{-20,40},{
          -20,-96},{-8,-96},{-8,-92}},
                                   color={255,0,255}));
  connect(and2.y, swiOff2.u2) annotation (Line(points={{-58,40},{148,40},{148,
          -80},{158,-80}},
                      color={255,0,255}));
  connect(yValIso, multiMax.u[1:2])
    annotation (Line(points={{-240,40},{-202,40},{-202,39}}, color={0,0,127}));
  connect(uEnaHex, and2.u1) annotation (Line(points={{-240,100},{-100,100},{
          -100,40},{-82,40}}, color={255,0,255}));
  connect(and2.y, con1.trigger) annotation (Line(points={{-58,40},{-20,40},{-20,
          -16},{-8,-16},{-8,-12}}, color={255,0,255}));
  connect(and2.y, swiOff1.u2) annotation (Line(points={{-58,40},{148,40},{148,0},
