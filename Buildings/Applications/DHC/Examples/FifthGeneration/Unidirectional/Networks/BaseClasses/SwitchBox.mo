...
model SwitchBox
  "Mass flow rate redirection for energy transfer station"
...
equation
  connect(port_b1, splSup1.port_2)
    annotation (Line(points={{-60,100},{-60,80},{-40,80},{-40,70}},
                                                  color={0,127,255}));
  connect(mFreCoo_flow, con.mFreCoo_flow) annotation (Line(points={{-110,2},{-84,
          2},{-84,-48},{-70,-48}},    color={0,0,127}));
  connect(mSpaHea_flow, con.mSpaHea_flow) annotation (Line(points={{-108,82},{-80,
          82},{-80,-32},{-70,-32}},   color={0,0,127}));
