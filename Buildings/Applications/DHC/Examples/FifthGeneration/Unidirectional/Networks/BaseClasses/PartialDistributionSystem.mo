...
partial model PartialDistributionSystem
  ...
  Modelica.Fluid.Interfaces.FluidPorts_a ports_aCon[nCon](
    ...
    "Connection return ports" annotation (Placement(transformation(
        extent={{-10,-40},{10,40}},
        rotation=90,
  ...
  Modelica.Fluid.Interfaces.FluidPorts_b ports_bCon[nCon](
    ...
    each h_outflow(start=Medium.h_default, nominal=Medium.h_default))
    "Connection supply ports" annotation (Placement(transformation(
        extent={{-10,-40},{10,40}},
        rotation=90,
        origin={-80,100}), iconTransformation(
        extent={{-20,-80},{20,80}},
  ...
  Modelica.Fluid.Interfaces.FluidPort_a port_aDisSup(
    ...
    "Distribution supply inlet port" annotation (Placement(transformation(
          extent={{-110,-10},{-90,10}}), iconTransformation(extent={{-220,-20},
            {-180,20}})));
  Modelica.Fluid.Interfaces.FluidPort_b port_bDisSup(
    ...
    "Distribution supply outlet port" annotation (Placement(transformation(
          extent={{90,-10},{110,10}}), iconTransformation(extent={{180,-20},{
            220,20}})));
  annotation (
