...
model EnergyTransferStation_bck1
  ...
  Fluid.Sensors.MassFlowRate           senMasFloHeaWat1(redeclare final package
      Medium = Medium, allowFlowReversal=allowFlowReversal)
    "Heating water mass flow rate (sensed)"
    annotation (Placement(transformation(extent={{60,350},{80,330}})));
  Fluid.Sensors.MassFlowRate           senMasFloChiWat1(redeclare package
      Medium = Medium, allowFlowReversal=allowFlowReversal)
    "Chilled water mass flow rate (sensed)"
    annotation (Placement(transformation(extent={{80,-130},{100,-110}})));
  Fluid.Sensors.MassFlowRate           senMasFloHeaWat2(redeclare final package
      Medium = Medium, allowFlowReversal=allowFlowReversal)
    "Heating water mass flow rate (sensed)"
    annotation (Placement(transformation(extent={{-8,310},{-28,290}})));
  Fluid.Sensors.MassFlowRate           senMasFloChiWat2(redeclare package
      Medium = Medium, allowFlowReversal=allowFlowReversal)
    "Chilled water mass flow rate (sensed)"
...
equation
  ...
  connect(port_b, volMix_b.ports[1]) annotation (Line(points={{280,-400},{
          257.333,-400}},
                color={0,127,255}));
  connect(volHeaWat.ports[1], pumCon.port_a) annotation (Line(points={{-3.2,340},
          {-3.2,320},{140,320},{140,160},{70,160}},     color={0,127,255}));
  connect(senMasFloHeaWat.port_b, volHeaWat.ports[2])
    annotation (Line(points={{-210,340},{-1.6,340}},
                                                  color={0,127,255}));
  ...
  connect(senTConLvg.port_b, volHeaWat.ports[3]) annotation (Line(points={{-170,
          160},{-200,160},{-200,220},{0,220},{0,340}}, color={0,127,255}));
  connect(PPum, PPum)
  ...
  connect(volHeaWat.ports[4], senMasFloHeaWat1.port_a)
    annotation (Line(points={{1.6,340},{60,340}}, color={0,127,255}));
  connect(senMasFloHeaWat1.port_b, senTHeaWatSup.port_a)
    annotation (Line(points={{80,340},{130,340}}, color={0,127,255}));
  connect(volChiWat.ports[4], senMasFloChiWat1.port_a)
    annotation (Line(points={{1.6,-120},{80,-120}}, color={0,127,255}));
  connect(senMasFloChiWat1.port_b, senTChiWatSup.port_a)
    annotation (Line(points={{100,-120},{130,-120}}, color={0,127,255}));
  connect(bouHea.ports[1], senMasFloHeaWat2.port_b)
    annotation (Line(points={{-40,300},{-28,300}}, color={0,127,255}));
  connect(senMasFloHeaWat2.port_a, volHeaWat.ports[5]) annotation (Line(points=
          {{-8,300},{3.2,300},{3.2,340}}, color={0,127,255}));
  connect(bouChi.ports[1], senMasFloChiWat2.port_b)
    annotation (Line(points={{-42,-140},{-30,-140}}, color={0,127,255}));
  connect(senMasFloChiWat2.port_a, volChiWat.ports[5]) annotation (Line(points=
          {{-10,-140},{0,-140},{0,-120},{3.2,-120}}, color={0,127,255}));
...
end EnergyTransferStation_bck1;
