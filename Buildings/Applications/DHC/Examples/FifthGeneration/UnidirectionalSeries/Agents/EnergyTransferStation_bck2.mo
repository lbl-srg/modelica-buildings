...
model EnergyTransferStation_bck2
  ...
  Buildings.Fluid.Delays.DelayFirstOrder volHeaWatRet(
    ...
    annotation (Placement(transformation(extent={{-10,340},{10,360}})));
  ...
  Buildings.Fluid.Sources.Boundary_pT bouChi(
    redeclare final package Medium = Medium, nPorts=1)
              "Pressure boundary condition representing the expansion vessel"
    annotation (Placement(transformation(extent={{-42,-150},{-22,-130}})));
...
equation
  ...
  connect(port_b, volMix_b.ports[1]) annotation (Line(points={{280,-400},{
          257.333,-400}},
                color={0,127,255}));
  connect(volHeaWatRet.ports[1], pumCon.port_a) annotation (Line(points={{-3.2,
          340},{-3.2,320},{140,320},{140,160},{70,160}}, color={0,127,255}));
  connect(senMasFloHeaWat.port_b, volHeaWatRet.ports[2])
    annotation (Line(points={{-210,340},{-1.6,340}}, color={0,127,255}));
  connect(senMasFloHeaWat.m_flow, hysWitHol.u) annotation (Line(points={{-220,329},
  ...
  connect(gai.y, pumCon.m_flow_in) annotation (Line(points={{-118,280},{60,280},
          {60,172}},   color={0,0,127}));
  ...
  connect(senMasFloChiWat.port_b, volChiWat.ports[1])
    annotation (Line(points={{-210,-120},{-3.2,-120}},color={0,127,255}));
  connect(senMasFloChiWat.m_flow, hysWitHol1.u) annotation (Line(points={{-220,-109},
  ...
  connect(pro.y, pum1HexChi.m_flow_in)
    annotation (Line(points={{-66,0},{-40,0},{-40,-60},{-100,-60},{-100,-248}},
                                                            color={0,0,127}));
  connect(conTChiWat.y, pro.u1) annotation (Line(points={{-148,40},{-100,40},{-100,
          6},{-90,6}},             color={0,0,127}));
  connect(gai4.y, pum2CooHex.m_flow_in) annotation (Line(points={{-118,-40},{60,
          -40},{60,-208}},    color={0,0,127}));
  connect(senMasFloChiWat.m_flow, gai4.u) annotation (Line(points={{-220,-109},{
          -220,-40},{-142,-40}},   color={0,0,127}));
  connect(PPum, PPum)
  ...
  connect(pumCon.P, PPumHea.u[1]) annotation (Line(points={{49,169},{40,169},{40,
          200},{168,200},{168,421}},     color={0,0,127}));
  connect(pumEva.P, PPumHea.u[2]) annotation (Line(points={{-89,129},{-89,128},{
          -80,128},{-80,180},{168,180},{168,419}},
                                              color={0,0,127}));
  connect(pum1HexChi.P, PPumCoo.u[1]) annotation (Line(points={{-89,-251},{-80,-251},
          {-80,-240},{160,-240},{160,381},{168,381}},
                                          color={0,0,127}));
  connect(pum2CooHex.P, PPumCoo.u[2]) annotation (Line(points={{49,-211},{40,-211},
          {40,0},{160,0},{160,379},{168,379}},                  color={0,0,127}));
  connect(PPumHea.y, mulSum1.u[1]) annotation (Line(points={{192,420},{220,420},
          {220,361},{228,361}}, color={0,0,127}));
  connect(gai1.y, mulSum1.u[2]) annotation (Line(points={{-118,240},{228,240},{228,
          359}},                                         color={0,0,127}));
  ...
  connect(pum2CooHex.port_b, hexChi.port_a2)
    annotation (Line(points={{50,-220},{20,-220},{20,-248},{10,-248}},
                                                  color={0,127,255}));
  ...
  connect(volChiWat.ports[2], pum2CooHex.port_a) annotation (Line(points={{-1.6,
          -120},{6,-120},{6,-160},{140,-160},{140,-220},{70,-220}},   color=
         {0,127,255}));
  connect(senT2HexChiLvg.port_b, volChiWat.ports[3]) annotation (Line(
        points={{-170,-220},{-200,-220},{-200,-160},{0,-160},{0,-120}},
        color={0,127,255}));
  ...
  connect(pumCon.port_b, heaPum.port_a1) annotation (Line(points={{50,160},{40,160},
          {40,132},{10,132}},         color={0,127,255}));
  connect(ports_a1[1], senMasFloHeaWat.port_a) annotation (Line(points={{-280,100},
          {-240,100},{-240,340},{-230,340}}, color={0,127,255}));
  connect(ports_a1[2], senMasFloChiWat.port_a) annotation (Line(points={{-280,140},
          {-240,140},{-240,-120},{-230,-120}}, color={0,127,255}));
  connect(senTHeaWatSup.port_b, ports_b1[1]) annotation (Line(points={{150,340},
          {180,340},{180,100},{280,100}},color={0,127,255}));
  connect(senTChiWatSup.port_b, ports_b1[2]) annotation (Line(points={{150,-120},
          {240,-120},{240,140},{280,140}}, color={0,127,255}));
  connect(pum1HexChi.m_flow_actual, mCoo_flow) annotation (Line(points={{-89,
          -255},{-80,-255},{-80,-242},{162,-242},{162,240},{300,240}}, color={0,
          0,127}));
  connect(pumEva.m_flow_actual, mHea_flow) annotation (Line(points={{-89,125},{
          -78,125},{-78,180},{168,180},{168,280},{300,280}}, color={0,0,127}));
  connect(volHeaWatRet.ports[3], senTHeaWatSup.port_a) annotation (Line(points=
          {{0,340},{66,340},{66,340},{130,340}}, color={0,127,255}));
  connect(bouHea.ports[1], volHeaWatRet.ports[4]) annotation (Line(points={{-20,
          320},{-10,320},{-10,340},{1.6,340}}, color={0,127,255}));
  connect(volChiWat.ports[4], senTChiWatSup.port_a)
    annotation (Line(points={{1.6,-120},{130,-120}}, color={0,127,255}));
  connect(bouChi.ports[1], volChiWat.ports[5]) annotation (Line(points={{-22,
          -140},{3.2,-140},{3.2,-120}}, color={0,127,255}));
  connect(senTConLvg.port_b, volHeaWatRet.ports[5]) annotation (Line(points={{
          -170,160},{-200,160},{-200,220},{3.2,220},{3.2,340}}, color={0,127,
          255}));
  annotation (
...
end EnergyTransferStation_bck2;
