...
equation
  ...
  connect(senT1Sup.port_b, hydHea.ports_a[1]) annotation (Line(points={{-30,20},
          {2,20},{2,8}},         color={0,127,255}));
  connect(hydHea.ports_b[1], senT1Ret.port_a) annotation (Line(points={{-2,-12},
          {-2,-20},{-30,-20}},    color={0,127,255}));
  connect(senT2Ret.port_b, hydHea.ports_b[2]) annotation (Line(points={{30,-20},
          {14,-20},{14,-12},{2,-12}},        color={0,127,255}));
  connect(hydHea.ports_a[2], senT2Sup.port_a) annotation (Line(points={{-2,8},{
  ...
  connect(m2.y,sou3. m_flow_in)
    annotation (Line(points={{178,-80},{160,-80},{160,-148}},
                                                          color={0,0,127}));
  connect(senT2Ret1.port_b, hydHea.ports_b[2]) annotation (Line(points={{30,
          -160},{14,-160},{14,-12},{2,-12}}, color={0,127,255}));
  connect(hydHea.ports_a[2], senT2Sup1.port_a) annotation (Line(points={{-2,8},
          {20,8},{20,-120},{30,-120}}, color={0,127,255}));
  annotation (
   ...
   experiment(
    ...
    __Dymola_Commands(file="Resources/Scripts/Dymola/Applications/DHC/Examples/FifthGenUniSeries/Validation/BuildingETSConnection.mos"
        "Simulate and plot"),
    Icon(coordinateSystem(extent={{-180,-200},{220,120}})));
end Decoupler;
