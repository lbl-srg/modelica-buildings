within Buildings.Applications.DataCenters.DXCooled.Examples.BaseClasses.Examples;
model AirsideEconomizerController
  ...
  Buildings.Applications.DataCenters.DXCooled.Examples.BaseClasses.AirsideEconomizerController con(
    minOAFra= 0,
...
equation
  ...
  annotation (
    __Dymola_Commands(file="Resources/Scripts/Dymola/Applications/DataCenters/DXCooled/Examples/BaseClasses/Examples/AirsideEconomizerController.mos"
        "Simulate and Plot"),
