...
model ReheatOnOffControl "Test model for reheater controller"
  extends Modelica.Icons.Example;

  Buildings.Applications.DataCenters.HVAC.AHUs.BaseClasses.ReheatOnOffControl heaCon(
    yValSwi=0.2,
    yValDeaBan=0.1,
    dTSwi=0,
    dTDeaBan=0.5,
...
equation
  ...
  annotation (experiment(Tolerance=1e-6, StopTime=100),
    __Dymola_Commands(file="Resources/Scripts/Dymola/Applications/DataCenters/HVAC/AHUs/BaseClasses/Examples/ReheatOnOffControl.mos"
        "Simulate and Plot"),
