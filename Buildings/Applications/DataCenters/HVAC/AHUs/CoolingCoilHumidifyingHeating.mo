...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
    ...
    as shown in <a href=\"modelica://Buildings.Applications.DataCenters.HVAC.AHUs.Examples.CoolingCoilHumidifyingHeating_ClosedLoop\">
    Buildings.Applications.DataCenters.HVAC.AHUs.Examples.CoolingCoilHumidifyingHeating_ClosedLoop.</a>
    </p>
    ...
    Buildings.Applications.DataCenters.HVAC.AHUs.BaseClasses.ReheatOnOffControl.</a></p>
