within Buildings.Applications.DataCenters.ChillerCooled.Controls.Examples;
model CoolingModeControlNonIntegrated
  "Example that illustrates the use of Buildings.Applications.DataCenters.ChillerCooled.Controls.CoolingModeControlNonIntegrated"
  extends Modelica.Icons.Example;

  Buildings.Applications.DataCenters.ChillerCooled.Controls.CoolingModeControlNonIntegrated
  cooModCon(
    tWai=30,
    deaBan=1,
    TSwi=280.15)
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
    ...
    __Dymola_Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Controls/Examples/CoolingModeControlNonIntegrated.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This model tests the cooling mode controller implemented in 
<a href=\"modelica://Buildings.Applications.DataCenters.ChillerCooled.Controls.CoolingModeControlNonIntegrated\">
Buildings.Applications.DataCenters.ChillerCooled.Controls.CoolingModeControlNonIntegrated</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
