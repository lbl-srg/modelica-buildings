...
model ChillerStageControl
  ...
  Buildings.Applications.DataCenters.ChillerCooled.Controls.ChillerStageControl chiStaCon(
    tWai=30,
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
    ...
    __Dymola_Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Controls/Examples/ChillerStageControl.mos"
        "Simulate and plot"),
