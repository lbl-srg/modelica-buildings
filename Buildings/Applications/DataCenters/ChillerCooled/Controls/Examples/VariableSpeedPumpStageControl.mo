...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
    ...
    __Dymola_Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Controls/Examples/VariableSpeedPumpStageControl.mos"
        "Simulate and plot"),
...
Buildings.Applications.DataCenters.ChillerCooled.Controls.VariableSpeedPumpStageControl</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
