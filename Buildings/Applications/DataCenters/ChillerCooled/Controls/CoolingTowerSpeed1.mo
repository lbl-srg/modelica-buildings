...
model CoolingTowerSpeed1 "Controller for the fan speed in cooling towers"
...
equation
  ...
  connect(swi1.y, conPID.u_s)
    annotation (Line(points={{-9,50},{0,50},{0,0},{18,0}},
                 color={0,0,127}));
  ...
  connect(swi2.y, conPID.u_m)
    annotation (Line(points={{-19,-60},{30,-60},{30,-12}}, color={0,0,127}));
