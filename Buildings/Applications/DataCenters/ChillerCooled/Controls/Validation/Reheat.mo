...
model Reheat "Test model for reheater controller with hysteresis"
...
equation
  ...
  annotation (experiment(Tolerance=1e-6, StopTime=100),
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Controls/Validation/Reheat.mos"
        "Simulate and Plot"),
