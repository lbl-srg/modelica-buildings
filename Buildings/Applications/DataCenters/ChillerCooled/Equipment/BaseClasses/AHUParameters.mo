...
partial model AHUParameters "Essential parameters for air handling unit"
  ...
  parameter Modelica.Units.SI.Time tau1=20
    "Time constant at nominal flow of medium 1" annotation (Dialog(group=
          "Cooling coil", enable=not (energyDynamics == Modelica.Fluid.Types.Dynamics.SteadyState)));
  parameter Modelica.Units.SI.Time tau2=1
    "Time constant at nominal flow of medium 2" annotation (Dialog(group=
          "Cooling coil", enable=not (energyDynamics == Modelica.Fluid.Types.Dynamics.SteadyState)));
