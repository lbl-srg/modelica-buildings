within Buildings.Applications.DataCenters.DataHalls.Racks.LiquidCooledSinglePhase.BaseClasses.Examples;
model CaseTemperature "Example model for case temperature"
  extends Modelica.Icons.Example;

  parameter Integer nPar = 4 "Number of parallel cold plates";
  Buildings.Applications.DataCenters.DataHalls.Racks.LiquidCooledSinglePhase.BaseClasses.CaseTemperature
...
equation
  ...
  annotation (
   experiment(
     ...
     StopTime=1),
     __Dymola_Commands(
       file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/DataHalls/Racks/LiquidCooledSinglePhase/BaseClasses/Examples/CaseTemperature.mos" "Simulate and plot"),
