within Buildings.Applications.DataCenters.DataHalls.Racks.LiquidCooledSinglePhase.Examples;
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
      __Dymola_Commands(
       file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/DataHalls/Racks/LiquidCooledSinglePhase/Examples/ColdPlateR_P.mos" "Simulate and plot"),
