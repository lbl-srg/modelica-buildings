within Buildings.Applications.DataCenters.DataHalls.Racks.BaseClasses;
partial model PartialRack "Partial model of an IT rack, with utilization as input"
  ...
  replaceable parameter Buildings.Applications.DataCenters.DataHalls.Racks.BaseClasses.Data.Generic dat
    "Performance data"
