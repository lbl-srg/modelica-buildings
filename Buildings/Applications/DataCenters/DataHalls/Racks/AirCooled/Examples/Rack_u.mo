within Buildings.Applications.DataCenters.DataHalls.Racks.AirCooled.Examples;
model Rack_u "Example model for air cooled rack"
  ...
  Buildings.Applications.DataCenters.DataHalls.Racks.AirCooled.Rack_u rac(
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
      __Dymola_Commands(
       file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/DataHalls/Racks/AirCooled/Examples/Rack_u.mos" "Simulate and plot"),
