...
model ChillerWSEDesignConditionsGlycol
  ...
  extends Buildings.Applications.DataCenters.DataHalls.Examples.ChillerWSE(
    break weaDat,
    break weaBus,
    uti(k=1),
    fraWSE=0.999999,
...
equation
  ...
  annotation (Diagram(coordinateSystem(extent={{-580,-120},{540,780}})),
    ...
    experiment(
      ...
      Tolerance=1e-06),
      __Dymola_Commands(
       file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/DataHalls/Validation/ChillerWSEDesignConditionsGlycol.mos" "Simulate and plot"),
