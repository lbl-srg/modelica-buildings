within Buildings.Applications.DataCenters.DataHalls.CDUs.LiquidToLiquid.Data.BaseClasses;
function thermalConductivity_TX_a "Return thermal conductivity"
  extends Modelica.Icons.Function;
  input Buildings.Applications.DataCenters.DataHalls.Types.Media medium
    "Medium type";
...
algorithm
  k_default :=
  if medium == Buildings.Applications.DataCenters.DataHalls.Types.Media.EthyleneGlycol
  then
