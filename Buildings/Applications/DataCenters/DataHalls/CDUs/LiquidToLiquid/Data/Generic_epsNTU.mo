...
record Generic_epsNTU
  ...
  // Volume fractions
  parameter DataHalls.Types.Media medPla=Buildings.Applications.DataCenters.DataHalls.Types.Media.Water
  ...
  final parameter Modelica.Units.SI.MassFraction XGlyPla =
    if medPla ==Buildings.Applications.DataCenters.DataHalls.Types.Media.Water
    then
      0
    elseif medPla ==Buildings.Applications.DataCenters.DataHalls.Types.Media.EthyleneGlycol
    then
  ...
  parameter DataHalls.Types.Media medRac
    "Media for which performance data are specified"
  ...
  final parameter Modelica.Units.SI.MassFraction XGlyRac =
    if medRac ==Buildings.Applications.DataCenters.DataHalls.Types.Media.Water
    then
      0
    elseif medRac ==Buildings.Applications.DataCenters.DataHalls.Types.Media.EthyleneGlycol
    then
      Buildings.Media.Antifreeze.Functions.EthyleneGlycolWater.volumeToMassFraction(
        phi=phiGlyRac,
        T=TRacOut_nominal)
  ...
  final parameter Modelica.Units.SI.DynamicViscosity etaPla_default =
    Buildings.Applications.DataCenters.DataHalls.CDUs.LiquidToLiquid.Data.BaseClasses.dynamicViscosity_TX_a(
  ...
  final parameter Modelica.Units.SI.SpecificHeatCapacity cpPla_default =
    Buildings.Applications.DataCenters.DataHalls.CDUs.LiquidToLiquid.Data.BaseClasses.specificHeatCapacityCp_TX_a(
      medium=medPla, X_a=XGlyPla, T=TRacOut_nominal)
  ...
  final parameter Modelica.Units.SI.ThermalConductivity kPla_default =
    Buildings.Applications.DataCenters.DataHalls.CDUs.LiquidToLiquid.Data.BaseClasses.thermalConductivity_TX_a(
      medium=medPla, X_a=XGlyPla, T=TRacOut_nominal)
    "Thermal conductivity for plant-side performance data";
  final parameter Modelica.Units.SI.PrandtlNumber PrPla_default =
    Buildings.Applications.DataCenters.DataHalls.CDUs.LiquidToLiquid.Data.BaseClasses.prandtlNumber_TX_a(
      medium=medPla, X_a=XGlyPla, T=TRacOut_nominal)
  ...
  final parameter Modelica.Units.SI.Density rhoRac_default =
    Buildings.Applications.DataCenters.DataHalls.CDUs.LiquidToLiquid.Data.BaseClasses.density_TX_a(
      medium=medRac, X_a=XGlyRac, T=TRacOut_nominal)
...
<a href=\"modelica://Buildings.Applications.DataCenters.DataHalls.CDUs.LiquidToLiquid.Data.GoogleProjectDeschutes\">
Buildings.Applications.DataCenters.DataHalls.CDUs.LiquidToLiquid.Data.GoogleProjectDeschutes</a>, which is
