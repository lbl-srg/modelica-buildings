within Buildings.Applications.DataCenters.DataHalls.CDUs.LiquidToLiquid.Examples;
model CDU_epsNTU "Example model of a CDU with varying load on the IT side"
  ...
  parameter Buildings.Applications.DataCenters.DataHalls.CDUs.LiquidToLiquid.Data.Generic_epsNTU datCDU(
    Q_flow_nominal=-PRac,
...
equation
  ...
  annotation (Diagram(coordinateSystem(extent={{-120,-120},{120,140}})), Icon(
    ...
    experiment(
      ...
      Tolerance=1e-05),
      __Dymola_Commands(
       file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/DataHalls/CDUs/LiquidToLiquid/Examples/CDU_epsNTU.mos" "Simulate and plot"),
