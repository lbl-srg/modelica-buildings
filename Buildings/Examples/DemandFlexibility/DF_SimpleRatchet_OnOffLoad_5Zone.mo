...
replaceable package MediumAir = Buildings.Media.Air;
  ...
  Buildings.Controls.OBC.DemandFlexibility.multiple_zone_ratchet multiple_zone_ratchet(
    nZones=5,
  ...
  Buildings.Controls.OBC.DemandFlexibility.multiple_zone_ratchet multiple_zone_ratchet_baseline(
    nZones=5,
    TZonHeaSetNomOcc=THeaSetOcc,
    TZonHeaSetNomUnocc=THeaSetUnocc,
    TZonCooSetNomOcc=TCooSetOcc,
...
equation
  ...
  connect(setpoint_processing_baseline.TZonCooSetPro,
    multiple_zone_ratchet_baseline.TZonCooSetCur) annotation (Line(points={{20,-38},
