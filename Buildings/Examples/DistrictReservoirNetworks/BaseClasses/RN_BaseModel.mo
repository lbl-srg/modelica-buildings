...
partial model RN_BaseModel "Partial model for the reservoir network"
  ...
  Networks.DistributionPipe disPip3(
    ...
    final R=datDes.RDisPip) "Distribution pipe" annotation (Placement(
        ...
        rotation=-90,
        origin={80,72})));
  Networks.SwitchBoxEnergyTransferStation swiOff(final m_flow_nominal=datDes.mDisPip_flow_nominal,
      redeclare package Medium = Medium) "Flow switch office building"
    annotation (Placement(transformation(
        extent={{10,10},{-10,-10}},
        rotation=-90,
        origin={-150,0})));
  Networks.SwitchBoxEnergyTransferStation swiApa(final m_flow_nominal=datDes.mDisPip_flow_nominal,
      redeclare package Medium = Medium) "Flow switch apartment" annotation (
      Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=-90,
        origin={150,158})));
  Networks.SwitchBoxEnergyTransferStation swiHos(final m_flow_nominal=datDes.mDisPip_flow_nominal,
      redeclare package Medium = Medium) "Flow switch hospital" annotation (
      Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=-90,
        origin={150,-52})));
...
equation
  ...
  connect(mSetPla_flow.y, pumPlaPri.m_flow_in) annotation (Line(points={{-263.2,
  ...
  connect(proOff.m_flow_FC, swiOff.mFreCoo_flow) annotation (Line(points={{
        ...
        color={0,0,127}));
  connect(bou.ports[1], pumDisLop.port_a) annotation (Line(points={{120,-270},{
  ...
  connect(EPumDis.u[1], pumDisLop.P) annotation (Line(points={{114,-317.9},{92,
          -317.9},{92,-318},{70,-318},{70,-310},{71,-310},{71,-301}}, color={0,
          0,127}));
  connect(EBorFie.u[1], borFie.Q_flow) annotation (Line(points={{-28,-458},{-20,
          -458},{-20,-448},{-13,-448}}, color={0,0,127}));
  connect(swiOff.PPum, EPumPro.u[4]) annotation (Line(points={{-150,10.8333},{
          -150,287.3},{246,287.3}}, color={0,0,127}));
  connect(swiApa.PPum, EPumPro.u[5]) annotation (Line(points={{150,147.167},{
          150,146},{164,146},{164,290},{246,290},{246,285.9}}, color={0,0,127}));
  connect(swiHos.PPum, EPumPro.u[6]) annotation (Line(points={{150,-62.8333},{
          150,-76},{166,-76},{166,284.5},{246,284.5}}, color={0,0,127}));
  ...
  connect(proOff.port_b, swiOff.port_a2) annotation (Line(points={{-219.857,-20},
  ...
  connect(senEntBorIn.port_b, pumDisLop.port_b)
  ...
  connect(proHos.port_b, swiHos.port_a2) annotation (Line(points={{219.857,-34},
          ...
          255}));
  connect(proApa.port_b, swiApa.port_a2) annotation (Line(points={{219.857,178},
          {232,178},{232,146},{170,146},{170,153},{159.9,153}}, color={0,127,
          255}));
  annotation (Diagram(
