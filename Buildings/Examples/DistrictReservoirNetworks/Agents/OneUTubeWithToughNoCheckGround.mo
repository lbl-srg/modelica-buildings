...
model OneUTubeWithToughNoCheckGround
  "Borefield model containing single U-tube boreholes, with ground response calcuted by TOUGH"
  extends
    Buildings.Fluid.Geothermal.Borefields.BaseClasses.PartialBorefieldWithToughNoCheckGround(
    show_T=true,
...
end OneUTubeWithToughNoCheckGround;
