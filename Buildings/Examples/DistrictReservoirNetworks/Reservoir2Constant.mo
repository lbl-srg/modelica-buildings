...
model Reservoir2Constant "Reservoir network with simple control and dp=125 Pa/m"
  ...
  extends
    Buildings.Examples.DistrictReservoirNetworks.Reservoir1Constant(
    datDes(
      RDisPip=125));

  annotation (
  Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-320,-480},{380,360}})),
        __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Examples/DistrictReservoirNetworks/Reservoir2Constant.mos"
        "Simulate and plot"),
