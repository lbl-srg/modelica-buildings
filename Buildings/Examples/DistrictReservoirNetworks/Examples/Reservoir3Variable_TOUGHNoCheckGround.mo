...
model Reservoir3Variable_TOUGHNoCheckGround
  "Reservoir network with optimized controller"
  extends Modelica.Icons.Example;
  extends
    Buildings.Examples.DistrictReservoirNetworks.Examples.BaseClasses.RN_BaseModel_TOUGHNoCheckGround(
  datDes(
...
end Reservoir3Variable_TOUGHNoCheckGround;
