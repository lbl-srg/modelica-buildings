...
model Bidirectional "Bidirectional network"
  ...
  parameter Buildings.Examples.DistrictReservoirNetworks.Examples.DesignValues datDes(
   ...
   Buildings.Examples.DistrictReservoirNetworks.Agents.BoreField borFie(
  ...
  Networks.DistributionPipe disPip6(
    ...
    final R=datDes.RDisPip) "Distribution pipe" annotation (Placement(
        ...
        rotation=-90,
        origin={160,-30})));
  Networks.SwitchBoxBorehole swiBoxBorFie(final m_flow_nominal=datDes.mSto_flow_nominal,
      redeclare package Medium = Medium)
  ...
  Networks.Controls.PumpMode conPumMod "Controller for pump mode"
