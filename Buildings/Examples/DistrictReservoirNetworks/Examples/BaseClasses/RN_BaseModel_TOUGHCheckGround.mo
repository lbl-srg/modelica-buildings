...
partial model RN_BaseModel_TOUGHCheckGround
  ...
  Agents.OneUTubeWithToughCheckGround borFie(redeclare package Medium =
...
equation
  ...
  connect(tempAfterPlantSecondSide.port_b, sewageSourceAtConstTemp.ports[1])
    annotation (Line(points={{-172,-270},{-180,-270},{-180,-241}},color={0,127,
          255},
      thickness=1));
...
end RN_BaseModel_TOUGHCheckGround;
