...
partial model RN_BaseModel_TOUGHNoCheckGround
  ...
  Agents.OneUTubeWithToughNoCheckGround
...
equation
  ...
  connect(pumpPrimarySidePlant.P, EPumPla.u[2]) annotation (Line(points={{-131,-199},
          {-131,-174},{-164,-174},{-164,-150.95},{-154,-150.95}},
                                                         color={0,0,127}));
  ...
  connect(heatFromToNetwrokProsumer2.y, ESumProsumers.u[3]) annotation (Line(
        points={{199,100},{190,100},{190,60},{276,60},{276,-118},{288,-118},{288,
          -112.6}},                                               color={0,0,
          127}));
  connect(EHeaPum.y, EEleTot.u[1]) annotation (Line(points={{259.02,268},{266,268},
          {266,278.95},{284,278.95}}, color={0,0,127}));
  ...
  connect(Tml2.T, TVio.u[2]) annotation (Line(points={{-86.6,-94},{-282,-94},{-282,
          329.16},{324,329.16}}, color={0,0,127}));
  ...
  connect(Tml5.T, TVio.u[5]) annotation (Line(points={{86.6,-100},{140,-100},{140,
          -132},{310,-132},{310,331.68},{324,331.68}}, color={0,0,127}));
  connect(TVio.y, pri1.x[1])
    annotation (Line(points={{337.02,330},{350,330}}, color={0,0,127}));
  connect(EPumPro.y, EPumTot.u[1]) annotation (Line(points={{259.02,288},{266,288},
          {266,306.6},{284,306.6}},      color={0,0,127}));
  connect(EPumDis.y, EPumTot.u[2]) annotation (Line(points={{119.02,-390},{268,
          -390},{268,308},{284,308}}, color={0,0,127}));
  connect(EPumPla.y, EPumTot.u[3]) annotation (Line(points={{-140.98,-152},{-132,
          -152},{-132,-88},{-270,-88},{-270,328},{270,328},{270,309.4},{284,309.4}},
                       color={0,0,127}));
  connect(EPumTot.y, EEleTot.u[2]) annotation (Line(points={{297.02,308},{300,308},
          {300,294},{276,294},{276,281.05},{284,281.05}},    color={0,0,127}));
  annotation (Diagram(
...
end RN_BaseModel_TOUGHNoCheckGround;
