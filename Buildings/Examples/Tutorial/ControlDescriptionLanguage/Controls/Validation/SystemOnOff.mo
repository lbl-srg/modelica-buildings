...
model SystemOnOff
  ...
  Buildings.Examples.Tutorial.ControlDescriptionLanguage.Controls.SystemOnOff
...
__Dymola_Commands(file=
     "modelica://Buildings/Resources/Scripts/Dymola/Examples/Tutorial/ControlDescriptionLanguage/Controls/Validation/SystemOnOff.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06,
