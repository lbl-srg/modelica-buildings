within Buildings.Examples.Tutorial.ControlDescriptionLanguage.Controls.Validation;
model EquipmentOnOff
  ...
  Buildings.Examples.Tutorial.ControlDescriptionLanguage.Controls.EquipmentOnOff
...
__Dymola_Commands(file=
     "modelica://Buildings/Resources/Scripts/Dymola/Examples/Tutorial/ControlDescriptionLanguage/Controls/Validation/EquipmentOnOff.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06,
