...
model RadiatorSupply
  ...
  Buildings.Examples.Tutorial.ControlDescriptionLanguage.Controls.RadiatorSupply
...
__Dymola_Commands(file=
     "modelica://Buildings/Resources/Scripts/Dymola/Examples/Tutorial/ControlDescriptionLanguage/Controls/Validation/RadiatorSupply.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06,
