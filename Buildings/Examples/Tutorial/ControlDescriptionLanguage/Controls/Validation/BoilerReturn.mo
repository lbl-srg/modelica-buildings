...
model BoilerReturn
  ...
  Buildings.Examples.Tutorial.ControlDescriptionLanguage.Controls.BoilerReturn
...
__Dymola_Commands(file=
     "modelica://Buildings/Resources/Scripts/Dymola/Examples/Tutorial/ControlDescriptionLanguage/Controls/Validation/BoilerReturn.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06,
