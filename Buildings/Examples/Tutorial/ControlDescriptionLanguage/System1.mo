...
//--------------------------------------------------------------------------------//
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant y1(k=1)
    "Control signal of 1"
...
equation
  ...
  connect(TOut.port, senTOut.port) annotation (Line(
      ...
      color={191,0,0},
      smooth=Smooth.None));
  connect(y1.y, pumBoi.m_flow_in) annotation (Line(points={{-98,-70},{-80,-70},
          {-80,-280},{-62,-280}}, color={0,0,127}));
  connect(y2.y, valBoi.y) annotation (Line(points={{122,-200},{130,-200},{130,
          -230},{72,-230}}, color={0,0,127}));
  connect(y1.y, pumRad.m_flow_in)
    annotation (Line(points={{-98,-70},{-62,-70}}, color={0,0,127}));
  connect(y1.y, valRad.y) annotation (Line(points={{-98,-70},{-80,-70},{-80,
          -150},{-62,-150}}, color={0,0,127}));
  connect(y3.y, boi.y) annotation (Line(points={{-98,-250},{32,-250},{32,-302},
          {22,-302}}, color={0,0,127}));
  annotation (Documentation(info="<html>
<p>
This model implements the HVAC system model and a simple room, which is here modeled
...
<p>
Simulate the model for January 1 and 2 and plot the open loop temperatures
as shown below.
</p>
<p align=\"center\">
...
First implementation.
    ...
    __Dymola_Commands(file=
     "modelica://Buildings/Resources/Scripts/Dymola/Examples/Tutorial/ControlDescriptionLanguage/System1.mos"
        "Simulate and plot"),
    experiment(
      StopTime=172800,
      Tolerance=1e-06,
