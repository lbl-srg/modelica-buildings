...
model System2_RadTest_0605_Exterior_v18FINAL
...
equation
  ...
  connect(zeroOrderHold.y, chaSig.u) annotation (Line(points={{-629,218},{-746,218},
          {-746,198},{-860,198},{-860,150},{-816,150}}, color={0,0,127}));
  ...
  connect(airIn.ports[1], testCell_Radiant.ports[1]) annotation (Line(points={{20,272},
          {62,272},{62,307.333},{87,307.333}},
                                            color={0,127,255}));
  connect(testCell_Radiant.ports[2], temRoom.port_a) annotation (Line(points={{87,310},
          {87,260},{170,260},{170,162}},      color={0,127,255}));
  connect(temRoom.port_b, airOut1.ports[1]) annotation (Line(points={{170,182},{
          88,182},{88,100},{68,100}}, color={0,127,255}));
  connect(intGai2.y, testCell_Radiant.qGai_flow) annotation (Line(points={{35,316},
          {58,316},{58,328},{80.4,328}}, color={0,0,127}));
  connect(sla1.surf_a, testCell_Radiant.heaPorRad) annotation (Line(points={{10,
          22},{44,22},{44,316.2},{101,316.2}}, color={191,0,0}));
  connect(shaPos2.y[1], testCell_Radiant.uSha[1]) annotation (Line(points={{29,342},
          {62,342},{62,338},{80.4,338}}, color={0,0,127}));
  ...
  connect(conBel2.port_b, testCell_Radiant.surf_conBou[1]) annotation (Line(
        points={{138,262},{124,262},{124,304},{108,304}}, color={191,0,0}));
...
end System2_RadTest_0605_Exterior_v18FINAL;
