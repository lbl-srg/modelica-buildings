...
partial model PartialChillerPlant "Chiller plant model for closed-loop test"
  ...
  Modelica.Fluid.Interfaces.FluidPort_b portCooCoiRet(redeclare package Medium
    ...
    annotation (Placement(transformation(extent={{430,-50},{450,-30}}),
...
equation
  ...
  connect(jun10.port_2, portCooCoiSup)
    annotation (Line(points={{200,60},{200,-40}}, color={0,127,255}));
  connect(chiWatRet1.port_a, portCooCoiRet)
    annotation (Line(points={{440,-10},{440,-40}}, color={0,127,255}));
