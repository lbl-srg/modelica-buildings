...
partial model DataCenter
  ...
  Buildings.Examples.BoilerPlant.BaseClasses.Controls.WSEControl wseCon
  ...
  Buildings.Examples.BoilerPlant.BaseClasses.Controls.LinearPiecewiseTwo linPieTwo(
    x0=0,
    x2=1,
    x1=0.5,
    y11=1,
  ...
  Buildings.Examples.BoilerPlant.BaseClasses.Controls.KMinusU KMinusU(k=1)
