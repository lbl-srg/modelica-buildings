...
model BoilerPlant_backup "Boiler plant model for closed loop testing"
  ...
  Fluid.FixedResistances.PressureDrop           pipe1(
    redeclare package Medium = MediumW,
    final allowFlowReversal=false,
    final m_flow_nominal=mSec_flow_nominal) if not have_priOnl
    "Dynamic pipe element to represent duct loss"
...
equation
  ...
  connect(senTem.T, ySupTem) annotation (Line(points={{-41,130},{-60,130},{-60,148},
          {300,148},{300,100},{340,100}},           color={0,0,127}));
  ...
  connect(senTem.port_b, port_b) annotation (Line(points={{-30,140},{-32,140},{-32,
  ...
  connect(senTem.T, conPIDPla.u_m) annotation (Line(points={{-41,130},{-60,130},
          {-60,168}},       color={0,0,127}));
  connect(TPlaHotWatSupSet, conPIDPla.u_s) annotation (Line(points={{-340,-160},
          {-88,-160},{-88,180},{-72,180}}, color={0,0,127}));
  ...
  connect(uPla, edg1.u) annotation (Line(points={{-340,200},{-126,200},{-126,160},
          {-122,160}}, color={255,0,255}));
  connect(edg1.y, conPIDPla.trigger) annotation (Line(points={{-98,160},{-66,160},
          {-66,168}},                         color={255,0,255}));
  connect(mul.y, reaScaRep.u)
    annotation (Line(points={{122,180},{138,180}}, color={0,0,127}));
  connect(conPIDPla.y, mul.u2) annotation (Line(points={{-48,180},{92,180},{92,174},
  ...
  connect(uHotIsoVal[1], val1.y) annotation (Line(points={{-340,75},{-50,75},{-50,
          -100},{10,-100},{10,-138}}, color={0,0,127}));
  connect(uHotIsoVal[2], val2.y) annotation (Line(points={{-340,85},{-50,85},{-50,
