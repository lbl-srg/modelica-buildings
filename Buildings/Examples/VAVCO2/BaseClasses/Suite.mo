...
scaM_flow*(5.196+2.8428+1.0044+0.9612+0.3624+0.1584);
  Buildings.Fluid.FixedResistances.Junction spl34(
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial) annotation (
      extent=[-30,110; -10,130], Placement(transformation(extent={{-30,110},{-10,
            130}})));
  Buildings.Fluid.FixedResistances.Junction mix55(
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial) annotation (
      extent=[-30,-30; -10,-50], Placement(transformation(extent={{-30,-30},{-10,
            -50}})));
  Buildings.Fluid.FixedResistances.PressureDrop res13(
    m_flow_nominal=scaM_flow*1,
    dp_nominal=0.1E3,
    redeclare package Medium = Medium) annotation (extent=[0,10; 20,30],
      Placement(transformation(extent={{0,10},{20,30}})));
  Buildings.Fluid.FixedResistances.PressureDrop res14(
    m_flow_nominal=scaM_flow*1,
    dp_nominal=0.1E3,
    redeclare package Medium = Medium) annotation (extent=[60,10; 80,30]);
  Buildings.Fluid.FixedResistances.PressureDrop res15(
    m_flow_nominal=scaM_flow*1,
    dp_nominal=0.1E3,
    redeclare package Medium = Medium) annotation (extent=[120,10; 140,30]);
  Buildings.Fluid.FixedResistances.PressureDrop res16(
    m_flow_nominal=scaM_flow*1,
    dp_nominal=0.1E3,
    redeclare package Medium = Medium) annotation (extent=[180,10; 200,30],
      Placement(transformation(extent={{180,10},{200,30}})));
  Buildings.Fluid.FixedResistances.PressureDrop res17(
    m_flow_nominal=scaM_flow*1,
    dp_nominal=0.1E3,
    redeclare package Medium = Medium) annotation (extent=[240,10; 260,30],
  ...
  Buildings.Fluid.FixedResistances.Junction mix52(
    ...
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial) annotation (
      extent=[150,-30; 170,-50], Placement(transformation(extent={{150,-30},{
            170,-50}})));
