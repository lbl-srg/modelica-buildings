...
// protected
  ...
  Controls.OBC.Utilities.ExtremumSeekingControl esc(iniSet=0.5,
    minSet=0.01,
    maxSet=1,
    delTim=30,
    samplePeriod=30,
  ...
  Controls.OBC.CDL.Reals.MultiSum mulSum(nin=8)
  ...
  Modelica.Icons.SignalBus signalBus annotation (Placement(transformation(
          extent={{-160,380},{-120,420}}), iconTransformation(extent={{-668,386},
            {-628,426}})));
  Modelica.Icons.SignalBus signalBus1 annotation (Placement(transformation(
          extent={{210,354},{250,394}}), iconTransformation(extent={{-668,386},{
            -628,426}})));
  Modelica.Icons.SignalBus signalBus2 annotation (Placement(transformation(
          extent={{308,-98},{348,-58}}), iconTransformation(extent={{-668,386},{
            -628,426}})));
equation
  ...
  connect(booToRea1.u, mulOr.u) annotation (Line(points={{18,310},{-16,310},{-16,
          410},{98,410}}, color={255,0,255}));
  connect(mulOr.y, esc.uDevSta) annotation (Line(points={{122,410},{132,410},{132,
          416},{138,416}}, color={255,0,255}));
  connect(esc.y, cooTow1.y) annotation (Line(points={{162,410},{352,410},{352,388},
          {342,388}}, color={0,0,127}));
  connect(esc.y, cooTow2.y) annotation (Line(points={{162,410},{352,410},{352,318},
          {342,318}}, color={0,0,127}));
  connect(mulSum.y, esc.uCos) annotation (Line(points={{-58,410},{-20,410},{-20,
          404},{92,404},{92,392},{128,392},{128,404},{138,404}}, color={0,0,127}));
  connect(cooTow1.PFan, signalBus1.PCooTow1) annotation (Line(points={{319,388},
          {300,388},{300,374},{230,374}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(cooTow2.PFan, signalBus1.PCooTow2) annotation (Line(points={{319,318},
          {312,318},{312,340},{230,340},{230,374}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(conWatPum1.P, signalBus1.PConWatPum1) annotation (Line(points={{209,199},
          {209,196},{232,196},{232,336},{228,336},{228,348},{230,348},{230,374}},
        color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(conWatPum2.P, signalBus1.PConWatPum2) annotation (Line(points={{269,199},
          {269,192},{288,192},{288,372},{260,372},{260,374},{230,374}}, color={0,
          0,127}), Text(
      string="%second",
      index=1,
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(signalBus1, signalBus) annotation (Line(
      points={{230,374},{232,374},{232,432},{-140,432},{-140,400}},
      color={255,204,51},
      thickness=0.5));
  connect(signalBus.PConWatPum1, mulSum.u[1]) annotation (Line(
      points={{-140,400},{-92,400},{-92,409.125},{-82,409.125}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(signalBus.PConWatPum2, mulSum.u[2]) annotation (Line(
      points={{-140,400},{-92,400},{-92,408},{-82,408},{-82,409.375}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(signalBus.PCooTow1, mulSum.u[3]) annotation (Line(
      points={{-140,400},{-92,400},{-92,408},{-82,408},{-82,409.625}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(signalBus.PCooTow2, mulSum.u[4]) annotation (Line(
      points={{-140,400},{-92,400},{-92,408},{-82,408},{-82,409.875}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(chi1.P, signalBus2.PChi1) annotation (Line(points={{341,103},{341,116},
          {136,116},{136,-48},{296,-48},{296,-80},{328,-80},{328,-78}}, color={0,
          0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(chi2.P, signalBus2.PChi2) annotation (Line(points={{341,13},{341,32},{
          308,32},{308,-48},{328,-48},{328,-78}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(chiWatPum2.P, signalBus2.PChiWatPum2) annotation (Line(points={{269,-107},
          {292,-107},{292,-80},{328,-80},{328,-78}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(chiWatPum1.P, signalBus2.PChiWatPum1) annotation (Line(points={{209,-107},
          {232,-107},{232,-184},{328,-184},{328,-78}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(signalBus2, signalBus) annotation (Line(
      points={{328,-78},{328,-44},{492,-44},{492,420},{232,420},{232,432},{-140,
          432},{-140,400}},
      color={255,204,51},
      thickness=0.5));
  connect(signalBus.PChi1, mulSum.u[5]) annotation (Line(
      points={{-140,400},{-92,400},{-92,408},{-82,408},{-82,410.125}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(signalBus.PChi2, mulSum.u[6]) annotation (Line(
      points={{-140,400},{-92,400},{-92,408},{-82,408},{-82,410.375}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(signalBus.PChiWatPum1, mulSum.u[7]) annotation (Line(
      points={{-140,400},{-92,400},{-92,408},{-82,408},{-82,410.625}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(signalBus.PChiWatPum2, mulSum.u[8]) annotation (Line(
      points={{-140,400},{-92,400},{-92,408},{-82,408},{-82,410.875}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
