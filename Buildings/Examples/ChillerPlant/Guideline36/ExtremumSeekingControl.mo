...
model ExtremumSeekingControl
  ...
  Buildings.Examples.ChillerPlant.Guideline36.BaseClasses.CoolingTowerESC chiPla(
...
annotation (experiment(
      ...
      StopTime=15897600,
      Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Examples/ChillerPlant/Guideline36/ExtremumSeekingControl.mos"
    "Simulate and plot"),
