within Buildings.Examples.ChillerPlant.Guideline36;
model ClosedLoop
...
annotation (experiment(
      ...
      StopTime=15897600,
      Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Examples/ChillerPlant/Guideline36/ClosedLoop.mos"
    "Simulate and plot"),
