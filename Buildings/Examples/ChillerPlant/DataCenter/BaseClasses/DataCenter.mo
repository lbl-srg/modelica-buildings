within Buildings.Examples.ChillerPlant.DataCenter.BaseClasses;
partial model DataCenter
  ...
  Buildings.Examples.ChillerPlant.DataCenter.BaseClasses.Controls.WSEControl wseCon
  ...
  Buildings.Fluid.Actuators.Valves.TwoWayLinear val6(
    ...
    "Control valve for chilled water leaving from chiller" annotation (
      Placement(transformation(
        ...
        rotation=270,
        origin={358,40})));
  Buildings.Examples.ChillerPlant.DataCenter.BaseClasses.Controls.ChillerSwitch
  ...
  Buildings.Examples.ChillerPlant.DataCenter.BaseClasses.Controls.LinearPiecewiseTwo
    linPieTwo(
    x0=0,
    x2=1,
    x1=0.5,
  ...
  Buildings.Examples.ChillerPlant.DataCenter.BaseClasses.Controls.KMinusU KMinusU(k=1)
...
<a href=\"modelica://Buildings.Examples.ChillerPlant.DataCenter\">
Buildings.Examples.ChillerPlant.DataCenter</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
...
<a href=\"modelica://Buildings.Examples.ChillerPlant.DataCenter.DiscreteTimeControl\">
Buildings.Examples.ChillerPlant.DataCenter.DiscreteTimeControl</a>
to converge.
</li>
<li>
