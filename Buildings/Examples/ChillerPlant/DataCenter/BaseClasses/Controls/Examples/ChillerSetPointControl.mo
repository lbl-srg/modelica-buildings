within Buildings.Examples.ChillerPlant.DataCenter.BaseClasses.Controls.Examples;
model ChillerSetPointControl
  ...
  Buildings.Examples.ChillerPlant.DataCenter.BaseClasses.Controls.TrimAndRespond
    triAndRes(
    yEqu0=0.1,
    uTri=0.8,
    yDec=-0.03,
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/Examples/ChillerPlant/DataCenter/BaseClasses/Controls/Examples/ChillerSetPointControl.mos"
        "Simulate and plot"),
    experiment(
      StopTime=86400,
      Tolerance=1e-6),
