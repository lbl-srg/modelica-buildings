...
model RequestCounter "Test model for RequestCounter"
  ...
  Buildings.Examples.ChillerPlant.DataCenter.BaseClasses.Controls.RequestCounter
...
equation
  ...
  annotation (
    __Dymola_Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/Examples/ChillerPlant/DataCenter/BaseClasses/Controls/Examples/RequestCounter.mos"
        "Simulate and plot"),
    experiment(
      StopTime=600,
      Tolerance=1e-6),
