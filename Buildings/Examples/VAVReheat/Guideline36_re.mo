...
model Guideline36_re
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.Generic.SetPoints.ZoneStatus_re zonSta1
    [numZon]
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.Generic.SetPoints.GroupStatus
    zonGroSta1(numZon=numZon)
    annotation (Placement(transformation(extent={{-160,260},{-140,300}})));
  Buildings.Controls.OBC.ASHRAE.G36_PR1.Generic.SetPoints.OperationMode_re
    opeModSel
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.TerminalUnits.SetPoints.ZoneTemperatures
    TZonSet[numZon](final have_occSen=fill(false, numZone), final have_winSen=
        fill(false, numZone)) "Zone setpoint"
    annotation (Placement(transformation(extent={{-100,226},{-80,254}})));
...
equation
  ...
  connect(wes.y_actual,conVAVWes.yDam_actual)  annotation (Line(points={{1332,
          ...
          127}));
  connect(warCooTim.y, zonSta1.cooDowTim) annotation (Line(points={{-278,380},{
          -240,380},{-240,290},{-222,290}}, color={0,0,127}));
  connect(warCooTim.y, zonSta1.warUpTim) annotation (Line(points={{-278,380},{
          -240,380},{-240,286},{-222,286}}, color={0,0,127}));
  connect(flo.TRooAir, zonSta1.TZon) annotation (Line(points={{1094.14,491.333},
          {1164,491.333},{1164,660},{-250,660},{-250,274},{-222,274}}, color={0,
          0,127}));
  connect(zonSta1.yCooTim, zonGroSta1.uCooTim) annotation (Line(points={{-198,
          295},{-176,295},{-176,291},{-162,291}}, color={0,0,127}));
  connect(zonSta1.yWarTim, zonGroSta1.uWarTim) annotation (Line(points={{-198,
          293},{-178,293},{-178,289},{-162,289}}, color={0,0,127}));
  connect(zonSta1.yOccHeaHig, zonGroSta1.uOccHeaHig) annotation (Line(points={{
          -198,288},{-180,288},{-180,285},{-162,285}}, color={255,0,255}));
  connect(zonSta1.yHigOccCoo, zonGroSta1.uHigOccCoo)
  ...
  connect(zonSta1.THeaSetOff, zonGroSta1.THeaSetOff) annotation (Line(points={{
          -198,280},{-182,280},{-182,277},{-162,277}}, color={0,0,127}));
  connect(zonSta1.yUnoHeaHig, zonGroSta1.uUnoHeaHig) annotation (Line(points={{
          -198,278},{-188,278},{-188,279},{-162,279}}, color={255,0,255}));
  connect(zonSta1.yEndSetBac, zonGroSta1.uEndSetBac) annotation (Line(points={{
          -198,276},{-188,276},{-188,275},{-162,275}}, color={255,0,255}));
  connect(zonSta1.TCooSetOff, zonGroSta1.TCooSetOff) annotation (Line(points={{
          -198,273},{-190,273},{-190,269},{-162,269}}, color={0,0,127}));
  connect(zonSta1.yHigUnoCoo, zonGroSta1.uHigUnoCoo)
  ...
  connect(zonSta1.yEndSetUp, zonGroSta1.uEndSetUp) annotation (Line(points={{
          -198,269},{-192,269},{-192,267},{-162,267}}, color={255,0,255}));
  connect(flo.TRooAir, zonGroSta1.TZon) annotation (Line(points={{1094.14,
          491.333},{1164,491.333},{1164,660},{-250,660},{-250,263},{-162,263}},
        color={0,0,127}));
  connect(falSta.y, zonGroSta1.uWin) annotation (Line(points={{-278,340},{-172,
  ...
  connect(reaRep.y, zonGroSta1.tNexOcc) annotation (Line(points={{-178,-180},{
          -164,-180},{-164,295},{-162,295}}, color={0,0,127}));
  connect(occSch.occupied, booRep.u) annotation (Line(points={{-297,-216},{-220,
          -216},{-220,-140},{-202,-140}}, color={255,0,255}));
  connect(booRep.y, zonGroSta1.uOcc) annotation (Line(points={{-178,-140},{-166,
          -140},{-166,297},{-162,297}}, color={255,0,255}));
  connect(falSta.y, zonGroSta1.zonOcc) annotation (Line(points={{-278,340},{
          -172,340},{-172,299},{-162,299}}, color={255,0,255}));
  connect(zonGroSta1.uGroOcc, opeModSel.uOcc) annotation (Line(points={{-138,
          299},{-136,299},{-136,314},{-102,314}}, color={255,0,255}));
  connect(zonGroSta1.nexOcc, opeModSel.tNexOcc) annotation (Line(points={{-138,
          297},{-134,297},{-134,312},{-102,312}}, color={0,0,127}));
  connect(zonGroSta1.yCooTim, opeModSel.maxCooDowTim) annotation (Line(points={
          {-138,293},{-132,293},{-132,310},{-102,310}}, color={0,0,127}));
  connect(zonGroSta1.yWarTim, opeModSel.maxWarUpTim) annotation (Line(points={{
          -138,291},{-128,291},{-128,306},{-102,306}}, color={0,0,127}));
  connect(zonGroSta1.yOccHeaHig, opeModSel.uOccHeaHig) annotation (Line(points=
          {{-138,287},{-126,287},{-126,304},{-102,304}}, color={255,0,255}));
  connect(zonGroSta1.yHigOccCoo, opeModSel.uHigOccCoo) annotation (Line(points=
          {{-138,285},{-130,285},{-130,308},{-102,308}}, color={255,0,255}));
  connect(zonGroSta1.yWin, opeModSel.uWin) annotation (Line(points={{-138,261},
          {-124,261},{-124,302},{-102,302}}, color={255,0,255}));
  connect(zonGroSta1.yColZon, opeModSel.totColZon) annotation (Line(points={{
          -138,281},{-122,281},{-122,300},{-102,300}}, color={255,127,0}));
  connect(zonGroSta1.ySetBac, opeModSel.uSetBac) annotation (Line(points={{-138,
          279},{-120,279},{-120,298},{-102,298}}, color={255,0,255}));
  connect(zonGroSta1.yEndSetBac, opeModSel.uEndSetBac) annotation (Line(points=
          {{-138,277},{-118,277},{-118,296},{-102,296}}, color={255,0,255}));
  connect(zonGroSta1.TZonMax, opeModSel.TZonMax) annotation (Line(points={{-138,
          266},{-116,266},{-116,294},{-102,294}}, color={0,0,127}));
  connect(zonGroSta1.TZonMin, opeModSel.TZonMin) annotation (Line(points={{-138,
          264},{-114,264},{-114,292},{-102,292}}, color={0,0,127}));
  connect(zonGroSta1.yHotZon, opeModSel.totHotZon) annotation (Line(points={{
          -138,273},{-112,273},{-112,290},{-102,290}}, color={255,127,0}));
  connect(zonGroSta1.ySetUp, opeModSel.uSetUp) annotation (Line(points={{-138,
          271},{-110,271},{-110,288},{-102,288}}, color={255,0,255}));
  connect(zonGroSta1.yEndSetUp, opeModSel.uEndSetUp) annotation (Line(points={{
          -138,269},{-108,269},{-108,286},{-102,286}}, color={255,0,255}));
  connect(opeModSel.yOpeMod, TZonSet.uOpeMod) annotation (Line(points={{-78,300},
          {-64,300},{-64,260},{-120,260},{-120,253},{-102,253}}, color={255,127,
          0}));
  connect(zonSta1.THeaSetOn, TZonSet.TZonHeaSetOcc) annotation (Line(points={{
          -198,290},{-186,290},{-186,244},{-102,244}}, color={0,0,127}));
  connect(zonSta1.THeaSetOff, TZonSet.TZonHeaSetUno) annotation (Line(points={{
          -198,280},{-182,280},{-182,242},{-102,242}}, color={0,0,127}));
  connect(zonSta1.TCooSetOn, TZonSet.TZonCooSetOcc) annotation (Line(points={{
          -198,285},{-184,285},{-184,249},{-102,249}}, color={0,0,127}));
  connect(zonSta1.TCooSetOff, TZonSet.TZonCooSetUno) annotation (Line(points={{
          -198,273},{-190,273},{-190,247},{-102,247}}, color={0,0,127}));
  connect(demLimLev.y, TZonSet.uCooDemLimLev) annotation (Line(points={{-278,
          230},{-140,230},{-140,234},{-102,234}}, color={255,127,0}));
  connect(demLimLev.y, TZonSet.uHeaDemLimLev) annotation (Line(points={{-278,
          230},{-140,230},{-140,232},{-102,232}}, color={255,127,0}));
