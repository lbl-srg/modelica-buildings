...
model ASHRAE2006_IBPSA
  "Variable air volume flow system with terminal reheat and five thermal zones"
  extends Modelica.Icons.Example;
  extends Buildings.Examples.VAVReheat.BaseClasses.PartialOpenLoop(
    heaCoi(show_T=true),
    redeclare Buildings.Fluid.HeatExchangers.WetCoilEffectivesnessNTU cooCoi(
      show_T=true,
      configuration=Buildings.Fluid.Types.HeatExchangerConfiguration.CounterFlow,
      Q_flow_nominal=-m_flow_nominal*1000*15,
      T_a1_nominal=6 + 273.15,
      T_a2_nominal=26.2 + 273.15,
      X_w2_nominal=0.017));
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/426\">issue 426</a>.
    ...
    __Dymola_Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/Examples/VAVReheat/ASHRAE2006_IBPSA.mos"
        "Simulate and plot"),
    experiment(
      StopTime=172800,
      Tolerance=1e-06));
end ASHRAE2006_IBPSA;
