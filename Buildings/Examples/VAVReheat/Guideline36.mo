...
equation
  ...
  connect(TSetZon.uOcc, occSch.occupied) annotation (Line(points={{58,302.025},{
          -92,302.025},{-92,300},{-240,300},{-240,-216},{-297,-216}},
                        color={255,0,255}));
  connect(occSch.tNexOcc, TSetZon.tNexOcc) annotation (Line(points={{-297,-204},
          {-254,-204},{-254,318},{58,318}},
        color={0,0,127}));
  connect(TSetZon.TZon, flo.TRooAir) annotation (Line(points={{58,314.025},{58,
          314},{46,314},{46,626},{1164,626},{1164,491.333},{1094.14,491.333}},
                     color={0,0,127}));
  connect(conAHU.THeaSet, TSetZon.THeaSet) annotation (Line(points={{391,
          444.077},{120,444.077},{120,313},{81,313}},
                                                  color={0,0,127}));
  connect(conAHU.TCooSet, TSetZon.TCooSet) annotation (Line(points={{391,
