...
equation
  ...
  connect(conVAVCor.TZooHeaSet, TSetZon.TOccZonHeaSet[1]) annotation (Line(
        points={{529,47},{480,47},{480,313},{81,313}}, color={0,0,127}));
  connect(conVAVCor.TRooCooSet, TSetZon.TOccZonCooSet[1]) annotation (Line(
        points={{529,45},{480,45},{480,317},{81,317}}, color={0,0,127}));
  connect(conVAVSou.TZooHeaSet, TSetZon.TOccZonHeaSet[2]) annotation (Line(
        points={{699,45},{660,45},{660,313},{81,313}}, color={0,0,127}));
  connect(conVAVSou.TRooCooSet, TSetZon.TOccZonCooSet[2]) annotation (Line(
        points={{699,43},{660,43},{660,317},{81,317}}, color={0,0,127}));
  connect(conVAVEas.TZooHeaSet, TSetZon.TOccZonHeaSet[3]) annotation (Line(
        points={{879,45},{850,45},{850,313},{81,313}}, color={0,0,127}));
  connect(conVAVEas.TRooCooSet, TSetZon.TOccZonCooSet[3]) annotation (Line(
        points={{879,43},{850,43},{850,317},{81,317}}, color={0,0,127}));
  connect(conVAVNor.TZooHeaSet, TSetZon.TOccZonHeaSet[4]) annotation (Line(
        points={{1039,45},{1020,45},{1020,313},{81,313}}, color={0,0,127}));
  connect(conVAVNor.TRooCooSet, TSetZon.TOccZonCooSet[4]) annotation (Line(
        points={{1039,43},{1020,43},{1020,317},{81,317}}, color={0,0,127}));
  connect(conVAVWes.TZooHeaSet, TSetZon.TOccZonHeaSet[5]) annotation (Line(
        points={{1239,43},{1202,43},{1202,313},{81,313}}, color={0,0,127}));
  connect(conVAVWes.TRooCooSet, TSetZon.TOccZonCooSet[5]) annotation (Line(
        points={{1239,41},{1202,41},{1202,317},{81,317}}, color={0,0,127}));
  ...
  connect(TSetZon.TZon, flo.TRooAir) annotation (Line(points={{59,315},{59,314},
         ...
         {0,0,127}));
  connect(conAHU.TZonHeaSet, TSetZon.TOccZonHeaSet[1]) annotation (Line(points=
          {{383,468},{110,468},{110,313},{81,313}}, color={0,0,127}));
  connect(conAHU.TZonCooSet, TSetZon.TOccZonCooSet[1]) annotation (Line(points=
