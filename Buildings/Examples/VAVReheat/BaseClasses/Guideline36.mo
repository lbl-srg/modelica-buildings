...
//     "Minimum expected zone primary flow rate";
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.Controller conAHU(
    ...
    final buiPreCon=Buildings.Controls.OBC.ASHRAE.G36_2018.Types.PressureControl.BarometricRelief,
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.ZoneGroups.ZoneStatus zonSta[numZon]
    "Status of different zone temperature"
    annotation (Placement(transformation(extent={{-220,380},{-200,408}})));
  Buildings.Controls.OBC.ASHRAE.G36_2018.ZoneGroups.GroupStatus groSta(final nBuiZon=
       numZon)
    "Zone group status"
    annotation (Placement(transformation(extent={{-120,380},{-100,420}})));
  Buildings.Controls.OBC.ASHRAE.G36_2018.ThermalZones.Setpoints TZonSet[numZon](
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.Reheat.Controller conVAV[numZon](
    final venStd=fill(Buildings.Controls.OBC.ASHRAE.G36_2018.Types.VentilationStandard.ASHRAE62_1, numZon),
    final have_winSen=fill(false, numZon),
    final have_occSen=fill(false, numZon),
...
Buildings.Controls.OBC.ASHRAE.G36_2018</a> for
