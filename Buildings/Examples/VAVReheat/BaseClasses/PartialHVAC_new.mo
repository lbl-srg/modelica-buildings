...
equation
  ...
  connect(valCooCoi.port_b, cooCoi.port_a1) annotation (Line(points={{220,-200},
          {220,-52},{210,-52}}, color={0,127,255}));
  connect(cooCoi.port_b1, portCooCoiRet) annotation (Line(points={{190,-52},{190,
          -272},{240,-272},{240,-300}}, color={0,127,255}));
  connect(valHeaCoi.port_b, heaCoi.port_a1) annotation (Line(points={{128,-200},
