...
model ASHRAE2006_RTU
  ...
  Buildings.Controls.OBC.CDL.Continuous.Multiply mulAuxHea
    ...
    annotation (Placement(transformation(extent={{550,-114},{570,-94}})));
...
equation
  ...
  connect(dpDisSupFan.p_rel, conFanSup.u_m) annotation (Line(
      points={{411,4.44089e-16},{396,4.44089e-16},{396,0},{380,0},{380,30},{270,
          30},{270,38}},
      color={0,0,127},
      smooth=Smooth.None,
      pattern=LinePattern.Dash));
  ...
  connect(controlBus.TRooSetHea, TRooHeaSet.u) annotation (Line(
      points={{-240,-340},{386,-340},{386,64},{478,64}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
  ...
  connect(controlBus.TRooSetCoo, TRooCooSet.u) annotation (Line(
      points={{-240,-340},{394,-340},{394,30},{478,30}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
  ...
  connect(timDXSta.passed,RTUCon. uDXHeaCoi) annotation (Line(points={{202,-158},
          {960,-158},{960,257.083},{1008,257.083}},
                                            color={255,0,255}));
  connect(RTUCon.yAuxHea, mulAuxHea.u1) annotation (Line(points={{1032,240.283},
          {1040,240.283},{1040,-80},{540,-80},{540,-98},{548,-98}},
                                                                 color={0,0,127}));
  ...
  connect(fanSup.y_actual,hys2. u) annotation (Line(points={{421,-33},{421,-34},
          {426,-34},{426,-110},{458,-110}}, color={0,0,127}));
  connect(hys2.y,booToRea1. u) annotation (Line(points={{482,-110},{498,-110}},
          color={255,0,255}));
  connect(booToRea1.y,mulAuxHea. u2) annotation (Line(points={{522,-110},{548,
          -110}},                       color={0,0,127}));
  connect(mulAuxHea.y, AuxHeaCoi.u) annotation (Line(points={{572,-104},{580,
          -104},{580,-70},{456,-70},{456,-34},{458,-34}}, color={0,0,127}));
  ...
  connect(con.y, conFanSup.uFan) annotation (Line(points={{182,110},{220,110},{
          220,56},{258,56}}, color={255,0,255}));
  connect(conFanSup.y, fanSup.y)
    annotation (Line(points={{281,50},{410,50},{410,-28}}, color={0,0,127}));
  connect(booToRea4.y, mul1.u1) annotation (Line(points={{122,56},{142,56}},
                         color={0,0,127}));
  connect(pSetDuc.y, mul1.u2) annotation (Line(points={{181,-6},{186,-6},{186,
          26},{132,26},{132,44},{142,44}}, color={0,0,127}));
  connect(mul1.y, addPar.u)
    annotation (Line(points={{166,50},{178,50}}, color={0,0,127}));
  connect(addPar.y, conFanSup.u) annotation (Line(points={{202,50},{258,50}},
                             color={0,0,127}));
  connect(modeSelector.yFan, booToRea4.u) annotation (Line(points={{-179.091,
          -305.455},{-174,-305.455},{-174,-306},{-170,-306},{-170,56},{98,56}},
        color={255,0,255}));
  annotation (
