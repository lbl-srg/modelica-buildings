...
//     "Minimum expected zone primary flow rate";
  ...
  Buildings.Controls.OBC.CDL.Integers.MultiSum temResReq(
    final nin=numZon) "Zone temperature reset request"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.IntegerOutput nReqPlaHeaWat
                                                                   annotation (
      Placement(transformation(extent={{1420,420},{1460,460}}),
        iconTransformation(extent={{440,-80},{480,-40}})));
  Buildings.Controls.OBC.CDL.Interfaces.IntegerOutput nReqPlaChiWat
                                                                   annotation (
      Placement(transformation(extent={{1420,380},{1460,420}}),
                                                             iconTransformation(
          extent={{440,-20},{480,20}})));
  Buildings.Controls.OBC.CDL.Interfaces.IntegerOutput nReqResChiWat
                                                                   annotation (
      Placement(transformation(extent={{1420,300},{1460,340}}),
        iconTransformation(extent={{440,60},{480,100}})));
  Buildings.Controls.OBC.CDL.Interfaces.IntegerOutput nReqResHeaWat
                                                                   annotation (
      Placement(transformation(extent={{1420,340},{1460,380}}),
        iconTransformation(extent={{440,120},{480,160}})));
  Buildings.Controls.OBC.CDL.Integers.Add addInt
    annotation (Placement(transformation(extent={{1220,430},{1240,450}})));
  Buildings.Controls.OBC.CDL.Integers.Add addInt1
    annotation (Placement(transformation(extent={{1220,372},{1240,392}})));
  Buildings.Controls.OBC.CDL.Integers.MultiSum hotWatPlaReq(final nin=numZon)
    "Hot water plant request"
    annotation (Placement(transformation(extent={{760,170},{780,190}})));
  Buildings.Controls.OBC.CDL.Integers.MultiSum hotWatResReq(final nin=numZon)
    "Hot water reset request"
    annotation (Placement(transformation(extent={{760,130},{780,150}})));
  Buildings.Controls.OBC.CDL.Integers.Multiply mulInt
    annotation (Placement(transformation(extent={{1120,440},{1140,460}})));
  Buildings.Controls.OBC.CDL.Integers.Multiply mulInt1
    annotation (Placement(transformation(extent={{1120,380},{1140,400}})));
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant conInt(k=5)
    annotation (Placement(transformation(extent={{1020,430},{1040,450}})));
equation
  ...
  connect(conAHU.yHeaCoi, sysHysHea.u) annotation (Line(points={{544,504},{880,504},
          {880,-310},{-60,-310},{-60,-140},{-42,-140}}, color={0,0,127}));
  connect(conAHU.yCooCoi, sysHysCoo.u) annotation (Line(points={{544,510},{880,510},
  ...
  connect(conAHU.yChiWatResReq, nReqResChiWat) annotation (Line(points={{544,480},
          {900,480},{900,320},{1440,320}}, color={255,127,0}));
  connect(conAHU.yChiPlaReq, nReqPlaChiWat) annotation (Line(points={{544,474},{
          1400,474},{1400,400},{1440,400}}, color={255,127,0}));
  connect(conVAV.yHotWatPlaReq, hotWatPlaReq.u) annotation (Line(points={{640,
          194},{744,194},{744,180},{758,180}}, color={255,127,0}));
  connect(conVAV.yHeaValResReq, hotWatResReq.u) annotation (Line(points={{640,
          196},{648,196},{648,184},{736,184},{736,140},{758,140}}, color={255,127,
          0}));
  connect(hotWatPlaReq.y, addInt.u2) annotation (Line(points={{782,180},{912,180},
          {912,352},{1200,352},{1200,434},{1218,434}}, color={255,127,0}));
  connect(hotWatResReq.y, addInt1.u2) annotation (Line(points={{782,140},{888,140},
          {888,360},{1218,360},{1218,376}}, color={255,127,0}));
  connect(addInt.y, nReqPlaHeaWat)
    annotation (Line(points={{1242,440},{1440,440}}, color={255,127,0}));
  connect(addInt1.y, nReqResHeaWat) annotation (Line(points={{1242,382},{1400,382},
          {1400,360},{1440,360}}, color={255,127,0}));
  connect(conAHU.yHotWatPlaReq, mulInt.u1) annotation (Line(points={{544,462},{
          544,464},{1104,464},{1104,456},{1118,456}}, color={255,127,0}));
  connect(conAHU.yHotWatResReq, mulInt1.u1) annotation (Line(points={{544,468},
          {576,468},{576,416},{1104,416},{1104,396},{1118,396}}, color={255,127,
          0}));
  connect(mulInt.y, addInt.u1) annotation (Line(points={{1142,450},{1152,446},{
          1218,446}}, color={255,127,0}));
  connect(mulInt1.y, addInt1.u1) annotation (Line(points={{1142,390},{1152,388},
          {1218,388}}, color={255,127,0}));
  connect(conInt.y, mulInt.u2) annotation (Line(points={{1042,440},{1104,440},{
