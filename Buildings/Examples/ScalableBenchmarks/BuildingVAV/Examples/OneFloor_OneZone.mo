...
equation
  for iFlo in 1:nFlo loop
    ...
    connect(conTSup[iFlo].yOA, conEco[iFlo].uOATSup) annotation (Line(points={{-218,-60},{
            ...
            0,127}));
    connect(modeSelector[iFlo].yEco, conEco[iFlo].uEna) annotation (Line(points={{
            -163.273,44.3636},{-160,44.3636},{-160,80},{-282,80},{-282,86.4}},
                                                                      color={255,
            0,255}));
    ...
    connect(modeSelector[iFlo].yFan, conTSup[iFlo].uEna) annotation (Line(points={{
            -163.273,51.6364},{-146,51.6364},{-146,0},{-250,0},{-250,-66},{-242,
            -66}},
          color={255,0,255}));
    connect(modeSelector[iFlo].yFan, conFanRet[iFlo].uFan) annotation (Line(points={{
