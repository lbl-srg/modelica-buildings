...
model IntegratedChillerWSE
  "Integrated chiller and WSE cooling system for data centers"
...
equation
  ...
  connect(chi[1].port_a1, port_a1) annotation (Line(points={{-30,28},{-46,28},{
          -46,28},{-46,80},{-80,80},{-80,60},{-100,60}}, color={0,127,255}));
