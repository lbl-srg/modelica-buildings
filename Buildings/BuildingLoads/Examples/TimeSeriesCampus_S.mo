...
model TimeSeriesCampus_S
  ...
  Buildings.BuildingLoads.Examples.BaseClasses.BatteryControl_S conBat(PMax=PBat)
    "Battery control"
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-240,
    ...
    experiment(
      ...
      Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/BuildingLoads/Examples/TimeSeriesCampus_S.mos"
        "Simulate and plot"));
