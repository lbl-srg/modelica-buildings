...
model TimeSeries "Example model for the time series building load"
  ...
  Buildings.BuildingLoads.TimeSeries buiA(fileName="modelica://Buildings/Resources/Data/BuildingLoads/Examples/buildingA.txt",
    VACDis_nominal=480,
    VACBui_nominal=110,
    VDCDis_nominal=240,
    VDCBui_nominal=48) "Building A"
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  Buildings.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(filNam=
        "modelica://Buildings/Resources/weatherdata/CZ10RV2.mos")
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
    ...
    Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/BuildingLoads/Examples/TimeSeries.mos"
        "Simulate and plot"));
end TimeSeries;
