...
partial model PartialTimeSeriesCampus
  ...
  model dcLine = Buildings.Electrical.DC.Lines.Line (
    V_nominal=VDCDis_nominal,
    mode=Buildings.Electrical.Types.CableMode.commercial,
    commercialCable_low=Buildings.Electrical.Transmission.LowVoltageCables.Generic(
  ...
  Buildings.BuildingLoads.TimeSeries buiA(
    fileName=
        "modelica://Buildings/Resources/Data/BuildingLoads/Examples/buildingA.txt",
  ...
  Buildings.BuildingLoads.TimeSeries buiB(
    fileName=
        "modelica://Buildings/Resources/Data/BuildingLoads/Examples/buildingB.txt",
    final VACDis_nominal=VACDis_nominal,
    final VACBui_nominal=VACBui_nominal,
    final VDCDis_nominal=VDCDis_nominal,
  ...
  Buildings.BuildingLoads.TimeSeries buiC(
    fileName=
        "modelica://Buildings/Resources/Data/BuildingLoads/Examples/buildingC.txt",
    final VACDis_nominal=VACDis_nominal,
    final VACBui_nominal=VACBui_nominal,
    final VDCDis_nominal=VDCDis_nominal,
  ...
  Buildings.BuildingLoads.TimeSeries buiD(
    fileName=
        "modelica://Buildings/Resources/Data/BuildingLoads/Examples/buildingD.txt",
    final VACDis_nominal=VACDis_nominal,
    final VACBui_nominal=VACBui_nominal,
    final VDCDis_nominal=VDCDis_nominal,
  ...
  Buildings.BuildingLoads.TimeSeries buiE(
    fileName=
        "modelica://Buildings/Resources/Data/BuildingLoads/Examples/buildingE.txt",
    final VACDis_nominal=VACDis_nominal,
    final VACBui_nominal=VACBui_nominal,
    final VDCDis_nominal=VDCDis_nominal,
  ...
  acLine linD(
    V_nominal=VACDis_nominal,
    P_nominal=P_d,
    l=20) "Distribution line" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={10,-58})));
  acLine linE(
  ...
  acLine linCE(
    V_nominal=VACDis_nominal,
    P_nominal=P_ce,
    l=50) "Distribution line"
    annotation (Placement(transformation(extent={{150,-30},{170,-10}})));
  acLine linC(
    V_nominal=VACDis_nominal,
    P_nominal=P_c,
    l=60) "Distribution line" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={200,10})));
  acLine linBC(
  ...
  Buildings.Electrical.AC.ThreePhasesBalanced.Sensors.GeneralizedSensor senTra
  ...
  Buildings.Electrical.DC.Sources.PVSimple pv(A=10000) "PV array"
  ...
  Buildings.Electrical.DC.Sources.WindTurbine tur(h=50, scale=PWinGen)
    "Wind turbine"
    annotation (Placement(transformation(extent={{430,170},{450,190}})));
  Buildings.Electrical.DC.Storage.Battery bat(EMax(displayUnit="J") = EBat)
    "Battery"
    annotation (Placement(transformation(extent={{418,-30},{438,-10}})));
  Buildings.Electrical.AC.ThreePhasesBalanced.Sensors.GeneralizedSensor senDE
    "Sensor in DE line"
