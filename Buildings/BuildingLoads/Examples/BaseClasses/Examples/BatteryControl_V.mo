within Buildings.BuildingLoads.Examples.BaseClasses.Examples;
model BatteryControl_V "Test model for the battery control"
  ...
  Buildings.BuildingLoads.Examples.BaseClasses.BatteryControl_V con(
...
equation
  ...
  annotation (
    experiment(
      ...
      Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/BuildingLoads/Examples/BaseClasses/Examples/BatteryControl_V.mos"
        "Simulate and plot"),
