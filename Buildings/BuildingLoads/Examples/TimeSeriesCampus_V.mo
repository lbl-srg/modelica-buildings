...
model TimeSeriesCampus_V
  ...
  extends Buildings.BuildingLoads.Examples.BaseClasses.PartialTimeSeriesCampus;

  Buildings.BuildingLoads.Examples.BaseClasses.BatteryControl_V conBat(
    VDis=VDCDis_nominal,
...
equation
  ...
  annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-240,
    ...
    experiment(
      ...
      Commands(file=
          "modelica://Buildings/Resources/Scripts/Dymola/BuildingLoads/Examples/TimeSeriesCampus_V.mos"
        "Simulate and plot"));
