...
model GeojsonExportRaw "Multizone RC model"
  ...
  Buildings.DistrictHeatingCooling.Loads.Examples.BaseClasses.GeojsonExportBuilding bui
...
equation
  ...
  connect(bui.Q_flowHeaReq, heaFloHea.Q_flow)
    annotation (Line(points={{61,-27},{80,-27},{80,0},{-40,0},{-40,-20},{-18,-20}}, color={0,0,127}));
  connect(bui.Q_flowCooReq, heaFloCoo.Q_flow)
    annotation (Line(points={{61,-33},{80,-33},{80,-60},{-40,-60},{-40,-40},{-18,-40}}, color={0,0,127}));
  annotation (
