within Buildings.DistrictHeatingCooling.Loads.Examples.BaseClasses;
model GeojsonExportBuilding "Building model of type RC based on Urbanopt GeoJSON export"
  import Buildings;
  extends Buildings.DistrictHeatingCooling.Loads.BaseClasses.PartialBuilding(
    final heaLoaTyp=fill(Buildings.DistrictHeatingCooling.Loads.Types.ModelType.HeatPort, nHeaLoa),
    final cooLoaTyp=fill(Buildings.DistrictHeatingCooling.Loads.Types.ModelType.HeatPort, nCooLoa),
    final nHeaLoa=6,
    final nCooLoa=6,
  ...
  Buildings.DistrictHeatingCooling.Loads.Examples.BaseClasses.GeojsonExport.B5a6b99ec37f4de7f94020090_Office
    b5a6b99ec37f4de7f94020090_Office annotation (Placement(transformation(extent={{-100,-20},{-80,0}})));
  Buildings.DistrictHeatingCooling.Loads.Examples.BaseClasses.GeojsonExport.B5a6b99ec37f4de7f94020090_Floor
    b5a6b99ec37f4de7f94020090_Floor annotation (Placement(transformation(extent={{-60,-20},{-40,0}})));
  Buildings.DistrictHeatingCooling.Loads.Examples.BaseClasses.GeojsonExport.B5a6b99ec37f4de7f94020090_Storage
    b5a6b99ec37f4de7f94020090_Storage annotation (Placement(transformation(extent={{-20,-20},{0,0}})));
  Buildings.DistrictHeatingCooling.Loads.Examples.BaseClasses.GeojsonExport.B5a6b99ec37f4de7f94020090_Meeting
    b5a6b99ec37f4de7f94020090_Meeting annotation (Placement(transformation(extent={{20,-20},{40,0}})));
  Buildings.DistrictHeatingCooling.Loads.Examples.BaseClasses.GeojsonExport.B5a6b99ec37f4de7f94020090_Restroom
    b5a6b99ec37f4de7f94020090_Restroom annotation (Placement(transformation(extent={{60,-20},{80,0}})));
  Buildings.DistrictHeatingCooling.Loads.Examples.BaseClasses.GeojsonExport.B5a6b99ec37f4de7f94020090_ICT
