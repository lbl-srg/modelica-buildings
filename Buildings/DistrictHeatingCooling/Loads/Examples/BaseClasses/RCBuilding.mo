...
model RCBuilding "Building model of type RC one element"
  ...
  extends Buildings.DistrictHeatingCooling.Loads.BaseClasses.PartialBuilding(
    final nCooLoa=1,
    final cooLoaTyp={Buildings.DistrictHeatingCooling.Loads.Types.ModelType.HeatPort},
    Q_flowHea_nominal={500,1000},
    Q_flowCoo_nominal={2000},
    final nHeaLoa=2,
    final heaLoaTyp={Buildings.DistrictHeatingCooling.Loads.Types.ModelType.HeatPort,Buildings.DistrictHeatingCooling.Loads.Types.ModelType.ODE});
