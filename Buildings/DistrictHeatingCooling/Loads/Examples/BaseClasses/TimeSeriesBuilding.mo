...
model TimeSeriesBuilding
  ...
  extends Buildings.DistrictHeatingCooling.Loads.BaseClasses.PartialBuilding(
    nCooLoa=1,
    final cooLoaTyp={Buildings.DistrictHeatingCooling.Loads.Types.ModelType.ODE},
    nHeaLoa=2,
    final heaLoaTyp={Buildings.DistrictHeatingCooling.Loads.Types.ModelType.ODE,Buildings.DistrictHeatingCooling.Loads.Types.ModelType.PrescribedT},
...
equation
  ...
  connect(from_degC1.y, heaLoaO[1].TSet)
    annotation (Line(points={{-79,130},{-60,130},{-60,102.8},{-178,102.8}}, color={0,0,127}));
  connect(maxTSet.y, from_degC2.u) annotation (Line(points={{-119,-130},{-102,-130}}, color={0,0,127}));
  connect(from_degC2.y, cooLoaO[1].TSet)
    annotation (Line(points={{-79,-130},{-60,-130},{-60,-97.2},{-178,-97.2}}, color={0,0,127}));
  ...
  connect(loa.y[1], cooLoaO[1].Q_flowReq)
    annotation (Line(points={{21,0},{80,0},{80,-103},{-178,-103}}, color={0,0,127}));
  connect(loa.y[2], heaLoaO[1].Q_flowReq) annotation (Line(points={{21,0},{80,0},{80,97},{-178,97}}, color={0,0,127}));
