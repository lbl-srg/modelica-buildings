within Buildings.DistrictHeatingCooling.Loads.Examples.BaseClasses.GeojsonExport;
model B5a6b99ec37f4de7f94020090_Meeting
  ...
  thermalZoneTwoElements(
    ...
    nOrientations=6,
    AWin={11.92763144924453, 0.0, 11.92763144924453, 1.1056190934805288, 0.0, 1.1056190934805288},
    ATransparent={11.92763144924453, 0.0, 11.92763144924453, 1.1056190934805288, 0.0, 1.1056190934805288},
    AExt={35.782894347733595, 72.92818030400002, 35.782894347733595, 3.316857280441586, 72.92818030400002, 3.316857280441586})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWall={0.15582361279765056, 0.2967672829195336, 0.15582361279765056, 0.014443903825944524, 0.0, 0.014443903825944524},
    wfWin={0.45758467583140006, 0.0, 0.45758467583140006, 0.04241532416859994, 0.0, 0.04241532416859994},
    withLongwave=true,
    aExt=0.5,
    alphaWallOut=20.0,
    alphaRad=5.0,
  ...
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*224.0558638643504)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=24.999999999999996*26.066501085450113)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Buildings/DistrictHeatingCooling/Loads/Examples/Resources/InternalGains_B5a6b99ec37f4de7f94020090Meeting.mat"),
      columns={2,3,4})
...
equation
  ...
  events=false));
end B5a6b99ec37f4de7f94020090_Meeting;
