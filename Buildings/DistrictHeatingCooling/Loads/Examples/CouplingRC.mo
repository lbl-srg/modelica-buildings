...
model CouplingRC "Example illustrating the coupling of a RC building model to a fluid loop"
  ...
  Buildings.DistrictHeatingCooling.Loads.Examples.BaseClasses.RCBuilding bui
  ...
  Buildings.DistrictHeatingCooling.Loads.BaseClasses.HeatingOrCooling couHea(
    ...
    T_a_nominal=318.15,
    T_b_nominal=313.15) annotation (Placement(transformation(extent={{0,40},{20,20}})));
  Buildings.DistrictHeatingCooling.Loads.BaseClasses.HeatingOrCooling couCoo(
    ...
    nLoa=bui.nCooLoa,
    T_a_nominal=280.15,
    T_b_nominal=285.15) annotation (Placement(transformation(extent={{0,-100},{20,-80}})));
