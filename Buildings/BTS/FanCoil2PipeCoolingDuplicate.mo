...
model FanCoil2PipeCoolingDuplicate "Model of a sensible only two-pipe fan coil unit for cooling,
  ...
  Fluid.Sensors.TemperatureTwoPort TOutAir(
    redeclare final package Medium = Medium2,
    final m_flow_nominal=hexWetNtu.m2_flow_nominal,
...
equation
  ...
  connect(one.y, swi.u3) annotation (Line(points={{12,140},{18,140},{18,172},{24,
          172}}, color={0,0,127}));
  connect(hexWetNtu.port_b2, TOutAir.port_a)
...
First implementation.
        ...
        Line(
          ...
          color={255,255,255},
          thickness=1)}));
end FanCoil2PipeCoolingDuplicate;
