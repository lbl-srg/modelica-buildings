...
model FanCoil2PipeHeatingDuplicate "Model of a two-pipe fan coil unit for heating,
  ...
  Fluid.Sensors.TemperatureTwoPort TOutAir(
    redeclare final package Medium = Medium2,
    final m_flow_nominal=hex.m2_flow_nominal,
    tau=0) annotation (Placement(transformation(extent={{-100,-10},{-120,10}})));
equation
  ...
  connect(hex.port_b2, TOutAir.port_a)
    annotation (Line(points={{-80,0},{-100,0}}, color={0,127,255}));
  connect(TOutAir.port_b, sinAir.ports[1])
...
First implementation.
        ...
        Line(
          ...
          color={255,255,255},
          thickness=1)}));
end FanCoil2PipeHeatingDuplicate;
