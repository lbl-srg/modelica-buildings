...
model ChillerDXHeatingEconomizerDuplicate
  ...
  Buildings.BTS.ControllerChillerDXHeatingEconomizerDuplicate con(
    minAirFlo=0.1,
    minOAFra=0.4,
...
Duplicate of Buildings.Air.Systems.SingleZone.VAV.Examples.ChillerDXHeatingEconomizer.
Replaced the control block with Buildings.BTS.ControllerChillerDXHeatingEconomizerDuplicate.
</p>
</html>", revisions="<html>
<ul>
<li>
...
end ChillerDXHeatingEconomizerDuplicate;
