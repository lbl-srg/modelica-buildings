...
r.move_class(path + "TerminalUnit.Validation.EconomizerMultiZone_Mod_DamLim.mo",
             path + "AHU.Economizer.Validation.EconomizerMultiZone_Mod_DamLim.mo")
r.move_class(path + "TerminalUnit.Validation.EconomizerSingleZone_Disable.mo",
             path + "AHU.Economizer.Validation.EconomizerSingleZone_Disable.mo")
r.move_class(path + "TerminalUnit.Validation.EconomizerSingleZone_Mod_DamLim.mo",
             path + "AHU.Economizer.Validation.EconomizerSingleZone_Mod_DamLim.mo")
