...
algorithm
 ...
 /*assert(Buildings.Utilities.Math.Functions.trapezoidalIntegration(N=7, f=y2, deltaX=0.3333) - 80.8889 < 1E-2,
...
<p>Tests the correct implementation of function trapezoidalIntegration.</p>
