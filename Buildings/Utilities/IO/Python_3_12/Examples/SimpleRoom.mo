within Buildings.Utilities.IO.Python_3_12.Examples;
model SimpleRoom
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/IO/Python_3_12/Examples/SimpleRoom.mos"
        "Simulate and plot"),
