...
algorithm
  yR1 := Buildings.Utilities.IO.Python34.Functions.exchange(
  ...
  yR2 := Buildings.Utilities.IO.Python34.Functions.exchange(
    moduleName="testFunctions",
    functionName="r1_r2",
    dblWri={2.0},
    intWri={0},
  ...
  (yR1,yI1) := Buildings.Utilities.IO.Python34.Functions.exchange(
    moduleName="testFunctions",
    functionName="i1_i1",
    dblWri={0.0},
    intWri={3},
  ...
  (yR1,yI2) := Buildings.Utilities.IO.Python34.Functions.exchange(
    moduleName="testFunctions",
    functionName="i1_i2",
    dblWri={0.0},
    intWri={2},
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/IO/Python34/Functions/Examples/Exchange.mos"
        "Simulate and plot"),
