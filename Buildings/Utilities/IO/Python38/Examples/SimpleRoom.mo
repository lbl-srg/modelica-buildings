within Buildings.Utilities.IO.Python38.Examples;
model SimpleRoom
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/IO/Python38/Examples/SimpleRoom.mos"
        "Simulate and plot"),
