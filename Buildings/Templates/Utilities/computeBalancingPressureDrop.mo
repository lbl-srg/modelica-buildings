...
function computeBalancingPressureDrop
  ...
  input Modelica.Units.SI.VolumeFlowRate V_flow_nominal
    "Design volume flow rate (target)";
  input Modelica.Units.SI.PressureDifference dp_nominal
    "Pressure drop of equipment in series at design flow rate";
  input Buildings.Fluid.Movers.BaseClasses.Characteristics.flowParameters prePum
    "Pump pressure curve";
...
<p>
Given the design volume flow rate, the design pressure drop
of all equipment in series, the pump pressure curve and the 
