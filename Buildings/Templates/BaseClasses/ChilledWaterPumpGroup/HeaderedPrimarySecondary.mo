...
model HeaderedPrimarySecondary
  extends Buildings.Templates.Interfaces.ChilledWaterPumpGroup(
    final typ=Types.ChilledWaterPumpGroup.HeaderedPrimarySecondary);
...
equation
  ...
  connect(splByp.port_3, senVolFlo.port_b) annotation (Line(points={{40,-10},{
          40,-40},{0,-40},{0,-50}}, color={0,127,255}));
  connect(senVolFlo.port_a, port_byp)
