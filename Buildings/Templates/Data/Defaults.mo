...
package Defaults
  ...
  constant Real ratMFloAirByCapChi(unit="(kg/s)/W") = 1E-4
  ...
  constant Real COPHpAwHea(unit="1") = 1.75
...
annotation(Documentation(
  info="<html>
<p>This package defines some constants that are either</p>
<ul>
  <li>
    typical values used as default parameter values for models inside the
    package
    <a href=\"modelica://Buildings.Templates\">
      Buildings.Templates</a>, or
  </li>
  <li>
    arbitrary values used for validation purposes only. Those are typically
    project-specific characteristics (e.g., chiller COP at nominal conditions)
    and should not be considered as generic default values.
  </li>
</ul>
</html>",
  revisions="<html>
