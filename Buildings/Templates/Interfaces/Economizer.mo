...
partial model Economizer
  ...
  Modelica.Fluid.Interfaces.FluidPort_b port_Exh(
    redeclare package Medium = Medium) if typ <> AHUs.Types.Economizer.CommonDamperFreeNoRelief
    "Exhaust/relief air"
    annotation (Placement(transformation(
  ...
  Modelica.Fluid.Interfaces.FluidPort_a port_OutMin(
    redeclare package Medium = Medium) if typ == AHUs.Types.Economizer.DedicatedDamperTandem
