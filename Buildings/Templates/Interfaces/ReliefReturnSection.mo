...
partial model ReliefReturnSection "Relief/return air section"
  ...
  Modelica.Fluid.Interfaces.FluidPort_b port_b(
    ...
    h_outflow(start=MediumAir.h_default, nominal=MediumAir.h_default))
 if typ<>Templates.Types.ReliefReturnSection.NoRelief
  ...
  Modelica.Fluid.Interfaces.FluidPort_b port_bRet(
    ...
    m_flow(max=if allowFlowReversal then +Modelica.Constants.inf else 0),
    h_outflow(start=MediumAir.h_default, nominal=MediumAir.h_default))
 if typ<>Templates.Types.ReliefReturnSection.NoEconomizer
