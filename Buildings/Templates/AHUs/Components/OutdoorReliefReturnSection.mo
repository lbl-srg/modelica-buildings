...
package OutdoorReliefReturnSection
  ...
  model Economizer "Air economizer"
    ...
    replaceable
      Buildings.Templates.AHUs.Components.ReliefReturnSection.ReturnFan secRel
      constrainedby Interfaces.ReliefReturnSection(redeclare final package
  ...
  model HeatRecovery "Heat recovery"
    ...
    replaceable
      Buildings.Templates.AHUs.Components.ReliefReturnSection.ReturnFan secRel
      constrainedby Interfaces.ReliefReturnSection(redeclare final package
        MediumAir = MediumAir, final have_recHea=true)
      "Relief/return air section" annotation (
      choices(
        choice(redeclare BaseClasses.ReliefReturnSection.ReturnFan secRel
            "Return fan - Modulated relief damper"),
  ...
  model NoRelief " No relief branch"
    ...
    replaceable
      Buildings.Templates.AHUs.Components.ReliefReturnSection.NoRelief secRel(
        redeclare final package MediumAir = MediumAir, final have_recHea=false)
      "Relief/return air section" annotation (Dialog(group=
