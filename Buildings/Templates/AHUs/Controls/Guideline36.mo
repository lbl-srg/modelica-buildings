...
block Guideline36 "Guideline 36 VAV single duct controller"
  ...
  parameter String namGroZon[nZon] = {
    dat.getString(varName=idTerArr[zon] + ".Identification.Zone group name.value")
    for zon in 1:nZon}
  ...
  final parameter Integer nZonGro[nGro] = {
    Modelica.Math.BooleanVectors.countTrue({
      namGroZon[zon] == namGro[gro] for zon in 1:nZon})
    for gro in 1:nGro}
...
equation
  ...
  connect(zonGroSta.nexOcc,opeModSel.tNexOcc) annotation (Line(points={{-82,-143},
          {-102,-143},{-102,-106},{-82,-106}},    color={0,0,127}));
  ...
  connect(zonGroSta.yColZon,opeModSel.totColZon) annotation (Line(points={{-82,-158},
          {-102,-158},{-102,-118},{-82,-118}},    color={255,127,0}));
  connect(zonGroSta.ySetBac,opeModSel.uSetBac) annotation (Line(points={{-82,-160},
          {-100,-160},{-100,-120},{-82,-120}},    color={255,0,255}));
  connect(zonGroSta.yEndSetBac,opeModSel.uEndSetBac) annotation (Line(points={{-82,
          -162},{-98,-162},{-98,-122},{-82,-122}},      color={255,0,255}));
  connect(zonGroSta.TZonMax,opeModSel.TZonMax) annotation (Line(points={{-82,-173},
          {-96,-173},{-96,-124},{-82,-124}},      color={0,0,127}));
  connect(zonGroSta.TZonMin,opeModSel.TZonMin) annotation (Line(points={{-82,-175},
          {-94,-175},{-94,-126},{-82,-126}},      color={0,0,127}));
  connect(zonGroSta.yHotZon,opeModSel. totHotZon) annotation (Line(points={{-82,
          -165},{-90,-165},{-90,-128},{-82,-128}},color={255,127,0}));
  connect(zonGroSta.ySetUp,opeModSel. uSetUp) annotation (Line(points={{-82,-167},
          {-90,-167},{-90,-130},{-82,-130}},      color={255,0,255}));
  connect(zonGroSta.yEndSetUp,opeModSel. uEndSetUp) annotation (Line(points={{-82,
          -169},{-88,-169},{-88,-132},{-82,-132}},color={255,0,255}));
  connect(zonGroSta.yOpeWin,opeModSel. uOpeWin) annotation (Line(points={{-82,-179},
          {-104,-179},{-104,-116},{-82,-116}},
                                             color={255,127,0}));
 ...
 connect(FIXME9.y, busOutAHU.yDamRel) annotation (Line(points={{278,152},{166,152},{166,160},{100,160}},
  ...
  connect(zonStaDup.zonOcc, busTer.sof.uOveZon) annotation (Line(points={{-10,-141},
          {200,-141},{200,0.1},{220.1,0.1}}, color={255,0,255}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(zonStaDup.uOcc, busTer.sof.uOccSch) annotation (Line(points={{-10,-143},
          {200,-143},{200,0.1},{220.1,0.1}}, color={255,0,255}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(zonStaDup.tNexOcc, busTer.sof.tNexOcc) annotation (Line(points={{-10,-145},
          {200,-145},{200,0.1},{220.1,0.1}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(zonStaDup.uCooTim, busTer.sof.yCooTim) annotation (Line(points={{-10,-149},
          {200,-149},{200,0.1},{220.1,0.1}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(zonStaDup.uWarTim, busTer.sof.yWarTim) annotation (Line(points={{-10,-151},
          {200,-151},{200,0.1},{220.1,0.1}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(zonStaDup.uOccHeaHig, busTer.sof.yOccHeaHig) annotation (Line(points={
          {-10,-155},{200,-155},{200,0.1},{220.1,0.1}}, color={255,0,255}),
      Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(zonStaDup.uHigOccCoo, busTer.sof.yHigOccCoo) annotation (Line(points={
          {-10,-157},{200,-157},{200,0.1},{220.1,0.1}}, color={255,0,255}),
      Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(zonStaDup.uUnoHeaHig, busTer.sof.yUnoHeaHig) annotation (Line(points={
          {-10,-161},{200,-161},{200,0.1},{220.1,0.1}}, color={255,0,255}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(zonStaDup.THeaSetOff, busTer.sof.THeaSetOff) annotation (Line(points={
          {-10,-163},{200,-163},{200,0.1},{220.1,0.1}}, color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(zonStaDup.uEndSetBac, busTer.sof.yEndSetBac) annotation (Line(points={
          {-10,-165},{200,-165},{200,0.1},{220.1,0.1}}, color={255,0,255}),
      Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(zonStaDup.uHigUnoCoo, busTer.sof.yHigUnoCoo) annotation (Line(points={
          {-10,-169},{200,-169},{200,0.1},{220.1,0.1}}, color={255,0,255}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(zonStaDup.TCooSetOff, busTer.sof.TCooSetOff) annotation (Line(points={
          {-10,-171},{200,-171},{200,0.1},{220.1,0.1}}, color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(zonStaDup.uEndSetUp, busTer.sof.yEndSetUp) annotation (Line(points={{-10,
          -173},{200,-173},{200,0.1},{220.1,0.1}}, color={255,0,255}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(zonStaDup.TZon, busTer.inp.TZon) annotation (Line(points={{-10,-177},{
          200,-177},{200,0.1},{220.1,0.1}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(zonStaDup.uWin, busTer.inp.uWin) annotation (Line(points={{-10,-179},{
          200,-179},{200,0.1},{220.1,0.1}}, color={255,0,255}),
      Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(opeModSel[idGroZon].yOpeMod, busTer.sof.yOpeMod) annotation (Line(
        points={{-58,-118},{200,-118},{200,0.1},{220.1,0.1}}, color={255,127,0}),
      Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(zonStaDup.yzonOcc, zonGroSta.zonOcc)
    annotation (Line(points={{-22,-141},{-58,-141}}, color={255,0,255}));
  connect(zonStaDup.yOcc, zonGroSta.uOcc)
    annotation (Line(points={{-22,-143},{-58,-143}}, color={255,0,255}));
  connect(zonStaDup.ytNexOcc, zonGroSta.tNexOcc)
    annotation (Line(points={{-22,-145},{-58,-145}}, color={0,0,127}));
  connect(zonStaDup.yCooTim, zonGroSta.uCooTim)
    annotation (Line(points={{-22,-149},{-58,-149}}, color={0,0,127}));
  connect(zonStaDup.yWarTim, zonGroSta.uWarTim)
    annotation (Line(points={{-22,-151},{-58,-151}}, color={0,0,127}));
  connect(zonStaDup.yOccHeaHig, zonGroSta.uOccHeaHig)
    annotation (Line(points={{-22,-155},{-58,-155}}, color={255,0,255}));
  connect(zonStaDup.yHigOccCoo, zonGroSta.uHigOccCoo)
    annotation (Line(points={{-22,-157},{-58,-157}}, color={255,0,255}));
  connect(zonStaDup.yUnoHeaHig, zonGroSta.uUnoHeaHig) annotation (Line(points={{
          -22,-161},{-40,-161},{-40,-161},{-58,-161}}, color={255,0,255}));
  connect(zonStaDup.yEndSetBac, zonGroSta.uEndSetBac)
    annotation (Line(points={{-22,-165},{-58,-165}}, color={255,0,255}));
  connect(zonStaDup.yTHeaSetOff, zonGroSta.THeaSetOff)
    annotation (Line(points={{-22,-163},{-58,-163}}, color={0,0,127}));
  connect(zonStaDup.yHigUnoCoo, zonGroSta.uHigUnoCoo)
    annotation (Line(points={{-22,-169},{-58,-169}}, color={255,0,255}));
  connect(zonStaDup.yEndSetUp, zonGroSta.uEndSetUp)
    annotation (Line(points={{-22,-173},{-58,-173}}, color={255,0,255}));
  connect(zonStaDup.yTCooSetOff, zonGroSta.TCooSetOff)
    annotation (Line(points={{-22,-171},{-58,-171}}, color={0,0,127}));
  connect(zonStaDup.yTZon, zonGroSta.TZon)
    annotation (Line(points={{-22,-177},{-58,-177}}, color={0,0,127}));
  connect(zonStaDup.yWin, zonGroSta.uWin) annotation (Line(points={{-22,-179},{-58,-179}}, color={255,0,255}));
