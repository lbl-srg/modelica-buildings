...
model VAVSingleDuct "VAV single duct with relief"
  ...
  replaceable Economizers.None eco
    ...
    annotation (
      ...
      Placement(transformation(extent={{-200,-150},{-180,-130}})));
  ...
  replaceable Coils.None coiHea3
    ...
    "Heating coil - Option 3: reheat coil"
      ...
      choicesAllMatching=true,
      Dialog(group="Cooling coil"),
      Placement(transformation(extent={{48,-210},{68,-190}})));
...
equation
  connect(port_OutMin, eco.port_OutMin)
    annotation (Line(points={{-300,-140},{-200,-140}}, color={0,127,255}));
  connect(port_Exh, eco.port_Exh) annotation (Line(points={{-300,-80},{-240,-80},
          {-240,-133},{-200,-133}}, color={0,127,255}));
  ...
  connect(eco.port_Ret, resRet.port_b) annotation (Line(points={{-180,-132.8},{-172,
  ...
  connect(ahuBus, eco.ahuBus) annotation (Line(
      points={{-300,0},{-220,0},{-220,-130},{-190,-130}},
      color={255,204,51},
      thickness=0.5));
  ...
  connect(fanSupDra.port_b, resSup.port_a)
    annotation (Line(points={{100,-200},{180,-200}}, color={0,127,255}));
  ...
  connect(eco.port_Sup, senTMix.port_a) annotation (Line(points={{-180,-147},{-176,
  ...
  connect(coiCoo.port_b, coiHea3.port_a)
    annotation (Line(points={{10,-200},{48,-200}}, color={0,127,255}));
  connect(coiHea3.port_b, fanSupDra.port_a)
    annotation (Line(points={{68,-200},{80,-200}}, color={0,127,255}));
  ...
  connect(senTHea1.port_b, eco.port_Out) annotation (Line(points={{-230,-200},{-220,
          -200},{-220,-146},{-210,-146},{-210,-147},{-200,-147}}, color={0,127,255}));
  annotation (
