...
package OutdoorReliefReturnSection
  ...
  model NoRelief " No relief branch"
    ...
    replaceable Buildings.Templates.AHUs.BaseClasses.ReliefReturnSection.NoRelief
      secRel(redeclare final package MediumAir = MediumAir, final have_recHea=false)
