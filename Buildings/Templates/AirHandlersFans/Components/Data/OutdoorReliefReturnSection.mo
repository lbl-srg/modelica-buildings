...
record OutdoorReliefReturnSection
  ...
  parameter Modelica.Units.SI.MassFlowRate mOutMin_flow_nominal=
    if typSecRel==Buildings.Templates.AirHandlersFans.Types.ReliefReturnSection.NoEconomizer
      then damOut.m_flow_nominal
    else 0.15 * damOut.m_flow_nominal
  ...
  parameter Buildings.Templates.Components.Data.Damper damOut(final typ=
        typDamOut) "Outdoor air damper" annotation (Dialog(group="Dampers and economizers",
  ...
  parameter Buildings.Templates.Components.Data.Damper damOutMin(final typ=
        typDamOutMin) "Minimum outdoor air damper" annotation (Dialog(group=
          "Dampers and economizers", enable=typDamOutMin <> Buildings.Templates.Components.Types.Damper.None));
  parameter Buildings.Templates.Components.Data.Damper damRel(final typ=
        typDamRel) "Relief damper" annotation (Dialog(group="Dampers and economizers",
  ...
  parameter Buildings.Templates.Components.Data.Damper damRet(final typ=
        typDamRet) "Return damper" annotation (Dialog(group="Dampers and economizers",
  ...
  parameter Buildings.Templates.Components.Data.Fan fanRel(final typ=typFanRel)
    "Relief fan" annotation (Dialog(group="Fans", enable=typFanRel <>
  ...
  parameter Buildings.Templates.Components.Data.Fan fanRet(final typ=typFanRet)
    "Return fan" annotation (Dialog(group="Fans", enable=typFanRet <>
          Buildings.Templates.Components.Types.Fan.None));
