...
block G36VAVMultiZone
  ...
  final parameter Buildings.Controls.OBC.ASHRAE.G36_2018.Types.ASHRAEClimateZone ashCliZon=
    datAll.ashCliZon
    "ASHRAE climate zone"
    annotation (Dialog(group="Configuration"));

  final parameter Buildings.Controls.OBC.ASHRAE.G36_2018.Types.Title24ClimateZone tit24CliZon=
    datAll.tit24CliZon
  ...
  final parameter Buildings.Controls.OBC.ASHRAE.G36_2018.Types.CoolingCoil typCoiCoo=
    if coiCoo.typ==Buildings.Templates.Components.Types.Coil.WaterBasedCooling then
      Buildings.Controls.OBC.ASHRAE.G36_2018.Types.CoolingCoil.WaterBased
    elseif coiCoo.typ==Buildings.Templates.Components.Types.Coil.EvaporatorMultiStage or
      ...
      Buildings.Controls.OBC.ASHRAE.G36_2018.Types.CoolingCoil.DXCoil
    else Buildings.Controls.OBC.ASHRAE.G36_2018.Types.CoolingCoil.None
    "Type of cooling coil"
    annotation(Evaluate=true);

  final parameter Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil typCoiHea=
    if coiHeaPre.typ==Buildings.Templates.Components.Types.Coil.WaterBasedHeating or
      ...
      then Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
    elseif coiHeaPre.typ==Buildings.Templates.Components.Types.Coil.ElectricHeating or
      ...
      then Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.Electric
    else Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.None
    "Type of cooling coil"
    annotation(Evaluate=true);
  ...
  /*
  *  Parameters for Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.Controller
  */
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.Controller ctl(
    final eneStd=stdEne,
    final venStd=stdVen,
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.ASHRAE62_1.SumZone
    aggZonVen_A621(
    final nZon=nZon,
    final nGro=nGro,
    final zonGroMat=isZonInGroInt,
    final zonGroMatTra=isZonInGroIntTra)
    if stdVen==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.VentilationStandard.ASHRAE62_1
    "Aggregate zone level ventilation signals - ASHRAE 62.1"
    annotation (Placement(transformation(extent={{-90,-10},{-70,10}})));

  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.SumZone
    aggZonVen_T24(
    final nZon=nZon,
    final nGro=nGro,
    final zonGroMat=isZonInGroInt,
    final have_CO2Sen=have_CO2Sen)
    if stdVen==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.VentilationStandard.California_Title_24
    "Aggregate zone level ventilation signals - California Title 24"
    annotation (Placement(transformation(extent={{-90,-40},{-70,-20}})));

  Buildings.Controls.OBC.ASHRAE.G36_2018.ZoneGroups.ZoneStatusDuplicator repSigZon(
    final nZon=nZon,
    final nZonGro=nGro)
    "Replicate zone signals"
    annotation (Placement(transformation(extent={{-190,100},{-182,140}})));

  Buildings.Controls.OBC.ASHRAE.G36_2018.ZoneGroups.GroupStatus staGro[nGro](
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.ZoneGroups.OperationMode opeModSel[nGro](
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.ZoneGroups.ZoneGroupSystem ahuMod(
    final nGro=nGro)
...
equation
  ...
  if typSecOut==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.OutdoorAirSection.SingleDamper then
    connect(bus.VOut_flow, ctl.VAirOut_flow);
  end if;
  if typSecOut==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.OutdoorAirSection.DedicatedDampersAirflow then
...
<ul>
<li>
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.Controller\">
Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.Controller</a>:
Main controller for the air handler
</li>
<li>
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2018.ZoneGroups.GroupStatus\">
Buildings.Controls.OBC.ASHRAE.G36_2018.ZoneGroups.GroupStatus</a>
and
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2018.ZoneGroups.OperationMode\">
Buildings.Controls.OBC.ASHRAE.G36_2018.ZoneGroups.OperationMode</a>:
Computation of the zone group operating mode out of zone-level signals
</li>
<li>
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2018.ZoneGroups.ZoneGroupSystem\">
Buildings.Controls.OBC.ASHRAE.G36_2018.ZoneGroups.ZoneGroupSystem</a>:
