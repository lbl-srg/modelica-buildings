...
equation
  connect(port_a, con.port_a1)
    annotation(Line(points={{-100,0},{-6,0}},
      color={0,127,255}));
  connect(con.port_b1, port_b)
    annotation(Line(points={{6,0},{100,0}},
      color={0,127,255}));
  connect(con.port_b2, loa.port_a)
    annotation(Line(points={{-6,20},{-6,40},{-10,40},{-10,60}},
      color={0,127,255}));
  connect(con.port_a2, loa.port_b)
    annotation(Line(points={{6,20},{6,40},{10,40},{10,60}},
      color={0,127,255}));
  connect(loa.yVal, con.yVal)
    annotation(Line(points={{12,68},{20,68},{20,80},{-20,80},{-20,10},{-12,10}},
      color={0,0,127}));
  connect(u, loa.u)
    annotation(Line(points={{-120,80},{-40,80},{-40,68},{-12,68}},
      color={0,0,127}));
  connect(loa.yLoa_actual, yLoa_actual)
    annotation(Line(points={{12,64},{90,64},{90,40},{120,40}},
      color={0,0,127}));
  connect(loa.Q_flow, Q_flow)
    annotation(Line(points={{12,51},{80,51},{80,-60},{120,-60}},
      color={0,0,127}));
  connect(con.yVal_actual, yVal_actual)
    annotation(Line(points={{12,10},{70,10},{70,80},{120,80}},
      color={0,0,127}));
  connect(u1, loa.u1)
    annotation(Line(points={{-120,40},{-40,40},{-40,64},{-12,64}},
      color={255,0,255}));
annotation(defaultComponentName="loa",
  Icon(coordinateSystem(preserveAspectRatio=false),
    ...
    Ellipse(extent={{-72,50},{28,-50}},
      lineColor={0,0,0},
      lineThickness=0.5,
      fillColor={255,255,255},
      fillPattern=FillPattern.Solid),
    Ellipse(extent={{-58,36},{14,-36}},
      lineColor={0,0,0},
      lineThickness=0.5,
      fillColor={255,255,255},
      fillPattern=FillPattern.Solid),
    Line(points={{-48.5,-24.5},{1.5,27.5}},
      color={0,0,0},
      thickness=0.5),
    Polygon(points={{40,10},{40,-10},{60,0},{40,10}},
      lineColor={0,0,0},
      lineThickness=0.5),
    Polygon(points={{-10,10},{-10,-10},{10,0},{-10,10}},
      lineColor={0,0,0},
      lineThickness=0.5,
      origin={70,0},
      rotation=180),
    Line(points={{-100,0},{-72,0}},
      color={0,0,0},
      thickness=0.5),
    Line(points={{28,0},{40,0}},
      color={0,0,0},
      thickness=0.5),
    Line(points={{80,0},{100,0}},
      color={0,0,0},
      thickness=0.5),
    Rectangle(extent={{50,34},{70,14}},
      lineColor={0,0,0},
      lineThickness=0.5),
    Line(points={{-22,50},{-22,62}},
      color={0,0,0},
      thickness=0.5),
    Line(points={{10,72},{-12,72}},
      color={0,0,0},
      thickness=0.5,
      pattern=LinePattern.Dot),
    Line(points={{10,82},{30,72},{10,62}},
      color={0,0,0},
      thickness=0.5),
    Rectangle(extent={{10,82},{50,62}},
      lineColor={0,0,0},
      lineThickness=0.5),
    Line(points={{50,72},{60,72},{60,34}},
      color={0,0,0},
      pattern=LinePattern.Dot,
      thickness=0.5),
    Ellipse(extent={{-32,82},{-12,62}},
      lineColor={0,0,0},
      lineThickness=0.5),
    Line(points={{-22,68},{-22,76}},
      color={0,0,0},
      thickness=1),
    Line(points={{-26,76},{-18,76}},
      color={0,0,0},
      thickness=1),
    Line(points={{-14,-1.71451e-15},{3.74941e-32,-6.12325e-16}},
      color={0,0,0},
      thickness=0.5,
      origin={60,0},
      rotation=270)}),
...
of
<a href=\"modelica://Buildings.Templates.Components.Loads.Load\">
Buildings.Templates.Components.Loads.Load</a>
