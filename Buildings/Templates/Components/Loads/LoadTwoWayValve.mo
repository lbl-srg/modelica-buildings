...
<p>
This model represents a thermal load on a hydronic circuit, composed of
<a href=\"modelica://Buildings.Templates.Components.Loads.Load\">
Buildings.Templates.Components.Loads.Load</a>
and a two-way valve component that is used to modulate the flow rate 
through the load component.
</p>
</html>", revisions="<html>
<ul>
<li>
