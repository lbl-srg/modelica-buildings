...
model HotWaterTable
  "Hot water boiler with efficiency described by a table"
...
<p>
  ...
  based on a lookup table indexed by the firing rate and the inlet
  temperature. This model is based on
  <a href=\"modelica://Buildings.Fluid.Boilers.BoilerTable\">
    Buildings.Fluid.Boilers.BoilerTable</a>. The user may refer to the
  documentation of
  <a href=\"modelica://Buildings.Fluid.Boilers.UsersGuide\">
    Buildings.Fluid.Boilers.UsersGuide</a> for the modeling assumptions.
</p>
...
<p>
  The design parameters and the efficiency table are specified with an
  instance of
  <a href=\"modelica://Buildings.Templates.Components.Data.BoilerHotWater\">
    Buildings.Templates.Components.Data.BoilerHotWater</a>. The documentation of
  this record class provides further details on how to properly parameterize
  the model.
</p>
</html>",
    revisions="<html>
