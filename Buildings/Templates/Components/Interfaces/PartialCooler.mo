...
partial model PartialCooler
  ...
  parameter Buildings.Templates.Components.Data.Cooler dat(final typ=typ)
  ...
  final parameter Modelica.Units.SI.PressureDifference dpConWatFri_nominal(
    final min=0) = dat.dpConWatFri_nominal
  ...
  final parameter Modelica.Units.SI.PressureDifference dpConWatSta_nominal(
    final min=0) = dat.dpConWatSta_nominal
    "CW elevation head";
  ...
  final parameter MediumConWat.ThermodynamicState staConWat_default =
    MediumConWat.setState_pTX(
      T=dat.TConWatSup_nominal,
      p=MediumConWat.p_default,
      X=MediumConWat.X_default)
    "CW default state";
  final parameter MediumConWat.SpecificHeatCapacity cpConWat_default =
    MediumConWat.specificHeatCapacityCp(staConWat_default)
    "CW default specific heat capacity";
...
annotation(Icon(coordinateSystem(preserveAspectRatio=false)),
  ...
  Documentation(
    info="<html>
<p>This partial class provides a standard interface for cooler models.</p>
</html>",
    revisions="<html>
<ul>
  <li>
