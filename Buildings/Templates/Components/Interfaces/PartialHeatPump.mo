...
model PartialHeatPump
  ...
  Modelica.Fluid.Interfaces.FluidPort_a port_aSou(
    ...
    "Source fluid connector a (positive design flow direction is from port_a to port_b)"
  ...
  Modelica.Fluid.Interfaces.FluidPort_b port_bSou(
    redeclare final package Medium=MediumSou)
    "Source fluid connector b (positive design flow direction is from port_a to port_b)"
    annotation(Placement(
      iconVisible=typ ==
        Buildings.Templates.Components.Types.HeatPump.WaterToWater,
      transformation(extent={{-70,-150},{-90,-130}}),
...
equation
  connect(busWea, air.weaBus)
    annotation(Line(points={{-40,-140},{0.2,-140}},
      color={255,204,51},
      thickness=0.5));
  connect(port_aSou, air.ports[1])
    annotation(Line(points={{80,-140},{80,-120},{-1,-120}},
      color={0,127,255}));
  connect(port_bSou, air.ports[2])
    annotation(Line(points={{-80,-140},{-80,-120},{1,-120}},
      color={0,127,255}));
annotation(Icon(graphics={Rectangle(extent={{100,100},{-100,-100}},
  lineColor={0,0,0},
  lineThickness=1),
Bitmap(extent={{-20,50},{20,90}},
...
Text(extent={{-60,0},{60,-40}},
  ...
  Documentation(
    info="<html>
<p>This partial class provides a standard interface for heat pump models.</p>
</html>",
    revisions="<html>
<ul>
  <li>
