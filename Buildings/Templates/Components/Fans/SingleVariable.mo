...
model SingleVariable "Single fan - Variable speed"
  extends Buildings.Templates.Components.Interfaces.Fan(final typ=Buildings.Templates.Components.Types.Fan.SingleVariable);
  ...
  Buildings.Controls.OBC.CDL.Continuous.Product conSup
    ...
    "Resulting control signal" annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={-40,40})));
  Buildings.Controls.OBC.CDL.Continuous.Product conRet if loc == Buildings.Templates.Components.Types.Location.Return
     or loc == Buildings.Templates.Components.Types.Location.Relief
    "Resulting control signal" annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=-90,
