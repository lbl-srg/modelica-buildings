...
model Tanks
  "Validation model for tank components"
...
equation
  ...
  connect(tan.port_b, sin.ports[1])
    annotation (Line(points={{20,0},{40,0},{40,-1},{60,-1}},color={0,127,255}));
  ...
  connect(noTan.port_b, sin.ports[2])
    annotation (Line(points={{20,-60},{40,-60},{40,1},{60,1}},color={0,127,255}));
  annotation (
    __Dymola_Commands(
      file=
        "modelica://Buildings/Resources/Scripts/Dymola/Templates/Components/Validation/Tanks.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=500),
