...
model HeatPumpsRecord
  ...
  parameter Buildings.Templates.Components.Data.HeatPump datHeaPumRevAss(
    ...
    mHeaWat_flow_nominal=datHeaPumRevAss.capHea_nominal/
    ...
    mChiWat_flow_nominal=datHeaPumRevAss.capCoo_nominal/
  ...
  parameter Buildings.Templates.Components.Data.HeatPump datHeaPumRevRed(
    ...
    final is_rev=true,
    final typMod=Buildings.Templates.Components.Types.HeatPumpModel.EquationFit,
    mHeaWat_flow_nominal=datHeaPumRevRed.capHea_nominal/
      abs(Buildings.Templates.Data.Defaults.THeaWatSupMed-
      Buildings.Templates.Data.Defaults.THeaWatRetMed)/
      Buildings.Utilities.Psychrometrics.Constants.cpWatLiq,
    dpHeaWat_nominal=Buildings.Templates.Data.Defaults.dpConWatChi,
    capHea_nominal=500E3,
    THeaWatSup_nominal=Buildings.Templates.Data.Defaults.THeaWatSupMed,
    mChiWat_flow_nominal=datHeaPumRevRed.capCoo_nominal/
      abs(Buildings.Templates.Data.Defaults.TChiWatSup-
      Buildings.Templates.Data.Defaults.TChiWatRet)/
      Buildings.Utilities.Psychrometrics.Constants.cpWatLiq,
    capCoo_nominal=500E3,
  ...
  parameter Buildings.Templates.Components.Data.HeatPump datHeaPumNonRevLoc(
    ...
    final is_rev=false,
    final typMod=Buildings.Templates.Components.Types.HeatPumpModel.EquationFit,
    mHeaWat_flow_nominal=datHeaPumNonRevLoc.capHea_nominal/
      abs(Buildings.Templates.Data.Defaults.THeaWatSupMed-
      Buildings.Templates.Data.Defaults.THeaWatRetMed)/
      Buildings.Utilities.Psychrometrics.Constants.cpWatLiq,
    dpHeaWat_nominal=Buildings.Templates.Data.Defaults.dpConWatChi,
  ...
  annotation (
  __Dymola_Commands(
  file="modelica://Buildings/Resources/Scripts/Dymola/Templates/Components/Validation/HeatPumpsRecord.mos"
  "Simulate and plot"),
