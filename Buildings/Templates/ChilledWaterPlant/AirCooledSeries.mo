...
model AirCooledSeries
  ...
  extends
    ...
    redeclare final Buildings.Templates.ChilledWaterPlant.Components.ChillerGroup.ChillerSeries chi);
  inner replaceable
...
equation
  ...
  connect(TCHWRet.y, chwCon.TRet) annotation (Line(points={{150,-58},{150,60},{
      ...
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(dpCHW.y, chwCon.dp) annotation (Line(points={{180,22},{180,34},{174,
          34},{174,60},{200,60}}, color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
