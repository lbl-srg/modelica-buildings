...
equation
  ...
  connect(colDis.port_aDisRet, senVolFlo.port_a) annotation (Line(points={{20,
          -56},{30,-56},{30,-40},{80,-40},{80,-30}}, color={0,127,255}));
  connect(senVolFlo.port_b, port_b)
    annotation (Line(points={{80,-10},{80,0},{100,0}}, color={0,127,255}));
  connect(senVolFlo.V_flow, V_flow) annotation (Line(points={{69,-20},{60,-20},
