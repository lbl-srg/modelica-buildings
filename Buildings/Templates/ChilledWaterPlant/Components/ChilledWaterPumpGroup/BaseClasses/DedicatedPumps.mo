within Buildings.Templates.ChilledWaterPlant.Components.ChilledWaterPumpGroup.BaseClasses;
model DedicatedPumps
...
equation
  ...
  connect(senVolFlo.port_a, vol.ports[1])
    annotation (Line(points={{68,0},{60,0},{60,-20}}, color={0,127,255}));
  connect(senVolFlo.port_b, port_b)
    annotation (Line(points={{88,0},{100,0}}, color={0,127,255}));
  connect(senVolFlo.V_flow, V_flow)
    annotation (Line(points={{78,11},{78,30},{120,30}}, color={0,0,127}));
