...
equation
  ...
  connect(pumSec.V_flow, busCon.inp.VSec_flow) annotation (Line(points={{81,5},{
          86,5},{86,80},{0,80},{0,100}},        color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(pumSec.y_actual, busCon.inp.uStaPumSec) annotation (Line(points={{81,8},{
          86,8},{86,80},{0,80},{0,100}},           color={255,0,255}), Text(
      string="%second",
      index=1,
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
