within Buildings.Templates.ChilledWaterPlant.Components.ChilledWaterPumpGroup.Interfaces;
partial model ChilledWaterPumpGroup
  ...
  parameter Boolean has_secPum "= true if there is secondary pumping";
  ...
  parameter Buildings.Types.ChilledWaterPumpGroup typ "Type of pump"
