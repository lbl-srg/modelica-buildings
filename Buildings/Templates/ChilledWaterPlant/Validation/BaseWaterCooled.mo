...
model BaseWaterCooled
  ...
  replaceable Buildings.Templates.ChilledWaterPlant.WaterCooledChilledWaterPlant chw constrainedby
    Buildings.Templates.ChilledWaterPlant.Validation.UserProject.BaseWaterCooled
...
protected
  ...
  annotation (Placement(
      transformation(extent={{10,40},{50,80}}), iconTransformation(
        extent={{-258,-26},{-238,-6}})));
  BaseClasses.Connectors.BusCondenserWater busCW
  annotation (Placement(
      transformation(extent={{-80,-80},{-40,-40}}), iconTransformation(
        extent={{-258,-26},{-238,-6}})));
equation
  ...
  connect(busCW, chw.cwCon) annotation (Line(
      points={{-60,-60},{-60,8},{-40,8}},
      color={255,204,51},
      thickness=0.5), Text(
      string="%first",
      index=-1,
