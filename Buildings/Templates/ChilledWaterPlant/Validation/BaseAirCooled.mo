...
model BaseAirCooled
  ...
  replaceable Buildings.Templates.ChilledWaterPlant.AirCooledChilledWaterPlant chw constrainedby
    Buildings.Templates.ChilledWaterPlant.Validation.UserProject.BaseAirCooled
...
protected
  BaseClasses.Connectors.BusChilledWater busCHW
  annotation (
    Placement(
