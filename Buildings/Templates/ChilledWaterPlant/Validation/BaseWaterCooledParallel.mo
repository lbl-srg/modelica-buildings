...
model BaseWaterCooledParallel
  ...
  replaceable Buildings.Templates.ChilledWaterPlant.WaterCooledParallel chw
    constrainedby
    Buildings.Templates.ChilledWaterPlant.Validation.UserProject.BaseWaterCooledParallel
