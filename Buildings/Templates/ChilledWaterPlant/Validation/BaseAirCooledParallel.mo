...
model BaseAirCooledParallel
  ...
  replaceable Buildings.Templates.ChilledWaterPlant.AirCooledParallel chw
    constrainedby
    Buildings.Templates.ChilledWaterPlant.Validation.UserProject.BaseAirCooledParallel
...
protected
  BaseClasses.BusChilledWater            busCHW(
    final nChi=chw.nChi,
