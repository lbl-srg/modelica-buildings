...
model ChillerGroup "Validation model for chiller group"
  ...
  parameter Buildings.Templates.ChilledWaterPlants.Components.Data.ChillerGroup datChiWatCoo(
    ...
    final dpConWatChi_nominal=dpConWatChi_nominal,
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TChiWat[nChi](final k=
    ...
    annotation (Placement(transformation(extent={{-178,390},{-158,410}})));
...
equation
  ...
  connect(sigModLoa.y, loa.u)
    annotation (Line(points={{31,134},{40,134},{40,126},{32,126}},
                                                               color={0,0,127}));
  ...
  connect(busChi, busPla.chi) annotation (Line(
      ...
      color={255,204,51},
      thickness=0.5));
  connect(TChiWat.y, busChi.TChiWatSupSet) annotation (Line(points={{-156,400},{
  ...
  connect(busPumChiWatPri1, pumChiWatPri1.bus) annotation (Line(
      ...
      color={255,204,51},
      thickness=0.5));
  connect(sigModLoa1.y, loa1.u) annotation (Line(points={{31,-6},{40,-6},{40,-14},
          {32,-14}}, color={0,0,127}));
