...
model ChillersToPrimaryPumpsSeries
  ...
  parameter Buildings.Templates.Components.Data.PumpMultiple datPumChiWatChi(
    ...
    dp_nominal=fill(2*sum(dpChiWatChi_nominal), nChi));
...
equation
  ...
  connect(TChiWatChiEnt3.port_b, resEva3.port_a) annotation (Line(points={{-190,
          -180},{-200,-180},{-200,-160}},
                                       color={0,127,255}));
  connect(sigModLoa3.y, loa3.u) annotation (Line(points={{11,-166},{20,-166},{20,
          -174},{12,-174}},
                          color={0,0,127}));
  ...
  connect(cooEco1.port_b, rou3.ports_aSup[nChi + 1]) annotation (Line(points={{-160,
          -220},{-120,-220},{-120,-120},{-80,-120}}, color={0,127,255}));
  ...
  connect(pumEco.port_a, rou3.ports_bRet[nChi + 1]) annotation (Line(points={{-100,
          -230},{-100,-180},{-80,-180}}, color={0,127,255}));
  ...
  connect(busPla2.valChiWatChiByp, busValChiWatChiByp2) annotation (Line(
      ...
      color={255,204,51},
      thickness=0.5));
  connect(mChiWatPri_flow3.port_b, del.ports[1]) annotation (Line(points={{110,-120},
          {120,-120},{120,-180},{59,-180}},       color={0,127,255}));
  connect(del.ports[2], loa3.port_a)
    annotation (Line(points={{61,-180},{10,-180}}, color={0,127,255}));
  connect(y1ValChiWatEcoByp.y[1],busValChiWatEcoByp. y) annotation (Line(points={{-228,
          300},{150,300},{150,80},{200,80}},       color={0,0,127}));
