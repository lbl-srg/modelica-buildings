...
equation
  ...
  connect(pumConWat1.ports_a, inlPumConWat1.ports_b)
    annotation (Line(points={{-50,-180},{-50,-180}},
                                                   color={0,127,255}));
  connect(y1.y[1], busPumConWat1.y1) annotation (Line(points={{-228,220},{160,
          220},{160,-100},{200,-100}}, color={255,0,255}));
  connect(coo1.port_b, inlPumConWat1.port_a) annotation (Line(points={{-150,-100},
          {-200,-100},{-200,-180},{-70,-180}},
                                          color={0,127,255}));
  connect(bouCon1.ports[1], inlPumConWat1.port_a) annotation (Line(points={{-80,
          -200},{-80,-180},{-70,-180}},
                                      color={0,127,255}));
  connect(pumConWat1.ports_b, outConWatChi1.ports_b)
    annotation (Line(points={{-30,-180},{-20,-180}},
                                                   color={0,127,255}));
  connect(outConWatChi1.port_a, loaCon1.port_a)
    annotation (Line(points={{0,-180},{20,-180},{20,-150}},
                                                         color={0,127,255}));
  connect(loaCon1.port_b, coo1.port_a)
    annotation (Line(points={{20,-130},{20,-100},{-130,-100}},
                                                        color={0,127,255}));
  connect(busPumConWat1, pumConWat1.bus) annotation (Line(
      points={{200,-100},{200,-170},{-40,-170}},
      color={255,204,51},
      thickness=0.5));
  connect(busPla1, coo1.bus) annotation (Line(
      points={{200,-60},{-140,-60}},
      color={255,204,51},
      thickness=0.5));
  connect(weaDat.weaBus, coo1.busWea) annotation (Line(
      points={{-230,140},{-220,140},{-220,-40},{-118,-40},{-118,-60}},
      color={255,204,51},
      thickness=0.5));
  ...
  connect(y1.y[1], busPla1.y1Coo) annotation (Line(points={{-228,220},{180,220},
          {180,-56},{200,-56},{200,-60}}, color={255,0,255}));
  connect(yCoo.y, busPla1.yCoo) annotation (Line(points={{-228,260},{220,260},{
          220,-60},{200,-60}}, color={0,0,127}));
  connect(y1.y[1], booToRea.u) annotation (Line(points={{-228,220},{240,220},{
          240,92}}, color={255,0,255}));
  connect(comSigLoa.y, loaCon1.u) annotation (Line(points={{240,38},{240,-160},
          {26,-160},{26,-152}}, color={0,0,127}));
