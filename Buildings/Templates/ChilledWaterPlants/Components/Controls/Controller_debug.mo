...
block Controller_debug
  "Debugging version of PrimarySystem.ChillerPlant.Controller from commit 3f8c79f4cd"
  ...
  parameter Buildings.Controls.OBC.CDL.Types.SimpleController ecoValCon=Buildings.Controls.OBC.CDL.Types.SimpleController.PI
    "Type of controller"
    annotation (Dialog(tab="Waterside economizer",group="Valve or pump control",
        enable=have_WSE and have_byPasValCon));
  ...
  parameter Real TiEcoVal=0.5
    ...
    annotation (Dialog(tab="Waterside economizer", group="Valve or pump control",
        enable=have_WSE and have_byPasValCon
               and (ecoValCon == Buildings.Controls.OBC.CDL.Types.SimpleController.PI or
               ecoValCon == Buildings.Controls.OBC.CDL.Types.SimpleController.PID)));

  parameter Real TdEcoVal=0.1
    "Time constant of derivative block"
    annotation (Dialog(tab="Waterside economizer",group="Valve or pump control",
      enable=have_WSE and have_byPasValCon
             and (ecoValCon == Buildings.Controls.OBC.CDL.Types.SimpleController.PD or
             ecoValCon == Buildings.Controls.OBC.CDL.Types.SimpleController.PID)));
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant FIXME_uIntGreThr(k=1)
    if not have_heaChiWatPum
    "#2299: Missing input if not have_heaChiWatPum"
    annotation (Placement(transformation(extent={{540,660},{560,680}})));
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant FIXME_uLifMax(
    k=max(TConWatRet_nominal .- TChiWatSupMin))
    "Unconnected inside input connector"
...
equation
  ...
  connect(FIXME_uIntGreThr.y, intGreThr.u) annotation (Line(points={{562,670},{570,
          670},{570,600},{578,600}}, color={255,127,0}));
annotation (
