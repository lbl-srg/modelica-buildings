...
model Series "Model for chillers in series"
  extends
    ...
    final typ=Buildings.Templates.ChilledWaterPlants.Components.Types.ChillerSection.ChillerSeries,
  ...
  inner replaceable
    ...
    final nChi=nChi,
    final dat=datPumPri) "Chilled water primary pumps" annotation (Placement(
        transformation(extent={{-70,-10},{-90,10}})), choices(choice(redeclare
          Buildings.Templates.ChilledWaterPlants.Components.PumpsPrimary.HeaderedSeries
          pumPri "Headered")));
...
equation
  ...
  connect(valChiWatChiIso.bus, bus.valChiWatChiIso) annotation (Line(
