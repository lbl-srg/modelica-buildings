within Buildings.Templates.ChilledWaterPlants.Components.PumpsCondenserWater.Interfaces;
partial model PartialCondenserPump "Partial condenser pump model"
  ...
  outer parameter Boolean have_eco
    "Set to true if pump supply waterside economizer";
...
equation
  ...
  connect(bus.pumCon, pum.bus) annotation (Line(
