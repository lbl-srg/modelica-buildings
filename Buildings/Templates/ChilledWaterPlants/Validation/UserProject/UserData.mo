...
record UserData
  extends Buildings.Templates.ChilledWaterPlants.Data.ChilledWaterPlant(
    ...
    pumPri(
      m_flow_nominal=9,
      pum(each dp_nominal=12000, each dpValve_nominal=2000),
    ...
    pumSec(m_flow_nominal=9, pum(each dp_nominal=12000, each dpValve_nominal=2000)),
    chiSec(chi(
    ...
    eco(
      ...
      pumEco(dp_nominal=12000, dpValve_nominal=2000),
