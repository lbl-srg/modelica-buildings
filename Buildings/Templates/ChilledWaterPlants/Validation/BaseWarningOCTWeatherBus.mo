...
model BaseWarningOCTWeatherBus
...
protected
  Buildings.Templates.Components.Interfaces.Bus busChi[nChi]
    "Chiller control bus" annotation (Placement(transformation(extent={{-210,-80},
...
equation
  ...
  connect(bus.pumChiWatSec, pumChiWatSec.bus) annotation (Line(
      ...
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(outPumChiWatSec.port_b, bouChiWat.ports[1]) annotation (Line(points={{
          280,40},{290,40},{290,41},{300,41}}, color={0,127,255}));
  ...
  connect(bypChiWatFix.port_b, rou.port_aByp) annotation (Line(points={{120,-20},
          {102,-20},{102,-10},{80,-10}},
                                       color={0,127,255}));
  connect(valChiWatMinByp.port_b, rou.port_aByp) annotation (Line(points={{168,-8},
          {168,-14},{146,-14},{146,-4},{86,-4},{86,-10},{80,-10}},
                                          color={0,127,255}));
  connect(bypChiWatFix.port_a, outPumChiWatPri.port_b) annotation (Line(points={{140,-20},
          {180,-20},{180,40}},                  color={0,127,255}));
  connect(outPumChiWatPri.port_b, valChiWatMinByp.port_a) annotation (Line(
        points={{180,40},{180,18},{168,18},{168,12}}, color={0,127,255}));
