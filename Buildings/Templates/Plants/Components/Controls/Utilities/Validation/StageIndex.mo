...
model StageIndex
  ...
  Buildings.Templates.Plants.Components.Controls.Utilities.StageIndex idxStaRunUna(
    final nSta=nSta,
    dtRun=25)
...
equation
  ...
  annotation (
    __Dymola_Commands(
      file=
        "modelica://Buildings/Resources/Scripts/Dymola/Templates/Plants/Components/Controls/Utilities/Validation/StageIndex.mos"
        "Simulate and plot"),
    experiment(
      StopTime=160.0,
      Tolerance=1e-06),
