...
model LastTrueIndex
  "Validation model"
  Buildings.Templates.Plants.Components.Controls.Utilities.LastTrueIndex idxLasTru(
    nin=6)
    "Return last true index"
    annotation (Placement(transformation(extent={{-10,50},{10,70}})));
  Buildings.Templates.Plants.Components.Controls.Utilities.LastTrueIndex idxLasTru1(
    nin=6)
    "Return last true index"
