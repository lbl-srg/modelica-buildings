...
model Enable
  ...
  Buildings.Templates.Plants.Components.Controls.Enabling.Enable enaCoo(
...
equation
  ...
  annotation (
    __Dymola_Commands(
      file=
        "modelica://Buildings/Resources/Scripts/Dymola/Templates/Plants/Components/Controls/Enabling/Validation/Enable.mos"
        "Simulate and plot"),
    experiment(
      StopTime=7200.0,
      Tolerance=1e-06),
