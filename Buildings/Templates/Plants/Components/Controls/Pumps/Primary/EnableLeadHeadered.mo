...
block EnableLeadHeadered
  ...
  Buildings.Controls.OBC.CDL.Logical.Not cloParMod[nValIso]
    if typValIso == Buildings.Templates.Plants.Components.Controls.Types.Actuator.Modulating
      and typCon == Buildings.Templates.Plants.Components.Controls.Types.EquipmentConnection.Parallel
  ...
  Buildings.Controls.OBC.CDL.Reals.LessThreshold cloSerMod[nValIso](
    each final t=0.99)
    if typValIso == Buildings.Templates.Plants.Components.Controls.Types.Actuator.Modulating
      and typCon == Buildings.Templates.Plants.Components.Controls.Types.EquipmentConnection.Series
