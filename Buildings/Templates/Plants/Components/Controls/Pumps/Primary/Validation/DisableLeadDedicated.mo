within Buildings.Templates.Plants.Components.Controls.Pumps.Primary.Validation;
model DisableLeadDedicated
  ...
  Buildings.Templates.Plants.Components.Controls.Pumps.Primary.DisableLeadDedicated disLea
    "Disable lead pump - Without flow request"
    annotation (Placement(transformation(extent={{40,10},{60,30}})));
  Buildings.Templates.Plants.Components.Controls.Pumps.Primary.DisableLeadDedicated disLeaReq(
    have_req=true)
...
equation
  ...
  annotation (
    __Dymola_Commands(
      file=
        "modelica://Buildings/Resources/Scripts/Dymola/Templates/Plants/Components/Controls/Pumps/Primary/Validation/DisableLeadDedicated.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600.0,
      Tolerance=1e-06),
...
<a href=\"modelica://Buildings.Templates.Plants.Components.Controls.Pumps.Primary.DisableLeadDedicated\">
Buildings.Templates.Plants.Components.Controls.Pumps.Primary.EnableLeadDedicated</a>
