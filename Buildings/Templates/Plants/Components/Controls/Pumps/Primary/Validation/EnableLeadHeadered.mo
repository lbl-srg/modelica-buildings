...
model EnableLeadHeadered
  ...
  Buildings.Templates.Plants.Components.Controls.Pumps.Primary.EnableLeadHeadered enaSerTwo(
    typCon=Buildings.Templates.Plants.Components.Controls.Types.EquipmentConnection.Series,
    typValIso=Buildings.Templates.Plants.Components.Controls.Types.Actuator.TwoPosition,
    nValIso=2)
  ...
  Buildings.Templates.Plants.Components.Controls.Pumps.Primary.EnableLeadHeadered enaSerMod(
    typCon=Buildings.Templates.Plants.Components.Controls.Types.EquipmentConnection.Series,
    typValIso=Buildings.Templates.Plants.Components.Controls.Types.Actuator.Modulating,
    nValIso=2)
    "Enable lead pump - Series piped equipment with modulating isolation valves"
    annotation (Placement(transformation(extent={{50,-70},{70,-50}})));
  Buildings.Templates.Plants.Components.Controls.Pumps.Primary.EnableLeadHeadered enaParTwo(
    typCon=Buildings.Templates.Plants.Components.Controls.Types.EquipmentConnection.Parallel,
    typValIso=Buildings.Templates.Plants.Components.Controls.Types.Actuator.TwoPosition,
    nValIso=2)
  ...
  Buildings.Templates.Plants.Components.Controls.Pumps.Primary.EnableLeadHeadered enaParMod(
    typCon=Buildings.Templates.Plants.Components.Controls.Types.EquipmentConnection.Parallel,
    typValIso=Buildings.Templates.Plants.Components.Controls.Types.Actuator.Modulating,
    nValIso=2)
...
equation
  ...
  annotation (
    __Dymola_Commands(
      file=
        "modelica://Buildings/Resources/Scripts/Dymola/Templates/Plants/Components/Controls/Pumps/Primary/Validation/EnableLeadHeadered.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3000.0,
      Tolerance=1e-06),
...
<a href=\"modelica://Buildings.Templates.Plants.Components.Controls.Pumps.Primary.EnableLeadHeadered\">
Buildings.Templates.Plants.Components.Controls.Pumps.Primary.EnableLeadHeadered</a>
