...
model ResetLocalDifferentialPressure
  ...
  Buildings.Templates.Plants.Components.Controls.Pumps.Generic.ResetLocalDifferentialPressure resDpLoc(
...
equation
  ...
  annotation (
    __Dymola_Commands(
      file=
        "modelica://Buildings/Resources/Scripts/Dymola/Templates/Plants/Components/Controls/Pumps/Generic/Validation/ResetLocalDifferentialPressure.mos"
        "Simulate and plot"),
    experiment(
      StopTime=8400.0,
      Tolerance=1e-06),
...
<a href=\"modelica://Buildings.Templates.Plants.Components.Controls.Pumps.Generic.ResetLocalDifferentialPressure\">
Buildings.Templates.Plants.Components.Controls.Pumps.Generic.ResetLocalDifferentialPressure</a>.
</p>
<p>
