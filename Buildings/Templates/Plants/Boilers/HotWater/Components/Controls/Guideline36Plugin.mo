...
block Guideline36Plugin
  ...
  parameter Boolean have_priSecTemSen=false
    ...
    annotation (Dialog(tab="Primary pump control parameters",
      ...
      enable = speConTypPri == Buildings.Templates.Plants.Boilers.HotWater.Components.Controls.TypesTmp.PrimaryPumpSpeedControlTypes.temperature));
  ...
  parameter Integer boiTyp[nBoi]={
    Buildings.Templates.Plants.Boilers.HotWater.Components.Controls.TypesTmp.BoilerTypes.condensingBoiler,
    Buildings.Templates.Plants.Boilers.HotWater.Components.Controls.TypesTmp.BoilerTypes.nonCondensingBoiler}
    "Boiler type"
    annotation(Dialog(tab="General", group="Boiler plant configuration parameters"));
  ...
  parameter Real maxLocDpPri(
    ...
    annotation (Dialog(tab="Primary pump control parameters", group="DP-based speed regulation",
      enable = speConTypPri == Buildings.Templates.Plants.Boilers.HotWater.Components.Controls.TypesTmp.PrimaryPumpSpeedControlTypes.localDP
      or speConTypPri == Buildings.Templates.Plants.Boilers.HotWater.Components.Controls.TypesTmp.PrimaryPumpSpeedControlTypes.remoteDP));
  ...
  parameter Real maxLocDpSec(
    ...
    annotation (Dialog(tab="Secondary pump control parameters", group="DP-based speed regulation",
      enable = speConTypSec == Buildings.Templates.Plants.Boilers.HotWater.Components.Controls.TypesTmp.PrimaryPumpSpeedControlTypes.localDP));
  ...
  parameter Buildings.Templates.Plants.Boilers.HotWater.Components.Controls.TypesTmp.PrimaryPumpSpeedControlTypes
    speConTypPri = Buildings.Templates.Plants.Boilers.HotWater.Components.Controls.TypesTmp.PrimaryPumpSpeedControlTypes.remoteDP
    "Primary pump speed regulation method"
    annotation (Dialog(group="Boiler plant configuration parameters", enable=have_varPriPum));

  parameter Buildings.Templates.Plants.Boilers.HotWater.Components.Controls.TypesTmp.SecondaryPumpSpeedControlTypes
    speConTypSec = Buildings.Templates.Plants.Boilers.HotWater.Components.Controls.TypesTmp.SecondaryPumpSpeedControlTypes.remoteDP
...
protected
  parameter Boolean have_remDPRegPri = (speConTypPri == Buildings.Templates.Plants.Boilers.HotWater.Components.Controls.TypesTmp.PrimaryPumpSpeedControlTypes.remoteDP)
    "Boolean flag for primary pump speed control with remote differential pressure";

  parameter Boolean have_locDPRegPri = (speConTypPri == Buildings.Templates.Plants.Boilers.HotWater.Components.Controls.TypesTmp.PrimaryPumpSpeedControlTypes.localDP)
    "Boolean flag for primary pump speed control with local differential pressure";

  parameter Boolean have_temRegPri = (speConTypPri == Buildings.Templates.Plants.Boilers.HotWater.Components.Controls.TypesTmp.PrimaryPumpSpeedControlTypes.temperature)
    "Boolean flag for primary pump speed control with temperature readings";

  parameter Boolean have_floRegPri = (speConTypPri == Buildings.Templates.Plants.Boilers.HotWater.Components.Controls.TypesTmp.PrimaryPumpSpeedControlTypes.flowrate)
    "Boolean flag for primary pump speed control with flowrate readings";

  parameter Boolean have_remDPRegSec = (speConTypSec == Buildings.Templates.Plants.Boilers.HotWater.Components.Controls.TypesTmp.SecondaryPumpSpeedControlTypes.remoteDP)
    "Boolean flag for secondary pump speed control with remote differential pressure";

  parameter Boolean have_locDPRegSec = (speConTypSec == Buildings.Templates.Plants.Boilers.HotWater.Components.Controls.TypesTmp.SecondaryPumpSpeedControlTypes.localDP)
