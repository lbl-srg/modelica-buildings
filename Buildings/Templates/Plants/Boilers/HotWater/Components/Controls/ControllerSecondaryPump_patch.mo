...
block ControllerSecondaryPump_patch
...
equation
  ...
  connect(min.y, enaLagSecPum.uPumSpe) annotation (Line(points={{182,-400},{190,
          -400},{190,-286},{-208,-286},{-208,38},{-122,38}}, color={0,0,127}));
...
end ControllerSecondaryPump_patch;
