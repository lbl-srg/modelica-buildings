...
block PartialController
  ...
  final parameter Boolean have_senTHeaWatPriSupNon =
    ...
    annotation(Evaluate=true,
      Dialog(group="Configuration"));
  final parameter Boolean have_senTHeaWatPlaRetCon = cfg.have_boiCon
  ...
  Buildings.Templates.Components.Interfaces.Bus busBoiNon[cfg.nBoiNon]
    if cfg.have_boiNon
  ...
  Buildings.Templates.Components.Interfaces.Bus busValBoiConIso[cfg.nBoiCon]
    ...
    annotation(Placement(transformation(extent={{-260,100},{-220,140}}),
      iconTransformation(extent={{-466,50},{-426,90}})));
  Buildings.Templates.Components.Interfaces.Bus busValBoiNonIso[cfg.nBoiNon]
    if cfg.have_boiNon
  ...
  Buildings.Templates.Components.Interfaces.Bus busLooNon
    ...
    annotation(Placement(transformation(extent={{-180,180},{-140,220}}),
      iconTransformation(extent={{-466,50},{-426,90}})));
equation
  connect(busBoiCon, bus.boiCon)
    annotation(Line(points={{-240,160},{-220,160},{-220,0},{-260,0}},
      color={255,204,51},
      thickness=0.5));
  connect(busValBoiConIso, bus.valBoiConIso)
    annotation(Line(points={{-240,120},{-220,120},{-220,0},{-260,0}},
      color={255,204,51},
      thickness=0.5));
  connect(busPumHeaWatPriCon, bus.pumHeaWatPriCon)
    annotation(Line(points={{-240,80},{-220,80},{-220,0},{-260,0}},
      color={255,204,51},
      thickness=0.5));
  connect(busPumHeaWatSec, bus.pumHeaWatSec)
    annotation(Line(points={{-200,-40},{-200,0},{-260,0}},
      color={255,204,51},
      thickness=0.5));
  connect(busPumHeaWatPriNon, bus.pumHeaWatPriNon)
    annotation(Line(points={{-160,80},{-180,80},{-180,0},{-260,0}},
      color={255,204,51},
      thickness=0.5));
  connect(busValBoiNonIso, bus.valBoiNonIso)
    annotation(Line(points={{-160,120},{-180,120},{-180,0},{-260,0}},
      color={255,204,51},
      thickness=0.5));
  connect(busBoiNon, bus.boiNon)
    annotation(Line(points={{-160,160},{-180,160},{-180,0},{-260,0}},
      color={255,204,51},
      thickness=0.5));
  ...
  connect(busLooCon, bus.looCon)
    annotation(Line(points={{-240,200},{-220,200},{-220,0},{-260,0}},
      color={255,204,51},
      thickness=0.5));
...
annotation(Icon(coordinateSystem(preserveAspectRatio=false)),
  ...
  Documentation(
    info="<html>
<p>
  This partial class provides a standard interface for boiler plant
  controllers.
</p>
</html>",
    revisions="<html>
