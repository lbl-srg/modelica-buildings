...
block DistributionControlPoints
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant dpHeaWatRem[nSenDpHeaWatRem](
    each k=Buildings.Templates.Data.Defaults.dpHeaWatRemSet_max)
...
annotation(Documentation(
  info="<html>
<p>
  This class generates signals typically yielded by sensors from the HW
