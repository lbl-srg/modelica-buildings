...
block BASControlPoints
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant TOut(k=10 + 273.15)
...
equation
  connect(TOut.y, bus.TOut)
    annotation(Line(points={{14,0},{100,0}},
      color={0,0,127}));
  connect(u1Sch.y, bus.u1Sch)
    annotation(Line(points={{14,40},{80,40},{80,0},{100,0}},
      color={255,0,255}));
annotation(defaultComponentName="sigBAS",
  Documentation(
    info="<html>
<p>
  This class generates signals typically provided by the BAS. It is aimed for
