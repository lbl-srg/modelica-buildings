...
model PlantReset
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.TimeTable ena(
    table=[0,0; 2,1; 19,0],
    timeScale=1000,
    final period=20000) "Plant enable"
    annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));

  Buildings.Controls.OBC.CDL.Reals.Sources.TimeTable timTabLin(
    final smoothness=Buildings.Controls.OBC.CDL.Types.Smoothness.ConstantSegments,
    final table=[0,0; 150,0; 300,0; 450,0; 600,0; 750,0; 900,0; 1050,0; 1200,4;
        1350,3; 1500,2; 1650,1; 1800,0],
    timeScale=10) "Time table with smoothness method of constant segments"
    annotation (Placement(transformation(extent={{-80,30},{-60,50}})));

  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse staPro(
    width=0.1,
    final period=8000,
    shift=2000) "Staging process in progress"
...
equation
  ...
  connect(reaToInt.y, res.uReqRes) annotation (Line(points={{-18,40},{0,40},{0,6},
          {18,6}}, color={255,127,0}));
  connect(staPro.y, res.u1StaPro) annotation (Line(points={{-58,-40},{0,-40},{0,
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Templates/Plants/Controls/Setpoints/Validation/PlantReset.mos"
    "Simulate and plot"),
