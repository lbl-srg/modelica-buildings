...
block FailsafeCondition
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TSupSet(
    ...
    annotation (Placement(transformation(extent={{-178,40},{-138,80}}),
      iconTransformation(extent={{-140,20},{-100,60}})));
  Buildings.Controls.OBC.CDL.Reals.Subtract dTSecPri
    if have_pumSec
    "Secondary-primary ∆T"
    annotation (Placement(transformation(extent={{-110,-90},{-90,-70}})));
  Buildings.Controls.OBC.CDL.Reals.Subtract dTPriSet
    "Primary-setpoint ∆T"
    annotation (Placement(transformation(extent={{-110,30},{-90,50}})));
  Buildings.Controls.OBC.CDL.Reals.MultiplyByParameter polHeaCoo(
    final k=if typ == Buildings.Templates.Plants.Controls.Types.Application.Cooling
      then - 1 else 1)
    "Polarity depending on heating or cooling application"
    annotation (Placement(transformation(extent={{-80,30},{-60,50}})));
  Buildings.Controls.OBC.CDL.Reals.MultiplyByParameter polHeaCoo1(
    final k=if typ == Buildings.Templates.Plants.Controls.Types.Application.Cooling
      then - 1 else 1)
    if have_pumSec
    "Polarity depending on heating or cooling application"
    annotation (Placement(transformation(extent={{-80,-90},{-60,-70}})));
  Buildings.Controls.OBC.CDL.Reals.LessThreshold lesPriSet(
    final t=- dT,
    final h=0.1 * dT)
    "True if Delta-T less than threshold"
    annotation (Placement(transformation(extent={{-50,30},{-30,50}})));
  Buildings.Controls.OBC.CDL.Reals.LessThreshold lesSecPri(
    final t=- dT,
    final h=0.1 * dT)
    if have_pumSec
    "True if Delta-T less than threshold"
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset timPriSet(
    final t=dtPri)
    "Timer"
    annotation (Placement(transformation(extent={{-10,30},{10,50}})));
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset timSecPri(
    final t=dtSec)
    if have_pumSec
    "Timer"
    annotation (Placement(transformation(extent={{-10,-90},{10,-70}})));
  Buildings.Controls.OBC.CDL.Logical.Or any
    "Any criterion met"
    annotation (Placement(transformation(extent={{112,-10},{132,10}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput y1
    "Failsafe stage up condition met"
  ...
  Buildings.Controls.OBC.CDL.Reals.Subtract dTSecSet
    if have_pumSec
    "Secondary-setpoint ∆T"
    annotation (Placement(transformation(extent={{-110,-50},{-90,-30}})));
  Buildings.Controls.OBC.CDL.Reals.MultiplyByParameter polHeaCoo2(
    final k=if typ == Buildings.Templates.Plants.Controls.Types.Application.Cooling
      then - 1 else 1)
    if have_pumSec
    "Polarity depending on heating or cooling application"
    annotation (Placement(transformation(extent={{-80,-50},{-60,-30}})));
  Buildings.Controls.OBC.CDL.Reals.LessThreshold lesSecSet(
    final t=- dT,
    final h=0.1 * dT)
    if have_pumSec
    "True if Delta-T less than threshold"
    annotation (Placement(transformation(extent={{-50,-50},{-30,-30}})));
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset timSecSet(
    final t=dtSec)
    if have_pumSec
    "Timer"
    annotation (Placement(transformation(extent={{-10,-50},{10,-30}})));
  Buildings.Controls.OBC.CDL.Logical.And allSec
    if have_pumSec
    "All criteria on secondary temperature met"
    annotation (Placement(transformation(extent={{28,-70},{48,-50}})));
equation
  connect(TPriSup, dTPriSet.u1)
    annotation (Line(points={{-158,0},{-120,0},{-120,46},{-112,46}},color={0,0,127}));
  connect(TSupSet, dTPriSet.u2)
    annotation (Line(points={{-158,60},{-130,60},{-130,34},{-112,34}},color={0,0,127}));
  connect(TSecSup, dTSecPri.u1)
    annotation (Line(points={{-160,-60},{-124,-60},{-124,-74},{-112,-74}},color={0,0,127}));
  connect(TPriSup, dTSecPri.u2)
    annotation (Line(points={{-158,0},{-120,0},{-120,-86},{-112,-86}},color={0,0,127}));
  ...
  connect(polHeaCoo.y, lesPriSet.u)
  ...
  connect(reset, timPriSet.reset)
    annotation (Line(points={{-158,100},{-20,100},{-20,32},{-12,32}},color={255,0,255}));
  connect(lesSecPri.y, timSecPri.u)
    annotation (Line(points={{-28,-80},{-12,-80}},color={255,0,255}));
  connect(reset, timSecPri.reset)
    annotation (Line(points={{-158,100},{-20,100},{-20,-88},{-12,-88}},color={255,0,255}));
  connect(any.y, y1)
  ...
  connect(lesSecSet.y, timSecSet.u)
    annotation (Line(points={{-28,-40},{-12,-40}},color={255,0,255}));
  connect(reset, timSecSet.reset)
    annotation (Line(points={{-158,100},{-20,100},{-20,-48},{-12,-48}},color={255,0,255}));
  connect(reset, timSecPri.reset)
    annotation (Line(points={{-158,100},{-20,100},{-20,-88},{-12,-88}},color={255,0,255}));
  connect(TSecSup, dTSecSet.u1)
    annotation (Line(points={{-160,-60},{-124,-60},{-124,-34},{-112,-34}},color={0,0,127}));
  connect(TSupSet, dTSecSet.u2)
    annotation (Line(points={{-158,60},{-130,60},{-130,-46},{-112,-46}},color={0,0,127}));
  connect(timSecSet.passed, allSec.u1)
    annotation (Line(points={{12,-48},{20,-48},{20,-60},{26,-60}},color={255,0,255}));
  connect(timSecPri.passed, allSec.u2)
    annotation (Line(points={{12,-88},{20,-88},{20,-68},{26,-68}},color={255,0,255}));
  connect(allSec.y, ph.u)
    annotation (Line(points={{50,-60},{68,-60}},color={255,0,255}));
  connect(timPriSet.passed, any.u1)
    annotation (Line(points={{12,32},{100,32},{100,0},{110,0}},color={255,0,255}));
  connect(ph.y, any.u2)
    annotation (Line(points={{92,-60},{100,-60},{100,-8},{110,-8}},color={255,0,255}));
  annotation (
