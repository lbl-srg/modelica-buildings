...
block LoadAverage
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput QReq_flow(
    final unit="W")
    "Load"
...
equation
  connect(capFlo.y, capReq.u2)
    annotation (Line(points={{-48,-40},{-20,-40},{-20,-6},{-12,-6}},color={0,0,127}));
  connect(TSupSet, delT.u1)
    annotation (Line(points={{-120,40},{-80,40},{-80,6},{-72,6}},color={0,0,127}));
  ...
  connect(delT.y, capReq.u1)
    annotation (Line(points={{-48,0},{-20,0},{-20,6},{-12,6}},color={0,0,127}));
