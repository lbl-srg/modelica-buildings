...
equation
  connect(u1_actual, disAndOff.u2)
    annotation (Line(points={{-180,-60},{-100,-60},{-100,-48},{-92,-48}},
                                                                       color={255,0,255}));
  connect(u1_actual, enaAndOn.u2)
    annotation (Line(points={{-180,-60},{-100,-60},{-100,-8},{-92,-8}},
                                                                     color={255,0,255}));
  connect(endStaPro.y, y1End)
    annotation (Line(points={{142,100},{180,100}},color={255,0,255}));
  connect(lckChaSta.y, y1)
    annotation (Line(points={{92,100},{100,100},{100,-60},{180,-60}},color={255,0,255}));
  ...
  connect(chaAndMat.y, lckChaSta.clr)
    annotation (Line(points={{52,60},{60,60},{60,94},{68,94}},
      color={255,0,255}));
  connect(lckChaSta.y, endStaPro.u)
    annotation (Line(points={{92,100},{118,100}},color={255,0,255}));
  connect(enaAndOn.y, onOrOff.u1)
    annotation (Line(points={{-68,0},{-52,0}},color={255,0,255}));
  connect(disAndOff.y, onOrOff.u2)
    annotation (Line(points={{-68,-40},{-60,-40},{-60,-8},{-52,-8}},color={255,0,255}));
  connect(onOrOff.y, allTru.u)
    annotation (Line(points={{-28,0},{-12,0}},
                                            color={255,0,255}));
  connect(allTru.y, chaAndMat.u2)
    annotation (Line(points={{12,0},{20,0},{20,52},{28,52}},
      color={255,0,255}));
  connect(chaSta.y, lckChaSta.u)
    annotation (Line(points={{-108,100},{68,100}},color={255,0,255}));
  ...
  connect(u1Pre.y, enaAndOn.u1)
    annotation (Line(points={{-128,0},{-92,0}}, color={255,0,255}));
