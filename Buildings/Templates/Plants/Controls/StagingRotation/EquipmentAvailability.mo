...
block EquipmentAvailability
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1_actual
    "Equipment status" annotation (Placement(transformation(extent={{-200,60},{
            -160,100}}),iconTransformation(extent={{-140,40},{-100,80}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput y1Hea if have_heaWat
    "Equipment available for heating" annotation (Placement(transformation(
          extent={{160,60},{200,100}}), iconTransformation(extent={{100,40},{
            140,80}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1Hea_actual
    if have_heaWat and have_chiWat
    "Equipment operating mode" annotation (Placement(transformation(extent={{-200,
            -100},{-160,-60}}),iconTransformation(extent={{-140,-80},{-100,-40}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput y1Coo if have_chiWat
    "Equipment available for cooling" annotation (Placement(transformation(
          extent={{160,-100},{200,-60}}),iconTransformation(extent={{100,-80},{
            140,-40}})));
  ...
  Buildings.Controls.OBC.CDL.Logical.And avaCooAva if have_chiWat
  ...
  Buildings.Controls.OBC.CDL.Logical.And avaHeaAva if have_heaWat
  ...
  Buildings.Controls.OBC.CDL.Logical.Timer timOff(t=dtOff)
    "Time elapsed since equipment is off"
    annotation (Placement(transformation(extent={{-70,30},{-50,50}})));
  Buildings.Controls.OBC.CDL.Logical.Or avaOrOnHea if have_heaWat
    "Available after off time or already on in heating mode"
    annotation (Placement(transformation(extent={{90,70},{110,90}})));
  Buildings.Controls.OBC.CDL.Logical.Or avaOrOnCoo if have_chiWat
...
equation
  connect(coo.y, onAndCoo.u2) annotation (Line(points={{-88,-40},{-76,-40},{-76,
          72},{-72,72}},   color={255,0,255}));
  connect(u1_actual, onAndHea.u1)
    annotation (Line(points={{-180,80},{-80,80},{-80,-80},{-72,-80}},
                                                color={255,0,255}));
  connect(u1_actual, onAndCoo.u1) annotation (Line(points={{-180,80},{-72,80}},
                           color={255,0,255}));
  connect(u1Ava, avaCooAva.u1) annotation (Line(points={{-180,0},{120,0},{120,
          -80},{128,-80}},
                     color={255,0,255}));
  connect(u1Ava, avaHeaAva.u2) annotation (Line(points={{-180,0},{120,0},{120,
          72},{130,72}},
                    color={255,0,255}));
  connect(u1Hea_actual, pla.u)
    annotation (Line(points={{-180,-80},{-152,-80}},color={255,0,255}));
  connect(pla.y, onAndHea.u2) annotation (Line(points={{-128,-80},{-100,-80},{
          -100,-88},{-72,-88}},
                           color={255,0,255}));
  connect(pla.y, coo.u) annotation (Line(points={{-128,-80},{-120,-80},{-120,
          -40},{-112,-40}},
                      color={255,0,255}));
  connect(u1_actual, off.u) annotation (Line(points={{-180,80},{-150,80},{-150,
          40},{-142,40}},
                      color={255,0,255}));
  connect(off.y, timOff.u)
    annotation (Line(points={{-118,40},{-72,40}},
                                               color={255,0,255}));
  ...
  connect(onAndHea.y, avaOrOnHea.u2) annotation (Line(points={{-48,-80},{70,-80},
          {70,72},{88,72}}, color={255,0,255}));
  connect(avaOrOnCoo.y, avaCooAva.u2) annotation (Line(points={{112,-80},{116,
          -80},{116,-88},{128,-88}}, color={255,0,255}));
  connect(avaOrOnHea.y, avaHeaAva.u1)
    annotation (Line(points={{112,80},{130,80}}, color={255,0,255}));
  connect(timOff.passed, latCoo.clr) annotation (Line(points={{-48,32},{-30,32},
          {-30,54},{-22,54}}, color={255,0,255}));
  connect(timOff.passed, latHea.clr) annotation (Line(points={{-48,32},{-30,32},
          {-30,-26},{-22,-26}}, color={255,0,255}));
  connect(unaHea.y, avaOrOnHea.u1) annotation (Line(points={{52,40},{80,40},{80,
          80},{88,80}}, color={255,0,255}));
  connect(unaCoo.y, avaOrOnCoo.u1) annotation (Line(points={{52,-20},{80,-20},{
          80,-80},{88,-80}}, color={255,0,255}));
  connect(onAndHea.y, latHea.u) annotation (Line(points={{-48,-80},{-40,-80},{
          -40,-20},{-22,-20}}, color={255,0,255}));
  connect(off.y, latOff.u) annotation (Line(points={{-118,40},{-100,40},{-100,
          20},{-22,20}}, color={255,0,255}));
  connect(timOff.passed, latOff.clr) annotation (Line(points={{-48,32},{-30,32},
          {-30,14},{-22,14}}, color={255,0,255}));
  connect(latOff.y, unaCoo.u1) annotation (Line(points={{2,20},{20,20},{20,-20},
          {28,-20}}, color={255,0,255}));
  connect(latHea.y, unaCoo.u2) annotation (Line(points={{2,-20},{8,-20},{8,-28},
          {28,-28}}, color={255,0,255}));
  connect(latCoo.y, unaHea.u1) annotation (Line(points={{2,60},{20,60},{20,40},
          {28,40}}, color={255,0,255}));
  connect(latOff.y, unaHea.u2) annotation (Line(points={{2,20},{20,20},{20,32},
          {28,32}}, color={255,0,255}));
  connect(onAndCoo.y, latCoo.u) annotation (Line(points={{-48,80},{-30,80},{-30,
          60},{-22,60}}, color={255,0,255}));
  connect(onAndCoo.y, avaOrOnCoo.u2) annotation (Line(points={{-48,80},{60,80},
          {60,-88},{88,-88}}, color={255,0,255}));
          annotation (
