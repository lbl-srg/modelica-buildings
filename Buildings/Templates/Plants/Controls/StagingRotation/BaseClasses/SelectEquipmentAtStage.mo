...
block SelectEquipmentAtStage
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput y1NotReqNorAlt[nEqu]
    "True if unit is not required nor indexed as lead/lag alternate"
...
equation
  ...
  connect(notReqNorAlt.y, y1NotReqNorAlt)
    annotation (Line(points={{12,-80},{120,-80}}, color={255,0,255}));
