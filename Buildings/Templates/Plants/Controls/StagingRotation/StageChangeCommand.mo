...
block StageChangeCommand
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset timUp(
    final t=dtRun)
    "Timer"
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset timDow(
    final t=dtRun)
    "Timer"
