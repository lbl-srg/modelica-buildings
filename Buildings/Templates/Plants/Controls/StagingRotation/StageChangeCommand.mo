...
equation
  ...
  connect(traMatStaEqu.y, reqEquSta.u)
    annotation(Line(points={{-48,220},{-12,220}},
      color={0,0,127}));
  connect(reqEquSta.y, capEquSta.u1)
    annotation(Line(points={{12,220},{20,220},{20,226},{28,226}},
      color={0,0,127}));
  connect(capEquPar.y, capEquSta.u2)
    annotation(Line(points={{-48,160},{20,160},{20,214},{28,214}},
      color={0,0,127}));
  connect(capEquSta.y, capSta.u)
    annotation(Line(points={{52,220},{68,220}},
      color={0,0,127}));
  connect(intScaRep.u, maxInt.y)
    annotation(Line(points={{-112,200},{-118,200}},
      color={255,127,0}));
  connect(idxSta.y, idxStaLesAct.u1)
    annotation(Line(points={{-158,140},{-154,140},{-154,100},{-152,100}},
      color={255,127,0}));
  connect(uSta, intScaRep1.u)
    annotation(Line(points={{-220,180},{-190,180},{-190,100},{-182,100}},
      color={255,127,0}));
  connect(intScaRep1.y, idxStaLesAct.u2)
    annotation(Line(points={{-158,100},{-156,100},{-156,92},{-152,92}},
      color={255,127,0}));
  connect(idxStaLesAct.y, idxStaLesActAva.u1)
    annotation(Line(points={{-128,100},{-120,100},{-120,80},{-112,80}},
      color={255,0,255}));
  connect(u1AvaSta, idxStaLesActAva.u2)
    annotation(Line(points={{-220,60},{-120,60},{-120,72},{-112,72}},
      color={255,0,255}));
  connect(idxStaLesActAva.y, idxLasTru.u1)
    annotation(Line(points={{-88,80},{-82,80}},
      color={255,0,255}));
  connect(idxLasTru.y, maxInt1.u2)
    annotation(Line(points={{-58,80},{-44,80},{-44,114},{-32,114}},
      color={255,127,0}));
  connect(one.y, maxInt1.u1)
    annotation(Line(points={{-158,180},{-40,180},{-40,126},{-32,126}},
      color={255,127,0}));
  connect(maxInt1.y, intScaRep2.u)
    annotation(Line(points={{-8,120},{8,120}},
      color={255,127,0}));
  connect(uSta, maxInt.u1)
    annotation(Line(points={{-220,180},{-190,180},{-190,206},{-142,206}},
      color={255,127,0}));
  connect(one.y, maxInt.u2)
    annotation(Line(points={{-158,180},{-150,180},{-150,194},{-142,194}},
      color={255,127,0}));
  connect(intScaRep2.y, reqEquStaLow.index)
    annotation(Line(points={{32,120},{40,120},{40,140},{0,140},{0,168}},
      color={255,127,0}));
  ...
  connect(reqEquStaLow.y, capEquStaLow.u2)
    annotation(Line(points={{12,180},{16,180},{16,174},{28,174}},
      color={0,0,127}));
  connect(capEquPar.y, capEquStaLow.u1)
    annotation(Line(points={{-48,160},{20,160},{20,186},{28,186}},
      color={0,0,127}));
  connect(capEquStaLow.y, capStaLow.u)
    annotation(Line(points={{52,180},{68,180}},
      color={0,0,127}));
  connect(idxLasTru.y, minInt.u2)
    annotation(Line(points={{-58,80},{-44,80},{-44,74},{-32,74}},
      color={255,127,0}));
  connect(one.y, minInt.u1)
    annotation(Line(points={{-158,180},{-40,180},{-40,86},{-32,86}},
      color={255,127,0}));
  connect(minInt.y, intToRea.u)
    annotation(Line(points={{-8,80},{8,80}},
      color={255,127,0}));
  connect(capStaLow.y, setZer.u1)
    annotation(Line(points={{92,180},{100,180},{100,186},{108,186}},
      color={0,0,127}));
  connect(intToRea.y, setZer.u2)
    annotation(Line(points={{32,80},{100,80},{100,174},{108,174}},
      color={0,0,127}));
  ...
  connect(capSta.y, splTimCapSta.u2)
    annotation(Line(
      points={{92,220},{136,220},{136,-160},{-136,-160},{-136,-146},{-132,-146}},
      color={0,0,127}));
  connect(setZer.y, splTimCapStaLow.u2)
    annotation(Line(
      points={{132,180},{140,180},{140,-200},{-136,-200},{-136,-186},{-132,-186}},
      color={0,0,127}));
  ...
  connect(uPlrSta, parPlrSta.u)
    annotation(Line(points={{-220,-220},{-192,-220}},
      color={0,0,127}));
  connect(parPlrSta.y, splTimCapSta.u1)
    annotation(Line(points={{-168,-220},{-140,-220},{-140,-134},{-132,-134}},
      color={0,0,127}));
  connect(parPlrSta.y, splTimCapStaLow.u1)
    annotation(Line(points={{-168,-220},{-140,-220},{-140,-174},{-132,-174}},
      color={0,0,127}));
  ...
  connect(TSupSet, capReq.TSupSet)
    annotation(Line(points={{-220,-80},{-180,-80},{-180,-94},{-172,-94}},
      color={0,0,127}));
  connect(TRet, capReq.TRet)
    annotation(Line(points={{-220,-140},{-192,-140},{-192,-100},{-172,-100}},
      color={0,0,127}));
  connect(V_flow, capReq.V_flow)
    annotation(Line(points={{-220,-180},{-180,-180},{-180,-106},{-172,-106}},
      color={0,0,127}));
  connect(capReq.QReq_flow, hol.u)
    annotation(Line(points={{-148,-100},{-144,-100},{-144,-106},{-132,-106}},
      color={0,0,127}));
  connect(u1StaPro, endStaPro.u)
    annotation(Line(points={{-220,20},{-132,20}},
      color={255,0,255}));
  connect(TPriSup, faiSaf.TPriSup)
    annotation(Line(points={{-220,-20},{-92,-20}},
      color={0,0,127}));
  connect(endStaPro.y, faiSaf.reset)
    annotation(Line(points={{-108,20},{-100,20},{-100,-12},{-92,-12}},
      color={255,0,255}));
  connect(TSecSup, faiSaf.TSecSup)
    annotation(Line(points={{-220,-40},{-100,-40},{-100,-24},{-92,-24}},
      color={0,0,127}));
  connect(TSupSet, faiSaf.TSupSet)
    annotation(Line(points={{-220,-80},{-180,-80},{-180,-16},{-92,-16}},
      color={0,0,127}));
  connect(faiSaf.y1, effOrFaiSaf.u1)
    annotation(Line(points={{-68,-20},{0,-20},{0,-60},{8,-60}},
      color={255,0,255}));
  connect(timUp.passed, effOrFaiSaf.u2)
    annotation(Line(points={{-28,-108},{0,-108},{0,-68},{8,-68}},
      color={255,0,255}));
  connect(effOrFaiSaf.y, y1Up)
    annotation(Line(points={{32,-60},{180,-60},{180,80},{220,80}},
      color={255,0,255}));
  connect(faiSaf.y1, notFaiSaf.u)
    annotation(Line(points={{-68,-20},{-56,-20},{-56,-40},{-52,-40}},
      color={255,0,255}));
  connect(timDow.passed, effAndNotFaiSaf.u2)
    annotation(Line(points={{-28,-148},{8,-148}},
      color={255,0,255}));
  connect(notFaiSaf.y, effAndNotFaiSaf.u1)
    annotation(Line(points={{-28,-40},{-20,-40},{-20,-140},{8,-140}},
      color={255,0,255}));
  connect(effAndNotFaiSaf.y, y1Dow)
    annotation(Line(points={{32,-140},{180,-140},{180,-80},{220,-80}},
      color={255,0,255}));
  connect(uStaOpp, extTra.u)
    annotation(Line(points={{-220,260},{-72,260}},
      color={255,127,0}));
  connect(extTra.y, reqEquSta.u)
    annotation(Line(points={{-48,260},{-20,260},{-20,220},{-12,220}},
      color={0,0,127}));
  connect(extTra.y, reqEquStaLow.u)
    annotation(Line(points={{-48,260},{-20,260},{-20,180},{-12,180}},
      color={0,0,127}));
  connect(extTra.y, staTra)
    annotation(Line(points={{-48,260},{220,260}},
      color={0,0,127}));
annotation(defaultComponentName="chaSta",
  Icon(coordinateSystem(preserveAspectRatio=false,
    extent={{-100,-120},{100,120}}),
    graphics={Rectangle(extent={{-100,120},{100,-120}},
      lineColor={0,0,0},
