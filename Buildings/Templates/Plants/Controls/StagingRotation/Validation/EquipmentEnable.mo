...
equation
  connect(u1AvaEqu.y, equEnaOneTwo.u1Ava)
    annotation (Line(points={{-58,-40},{-40,-40},{-40,-44},{68,-44}},color={255,0,255}));
  connect(uSta.y[1], equEnaOneTwo.uSta)
    annotation (Line(points={{-58,0},{64,0},{64,-40},{68,-40}},color={255,127,0}));
  ...
  connect(u1AvaEqu.y, equEnaEqu.u1Ava)
    annotation (Line(points={{-58,-40},{-40,-40},{-40,36},{68,36}},color={255,0,255}));
  ...
  connect(sort.yIdx, equEnaEqu.uIdxAltSor)
    annotation (Line(points={{22,54},{60,54},{60,48},{68,48}},color={255,127,0}));
