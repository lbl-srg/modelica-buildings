...
equation
  connect(booPul.y, ctl.u1HpAva[3]) annotation (Line(points={{-58,-40},{-26,-40},
          {-26,0},{-22,0},{-22,4},{-12,4}},             color={255,0,255}));
  connect(con.y, ctl.u1HpAva[1]) annotation (Line(points={{-58,-10},{-22,-10},{
          -22,3.5},{-12,3.5}},         color={255,0,255}));
  connect(con.y, ctl.u1HeaHp[1]) annotation (Line(points={{-58,-10},{-26,-10},{
          -26,-0.5},{-12,-0.5}},           color={255,0,255}));
