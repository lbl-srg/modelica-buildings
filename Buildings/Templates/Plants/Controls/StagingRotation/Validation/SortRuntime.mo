...
model SortRuntime
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.SampleTrigger upPul(period=60)
    "Stage up command pulse"
    annotation (Placement(transformation(extent={{-130,-30},{-110,-10}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.SampleTrigger dowPul(period=60)
    "Stage down command pulse"
    annotation (Placement(transformation(extent={{-130,-70},{-110,-50}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.TimeTable booTimTab(table=[0,0,0; 60,
        1,0; 300,0,1], period=500)
...
equation
  ...
  connect(booTimTab.y[1],up. u1)
    annotation (Line(points={{-108,20},{-90,20},{-90,-20},{-82,-20}},
                                                                  color={255,0,255}));
  connect(dowPul.y, dow.u2) annotation (Line(points={{-108,-60},{-100,-60},{-100,
          -68},{-82,-68}},
                      color={255,0,255}));
  connect(up.y, idxSta.u1Up) annotation (Line(points={{-58,-20},{-50,-20},{-50,42},
          {-42,42}},     color={255,0,255}));
  connect(dow.y, idxSta.u1Dow) annotation (Line(points={{-58,-60},{-48,-60},{-48,
