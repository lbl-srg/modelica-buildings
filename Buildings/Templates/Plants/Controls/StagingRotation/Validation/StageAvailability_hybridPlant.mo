...
model StageAvailability_hybridPlant
  ...
  Buildings.Templates.Plants.Controls.StagingRotation.StageAvailability_hybridPlant
                                                                        avaStaEqu(nSta=3,
      nEqu=3)
...
equation
  ...
  annotation (
    __Dymola_Commands(
      file=
        "modelica://Buildings/Resources/Scripts/Dymola/Templates/Plants/Controls/StagingRotation/Validation/StageAvailability_hybridPlant.mos"
        "Simulate and plot"),
    experiment(
      StopTime=7.0,
      Tolerance=1e-06),
