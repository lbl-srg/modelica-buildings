...
block UpdateEnableState
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1[nEqu]
    "Raw enable signal" annotation (Placement(transformation(extent={{-140,40},{
            -100,80}}), iconTransformation(extent={{-140,-20},{-100,20}})));
  Buildings.Controls.OBC.CDL.Interfaces.IntegerInput n "Number of equipment"
    annotation (Placement(transformation(extent={{-140,-60},{-100,-20}}),
        iconTransformation(extent={{-140,60},{-100,100}})));
equation
  connect(y1Pre.y,logSwi. u3)
    annotation (Line(points={{48,0},{40,0},{40,52},{48,52}},        color={255,0,255}));
  connect(booScaRep.y,logSwi. u2)
    annotation (Line(points={{22,0},{34,0},{34,60},{48,60}},      color={255,0,255}));
  ...
  connect(intGre.y,swiEna. u2)
    annotation (Line(points={{-58,-40},{-50,-40},{-50,-8},{-32,-8}},color={255,0,255}));
  ...
  connect(logSwi.y, y1) annotation (Line(points={{72,60},{80,60},{80,0},{120,0}},
        color={255,0,255}));
  connect(u1, logSwi.u1) annotation (Line(points={{-120,60},{20,60},{20,68},{48,
          68}}, color={255,0,255}));
  connect(uSta, cha.u)
    annotation (Line(points={{-120,0},{-82,0}}, color={255,127,0}));
  connect(n, intGre.u1)
    annotation (Line(points={{-120,-40},{-82,-40}}, color={255,127,0}));
  connect(u1Ava, isEnaPreAva.u2) annotation (Line(points={{-120,-80},{40,-80},{40,
          -68},{32,-68}}, color={255,0,255}));
  connect(y1Pre.y, isEnaPreAva.u1) annotation (Line(points={{48,0},{40,0},{40,-60},
          {32,-60}}, color={255,0,255}));
  connect(nEnaAvaPre.y, intGre.u2) annotation (Line(points={{-32,-60},{-90,-60},
          {-90,-48},{-82,-48}}, color={255,127,0}));
