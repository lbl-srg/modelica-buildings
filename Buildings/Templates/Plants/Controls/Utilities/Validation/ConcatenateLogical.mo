...
model ConcatenateLogical
  ...
  Buildings.Templates.Plants.Controls.Utilities.ConcatenateLogical cat0(
    new=fill(true, 0),
    nin=2)
...
equation
  connect(con.y, catApp.u1)
    annotation(Line(points={{-38,0},{-12,0}},
      color={255,0,255}));
  connect(con.y, cat0.u1[1:6])
    annotation(Line(points={{-38,0},{-20,0},{-20,40.8333},{-12,40.8333}},
      color={255,0,255}));
  connect(con.y, catPre.u1[1:6])
    annotation(Line(points={{-38,0},{-20,0},{-20,-39.1667},{-12,-39.1667}},
      color={255,0,255}));
