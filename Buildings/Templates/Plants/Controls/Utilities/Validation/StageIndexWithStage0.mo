...
model StageIndexWithStage0
  ...
  Buildings.Templates.Plants.Controls.Utilities.StageIndexWithStage0 idxSta(
      have_inpAva=false, final nSta=nSta)
  ...
  Buildings.Templates.Plants.Controls.Utilities.StageIndexWithStage0
    idxStaUna(final nSta=nSta)
...
equation
  connect(ena.y, idxSta.u1) annotation (Line(points={{-68,60},{0,60},{0,66},{18,
          66}}, color={255,0,255}));
  connect(ena.y, idxStaUna.u1) annotation (Line(points={{-68,60},{0,60},{0,36},{
          60,36}}, color={255,0,255}));
  connect(ena.y, idxStaRun.u1) annotation (Line(points={{-68,60},{0,60},{0,-24},
          {18,-24}}, color={255,0,255}));
  connect(u1AvaSta.y, idxStaUna.u1AvaSta)
    annotation (Line(points={{-68,-80},{50,-80},{50,24},{60,24}},color={255,0,255}));
  connect(ena.y, idxStaRunUna.u1) annotation (Line(points={{-68,60},{0,60},{0,-54},
          {58,-54}}, color={255,0,255}));
  ...
  annotation (
    __Dymola_Commands(
      file=
        "modelica://Buildings/Resources/Scripts/Dymola/Templates/Plants/Controls/Utilities/Validation/StageIndexWithStage0.mos"
        "Simulate and plot"),
    experiment(
      StopTime=160.0,
      Tolerance=1e-06),
...
<a href=\"modelica://Buildings.Templates.Plants.Controls.Utilities.StageIndexWithStage0\">
Buildings.Templates.Plants.Controls.Utilities.StageIndexWithStage0</a>.
</p>
</html>",
      revisions="<html>
<ul>
