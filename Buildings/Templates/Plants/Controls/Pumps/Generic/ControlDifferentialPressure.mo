...
block ControlDifferentialPressure
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.PIDWithEnable ctlDpRem[nSenDpRem](
    each final k=k,
    each final Ti=Ti,
    each r=dpSca,
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.PIDWithEnable ctlDpLoc(
    final k=k,
    final Ti=Ti,
    final r=dpSca,
    final yMin=y_min,
