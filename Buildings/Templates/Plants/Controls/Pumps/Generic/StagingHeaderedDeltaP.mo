...
block StagingHeaderedDeltaP
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset timHigV(final t=
        dtRun)
    "Return true if stage up condition is true for specified duration"
    annotation (Placement(transformation(extent={{10,50},{30,70}})));
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset timLowV(final t=
        dtRun)
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset timHigY(final t=dtRunFaiSaf)
                                                     "Timer"
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset timLowDp[nSenDp](each final t=dtRunFaiSaf)
                                                                 "Timer"
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset timLowY(final t=dtRunFaiSafLowY)
                                                     "Timer"
    annotation (Placement(transformation(extent={{-70,-70},{-50,-50}})));
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset timHigDp[nSenDp](each final t=dtRunFaiSaf)
                                                                 "Timer"
