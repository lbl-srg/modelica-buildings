...
block VariableSpeedNoDpControl
  ...
  parameter Boolean have_pumHeaWatPri(start=false)
    ...
    annotation (Evaluate=true, Dialog(group="Plant configuration", enable=have_heaWat));
  parameter Boolean have_pumChiWatPri(start=false)
    "Set to true for plants with separate primary CHW pumps"
    annotation (Evaluate=true, Dialog(group="Plant configuration", enable=have_chiWat));
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yPumHeaWatPriHdr
    ...
    "Headered primary HW pump speed command" annotation (Placement(
        transformation(extent={{140,80},{180,120}}),iconTransformation(extent={{
            100,40},{140,80}})));
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yPumChiWatPriHdr
    ...
    "Headered primary CHW pump speed command" annotation (Placement(
        transformation(extent={{140,40},{180,80}}),iconTransformation(extent={{100,
            0},{140,40}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yPumHeaWatPriDed[
    nPumHeaWatPri] if have_pumHeaWatPri and not have_pumPriHdr
    "Dedicated primary HW pump speed command" annotation (Placement(
        transformation(extent={{140,-80},{180,-40}}),
                                                    iconTransformation(extent={{
            100,-40},{140,0}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yPumChiWatPriDed[
    nPumChiWatPri] if have_pumChiWatPri and not have_pumPriHdr
    "Dedicated primary CHW pump speed command" annotation (Placement(
        transformation(extent={{140,-120},{180,-80}}),iconTransformation(extent
          ={{100,-80},{140,-40}})));
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant spePumChiWatPri(final k=
        yPumChiWatPriSet) if have_pumChiWatPri "Constant"
  ...
  Buildings.Controls.OBC.CDL.Routing.RealScalarReplicator rep(nout=
        nPumHeaWatPri) if have_pumHeaWatPri "Replicate signal"
    annotation (Placement(transformation(extent={{-60,-30},{-40,-10}})));
  Buildings.Controls.OBC.CDL.Routing.RealScalarReplicator rep1(nout=
        nPumChiWatPri) if have_pumChiWatPri "Replicate signal"
    annotation (Placement(transformation(extent={{-60,-130},{-40,-110}})));
  Buildings.Controls.OBC.CDL.Routing.RealScalarReplicator rep2(nout=
        nPumChiWatPri) if have_pumChiWatPri "Replicate signal"
    annotation (Placement(transformation(extent={{-60,-90},{-40,-70}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant spePumHeaWatPri(final k=
        yPumHeaWatPriSet) if have_pumHeaWatPri "Constant"
  ...
  Buildings.Controls.OBC.CDL.Logical.MultiOr anyPumChiWatPri(nin=nPumChiWatPri)
    if have_pumChiWatPri "Return true if any pump is enabled"
    annotation (Placement(transformation(extent={{-110,-10},{-90,10}})));
  Buildings.Controls.OBC.CDL.Logical.MultiOr anyPumHeaWatPri(nin=nPumHeaWatPri)
    if have_pumHeaWatPri "Return true if any pump is enabled"
    annotation (Placement(transformation(extent={{-110,50},{-90,70}})));

  Buildings.Controls.OBC.CDL.Reals.Switch selSpeHea[nPumHeaWatPri]
    if have_heaWat and not have_pumChiWatPri and not have_pumPriHdr
    "Select prescribed pump speed depending on heating/cooling mode – Case with common CHW and HW dedicated pumps"
    annotation (Placement(transformation(extent={{40,-50},{60,-30}})));
  Buildings.Controls.OBC.CDL.Routing.RealScalarReplicator rep3(nout=
        nPumHeaWatPri) if have_pumHeaWatPri "Replicate signal"
    annotation (Placement(transformation(extent={{-60,20},{-40,40}})));
  Buildings.Controls.OBC.CDL.Routing.RealScalarReplicator rep4(nout=
        nPumHeaWatPri) if have_pumHeaWatPri "Replicate signal"
...
equation
  connect(u1PumChiWatPri, setPumChiWatPriDed.u2) annotation (Line(points={{-160,0},
          {-126,0},{-126,-100},{108,-100}}, color={255,0,255}));
  connect(setPumChiWatPriDed.y, yPumChiWatPriDed)
    annotation (Line(points={{132,-100},{160,-100}},
                                                  color={0,0,127}));
  connect(setPumHeaWatPriDed.y, yPumHeaWatPriDed)
    annotation (Line(points={{132,-60},{160,-60}},color={0,0,127}));
  connect(zer.y, rep.u) annotation (Line(points={{-88,-80},{-70,-80},{-70,-20},{
          -62,-20}}, color={0,0,127}));
  ...
  connect(setPumChiWatPriHdr.y, yPumChiWatPriHdr)
    annotation (Line(points={{132,60},{160,60}},color={0,0,127}));
  connect(rep2.y, setPumChiWatPriDed.u3) annotation (Line(points={{-38,-80},{-20,
          -80},{-20,-108},{108,-108}},
                                    color={0,0,127}));
  connect(rep1.y, setPumChiWatPriDed.u1) annotation (Line(points={{-38,-120},{80,
          -120},{80,-92},{108,-92}}, color={0,0,127}));
  connect(zer.y, setPumChiWatPriHdr.u3) annotation (Line(points={{-88,-80},{-70,
          -80},{-70,52},{108,52}},color={0,0,127}));
  connect(rep.y, setPumHeaWatPriDed.u3) annotation (Line(points={{-38,-20},{-20,
          -20},{-20,-68},{108,-68}},color={0,0,127}));
  connect(zer.y, setPumHeaWatPriHdr.u3) annotation (Line(points={{-88,-80},{-70,
          -80},{-70,92},{108,92}},color={0,0,127}));
  connect(spePumChiWatPri.y, setPumChiWatPriHdr.u1) annotation (Line(points={{-88,
          -120},{-80,-120},{-80,68},{108,68}},color={0,0,127}));
  connect(u1PumChiWatPri, anyPumChiWatPri.u)
    annotation (Line(points={{-160,0},{-112,0}}, color={255,0,255}));
  connect(u1PumHeaWatPri, anyPumHeaWatPri.u) annotation (Line(points={{-160,60},
          {-136,60},{-136,60},{-112,60}}, color={255,0,255}));
  connect(anyPumHeaWatPri.y, setPumHeaWatPriHdr.u2) annotation (Line(points={{-88,60},
          {60,60},{60,100},{108,100}},    color={255,0,255}));
  connect(spePumHeaWatPri.y, setPumHeaWatPriHdr.u1) annotation (Line(points={{-88,120},
          {40,120},{40,108},{108,108}},     color={0,0,127}));
  connect(anyPumChiWatPri.y, setPumChiWatPriHdr.u2) annotation (Line(points={{-88,0},
          {80,0},{80,60},{108,60}},   color={255,0,255}));
  connect(u1PumHeaWatPri, setPumHeaWatPriDed.u2) annotation (Line(points={{-160,60},
          {-120,60},{-120,-60},{108,-60}},    color={255,0,255}));
  connect(u1Hea, selSpeHea.u2) annotation (Line(points={{-160,-60},{-132,-60},{-132,
          -40},{38,-40}}, color={255,0,255}));
  connect(spePumHeaWatPri.y, rep3.u) annotation (Line(points={{-88,120},{-86,120},
          {-86,122},{-84,122},{-84,30},{-62,30}}, color={0,0,127}));
  connect(rep3.y, selSpeHea.u1) annotation (Line(points={{-38,30},{30,30},{30,-32},
          {38,-32}}, color={0,0,127}));
  connect(rep4.y, selSpeHea.u3) annotation (Line(points={{-8,12},{20,12},{20,-48},
          {38,-48}}, color={0,0,127}));
  connect(spePumChiWatPri.y, rep4.u) annotation (Line(points={{-88,-120},{-80,-120},
          {-80,12},{-32,12}}, color={0,0,127}));
  connect(pla.y, setPumHeaWatPriDed.u1) annotation (Line(points={{92,-40},{100,-40},
