...
block VariableSpeed "Variable speed primary pumps"
  ...
  parameter Real kCtlDpHeaWat(
    ...
    annotation (Dialog(group="Control gains", enable=have_heaWat and have_pumPriCtlDp));
  ...
  parameter Real kCtlDpChiWat(
    ...
    annotation (Dialog(group="Control gains", enable=have_chiWat and have_pumPriCtlDp));
  parameter Real TiCtlDpChiWat(
    ...
    annotation (Dialog(group="Control gains", enable=have_chiWat and have_pumPriCtlDp));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1PumHeaWatPri[
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1PumChiWatPri[
  ...
  Buildings.Controls.OBC.CDL.Logical.MultiOr anyPumChiWatPri(
    nin=nPumChiWatPri) if have_pumChiWatPri
  ...
  Generic.ControlDifferentialPressure ctlDpHeaWat(
    ...
    if have_heaWat and have_pumPriCtlDp "HW loop ∆p control"
  ...
  Utilities.PlaceholderReal phSpePumHeaWatPri(
    ...
    final u_internal=yPumHeaWatPriSet) if have_heaWat "Replace with fixed speed"
  ...
  Generic.ControlDifferentialPressure ctlDpChiWat(
    ...
    if have_chiWat and have_pumPriCtlDp "CHW loop ∆p control"
    annotation (Placement(transformation(extent={{-60,150},{-40,170}})));
  Utilities.PlaceholderReal phSpePumChiWatPri(
    final have_inp=have_pumPriCtlDp,          final have_inpPh=false, final
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput dpChiWatRemSet[
    ...
    "Remote CHW differential pressure setpoint" annotation (Placement(
        transformation(extent={{-200,20},{-160,60}}), iconTransformation(extent
          ={{-140,-80},{-100,-40}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput dpHeaWatLocSetMax(final unit
      ="Pa") if have_heaWat and have_pumPriCtlDp and not have_senDpHeaWatRemWir
    "Maximum HW local differential pressure setpoint" annotation (Placement(
        transformation(extent={{160,180},{200,220}}), iconTransformation(extent
          ={{100,100},{140,140}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput dpChiWatLocSetMax(final unit
      ="Pa") if have_chiWat and have_pumPriCtlDp and not have_senDpChiWatRemWir
    "Maximum CHW local differential pressure setpoint" annotation (Placement(
        transformation(extent={{160,140},{200,180}}), iconTransformation(extent
          ={{100,60},{140,100}})));
equation
  connect(u1PumChiWatPri, setPumChiWatPriDed.u2)
    annotation (Line(points={{-180,-80},{-58,-80},{-58,-180},{128,-180}},
                                                                       color={255,0,255}));
  ...
  connect(rep2.y, setPumChiWatPriDed.u3)
    annotation (Line(points={{32,-200},{120,-200},{120,-188},{128,-188}},
                                                                        color={0,0,127}));
  connect(rep1.y, setPumChiWatPriDed.u1)
    annotation (Line(points={{32,-160},{120,-160},{120,-172},{128,-172}},
                                                                      color={0,0,127}));
  ...
  connect(u1PumChiWatPri, anyPumChiWatPri.u)
    annotation (Line(points={{-180,-80},{-58,-80},{-58,60},{-52,60}},
                                                color={255,0,255}));
  connect(u1PumHeaWatPri, anyPumHeaWatPri.u)
    annotation (Line(points={{-180,-60},{-60,-60},{-60,100},{-52,100}},
                                                                      color={255,0,255}));
  ...
  connect(phSpePumHeaWatPri.y, setPumHeaWatPriHdr.u1) annotation (Line(points={{-8,200},
          {120,200},{120,108},{128,108}},         color={0,0,127}));
  connect(phSpePumHeaWatPri.y, rep3.u) annotation (Line(points={{-8,200},{2,200},
          {2,-40},{8,-40}},          color={0,0,127}));
  connect(ctlDpChiWat.y, phSpePumChiWatPri.u)
    annotation (Line(points={{-38,160},{-32,160}}, color={0,0,127}));
  connect(phSpePumChiWatPri.y, setPumChiWatPriHdr.u1) annotation (Line(points={{-8,160},
          {110,160},{110,68},{128,68}},           color={0,0,127}));
  connect(phSpePumChiWatPri.y, rep1.u) annotation (Line(points={{-8,160},{0,160},
          {0,-160},{8,-160}},          color={0,0,127}));
  connect(u1PumHeaWatPri_actual, ctlDpHeaWat.y1_actual) annotation (Line(points={{-180,
          200},{-150,200},{-150,208},{-62,208}},        color={255,0,255}));
  connect(u1Hea, u1Coo.u) annotation (Line(points={{-180,-160},{-155,-160},{-155,
          -140},{-152,-140}},
                       color={255,0,255}));
  connect(u1Coo.y, u1CooAndOn.u2) annotation (Line(points={{-128,-140},{-120,-140},
          {-120,-120},{-150,-120},{-150,140},{-142,140}},
                                                    color={255,0,255}));
  connect(u1PumHeaWatPri_actual, u1CooAndOn.u1) annotation (Line(points={{-180,
          200},{-150,200},{-150,148},{-142,148}},
                                             color={255,0,255}));
  connect(u1PumChiWatPri_actual, phPumChiWatPriSta.u)
    annotation (Line(points={{-180,180},{-142,180}}, color={255,0,255}));
  connect(u1CooAndOn.y, phPumChiWatPriSta.uPh) annotation (Line(points={{-118,
          148},{-116,148},{-116,166},{-144,166},{-144,174},{-142,174}}, color={
          255,0,255}));
  connect(phPumChiWatPriSta.y, ctlDpChiWat.y1_actual) annotation (Line(points={
          {-118,180},{-80,180},{-80,168},{-62,168}}, color={255,0,255}));
  connect(phSpePumChiWatPri.y, rep4.u) annotation (Line(points={{-8,160},{0,160},
          {0,-100},{8,-100}},color={0,0,127}));
  connect(dpHeaWatRemSet, ctlDpHeaWat.dpRemSet) annotation (Line(points={{-180,
          120},{-100,120},{-100,204},{-62,204}}, color={0,0,127}));
  connect(dpHeaWatRem, ctlDpHeaWat.dpRem) annotation (Line(points={{-180,100},{
          -96,100},{-96,200},{-62,200}}, color={0,0,127}));
  connect(dpHeaWatLocSet, ctlDpHeaWat.dpLocSet) annotation (Line(points={{-180,
          80},{-92,80},{-92,196},{-62,196}}, color={0,0,127}));
  connect(dpHeaWatLoc, ctlDpHeaWat.dpLoc) annotation (Line(points={{-180,60},{
          -88,60},{-88,192},{-62,192}}, color={0,0,127}));
  connect(dpChiWatRemSet, ctlDpChiWat.dpRemSet) annotation (Line(points={{-180,
          40},{-80,40},{-80,164},{-62,164}}, color={0,0,127}));
  connect(dpChiWatRem, ctlDpChiWat.dpRem) annotation (Line(points={{-180,20},{
          -76,20},{-76,160},{-62,160}}, color={0,0,127}));
  connect(dpChiWatLocSet, ctlDpChiWat.dpLocSet) annotation (Line(points={{-180,
          0},{-72,0},{-72,156},{-62,156}}, color={0,0,127}));
  connect(dpChiWatLoc, ctlDpChiWat.dpLoc) annotation (Line(points={{-180,-20},{
          -66,-20},{-66,152},{-62,152}}, color={0,0,127}));
  connect(ctlDpHeaWat.dpLocSetMax, dpHeaWatLocSetMax) annotation (Line(points={
          {-38,196},{-34,196},{-34,186},{140,186},{140,200},{180,200}}, color={
          0,0,127}));
