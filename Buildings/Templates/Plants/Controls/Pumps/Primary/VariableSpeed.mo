...
block VariableSpeed
  ...
  // The parameter nPumChiWatPriInp facilitates connecting to the pump staging
  // block in polyvalent heat pump configurations.
  final parameter Integer nPumChiWatPriInp =
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1PumChiWatPri[nPumChiWatPriInp]
  ...
  Generic.ControlDifferentialPressure ctlDpChiWat(
    ...
    final y_min=if have_pumChiWatPri
      then yPumChiWatPri_min else yPumHeaWatPri_min)
  ...
  Utilities.PlaceholderLogical phPumChiWatPriSta[if have_pumChiWatPri
  then nPumChiWatPri else nPumHeaWatPri](
  ...
  Buildings.Controls.OBC.CDL.Routing.BooleanExtractSignal extPumChiWatPri(
    final nin=nPumChiWatPriInp,
    final nout=nPumChiWatPri,
    extract={i + nPumChiWatPriInp - nPumChiWatPri for i in 1:nPumChiWatPri})
    if have_pumChiWatPri and have_pumPriHdr
    "Filter out placeholder signals"
    annotation(Placement(transformation(extent={{120,-190},{140,-170}})));
equation
  connect(setPumChiWatPriDed.y, yPumChiWatPriDed)
    annotation(Line(points={{192,-180},{220,-180}},
      color={0,0,127}));
  connect(setPumHeaWatPriDed.y, yPumHeaWatPriDed)
    annotation(Line(points={{192,-80},{220,-80}},
      color={0,0,127}));
  connect(zer.y, rep.u)
    annotation(Line(points={{12,-200},{30,-200},{30,-120},{48,-120}},
      color={0,0,127}));
  connect(zer.y, rep2.u)
    annotation(Line(points={{12,-200},{48,-200}},
      color={0,0,127}));
  ...
  connect(rep2.y, setPumChiWatPriDed.u3)
    annotation(Line(points={{72,-200},{160,-200},{160,-188},{168,-188}},
      color={0,0,127}));
  connect(rep1.y, setPumChiWatPriDed.u1)
    annotation(Line(points={{72,-160},{160,-160},{160,-172},{168,-172}},
      color={0,0,127}));
  connect(zer.y, setPumChiWatPriHdr.u3)
    annotation(Line(points={{12,-200},{30,-200},{30,52},{168,52}},
      color={0,0,127}));
  connect(rep.y, setPumHeaWatPriDed.u3)
    annotation(Line(points={{72,-120},{160,-120},{160,-88},{168,-88}},
      color={0,0,127}));
  connect(zer.y, setPumHeaWatPriHdr.u3)
    annotation(Line(points={{12,-200},{30,-200},{30,92},{168,92}},
      color={0,0,127}));
  connect(u1PumChiWatPri, anyPumChiWatPri.u)
    annotation(Line(points={{-220,-80},{-18,-80},{-18,60},{-12,60}},
      color={255,0,255}));
  connect(u1PumHeaWatPri, anyPumHeaWatPri.u)
    annotation(Line(points={{-220,-60},{-20,-60},{-20,100},{-12,100}},
      color={255,0,255}));
  connect(anyPumHeaWatPri.y, setPumHeaWatPriHdr.u2)
    annotation(Line(points={{12,100},{168,100}},
      color={255,0,255}));
  ...
  connect(u1PumHeaWatPri, setPumHeaWatPriDed.u2)
    annotation(Line(
      points={{-220,-60},{-20,-60},{-20,-100},{140,-100},{140,-80},{168,-80}},
      color={255,0,255}));
  connect(rep3.y, selSpeHea.u1)
    annotation(Line(points={{72,-20},{80,-20},{80,-52},{88,-52}},
      color={0,0,127}));
  connect(ph.y, setPumHeaWatPriDed.u1)
    annotation(Line(points={{154,-60},{158,-60},{158,-72},{168,-72}},
      color={0,0,127}));
  connect(selSpeHea.y, ph.u)
    annotation(Line(points={{112,-60},{130,-60}},
      color={0,0,127}));
  ...
  connect(u1PumChiWatPri_actual, phPumChiWatPriSta.u)
    annotation(Line(points={{-220,180},{-120,180},{-120,140},{-52,140}},
      color={255,0,255}));
  connect(phPumChiWatPriSta.y, ctlDpChiWat.y1_actual)
    annotation(Line(points={{-28,140},{-26,140},{-26,172},{-22,172}},
      color={255,0,255}));
  connect(dpHeaWatRemSet, ctlDpHeaWat.dpRemSet)
    annotation(Line(points={{-220,120},{-180,120},{-180,228},{-22,228}},
      color={0,0,127}));
  connect(dpHeaWatRem, ctlDpHeaWat.dpRem)
    annotation(Line(points={{-220,100},{-176,100},{-176,224},{-22,224}},
      color={0,0,127}));
  connect(dpHeaWatLocSet, ctlDpHeaWat.dpLocSet)
    annotation(Line(points={{-220,80},{-172,80},{-172,220},{-22,220}},
      color={0,0,127}));
  connect(dpHeaWatLoc, ctlDpHeaWat.dpLoc)
    annotation(Line(points={{-220,60},{-168,60},{-168,216},{-22,216}},
      color={0,0,127}));
  ...
  connect(u1PumHeaWatPri_actual, u1HeaAndOn.u1)
    annotation(Line(points={{-220,200},{-100,200},{-100,180},{-92,180}},
      color={255,0,255}));
  connect(edgU1AndHea.y, latHea.u)
    annotation(Line(points={{-130,-160},{-122,-160}},
      color={255,0,255}));
  connect(phSpePumChiWatPri.y, setPumChiWatPriHdr.u1)
    annotation(Line(points={{32,140},{40,140},{40,68},{168,68}},
      color={0,0,127}));
  connect(ctlDpHeaWat.y, phSpePumHeaWatPri.u)
    annotation(Line(points={{2,224},{6,224},{6,200},{10,200}},
      color={0,0,127}));
  connect(ctlDpChiWat.y, phSpePumChiWatPri.u)
    annotation(Line(points={{2,164},{6,164},{6,140},{8,140}},
      color={0,0,127}));
  connect(phSpePumHeaWatPri.y, setPumHeaWatPriHdr.u1)
    annotation(Line(points={{34,200},{42,200},{42,108},{168,108}},
      color={0,0,127}));
  connect(phSpePumHeaWatPri.y, rep3.u)
    annotation(Line(points={{34,200},{42,200},{42,-20},{48,-20}},
      color={0,0,127}));
  connect(phSpePumChiWatPri.y, rep4.u)
    annotation(Line(points={{32,140},{40,140},{40,-80},{48,-80}},
      color={0,0,127}));
  connect(u1CooAndOn.y, phPumChiWatPriSta.uPh)
    annotation(Line(points={{-68,120},{-60,120},{-60,134},{-52,134}},
      color={255,0,255}));
  connect(phPumHeaWatPriSta.y, ctlDpHeaWat.y1_actual)
    annotation(Line(points={{-28,200},{-26,200},{-26,232},{-22,232}},
      color={255,0,255}));
  connect(u1HeaAndOn.y, phPumHeaWatPriSta.uPh)
    annotation(Line(points={{-68,180},{-60,180},{-60,194},{-52,194}},
      color={255,0,255}));
  connect(u1PumHeaWatPri_actual, phPumHeaWatPriSta.u)
    annotation(Line(points={{-220,200},{-52,200}},
      color={255,0,255}));
  connect(latCoo.y, u1CooAndOn.u2)
    annotation(Line(points={{-98,-120},{-96,-120},{-96,112},{-92,112}},
      color={255,0,255}));
  connect(latHea.y, selSpeHea.u2)
    annotation(Line(points={{-98,-160},{0,-160},{0,-60},{88,-60}},
      color={255,0,255}));
  connect(latHea.y, u1HeaAndOn.u2)
    annotation(Line(points={{-98,-160},{-98,172},{-92,172}},
      color={255,0,255}));
  connect(phSpePumChiWatPri.y, rep1.u)
    annotation(Line(points={{32,140},{40,140},{40,-160},{48,-160}},
      color={0,0,127}));
  connect(u1PumHeaWatPri_actual, u1CooAndOn.u1)
    annotation(Line(points={{-220,200},{-100,200},{-100,120},{-92,120}},
      color={255,0,255}));
  ...
  connect(edgU1Coo.y, latCoo.u)
    annotation(Line(points={{-130,-120},{-122,-120}},
      color={255,0,255}));
  ...
  connect(edgU1Coo.y, latHea.clr)
    annotation(Line(points={{-130,-120},{-128,-120},{-128,-166},{-122,-166}},
      color={255,0,255}));
  connect(extPumChiWatPri.y, setPumChiWatPriDed.u2)
    annotation(Line(points={{142,-180},{168,-180}},
      color={255,0,255}));
  connect(u1PumChiWatPri, extPumChiWatPri.u)
    annotation(Line(points={{-220,-80},{-18,-80},{-18,-180},{118,-180}},
      color={255,0,255}));
annotation(defaultComponentName="ctlPumPri",
  ...
  Diagram(coordinateSystem(extent={{-200,-240},{200,240}}),
    graphics={Rectangle(extent={{-198,-84},{-22,-218}},
      lineColor={0,0,0},
      fillColor={215,215,215},
      fillPattern=FillPattern.Solid,
      pattern=LinePattern.None),
    Text(extent={{-196,-180},{-60,-200}},
      textColor={0,0,255},
