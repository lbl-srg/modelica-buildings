...
model EnableDedicated
  "Validation model for dedicated primary pump enable logic"
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse y1(
    period=60 * 30)
    "Lead pump enable"
    annotation (Placement(transformation(extent={{-80,30},{-60,50}})));
  Buildings.Templates.Plants.Controls.Pumps.Primary.EnableDedicated enaDed
    "Command dedicated pumps – Without flow request"
    annotation (Placement(transformation(extent={{40,10},{60,30}})));
  Buildings.Templates.Plants.Controls.Pumps.Primary.EnableDedicated enaDedReq(
...
equation
  ...
  annotation (
    __Dymola_Commands(
      file=
        "modelica://Buildings/Resources/Scripts/Dymola/Templates/Plants/Controls/Pumps/Primary/Validation/EnableDedicated.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600.0,
      Tolerance=1e-06),
...
Buildings.Templates.Plants.Controls.Pumps.Primary.EnableDedicated</a>
