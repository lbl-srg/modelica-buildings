...
block EnableLeadHeadered
  ...
  parameter Buildings.Templates.Plants.Controls.Types.Actuator typValIso=Buildings.Templates.Plants.Controls.Types.Actuator.TwoPosition
    "Type of isolation valve" annotation (Evaluate=true);
