...
equation
  ...
  connect(ctl.y1Hp, y1Hp_actual.y1)
    annotation (Line(points={{72,53},{88,53},{88,60},{98,60}},color={255,0,255}));
  connect(y1Hp_actual.y1_actual, ctl.u1Hp_actual)
    annotation (Line(points={{122,60},{130,60},{130,80},{26,80},{26,46},{28,46}},
      color={255,0,255}));
  connect(ctl.y1PumHeaWatPri, y1PumHeaWatPri_actual1.y1)
    annotation (Line(points={{72,37},{90,37},{90,40},{128,40}},
                                                              color={255,0,255}));
  connect(ctl.y1PumChiWatPri, y1PumChiWatPri_actual.y1)
    annotation (Line(points={{72,35},{90,35},{90,20},{98,20}},color={255,0,255}));
  connect(ctl.y1PumHeaWatSec, y1PumHeaWatSec_actual.y1)
    annotation (Line(points={{72,31},{90,31},{90,0},{128,0}},
                                                            color={255,0,255}));
  connect(ctl.y1PumChiWatSec, y1PumChiWatSec_actual.y1)
    annotation (Line(points={{72,29},{88,29},{88,-20},{98,-20}},color={255,0,255}));
  connect(y1PumHeaWatPri_actual1.y1_actual, ctl.u1PumHeaWatPri_actual)
    annotation (Line(points={{152,40},{164,40},{164,82},{24,82},{24,42},{28,42}},
      color={255,0,255}));
  connect(y1PumHeaWatSec_actual.y1_actual, ctl.u1PumHeaWatSec_actual)
    annotation (Line(points={{152,0},{168,0},{168,86},{20,86},{20,34},{28,34}},
      color={255,0,255}));
  connect(y1PumChiWatPri_actual.y1_actual, ctl.u1PumChiWatPri_actual)
    annotation (Line(points={{122,20},{166,20},{166,84},{22,84},{22,40},{28,40}},
      color={255,0,255}));
  connect(y1PumChiWatSec_actual.y1_actual, ctl.u1PumChiWatSec_actual)
    annotation (Line(points={{122,-20},{170,-20},{170,88},{18,88},{18,32},{28,32}},
      color={255,0,255}));
  connect(TOut.y, ctl.TOut)
    annotation (Line(points={{-138,92},{10,92},{10,15.8},{28,15.8}},
                                                                  color={0,0,127}));
  ...
  connect(reqPlaHeaWat.y, ctl.nReqPlaHeaWat)
    annotation (Line(points={{-28,110},{-6,110},{-6,23.8},{28,23.8}},
                                                                   color={255,127,0}));
  connect(reqPlaChiWat.y, ctl.nReqPlaChiWat)
    annotation (Line(points={{-28,70},{-10,70},{-10,21.8},{28,21.8}},
                                                                 color={255,127,0}));
  connect(VHeaWat_flow.y, ctl.VHeaWatPri_flow)
    annotation (Line(points={{-58,-20},{4,-20},{4,9.8},{28,9.8}},  color={0,0,127}));
  connect(VHeaWat_flow.y, ctl.VHeaWatSec_flow)
    annotation (Line(points={{-58,-20},{4,-20},{4,-4.2},{28,-4.2}},
                                                                 color={0,0,127}));
  connect(VChiWat_flow.y, ctl.VChiWatPri_flow)
    annotation (Line(points={{-28,-40},{6,-40},{6,3.8},{28,3.8}},color={0,0,127}));
  connect(VChiWat_flow.y, ctl.VChiWatSec_flow)
    annotation (Line(points={{-28,-40},{6,-40},{6,-12.2},{28,-12.2}},
                                                                   color={0,0,127}));
  ...
  connect(reqResHeaWat.y, ctl.nReqResHeaWat)
    annotation (Line(points={{-28,40},{12,40},{12,19.8},{28,19.8}},
                                                                 color={255,127,0}));
  connect(reqResChiWat.y, ctl.nReqResChiWat)
    annotation (Line(points={{-28,10},{-10,10},{-10,17.8},{28,17.8}},
                                                                 color={255,127,0}));
  connect(sin.y, dpHeaWatRem.u2)
    annotation (Line(points={{-108,-86},{-52,-86}},color={0,0,127}));
  connect(dpChiWatRem.y, ctl.dpChiWatRem)
    annotation (Line(points={{-28,-120},{12,-120},{12,-20.2},{28,-20.2}},
                                                                       color={0,0,127}));
  connect(dpHeaWatRem.y, ctl.dpHeaWatRem)
    annotation (Line(points={{-28,-80},{10,-80},{10,-14.2},{28,-14.2}},
                                                                     color={0,0,127}));
  connect(ctl.dpHeaWatRemSet, dpHeaWatRem.u1)
    annotation (Line(points={{72,5},{80,5},{80,-60},{-70,-60},{-70,-74},{-52,-74}},
      color={0,0,127}));
  connect(ctl.dpChiWatRemSet, dpChiWatRem.u1)
    annotation (Line(points={{72,3},{78,3},{78,-100},{-60,-100},{-60,-114},{-52,
          -114}},
      color={0,0,127}));
  ...
  connect(ctl.dpHeaWatRemSet, resDpHeaWatLoc.dpRemSet)
    annotation (Line(points={{72,5},{80,5},{80,-60},{-70,-60},{-70,-134},{-12,-134}},
      color={0,0,127}));
  ...
  connect(ctl.dpChiWatRemSet, resDpChiWatLoc.dpRemSet)
    annotation (Line(points={{72,3},{77.9167,3},{77.9167,-100},{-60,-100},{-60,-174},
          {-12,-174}},
      color={0,0,127}));
  ...
  connect(resDpChiWatLoc.dpLocSet, ctl.dpChiWatLocSet)
    annotation (Line(points={{11.8,-180},{16,-180},{16,-22.2},{28,-22.2}},
                                                                         color={0,0,127}));
  connect(dpChiWatLoc.y, ctl.dpChiWatLoc)
    annotation (Line(points={{-28,-200},{18,-200},{18,-24.2},{28,-24.2}},
                                                                       color={0,0,127}));
  connect(dpHeaWatLoc.y, ctl.dpHeaWatLoc)
    annotation (Line(points={{-28,-160},{14,-160},{14,-18.2},{28,-18.2}},
                                                                       color={0,0,127}));
  connect(resDpHeaWatLoc.dpLocSet, ctl.dpHeaWatLocSet)
    annotation (Line(points={{11.8,-140},{20,-140},{20,-16.2},{28,-16.2}},
                                                                         color={0,0,127}));
  connect(ctl.y1Hrc, y1Hrc_actual.y1)
    annotation (Line(points={{72,-7},{86,-7},{86,-40},{128,-40}}, color={255,0,255}));
  connect(y1Hrc_actual.y1_actual, ctl.u1Hrc_actual)
    annotation (Line(points={{152,-40},{172,-40},{172,90},{16,90},{16,30},{28,30}},
      color={255,0,255}));
  connect(ctl.TChiWatSupSet, ctl.TChiWatSecSup)
    annotation (Line(points={{72,-5},{74,-5},{74,-30},{-2,-30},{-2,-6.2},{28,-6.2}},
      color={0,0,127}));
  connect(ctl.TChiWatSupSet, ctl.TChiWatPriSup)
    annotation (Line(points={{72,-5},{74,-5},{74,-30},{-2,-30},{-2,7.8},{28,7.8}},
      color={0,0,127}));
  connect(ctl.THeaWatSupSet, ctl.THeaWatPriSup)
    annotation (Line(points={{72,-3},{76,-3},{76,-32},{-4,-32},{-4,13.8},{28,13.8}},
      color={0,0,127}));
  connect(ctl.THeaWatSupSet, ctl.THeaWatSecSup)
    annotation (Line(points={{72,-3},{76,-3},{76,-32},{-4,-32},{-4,1.8},{28,1.8}},
      color={0,0,127}));
  connect(ctl.THeaWatSupSet, THeaWatRet.u1)
    annotation (Line(points={{72,-3},{76,-3},{76,176},{-56,176},{-56,166},{-52,166}},
      color={0,0,127}));
  ...
  connect(ctl.TChiWatSupSet, TChiWatRet.u2)
    annotation (Line(points={{72,-5},{74,-5},{74,126},{-90,126},{-90,134},{-82,134}},
      color={0,0,127}));
  ...
  connect(TChiWatRetUpsHrc.u2, ctl.TChiWatSupSet)
    annotation (Line(points={{-82,174},{-90,174},{-90,126},{74,126},{74,-5},{72,
          -5}},
      color={0,0,127}));
  connect(THeaWatRetUpsHrc.u2, ctl.THeaWatSupSet)
    annotation (Line(points={{-52,194},{-56,194},{-56,176},{76,176},{76,-3},{72,
          -3}},
      color={0,0,127}));
  ...
  connect(THeaWatRet.y, ctl.THeaWatPriRet)
    annotation (Line(points={{-28,160},{4,160},{4,11.8},{28,11.8}},color={0,0,127}));
  connect(THeaWatRet.y, ctl.THeaWatSecRet)
    annotation (Line(points={{-28,160},{4,160},{4,-0.2},{28,-0.2}},
                                                                 color={0,0,127}));
  connect(TChiWatRet.y, ctl.TChiWatSecRet)
    annotation (Line(points={{-58,140},{2,140},{2,-8.2},{28,-8.2}},color={0,0,127}));
  connect(TChiWatRet.y, ctl.TChiWatPriRet)
    annotation (Line(points={{-58,140},{2,140},{2,5.8},{28,5.8}},  color={0,0,127}));
  connect(TChiWatRetUpsHrc.y, ctl.TChiWatRetUpsHrc)
    annotation (Line(points={{-58,180},{0,180},{0,-10.2},{28,-10.2}},
                                                                   color={0,0,127}));
  connect(THeaWatRetUpsHrc.y, ctl.THeaWatRetUpsHrc)
    annotation (Line(points={{-28,200},{8,200},{8,-2.2},{28,-2.2}},
                                                                 color={0,0,127}));
  annotation (
    __Dymola_Commands(
      file=
