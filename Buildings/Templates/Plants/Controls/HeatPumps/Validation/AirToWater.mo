...
equation
  connect(ratV_flow.y[1], VHeaWat_flow.u)
    annotation (Line(points={{-138,-140},{-120,-140},{-120,-120},{-112,-120}},
      color={0,0,127}));
  ...
  connect(y1Hp_actual.y1_actual, ctl.u1Hp_actual)
    annotation (Line(points={{52,20},{60,20},{60,40},{-20,40},{-20,16},{-16,16}},
      color={255,0,255}));
  connect(ctl.y1PumHeaWatPri, y1PumHeaWatPri_actual1.y1)
    annotation (Line(points={{16,4},{20,4},{20,0},{58,0}},color={255,0,255}));
  connect(ctl.y1PumChiWatPri, y1PumChiWatPri_actual.y1)
    annotation (Line(points={{16,2},{20,2},{20,-20},{28,-20}},color={255,0,255}));
  connect(ctl.y1PumHeaWatSec, y1PumHeaWatSec_actual.y1)
    annotation (Line(points={{16,-2},{18,-2},{18,-40},{58,-40}},color={255,0,255}));
  connect(ctl.y1PumChiWatSec, y1PumChiWatSec_actual.y1)
    annotation (Line(points={{16,-4},{16,-60},{28,-60}},color={255,0,255}));
  ...
  connect(u1Ava.y,ctl.u1AvaHp)
    annotation (Line(points={{-138,60},{-18,60},{-18,18},{-16,18}},color={255,0,255}));
  connect(TOut.y, ctl.TOut)
    annotation (Line(points={{-138,-20},{-32,-20},{-32,-5.8},{-16,-5.8}},
                                                                     color={0,0,127}));
  connect(ratV_flow.y[1], isDemHea.u)
    annotation (Line(points={{-138,-140},{-120,-140},{-120,40},{-112,40}},color={0,0,127}));
  connect(ratV_flow.y[2], isDemCoo.u)
    annotation (Line(points={{-138,-140},{-120,-140},{-120,0},{-112,0}},color={0,0,127}));
  ...
  connect(reqPlaHeaWat.y, ctl.nReqHeaWat)
    annotation (Line(points={{-58,40},{-40,40},{-40,4},{-16,4}},color={255,127,0}));
  connect(reqPlaChiWat.y, ctl.nReqChiWat)
    annotation (Line(points={{-58,0},{-40,0},{-40,2},{-16,2}},color={255,127,0}));
  connect(THeaWatRet.y, ctl.THeaWatSecRet)
    annotation (Line(points={{-138,-60},{-30,-60},{-30,-15.8},{-16,-15.8}},
                                                                       color={0,0,127}));
  connect(THeaWatRet.y, ctl.THeaWatPriRet)
    annotation (Line(points={{-138,-60},{-30,-60},{-30,-7.8},{-16,-7.8}},
                                                                     color={0,0,127}));
  connect(TChiWatRet.y, ctl.TChiWatSecRet)
    annotation (Line(points={{-138,-100},{-28,-100},{-28,-20},{-16,-20}},
      color={0,0,127}));
  connect(TChiWatRet.y, ctl.TChiWatPriRet)
    annotation (Line(points={{-138,-100},{-28,-100},{-28,-11.8},{-16,-11.8}},
                                                                       color={0,0,127}));
  connect(VHeaWat_flow.y, ctl.VHeaWatPri_flow)
    annotation (Line(points={{-88,-120},{-26,-120},{-26,-9.8},{-16,-9.8}},
                                                                      color={0,0,127}));
  connect(VHeaWat_flow.y, ctl.VHeaWatSec_flow)
    annotation (Line(points={{-88,-120},{-26,-120},{-26,-18},{-16,-18}},
      color={0,0,127}));
  connect(VChiWat_flow.y, ctl.VChiWatPri_flow)
    annotation (Line(points={{-58,-140},{-24,-140},{-24,-13.8},{-16,-13.8}},
                                                                        color={0,0,127}));
  connect(VChiWat_flow.y, ctl.VChiWatSec_flow)
    annotation (Line(points={{-58,-140},{-24,-140},{-24,-18},{-16,-18},{-16,-22}},
      color={0,0,127}));
  connect(ratV_flow.y, gai.u) annotation (Line(points={{-138,-140},{-120,-140},
          {-120,-40},{-110,-40}}, color={0,0,127}));
  connect(gai[1].y, reqResHeaWat.u)
    annotation (Line(points={{-86,-40},{-82,-40}}, color={0,0,127}));
  connect(gai[2].y, reqResChiWat.u) annotation (Line(points={{-86,-40},{-84,-40},
          {-84,-80},{-82,-80}}, color={0,0,127}));
  connect(reqResHeaWat.y, ctl.uReqResHeaWat) annotation (Line(points={{-58,-40},
          {-38,-40},{-38,0},{-16,0}}, color={255,127,0}));
  connect(reqResChiWat.y, ctl.uReqResChiWat) annotation (Line(points={{-58,-80},
          {-36,-80},{-36,-2},{-16,-2}}, color={255,127,0}));
  annotation (
    __Dymola_Commands(
      file=
