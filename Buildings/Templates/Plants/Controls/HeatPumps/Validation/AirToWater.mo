...
model AirToWater
  ...
  Buildings.Templates.Plants.Controls.HeatPumps.AirToWater ctl(
    ...
    "Plant controller"
    annotation(Placement(transformation(extent={{0,-24},{40,60}})));
...
equation
  ...
  connect(reqPlaHeaWat.y, ctl.nReqPlaHeaWat)
    annotation(Line(points={{-58,110},{-40,110},{-40,26},{-2,26}},
      color={255,127,0}));
  connect(reqPlaChiWat.y, ctl.nReqPlaChiWat)
    annotation(Line(points={{-58,70},{-40,70},{-40,24},{-2,24}},
      color={255,127,0}));
  connect(VHeaWat_flow.y, ctl.VHeaWatPri_flow)
    annotation(Line(points={{-88,-20},{-26,-20},{-26,12},{-2,12}},
      color={0,0,127}));
  ...
  connect(VChiWat_flow.y, ctl.VChiWatPri_flow)
    annotation(Line(points={{-58,-40},{-24,-40},{-24,6},{-2,6}},
      color={0,0,127}));
  connect(VChiWat_flow.y, ctl.VChiWatSec_flow)
    annotation(Line(points={{-58,-40},{-22,-40},{-22,-10},{-2,-10}},
      color={0,0,127}));
  ...
  connect(reqResHeaWat.y, ctl.nReqResHeaWat)
    annotation(Line(points={{-58,40},{-42,40},{-42,22},{-2,22}},
      color={255,127,0}));
  connect(reqResChiWat.y, ctl.nReqResChiWat)
    annotation(Line(points={{-58,10},{-40,10},{-40,20},{-2,20}},
      color={255,127,0}));
  connect(sin.y, dpHeaWatRem.u2)
    annotation(Line(points={{-138,-86},{-82,-86}},
      color={0,0,127}));
  connect(dpChiWatRem.y, ctl.dpChiWatRem)
    annotation(Line(points={{-58,-120},{-18,-120},{-18,-18},{-2,-18}},
      color={0,0,127}));
  connect(dpHeaWatRem.y, ctl.dpHeaWatRem)
    annotation(Line(points={{-58,-80},{-20,-80},{-20,-12},{-2,-12}},
      color={0,0,127}));
  connect(ctl.dpHeaWatRemSet, dpHeaWatRem.u1)
    annotation(Line(
      points={{42,-1.09091},{50,-1.09091},{50,-60},{-100,-60},{-100,-74},{-82,-74}},
      color={0,0,127}));
  connect(ctl.dpChiWatRemSet, dpChiWatRem.u1)
    annotation(Line(
      points={{42,-3},{48,-3},{48,-100},{-90,-100},{-90,-114},{-82,-114}},
      color={0,0,127}));
  ...
  connect(ctl.dpHeaWatRemSet, resDpHeaWatLoc.dpRemSet)
    annotation(Line(
      points={{42,-1.09091},{50,-1.09091},{50,-60},{-100,-60},{-100,-134},{-42,-134}},
      color={0,0,127}));
  ...
  connect(ctl.dpChiWatRemSet, resDpChiWatLoc.dpRemSet)
    annotation(Line(
      points={{42,-3},{47.9167,-3},{47.9167,-100},{-90,-100},{-90,-174},{-42,-174}},
      color={0,0,127}));
  ...
  connect(resDpChiWatLoc.dpLocSet, ctl.dpChiWatLocSet)
    annotation(Line(points={{-18.2,-180},{-14,-180},{-14,-20},{-2,-20}},
      color={0,0,127}));
  connect(dpChiWatLoc.y, ctl.dpChiWatLoc)
    annotation(Line(points={{-58,-200},{-12,-200},{-12,-22},{-2,-22}},
      color={0,0,127}));
  connect(dpHeaWatLoc.y, ctl.dpHeaWatLoc)
    annotation(Line(points={{-58,-160},{-16,-160},{-16,-16},{-2,-16}},
      color={0,0,127}));
  connect(resDpHeaWatLoc.dpLocSet, ctl.dpHeaWatLocSet)
    annotation(Line(points={{-18.2,-140},{-10,-140},{-10,-14},{-2,-14}},
      color={0,0,127}));
  connect(ctl.y1Hrc, y1Hrc_actual.y1)
    annotation(Line(points={{42,-12},{56,-12},{56,-140},{98,-140}},
      color={255,0,255}));
  connect(y1Hrc_actual.y1_actual, ctl.u1Hrc_actual)
    annotation(Line(
      points={{122,-140},{160,-140},{160,90},{-14,90},{-14,32},{-2,32}},
      color={255,0,255}));
  connect(ctl.TChiWatSupSet, ctl.TChiWatSecSup)
    annotation(Line(points={{42,-10.6364},{42,-32},{-32,-32},{-32,-4},{-2,-4}},
      color={0,0,127}));
  connect(ctl.TChiWatSupSet, ctl.TChiWatPriSup)
    annotation(Line(points={{42,-10.6364},{42,-32},{-32,-32},{-32,10},{-2,10}},
      color={0,0,127}));
  connect(ctl.THeaWatSupSet, ctl.THeaWatPriSup)
    annotation(Line(
      points={{42,-8.72727},{46,-8.72727},{46,-36},{-34,-36},{-34,16},{-2,16}},
      color={0,0,127}));
  connect(ctl.THeaWatSupSet, ctl.THeaWatSecSup)
    annotation(Line(
      points={{42,-8.72727},{46,-8.72727},{46,-34},{-34,-34},{-34,4},{-2,4}},
      color={0,0,127}));
  connect(ctl.THeaWatSupSet, THeaWatRet.u1)
    annotation(Line(
      points={{42,-8.72727},{46,-8.72727},{46,176},{-86,176},{-86,166},{-82,166}},
      color={0,0,127}));
  ...
  connect(ctl.TChiWatSupSet, TChiWatRet.u2)
    annotation(Line(
      points={{42,-10.6364},{42,126},{-120,126},{-120,134},{-112,134}},
      color={0,0,127}));
  ...
  connect(TChiWatRetUpsHrc.u2, ctl.TChiWatSupSet)
    annotation(Line(
      points={{-112,174},{-120,174},{-120,126},{44,126},{44,-10.6364},{42,-10.6364}},
      color={0,0,127}));
  connect(THeaWatRetUpsHrc.u2, ctl.THeaWatSupSet)
    annotation(Line(
      points={{-82,194},{-86,194},{-86,176},{46,176},{46,-8.72727},{42,-8.72727}},
      color={0,0,127}));
  ...
  connect(THeaWatRet.y, ctl.THeaWatPriRet)
    annotation(Line(points={{-58,160},{-26,160},{-26,14},{-2,14}},
      color={0,0,127}));
  ...
  connect(TChiWatRetUpsHrc.y, ctl.TChiWatRetUpsHrc)
    annotation(Line(points={{-88,180},{-30,180},{-30,-8},{-2,-8}},
      color={0,0,127}));
  connect(THeaWatRetUpsHrc.y, ctl.THeaWatRetUpsHrc)
    annotation(Line(points={{-58,200},{-22,200},{-22,0},{-2,0}},
      color={0,0,127}));
  connect(ctl.y1PumChiWatPriDedHp, y1PumChiWatPriDedHp_actual.y1)
    annotation(Line(points={{42,26},{62,26},{62,-60},{98,-60}},
      color={255,0,255}));
  connect(ctl.y1PumChiWatPriHdr, y1PumChiWatPriHdr_actual.y1)
    annotation(Line(points={{42,28},{62,28},{62,-40},{68,-40}},
      color={255,0,255}));
