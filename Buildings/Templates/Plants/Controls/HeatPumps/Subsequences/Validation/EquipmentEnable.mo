...
model EquipmentEnable
  ...
  PolyvalentHeatPumps.ExtractStagingMatrix extractStagingMatrix2D(
...
<p>
  ...
  large equally sized units (component <code>equEnaOneTwo</code>). Only the
  units of the same size are lead/lag alternated.
</p>
</html>",
    revisions="<html>
<ul>
