...
model AirToWater
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.TimeTable intTimTab(
    ...
    period=1E10)
    "Load model operating mode index"
...
equation
  ...
  connect(mChiWat_flow.port_b, dpChiWatRem[1].port_b)
    annotation (Line(points={{160,-70},{160,-80},{40,-80},{40,-70}},  color={0,127,255}));
  connect(mHeaWat_flow.port_b, dpHeaWatRem[1].port_b)
    annotation (Line(points={{160,-130},{160,-140},{40,-140},{40,-130}},color={0,127,255}));
  ...
  connect(pipHeaWat.port_b, pla.port_aHeaWat)
    annotation (Line(points={{-10,-140},{-30,-140},{-30,-98},{-40,-98}},  color={0,127,255}));
  connect(pipChiWat.port_b, pla.port_aChiWat)
    annotation (Line(points={{-10,-80},{-20,-80},{-20,-84},{-40,-84}},    color={0,127,255}));
  connect(mChiWat_flow.port_b, pipChiWat.port_a)
    annotation (Line(points={{160,-70},{160,-80},{10,-80}},  color={0,127,255}));
  connect(mHeaWat_flow.port_b, pipHeaWat.port_a)
    annotation (Line(points={{160,-130},{160,-140},{10,-140}},color={0,127,255}));
  ...
  connect(dpChiWatRem.p_rel, busPla.dpChiWatRem)
    annotation (Line(points={{31,-60},{20.5,-60},{20.5,-20},{-80,-20}},color={0,0,127}),
  ...
  connect(dpHeaWatRem.p_rel, busPla.dpHeaWatRem)
    annotation (Line(points={{31,-120},{18,-120},{18,-22},{-80,-22},{-80,-20}},
      color={0,0,127}),Text(string="%second",index=1,extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(pla.port_bChiWat, loaCoo.port_a) annotation (Line(points={{-40,-76},{-20,
          -76},{-20,-40},{80,-40}}, color={0,127,255}));
  connect(loaCoo.port_b, mChiWat_flow.port_a) annotation (Line(points={{100,-40},
          {160,-40},{160,-50}}, color={0,127,255}));
  connect(dpChiWatRem[1].port_a, loaCoo.port_a)
    annotation (Line(points={{40,-50},{40,-40},{80,-40}}, color={0,127,255}));
  connect(loaCoo.yVal_actual, reqPlaRes.uCooCoiSet) annotation (Line(points={{102,
          -32},{116,-32},{116,49},{92,49}}, color={0,0,127}));
  connect(loaHea.port_b, mHeaWat_flow.port_a) annotation (Line(points={{100,-100},
          {160,-100},{160,-110}}, color={0,127,255}));
  connect(pla.port_bHeaWat, loaHea.port_a) annotation (Line(points={{-40,-90},{-20,
          -90},{-20,-100},{80,-100}}, color={0,127,255}));
  connect(dpHeaWatRem[1].port_a, loaHea.port_a) annotation (Line(points={{40,-110},
          {40,-100},{80,-100}}, color={0,127,255}));
  connect(ratLoa.y[2], loaCoo.u) annotation (Line(points={{-158,40},{60,40},{60,
          -32},{78,-32}}, color={0,0,127}));
  connect(ratLoa.y[1], loaHea.u) annotation (Line(points={{-158,40},{60,40},{60,
          -92},{78,-92}}, color={0,0,127}));
  connect(loaHea.yVal_actual, reqPlaRes.uHeaCoiSet) annotation (Line(points={{102,
          -92},{120,-92},{120,44},{92,44}}, color={0,0,127}));
  connect(intTimTab.y[1], loaCoo.mode) annotation (Line(points={{-158,0},{56,0},
          {56,-36},{78,-36}}, color={255,127,0}));
  connect(intTimTab.y[1], loaHea.mode) annotation (Line(points={{-158,0},{56,0},
          {56,-96},{78,-96}}, color={255,127,0}));
  annotation (
    __Dymola_Commands(
      file=
