...
model AirToWaterPolyvalent
  ...
  extends Buildings.Templates.Plants.HeatPumps.Validation.AirToWaterReversiblePolyvalent(pla(
      ...
      typArrPumPri_select=Buildings.Templates.Components.Types.PumpArrangement.Headered), ratLoa(
        table=[0,0,0; 5,0,0; 7,1,0; 10,0.5,0.1; 14,0,0.6; 16,0,1; 18,0,0.6; 22,
          0.1,0.1; 24,0,0])                                                             );
