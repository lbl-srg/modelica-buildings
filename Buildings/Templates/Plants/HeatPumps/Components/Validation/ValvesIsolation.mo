...
model ValvesIsolation
  ...
  Buildings.Templates.Plants.HeatPumps.Components.ValvesIsolation valIso(
    ...
    annotation (Placement(transformation(extent={{-120,180},{80,260}})));
  ...
  Controls.OpenLoop ctlHeaInl(final cfg=datCtlHeaInl.cfg, final dat=datCtlHeaInl)
    "Plant controller"
  ...
  Buildings.Templates.Plants.HeatPumps.Interfaces.Bus busPla
    "Plant controller"
    annotation (Placement(iconVisible=false,transformation(extent={{80,-100},{120,
            -60}}),
  ...
  Buildings.Templates.Components.Interfaces.Bus busPumHeaWatPri
    ...
    annotation (Placement(
      iconVisible=false,
      transformation(extent={{80,-250},{120,-210}}),
      iconTransformation(extent={{-466,50},{-426,90}})));
  Buildings.Templates.Components.Interfaces.Bus busPumChiWatPri
    "Primary CHW pump control bus" annotation (Placement(
    iconVisible=false,
    transformation(extent={{100,-270},{140,-230}}), iconTransformation(
...
equation
  connect(retHeaWat.ports[1], valIso.port_aHeaWat)
    annotation (Line(points={{120,120},{-140,120},{-140,256},{-120,256}},
                                                                       color={0,127,255}));
  connect(retChiWat.ports[1], valIso.port_aChiWat)
    annotation (Line(points={{120,232},{80,232}}, color={0,127,255}));
  connect(valIso.port_bChiWat, supChiWat.ports[1])
    annotation (Line(points={{80,248},{150,248}}, color={0,127,255}));
  connect(valIso.port_bHeaWat, supHeaWat.ports[1])
    annotation (Line(points={{-120,240},{-130,240},{-130,140},{150,140}},
                                                                       color={0,127,255}));
  connect(ctl.bus, valIso.bus) annotation (Line(
      points={{-30,280},{-20,280},{-20,260}},
      color={255,204,51},
      thickness=0.5));
  connect(retHeaWat1.ports[1], valIsoHeaInl.port_aHeaWat) annotation (Line(
        points={{120,-60},{-140,-60},{-140,76},{-120,76}},     color={0,127,255}));
  connect(valIsoHeaInl.port_bHeaWat, supHeaWat1.ports[1]) annotation (Line(
        points={{-120,60},{-130,60},{-130,-40},{150,-40}},     color={0,127,255}));
  connect(ctlHeaInl.bus, valIsoHeaInl.bus) annotation (Line(
      points={{-30,100},{-20,100},{-20,80}},
      color={255,204,51},
      thickness=0.5));
  connect(valIso.ports_bChiHeaWatHp, hp.port_a)
    annotation (Line(points={{30,180},{30,160},{-10,160}},
                                                       color={0,127,255}));
  connect(hp.port_b, valIso.ports_aChiHeaWatHp)
    annotation (Line(points={{-30,160},{-70,160},{-70,180}},
                                                          color={0,127,255}));
  connect(valIsoHeaInl.ports_bChiHeaWatHp, hpHea.port_a) annotation (Line(
        points={{30,0},{30,-20},{-10,-20}},     color={0,127,255}));
  connect(hpHea.port_b, valIsoHeaInl.ports_aChiHeaWatHp) annotation (Line(
        points={{-30,-20},{-70,-20},{-70,0}},      color={0,127,255}));
  connect(valIsoSep.port_bHeaWat, supHeaWat2.ports[1]) annotation (Line(points={{-120,
          -120},{-130,-120},{-130,-281},{150,-281}},       color={0,127,255}));
  connect(ctlSep.bus, valIsoSep.bus) annotation (Line(
      points={{-30,-80},{-20,-80},{-20,-100}},
      color={255,204,51},
      thickness=0.5));
  connect(valIsoSep.ports_bChiHeaWatHp, hpSep.port_a) annotation (Line(points={{30,-180},
          {30,-260},{20,-260}},          color={0,127,255}));
  connect(supHeaWat2.ports[2], valIsoSep.port_aHeaWat) annotation (Line(points={{150,
          -279},{150,-270},{-140,-270},{-140,-104},{-120,-104}},      color={0,127,
          255}));
  connect(hpSep.port_b, pumChiWatPri.port_a) annotation (Line(points={{0,-260},{
          -54,-260},{-54,-248}},  color={0,127,255}));
  connect(hpSep.port_b, pumHeaWatPri.port_a) annotation (Line(points={{0,-260},{
          -86,-260},{-86,-234}},  color={0,127,255}));
  connect(ctlSep.bus, busPla) annotation (Line(
      points={{-30,-80},{100,-80}},
      color={255,204,51},
      thickness=0.5));
  connect(busPla.pumHeaWatPri, busPumHeaWatPri) annotation (Line(
      points={{100,-80},{100,-230}},
      color={255,204,51},
      thickness=0.5));
  connect(busPumHeaWatPri.y1, yPumHeaWatPri.u) annotation (Line(
      points={{100,-230},{62,-230}},
      color={255,204,51},
      thickness=0.5));
  connect(yPumHeaWatPri.y, pumHeaWatPri.y) annotation (Line(points={{38,-230},{-20,
          -230},{-20,-224},{-74,-224}},
                                      color={0,0,127}));
  connect(busPla.pumChiWatPri, busPumChiWatPri) annotation (Line(
      points={{100,-80},{120,-80},{120,-250}},
      color={255,204,51},
      thickness=0.5));
  connect(busPumChiWatPri.y1, yPumChiWatPri.u) annotation (Line(
      points={{120,-250},{92,-250}},
      color={255,204,51},
      thickness=0.5));
  connect(yPumChiWatPri.y, pumChiWatPri.y) annotation (Line(points={{68,-250},{-20,
          -250},{-20,-238},{-42,-238}},
                                      color={0,0,127}));
  connect(valIsoSep.port_bChiWat, valIsoSep.port_aChiWat) annotation (Line(
        points={{80,-112},{90,-112},{90,-128},{80,-128}},     color={0,127,255}));
