...
model ValvesIsolation
  ...
  final parameter Buildings.Templates.Components.Types.Valve typValHpInlIso=
    if have_valHpInlIso then Buildings.Templates.Components.Types.Valve.TwoWayTwoPosition
  ...
  final parameter Buildings.Templates.Components.Types.Valve typValHpOutIso=
    if have_valHpOutIso then Buildings.Templates.Components.Types.Valve.TwoWayTwoPosition
    else Buildings.Templates.Components.Types.Valve.None
  ...
  parameter Modelica.Units.SI.PressureDifference dpHeaWatHp_nominal[nHp](
    each final min=0, each start=Buildings.Templates.Data.Defaults.dpHeaWatHp)
  ...
  parameter Modelica.Units.SI.PressureDifference dpBalChiWatHp_nominal[nHp](
    ...
    annotation (Dialog(group="Nominal condition",
      enable=have_chiWat));
  parameter Modelica.Units.SI.PressureDifference dpValveHeaWat_nominal[nHp]=fill(
      Buildings.Templates.Data.Defaults.dpValIso, nHp)
  ...
  parameter Modelica.Units.SI.PressureDifference dpValveChiWat_nominal[nHp](
    each final min=0, each start=0)=fill(Buildings.Templates.Data.Defaults.dpValIso, nHp)
  ...
  // If no isolation valves are used, the fixed resistance is included at HP outlet.
  final parameter Buildings.Templates.Components.Data.Valve datValHeaWatHpOutIso[nHp](
    each typ=typValHpOutIso,
    m_flow_nominal=mHeaWatHp_flow_nominal,
    dpValve_nominal=dpValveHeaWat_nominal,
    dpFixed_nominal=if have_valHpOutIso or not have_valHpOutIso and not have_valHpInlIso
      then dpFixedHeaWat_nominal else fill(0, nHp))
  ...
  final parameter Buildings.Templates.Components.Data.Valve datValChiWatHpOutIso[nHp](
    ...
    dpFixed_nominal=if have_valHpOutIso or not have_valHpOutIso and not have_valHpInlIso
      then dpFixedChiWat_nominal else fill(0, nHp))
...
equation
  ...
  connect(ports_aChiHeaWatHp, valHeaWatHpOutIso.port_a)
    annotation (Line(points={{-100,-200},{-120,-200},{-120,-20},{-160,-20},{-160, -10}},
      color={0,127,255}));
  ...
  connect(ports_aChiWatHp, valChiWatHpOutIso.port_a)
    annotation (Line(points={{-20,-200},{-20,-20},{-80,-20},{-80,-10}}, color={0,127,255}));
  ...
  connect(junHeaWatSup.ports[nHp + 1], port_bHeaWat)
    annotation (Line(points={{-160,110},{-180,110},{-180,200}}, color={0,127,255}));
  ...
  connect(port_bChiWat, junChiWatSup.ports[nHp + 1])
    annotation (Line(points={{-100,200},{-100,110},{-80,110}}, color={0,127,255}));
  ...
  connect(junHeaWatRet.ports[1:nHp], valHeaWatHpInlIso.port_a)
    annotation (Line(points={{80,110},{80,10}},                 color={0,127,255}));
  ...
  connect(busValHeaWatHpInlIso, valHeaWatHpInlIso.bus)
    annotation (Line(points={{60,160},{90,160},{90,0}},  color={255,204,51},thickness=0.5));
  connect(busValChiWatHpInlIso, valChiWatHpInlIso.bus)
    annotation (Line(points={{30,180},{170,180},{170,0}},color={255,204,51},thickness=0.5));
  connect(busValChiWatHpOutIso, valChiWatHpOutIso.bus)
    annotation (Line(points={{-30,180},{-90,180},{-90,0}},  color={255,204,51},thickness=0.5));
  connect(busValHeaWatHpOutIso, valHeaWatHpOutIso.bus)
    annotation (Line(points={{-60,160},{-170,160},{-170,0}},color={255,204,51},thickness=0.5));

  connect(valHeaWatHpInlIso.port_b, ports_bChiHeaWatHp) annotation (Line(points={{80,-10},
          {80,-200},{100,-200}},           color={0,127,255}));
  connect(valChiWatHpInlIso.port_b, ports_bChiHeaWatHp) annotation (Line(points={{160,-10},
          {160,-180},{120,-180},{120,-200},{100,-200}},color={0,127,255}));
  annotation (
    ...
    Line( visible=have_chiWat and nHp >= 1 and have_valHpInlIso,
          ...
          origin={2370,-200},
          rotation=-90),
   Bitmap(visible=typValHpInlIso == Buildings.Templates.Components.Types.Valve.TwoWayTwoPosition
   ...
   Line( visible=have_valHpInlIso and nHp >= 1,
          ...
          origin={2170,-200},
          rotation=-90),
   Bitmap(visible=typValHpOutIso == Buildings.Templates.Components.Types.Valve.TwoWayTwoPosition
   ...
   Rectangle(
    ...
    Bitmap(visible=typValHpInlIso == Buildings.Templates.Components.Types.Valve.TwoWayTwoPosition
          ...
          fileName=
              "modelica://Buildings/Resources/Images/Templates/Components/Actuators/TwoPosition.svg"),
    Bitmap(
          visible=typValHpInlIso == Buildings.Templates.Components.Types.Valve.TwoWayTwoPosition
    ...
    Line( visible=have_valHpInlIso and nHp >= 2,
          ...
          rotation=-90),
    Bitmap(
          visible=typValHpOutIso == Buildings.Templates.Components.Types.Valve.TwoWayTwoPosition
