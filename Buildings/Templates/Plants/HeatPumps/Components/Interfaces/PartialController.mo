...
block PartialController
  ...
  parameter Buildings.Templates.Plants.HeatPumps.Types.PumpsPrimary typPumHeaWatPri(
    ...
    annotation (Evaluate=true,
    Dialog(group="Configuration"));
  final parameter Boolean have_varPumHeaWatPri=typPumHeaWatPri == Buildings.Templates.Plants.HeatPumps.Types.PumpsPrimary.FactoryVariable
    or typPumHeaWatPri == Buildings.Templates.Plants.HeatPumps.Types.PumpsPrimary.Variable
  ...
  parameter Integer nAirHan(
    ...
    annotation (Evaluate=true,
    Dialog(group="Configuration",
      enable=typ==Buildings.Templates.Plants.HeatPumps.Types.Controller.Guideline36));
  ...
  parameter Buildings.Templates.Plants.HeatPumps.Types.PrimaryOverflowMeasurement typMeaCtlHeaWatPri(
    ...
    Dialog(group="Configuration",
      enable=typ==Buildings.Templates.Plants.HeatPumps.Types.Controller.Guideline36
        and typPumHeaWatSec<>Buildings.Templates.Plants.HeatPumps.Types.PumpsSecondary.None
        and (have_varPumHeaWatPriCon or have_varPumHeaWatPriNon)));
  final parameter Boolean have_senVHeaWatPri=if have_varPumHeaWatPri and typPumHeaWatSec <>
    Buildings.Templates.Plants.HeatPumps.Types.PumpsSecondary.None then typMeaCtlHeaWatPri ==
    Buildings.Templates.Plants.HeatPumps.Types.PrimaryOverflowMeasurement.FlowDifference
  ...
  parameter Buildings.Templates.Plants.HeatPumps.Types.SensorLocation locSenVHeaWatPri=
    ...
    Dialog(group="Configuration",
      enable=typ==Buildings.Templates.Plants.HeatPumps.Types.Controller.Guideline36
        and have_senVHeaWatPriCon or have_senVHeaWatPriNon));
  final parameter Boolean have_senVHeaWatSec=typPumHeaWatSec <> Buildings.Templates.Plants.HeatPumps.Types.PumpsSecondary.None
    and typMeaCtlHeaWatPri == Buildings.Templates.Plants.HeatPumps.Types.PrimaryOverflowMeasurement.FlowDifference
  ...
  final parameter Boolean have_senTHeaWatPriSup=if typPumHeaWatSec <> Buildings.Templates.Plants.HeatPumps.Types.PumpsSecondary.None
    then typMeaCtlHeaWatPri == Buildings.Templates.Plants.HeatPumps.Types.PrimaryOverflowMeasurement.TemperatureSupplySensor
    else have_varPumHeaWatPri
    "Set to true for primary HW supply temperature sensor"
    annotation (Evaluate=true,
    Dialog(group="Configuration"));
  final parameter Boolean have_senTHeaWatPlaRet=typPumHeaWatSec == Buildings.Templates.Plants.HeatPumps.Types.PumpsSecondary.None
    "Set to true for plant HW return temperature sensor"
    annotation (Evaluate=true,
    Dialog(group="Configuration"));
  final parameter Boolean have_senTHeaWatSecSup=typPumHeaWatSec <> Buildings.Templates.Plants.HeatPumps.Types.PumpsSecondary.None
    "Set to true for secondary HW supply temperature sensor"
    annotation (Evaluate=true,
    Dialog(group="Configuration"));
  final parameter Boolean have_senTHeaWatSecRet=typPumHeaWatSec <> Buildings.Templates.Plants.HeatPumps.Types.PumpsSecondary.None
