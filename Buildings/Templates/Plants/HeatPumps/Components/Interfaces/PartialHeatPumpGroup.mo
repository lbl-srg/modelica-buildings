...
annotation(Diagram(coordinateSystem(extent={{-200,-200},{200,200}})),
  Icon(coordinateSystem(preserveAspectRatio=false,
    ...
    Line(
          points={{2400,400},{2400,-80},{2200,-80},{2200,0}},
          color={0,0,0},
          thickness=5,
          pattern=LinePattern.Dash,
          visible=nHp + nShc >= 1 and nHp < 1),
    Line(
          points={{1600,400},{1600,-80},{1400,-80},{1400,0}},
          color={0,0,0},
          thickness=5,
          pattern=LinePattern.Dash,
          visible=nHp + nShc >= 2 and nHp < 2),
    Line(
          points={{800,400},{800,-80},{600,-80},{600,0}},
          color={0,0,0},
          thickness=5,
          pattern=LinePattern.Dash,
          visible=nHp + nShc >= 3 and nHp < 3),
    Line(
          points={{0,400},{0,-80},{-200,-80},{-200,0}},
          color={0,0,0},
          thickness=5,
          pattern=LinePattern.Dash,
          visible=nHp + nShc >= 4 and nHp < 4),
    Line(
          points={{-800,400},{-800,-80},{-1000,-80},{-1000,0}},
          color={0,0,0},
          thickness=5,
          pattern=LinePattern.Dash,
          visible=nHp + nShc >= 5 and nHp < 5),
    Line(
          points={{-1600,400},{-1600,-80},{-1800,-80},{-1800,0}},
          color={0,0,0},
          thickness=5,
          pattern=LinePattern.Dash,
          visible=nHp + nShc >= 6 and nHp < 6),
    Line(
          points={{1000,400},{1000,-80},{1200,-80},{1200,0}},
          color={0,0,0},
          thickness=5,
          visible=nHp + nShc >= 2 and nHp < 2),
    Line(
