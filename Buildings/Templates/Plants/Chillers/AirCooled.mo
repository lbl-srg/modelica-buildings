...
equation
  for i in 1:nChi loop
    connect(busWea, souAir[i].weaBus)
      annotation(Line(
  ...
  connect(y1Chi.y, mCon_flow.u)
    annotation(Line(points={{-260,98},{-260,82}},
      color={0,0,127}));
  connect(mCon_flow.y, souAir.m_flow_in)
    annotation(Line(points={{-260,58},{-260,-200},{-90,-200}},
      color={0,0,127}));
  connect(busChi.y1, y1Chi.u)
    annotation(Line(points={{-260,140},{-260,122}},
      color={255,204,51},
      thickness=0.5));
  connect(bus.chi, busChi)
    annotation(Line(points={{-300,200},{-280,200},{-280,140},{-260,140}},
      color={255,204,51},
      thickness=0.5));
annotation(Documentation(
  info="<html>
<p>
  This template represents a chilled water plant with air-cooled compression
  chillers.
</p>
<p>
...
<table summary=\"summary\" border=\"1\">
  ...
  <tr>
    ...
    <td>
      ...
      configurations with series chillers.
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      Waterside economizers are not supported within air-cooled chiller
      plants.
    </td>
  </tr>
  <tr>
