...
model WaterCooledOpenLoop
  ...
  replaceable Buildings.Templates.Plants.Chillers.WaterCooled pla(
    ...
    redeclare replaceable Buildings.Templates.Plants.Chillers.Components.CoolerGroups.CoolingTower coo,
  ...
  Fluid.Sources.PropertySource_T setTChiWatRet(
    use_T_in=true,
...
equation
  ...
  connect(VChiWat_flow.port_a, setTChiWatRet.port_b)
    annotation(Line(points={{60,-40},{80,-40},{80,-30}},
      color={0,127,255}));
  connect(TChiWatRetPre.y, setTChiWatRet.T_in)
...
annotation(experiment(StartTime=19612800,
  ...
  Tolerance=1e-06),
  __Dymola_Commands(
    file="modelica://Buildings/Resources/Scripts/Dymola/Templates/Plants/Chillers/Validation/WaterCooledOpenLoop.mos"
      "Simulate and plot"),
...
<p>
  ...
  physical behavior is not expected. For instance, the coolers are commanded
  at maximum speed which may yield freezing conditions in the CW loop.
</p>
</html>"));
