...
block DistributionControlPoints
  ...
  Plants.Chillers.Interfaces.Bus bus
    ...
    annotation(Placement(transformation(extent={{-20,-20},{20,20}},
      ...
      iconTransformation(extent={{-20,-20},{20,20}},
        ...
        origin={100,0})));
equation
  connect(dpChiWatRem.y, bus.dpChiWatRem)
    annotation(Line(points={{14,0},{100,0}},
      color={0,0,127}),
      Text(string="%second",
        index=1,
        extent={{6,3},{6,3}},
...
annotation(Documentation(
  info="<html>
<p>
  This class generates signals typically yielded by sensors from the CHW
  distribution system. It is aimed for validation purposes only.
</p>
</html>"));
