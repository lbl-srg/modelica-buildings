...
class AllSystemsWaterCooled
  ...
  parameter Buildings.Templates.Plants.Chillers.Data.ChillerPlant pla(
    chi(
      COPChi_nominal=fill(Buildings.Templates.Data.Defaults.COPChiWatCoo,
          pla.cfg.nChi),
      ...
      redeclare Fluid.Chillers.Data.ElectricReformulatedEIR.ReformEIRChiller_Trane_CVHE_1442kW_6_61COP_VSD perChi),
    ctl(
