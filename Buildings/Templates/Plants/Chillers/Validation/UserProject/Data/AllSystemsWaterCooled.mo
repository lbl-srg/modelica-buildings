...
class AllSystemsWaterCooled
  ...
  parameter Buildings.Templates.Plants.Chillers.Data.ChillerPlant pla(
    chi(
      dpChiWatChi_nominal=fill(
        Buildings.Templates.Data.Defaults.dpChiWatChi, pla.cfg.nChi),
      dpConChi_nominal=fill(
        Buildings.Templates.Data.Defaults.dpConWatChi, pla.cfg.nChi),
      perChi(
    ...
    ctl(
      TChiWatSupChi_nominal=fill(
        Buildings.Templates.Data.Defaults.TChiWatSup, pla.cfg.nChi),
      dpChiWatLocSet_min=Buildings.Templates.Data.Defaults.dpChiWatSet_min,
      dpChiWatRemSet_min=fill(
        Buildings.Templates.Data.Defaults.dpChiWatSet_min,
        pla.cfg.nSenDpChiWatRem),
      VChiWatChi_flow_nominal=pla.ctl.capChi_nominal /
      ...
      VConWatChi_flow_nominal=pla.ctl.capChi_nominal * (1 + 1 /
        ...
        pla.cfg.rhoCon_default,
      dTLifChi_min=fill(
        Buildings.Templates.Data.Defaults.dTLifChi_min, pla.cfg.nChi),
      dTLifChi_nominal=pla.ctl.TConWatRetChi_nominal .-
        pla.ctl.TChiWatSupChi_nominal,
      ...
      staPumConWat=if pla.cfg.typEco <>
        ...
        then [0, 0; 1, 0; 1, 0; 1, 1; 1, 1; 1, 1] else [0, 0; 1, 0; 1, 1],
      staCoo=if pla.cfg.typEco <>
        Buildings.Templates.Plants.Chillers.Types.Economizer.None
        then {0, 1, 1, 2, 2, 2} else {0, 1, 2},
      TOutChiWatLck=250,
      TConWatRetChi_nominal=fill(
        Buildings.Templates.Data.Defaults.TConWatRet, pla.cfg.nChi),
      TConWatSupChi_nominal=fill(
        Buildings.Templates.Data.Defaults.TConWatSup, pla.cfg.nChi),
    ...
    coo(
      mAirCoo_flow_nominal=pla.coo.mConWatCoo_flow_nominal /
    ...
    pumConWat(
      dp_nominal=1.5 * (pla.chi.dpConChi_nominal +
        pla.coo.dpConWatFriCoo_nominal + pla.coo.dpConWatStaCoo_nominal)),
    eco(
...
annotation(Documentation(
  info="<html>
<p>
  This class provides system parameters for the validation of water-cooled
  chiller plant models.
</p>
</html>"));
