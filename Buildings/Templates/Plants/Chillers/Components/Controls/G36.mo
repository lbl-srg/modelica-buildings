...
block G36
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Pumps.ChilledWater.Subsequences.LocalDp_setpoint resDpChiWatLoc(
    ...
    k=0.1,
    Ti=60)
    if not cfg.have_senDpChiWatRemWir
...
equation
  ...
  connect(FIXME_uChiWatIsoVal.y, ctl.uChiWatIsoVal)
    annotation(Line(points={{-88,160},{-20,160},{-20,-10},{-2,-10}},
      color={0,0,127}));
  // Controller outputs
  ...
  connect(reqPlaChiWat.y, ctl.chiPlaReq)
    annotation(Line(points={{168,154},{-18,154},{-18,-14},{-2,-14}},
      color={255,127,0}));
  connect(reqResChiWat.y, ctl.TChiWatSupResReq)
    annotation(Line(points={{168,114},{-16,114},{-16,-12},{-2,-12}},
      color={255,127,0}));
  ...
  connect(resDpChiWatLoc.dpChiWatPumSet_local, ctl.dpChiWatSet_local)
    annotation(Line(points={{-38,26},{-2,26}},
      color={0,0,127}));
