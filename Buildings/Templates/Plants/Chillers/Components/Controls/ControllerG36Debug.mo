...
block ControllerG36Debug "Chiller plant controller"
...
public
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant dTLifMin(k=minChiLif)
    "Minimum chiller lift"
    annotation (Placement(transformation(extent={{-1042,-12},{-1022,8}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant dTLifMax(k=max(
        TConWatRet_nominal - TChiWatSupMin)) "Maximum chiller lift"
    annotation (Placement(transformation(extent={{-1042,-52},{-1022,-32}})));
equation
  // DEBUG: Missing connections
  connect(dTLifMin.y, staSetCon.uLifMin);
  connect(dTLifMax.y, staSetCon.uLifMax);
