...
block OpenLoop
  "Open loop controller (output signals only)"
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant yValConWatChiIso[cfg.nChi](
    each k=1)
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.TimeTable y1ValCooInlIso[cfg.nCoo](
    each table=[
      0, 0;
      1, 0;
      1, 1;
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant yValCooInlIso[cfg.nCoo](
    each k=1)
    if cfg.typValCooInlIso == Buildings.Templates.Components.Types.Valve.TwoWayModulating
    "Cooler inlet isolation valve opening signal"
    annotation (Placement(transformation(extent={{-110,-210},{-130,-190}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant yValCooOutIso[cfg.nCoo](
    each k=1)
    if cfg.typValCooOutIso == Buildings.Templates.Components.Types.Valve.TwoWayModulating
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.TimeTable y1Chi[cfg.nChi](
    each table=[
      0, 0;
      1, 0;
      1, 1;
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.TimeTable y1Coo[cfg.nCoo](
    each table=[
      0, 0;
      1, 0;
      1, 1;
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.TimeTable y1ValCooOutIso[cfg.nCoo](
    each table=[
      0, 0;
      1, 0;
      1, 1;
    ...
    each timeScale=1000,
    each period=2000)
    if cfg.typValCooOutIso == Buildings.Templates.Components.Types.Valve.TwoWayTwoPosition
    "Cooler outlet isolation valve opening signal"
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.TimeTable y1ValChiWatChiIso[cfg.nChi](
    each table=[
      0, 0;
      1, 0;
      1, 1;
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.TimeTable y1ValConWatChiIso[cfg.nChi](
    each table=[
      0, 0;
      1, 0;
      1, 1;
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.TimeTable y1PumChiWatPri[cfg.nChi](
    each table=[
      0, 0;
      1, 0;
      1, 1;
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.TimeTable y1PumConWat[cfg.nChi](
    each table=[
      0, 0;
      1, 0;
      1, 1;
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant yValChiWatMinByp(
    k=0)
    "CHW minimum flow bypass valve opening signal"
    annotation (Placement(transformation(extent={{-160,110},{-140,130}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.TimeTable y1ValChiWatChiBypSer[cfg.nChi](
    each table=[
      0, 0;
      1, 0;
      1, 1;
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant yValChiWatEcoByp(
    k=1)
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.TimeTable y1PumChiWatEco(
    ...
    timeScale=1000,
    period=2000)
    "WSE CHW HX pump Start/Stop signal"
...
protected
  ...
  Buildings.Templates.Components.Interfaces.Bus busValChiWatChiBypPar
    if cfg.typArrChi == Buildings.Templates.Plants.Chillers.Types.ChillerArrangement.Parallel
...
equation
  ...
  */
    ...
    connect(busPumChiWatSec, bus.pumChiWatSec)
      annotation (Line(points={{140,20},{160,20},{160,0},{-260,0}},color={255,204,51},thickness=0.5));
  ...
  connect(busPumChiWatPri, bus.pumChiWatPri)
    annotation (Line(points={{140,60},{170,60},{170,0},{-260,0}},color={255,204,51},thickness=0.5));
  ...
  connect(busPumConWat, bus.pumConWat)
    annotation (Line(points={{140,-40},{160,-40},{160,0},{-260,0}},color={255,204,51},thickness=0.5));
  connect(y1PumChiWatPri.y[1], busPumChiWatPri.y1)
    annotation (Line(points={{-138,80},{140,80},{140,60}},color={255,0,255}));
  ...
  connect(y1ValChiWatChiBypSer.y[1], busValChiWatChiBypSer.y1)
    annotation (Line(points={{-122,140},{-180,140},{-180,80},{-240,80}},color={255,0,255}));
  connect(busValChiWatChiBypPar, bus.valChiWatChiByp)
    annotation (Line(points={{140,160},{190,160},{190,0},{-260,0}},color={255,204,51},thickness=0.5));
  connect(y1ValChiWatChiBypPar.y[1], busValChiWatChiBypPar.y1)
    annotation (Line(points={{-138,160},{140,160}},color={255,0,255}));
  connect(busValChiWatMinByp, bus.valChiWatMinByp)
    annotation (Line(points={{140,120},{180,120},{180,0},{-260,0}},color={255,204,51},thickness=0.5));
  connect(yPumChiWatEco.y, busPumChiWatEco.y)
    annotation (Line(points={{-108,-160},{140,-160}},color={0,0,127}));
  ...
  connect(busValChiWatEcoByp, bus.valChiWatEcoByp)
    annotation (Line(points={{140,-100},{170,-100},{170,0},{-260,0}},color={255,204,51},thickness=0.5));
  connect(busValConWatEcoIso, bus.valConWatEcoIso)
    annotation (Line(points={{140,-120},{180,-120},{180,0},{-260,0}},color={255,204,51},thickness=0.5));
  connect(y1ValConWatEcoIso.y[1], busValConWatEcoIso.y1)
    annotation (Line(points={{-98,-120},{140,-120}},color={255,0,255}));
  connect(yPumConWatDed.y, busPumConWat.y)
    annotation (Line(points={{-78,-80},{140,-80},{140,-40}},color={0,0,127}),
  ...
  connect(yPumChiWatPriDed.y, busPumChiWatPri.y)
    annotation (Line(points={{-78,40},{140,40},{140,60}},color={0,0,127}),Text(string=
  ...
  connect(y1Coo.y[1], bus.y1Coo)
    annotation (Line(points={{-2,-260},{-254,-260},{-254,0},{-260,0}},color={255,0,255}),
      Text(string="%second",index=1,extent={{6,3},{6,3}},horizontalAlignment=TextAlignment.Left));
  connect(yCoo.y, bus.yCoo)
    annotation (Line(points={{38,-280},{-256,-280},{-256,0},{-260,0}},color={0,0,127}),
      Text(string="%second",index=1,extent={{6,3},{6,3}},horizontalAlignment=TextAlignment.Left));
  connect(y1ValCooInlIso.y[1], busValCooInlIso.y1)
    annotation (Line(points={{-162,-180},{-200,-180},{-200,-140},{-240,-140}},
      color={255,0,255}));
  connect(y1ValCooOutIso.y[1], busValCooOutIso.y1)
    annotation (Line(points={{-82,-220},{-240,-220},{-240,-180}},color={255,0,255}));
  connect(yValCooInlIso.y, busValCooInlIso.y)
    annotation (Line(points={{-132,-200},{-202,-200},{-202,-146},{-240,-146},{-240,-140}},
      color={0,0,127}));
  connect(yValCooOutIso.y, busValCooOutIso.y)
    annotation (Line(points={{-52,-240},{-244,-240},{-244,-180},{-240,-180}},
      color={0,0,127}));
  connect(y1ValChiWatChiIso.y[1], busValChiWatChiIso.y1)
    annotation (Line(points={{-162,240},{-230,240},{-230,160},{-240,160}},color={255,0,255}));
  connect(yValChiWatChiIso.y, busValChiWatChiIso.y)
    annotation (Line(points={{-132,220},{-226,220},{-226,160},{-240,160}},color={0,0,127}));
  connect(y1ValConWatChiIso.y[1], busValConWatChiIso.y1)
    annotation (Line(points={{-92,200},{-204,200},{-204,120},{-240,120}},color={255,0,255}));
  connect(yValConWatChiIso.y, busValConWatChiIso.y)
    annotation (Line(points={{-62,180},{-200,180},{-200,120},{-240,120}},color={0,0,127}));
  annotation (
