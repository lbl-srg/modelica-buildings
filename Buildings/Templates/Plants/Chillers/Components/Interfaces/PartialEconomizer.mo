...
partial model PartialEconomizer
  "Partial waterside economizer model"
  ...
  parameter Buildings.Templates.Plants.Chillers.Types.Economizer typ
    ...
    annotation(Evaluate=true,
      Dialog(group="Configuration",
        enable=false));
  parameter Buildings.Templates.Plants.Chillers.Components.Data.Economizer dat(
    final typ=typ)
...
annotation(Icon(coordinateSystem(preserveAspectRatio=false,
  extent={{-400,-100},{400,100}})),
  Diagram(coordinateSystem(preserveAspectRatio=false)),
  Documentation(
    info="<html>
<p>
  This partial class provides a standard interface for waterside economizer
  models.
</p>
</html>",
    revisions="<html>
