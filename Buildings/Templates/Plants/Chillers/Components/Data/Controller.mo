...
record Controller
  ...
  parameter Modelica.Units.SI.Temperature TChiWatSup_max(min=260) =
  ...
  parameter Modelica.Units.SI.Temperature TConWatRetChi_nominal[:](
    ...
    annotation(Dialog(group="Temperature setpoints",
      enable=cfg.typCtl ==
        ...
        and cfg.typChi ==
          Buildings.Templates.Components.Types.Chiller.WaterCooled));
  parameter Modelica.Units.SI.Temperature TOutChiWatLck(min=250) =
  ...
  parameter Modelica.Units.SI.PressureDifference dpChiWatRemSet_min[:](
    start=fill(
      Buildings.Templates.Data.Defaults.dpChiWatSet_min, cfg.nSenDpChiWatRem))
  ...
  parameter Modelica.Units.SI.TemperatureDifference dTLifChi_nominal[:](
    min=fill(0, cfg.nChi)) = TConWatRetChi_nominal - TChiWatSupChi_nominal
    ...
    annotation(Dialog(
      ...
      enable=cfg.typCtl ==
        ...
        and (cfg.typChi ==
          Buildings.Templates.Components.Types.Chiller.WaterCooled
          and cfg.have_pumConWatVar)));
  parameter Real yValConWatChiIso_min(max=1, min=0, start=0, unit="1")
  ...
  parameter Real yPumConWat_min(max=1, min=0, start=0.1, unit="1")
    ...
    annotation(Dialog(
      ...
      enable=cfg.typCtl ==
        ...
        and (cfg.typChi ==
          Buildings.Templates.Components.Types.Chiller.WaterCooled
          and cfg.have_pumConWatVar)));
  parameter Real yPumChiWatEco_nominal(max=1, min=0, start=1, unit="1")
    ...
    annotation(Dialog(
      ...
      enable=cfg.typCtl ==
        ...
        and (cfg.typDisChiWat ==
          ...
          or cfg.typDisChiWat ==
            Buildings.Templates.Plants.Chillers.Types.Distribution.Variable1And2Distributed)));
  parameter Real yPumChiWatPri_min(max=1, min=0, start=0.1, unit="1")
    ...
    annotation(Dialog(
      ...
      enable=cfg.typCtl ==
        ...
        and cfg.typDisChiWat ==
          Buildings.Templates.Plants.Chillers.Types.Distribution.Variable1Only));
  parameter Real yPumChiWatSec_min(max=1, min=0, start=0.1, unit="1")
    ...
    annotation(Dialog(
      ...
      enable=cfg.typCtl ==
        ...
        and (cfg.typDisChiWat ==
          ...
          or cfg.typDisChiWat ==
            Buildings.Templates.Plants.Chillers.Types.Distribution.Variable1And2)));
  parameter Real yFanCoo_min(max=1, min=0, start=0.1, unit="1")
  ...
  final parameter Integer nStaChi = size(staChi, 1)
    ...
    annotation(Dialog(group="Plant staging"));
  final parameter Integer nSta = if cfg.typEco <>
    Buildings.Templates.Plants.Chillers.Types.Economizer.None
...
<p>
  ...
  plant controllers that can be found within
