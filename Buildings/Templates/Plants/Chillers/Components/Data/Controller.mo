...
record Controller "Record for plant controller"
  ...
  parameter Modelica.Units.SI.VolumeFlowRate VChiWatPri_flow_nominal(
    ...
    typDisChiWat==Buildings.Templates.Plants.Chillers.Types.Distribution.Variable1And2Distributed) and
    (typMeaCtlChiWatPri==Buildings.Templates.Plants.Chillers.Types.PrimaryOverflowMeasurement.FlowDecoupler or
    typMeaCtlChiWatPri==Buildings.Templates.Plants.Chillers.Types.PrimaryOverflowMeasurement.FlowDifference) or
    typDisChiWat==Buildings.Templates.Plants.Chillers.Types.Distribution.Variable1Only and
  ...
  parameter Modelica.Units.SI.PressureDifference dpChiWatRemSet_nominal[nSenDpChiWatRem](
    ...
    enable=
    typ==Buildings.Templates.Plants.Chillers.Types.Controller.Guideline36 and (
    typDisChiWat==Buildings.Templates.Plants.Chillers.Types.Distribution.Variable1Only or
    typDisChiWat==Buildings.Templates.Plants.Chillers.Types.Distribution.Constant1Variable2  or
  ...
  parameter Modelica.Units.SI.PressureDifference dpChiWatLocSet_nominal(
    ...
    annotation(Dialog(group="Information provided by testing, adjusting, and balancing contractor",
    enable=typ==Buildings.Templates.Plants.Chillers.Types.Controller.Guideline36 and (
    typDisChiWat==Buildings.Templates.Plants.Chillers.Types.Distribution.Variable1Only and
    have_senDpChiWatLoc)));
  ...
  final parameter Integer nUniSta=
    if typEco<>Buildings.Templates.Plants.Chillers.Types.Economizer.None then nChi+1
    else nChi
