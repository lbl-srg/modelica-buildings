...
record Controller
  ...
  parameter Modelica.Units.SI.Temperature TChiWatSup_max(
    ...
    annotation (Dialog(group="Temperature setpoints",
      enable=typ==Buildings.Templates.Plants.Chillers.Types.Controller.G36));
  parameter Modelica.Units.SI.Temperature TConWatRetChi_nominal[nChi](
    each displayUnit="degC",
  ...
  parameter Modelica.Units.SI.VolumeFlowRate VChiWatPri_flow_nominal(
    ...
    annotation (Dialog(group="Capacity",
      enable=typ==Buildings.Templates.Plants.Chillers.Types.Controller.G36 and ((typDisChiWat==Buildings.Templates.Plants.Chillers.Types.Distribution.Variable1And2
        ...
        and (typMeaCtlChiWatPri==Buildings.Templates.Plants.Chillers.Types.PrimaryOverflowMeasurement.FlowDecoupler
        or typMeaCtlChiWatPri==Buildings.Templates.Plants.Chillers.Types.PrimaryOverflowMeasurement.FlowDifference)
  ...
  parameter Modelica.Units.SI.VolumeFlowRate VChiWatSec_flow_nominal[nLooChiWatSec](
    ...
    annotation (Dialog(group="Capacity",
      enable=typ==Buildings.Templates.Plants.Chillers.Types.Controller.G36 and ((typDisChiWat==Buildings.Templates.Plants.Chillers.Types.Distribution.Constant1Variable2
  ...
  parameter Modelica.Units.SI.TemperatureDifference dTAppEco_nominal(
    ...
    annotation (Dialog(group="Waterside economizer design information",
      enable=typ==Buildings.Templates.Plants.Chillers.Types.Controller.G36 and typEco<>Buildings.Templates.Plants.Chillers.Types.Economizer.None));
  ...
  parameter Modelica.Units.SI.VolumeFlowRate VConWatEco_flow_nominal(
    ...
    annotation (Dialog(group="Waterside economizer design information",
      enable=typ==Buildings.Templates.Plants.Chillers.Types.Controller.G36 and typEco==Buildings.Templates.Plants.Chillers.Types.Economizer.HeatExchangerWithValve));
  ...
  final parameter Integer nUniSta=if typEco <> Buildings.Templates.Plants.Chillers.Types.Economizer.None
