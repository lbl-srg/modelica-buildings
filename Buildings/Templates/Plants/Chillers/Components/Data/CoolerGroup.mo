...
record CoolerGroup
  ...
  parameter Modelica.Units.SI.Temperature TAirEnt_nominal(
    ...
    annotation(Dialog(group="Nominal condition",
      enable=typCoo == Buildings.Templates.Components.Types.Cooler.DryCooler));
...
annotation(defaultComponentName="datCoo",
  Documentation(
    info="<html>
<p>
  This record provides the set of sizing and operating parameters for cooler
