...
record ChillerGroup
  ...
  parameter Modelica.Units.SI.PressureDifference dpConChi_nominal[nChi](
    ...
    each start=if typ ==
      ...
      then Buildings.Templates.Data.Defaults.dpAirChi
      else 0)
  ...
  replaceable parameter Buildings.Fluid.Chillers.ModularReversible.Data.TableData2DLoadDep.Generic perChi[nChi](
    ...
    tabLowBou={[
      ...
      TConChi_nominal[i] + 10, TChiWatSupChi_nominal[i] - 2
    ] for i in 1:nChi},
    each devIde="")
...
annotation(defaultComponentName="datChi",
  Documentation(
    info="<html>
<p>
  This record provides the set of sizing and operating parameters for chiller
