...
model StagingMatrixComputation
  ...
  final parameter Integer staMat[nStaChiOnl, nChi](each fixed=false)
  ...
  final parameter Integer nUniSta = if have_eco then nChi + 1 else nChi
...
annotation(experiment(StopTime=1,
  ...
  Documentation(
    info="<html>
<p>
  This model validates the algorithm used to compute the so-called chiller
