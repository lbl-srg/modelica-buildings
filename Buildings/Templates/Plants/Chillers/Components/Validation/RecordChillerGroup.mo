...
model RecordChillerGroup
  ...
  Buildings.Templates.Plants.Chillers.Components.Data.ChillerGroup dat(
    final nChi=2,
    ...
    final dpChiWatChi_nominal=fill(Buildings.Templates.Data.Defaults.dpChiWatChi,
        2),
    final dpConChi_nominal=fill(Buildings.Templates.Data.Defaults.dpConWatChi,
        2),
    final capChi_nominal=fill(1E6, 2),
    final TChiWatSupChi_nominal=fill(Buildings.Templates.Data.Defaults.TChiWatSup,
        2),
    final TConEntChi_nominal=fill(30 + 273.15, 2),
    redeclare
      Buildings.Fluid.Chillers.Data.ElectricReformulatedEIR.ReformEIRChiller_Trane_CVHE_1442kW_6_61COP_VSD
      perChi(
      TConLvg_nominal=dat.TConLvgChi_nominal,
      TConLvgMin=dat.TConLvgChi_min,
      TConLvgMax=dat.TConLvgChi_max,
      QEva_flow_nominal={-1.4E6,-1.3E6},
      capFunT={{5.065247E-01,-4.158206E-03,-2.681976E-03,4.763436E-02,-1.951270E-03,
          3.994399E-03},{6.174861E-01,-7.299051E-02,-1.897105E-03,7.003662E-02,
          -2.852439E-03,5.751931E-03}},
      EIRFunT={{6.175311E-01,-3.913241E-02,6.177961E-04,2.775640E-02,-2.151466E-04,
          5.514895E-04},{6.931082E-01,-1.885558E-02,8.345461E-04,1.263879E-02,
          4.588028E-04,-8.221467E-04}},
      EIRFunPLR={{6.087656E-02,4.842164E-01,4.571519E-01},{1.040764E-01,
          2.818752E-01,6.144036E-01}}))
