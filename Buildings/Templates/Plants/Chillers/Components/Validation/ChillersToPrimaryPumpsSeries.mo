...
model ChillersToPrimaryPumpsSeries
  ...
  Fluid.Sensors.TemperatureTwoPort TChiWatPriSup3(
    redeclare final package Medium=MediumChiWat,
    final m_flow_nominal=sum(mChiWatChi_flow_nominal))
    "Primary CHW supply temperature"
    annotation(Placement(transformation(extent={{-10,-10},{10,10}},
  ...
  Fluid.FixedResistances.PressureDrop resEco1(
    ...
    annotation(Placement(transformation(extent={{-10,-10},{10,10}},
      rotation=90,
      origin={-200,-290})));
  Fluid.Sensors.TemperatureTwoPort TChiWatEcoEnt1(
    redeclare final package Medium=MediumChiWat,
    final m_flow_nominal=mChiWatEco_flow_nominal)
    "WSE entering CHW return temperature"
  ...
  Buildings.Controls.OBC.CDL.Conversions.BooleanToReal booToRea2[nChi]
    ...
    annotation(Placement(transformation(extent={{-10,-10},{10,10}},
      rotation=-90,
      origin={240,-160})));
  Buildings.Controls.OBC.CDL.Reals.MultiSum comSigLoa2(
    k=fill(1 / nChi, nChi),
    nin=nChi)
    "Compute load modulating signal"
    annotation(Placement(transformation(extent={{-10,-10},{10,10}},
...
equation
  connect(pumChiWatPri1.ports_b, outPumChiWatPri1.ports_a)
    annotation(Line(points={{-10,180},{16,180}},
      color={0,127,255}));
  ...
  connect(TChiWatChiEnt1.port_b, resEva1.port_a)
    annotation(Line(points={{-190,120},{-200,120},{-200,140}},
      color={0,127,255}));
  connect(outPumChiWatPri1.port_b, TChiWatPriSup1.port_a)
    annotation(Line(points={{36,180},{50,180}},
      color={0,127,255}));
  connect(TChiWatPriSup1.port_b, mChiWatPri_flow1.port_a)
    annotation(Line(points={{70,180},{90,180}},
      color={0,127,255}));
  connect(loa1.port_a, mChiWatPri_flow1.port_b)
    annotation(Line(points={{10,120},{120,120},{120,180},{110,180}},
      color={0,127,255}));
  connect(loa1.port_b, rou1.port_aRet)
    annotation(Line(points={{-10,120},{-36,120},{-36,91.791},{-40,91.791}},
      color={0,127,255}));
  ...
  connect(y1PumChiWatPri.y[1], busPumChiWatPri1.y1)
    annotation(Line(points={{-228,300},{160,300},{160,220},{200,220}},
      color={255,0,255}));
  ...
  connect(mChiWatChi_flow2.port_b, TChiWatChiEnt2.port_a)
    annotation(Line(points={{-150,-20},{-170,-20}},
      color={0,127,255}));
  connect(TChiWatChiEnt2.port_b, resEva2.port_a)
    annotation(Line(points={{-190,-20},{-200,-20},{-200,0}},
      color={0,127,255}));
  connect(outPumChiWatPri2.port_b, TChiWatPriSup2.port_a)
    annotation(Line(points={{36,40},{50,40}},
      color={0,127,255}));
  connect(TChiWatPriSup2.port_b, mChiWatPri_flow2.port_a)
    annotation(Line(points={{70,40},{90,40}},
      color={0,127,255}));
  connect(loa2.port_a, mChiWatPri_flow2.port_b)
    annotation(Line(points={{10,-20},{120,-20},{120,40},{110,40}},
      color={0,127,255}));
  connect(loa2.port_b, rou2.port_aRet)
    annotation(Line(points={{-10,-20},{-36,-20},{-36,-48.209},{-40,-48.209}},
      color={0,127,255}));
  ...
  connect(coo2.port_b, rou2.ports_aSup[1:nChi])
    annotation(Line(points={{-160,40},{-120,40},{-120,68.209},{-80,68.209}},
      color={0,127,255}));
  connect(resEva2.port_b, coo2.port_a)
    annotation(Line(points={{-200,20},{-200,40},{-180,40}},
      color={0,127,255}));
  connect(yPumChiWatPri.y, busPumChiWatPri2.y)
    annotation(Line(points={{-228,340},{180,340},{180,104},{200,104},{200,100}},
      color={0,0,127}));
  connect(y1PumChiWatPri.y[1], busPumChiWatPri2.y1)
    annotation(Line(points={{-228,300},{160,300},{160,100},{200,100}},
      color={255,0,255}));
  connect(mChiWatEco_flow.port_b, TChiWatEcoEnt.port_a)
    annotation(Line(points={{-150,-120},{-170,-120}},
      color={0,127,255}));
  connect(TChiWatEcoEnt.port_b, resEco.port_a)
    annotation(Line(points={{-190,-120},{-200,-120},{-200,-100}},
      color={0,127,255}));
  connect(resEco.port_b, cooEco.port_a)
    annotation(Line(points={{-200,-80},{-200,-60},{-180,-60}},
      color={0,127,255}));
  connect(rou2.ports_bRet[nChi + 1], mChiWatEco_flow.port_a)
    annotation(Line(
      points={{-80,-48.209},{-100,-48.209},{-100,-120},{-130,-120}},
      color={0,127,255}));
  connect(rou2.ports_aSup[nChi + 1], cooEco.port_b)
    annotation(Line(points={{-80,68.209},{-120,68.209},{-120,-60},{-160,-60}},
      color={0,127,255}));
  connect(busPumChiWatPri2, pumChiWatPri2.bus)
    annotation(Line(points={{200,100},{200,60},{-20,60},{-20,50}},
      color={255,204,51},
      thickness=0.5));
  ...
  connect(mChiWatChi_flow3.port_a, rou3.ports_bRet[1:nChi])
    annotation(Line(
      points={{-130,-220},{-100,-220},{-100,-248.209},{-80,-248.209}},
      color={0,127,255}));
  connect(mChiWatChi_flow3.port_b, TChiWatChiEnt3.port_a)
    annotation(Line(points={{-150,-220},{-170,-220}},
      color={0,127,255}));
  connect(TChiWatChiEnt3.port_b, resEva3.port_a)
    annotation(Line(points={{-190,-220},{-200,-220},{-200,-200}},
      color={0,127,255}));
  ...
  connect(TChiWatPriSup3.port_b, mChiWatPri_flow3.port_a)
    annotation(Line(points={{70,-160},{90,-160}},
      color={0,127,255}));
  connect(loa3.port_b, rou3.port_aRet)
    annotation(Line(
      points={{-10,-220},{-36,-220},{-36,-248.209},{-40,-248.209}},
      color={0,127,255}));
  connect(bouChiWat3.ports[1], loa3.port_b)
    annotation(Line(points={{-20,-230},{-20,-220},{-10,-220}},
      color={0,127,255}));
  connect(coo3.port_b, rou3.ports_aSup[1:nChi])
    annotation(Line(
      points={{-160,-160},{-120,-160},{-120,-131.791},{-80,-131.791}},
      color={0,127,255}));
  connect(resEva3.port_b, coo3.port_a)
    annotation(Line(points={{-200,-180},{-200,-160},{-180,-160}},
      color={0,127,255}));
  ...
  connect(TChiWat.y, coo1.T_in)
    annotation(Line(points={{-228,220},{-174,220},{-174,192}},
      color={0,0,127}));
  connect(TChiWat.y, coo2.T_in)
    annotation(Line(
      points={{-228,220},{-220,220},{-220,60},{-174,60},{-174,52}},
      color={0,0,127}));
  connect(TChiWat[1].y, cooEco.T_in)
    annotation(Line(
      points={{-228,220},{-220,220},{-220,-40},{-174,-40},{-174,-48}},
      color={0,0,127}));
  connect(rou3.ports_bSup, pumChiWatPri3.ports_a)
    annotation(Line(
      points={{-40,-131.791},{-36,-131.791},{-36,-160},{-30,-160}},
      color={0,127,255}));
  connect(y1PumChiWatPri.y[1], busPumChiWatPri3.y1)
    annotation(Line(points={{-228,300},{160,300},{160,-100},{200,-100}},
      color={255,0,255}),
      Text(string="%second",
        index=1,
  ...
  connect(yPumChiWatPri.y, busPumChiWatPri3.y)
    annotation(Line(
      points={{-228,340},{180,340},{180,-136},{200,-136},{200,-100}},
      color={0,0,127}),
      Text(string="%second",
        index=1,
        extent={{6,3},{6,3}},
        horizontalAlignment=TextAlignment.Left));
  connect(busPumChiWatPri3, pumChiWatPri3.bus)
    annotation(Line(points={{200,-100},{200,-140},{-20,-140},{-20,-150}},
      color={255,204,51},
      thickness=0.5));
  ...
  connect(cooEco1.port_b, rou3.ports_aSup[nChi + 1])
    annotation(Line(
      points={{-160,-260},{-120,-260},{-120,-131.791},{-80,-131.791}},
      color={0,127,255}));
  connect(mChiWatEco_flow1.port_b, TChiWatEcoEnt1.port_a)
    annotation(Line(points={{-150,-320},{-170,-320}},
      color={0,127,255}));
  connect(TChiWatEcoEnt1.port_b, resEco1.port_a)
    annotation(Line(points={{-190,-320},{-200,-320},{-200,-300}},
      color={0,127,255}));
  connect(resEco1.port_b, cooEco1.port_a)
    annotation(Line(points={{-200,-280},{-200,-260},{-180,-260}},
      color={0,127,255}));
  connect(mChiWatEco_flow1.port_a, pumEco.port_b)
    annotation(Line(points={{-130,-320},{-100,-320},{-100,-290}},
      color={0,127,255}));
  connect(pumEco.port_a, rou3.ports_bRet[nChi + 1])
    annotation(Line(points={{-100,-270},{-100,-248.209},{-80,-248.209}},
      color={0,127,255}));
  connect(busPumChiWatEco, pumEco.bus)
    annotation(Line(points={{200,-160},{200,-280},{-90,-280}},
      color={255,204,51},
      thickness=0.5));
  connect(yPumChiWatPri.y, busPumChiWatEco.y)
    annotation(Line(
      points={{-228,340},{180,340},{180,-196},{200,-196},{200,-160}},
      color={0,0,127}));
  connect(y1PumChiWatPri[1].y[1], busPumChiWatEco.y1)
    annotation(Line(points={{-228,300},{160,300},{160,-160},{200,-160}},
      color={255,0,255}));
  connect(yValChiWatEcoByp.y[1], busValChiWatEcoByp.y)
    annotation(Line(points={{-228,260},{150,260},{150,40},{200,40}},
      color={0,0,127}));
  connect(cooEco.port_b, valChiWatEcoByp1.port_b)
    annotation(Line(points={{-160,-60},{-120,-60},{-120,-80}},
      color={0,127,255}));
  connect(mChiWatEco_flow.port_a, valChiWatEcoByp1.port_a)
    annotation(Line(points={{-130,-120},{-120,-120},{-120,-100}},
      color={0,127,255}));
  connect(busValChiWatEcoByp, valChiWatEcoByp1.bus)
    annotation(Line(points={{200,40},{200,-90},{-110,-90}},
      color={255,204,51},
      thickness=0.5));
  connect(booToRea.y, comSigLoa.u)
    annotation(Line(points={{220,168},{220,162}},
      color={0,0,127}));
  connect(busPumChiWatPri1.y1_actual, booToRea.u)
    annotation(Line(points={{200,220},{220,220},{220,192}},
      color={255,204,51},
      thickness=0.5));
  connect(comSigLoa.y, loa1.u)
    annotation(Line(points={{220,138},{220,126},{12,126}},
      color={0,0,127}));
  connect(booToRea1.y, comSigLoa1.u)
    annotation(Line(points={{240,28},{240,22}},
      color={0,0,127}));
  connect(comSigLoa1.y, loa2.u)
    annotation(Line(points={{240,-2},{240,-14},{12,-14}},
      color={0,0,127}));
  connect(busPumChiWatPri2.y1_actual, booToRea1.u)
    annotation(Line(points={{200,100},{220,100},{220,60},{240,60},{240,52}},
      color={255,204,51},
      thickness=0.5));
  connect(booToRea2.y, comSigLoa2.u)
    annotation(Line(points={{240,-172},{240,-178}},
      color={0,0,127}));
  connect(busPumChiWatPri3.y1_actual, booToRea2.u)
    annotation(Line(
      points={{200,-100},{220,-100},{220,-140},{240,-140},{240,-148}},
      color={255,204,51},
      thickness=0.5));
  connect(mChiWatPri_flow3.port_b, loa3.port_a)
    annotation(Line(points={{110,-160},{120,-160},{120,-220},{10,-220}},
      color={0,127,255}));
  connect(comSigLoa2.y, loa3.u)
    annotation(Line(points={{240,-202},{240,-214},{12,-214}},
      color={0,0,127}));
  connect(pas.port_b, rou1.ports_aSup[nChi + 1])
    annotation(Line(points={{-100,160},{-100,208.209},{-80,208.209}},
      color={0,127,255}));
  connect(rou1.ports_bRet[nChi + 1], pas.port_a)
    annotation(Line(points={{-80,91.791},{-100,91.791},{-100,140}},
      color={0,127,255}));
annotation(Diagram(coordinateSystem(extent={{-260,-360},{260,360}})),
  experiment(StopTime=2000,
    Tolerance=1e-06),
  __Dymola_Commands(
    file="modelica://Buildings/Resources/Scripts/Dymola/Templates/Plants/Chillers/Components/Validation/ChillersToPrimaryPumpsSeries.mos"
      "Simulate and plot"),
  Documentation(
    info="<html>
<p>
  ...
  for various plant configurations where the chillers are connected in series.
