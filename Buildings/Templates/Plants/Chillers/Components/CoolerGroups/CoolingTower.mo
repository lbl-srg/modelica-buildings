...
<ul>
  ...
  Text(extent={{-780,-98},{-620,-158}},
    ...
    textString="CT-1",
    visible=nCoo >= 1),
  Bitmap(extent=if text_flip
    then {{-660,160},{-740,240}} else {{-740,160},{-660,240}},
  ...
  Text(extent={{-500,-98},{-340,-158}},
    ...
    textString="CT-2"),
  Bitmap(extent=if text_flip
    then {{-380,160},{-460,240}} else {{-460,160},{-380,240}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Actuators/VFD.svg",
    visible=nCoo >= 2),
  Bitmap(extent={{-60,-60},{60,60}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Fans/Propeller.svg",
  ...
  Text(extent={{-220,-98},{-60,-158}},
    ...
    textString="CT-3"),
  Bitmap(extent=if text_flip
    then {{-100,160},{-180,240}} else {{-180,160},{-100,240}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Actuators/VFD.svg",
    visible=nCoo >= 3),
  Bitmap(extent={{-60,-60},{60,60}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Fans/Propeller.svg",
  ...
  Rectangle(extent={{220,160},{60,-160}},
    ...
    visible=nCoo >= 4),
  Bitmap(extent=if text_flip
    then {{180,160},{100,240}} else {{100,160},{180,240}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Actuators/VFD.svg",
    visible=nCoo >= 4),
  Bitmap(extent={{-60,-60},{60,60}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Fans/Propeller.svg",
  ...
  Line(points={{140,-160},{140,-300},{0,-300}},
    ...
    visible=nCoo >= 4),
  Bitmap(extent=if text_flip
    then {{460,160},{380,240}} else {{380,160},{460,240}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Actuators/VFD.svg",
    visible=nCoo >= 5),
  Bitmap(extent={{-60,-60},{60,60}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Fans/Propeller.svg",
  ...
  Text(extent={{340,-100},{500,-160}},
    ...
    textString="CT-5"),
  Bitmap(extent=if text_flip
    then {{740,160},{660,240}} else {{660,160},{740,240}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Actuators/VFD.svg",
    visible=nCoo >= 6),
  Bitmap(extent={{-60,-60},{60,60}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Fans/Propeller.svg",
