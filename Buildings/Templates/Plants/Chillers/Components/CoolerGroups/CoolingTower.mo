...
model CoolingTower
  ...
  extends Buildings.Templates.Plants.Chillers.Components.Interfaces.PartialCoolerGroup(
    final typCoo=if typTow ==
...
equation
  ...
  connect(inlCoo.ports_b, valCooInlIso.port_a)
    annotation(Line(points={{-70,0},{-50,0}},
      color={0,127,255}));
...
annotation(defaultComponentName="coo",
  Documentation(
    info="<html>
<p>
  This model represents a group of cooling towers. The tower cells (or units)
  may be unequally sized as explained in the documentation of
...
<p>
  ...
  <a href=\"modelica://Buildings.Templates.Plants.Chillers.Components.Interfaces.PartialCoolerGroup\">
    Buildings.Templates.Plants.Chillers.Components.Interfaces.PartialCoolerGroup</a>.
</p>
</html>",
    revisions="<html>
<ul>
  ...
  Icon(graphics={Rectangle(extent={{60,-100},{220,-160}},
  ...
  Text(extent={{60,-100},{220,-160}},
    ...
    visible=nCoo >= 4,
    textString="CT-4"),
  Rectangle(extent={{-780,-100},{-620,-160}},
    lineColor={28,108,200},
    pattern=LinePattern.None,
    fillColor={239,239,239},
    fillPattern=FillPattern.Solid,
    visible=nCoo >= 1),
  Rectangle(extent={{-620,160},{-780,-160}},
    lineColor={0,0,0},
    lineThickness=1,
    visible=nCoo >= 1),
  Text(extent={{-780,-98},{-620,-158}},
    ...
    textString="CT-1",
    visible=nCoo >= 1),
  Bitmap(extent=if text_flip then {{-660,160},{-740,240}}
    else {{-740,160},{-660,240}},
  ...
  Bitmap(extent={{-60,-60},{60,60}},
    ...
    rotation=-90,
    visible=nCoo >= 1),
  Line(points={{-820,-240},{-820,80},{-780,80}},
    color={0,0,0},
    pattern=LinePattern.Dash,
    thickness=5,
    visible=nCoo >= 1),
  Line(points={{-700,-160},{-700,-300},{0,-300},{0,-302}},
    color={0,0,0},
    thickness=5,
    visible=nCoo >= 1),
  Rectangle(extent={{-500,-100},{-340,-160}},
    lineColor={28,108,200},
    pattern=LinePattern.None,
    fillColor={239,239,239},
    fillPattern=FillPattern.Solid,
    visible=nCoo >= 2),
  Rectangle(extent={{-340,160},{-500,-160}},
    lineColor={0,0,0},
    lineThickness=1,
    visible=nCoo >= 2),
  Text(extent={{-500,-98},{-340,-158}},
    ...
    visible=nCoo >= 2,
    textString="CT-2"),
  Bitmap(extent=if text_flip then {{-380,160},{-460,240}}
    else {{-460,160},{-380,240}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Actuators/VFD.svg",
    visible=nCoo >= 2),
  Bitmap(extent={{-60,-60},{60,60}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Fans/Propeller.svg",
    ...
    rotation=-90,
    visible=nCoo >= 2),
  Line(points={{-822,-240},{-540,-240},{-540,80},{-500,80}},
    color={0,0,0},
    pattern=LinePattern.Dash,
    thickness=5,
    visible=nCoo >= 2),
  Line(points={{-420,-160},{-420,-300}},
    color={0,0,0},
    thickness=5,
    visible=nCoo >= 2),
  Rectangle(extent={{-220,-100},{-60,-160}},
    lineColor={28,108,200},
    pattern=LinePattern.None,
    fillColor={239,239,239},
    fillPattern=FillPattern.Solid,
    visible=nCoo >= 3),
  Rectangle(extent={{-60,160},{-220,-160}},
    lineColor={0,0,0},
    lineThickness=1,
    visible=nCoo >= 3),
  Text(extent={{-220,-98},{-60,-158}},
    ...
    visible=nCoo >= 3,
    textString="CT-3"),
  Bitmap(extent=if text_flip then {{-100,160},{-180,240}}
    else {{-180,160},{-100,240}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Actuators/VFD.svg",
    visible=nCoo >= 3),
  Bitmap(extent={{-60,-60},{60,60}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Fans/Propeller.svg",
    ...
    rotation=-90,
    visible=nCoo >= 3),
  Line(points={{-542,-240},{-260,-240},{-260,80},{-220,80}},
    color={0,0,0},
    pattern=LinePattern.Dash,
    thickness=5,
    visible=nCoo >= 3),
  Line(points={{-140,-160},{-140,-300}},
    color={0,0,0},
    thickness=5,
    visible=nCoo >= 3),
  Rectangle(extent={{220,160},{60,-160}},
    lineColor={0,0,0},
    lineThickness=1,
    visible=nCoo >= 4),
  Bitmap(extent=if text_flip then {{180,160},{100,240}}
    else {{100,160},{180,240}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Actuators/VFD.svg",
    visible=nCoo >= 4),
  Bitmap(extent={{-60,-60},{60,60}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Fans/Propeller.svg",
    ...
    rotation=-90,
    visible=nCoo >= 4),
  Line(points={{-262,-240},{20,-240},{20,80},{60,80}},
    color={0,0,0},
    pattern=LinePattern.Dash,
    thickness=5,
    visible=nCoo >= 4),
  Line(points={{140,-160},{140,-300},{0,-300}},
    color={0,0,0},
    thickness=5,
    visible=nCoo >= 4),
  Bitmap(extent=if text_flip then {{460,160},{380,240}}
    else {{380,160},{460,240}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Actuators/VFD.svg",
    visible=nCoo >= 5),
  Bitmap(extent={{-60,-60},{60,60}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Fans/Propeller.svg",
    ...
    rotation=-90,
    visible=nCoo >= 5),
  Line(points={{18,-240},{300,-240},{300,80},{340,80}},
    color={0,0,0},
    pattern=LinePattern.Dash,
    thickness=5,
    visible=nCoo >= 5),
  Line(points={{420,-160},{420,-300},{140,-300}},
    color={0,0,0},
    thickness=5,
    visible=nCoo >= 5),
  Rectangle(extent={{340,-100},{500,-160}},
    lineColor={28,108,200},
    pattern=LinePattern.None,
    fillColor={239,239,239},
    fillPattern=FillPattern.Solid,
    visible=nCoo >= 5),
  Rectangle(extent={{500,160},{340,-160}},
    lineColor={0,0,0},
    lineThickness=1,
    visible=nCoo >= 5),
  Text(extent={{340,-100},{500,-160}},
    ...
    visible=nCoo >= 5,
    textString="CT-5"),
  Bitmap(extent=if text_flip then {{740,160},{660,240}}
    else {{660,160},{740,240}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Actuators/VFD.svg",
    visible=nCoo >= 6),
  Bitmap(extent={{-60,-60},{60,60}},
    fileName="modelica://Buildings/Resources/Images/Templates/Components/Fans/Propeller.svg",
    ...
    rotation=-90,
    visible=nCoo >= 6),
  Line(points={{298,-240},{580,-240},{580,80},{620,80}},
    color={0,0,0},
    pattern=LinePattern.Dash,
    thickness=5,
    visible=nCoo >= 6),
  Line(points={{700,-160},{700,-300},{420,-300}},
    color={0,0,0},
    thickness=5,
    visible=nCoo >= 6),
  Rectangle(extent={{620,-100},{780,-160}},
    lineColor={28,108,200},
    pattern=LinePattern.None,
    fillColor={239,239,239},
    fillPattern=FillPattern.Solid,
    visible=nCoo >= 6),
  Rectangle(extent={{780,160},{620,-160}},
    lineColor={0,0,0},
    lineThickness=1,
    visible=nCoo >= 6),
