...
partial model PartialChillerPlant
  "Interface class for chiller plant"
  ...
  parameter Integer nChi(start=1, final min=1)
    "Number of chillers"
    annotation(Evaluate=true,
      Dialog(group="Chillers"));
  ...
  final parameter Buildings.Templates.Plants.Chillers.Types.ChillerArrangement typArrChi =
    if nChi == 1
    then Buildings.Templates.Plants.Chillers.Types.ChillerArrangement.Parallel
      ...
      Dialog(group="CW loop",
        enable=typChi ==
          ...
          and typArrPumConWat ==
            Buildings.Templates.Components.Types.PumpArrangement.Headered));
  // The following parameter stores the user selection.
  parameter Buildings.Templates.Components.Types.PumpArrangement typArrPumConWat_select(
    start=Buildings.Templates.Components.Types.PumpArrangement.Headered)
      ...
      Dialog(group="CW loop",
        enable=typChi ==
          ...
          and typEco ==
            Buildings.Templates.Plants.Chillers.Types.Economizer.None));
  // The following parameter stores the actual configuration setting.
  final parameter Buildings.Templates.Components.Types.PumpArrangement typArrPumConWat =
    if typChi == Buildings.Templates.Components.Types.Chiller.AirCooled
  ...
  MediumChiWat.ThermodynamicState sta_a =
    ...
    else MediumChiWat.setState_phX(
      port_a.p,
...
annotation(defaultComponentName="plaChiWat",
  Icon(coordinateSystem(preserveAspectRatio=false,
    ...
    Polygon(points={{-20,-41},{-20,-79},{-1,-60},{-20,-41}},
      ...
      fillPattern=FillPattern.HorizontalCylinder,
      fillColor={255,255,255}),
    Rectangle(extent={{-180,-20},{-60,-140}},
      lineColor={0,0,255},
      pattern=LinePattern.None,
      fillColor={95,95,95},
      fillPattern=FillPattern.Solid),
    Rectangle(extent={{-50,8},{50,-8}},
      lineColor={0,0,0},
      fillColor={255,255,255},
      fillPattern=FillPattern.Solid,
      origin={-80,-78},
    ...
    Rectangle(extent={{-50,8},{50,-8}},
      ...
      origin={-160,-78},
      rotation=90),
    Rectangle(extent={{-2,32},{2,-32}},
      lineColor={0,0,0},
      fillColor={255,255,255},
      fillPattern=FillPattern.Solid,
      origin={-120,-108},
      rotation=-90),
    Ellipse(extent={{-136,-92},{-104,-124}},
      lineColor={0,0,0},
      fillColor={255,255,255},
      fillPattern=FillPattern.Solid),
    Polygon(points={{0,8},{-10,-8},{10,-8},{0,8}},
      lineColor={0,0,0},
      smooth=Smooth.None,
      fillColor={255,255,255},
      fillPattern=FillPattern.Solid,
      origin={-128,-48},
      rotation=-90),
    Polygon(points={{-8,0},{8,10},{8,-10},{-8,0}},
      lineColor={0,0,0},
      smooth=Smooth.None,
      fillColor={255,255,255},
      fillPattern=FillPattern.Solid,
      origin={-112,-48},
      rotation=360),
    Rectangle(extent={{-2,8},{2,-8}},
      lineColor={0,0,0},
      fillColor={255,255,255},
      fillPattern=FillPattern.Solid,
      origin={-96,-48},
      rotation=-90),
    Line(points={{-134,-100},{-112,-94}},
      color={0,0,0}),
    Rectangle(extent={{-2,8},{2,-8}},
      lineColor={0,0,0},
      fillColor={255,255,255},
      ...
      origin={-144,-48},
      rotation=-90),
    Line(points={{-134,-116},{-112,-122}},
      color={0,0,0}),
    Rectangle(extent={{-180,140},{-60,20}},
      lineColor={0,0,255},
      pattern=LinePattern.None,
      fillColor={95,95,95},
      fillPattern=FillPattern.Solid),
  ...
  Documentation(
    info="<html>
<p>
  This partial class provides a standard interface for chilled water plant
  templates.
</p>
<p>The following modeling assumptions and limitations are considered.</p>
<ul>
  <li>
    The chillers are assumed to be of the same type as defined by the
    enumeration
    <a href=\"modelica://Buildings.Templates.Components.Types.Chiller\">
      Buildings.Templates.Components.Types.Chiller</a>.
  </li>
  <li>
    The number of installed chillers is supposed to be equal to the number of
    chillers operating at design conditions. The same holds true for CW and
    CHW pump groups.
  </li>
  <li>
    Variable speed primary CHW pumps are controlled to the same speed, whether
    they are in a dedicated or headered arrangement.
  </li>
  <li>
    Variable speed CW pumps are controlled to different speeds if they are in
    a dedicated arrangement. Otherwise they are controlled to the same speed.
  </li>
  <li>
    A plant with a WSE requires variable speed CW pumps that must be in a
    headered arrangement.
  </li>
  <li>To allow for a WSE, the plant must have water-cooled chillers.</li>
</ul>
</html>",
    revisions="<html>
<ul>
