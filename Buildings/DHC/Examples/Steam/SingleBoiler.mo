within Buildings.DHC.Examples.Steam;
model SingleBoiler "Example model for a complete steam district heating system with a
  ...
  Buildings.DHC.Loads.Steam.BuildingTimeSeriesAtETS bld[N](
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(
    ...
    "modelica://Buildings/Resources/Scripts/Dymola/DHC/Examples/Steam/SingleBoiler.mos"
    "Simulate and plot"),
    experiment(
      StopTime=86400,
      Tolerance=1e-06),
