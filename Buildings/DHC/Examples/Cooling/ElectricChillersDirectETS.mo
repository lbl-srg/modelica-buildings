within Buildings.DHC.Examples.Cooling;
model ElectricChillersDirectETS "Example model for district cooling system with
  ...
  final parameter Modelica.Units.SI.HeatFlowRate QCoo_flow_nominal[nLoa](
    each max=-Modelica.Constants.eps)={Buildings.DHC.Loads.BaseClasses.getPeakLoad(
  ...
  Buildings.DHC.Plants.Cooling.ElectricChillerParallel pla(
    perChi=perChi,
    dTApp=3,
    perCHWPum=perCHWPum,
    perCWPum=perCWPum,
  ...
  Buildings.DHC.Networks.Distribution2PipePlugFlow_v dis(
...
equation
  ...
  connect(gnd1.port, dis.heatPortsDis) annotation (Line(points={{146,-44},{
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/DHC/Examples/Cooling/ElectricChillersDirectETS.mos" "Simulate and plot"),
    experiment(
      StartTime=15724800,
      StopTime=16329600,
      Tolerance=1e-06),
...
a two-pipe distribution network with plug flow pipes (<a href=\"modelica://Buildings.DHC.Networks.Distribution2PipePlugFlow_v\">
Buildings.DHC.Networks.Distribution2PipePlugFlow_v</a>),
...
threshold
(<a href=\"modelica://Buildings.DHC.Loads.Cooling.BuildingTimeSeriesWithETS\">
Buildings.DHC.Loads.Cooling.BuildingTimeSeriesWithETS</a>).
This configuration is illustrated in the schematic below.
</p>
<p align=\"center\"><img src=\"modelica://Buildings/Resources/Images/DHC/Examples/Cooling/ElectricChillersDirectETS.png\" alt=\"DC Schematic\"/></p>
</html>", revisions="<html>
<ul>
<li>
