within Buildings.DHC.Plants.Steam;
model SingleBoiler "A generic steam plant with a single boiler that discharges
  ...
  extends Buildings.DHC.Plants.BaseClasses.PartialPlant(
    final typ=Buildings.DHC.Types.DistrictSystemType.HeatingGeneration1,
  ...
  // At start up, water leaves port_a, see Buildings.DHC.Examples.Steam.SingleBoiler
  Buildings.DHC.Plants.Steam.BaseClasses.BoilerPolynomial boi(
