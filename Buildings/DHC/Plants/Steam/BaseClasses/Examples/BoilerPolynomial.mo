within Buildings.DHC.Plants.Steam.BaseClasses.Examples;
...
equation
  ...
  annotation (__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/DHC/Plants/Steam/BaseClasses/Examples/BoilerPolynomial.mos"
        "Simulate and plot"),
