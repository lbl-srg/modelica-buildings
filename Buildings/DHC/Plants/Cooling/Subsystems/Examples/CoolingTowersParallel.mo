...
model CoolingTowersParallel
  ...
  extends
    ...
    redeclare Buildings.DHC.Plants.Cooling.Subsystems.CoolingTowersParallel tow(
...
equation
  ...
  annotation (
    ...
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/DHC/Plants/Cooling/Subsystems/Examples/CoolingTowersParallel.mos"
      "Simulate and Plot"),
    Documentation(
      info="<html>
<p>This model validates the parallel connected cooling tower subsystem in
<a href=\"modelica://Buildings.DHC.Plants.Cooling.Subsystems.CoolingTowersParallel\">
Buildings.DHC.Plants.Cooling.Subsystems.CoolingTowersParallel</a>.</p>
</html>",
      revisions="<html>
<ul>
<li>
