...
model TankStatus "Validation model for tank status controller"
  ...
  Buildings.DHC.Plants.Cooling.Controls.TankStatus tanSta(
    TLow=280.15,
    THig=286.15,
    dTHys=1) "Tank status"
...
<a href=\"modelica://Buildings.DHC.Plants.Cooling.Controls.TankStatus\">
Buildings.DHC.Plants.Cooling.Controls.TankStatus</a>.
