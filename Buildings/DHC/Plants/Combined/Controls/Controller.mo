...
block Controller "Plant controller"
  ...
  Buildings.DHC.Plants.Combined.Controls.BaseClasses.StagingPump staPumChiWat(
    final nPum=nPumChiWat,
    final m_flow_nominal=mChiWat_flow_nominal)
    "CHW pump staging"
    annotation (Placement(transformation(extent={{120,230},{140,250}})));
  Buildings.Controls.OBC.Utilities.PIDWithEnable pumChiWat(
    k=0.1,
    Ti=60,
    r=dpChiWatSet_max,
    y_reset=1,
  ...
  Buildings.Controls.OBC.Utilities.PIDWithEnable pumHeaWat(
    k=0.1,
    Ti=60,
    r=dpHeaWatSet_max,
    y_reset=1,
  ...
  Buildings.DHC.Plants.Combined.Controls.BaseClasses.StagingPump staPumHeaWat(
    final nPum=nPumHeaWat,
    final m_flow_nominal=mHeaWat_flow_nominal)
    "HW pump staging"
    annotation (Placement(transformation(extent={{120,-50},{140,-30}})));
  Buildings.DHC.Plants.Combined.Controls.BaseClasses.StagingPump staPumConWatCon(
    final nPum=nPumConWatCon,
    final m_flow_nominal=mConWatCon_flow_nominal)
    "CW pump staging"
    annotation (Placement(transformation(extent={{120,-130},{140,-110}})));
  Buildings.Controls.OBC.Utilities.PIDWithEnable pumConWatCon(
    k=0.1,
    Ti=60,
  ...
  Buildings.Controls.OBC.Utilities.PIDWithEnable pumConWatEva(
    k=0.1,
    Ti=60,
  ...
  Buildings.DHC.Plants.Combined.Controls.BaseClasses.StagingPump staPumConWatEva(
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant dpConNom(
    final k=dpConWatConSet_max)
    "Constant"
    annotation (Placement(transformation(extent={{160,-130},{180,-110}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant dpEvaNom(
    final k=dpConWatEvaSet_max)
    "Constant"
  ...
  Buildings.DHC.Plants.Combined.Controls.BaseClasses.ModeCondenserLoop modConLoo(
    ...
    final nTTan=nTTan) "Condenser loop operating mode"
    annotation (Placement(transformation(extent={{-170,-170},{-150,-150}})));
  Buildings.DHC.Plants.Combined.Controls.BaseClasses.TankCycle cycTan(
    final mConWatHexCoo_flow_nominal=mConWatCon_flow_nominal,
    final TTanSet=TTanSet,
    final nTTan=nTTan)
  ...
  Buildings.DHC.Plants.Combined.Controls.BaseClasses.CoolingTowerLoop coo(
    final mConWatHexCoo_flow_nominal=mConWatCon_flow_nominal,
    final nCoo=nCoo,
...
equation
  ...
  connect(staPumChiWat.y1, y1PumChiWat) annotation (Line(points={{142,246},{180,
          246},{180,260},{280,260}}, color={255,0,255}));
  ...
  connect(dpChiWatSet, pumChiWat.u_s) annotation (Line(points={{-280,320},{-10,
          320},{-10,260},{176,260},{176,240},{188,240}}, color={0,0,127}));
  connect(staPumHeaWat.y1, y1PumHeaWat)
    annotation (Line(points={{142,-34},{180,-34},{180,-20},{280,-20}}, color={255,0,255}));
  ...
  connect(dpHeaWatSet, pumHeaWat.u_s) annotation (Line(points={{-280,300},{4,
          300},{4,-20},{160,-20},{160,-40},{188,-40}}, color={0,0,127}));
  ...
  connect(staPumConWatCon.y1, y1PumConWatCon) annotation (Line(points={{142,-114},
          {150,-114},{150,-100},{240,-100},{240,-120},{280,-120}}, color={255,0,255}));
  connect(staPumConWatEva.y1, y1PumConWatEva)
    annotation (Line(points={{142,-174},{150,-174},{150,-160},{280,-160}}, color={255,0,255}));
  ...
  connect(TChiWatPriRet, staPla.TChiWatPriRet) annotation (Line(points={{-280,
          240},{-242,240},{-242,160},{-212,160}}, color={0,0,127}));
  ...
  connect(mConWatOutTan_flow, cycTan.mConWatOutTan_flow) annotation (Line(
        points={{-280,-300},{-226,-300},{-226,-94},{-172,-94}}, color={0,0,127}));
  ...
  connect(cycTan.idxCycTan, extIndRea.index) annotation (Line(points={{-148,
          -100},{-140,-100},{-140,-240},{-110,-240},{-110,-232}}, color={255,127,0}));
  ...
  connect(staPla.y1Chi,valConEva. u1Chi) annotation (Line(points={{-188,164},{
          -164,164},{-164,58},{-62,58}}, color={255,0,255}));
  ...
  connect(valConEva.yValConSwiChiHea, yValConSwiChiHea)
    annotation (Line(points={{-38,32},{260,32},{260,20},{280,20}}, color={0,0,127}));
  ...
  connect(pumHeaWat.y, staPumHeaWat.y) annotation (Line(points={{212,-40},{220,
          -40},{220,-60},{110,-60},{110,-46},{118,-46}}, color={0,0,127}));
  ...
  connect(pumConWatCon.y, staPumConWatCon.y) annotation (Line(points={{212,-120},
          {220,-120},{220,-140},{114,-140},{114,-126},{118,-126}}, color={0,0,127}));
  connect(pumConWatEva.y, staPumConWatEva.y) annotation (Line(points={{212,-180},
          {220,-180},{220,-200},{114,-200},{114,-186},{118,-186}}, color={0,0,127}));
  ...
  connect(valConEva.y1PumConWatCon, staPumConWatCon.y1Ena) annotation (Line(
        points={{-38,54},{-2,54},{-2,-114},{118,-114}}, color={255,0,255}));
  ...
  connect(staPla.y1HeaCooChiHea, dirHeaCoo.y1HeaCoo) annotation (Line(points={{-188,
          142},{-170,142},{-170,4},{-126,4},{-126,4},{-122,4}}, color={255,0,255}));
  ...
  connect(dirHeaCoo.mEvaChiHeaSet_flow,valConEva. mEvaChiHeaSet_flow)
    annotation (Line(points={{-98,0},{-88,0},{-88,44},{-62,44}}, color={0,0,127}));
  ...
  connect(modConLoo.mode, coo.mode) annotation (Line(points={{-148,-160},{2,
          -160},{2,-330},{38,-330}}, color={255,127,0}));
  ...
  connect(TConWatCooSup, coo.TConWatCooSup) annotation (Line(points={{-280,0},{
          -250,0},{-250,-343.8},{38,-343.8}}, color={0,0,127}));
  connect(TConWatCooRet, coo.TConWatCooRet) annotation (Line(points={{-280,-20},
          {-244,-20},{-244,-345.8},{38,-345.8}},  color={0,0,127}));
  ...
  connect(cvtValBypTan.y, coo.yValBypTan) annotation (Line(points={{-18,-280},{
          -6,-280},{-6,-362},{38,-362}}, color={0,0,127}));
  connect(dirHeaCoo.TConEntChiHeaSet,valConEva. TConEntChiHeaSet) annotation (
      Line(points={{-98,-6},{-84,-6},{-84,34},{-62,34}}, color={0,0,127}));
