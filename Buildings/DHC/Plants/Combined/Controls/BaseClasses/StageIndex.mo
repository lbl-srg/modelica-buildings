...
block StageIndex
  ...
  Buildings.Controls.OBC.CDL.Logical.Not not1
    "True if enable signal false"
    annotation (Placement(transformation(extent={{-100,-50},{-80,-30}})));
  Modelica.Blocks.Sources.IntegerExpression calIdxSta(
    final y=Modelica.Math.BooleanVectors.firstTrueIndex(sta.active))
    "Compute stage index"
...
equation
  ...
  connect(enaLag[i].outPort, sta[i+1].inPort[1]) annotation (Line(points={{101.5,
            40},{110,40},{110,80},{-20,80},{-20,39.75},{-11,39.75}},  color={0,0,0}));
  ...
  connect(disLag[1].outPort, sta0.inPort[nSta+1]) annotation (Line(points={{121.5,
          20},{130,20},{130,100},{-140,100},{-140,40},{-121,40}}, color={0,0,0}));
  connect(sta.outPort[1], disAll.inPort) annotation (Line(points={{10.5,39.8333},
          {20,39.8333},{20,60},{76,60}}, color={0,0,0}));
  ...
  connect(sta.outPort[3], disLag.inPort) annotation (Line(points={{10.5,40.1667},
          {20,40.1667},{20,20},{116,20}}, color={0,0,0}));
  ...
  connect(u1, edg.u) annotation (Line(points={{-200,60},{-170,60},{-170,80},{
          -132,80}}, color={255,0,255}));
  connect(edg.y, or2.u1)
    annotation (Line(points={{-108,80},{-102,80}}, color={255,0,255}));
  ...
  connect(upAndEna.y, or2.u2) annotation (Line(points={{-138,-80},{-130,-80},{
          -130,60},{-106,60},{-106,72},{-102,72}}, color={255,0,255}));
