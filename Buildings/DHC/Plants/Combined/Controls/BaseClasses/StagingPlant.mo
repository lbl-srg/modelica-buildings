...
block StagingPlant
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput dpHeaWatSet(
    ...
    annotation (Placement(transformation(extent={{-280,-280},{-240,-240}}),
  ...
  Buildings.Controls.OBC.CDL.Reals.MovingAverage movAve1(
    final delta=300)
    "Moving average"
  ...
  Buildings.Controls.OBC.CDL.Logical.Or or2
    "Failsafe condition to stage up"
  ...
  Buildings.Controls.OBC.CDL.Logical.Timer timOPLRExcLim1(final t=15*60)
    "Timer for OPLR exceeding limit"
  ...
  Buildings.Controls.OBC.CDL.Logical.Timer timOPLRExcLim2(
    t=15*60)
    "Timer for OPLR exceeding limit"
  ...
  Buildings.Controls.OBC.CDL.Logical.Timer timOPLRExcLim3(
    t=15*60)
    "Timer for OPLR exceeding limit"
  ...
  Buildings.Controls.OBC.CDL.Reals.GreaterThreshold cmpErrLim2(
    t=+1, h=1E-4)
    "Check tracking error limit"
    annotation (Placement(transformation(extent={{-170,-230},{-150,-210}})));
  Buildings.Controls.OBC.CDL.Reals.GreaterThreshold cmpErrLim3(
    t=1.5E4, h=1E-1)
    "Check tracking error limit"
    annotation (Placement(transformation(extent={{-170,-290},{-150,-270}})));
  Buildings.Controls.OBC.CDL.Logical.Timer timErrExcLim2(
    t=15*60)
    "Timer for error exceeding error limit"
    annotation (Placement(transformation(extent={{-110,-230},{-90,-210}})));
  Buildings.Controls.OBC.CDL.Logical.Timer timErrExcLim3(
    t=15*60)
    "Timer for error exceeding error limit"
...
equation
  ...
  connect(THeaWatPriRet, dTHeaWat.u2) annotation (Line(points={{-260,-160},{
          -226,-160},{-226,-146},{-222,-146}}, color={0,0,127}));
  connect(rep.y, cmdChi.u)
    annotation (Line(points={{202,120},{208,120}}, color={255,127,0}));
  ...
  connect(rep5.y, cmdChiHea.u)
    annotation (Line(points={{202,-100},{208,-100}}, color={255,127,0}));
  ...
  connect(dpChiWatSet, errDpChiWat.u1) annotation (Line(points={{-260,280},{
          -206,280},{-206,266},{-202,266}}, color={0,0,127}));
  ...
  connect(cmdChi.y, y1Chi)
    annotation (Line(points={{232,120},{260,120}}, color={255,0,255}));
  ...
  connect(timOPLRExcLim.passed, or1.u2) annotation (Line(points={{-18,112},{-14,
          112},{-14,132},{-2,132}}, color={255,0,255}));
  ...
  connect(cmpErrLim3.y,and1. u1)
    annotation (Line(points={{-148,-280},{-142,-280}}, color={255,0,255}));
  connect(and1.y,timErrExcLim3. u)
    annotation (Line(points={{-118,-280},{-112,-280}}, color={255,0,255}));
...
As described in
<a href=\"modelica://Buildings.DHC.Plants.Combined.Controls.BaseClasses.ModeHeatRecoveryChiller\">
Buildings.DHC.Plants.Combined.Controls.BaseClasses.ModeHeatRecoveryChiller</a>
...
<tr><th>Heating stage &darr; Buildings.DHC.Plants.Cooling stage &rarr;</th>
<td>0</td>
<td>1</td>
<td>2</td>
<td>3</td>
