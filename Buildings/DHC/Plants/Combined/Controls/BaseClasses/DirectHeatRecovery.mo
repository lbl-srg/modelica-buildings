...
equation
  ...
  connect(heaCooAndOn.y, ctl.uEna) annotation (Line(points={{-98,60},{-80,60},{
          -80,-20},{-64,-20},{-64,-12}}, color={255,0,255}));
