...
model MultiplePumpsDp
  ...
  extends BaseClasses.PartialMultiplePumps(
    redeclare final Buildings.DHC.Plants.Combined.Subsystems.MultiplePumpsDp pum,
...
equation
  ...
  annotation (
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/DHC/Plants/Combined/Subsystems/Validation/MultiplePumpsDp.mos"
      "Simulate and plot"),
    experiment(
      StopTime=1000,
      Tolerance=1e-06),
...
<a href=\"modelica://Buildings.DHC.Plants.Combined.Subsystems.MultiplePumpsDp\">
Buildings.DHC.Plants.Combined.Subsystems.MultiplePumpsDp</a>
