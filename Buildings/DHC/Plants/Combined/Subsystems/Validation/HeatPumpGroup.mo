...
model HeatPumpGroup "Validation of heat pump group model"
  ...
  Buildings.DHC.Plants.Combined.Subsystems.HeatPumpGroup heaPum(
...
equation
  ...
  annotation (
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/DHC/Plants/Combined/Subsystems/Validation/HeatPumpGroup.mos"
      "Simulate and plot"),
    experiment(
      StopTime=1000,
      Tolerance=1e-06),
...
<a href=\"modelica://Buildings.DHC.Plants.Combined.Subsystems.HeatPumpGroup\">
Buildings.DHC.Plants.Combined.Subsystems.HeatPumpGroup</a>
