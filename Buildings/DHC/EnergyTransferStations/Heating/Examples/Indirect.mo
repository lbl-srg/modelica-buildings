within Buildings.DHC.EnergyTransferStations.Heating.Examples;
model Indirect "Example model for indirect heating energy transfer station
  ...
  Buildings.DHC.EnergyTransferStations.Heating.Indirect heaETS(
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/DHC/EnergyTransferStations/Heating/Examples/Indirect.mos" "Simulate and plot"),
    experiment(
      StartTime=0,
      StopTime=86400,
      Tolerance=1e-06),
