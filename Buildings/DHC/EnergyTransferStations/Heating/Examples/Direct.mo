...
model Direct "Example model for direct heating energy transfer station
  ...
  Buildings.DHC.EnergyTransferStations.Heating.Direct heaETS(
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/DHC/EnergyTransferStations/Heating/Examples/Direct.mos" "Simulate and plot"),
    experiment(
      StartTime=0,
      StopTime=86400,
      Tolerance=1e-06),
