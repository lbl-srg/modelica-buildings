within Buildings.DHC.EnergyTransferStations.Combined.Validation;
model ChillerBorefield
  ...
  annotation (
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/DHC/EnergyTransferStations/Combined/Validation/ChillerBorefield.mos" "Simulate and plot"),
    experiment(
      StopTime=360000,
      Tolerance=1e-06),
    Documentation(
...
See
<a href=\"modelica://Buildings.DHC.EnergyTransferStations.Combined.Validation.ChillerOnly\">
Buildings.DHC.EnergyTransferStations.Combined.Validation.ChillerOnly</a>
