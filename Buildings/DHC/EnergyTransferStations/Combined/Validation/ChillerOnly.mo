...
model ChillerOnly
  ...
  extends Buildings.DHC.EnergyTransferStations.Combined.Validation.BaseClasses.PartialChillerBorefield;
...
equation
  ...
  annotation (
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/DHC/EnergyTransferStations/Combined/Validation/ChillerOnly.mos" "Simulate and plot"),
    experiment(
      StopTime=360000,
      Tolerance=1e-06),
    Documentation(
...
<a href=\"modelica://Buildings.DHC.EnergyTransferStations.Combined.Validation.BaseClasses.PartialChillerBorefield\">
Buildings.DHC.EnergyTransferStations.Combined.Validation.BaseClasses.PartialChillerBorefield</a>.
</li>
</ul>
</html>"));
end ChillerOnly;
