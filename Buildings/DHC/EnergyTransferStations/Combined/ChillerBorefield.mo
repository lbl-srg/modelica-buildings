...
model ChillerBorefield "ETS model for 5GDHC systems with heat recovery chiller and optional borefield"
  extends Buildings.DHC.EnergyTransferStations.Combined.BaseClasses.PartialParallel(
    final have_eleCoo=true,
    final have_fan=false,
    redeclare replaceable Buildings.DHC.EnergyTransferStations.Combined.Controls.Supervisory conSup
      constrainedby Buildings.DHC.EnergyTransferStations.Combined.Controls.Supervisory(
  ...
  replaceable
    Buildings.DHC.EnergyTransferStations.Combined.Subsystems.Chiller
    chi(
  ...
  replaceable
    Buildings.DHC.EnergyTransferStations.Combined.Subsystems.Borefield
    borFie(
    redeclare final package Medium = MediumBui,
  ...
  Buildings.DHC.Networks.BaseClasses.DifferenceEnthalpyFlowRate dHFloChiWat(
    ...
    annotation (Placement(transformation(extent={{-10,10},{10,-10}},
        rotation=90,
        origin={274,130})));
  Buildings.DHC.EnergyTransferStations.Combined.Subsystems.WatersideEconomizer
    WSE(
  ...
  Buildings.DHC.EnergyTransferStations.BaseClasses.Junction splWSE(
  ...
  Buildings.DHC.EnergyTransferStations.BaseClasses.Junction mixWSE(
    redeclare final package Medium = MediumSer,
    final m_flow_nominal={
      hex.m1_flow_nominal,
      -hex.m1_flow_nominal - m1WSE_flow_nominal,
...
src=\"modelica://Buildings/Resources/Images/DHC/EnergyTransferStations/Combined/ChillerBorefield.png\"/>
</p>
</html>"));
