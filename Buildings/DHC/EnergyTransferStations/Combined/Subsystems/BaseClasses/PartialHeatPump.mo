within Buildings.DHC.EnergyTransferStations.Combined.Subsystems.BaseClasses;
model PartialHeatPump
  ...
  Buildings.DHC.EnergyTransferStations.BaseClasses.Pump_m_flow
                                     pumCon(
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
  ...
  Buildings.DHC.EnergyTransferStations.BaseClasses.Junction
