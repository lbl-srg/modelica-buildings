...
model Chiller
  ...
  Buildings.DHC.EnergyTransferStations.BaseClasses.Pump_m_flow pumCon(
    redeclare final package Medium=Medium,
  ...
  Buildings.DHC.EnergyTransferStations.BaseClasses.Pump_m_flow pumEva(
    redeclare final package Medium=Medium,
    final allowFlowReversal=allowFlowReversal,
  ...
  Buildings.DHC.EnergyTransferStations.Combined.Controls.Chiller con(
  ...
  Buildings.DHC.EnergyTransferStations.BaseClasses.Junction splEva(
    redeclare final package Medium=Medium,
  ...
  Buildings.DHC.EnergyTransferStations.BaseClasses.Junction splConMix(
    redeclare final package Medium=Medium,
...
<a href=\"modelica://Buildings.DHC.EnergyTransferStations.Combined.Controls.Chiller\">
Buildings.DHC.EnergyTransferStations.Combined.Controls.Chiller</a>.
