...
model Borefield
  ...
  Buildings.DHC.EnergyTransferStations.BaseClasses.Pump_m_flow pum(
    redeclare final package Medium=Medium,
    final m_flow_nominal=m_flow_nominal,
  ...
  Buildings.DHC.EnergyTransferStations.BaseClasses.Junction spl(
    redeclare final package Medium=Medium,
  ...
  Buildings.DHC.EnergyTransferStations.Combined.Controls.Borefield con(
...
<a href=\"modelica://Buildings.DHC.EnergyTransferStations.Combined.Controls.Borefield\">
Buildings.DHC.EnergyTransferStations.Combined.Controls.Borefield</a>.
