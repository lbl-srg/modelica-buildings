...
model SwitchBox
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput mPos_flow(final unit="kg/s")
    ...
    iconTransformation(extent=
           {{-140,20},{-100,60}})));
  // COMPONENTS
  Buildings.DHC.EnergyTransferStations.BaseClasses.Junction splSup(
    redeclare final package Medium = Medium,
    ...
    annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={-20,40})));
  Buildings.DHC.EnergyTransferStations.BaseClasses.Junction splRet(
    redeclare final package Medium = Medium,
    m_flow_nominal={1,1,1}*m_flow_nominal)
    "Flow splitter"
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={20,0})));
  Buildings.DHC.EnergyTransferStations.Combined.Controls.SwitchBox con(
...
<a href=\"modelica://Buildings.DHC.EnergyTransferStations.Combined.Controls.SwitchBox\">
Buildings.DHC.EnergyTransferStations.Combined.Controls.SwitchBox</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
