...
model HeatPumpDHWTank
  ...
  Buildings.DHC.EnergyTransferStations.Combined.Subsystems.HeatPumpDHWTank
    heaPum(
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/DHC/EnergyTransferStations/Combined/Subsystems/Validation/HeatPumpDHWTank.mos" "Simulate and plot"),
    experiment(
      StopTime=172800,
      Tolerance=1e-06),
    Documentation(
