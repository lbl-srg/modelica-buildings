...
model Chiller
  ...
  Buildings.DHC.EnergyTransferStations.Combined.Subsystems.Chiller chi(
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/DHC/EnergyTransferStations/Combined/Subsystems/Validation/Chiller.mos" "Simulate and plot"),
    experiment(
      StopTime=5000,
      Tolerance=1e-06),
    Documentation(
...
<a href=\"modelica://Buildings.DHC.EnergyTransferStations.Combined.Subsystems.Chiller\">
Buildings.DHC.EnergyTransferStations.Combined.Subsystems.Chiller</a>.
</p>
</html>"));
end Chiller;
