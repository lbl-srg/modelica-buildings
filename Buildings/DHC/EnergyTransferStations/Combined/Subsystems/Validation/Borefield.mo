...
model Borefield
  ...
  final parameter Modelica.Units.SI.Distance cooBor[nBorHol,2]=
      Buildings.DHC.EnergyTransferStations.BaseClasses.computeCoordinates(
      nBorHol, dxy) "Coordinates of boreholes";
  Buildings.DHC.EnergyTransferStations.Combined.Subsystems.Borefield borFie(
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/DHC/EnergyTransferStations/Combined/Subsystems/Validation/Borefield.mos" "Simulate and plot"),
    experiment(
      StopTime=20000,
      Tolerance=1e-06),
    Documentation(
...
<a href=\"modelica://Buildings.DHC.EnergyTransferStations.Combined.Subsystems.Borefield\">
Buildings.DHC.EnergyTransferStations.Combined.Subsystems.Borefield</a>.
</p>
</html>"));
end Borefield;
