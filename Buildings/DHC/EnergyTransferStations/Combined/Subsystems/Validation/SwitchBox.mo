within Buildings.DHC.EnergyTransferStations.Combined.Subsystems.Validation;
model SwitchBox "Validation of flow switch box"
  ...
  Fluid.Delays.DelayFirstOrder volRet(
    ...
    nPorts=3) "Mixing volume return" annotation (Placement(transformation(
        ...
        rotation=90,
        origin={70,0})));
  Buildings.DHC.EnergyTransferStations.BaseClasses.Pump_m_flow pum1(
    redeclare package Medium = Medium,
    final m_flow_nominal=m_flow_nominal)
    "Chilled water HX secondary pump"
    annotation (Placement(transformation(extent={{10,-10},{-10,10}})));
  Buildings.DHC.EnergyTransferStations.BaseClasses.Pump_m_flow pum2(
    redeclare package Medium = Medium,
    final m_flow_nominal=m_flow_nominal)
    "Chilled water HX secondary pump"
    annotation (Placement(transformation(extent={{-10,50},{10,70}})));
  Buildings.DHC.EnergyTransferStations.Combined.Subsystems.SwitchBox
...
<a href=\"modelica://Buildings.DHC.EnergyTransferStations.Combined.Subsystems.SwitchBox\">
Buildings.DHC.EnergyTransferStations.Combined.Subsystems.SwitchBox</a>
...
period set by the controller.
  ...
  experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
    file="modelica://Buildings/Resources/Scripts/Dymola/DHC/EnergyTransferStations/Combined/Subsystems/Validation/SwitchBox.mos"
    "Simulate and plot"));
end SwitchBox;
