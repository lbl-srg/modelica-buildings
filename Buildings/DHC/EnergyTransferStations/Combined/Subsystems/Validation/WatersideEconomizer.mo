...
model WatersideEconomizer
  ...
  Buildings.DHC.EnergyTransferStations.Combined.Subsystems.WatersideEconomizer hexPum(
    redeclare final package Medium1=Medium,
    redeclare final package Medium2=Medium,
    show_T=true,
    conCon=Buildings.DHC.EnergyTransferStations.Types.ConnectionConfiguration.Pump,
    dp1Hex_nominal=3E4,
    dp2Hex_nominal=3E4,
    Q_flow_nominal=-1E6,
    T_a1_nominal=281.15,
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senT2InlPum(redeclare final
    ...
    "Secondary inlet temperature" annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-40,-80})));
  Buildings.DHC.EnergyTransferStations.Combined.Subsystems.WatersideEconomizer hexVal(
    redeclare final package Medium1=Medium,
    redeclare final package Medium2=Medium,
    show_T=true,
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/DHC/EnergyTransferStations/Combined/Subsystems/Validation/WatersideEconomizer.mos"
      "Simulate and plot"),
    experiment(
      StopTime=5000,
      Tolerance=1e-06),
...
<a href=\"modelica://Buildings.DHC.EnergyTransferStations.Combined.Subsystems.WatersideEconomizer\">
Buildings.DHC.EnergyTransferStations.Combined.Subsystems.WatersideEconomizer</a>
