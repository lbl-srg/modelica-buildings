...
model HeatExchanger
  ...
  Buildings.DHC.EnergyTransferStations.Combined.Subsystems.HeatExchanger hexPum(
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senT2InlPum(redeclare final
    ...
    "Secondary inlet temperature" annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-30,-100})));
  Buildings.DHC.EnergyTransferStations.Combined.Subsystems.HeatExchanger hexVal(
    redeclare final package Medium1 = Medium,
    redeclare final package Medium2 = Medium,
    show_T=true,
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/DHC/EnergyTransferStations/Combined/Subsystems/Validation/HeatExchanger.mos" "Simulate and plot"),
    experiment(
      StopTime=5000,
      Tolerance=1e-06),
    Documentation(
