...
model PartialHeatPumpHeatExchanger
  ...
  Buildings.DHC.EnergyTransferStations.BaseClasses.Pump_m_flow pum1HexChi(
    redeclare final package Medium = MediumSer,
  ...
  Buildings.DHC.EnergyTransferStations.Combined.Controls.PIDWithEnable conTChiWat(
    k=0.05,
    Ti=120,
    yMax=1,
  ...
  Buildings.DHC.EnergyTransferStations.BaseClasses.Junction bypHeaWatSup(
    redeclare final package Medium = MediumBui, final m_flow_nominal=proHeaWat.mCon_flow_nominal
        *{1,-1,-1}) "Bypass heating water (supply)" annotation (Placement(
        ...
        rotation=0,
        origin={100,260})));
  Buildings.DHC.EnergyTransferStations.BaseClasses.Junction bypHeaWatRet(
    redeclare final package Medium = MediumBui, final m_flow_nominal=proHeaWat.mCon_flow_nominal
        *{1,-1,1})
  ...
  Buildings.DHC.EnergyTransferStations.Combined.Subsystems.HeatPump proHeaWat(
  ...
  Buildings.DHC.EnergyTransferStations.Combined.Controls.PrimaryVariableFlow conFloConHHW(
...
<a href=\"modelica://Buildings.DHC.EnergyTransferStations.Combined.Controls.PrimaryVariableFlow\">
Buildings.DHC.EnergyTransferStations.Combined.Controls.PrimaryVariableFlow</a>.
