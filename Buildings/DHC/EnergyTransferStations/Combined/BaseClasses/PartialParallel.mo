within Buildings.DHC.EnergyTransferStations.Combined.BaseClasses;
model PartialParallel
  "Partial ETS model with district heat exchanger and parallel connection of production systems"
  extends Buildings.DHC.EnergyTransferStations.BaseClasses.PartialETS(
  ...
  parameter Buildings.DHC.EnergyTransferStations.Types.ConnectionConfiguration conCon=
      Buildings.DHC.EnergyTransferStations.Types.ConnectionConfiguration.Pump
  ...
  // COMPONENTS
  replaceable Buildings.DHC.EnergyTransferStations.Combined.Controls.BaseClasses.PartialSupervisory conSup
    constrainedby Buildings.DHC.EnergyTransferStations.Combined.Controls.BaseClasses.PartialSupervisory(
  ...
  Buildings.Fluid.Actuators.Valves.TwoWayLinear valIsoCon(
    ...
    annotation (Placement(transformation(extent={{-70,-130},{-50,-110}})));
  Buildings.DHC.EnergyTransferStations.Combined.Subsystems.HeatExchanger hex(
  ...
  Buildings.DHC.EnergyTransferStations.BaseClasses.StratifiedTank tanChiWat(
    redeclare final package Medium = MediumBui,
  ...
  Buildings.DHC.EnergyTransferStations.BaseClasses.StratifiedTank tanHeaWat(
    redeclare final package Medium = MediumBui,
  ...
  Buildings.DHC.EnergyTransferStations.BaseClasses.CollectorDistributor colChiWat(
    redeclare final package Medium = MediumBui,
    ...
    "Collector/distributor for chilled water" annotation (Placement(
        ...
        rotation=180,
        origin={120,-34})));
  Buildings.DHC.EnergyTransferStations.BaseClasses.CollectorDistributor colHeaWat(
    redeclare final package Medium = MediumBui,
    ...
    "Collector/distributor for heating water" annotation (Placement(
        ...
        rotation=180,
        origin={-120,-34})));
  Buildings.DHC.EnergyTransferStations.BaseClasses.CollectorDistributor colAmbWat(
    redeclare final package Medium = MediumBui,
    final nCon=nSouAmb,
...
<a href=\"modelica://Buildings.DHC.EnergyTransferStations.Combined.Subsystems.HeatExchanger\">
Buildings.DHC.EnergyTransferStations.Combined.Subsystems.HeatExchanger</a>.
</li>
<li>
...
listed in
<a href=\"modelica://Buildings.DHC.EnergyTransferStations.Combined.Controls.BaseClasses.PartialSupervisory\">
Buildings.DHC.EnergyTransferStations.Combined.Controls.BaseClasses.PartialSupervisory</a>.
</li>
</ul>
<p>
...
src=\"modelica://Buildings/Resources/Images/DHC/EnergyTransferStations/Combined/BaseClasses/PartialParallel.png\"/>
</p>
</html>",
revisions="<html>
<ul>
