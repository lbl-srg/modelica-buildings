within Buildings.DHC.EnergyTransferStations.Cooling.Examples;
model Direct "Example model for direct cooling energy transfer station
  ...
  Buildings.DHC.EnergyTransferStations.Cooling.Direct cooETS(
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/DHC/EnergyTransferStations/Cooling/Examples/Direct.mos" "Simulate and plot"),
    experiment(
      StartTime=0,
      StopTime=86400,
      Tolerance=1e-06),
