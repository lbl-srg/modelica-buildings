...
model Indirect "Example model for indirect cooling energy transfer station
  ...
  Buildings.DHC.EnergyTransferStations.Cooling.Indirect cooETS(
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/DHC/EnergyTransferStations/Cooling/Examples/Indirect.mos" "Simulate and plot"),
    experiment(
      StartTime=0,
      StopTime=86400,
      Tolerance=1e-06),
