within Buildings.DHC.ETS.Heating.Examples;
model Direct "Example model for direct heating energy transfer station
  ...
  Buildings.DHC.ETS.Heating.Direct heaETS(
...
equation
  connect(TSetDisRet_max.y,heaETS.TDisRetSet)
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/DHC/ETS/Heating/Examples/Direct.mos" "Simulate and plot"),
    experiment(
      StartTime=0,
      StopTime=86400,
      Tolerance=1e-06),
