within Buildings.DHC.Loads.Steam.Examples;
model BuildingTimeSeriesAtETS
  ...
  Buildings.DHC.Loads.Steam.BuildingTimeSeriesAtETS bui(
...
__Dymola_Commands(file=
  "modelica://Buildings/Resources/Scripts/Dymola/DHC/Loads/Steam/Examples/BuildingTimeSeriesAtETS.mos"
  "Simulate and plot"),
