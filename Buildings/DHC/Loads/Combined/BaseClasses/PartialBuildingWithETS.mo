within Buildings.DHC.Loads.Combined.BaseClasses;
model PartialBuildingWithETS
  ...
  extends
    ...
    nPorts_heaWat=1,
    nPorts_chiWat=1);
  outer parameter Buildings.DHC.Examples.Combined.BaseClasses.DesignDataSeries datDes "DHC system design data"
