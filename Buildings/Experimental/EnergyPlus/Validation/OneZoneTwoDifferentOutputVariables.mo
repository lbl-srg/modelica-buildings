...
model OneZoneTwoDifferentOutputVariables
  ...
  Buildings.Experimental.EnergyPlus.OutputVariable incBeaSou(
...
First implementation.
 ...
 __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/EnergyPlus/Validation/OneZoneTwoDifferentOutputVariables.mos"
        "Simulate and plot"),
experiment(
      StopTime=432000,
      Tolerance=1e-06,
