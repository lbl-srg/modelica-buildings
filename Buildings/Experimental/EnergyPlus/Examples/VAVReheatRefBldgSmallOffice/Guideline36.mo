...
model Guideline36 "Six zones small office building with VAV reheat"
...
<ul><li>
November 21, 2018, by Michael Wetter:<br/>
First implementation.
</li>
</ul>
</html>"),
 __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/EnergyPlus/Examples/VAVReheatRefBldgSmallOffice/Guideline36.mos"
        "Simulate and plot"),
experiment(
      StopTime=172800,
      Tolerance=1e-06),
