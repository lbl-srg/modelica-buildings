...
equation
  connect(X_w.y, fmuZonCor.X_w) annotation (Line(points={{-67,54},{-14,54},{-14,
          34},{18,34}},
                      color={0,0,127}));
  connect(fmuZonCor.m_flow[1], mIn_flow.y) annotation (Line(points={{18,29},{-8,
          29},{-8,10},{-67,10}},    color={0,0,127}));
  connect(mOut_flow.u, mIn_flow.y) annotation (Line(points={{-52,30},{-60,30},{-60,
          10},{-67,10}},    color={0,0,127}));
  connect(mOut_flow.y, fmuZonCor.m_flow[2]) annotation (Line(points={{-29,30},{-10,
  ...
  connect(X_w.y, fmuZonSou.X_w) annotation (Line(points={{-67,54},{-14,54},{-14,
          -6},{18,-6}},   color={0,0,127}));
  connect(fmuZonSou.m_flow[1], mIn_flow.y) annotation (Line(points={{18,-11},{-8,
          -11},{-8,10},{-67,10}},    color={0,0,127}));
  connect(mOut_flow.y, fmuZonSou.m_flow[2]) annotation (Line(points={{-29,30},{-10,
          30},{-10,-9},{18,-9}},       color={0,0,127}));
  ...
  connect(TZonCor.y, fmuZonCor.T)
    annotation (Line(points={{81,30},{88,30},{88,60},{8,60},{8,38},{18,38}},
                                                             color={0,0,127}));
  connect(X_w.y, fmuZonNor.X_w) annotation (Line(points={{-67,54},{-14,54},{-14,
          -46},{18,-46}}, color={0,0,127}));
  connect(fmuZonNor.m_flow[1], mIn_flow.y) annotation (Line(points={{18,-51},{-8,
          -51},{-8,10},{-67,10}},  color={0,0,127}));
  connect(mOut_flow.y, fmuZonNor.m_flow[2]) annotation (Line(points={{-29,30},{-10,
          30},{-10,-49},{18,-49}}, color={0,0,127}));
  connect(TIn.y, fmuZonNor.TInlet) annotation (Line(points={{-67,-14},{0,-14},{
          0,-54},{18,-54}},
                          color={0,0,127}));
  connect(fmuZonNor.QGaiRad_flow, QGaiRad_flow.y) annotation (Line(points={{18,-58},
          {-4,-58},{-4,-36},{-67,-36}}, color={0,0,127}));
  connect(fmuZonCor.QCon_flow, TZonCor.u)
    annotation (Line(points={{41,32},{50,32},{50,30},{58,30}},
                                                color={0,0,127}));
  connect(fmuZonSou.QCon_flow, TZonSou.u)
    annotation (Line(points={{41,-8},{50,-8},{50,-10},{58,-10}},
                                               color={0,0,127}));
  connect(TZonSou.y, fmuZonSou.T) annotation (Line(points={{81,-10},{86,-10},{86,
          10},{10,10},{10,-2},{18,-2}}, color={0,0,127}));
  connect(fmuZonNor.QCon_flow, TZonNor.u)
    annotation (Line(points={{41,-48},{50,-48},{50,-50},{58,-50}},
                                                 color={0,0,127}));
  connect(TZonNor.y, fmuZonNor.T) annotation (Line(points={{81,-50},{86,-50},{86,
          -32},{10,-32},{10,-42},{18,-42}},     color={0,0,127}));
