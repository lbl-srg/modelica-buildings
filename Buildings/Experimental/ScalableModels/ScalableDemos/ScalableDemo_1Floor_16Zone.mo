...
model ScalableDemo_1Floor_16Zone
  extends
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/ScalableModels/ScalableDemos/ScalableDemo_1Floor_16Zone.mos"
        "Simulate and plot"),
...
end ScalableDemo_1Floor_16Zone;
