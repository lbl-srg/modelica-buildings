...
model ScalableDemo_8Floor_8Zone
  extends
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/ScalableModels/ScalableDemos/ScalableDemo_8Floor_8Zone.mos"
        "Simulate and plot"),
