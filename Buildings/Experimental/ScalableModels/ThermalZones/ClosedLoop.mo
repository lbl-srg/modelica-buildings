...
model ClosedLoop
  ...
  Examples.VAVReheat.Controls.ModeSelector modeSelector
  ...
  Buildings.Fluid.Sources.FixedBoundary souCoo(
    ...
    T=279.15) "Source for cooling coil" annotation (Placement(transformation(
        ...
        rotation=90,
        origin={230,-120})));
  Examples.VAVReheat.Controls.Economizer conEco(
    dT=1,
  ...
  Examples.VAVReheat.Controls.RoomTemperatureSetpoint TSetRoo
  ...
  Examples.VAVReheat.Controls.DuctStaticPressureSetpoint pSetDuc(
    nin=5,
    controllerType=Modelica.Blocks.Types.SimpleController.PI,
  ...
  Examples.VAVReheat.Controls.CoolingCoilTemperatureSetpoint TSetCoo
  ...
  Examples.VAVReheat.ThermalZones.Floor flo(redeclare package Medium = MediumA,
      lat=lat)
