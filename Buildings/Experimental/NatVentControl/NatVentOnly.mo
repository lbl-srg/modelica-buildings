...
block NatVentOnly "Natural ventilation control block with lockouts"
...
parameter Real winSpeLim(min=0,
  ...
  Lockouts.AllLockouts allLockouts(
...
protected
  parameter Real TNitFluCut(min=0,
    final unit="K",
    final displayUnit="degC",
    final quantity="ThermodynamicTemperature")=TDryBulCut "Outdoor air temperature below which night flush sequence does not operate";
equation
  connect(allLockouts.yAllNatVenLoc, swi.u2) annotation (Line(points={{-15.8,0},
          {-6,0},{-6,10},{18,10}}, color={255,0,255}));
  connect(winClose.y, swi.u3) annotation (Line(points={{-18,-52},{10,-52},{10,2},
          {18,2}}, color={0,0,127}));
  connect(uManOveRid, allLockouts.uManOveRid) annotation (Line(points={{-120,90},
          {-92,90},{-92,17.6},{-66.2,17.6}}, color={255,0,255}));
  connect(uNitFlu, allLockouts.uNitFlu) annotation (Line(points={{-120,50},{-92,
          50},{-92,13.6},{-66.2,13.6}}, color={255,0,255}));
  connect(uRai, allLockouts.uRai) annotation (Line(points={{-120,10},{-94,10},{-94,
          9.6},{-66.2,9.6}}, color={255,0,255}));
  connect(uOcc, allLockouts.uOcc) annotation (Line(points={{-120,-30},{-94,-30},
          {-94,5.6},{-66.2,5.6}}, color={255,0,255}));
  connect(uWinSpe, allLockouts.uWinSpe) annotation (Line(points={{-120,-98},{-92,
          -98},{-92,-14},{-66.2,-14}},  color={0,0,127}));
  connect(uRooSet, allLockouts.uRooSet) annotation (Line(points={{-120,-140},{-82,
          -140},{-82,-6},{-66.2,-6}}, color={0,0,127}));
  connect(uDryBul, allLockouts.uDryBul) annotation (Line(points={{-120,-70},{-92,
          -70},{-92,-10},{-66.2,-10}}, color={0,0,127}));
  connect(uWetBul, allLockouts.uWetBul) annotation (Line(points={{-120,-172},{-74,
          -172},{-74,-2},{-66.2,-2}}, color={0,0,127}));
  ...
  connect(uRooMeaTem, windowControl.TRooMea) annotation (Line(points={{-120,
          -208},{-88,-208},{-88,75},{-42,75}},
                                         color={0,0,127}));
  connect(uRooSet, windowControl.TRooSet) annotation (Line(points={{-120,-140},{
          -80,-140},{-80,67.2},{-42,67.2}}, color={0,0,127}));
  connect(windowControl.yWinOpeReq, swi.u1) annotation (Line(points={{-18,70.2},
          {2,70.2},{2,18},{18,18}}, color={0,0,127}));
  ...
  connect(hys.y, yNatVen) annotation (Line(points={{80,-72},{90,-72},{90,-72},{120,
          -72}}, color={255,0,255}));
  connect(uRooMeaTem, allLockouts.uRooMea) annotation (Line(points={{-120,-208},
          {-88,-208},{-88,-18},{-66.2,-18}}, color={0,0,127}));
