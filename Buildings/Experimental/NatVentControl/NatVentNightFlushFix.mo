...
block NatVentNightFlushFix "Nat vent control including night flush"
...
equation
  ...
  annotation (defaultComponentName = "natVenNFFix",Documentation(info="<html>
...
<p>
        ...
        Ellipse(
          ...
          preserveAspectRatio=false, extent={{-100,-180},{100,100}})));
end NatVentNightFlushFix;
