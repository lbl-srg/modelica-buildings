...
model NatVenNitFluFix_Exterior_Chi
  ...
  RadiantControl.SlabTempSignal.Validation.BaseClasses.ForecastHighChicago
    ForecastHighChicago
...
equation
  ...
  connect(temRoom1.T, natVentControlPlusNightFlush.uRooMeaTem) annotation (Line(
        ...
        color={0,0,127}));
  connect(ForecastHighChicago.TForecastHigh, natVentControlPlusNightFlush.uForHi)
    annotation (Line(points={{-60,-9.8},{-20,-9.8},{-20,27.44},{23,27.44}},
        color={0,0,127}));
  ...
  <p> fixme : Validation model in progress
        ...
        coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
            640,200}})));
end NatVenNitFluFix_Exterior_Chi;
