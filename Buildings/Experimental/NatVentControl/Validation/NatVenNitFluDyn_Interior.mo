...
model NatVenNitFluDyn_Interior
  ...
  Controls.OBC.CDL.Continuous.Sources.Constant           InteriorSetpoint2(k=260)
    annotation (Placement(transformation(extent={{542,108},{586,152}})));
  ...
  Controls.OBC.CDL.Continuous.Sources.Constant           InteriorSetpoint1(k=293)
  ...
  BoundaryConditions.WeatherData.Bus weaBus2 annotation (Placement(
        transformation(extent={{-98,158},{-58,198}}), iconTransformation(extent=
           {{-168,106},{-148,126}})));
  Controls.OBC.CDL.Continuous.Sources.Constant DummyAir(k=280)
  ...
  HeatTransfer.Sources.FixedTemperature fixedTemperature(T=292.15)
  ...
  NatVentNightFlushDyn natVentControlPlusNightFlushDynamicDuration
...
equation
  ...
  connect(temRoom1.port_b, airOut2.ports[1]) annotation (Line(points={{372,-70},
  ...
  connect(conBel1.port_b, testCell_Radiant_Interior.surf_surBou[1]) annotation (
     Line(points={{436,-74},{434,-74},{434,102},{434.2,102}}, color={191,0,0}));
  connect(testCell_Radiant_Interior.ports[1], doo.port_a2) annotation (Line(
        points={{423,103},{320,103},{320,104},{218,104}}, color={0,127,255}));
  connect(doo.port_b1, testCell_Radiant_Interior.ports[2]) annotation (Line(
        points={{218,116},{322,116},{322,105},{423,105}}, color={0,127,255}));
  connect(testCell_Radiant_Interior.ports[3], temRoom1.port_a) annotation (Line(
        points={{423,107},{398,107},{398,-90},{372,-90}}, color={0,127,255}));
  connect(airIn1.ports[1], testCell_Radiant_Interior.ports[4]) annotation (Line(
        points={{334,-26},{380,-26},{380,109},{423,109}}, color={0,127,255}));
  connect(intGai1.y, testCell_Radiant_Interior.qGai_flow) annotation (Line(
        points={{353,158},{386,158},{386,124},{416.4,124}}, color={0,0,127}));
  connect(conBel3.port_b, testCell_Radiant_Interior.surf_conBou[1]) annotation (
     Line(points={{474,-36},{484,-36},{484,-34},{494,-34},{494,99.2},{444,99.2}},
                                                              color={191,0,0}));
  connect(temRoom1.T, airOut2.T_in) annotation (Line(points={{361,-80},{322,-80},
          {322,-96},{286,-96},{286,-76}}, color={0,0,127}));
  connect(fixedTemperature.port, conBel3.port_a) annotation (Line(points={{530,
          62},{572,62},{572,-70},{512,-70},{512,-62},{454,-62},{454,-36}},
        color={191,0,0}));
  connect(fixedTemperature.port, conBel1.port_b) annotation (Line(points={{530,
          62},{542,62},{542,-92},{436,-92},{436,-74}}, color={191,0,0}));
  connect(natVentControlPlusNightFlushDynamicDuration.yWinOpe, doo.y)
    annotation (Line(points={{108,49.2},{151,49.2},{151,110},{197,110}}, color={
          0,0,127}));
  connect(booleanConstant.y, natVentControlPlusNightFlushDynamicDuration.uManOveRid)
    annotation (Line(points={{-61,112},{-24,112},{-24,73.2},{12,73.2}}, color={255,
          0,255}));
  connect(booPul.y, natVentControlPlusNightFlushDynamicDuration.uOcc)
    annotation (Line(points={{-66,70},{-52,70},{-52,58},{12,58}}, color={255,0,255}));
  connect(booleanConstant.y, natVentControlPlusNightFlushDynamicDuration.uRai)
    annotation (Line(points={{-61,112},{-24,112},{-24,65.2},{12,65.2}}, color={255,
          0,255}));
  connect(InteriorSetpoint1.y, natVentControlPlusNightFlushDynamicDuration.uRooSet)
    annotation (Line(points={{-45.6,-2},{-40,-2},{-40,38.8},{12,38.8}}, color={0,
          0,127}));
  connect(ram.y, natVentControlPlusNightFlushDynamicDuration.uWinSpe)
    annotation (Line(points={{-12,4},{0,4},{0,10},{12,10}}, color={0,0,127}));
  connect(ramp.y, natVentControlPlusNightFlushDynamicDuration.uForHi)
    annotation (Line(points={{-7,-80},{2,-80},{2,26.8},{12,26.8}}, color={0,0,127}));
  connect(weaBus2.TWetBul, natVentControlPlusNightFlushDynamicDuration.uWetBul)
    annotation (Line(
      ...
      extent={{-6,3},{-6,3}},
      horizontalAlignment=TextAlignment.Right));
  connect(DummyAir.y, natVentControlPlusNightFlushDynamicDuration.uDryBul)
    annotation (Line(points={{-49.6,-64},{-50,-64},{-50,-62},{-8,-62},{-8,20},{12,
          20},{12,18.8}}, color={0,0,127}));
  connect(temRoom1.T, natVentControlPlusNightFlushDynamicDuration.uRooMeaTem)
    annotation (Line(points={{361,-80},{352,-80},{352,-96},{8,-96},{8,2},{12,2}},
        color={0,0,127}));
  annotation (experiment(Tolerance=1e-6, StartTime=0, StopTime=864000), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/NatVentControl/Validation/NatVenNitFluDyn_Interior.mos"
