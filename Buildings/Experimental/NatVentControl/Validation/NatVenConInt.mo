...
equation
  ...
  connect(natVentControl.yWinOpe, doo.y) annotation (Line(points={{149.8,17.16},
          {149.8,18},{176,18},{176,110},{197,110}}, color={0,0,127}));
  connect(booleanConstant.y, natVentControl.uManOveRid) annotation (Line(points=
         {{-77,110},{-20,110},{-20,67.04},{8.2,67.04}}, color={255,0,255}));
  connect(booleanConstant.y, natVentControl.uRai) annotation (Line(points={{-77,
          110},{-30,110},{-30,43.84},{8.2,43.84}}, color={255,0,255}));
  connect(booleanConstant1.y, natVentControl.uOcc) annotation (Line(points={{-77,
          48},{-40.5,48},{-40.5,32.24},{8.2,32.24}}, color={255,0,255}));
  connect(booleanConstant.y, natVentControl.uNitFlu) annotation (Line(points={{-77,
          110},{-40,110},{-40,55.44},{8.2,55.44}}, color={255,0,255}));
  connect(temRoom1.T, natVentControl.uRooMeaTem) annotation (Line(points={{361,-80},
          {-28,-80},{-28,-36.2},{8.2,-36.2}}, color={0,0,127}));
  connect(InteriorSetpoint1.y, natVentControl.uRooSet) annotation (Line(points={
          {-45.6,-4},{-12.8,-4},{-12.8,-1.4},{8.2,-1.4}}, color={0,0,127}));
  ...
  connect(DummyAir.y, natVentControl.uDryBul) annotation (Line(points={{-47.6,-72},
          {-16,-72},{-16,-13},{8.2,-13}}, color={0,0,127}));
  ...
  connect(weaBus2.TWetBul, natVentControl.uWetBul) annotation (Line(
      ...
      extent={{-3,6},{-3,6}},
      horizontalAlignment=TextAlignment.Right));
  connect(ram.y, natVentControl.uWinSpe) annotation (Line(points={{-18,-88},{-6,
          -88},{-6,-24.6},{8.2,-24.6}}, color={0,0,127}));
  connect(fixedTemperature.port, conBel3.port_a) annotation (Line(points={{530,62},
          {572,62},{572,-70},{512,-70},{512,-62},{454,-62},{454,-36}}, color={191,
          0,0}));
  connect(fixedTemperature.port, conBel1.port_b) annotation (Line(points={{530,62},
          {542,62},{542,-92},{436,-92},{436,-74}}, color={191,0,0}));
  annotation (experiment(Tolerance=1e-6, StopTime=172800), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/NatVentControl/Validation/NatVenConInt.mos"
