...
model NatVenNitFluFix_Interior
  ...
  NatVentNightFlushFix natVentControlPlusNightFlushFixedStop(
    TDryBulCut=273.15,
    TWetBulDif=0.02,
    winSpeLim=1000,
    TNitFluCut=273.15)
...
equation
  ...
  connect(natVentControlPlusNightFlushFixedStop.yWinOpe, doo.y) annotation (
      Line(points={{126.6,86},{151.5,86},{151.5,110},{197,110}}, color={0,0,127}));
  connect(booleanConstant.y, natVentControlPlusNightFlushFixedStop.uManOveRid)
    annotation (Line(points={{-61,112},{-16,112},{-16,116},{23.4,116}}, color={255,
          0,255}));
  connect(booleanConstant.y, natVentControlPlusNightFlushFixedStop.uRai)
    annotation (Line(points={{-61,112},{-16,112},{-16,106},{23.4,106}}, color={255,
          0,255}));
  connect(booPul.y, natVentControlPlusNightFlushFixedStop.uOcc) annotation (
      Line(points={{-66,70},{-22,70},{-22,97},{23.4,97}}, color={255,0,255}));
  connect(InteriorSetpoint1.y, natVentControlPlusNightFlushFixedStop.uRooSet)
    annotation (Line(points={{-45.6,-2},{-40,-2},{-40,73},{23.4,73}}, color={0,0,
          127}));
  connect(ramp.y, natVentControlPlusNightFlushFixedStop.uForHi) annotation (
      Line(points={{-27,-80},{-27,-82},{-8,-82},{-8,58},{23.4,58}}, color={0,0,127}));
  connect(DummyAir.y, natVentControlPlusNightFlushFixedStop.uDryBul)
    annotation (Line(points={{-49.6,-64},{-49.6,-52},{16,-52},{16,48},{23.4,48}},
        color={0,0,127}));
  connect(temRoom1.T, natVentControlPlusNightFlushFixedStop.uRooMeaTem)
    annotation (Line(points={{361,-80},{356,-80},{356,-92},{8,-92},{8,27},{23.4,
          27}}, color={0,0,127}));
  connect(ram.y, natVentControlPlusNightFlushFixedStop.uWinSpe) annotation (
      Line(points={{-12,4},{0,4},{0,37},{23.4,37}}, color={0,0,127}));
  connect(weaBus2.TWetBul, natVentControlPlusNightFlushFixedStop.uWetBul)
    annotation (Line(
