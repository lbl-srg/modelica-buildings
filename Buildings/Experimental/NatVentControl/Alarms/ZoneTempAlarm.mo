...
parameter Real TErr(min=0,
  ...
  Modelica.Blocks.Math.Add addErr(k2=-1) "Air temperature minus air setpoint"
...
equation
  connect(swi.y,intWitRes. u) annotation (Line(points={{42,-30},{58,-30}},
                                   color={0,0,127}));
  connect(not7.y,intWitRes. trigger) annotation (Line(points={{42,-130},{70,-130},
  ...
  connect(TRooSet, addErr.u2) annotation (Line(points={{-160,-60},{-122,-60},{-122,
          -36},{-102,-36}}, color={0,0,127}));
  connect(TRooMea, addErr.u1) annotation (Line(points={{-160,0},{-134,0},{-134,
...
<p> If the zone temperature is more than the user-specified difference out of range for more than the user-specified amount of time, the alarm is triggered. 
        ...
        Rectangle(
          ...
          lineColor={255,0,0},
          lineThickness=1,
          textString="Z")}), Diagram(coordinateSystem(preserveAspectRatio=false, extent={
            {-140,-160},{140,100}})));
end ZoneTempAlarm;
