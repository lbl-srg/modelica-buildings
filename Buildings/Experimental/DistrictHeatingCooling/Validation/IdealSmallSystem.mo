...
model IdealSmallSystem "Validation model for a small system"
  ...
  Buildings.Fluid.FixedResistances.SplitterPressureDrop spl(
    redeclare package Medium = Medium,
  ...
  Buildings.Fluid.FixedResistances.SplitterPressureDrop spl1(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal*{1,1,1},
    dp_nominal=40*R_nominal*{0,1,1},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
  ...
  Buildings.Fluid.FixedResistances.SplitterPressureDrop spl2(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal*{1,1,1},
    dp_nominal=40*R_nominal*{0,1,1},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
  ...
  Buildings.Fluid.FixedResistances.SplitterPressureDrop spl3(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal*{1,1,1},
    dp_nominal=40*R_nominal*{0,1,1},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
  ...
  Buildings.Fluid.FixedResistances.SplitterPressureDrop spl4(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal*{1,1,1},
    dp_nominal=40*R_nominal*{0,1,1},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
  ...
  Buildings.Fluid.FixedResistances.SplitterPressureDrop spl5(
    redeclare package Medium = Medium,
    m_flow_nominal=m_flow_nominal*{1,1,1},
    dp_nominal=40*R_nominal*{0,1,1},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
