...
model MainPump "Main pump controller"
  ...
  Buildings.Controls.OBC.CDL.Reals.MultiplyByParameter gai(final k=0)
    "Gain factor"
    annotation (Placement(transformation(extent={{60,70},{80,90}})));
  Buildings.Controls.OBC.CDL.Reals.MultiplyByParameter gai1(final k=2)
    "Gain factor"
    annotation (Placement(transformation(extent={{60,-110},{80,-90}})));
  Buildings.Controls.OBC.CDL.Reals.LessThreshold lesThr(h=0.05)
  ...
  Buildings.Controls.OBC.CDL.Reals.GreaterThreshold greThr(t=0.001, h=0.01)
  ...
  Buildings.Controls.OBC.CDL.Reals.MultiSum mulSum1(nin=nBui, k=fill(1,
        nBui))
