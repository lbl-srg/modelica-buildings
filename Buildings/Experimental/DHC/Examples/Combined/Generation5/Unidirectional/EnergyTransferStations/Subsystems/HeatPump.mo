within Buildings.Experimental.DHC.Examples.Combined.Generation5.Unidirectional.EnergyTransferStations.Subsystems;
model HeatPump
  ...
  Controls.OBC.CDL.Continuous.Gain gai1(k=m2_flow_nominal)
  ...
  Fluid.Sensors.TemperatureTwoPort senTConEnt(
    ...
    annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-40,-20})));
  Controls.OBC.CDL.Logical.Switch enaHeaPum
    "Enable heat pump by switching to actual set point"
    annotation (Placement(transformation(extent={{-140,10},{-120,30}})));
  Controls.OBC.CDL.Interfaces.RealOutput mEva_flow(final unit="kg/s")
