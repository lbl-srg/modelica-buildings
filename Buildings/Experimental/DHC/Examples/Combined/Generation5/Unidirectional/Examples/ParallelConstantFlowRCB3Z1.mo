...
model ParallelConstantFlowRCB3Z1
  ...
  extends BaseClasses.PartialParallel(
    redeclare each Loads.BuildingRCZ1WithETS bui,
    nBui=3,
    datDes(
...
equation
  ...
  coordinateSystem(preserveAspectRatio=false, extent={{-360,-260},{360,260}})),
    __Dymola_Commands(
  file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/DHC/Examples/Combined/Generation5/Unidirectional/Examples/ParallelConstantFlowRCB3Z1.mos"
  "Simulate and plot"),
  experiment(
    StopTime=604800,
    Tolerance=1e-06));
