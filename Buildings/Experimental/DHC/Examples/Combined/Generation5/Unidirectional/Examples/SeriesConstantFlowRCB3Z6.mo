...
model SeriesConstantFlowRCB3Z6
  ...
  extends BaseClasses.PartialSeries(
    redeclare Loads.BuildingRCZ6WithETS bui[nBui],
    nBui=3,
    datDes(
...
equation
  ...
  coordinateSystem(preserveAspectRatio=false, extent={{-360,-260},{360,260}})),
    __Dymola_Commands(
  file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/DHC/Examples/Combined/Generation5/Unidirectional/Examples/SeriesConstantFlowRCB3Z6.mos"
  "Simulate and plot"),
  experiment(
    StopTime=604800,
    Tolerance=1e-06));
