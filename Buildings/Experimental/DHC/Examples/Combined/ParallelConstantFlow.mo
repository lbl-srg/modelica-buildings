...
model ParallelConstantFlow
  ...
  extends Buildings.Experimental.DHC.Examples.Combined.BaseClasses.PartialParallel(
    redeclare
...
equation
  ...
  coordinateSystem(preserveAspectRatio=false, extent={{-360,-260},{360,260}})),
    __Dymola_Commands(
  file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/DHC/Examples/Combined/ParallelConstantFlow.mos"
  "Simulate and plot"),
  experiment(
      StopTime=604800,
      Tolerance=1e-06),
