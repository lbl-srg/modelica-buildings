...
equation
  connect(buiWitETS.port_b,watSin.ports[1])
    annotation (Line(points={{-20,2},{-12,2},{-12,30},{40,30}},color={0,127,255}));
  connect(watSou.ports[1],buiWitETS.port_a)
    annotation (Line(points={{40,-30},{-50,-30},{-50,2},{-40,2}},color={0,127,255}));
  annotation (
    Icon(
      coordinateSystem(
