...
equation
  ...
  connect(TDisSup.port_b,coo.port_a1)
    annotation (Line(points={{-20,50},{-16,50},{-16,-14},{-10,-14}},color={0,127,255}));
  connect(coo.port_b1,TDisRet.port_a)
    annotation (Line(points={{10,-14},{16,-14},{16,50},{20,50}},color={0,127,255}));
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/DHC/EnergyTransferStations/Cooling/Examples/CoolingIndirectOpenLoops.mos" "Simulate and plot"),
    experiment(
      StartTime=0,
      StopTime=86400,
      Tolerance=1e-06),
