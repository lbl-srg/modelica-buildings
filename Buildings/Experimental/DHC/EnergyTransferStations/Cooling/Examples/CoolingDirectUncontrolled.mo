...
model CoolingDirectUncontrolled
  ...
  Buildings.Experimental.DHC.EnergyTransferStations.Cooling.CoolingDirectUncontrolled coo(
...
equation
  ...
  connect(coo.port_a1,souDis.ports[1])
    annotation (Line(points={{-10,-44},{-20,-44},{-20,-10},{-80,-10}},color={0,127,255}));
  connect(sinDis.ports[1],coo.port_b2)
    annotation (Line(points={{-80,-90},{-20,-90},{-20,-56},{-10,-56}},color={0,127,255}));
  connect(loa.port_a,coo.port_b1)
    annotation (Line(points={{80,-10},{20,-10},{20,-44},{10,-44}},color={0,127,255}));
  connect(val.port_b,coo.port_a2)
    annotation (Line(points={{140,-10},{150,-10},{150,-90},{20,-90},{20,-56},{10,-56}},color={0,127,255}));
  annotation (
    Icon(
      coordinateSystem(
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/DHC/EnergyTransferStations/Cooling/Examples/CoolingDirectUncontrolled.mos" "Simulate and plot"),
    experiment(
      StartTime=0,
      StopTime=86400,
      Tolerance=1e-06),
