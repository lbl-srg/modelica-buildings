...
equation
  ...
  connect(senTBuiRet.T,con.u_m)
    annotation (Line(points={{70,-49},{70,-40},{54,-40},{54,-140},{-50,-140},{-50,-132}},color={0,0,127}));
  connect(one.y,add.u1)
    annotation (Line(points={{-59,-94},{-22,-94}},color={0,0,127}));
  connect(con.y,add.u2)
    annotation (Line(points={{-39,-120},{-30,-120},{-30,-106},{-22,-106}},color={0,0,127}));
...
<p align=\"center\">
<img src=\"modelica://Buildings/Resources/Images/Experimental/DHC/EnergyTransferStations/CoolingDirectControlledReturn.PNG\" alt=\"DHC.ETS.CoolingDirectControlledReturn\"/>
</p>
<h4>Reference</h4>
<p>
