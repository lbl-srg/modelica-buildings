...
model HeatPumpHeatExchangerDHWTank_Current
...
equation
  ...
  connect(toSub.y, heaFloEvaSHW.u2) annotation (Line(points={{-102,80},{-106,80},
          {-106,94},{-102,94}}, color={0,0,127}));
...
end HeatPumpHeatExchangerDHWTank_Current;
