...
block LimPlaySequence
  "Play hysteresis controllers in sequence"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput uEna if have_enaSig
    "Enable signal"
    annotation (Placement(transformation(extent={{-20,-20},{20,20}},rotation=90,origin={-40,-120}),iconTransformation(extent={{-20,-20},{20,20}},rotation=90,origin={-40,-120})));
  ...
  Experimental.DHC.EnergyTransferStations.Combined.Generation5.Controls.LimPlay conPla[nCon](
  ...
  Buildings.Controls.OBC.CDL.Routing.BooleanReplicator booRep(
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},rotation=90,origin={-80,-70})));
...
equation
  connect(reaRep.y,conPla.u_m)
    annotation (Line(points={{8.88178e-16,-58},{8.88178e-16,-34},{0,-34},{0,-12}},color={0,0,127}));
  connect(setOff.y,conPla.u_s)
    annotation (Line(points={{-69,0},{-12,0}},color={0,0,127}));
  connect(u_m,reaRep.u)
    annotation (Line(points={{0,-120},{0,-82},{-6.66134e-16,-82}},color={0,0,127}));
  connect(conPla.y,y)
    annotation (Line(points={{12,0},{120,0}},color={0,0,127}));
  connect(uEna,booRep.u)
    annotation (Line(points={{-40,-120},{-40,-90},{-80,-90},{-80,-82}},color={255,0,255}));
  connect(uEna,conPla[1].uEna)
    annotation (Line(points={{-40,-120},{-40,-20},{-6,-20},{-6,-12}},color={255,0,255}));
  ...
  connect(greEquThr.y,and2.u2)
    annotation (Line(points={{82,40},{90,40},{90,60},{-60,60},{-60,-54},{-72,-54},{-72,-52}},color={255,0,255}));
  connect(and2[1:nCon-1].y,conPla[2:nCon].uEna)
    annotation (Line(points={{-80,-28},{-80,-20},{-6,-20},{-6,-12}},color={255,0,255}));
  annotation (
    defaultComponentName="conPlaSeq",
    Icon(
      coordinateSystem(
...
<a href=\"modelica://Buildings.Experimental.DHC.EnergyTransferStations.Combined.Generation5.Controls.LimPlay\">
Buildings.Experimental.DHC.EnergyTransferStations.Combined.Generation5.Controls.LimPlay</a>
...
src=\"modelica://Buildings/Resources/Images/Experimental/DHC/EnergyTransferStations/Combined/Generation5/Controls/LimPlaySequence.png\"/>
</p>
<p>
See
<a href=\"modelica://Buildings.Experimental.DHC.EnergyTransferStations.Combined.Generation5.Controls.Validation.LimPlaySequence\">
Buildings.Experimental.DHC.EnergyTransferStations.Combined.Generation5.Controls.Validation.LimPlaySequence</a>
