...
equation
  connect(min.u1,TTop)
    annotation (Line(points={{-92,-34},{-120,-34},{-120,-40},{-200,-40}},color={0,0,127}));
  connect(min.u2,TBot)
    annotation (Line(points={{-92,-46},{-120,-46},{-120,-140},{-200,-140}},color={0,0,127}));
  connect(min.y,errDis.u2)
    annotation (Line(points={{-68,-40},{-60,-40},{-60,-12}},color={0,0,127}));
  connect(TTop,errEna.u2)
    annotation (Line(points={{-200,-40},{-120,-40},{-120,20},{-80,20},{-80,28}},color={0,0,127}));
  connect(TBot,swi.u1)
    annotation (Line(points={{-200,-140},{-120,-140},{-120,-172},{-92,-172}},color={0,0,127}));
...
src=\"modelica://Buildings/Resources/Images/Experimental/DHC/EnergyTransferStations/Combined/Generation5/Controls/SideHot1.png\"/>
</p>
</html>"));
end SideHot1;
