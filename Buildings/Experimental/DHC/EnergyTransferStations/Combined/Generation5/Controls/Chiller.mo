...
model Chiller
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput uCoo
    ...
    annotation (Placement(transformation(extent={{-200,20},{-160,60}}),iconTransformation(extent={{-140,40},{-100,80}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput uHea
    "Heating mode enabled signal"
    annotation (Placement(transformation(extent={{-200,60},{-160,100}}),iconTransformation(extent={{-140,60},{-100,100}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput THeaWatSupSet(
    final unit="K",
    displayUnit="degC") if have_res
    "Heating water supply temperature set point"
    annotation (Placement(transformation(extent={{-200,-100},{-160,-60}}),iconTransformation(extent={{-140,20},{-100,60}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TChiWatSupPreSet(
    final unit="K",
    displayUnit="degC")
    "Chilled water supply temperature set point"
    annotation (Placement(transformation(extent={{-200,-60},{-160,-20}}),iconTransformation(extent={{-140,0},{-100,40}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput THeaWatSup(
    final unit="K",
    displayUnit="degC") if have_res
    "Heating water supply temperature"
    annotation (Placement(transformation(extent={{-200,-140},{-160,-100}}),iconTransformation(extent={{-140,-20},{-100,20}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TConWatEnt(
    final unit="K",
    displayUnit="degC")
    "Condenser water entering temperature"
    annotation (Placement(transformation(extent={{-200,-320},{-160,-280}}),iconTransformation(extent={{-140,-60},{-100,-20}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TEvaWatEnt(
    final unit="K",
    displayUnit="degC")
    "Evaporator water entering temperature"
    annotation (Placement(transformation(extent={{-200,-260},{-160,-220}}),iconTransformation(extent={{-140,-40},{-100,0}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput TChiWatSupSet(
    final unit="K",
    displayUnit="degC")
    "Chilled water supply temperature set point"
    annotation (Placement(transformation(extent={{160,-60},{200,-20}}),iconTransformation(extent={{100,20},{140,60}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yValCon
    "Condenser mixing valve control signal"
    annotation (Placement(transformation(extent={{160,-300},{200,-260}}),iconTransformation(extent={{100,-100},{140,-60}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yValEva
    "Evaporator mixing valve control signal"
    annotation (Placement(transformation(extent={{160,-240},{200,-200}}),iconTransformation(extent={{100,-60},{140,-20}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput yChi
    "Chiller enabled signal"
    annotation (Placement(transformation(extent={{160,40},{200,80}}),iconTransformation(extent={{100,60},{140,100}})));
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant tru(
    k=false) if not have_res
    "Always true"
    annotation (Placement(transformation(extent={{30,-30},{50,-10}})));
  Modelica.Blocks.Routing.BooleanPassThrough booThr if have_res
    "Pass through uHea if have_res"
    annotation (Placement(transformation(extent={{30,70},{50,90}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant dum(
    k=0) if not have_res
    "Dummy u2 value if not have_res"
    annotation (Placement(transformation(extent={{30,-170},{50,-150}})));
equation
  connect(swi2.y,TChiWatSupSet)
    annotation (Line(points={{152,-40},{180,-40}},color={0,0,127}));
  connect(x1.y,mapFun2.x1)
    annotation (Line(points={{52,-60},{80,-60},{80,-72},{88,-72}},color={0,0,127}));
  connect(x2.y,mapFun2.x2)
    annotation (Line(points={{52,-96},{60,-96},{60,-84},{88,-84}},color={0,0,127}));
  ...
  connect(heaOrCoo.y,conValEva.trigger)
    annotation (Line(points={{-78,0},{-40,0},{-40,-236},{52,-236},{52,-232}},color={255,0,255}));
  connect(heaOrCoo.y,conValCon.trigger)
    annotation (Line(points={{-78,0},{-40,0},{-40,-296},{52,-296},{52,-292}},color={255,0,255}));
  ...
  connect(minTChiWatSup.y,mapFun2.f2)
    annotation (Line(points={{52,-128},{64,-128},{64,-88},{88,-88}},color={0,0,127}));
  connect(THeaWatSupSet,conPID.u_s)
    annotation (Line(points={{-180,-80},{-92,-80}},color={0,0,127}));
  connect(THeaWatSup,conPID.u_m)
    annotation (Line(points={{-180,-120},{-80,-120},{-80,-92}},color={0,0,127}));
  connect(conPID.y,mapFun2.u)
    annotation (Line(points={{-68,-80},{88,-80}},color={0,0,127}));
  connect(uHea,conPID.trigger)
    annotation (Line(points={{-180,80},{-140,80},{-140,-100},{-86,-100},{-86,-92}},color={255,0,255}));
  connect(TChiWatSupPreSet,mapFun2.f1)
    annotation (Line(points={{-180,-40},{20,-40},{20,-76},{88,-76}},color={0,0,127}));
  connect(conValEva.y,actVal.u1)
    annotation (Line(points={{71,-220},{100,-220},{100,-228},{118,-228}},color={0,0,127}));
  connect(conValCon.y,actVal1.u1)
    annotation (Line(points={{71,-280},{100,-280},{100,-288},{118,-288}},color={0,0,127}));
  connect(x1.y,actVal.u3)
    annotation (Line(points={{52,-60},{80,-60},{80,-212},{118,-212}},color={0,0,127}));
  connect(x1.y,actVal1.u3)
    annotation (Line(points={{52,-60},{80,-60},{80,-272},{118,-272}},color={0,0,127}));
  connect(heaOrCoo.y,actVal.u2)
    annotation (Line(points={{-78,0},{-40,0},{-40,-200},{110,-200},{110,-220},{118,-220}},color={255,0,255}));
  connect(heaOrCoo.y,actVal1.u2)
    annotation (Line(points={{-78,0},{-40,0},{-40,-200},{110,-200},{110,-280},{118,-280}},color={255,0,255}));
  connect(actVal.y,yValEva)
    annotation (Line(points={{142,-220},{150,-220},{150,-220},{180,-220}},color={0,0,127}));
  connect(actVal1.y,yValCon)
    annotation (Line(points={{142,-280},{180,-280}},color={0,0,127}));
  connect(TChiWatSupPreSet,swi2.u3)
    annotation (Line(points={{-180,-40},{100,-40},{100,-32},{128,-32}},color={0,0,127}));
  connect(mapFun2.y,swi2.u1)
    annotation (Line(points={{112,-80},{120,-80},{120,-48},{128,-48}},color={0,0,127}));
  connect(tru.y,swi2.u2)
    annotation (Line(points={{52,-20},{110,-20},{110,-40},{128,-40}},color={255,0,255}));
  connect(uHea,booThr.u)
    annotation (Line(points={{-180,80},{28,80}},color={255,0,255}));
  connect(booThr.y,swi2.u2)
    annotation (Line(points={{51,80},{120,80},{120,-40},{128,-40}},color={255,0,255}));
  connect(dum.y,swi2.u1)
    annotation (Line(points={{52,-160},{120,-160},{120,-48},{128,-48}},color={0,0,127}));
  annotation (
    Icon(
      coordinateSystem(
