...
model HeatExchanger
  ...
  DHC.EnergyTransferStations.BaseClasses.Pump_m_flow pum1Hex(
    ...
    "District heat exchanger primary pump" annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-60,80})));
  DHC.EnergyTransferStations.BaseClasses.Pump_m_flow pum2Hex(
  ...
  Fluid.Actuators.Valves.TwoWayPressureIndependent       val1Hex(
    redeclare final package Medium = Medium1,
    final m_flow_nominal=m1_flow_nominal,
    from_dp=true,
  ...
  Buildings.Fluid.Actuators.Valves.ThreeWayEqualPercentageLinear val2Hex(
    redeclare final package Medium = Medium2,
    ...
    final dpFixed_nominal=fill(dp2Hex_nominal, 2)) "Control valve" annotation (
      Placement(transformation(
        ...
        rotation=0,
        origin={80,-60})));
  DHC.EnergyTransferStations.BaseClasses.Junction spl(redeclare final package
      Medium = Medium2, final m_flow_nominal=m2_flow_nominal .* {1,-1,-1})
