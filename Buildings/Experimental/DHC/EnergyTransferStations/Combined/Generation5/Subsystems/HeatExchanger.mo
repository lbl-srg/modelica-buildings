...
model HeatExchanger
  ...
  Experimental.DHC.EnergyTransferStations.Combined.Generation5.Controls.HeatExchanger
    ...
    final k=k,
    final Ti=Ti) "District heat exchanger loop controller"
...
equation
  ...
  connect(con.y1Hex, gai1.u) annotation (Line(points={{-48,166},{0,166},{0,120},
  ...
  connect(yValIso_actual, con.yValIso) annotation (Line(points={{-120,100},{-92,
          100},{-92,163},{-72,163}}, color={0,0,127}));
  connect(con.yPum2Hex, gai2.u)
    annotation (Line(points={{-48,160},{40,160},{40,130}}, color={0,0,127}));
  connect(u, con.u) annotation (Line(points={{-120,140},{-96,140},{-96,168},{-72,
          168}}, color={0,0,127}));
  ...
  connect(con.yVal2Hex, val2Hex.y) annotation (Line(points={{-48,154},{64,154},
          {64,-40},{80,-40},{80,-48}}, color={0,0,127}));
  connect(senT1HexWatLvg.T, con.T1HexWatLvg) annotation (Line(points={{9,20},{-76,
          20},{-76,152},{-72,152}}, color={0,0,127}));
  connect(senT1HexWatEnt.T, con.T1HexWatEnt) annotation (Line(points={{-31,40},
