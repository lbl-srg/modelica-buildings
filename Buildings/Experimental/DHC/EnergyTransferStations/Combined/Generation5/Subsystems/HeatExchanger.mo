...
model HeatExchanger
  ...
  // COMPONENTS
  Experimental.DHC.EnergyTransferStations.Combined.Generation5.Controls.HeatExchanger conHex(
    final conCon=conCon,
