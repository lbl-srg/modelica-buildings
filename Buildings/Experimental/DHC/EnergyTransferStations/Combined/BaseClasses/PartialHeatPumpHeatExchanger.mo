...
model PartialHeatPumpHeatExchanger
  ...
  Buildings.Controls.OBC.CDL.Continuous.MultiSum PPumHeaTot(nin=2)
  ...
  Buildings.Controls.OBC.CDL.Continuous.MultiSum masFloHeaTot(nin=2)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Add masFloHea
    ...
    annotation (
      Placement(transformation(
        ...
        rotation=-90,
        origin={0,-264})));
  Buildings.Controls.OBC.CDL.Continuous.MultiSum PHeaTot(nin=2)
