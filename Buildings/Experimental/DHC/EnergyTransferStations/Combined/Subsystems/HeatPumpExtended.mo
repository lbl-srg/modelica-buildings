...
model HeatPumpExtended "Base subsystem with water-to-water heat pump"
  extends Buildings.Experimental.DHC.EnergyTransferStations.Combined.Subsystems.BaseClasses.HeatPump(heaPum(
