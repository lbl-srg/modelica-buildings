within Buildings.Experimental.DHC.EnergyTransferStations.BaseClasses.Validation;
model CollectorDistributor
  ...
  Fluid.Sensors.TemperatureTwoPort senT1Ret(
    redeclare final package Medium=Medium,
    m_flow_nominal=m_flow_nominal)
  ...
  Buildings.Experimental.DHC.EnergyTransferStations.BaseClasses.CollectorDistributor colDis(
    redeclare final package Medium=Medium,
  ...
  Fluid.Sensors.TemperatureTwoPort senT2_2Sup1(
    redeclare final package Medium=Medium,
    m_flow_nominal=m_flow_nominal)
    "Secondary supply temperature (measured)"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},rotation=0,origin={60,-80})));
  Fluid.Sensors.TemperatureTwoPort senT2_2Ret1(
    redeclare final package Medium=Medium,
    m_flow_nominal=m_flow_nominal)
    "Secondary return temperature (measured)"
  ...
  Buildings.Experimental.DHC.EnergyTransferStations.BaseClasses.CollectorDistributor colDis1(
    redeclare final package Medium=Medium,
    mCon_flow_nominal=fill(
      m_flow_nominal,
      2),
  ...
  Fluid.Sensors.TemperatureTwoPort senT2_2Sup2(
    redeclare final package Medium=Medium,
    m_flow_nominal=m_flow_nominal)
    "Secondary supply temperature (measured)"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},rotation=0,origin={60,-360})));
  Fluid.Sensors.TemperatureTwoPort senT2_2Ret2(
    redeclare final package Medium=Medium,
    m_flow_nominal=m_flow_nominal)
    "Secondary return temperature (measured)"
  ...
  Buildings.Experimental.DHC.EnergyTransferStations.BaseClasses.CollectorDistributor colDis2(
    redeclare final package Medium=Medium,
    mCon_flow_nominal=fill(
      m_flow_nominal,
      2),
...
equation
  ...
  connect(senT1Ret.port_b,bou1.ports[2])
  ...
  connect(senT1Sup.port_b,colDis.port_aDisSup)
    annotation (Line(points={{-90,340},{-80,340},{-80,320},{-60,320}},color={0,127,255}));
  connect(senT1Ret.port_a,colDis.port_bDisRet)
  ...
  connect(colDis.port_bDisSup,colDis.port_aDisRet)
    annotation (Line(points={{-20,320},{-10,320},{-10,314},{-20,314}},color={0,127,255}));
  connect(m2.y,sou2.m_flow_in)
    annotation (Line(points={{-218,100},{-160,100},{-160,72}},color={0,0,127}));
  ...
  connect(senT2_1Ret1.T,conTChiWat3.u_m)
  ...
  connect(senT2_2Ret1.T,conTChiWat4.u_m)
  ...
  connect(senT2_1Ret2.T,conTChiWat5.u_m)
  ...
  connect(senT2_2Ret2.T,conTChiWat6.u_m)
  ...
  connect(senT1Ret2.port_b,bou3.ports[1])
    annotation (Line(points={{-110,-260},{-180,-260},{-180,-238}},color={0,127,255}));
  ...
  connect(colDis2.ports_bCon[1],senT2_1Sup2.port_a)
    annotation (Line(points={{-48,-230},{-40,-230},{-40,-200},{44,-200},{44,-220},{50,-220}},color={0,127,255}));
  connect(colDis2.ports_bCon[2],senT2_2Sup2.port_a)
    annotation (Line(points={{-56,-230},{-56,-204},{40,-204},{40,-360},{50,-360}},color={0,127,255}));
  connect(senT2_1Ret2.port_b,colDis2.ports_aCon[1])
    annotation (Line(points={{50,-260},{24,-260},{24,-220},{-14,-220},{-14,-230},{-24,-230}},color={0,127,255}));
  connect(senT2_2Ret2.port_b,colDis2.ports_aCon[2])
    annotation (Line(points={{50,-400},{20,-400},{20,-224},{-32,-224},{-32,-230}},color={0,127,255}));
  connect(bou3.ports[2],senMasFlo3.port_a)
    annotation (Line(points={{-180,-242},{-180,-220},{-140,-220}},color={0,127,255}));
  connect(senT1Sup2.port_b,colDis2.port_aDisSup)
    annotation (Line(points={{-90,-220},{-80,-220},{-80,-240},{-60,-240}},color={0,127,255}));
  connect(senT1Ret2.port_a,colDis2.port_bDisRet)
