...
model EnergyMassFlowInterface "Validation of the model EnergyMassFlowInterface"
  ...
  Buildings.Experimental.DHC.Loads.EnergyMassFlowInterface eneMasFlo(
    ...
    "Model driving energy and mass flow rate "
...
equation
  ...
  annotation (Diagram(
      ...
      Tolerance=1e-06),
      __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/DHC/Loads/Validation/EnergyMassFlowInterface.mos"
      "Simulate and plot"),
    Documentation(info="<html>
<p>
This is a validation model for
<a href=\"modelica://Buildings.Experimental.DHC.Loads.EnergyMassFlowInterface\">
Buildings.Experimental.DHC.Loads.EnergyMassFlowInterface</a>.
</p>
<p>
In the first case
