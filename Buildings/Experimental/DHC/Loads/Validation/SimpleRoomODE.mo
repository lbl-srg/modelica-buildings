...
equation
  ...
  connect(gai.y, prescribedHeatFlow.Q_flow) annotation (Line(points={{82,120},{126,
          120},{126,140},{82,140}},
                               color={0,0,127}));
  ...
  connect(gai2.y, rooOdeCoo.QReq_flow) annotation (Line(points={{82,-100},{126,-100},
          {126,-34},{-20,-34},{-20,-20},{-12,-20}},
                              color={0,0,127}));
  connect(prescribedHeatFlow1.port,romHeaUnm. port_a) annotation (Line(points={{62,80},
          {0,80},{0,70}},                        color={191,0,0}));
  connect(gai2.y, gai3.u) annotation (Line(points={{82,-100},{86,-100},{86,-80},
          {90,-80}},  color={0,0,127}));
  connect(gai3.y, rooOdeCoo.QAct_flow) annotation (Line(points={{114,-80},{120,-80},
          {120,-40},{-14,-40},{-14,-28},{-12,-28}},
                                   color={0,0,127}));
  connect(weaDat.weaBus, romHeaUnm.weaBus) annotation (Line(
      points={{-120,100},{-20,100},{-20,59.8},{-6,59.8}},
      color={255,204,51},
      thickness=0.5));
  connect(weaDat1.weaBus, romCooMet.weaBus) annotation (Line(
      points={{-120,-100},{-20,-100},{-20,-120.2},{-6,-120.2}},
      color={255,204,51},
      thickness=0.5));
  connect(weaDat1.weaBus, romCooUnm.weaBus) annotation (Line(
      points={{-120,-100},{-20,-100},{-20,-80.2},{-6,-80.2}},
      color={255,204,51},
      thickness=0.5));
  connect(romCooMet.TAir, conCoo.u_m)
    annotation (Line(points={{11,-120},{40,-120},{40,-112}}, color={0,0,127}));
  connect(gai.y, gai1.u) annotation (Line(points={{82,120},{86,120},{86,100},{90,
          100}}, color={0,0,127}));
  connect(gai.y, rooOdeHea.QReq_flow) annotation (Line(points={{82,120},{126,120},
          {126,0},{-20,0},{-20,20},{-12,20}}, color={0,0,127}));
  connect(gai3.y, prescribedHeatFlow2.Q_flow) annotation (Line(points={{114,-80},
          {120,-80},{120,-60},{80,-60}}, color={0,0,127}));
