...
model FanCoil2PipeCoolingWet_IBPSA "Model of a sensible only two-pipe fan coil unit for cooling,
  ...
  Buildings.Fluid.HeatExchangers.WetCoilEffectivesnessNTU hex(
...
end FanCoil2PipeCoolingWet_IBPSA;
