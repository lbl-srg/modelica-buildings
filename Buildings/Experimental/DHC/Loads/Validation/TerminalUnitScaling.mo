...
model TerminalUnitScaling
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TSet(
    k=293.15,
    y(
      final unit="K",
      displayUnit="degC"))
...
equation
  ...
  connect(ter.port_bHeaWat,sinHeaWat.ports[1])
    annotation (Line(points={{32,80},{60,80},{60,2.66667},{80,2.66667}},color={0,127,255}));
  connect(terUniMul.port_bHeaWat,sinHeaWat.ports[2])
    annotation (Line(points={{30,-20},{60,-20},{60,-2.22045e-16},{80,-2.22045e-16}},color={0,127,255}));
  ...
  connect(terUniMul.mReqHeaWat_flow,supHeaWat1.m_flow_in)
    annotation (Line(points={{31,-14},{40,-14},{40,-40},{-80,-40},{-80,-12},{-62,-12}},color={0,0,127}));
  ...
  connect(ram.y,terUniMul.QReqHea_flow)
    annotation (Line(points={{-78,20},{0,20},{0,-12},{5,-12}},color={0,0,127}));
  connect(TSet.y,ter.TSetHea)
    annotation (Line(points={{-78,60},{-20,60},{-20,96},{7,96}},color={0,0,127}));
  connect(TSet.y,terUniMul.TSetHea)
    annotation (Line(points={{-78,60},{-20,60},{-20,-4},{5,-4}},color={0,0,127}));
  ...
  connect(TSet.y,terUniMulZonMul.TSetHea)
    annotation (Line(points={{-78,60},{-20,60},{-20,-64},{7,-64}},color={0,0,127}));
  connect(ram.y,terUniMulZonMul.QReqHea_flow)
    annotation (Line(points={{-78,20},{0,20},{0,-72},{7,-72}},color={0,0,127}));
  connect(terUniMulZonMul.mReqHeaWat_flow,supHeaWat2.m_flow_in)
    annotation (Line(points={{33,-74},{40,-74},{40,-100},{-80,-100},{-80,-72},{-62,-72}},color={0,0,127}));
  annotation (
    experiment(
      StopTime=1000,
      Tolerance=1e-06),
