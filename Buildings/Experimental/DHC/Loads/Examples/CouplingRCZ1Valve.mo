...
equation
  ...
  connect(bui.ports_bChiWat[1], sinChiWat.ports[1]) annotation (Line(points={{40,
          44},{60,44},{60,20},{120,20}}, color={0,127,255}));
  annotation (
  experiment(
      StopTime=604800,
      Tolerance=1e-06),
...
First implementation.
  ...
  __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Experimental/DHC/Loads/Examples/CouplingRCZ1Valve.mos"
        "Simulate and plot"));
