...
model BuildingTimeSeriesWet_IBPSA
  ...
  Validation.BaseClasses.FanCoil2PipeCoolingWet_IBPSA terUniCoo(
    redeclare final package Medium1 = Medium,
    redeclare final package Medium2 = Medium2,
    ...
    final tau=tau,
    final use_inputFilter=use_inputFilter,
    final riseTime=riseTime) "Cooling terminal unit"
...
First implementation.
            ...
            {300,300}})));
end BuildingTimeSeriesWet_IBPSA;
