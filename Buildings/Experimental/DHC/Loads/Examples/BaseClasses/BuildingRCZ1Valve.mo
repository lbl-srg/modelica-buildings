...
equation
  ...
  connect(disFloHea.QActTot_flow,mulQHea_flow.u)
    annotation (Line(points={{-79,-116},{210,-116},{210,280},{268,280}},color={0,0,127}));
  connect(disFloCoo.QActTot_flow,mulQCoo_flow.u)
    annotation (Line(points={{-79,-156},{214,-156},{214,240},{268,240}},color={0,0,127}));
  connect(terUni.PFan,mulPFan.u)
    annotation (Line(points={{-139.167,-48},{206,-48},{206,120},{268,120}},color={0,0,127}));
  annotation (
    Documentation(
      info="
<html>
