...
model CouplingTimeSeries_Hospital
  "Example illustrating the coupling of a hospital building model to heating water and chilled water loops"
  ...
  Buildings.Experimental.DHC.Loads.Examples.BaseClasses.BuildingTimeSeries bui(
    ...
    nPorts_aChiWat=1,
    nPorts_bChiWat=1)
    "Hospital with time series heating and cooling loads."
...
equation
  ...
  annotation (
    ...
    Documentation(
      info="<html>
<p>
This example demonstrates the hydraulic connection between a hospital's heating and cooling
loads provided as time series to infinite sources of district heating and cooling.
</p>
</html>",
      revisions="<html>
<ul>
