...
First implementation.
  ...
  Diagram(
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Experimental/DHC/Loads/Examples/CouplingSpawnZ6Wet_IBPSA.mos"
        "Simulate and plot"));
end CouplingSpawnZ6Wet_IBPSA;
