...
model CouplingTimeSeries_PrimarySchool
  "Example illustrating the coupling of a school building model to heating water and chilled water loops"
  ...
  Buildings.Experimental.DHC.Loads.Examples.BaseClasses.BuildingTimeSeries bui(
    filNam="modelica://Buildings/Resources/Data/Experimental/DHC/Loads/Examples/primaryschool-3C-2013.mos",
    delTAirCoo(
      displayUnit="degC")=6,
    delTAirHea(
      displayUnit="degC")=18,
    ...
    nPorts_bHeaWat=1,
    nPorts_bChiWat=1)
    "School building with time series heating and cooling loads."
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/DHC/Loads/Examples/CouplingTimeSeries_PrimarySchool.mos" "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=604800),
    Documentation(
      info="<html>
<p>
This example demonstrates the hydraulic connection between a DOE-reference primary school 
...
end CouplingTimeSeries_PrimarySchool;
