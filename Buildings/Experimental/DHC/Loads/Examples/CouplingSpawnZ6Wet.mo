...
First implementation.
  ...
  Diagram(
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Experimental/DHC/Loads/Examples/CouplingSpawnZ6Wet.mos"
        "Simulate and plot"));
end CouplingSpawnZ6Wet;
