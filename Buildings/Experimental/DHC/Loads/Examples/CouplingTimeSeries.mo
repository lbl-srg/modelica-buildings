...
equation
  ...
  connect(supHeaWat.ports[1],bui.ports_aHeaWat[1])
    annotation (Line(points={{-40,20},{0,20},{0,2},{10,2}},color={0,127,255}));
  connect(supChiWat.ports[1],bui.ports_aChiWat[1])
    annotation (Line(points={{-40,-20},{0,-20},{0,-2},{10,-2}},
                                                             color={0,127,255}));
  connect(bui.ports_bHeaWat[1],sinHeaWat.ports[1])
    annotation (Line(points={{30,2},{60,2},{60,20},{120,20}},color={0,127,255}));
  connect(sinChiWat.ports[1],bui.ports_bChiWat[1])
    annotation (Line(points={{120,-20},{60,-20},{60,-2},{30,-2}},
                                                               color={0,127,255}));
  connect(bui.QHea_flow,EHeaAct.u)
    annotation (Line(points={{30.6667,12.6667},{40,12.6667},{40,60},{90,60},{90,
          80},{98,80}},                                                                      color={0,0,127}));
  connect(bui.QReqHea_flow,EHeaReq.u)
    annotation (Line(points={{26.6667,-7.33333},{26.6667,-8},{36,-8},{36,80},{
          58,80}},                                                                    color={0,0,127}));
  connect(bui.QReqCoo_flow,ECooReq.u)
    annotation (Line(points={{28,-7.33333},{28,-60},{58,-60}},          color={0,0,127}));
  connect(bui.QCoo_flow,ECooAct.u)
    annotation (Line(points={{30.6667,11.3333},{40,11.3333},{40,-40},{90,-40},{
          90,-60},{98,-60}},                                                                     color={0,0,127}));
  connect(bui.QReqHea_flow,QAveHeaReq_flow.u)
    annotation (Line(points={{26.6667,-7.33333},{26.6667,-7.90323},{35.9677,
  ...
  connect(bui.QReqCoo_flow,QAveCooReq_flow.u)
    annotation (Line(points={{28,-7.33333},{28.6316,-7.33333},{28.6316,-100},{
