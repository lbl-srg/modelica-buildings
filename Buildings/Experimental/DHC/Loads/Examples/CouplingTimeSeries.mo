...
equation
  ...
  connect(bui.QReqHea_flow,EHeaReq.u)
    annotation (Line(points={{26.6667,-4.66667},{26.6667,-8},{36,-8},{36,80},{
          58,80}},                                                                    color={0,0,127}));
  ...
  connect(bui.QReqHea_flow,QAveHeaReq_flow.u)
    annotation (Line(points={{26.6667,-4.66667},{26.6667,-7.90323},{35.9677,
  ...
  connect(bui.QReqCoo_flow,QAveCooReq_flow.u)
    annotation (Line(points={{28.6667,-4.66667},{28.6316,-4.66667},{28.6316,-60},
