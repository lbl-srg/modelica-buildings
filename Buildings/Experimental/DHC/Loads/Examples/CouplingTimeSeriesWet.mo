...
model CouplingTimeSeriesWet
  ...
  BaseClasses.BuildingTimeSeriesWet bui(
...
First implementation.
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/DHC/Loads/Examples/CouplingTimeSeriesWet.mos"
        "Simulate and plot"));
end CouplingTimeSeriesWet;
