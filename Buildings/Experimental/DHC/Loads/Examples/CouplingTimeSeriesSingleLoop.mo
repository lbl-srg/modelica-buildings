...
equation
  connect(TChiWatSup.y,supChiWat. T_in) annotation (Line(points={{-119,108},{-82,
          108}}, color={0,0,127}));
  ...
  connect(buiCoo.QReqCoo_flow, ECooReq.u) annotation (Line(points={{8.66667,
          99.3333},{8.66667,70},{38,70}},
                                 color={0,0,127}));
  connect(buiCoo.QReqCoo_flow, QAveCooReq_flow.u) annotation (Line(points={{8.66667,
          99.3333},{8.66667,30},{38,30}}, color={0,0,127}));
  connect(buiCoo.QCoo_flow, ECooAct.u) annotation (Line(points={{10.6667,
          117.333},{70,117.333},{70,70},{78,70}},
                                         color={0,0,127}));
  connect(buiCoo.QCoo_flow, QAveCooAct_flow.u) annotation (Line(points={{10.6667,
          117.333},{70,117.333},{70,30},{78,30}}, color={0,0,127}));
  ...
  connect(buiHea.QReqHea_flow, EHeaReq.u) annotation (Line(points={{6.66667,
          -20.6667},{6.66667,-60},{38,-60}},
                                   color={0,0,127}));
  connect(buiHea.QReqHea_flow, QAveHeaReq_flow.u) annotation (Line(points={{6.66667,
          -20.6667},{6.66667,-100},{38,-100}}, color={0,0,127}));
  connect(buiHea.QHea_flow, EHeaAct.u) annotation (Line(points={{10.6667,
          -1.33333},{70,-1.33333},{70,-60},{78,-60}},
                                            color={0,0,127}));
  connect(buiHea.QHea_flow, QAveHeaAct_flow.u) annotation (Line(points={{10.6667,
          -1.33333},{70,-1.33333},{70,-100},{78,-100}}, color={0,0,127}));
