...
model CouplingTimeSeriesWet_IBPSA
  ...
  BaseClasses.BuildingTimeSeriesWet_IBPSA bui(
...
First implementation.
  ...
  __Dymola_Commands(
    file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/DHC/Loads/Examples/CouplingTimeSeriesWet_IBPSA.mos"
    "Simulate and plot"));
end CouplingTimeSeriesWet_IBPSA;
