...
model ETS
  ...
  Fluid.Sources.Boundary_pT sinSerHeaSup(
    ...
    nPorts=1) if typ <> DHC.Types.DistrictSystemType.Cooling and typ <> DHC.Types.DistrictSystemType.CombinedGeneration5
    "Sink for service supply"
...
equation
  ...
  connect(souPCoo.y,PCoo)
    annotation (Line(points={{282,20},{302,20},{302,40},{320,40}},color={0,0,127}));
  connect(souPFan.y,PFan)
    annotation (Line(points={{282,-20},{302,-20},{302,0},{320,0}},color={0,0,127}));
  connect(souPPum.y,PPum)
    annotation (Line(points={{282,-60},{302,-60},{302,-40},{320,-40}},color={0,0,127}));
