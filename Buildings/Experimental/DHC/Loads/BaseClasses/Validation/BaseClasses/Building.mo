...
equation
  ...
  connect(loaHea.port_b,mulHeaWatOut[1].port_a)
    annotation (Line(points={{10,-60},{136,-60},{136,-60},{260,-60}},color={0,127,255}));
  connect(loaCoo.port_b,mulChiWatOut[1].port_a)
    annotation (Line(points={{10,-260},{260,-260},{260,-260}},color={0,127,255}));
  connect(mulChiWatInl[1].port_b,loaCoo.port_a)
    annotation (Line(points={{-260,-260},{-136,-260},{-136,-260},{-10,-260}},color={0,127,255}));
  connect(loaHea.Q_flow,addPar.u)
    annotation (Line(points={{11,-54},{20,-54},{20,-40},{28,-40}},color={0,0,127}));
  connect(loaCoo.Q_flow,addPar1.u)
    annotation (Line(points={{11,-254},{20,-254},{20,-240},{28,-240}},color={0,0,127}));
  connect(addPar.y,mulQHea_flow.u)
    annotation (Line(points={{52,-40},{80,-40},{80,280},{268,280}},color={0,0,127}));
  connect(addPar1.y,mulQCoo_flow.u)
    annotation (Line(points={{52,-240},{100,-240},{100,240},{268,240}},color={0,0,127}));
  connect(one.y,loaHea.u)
    annotation (Line(points={{-58,-160},{-40,-160},{-40,-54},{-12,-54}},color={0,0,127}));
  connect(one.y,loaCoo.u)
    annotation (Line(points={{-58,-160},{-40,-160},{-40,-254},{-12,-254}},color={0,0,127}));
  annotation (
    Icon(
      coordinateSystem(
