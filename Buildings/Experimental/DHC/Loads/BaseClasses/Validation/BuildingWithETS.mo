...
model BuildingWithETS
  ...
  Networks.BaseClasses.DifferenceEnthalpyFlowRate senDifEntFlo8(
    redeclare final package Medium1=MediumW,
    final m_flow_nominal=m_flow_nominal)
    "Change in enthalpy flow rate "
  ...
  Networks.BaseClasses.DifferenceEnthalpyFlowRate senDifEntFlo9(
    redeclare final package Medium1=MediumW,
    final m_flow_nominal=m_flow_nominal)
    "Change in enthalpy flow rate "
  ...
  Networks.BaseClasses.DifferenceEnthalpyFlowRate senDifEntFlo10(
    redeclare final package Medium1=MediumW,
    final m_flow_nominal=m_flow_nominal)
    "Change in enthalpy flow rate "
...
equation
  ...
  connect(senDifEntFlo1.port_b2,sinDisRet1.ports[1])
    annotation (Line(points={{-200,-20},{-212,-20},{-212,-40},{-220,-40}},color={0,127,255}));
  connect(souDisSup2.ports[1],senDifEntFlo2.port_a1)
    annotation (Line(points={{-180,-40},{-170,-40},{-170,-48},{-160,-48}},color={0,127,255}));
  connect(senDifEntFlo2.port_b2,sinDisRet2.ports[1])
    annotation (Line(points={{-160,-60},{-170,-60},{-170,-80},{-180,-80}},color={0,127,255}));
  ...
  connect(senDifEntFlo.port_b1,buiHeaGen1.port_aSerHea)
    annotation (Line(points={{-180,212},{-170,212},{-170,216},{-160,216}},color={0,127,255}));
  connect(senDifEntFlo.port_a2,buiHeaGen1.port_bSerHea)
    annotation (Line(points={{-180,200},{-120,200},{-120,216},{-140,216}},color={0,127,255}));
  connect(senDifEntFlo1.port_b1,buiComGen1.port_aSerHea)
    annotation (Line(points={{-180,-8},{-170,-8},{-170,-4},{-160,-4}},color={0,127,255}));
  connect(buiComGen1.port_bSerHea,senDifEntFlo1.port_a2)
    annotation (Line(points={{-140,-4},{-120,-4},{-120,-20},{-180,-20}},color={0,127,255}));
  connect(senDifEntFlo2.port_b1,buiComGen1.port_aSerCoo)
    annotation (Line(points={{-140,-48},{-120,-48},{-120,-30},{-166,-30},{-166,-8},{-160,-8}},color={0,127,255}));
  connect(buiComGen1.port_bSerCoo,senDifEntFlo2.port_a2)
    annotation (Line(points={{-140,-8},{-100,-8},{-100,-60},{-140,-60}},color={0,127,255}));
  ...
  connect(buiCoo.port_bSerCoo,senDifEntFlo3.port_a2)
    annotation (Line(points={{-140,92},{-120,92},{-120,80},{-180,80}},color={0,127,255}));
  ...
  connect(senDifEntFlo5.port_b1,buiComGen2to4.port_aSerHea)
    annotation (Line(points={{-20,-8},{-10,-8},{-10,-4},{0,-4}},color={0,127,255}));
  connect(buiComGen2to4.port_bSerHea,senDifEntFlo5.port_a2)
    annotation (Line(points={{20,-4},{40,-4},{40,-20},{-20,-20}},color={0,127,255}));
  connect(senDifEntFlo6.port_b1,buiComGen2to4.port_aSerCoo)
    annotation (Line(points={{20,-48},{40,-48},{40,-30},{-6,-30},{-6,-8},{0,-8}},color={0,127,255}));
  connect(buiComGen2to4.port_bSerCoo,senDifEntFlo6.port_a2)
    annotation (Line(points={{20,-8},{60,-8},{60,-60},{20,-60}},color={0,127,255}));
  ...
  connect(senDifEntFlo7.port_b1,buiHeaGen2to4.port_aSerHea)
    annotation (Line(points={{-20,212},{-10,212},{-10,216},{0,216}},color={0,127,255}));
  connect(senDifEntFlo7.port_a2,buiHeaGen2to4.port_bSerHea)
    annotation (Line(points={{-20,200},{40,200},{40,216},{20,216}},color={0,127,255}));
  ...
  connect(senDifEntFlo4.port_b1,buiComGen5.port_aSerAmb)
    annotation (Line(points={{180,-8},{190,-8},{190,0},{200,0}},color={0,127,255}));
  connect(buiComGen5.port_bSerAmb,senDifEntFlo4.port_a2)
    annotation (Line(points={{220,0},{240,0},{240,-20},{180,-20}},color={0,127,255}));
  connect(souDisSup8.ports[1],senDifEntFlo8.port_a1)
    annotation (Line(points={{-220,-160},{-210,-160},{-210,-168},{-200,-168}},color={0,127,255}));
  connect(sinDisRet8.ports[1],senDifEntFlo8.port_b2)
    annotation (Line(points={{-220,-200},{-210,-200},{-210,-180},{-200,-180}},color={0,127,255}));
  connect(senDifEntFlo8.port_b1,buiTesOutETS.port_aSerAmb)
    annotation (Line(points={{-180,-168},{-170,-168},{-170,-160},{-160,-160}},color={0,127,255}));
  connect(buiTesOutETS.port_bSerAmb,senDifEntFlo8.port_a2)
    annotation (Line(points={{-140,-160},{-120,-160},{-120,-180},{-180,-180}},color={0,127,255}));
  connect(souDisSup9.ports[1],senDifEntFlo9.port_a1)
    annotation (Line(points={{-60,-160},{-52,-160},{-52,-168},{-40,-168}},color={0,127,255}));
  connect(sinDisRet9.ports[1],senDifEntFlo9.port_b2)
    annotation (Line(points={{-60,-200},{-52,-200},{-52,-180},{-40,-180}},color={0,127,255}));
  connect(senDifEntFlo9.port_b1,buiTesOutETSBui.port_aSerAmb)
    annotation (Line(points={{-20,-168},{-12,-168},{-12,-160},{0,-160}},color={0,127,255}));
  connect(buiTesOutETSBui.port_bSerAmb,senDifEntFlo9.port_a2)
    annotation (Line(points={{20,-160},{40,-160},{40,-180},{-20,-180}},color={0,127,255}));
  connect(souDisSup10.ports[1],senDifEntFlo10.port_a1)
    annotation (Line(points={{120,-160},{130,-160},{130,-168},{140,-168}},color={0,127,255}));
  connect(sinDisRet10.ports[1],senDifEntFlo10.port_b2)
    annotation (Line(points={{120,-200},{130,-200},{130,-180},{140,-180}},color={0,127,255}));
  connect(senDifEntFlo10.port_b1,buiTesFacMul.port_aSerAmb)
    annotation (Line(points={{160,-168},{170,-168},{170,-160},{180,-160}},color={0,127,255}));
  connect(buiTesFacMul.port_bSerAmb,senDifEntFlo10.port_a2)
    annotation (Line(points={{200,-160},{220,-160},{220,-180},{160,-180}},color={0,127,255}));
  annotation (
    experiment(
      Tolerance=1e-6,
      StopTime=1.0),
