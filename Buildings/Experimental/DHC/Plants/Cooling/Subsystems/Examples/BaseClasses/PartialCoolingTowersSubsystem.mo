within Buildings.Experimental.DHC.Plants.Cooling.Subsystems.Examples.BaseClasses;
partial model PartialCoolingTowersSubsystem
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TEnt(redeclare package Medium = Medium_W,
