...
equation
  ...
  connect(THeaWatSupSet, chiHeaCoo.TSet) annotation (Line(points={{-320,-240},{
          -16,-240},{-16,-95},{-12,-95}},
                                      color={0,0,127}));
  ...
  connect(bouHeaWat.ports[1], junHeaWatRet.port_2) annotation (Line(points={{
          150,-160},{160,-160},{160,-200},{170,-200}}, color={0,127,255}));
