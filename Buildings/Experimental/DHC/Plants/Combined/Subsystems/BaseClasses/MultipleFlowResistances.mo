...
equation
  ...
  connect(junInl.port_3, valMod.port_a) annotation (Line(points={{-50,-20},{-20,
          -20},{-20,-80},{-10,-80}},
                              color={0,127,255}));
  connect(valMod.port_b, junOut.port_3) annotation (Line(points={{10,-80},{20,-80},
          {20,-20},{50,-20}},
                            color={0,127,255}));
  connect(junInl.port_3, valTwo.port_a) annotation (Line(points={{-50,-20},{-20,
          -20},{-20,-40},{-10,-40}},
                                color={0,127,255}));
  connect(valTwo.port_b, junOut.port_3) annotation (Line(points={{10,-40},{20,-40},
          {20,-20},{50,-20}},
                            color={0,127,255}));
  connect(junOut[1].port_2, port_b)
    annotation (Line(points={{60,-10},{60,0},{100,0}},color={0,127,255}));
  connect(junInl.port_3, res.port_a) annotation (Line(points={{-50,-20},{-20,-20},
          {-20,0},{-10,0}},   color={0,127,255}));
  connect(res.port_b, junOut.port_3) annotation (Line(points={{10,0},{20,0},{20,
          -20},{50,-20}},
                        color={0,127,255}));

  connect(port_a, junInl[1].port_1)
    annotation (Line(points={{-100,0},{-60,0},{-60,-10}},color={0,127,255}));
  connect(y, valMod.y) annotation (Line(points={{-120,40},{-46,40},{-46,-60},{0,
          -60},{0,-68}}, color={0,0,127}));
  connect(valMod.y_actual, y_actual) annotation (Line(points={{5,-73},{46,-73},{
          46,40},{120,40}}, color={0,0,127}));
  connect(y1, booToRea.u)
    annotation (Line(points={{-120,80},{-82,80}}, color={255,0,255}));
  connect(booToRea.y, valTwo.y) annotation (Line(points={{-58,80},{-40,80},{-40,
          -16},{0,-16},{0,-28}}, color={0,0,127}));
  connect(evaOpe.y, y1_actual)
    annotation (Line(points={{82,80},{120,80}}, color={255,0,255}));
  connect(valTwo.y_actual, evaOpe.u) annotation (Line(points={{5,-33},{40,-33},{
          40,80},{58,80}}, color={0,0,127}));
  annotation (
