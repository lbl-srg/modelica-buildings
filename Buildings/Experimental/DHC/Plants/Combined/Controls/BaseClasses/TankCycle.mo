...
equation
  ...
  connect(criFlo1.y, booToInt.u)
    annotation (Line(points={{-128,60},{-72,60}},color={255,0,255}));
  connect(booToInt.y, idxIni.u3) annotation (Line(points={{-48,60},{-34,60},{-34,
          52},{-22,52}}, color={255,127,0}));
  connect(criFlo1.y, allCri1.u2) annotation (Line(points={{-128,60},{-76,60},{
          -76,-80},{-26,-80},{-26,-68},{-22,-68}},
                                               color={255,0,255}));
  ...
  connect(criFlo1.y, criFlo2.u) annotation (Line(points={{-128,60},{-120,60},{
          -120,20},{-112,20}}, color={255,0,255}));
  connect(criFlo2.y, allCri2.u2) annotation (Line(points={{-88,20},{-80,20},{
          -80,-120},{-26,-120},{-26,-108},{-22,-108}}, color={255,0,255}));
  annotation (
