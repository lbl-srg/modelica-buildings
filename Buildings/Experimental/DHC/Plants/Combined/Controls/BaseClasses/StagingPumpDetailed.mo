...
equation
  connect(y, cmp.u)
    annotation (Line(points={{-220,-40},{-102,-40}}, color={0,0,127}));
  ...
  connect(cmp1.u, sum1.y)
    annotation (Line(points={{-102,-160},{-108,-160}},
                                                     color={0,0,127}));
  connect(yVal, sum1.u)
    annotation (Line(points={{-220,-160},{-132,-160}}, color={0,0,127}));
  ...
  connect(y, cmp4.u) annotation (Line(points={{-220,-40},{-160,-40},{-160,-80},
  ...
  connect(y1_actual, cvt.u)
    annotation (Line(points={{-220,120},{-162,120}}, color={255,0,255}));
  ...
  connect(timSpe1.passed,dow. u2) annotation (Line(points={{-48,-88},{-40,-88},
          {-40,-80},{-32,-80}},color={255,0,255}));
  ...
  connect(dow.y, upOrDown.u2)
    annotation (Line(points={{-8,-80},{8,-80},{8,28}},   color={255,0,255}));
  ...
  connect(dow.y, updDow.u1)
    annotation (Line(points={{-8,-80},{8,-80},{8,-120},{18,-120}},
                                                   color={255,0,255}));
  connect(oneIfTrue.y, add1.u[1]) annotation (Line(points={{72,-20},{72,
  ...
  connect(m_flow, filFlo.u)
    annotation (Line(points={{-220,40},{-172,40}}, color={0,0,127}));
  ...
  connect(y1_actual[1], leaDis.u) annotation (Line(points={{-220,120},{-180,120},
          {-180,-120},{-72,-120}}, color={255,0,255}));
  connect(leaDis.y, dow.u3) annotation (Line(points={{-48,-120},{-36,-120},{-36,
          -88},{-32,-88}}, color={255,0,255}));
  annotation (
