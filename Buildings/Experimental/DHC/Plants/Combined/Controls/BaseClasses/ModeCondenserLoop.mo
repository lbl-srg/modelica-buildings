...
block ModeCondenserLoop
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant modCha(final k=Buildings.Experimental.DHC.Plants.Combined.Controls.ModeCondenserLoop.chargeAssist)
    "Charge assist mode"
...
equation
  ...
  connect(or2.y,enaCha. u)
    annotation (Line(points={{12,-60},{18,-60}}, color={255,0,255}));
  connect(disCha.y, enaCha.clr) annotation (Line(points={{42,-30},{46,-30},{46,
          -44},{14,-44},{14,-66},{18,-66}}, color={255,0,255}));
  ...
  connect(or4.y, disCha.u1) annotation (Line(points={{-28,40},{-16,40},{-16,-30},
          {18,-30}}, color={255,0,255}));
  connect(timNotCha.passed, and3.u1) annotation (Line(points={{12,152},{16,152},
          {16,148},{18,148}},  color={255,0,255}));
  ...
  connect(and3.y,enaRej. u)
    annotation (Line(points={{42,140},{46,140},{46,100},{48,100}},
                                                 color={255,0,255}));
  connect(timCriFlo1.passed,enaRej. clr) annotation (Line(points={{-68,112},{
          -64,112},{-64,94},{48,94}},                 color={255,0,255}));
  connect(enaRej.y, intSwi1.u2) annotation (Line(points={{72,100},{88,100}},
                     color={255,0,255}));
  ...
  connect(enaCha.y, intSwi.u2) annotation (Line(points={{42,-60},{60,-60},{60,0},
