...
model AgentPumpExample
  ...
  Modelica.Blocks.Sources.CombiTimeTable TSouOut(table=[0,TSou; 900,TSou + 1; 2700,
        TSou - 1; 3600,TSou], extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic)
