...
partial model PartialDistribution2Pipe
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput dH_flow[nCon](
    ...
    annotation (Placement(transformation(extent={{100,60},{140,100}}),iconTransformation(extent={{200,50},{240,90}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput mCon_flow[nCon](
    each final unit="kg/s")
    "Connection supply mass flow rate (measured)"
    annotation (Placement(transformation(extent={{100,40},{140,80}}),iconTransformation(extent={{200,30},{240,70}})));
  // COMPONENTS
...
equation
  ...
  connect(senRelPre.p_rel,dp)
    annotation (Line(points={{-51,-30},{92,-30},{92,38},{106,38},{106,40},{120,40}},color={0,0,127}));
  ...
  connect(con.dH_flow,dH_flow)
    annotation (Line(points={{12,9},{16,9},{16,80},{120,80}},color={0,0,127}));
  annotation (
    Documentation(
      info="
<html>
