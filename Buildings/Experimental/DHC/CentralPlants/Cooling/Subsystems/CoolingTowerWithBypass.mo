...
model CoolingTowerWithBypass "Cooling tower system with bypass valve"
  ...
  Buildings.Experimental.DHC.CentralPlants.Cooling.Subsystems.CoolingTowerParellel
    cooTowSys(
...
equation
  ...
  connect(on, cooTowSys.on) annotation (Line(points={{-120,40},{-80,40},{-80,6},
          {-12,6}}, color={255,0,255}));
  connect(on[1], bypValCon.trigger) annotation (Line(points={{-120,30},{-92,30},
          {-92,-80},{-58,-80},{-58,-62}}, color={255,0,255}));
  annotation (
