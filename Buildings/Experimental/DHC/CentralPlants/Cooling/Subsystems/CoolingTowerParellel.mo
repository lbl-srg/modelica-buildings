...
equation
  ...
  if use_inputFilter then
    connect(booToRea.y, filter.u) annotation (Line(points={{-68,60},{-60,60},{-60,
          84},{-55.2,84}}, color={0,0,127}));
  else
    connect(booToRea.y, y_actual) annotation (Line(points={{-68,60},{-60,60},{-60,
          74},{-20,74}}, color={0,0,127}));
  end if;
