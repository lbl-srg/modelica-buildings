...
model CoolingTowerWithBypass
  ...
  Buildings.Experimental.DHC.CentralPlants.Cooling.Subsystems.CoolingTowerWithBypass cooTowPar(
...
equation
  ...
  connect(vol.ports[1],pum.port_a)
    annotation (Line(points={{27.3333,-20},{-60,-20},{-60,50},{-40,50}},color={0,127,255}));
  ...
  connect(exp.ports[1],vol.ports[3])
    annotation (Line(points={{80,-20},{32.6667,-20}},color={0,127,255}));
  ...
  connect(weaBus.TWetBul,cooTowPar.TWetBul)
    annotation (Line(points={{-70,90},{-70,30},{-10,30},{-10,48},{-2,48}},color={255,204,51},thickness=0.5));
  connect(cooTowPar.port_b,senTCWLvg.port_a)
    annotation (Line(points={{20,50},{30,50}},color={0,127,255}));
  connect(senTCWLvg.port_b,vol.ports[2])
    annotation (Line(points={{50,50},{60,50},{60,-20},{30,-20}},color={0,127,255}));
  connect(swi.y,pum.m_flow_in)
    annotation (Line(points={{51,-80},{60,-80},{60,-128},{-80,-128},{-80,68},{-30,68},{-30,62}},color={0,0,127}));
  connect(onOffCon.y,cooTowPar.on[1])
    annotation (Line(points={{11,-80},{20,-80},{20,-132},{-100,-132},{-100,72},{-10,72},{-10,54},{-2,54}},color={255,0,255}));
  ...
  annotation (
    ...
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Experimental/DHC/CentralPlants/Cooling/Subsystems/Examples/CoolingTowerWithBypass.mos" "Simulate and Plot"),
    Documentation(
      revisions="<html>
<ul>
<li>
