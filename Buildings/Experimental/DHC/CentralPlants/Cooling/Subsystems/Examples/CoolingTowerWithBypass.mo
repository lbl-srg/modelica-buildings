...
model CoolingTowerWithBypass
  ...
  Buildings.Experimental.DHC.CentralPlants.Cooling.Subsystems.CoolingTowerWithBypass
    cooTowPar(
...
equation
  ...
  connect(onOffCon.y, cooTowPar.on[1]) annotation (Line(points={{11,-80},{20,
          -80},{20,-132},{-100,-132},{-100,72},{-10,72},{-10,54},{-2,54}},
        color={255,0,255}));
  connect(onOffCon.y, cooTowPar.on[2]) annotation (Line(points={{11,-80},{20,
          -80},{20,-132},{-100,-132},{-100,72},{-10,72},{-10,54},{-2,54}},
        color={255,0,255}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},
    ...
    __Dymola_Commands(file=
          "Resources/Scripts/Dymola/Experimental/DHC/CentralPlants/Cooling/Subsystems/Examples/CoolingTowerWithBypass.mos"
        "Simulate and Plot"),
