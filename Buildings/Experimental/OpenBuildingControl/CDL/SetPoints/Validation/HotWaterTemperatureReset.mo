...
equation
  connect(TOut1.y, heaCur1.TOut) annotation (Line(points={{-39,-20},{-20,-20},{0,
          -20},{0,-34},{18,-34}}, color={0,0,127}));
  connect(TOut.y, heaCur.TOut) annotation (Line(points={{-39,60},{-20,60},{0,60},
          {0,46},{18,46}}, color={0,0,127}));
  connect(TRoo.y, heaCur.TSetZon) annotation (Line(points={{-39,20},{0,20},{0,34},
          {18.1,34}}, color={0,0,127}));
  connect(TRoo1.y, heaCur1.TSetZon) annotation (Line(points={{-39,-60},{0,-60},{
          0,-46},{18.1,-46}}, color={0,0,127}));
