...
model TimeTable "Validation model for TimeTable block"
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.SetPoints.TimeTable timTabLin(
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.SetPoints.TimeTable timTabLinHol(
      smoothness = Buildings.Experimental.OpenBuildingControl.CDL.Types.Smoothness.LinearSegments,
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.SetPoints.TimeTable timTabLinDer(
      smoothness = Buildings.Experimental.OpenBuildingControl.CDL.Types.Smoothness.LinearSegments,
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.SetPoints.TimeTable timTabCon(
