...
extends Modelica.Icons.Example;
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.Integers.Product product1
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.Continuous.Truncation trunc2
    "Block that discards the fractional portion of input and provides a whol number output"
...
equation
  ...
  connect(ramp2.y, trunc2.u) annotation (Line(points={{-51,-20},{-40.5,-20},{-30,
          -20}}, color={0,0,127}));
  connect(trunc1.y, product1.u1)
    annotation (Line(points={{-7,20},{4,20},{4,6},{14,6}}, color={255,127,0}));
  connect(trunc2.y, product1.u2) annotation (Line(points={{-7,-20},{2,-20},{2,-6},{14,
          -6}}, color={255,127,0}));
  annotation (
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/OpenBuildingControl/CDL/Integers/Validation/Product.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
Validation test for the block
<a href=\"modelica://Buildings.Experimental.OpenBuildingControl.CDL.Integers.Product\">
Buildings.Experimental.OpenBuildingControl.CDL.Integers.Product</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
