...
extends Modelica.Icons.Example;
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.Integers.Min min1
...
equation
  ...
  connect(ramp2.y, trunc2.u) annotation (Line(points={{-51,-20},{-40.5,-20},{-30,
          -20}}, color={0,0,127}));
  connect(trunc1.y, min1.u1)
    annotation (Line(points={{-7,20},{4,20},{4,6},{14,6}}, color={255,127,0}));
  connect(trunc2.y, min1.u2) annotation (Line(points={{-7,-20},{2,-20},{2,-6},{14,
          -6}}, color={255,127,0}));
  annotation (
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/OpenBuildingControl/CDL/Integers/Validation/Min.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
Validation test for the block
<a href=\"modelica://Buildings.Experimental.OpenBuildingControl.CDL.Integers.Min\">
Buildings.Experimental.OpenBuildingControl.CDL.Integers.Min</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
