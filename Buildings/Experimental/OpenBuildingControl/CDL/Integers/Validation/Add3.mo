...
extends Modelica.Icons.Example;
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.Continuous.Truncation trunc3
    "Block that discards the fractional portion of input and provides a whol number output"
...
equation
  ...
  connect(ramp2.y, trunc2.u) annotation (Line(points={{-51,0},{-40.5,0},{-30,0}},
                 color={0,0,127}));
  connect(trunc1.y, add1.u1)
    annotation (Line(points={{-7,36},{2,36},{2,8},{14,8}}, color={255,127,0}));
  connect(trunc2.y, add1.u2) annotation (Line(points={{-7,0},{2,0},{14,0}},
                color={255,127,0}));
  connect(ramp3.y, trunc3.u)
    annotation (Line(points={{-51,-36},{-40,-36},{-30,-36}}, color={0,0,127}));
  connect(trunc3.y, add1.u3) annotation (Line(points={{-7,-36},{2,-36},{2,-8},{14,
          -8}}, color={255,127,0}));
  annotation (
