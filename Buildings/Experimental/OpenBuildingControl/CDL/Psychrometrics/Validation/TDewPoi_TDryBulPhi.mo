...
model TDewPoi_TDryBulPhi
 ...
 // ============ Below blocks are from Buildings Library ============
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.Psychrometrics.TDewPoi_TDryBulPhi dewBulPhi1
   "Model for dew point temperature"
...
equation
  ...
  connect(TDryBul.y, dewBulPhi.TDryBul) annotation (Line(points={{-73,84},{-68,84},
          {-68,92},{15,92}},  color={0,0,127}));
  connect(phi.y, dewBulPhi.phi) annotation (Line(points={{-73,50},{-62,50},{-62,
          84},{15,84}},  color={0,0,127}));
  connect(p.y, dewBulPhi.p) annotation (Line(points={{-73,18},{-56,18},{-56,76},
          {15,76}},  color={0,0,127}));
  connect(p.y, X_pTphi.p_in) annotation (Line(points={{-73,18},{-56,18},{-56,20},
          {-48,20}},  color={0,0,127}));
  connect(TDryBul.y, X_pTphi.T) annotation (Line(points={{-73,84},{-68,84},{-68,
          14},{-48,14}},   color={0,0,127}));
  connect(phi.y, X_pTphi.phi) annotation (Line(points={{-73,50},{-62,50},{-62,8},
          {-48,8}},   color={0,0,127}));

  connect(TDewPoi.T, add.u2) annotation (Line(points={{39,14},{44,14},{44,44},{50,
          44}},     color={0,0,127}));
  connect(dewBulPhi.TDewPoi, add.u1) annotation (Line(points={{37,84},{42,84},{42,
          56},{50,56}}, color={0,0,127}));
  connect(TDryBul2.y, dewBulPhi1.TDryBul) annotation (Line(points={{-73,-18},{-68,
          -18},{-68,-10},{17,-10}}, color={0,0,127}));
  connect(TDryBul2.y, X_pTphi1.T) annotation (Line(points={{-73,-18},{-68,-18},{
          -68,-88},{-46,-88}}, color={0,0,127}));
  connect(p2.y, X_pTphi1.p_in) annotation (Line(points={{-73,-84},{-56,-84},{-56,
          -82},{-46,-82}}, color={0,0,127}));
  connect(p2.y, dewBulPhi1.p) annotation (Line(points={{-73,-84},{-56,-84},{-56,
          -26},{17,-26}}, color={0,0,127}));
  connect(phi2.y, dewBulPhi1.phi) annotation (Line(points={{-73,-50},{-62,-50},{
          -62,-18},{17,-18}}, color={0,0,127}));
  connect(phi2.y, X_pTphi1.phi) annotation (Line(points={{-73,-50},{-62,-50},{-62,
          -94},{-46,-94}}, color={0,0,127}));
  ...
  connect(dewBulPhi1.TDewPoi, add1.u1) annotation (Line(points={{39,-18},{44,-18},
          {44,-44},{50,-44}}, color={0,0,127}));
  connect(TDewPoi1.T, add1.u2) annotation (Line(points={{41,-88},{46,-88},{46,-56},
          {50,-56}}, color={0,0,127}));
    annotation (experiment(StopTime=1.0, Tolerance = 1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/OpenBuildingControl/CDL/Psychrometrics/Validation/TDewPoi_TDryBulPhi.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This examples is a unit test for the dew point temperature computation <a href=\"modelica://Buildings.Experimental.OpenBuildingControl.CDL.Psychrometrics.TDewPoi_TDryBulPhi\">
Buildings.Experimental.OpenBuildingControl.CDL.Psychrometrics.TDewPoi_TDryBulPhi</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
