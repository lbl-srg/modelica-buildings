...
equation
  X = conv*time;
  p_w =
    Buildings.Experimental.OpenBuildingControl.CDL.Psychrometrics.Functions.pW_X(
    X);
  XInv =
    Buildings.Experimental.OpenBuildingControl.CDL.Psychrometrics.Functions.X_pW(
    p_w);
  dX = X - XInv;
