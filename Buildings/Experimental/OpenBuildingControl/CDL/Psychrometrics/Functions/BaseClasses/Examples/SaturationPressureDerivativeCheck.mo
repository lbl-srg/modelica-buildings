within Buildings.Experimental.OpenBuildingControl.CDL.Psychrometrics.Functions.BaseClasses.Examples;
...
equation
  ...
  y =
    Buildings.Experimental.OpenBuildingControl.CDL.Psychrometrics.Functions.saturationPressure(
    TSat=T);
  der(y)=der(y_comp);
  err = y-y_comp;
