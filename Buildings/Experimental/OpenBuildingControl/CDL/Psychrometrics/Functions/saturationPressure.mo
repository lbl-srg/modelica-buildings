...
algorithm
  pSat := Buildings.Experimental.OpenBuildingControl.CDL.Psychrometrics.Functions.regStep(
    y1=
      Buildings.Experimental.OpenBuildingControl.CDL.Psychrometrics.Functions.saturationPressureLiquid(
       TSat),
    y2=
      Buildings.Experimental.OpenBuildingControl.CDL.Psychrometrics.Functions.sublimationPressureIce(
       TSat),
    x=TSat - 273.16,
    x_small=1.0);
...
Duplicated <code>Buildings.Utilities.Math.Functions.regStep</code> to the package 
<code>CDL.Psychrometrics.Functions</code>, changed <code>regStep</code> path.
</li>
<li>
