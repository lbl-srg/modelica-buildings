...
model TimeTable "Validation model for TimeTable block"
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.Continuous.Sources.TimeTable timTabLin(
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.Continuous.Sources.TimeTable timTabLinHol(
      smoothness = Buildings.Experimental.OpenBuildingControl.CDL.Types.Smoothness.LinearSegments,
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.Continuous.Sources.TimeTable timTabLinDer(
      smoothness = Buildings.Experimental.OpenBuildingControl.CDL.Types.Smoothness.LinearSegments,
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.Continuous.Sources.TimeTable timTabCon(
      smoothness = Buildings.Experimental.OpenBuildingControl.CDL.Types.Smoothness.ConstantSegments,
      table=[0,0; 6*3600,1; 18*3600,0.5; 24*3600,0])
    "Time table with smoothness method of constant segments"
    annotation (Placement(transformation(extent={{-80,-30},{-60,-10}})));
  Buildings.Experimental.OpenBuildingControl.CDL.Continuous.Sources.TimeTable timTabLinCon(
      smoothness=Buildings.Experimental.OpenBuildingControl.CDL.Types.Smoothness.LinearSegments,
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/OpenBuildingControl/CDL/Continuous/Sources/Validation/TimeTable.mos"
       "Simulate and plot"),
