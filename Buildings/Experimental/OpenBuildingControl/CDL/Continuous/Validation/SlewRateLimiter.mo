...
model SlewRateLimiter "Validation model for the SlewRateLimiter block"
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.Continuous.Sources.Ramp ramp6(
    offset=0,
    height=1.5,
    startTime=240,
    duration=40) "Block that generates ramp signal"
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.Continuous.Sources.Ramp ramp7(
    offset=0,
    height=-1.5,
    duration=50,
    startTime=360 + 60) "Block that generates ramp signal"
    annotation (Placement(transformation(extent={{-80,-130},{-60,-110}})));
  Buildings.Experimental.OpenBuildingControl.CDL.Continuous.Sources.Ramp ramp8(
    offset=0,
    height=1.5,
    duration=50,
