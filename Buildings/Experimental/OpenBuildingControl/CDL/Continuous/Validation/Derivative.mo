...
equation
  ...
  connect(cos1.y, der1.u)
    annotation (Line(points={{11,0},{32,0},{32,0}}, color={0,0,127}));
  annotation (
  experiment(StopTime=5.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/OpenBuildingControl/CDL/Continuous/Validation/Derivative.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
Validation test for the block
<a href=\"modelica://Buildings.Experimental.OpenBuildingControl.CDL.Continuous.Derivative\">
Buildings.Experimental.OpenBuildingControl.CDL.Continuous.Derivative</a>.
</p>
<p>
