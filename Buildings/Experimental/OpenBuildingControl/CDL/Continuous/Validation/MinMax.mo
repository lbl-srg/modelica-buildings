...
model MinMax "Validation model for the MinMax block"
extends Modelica.Icons.Example;
  parameter Integer sizOfVec = 5 "Size of the input vector";

  Buildings.Experimental.OpenBuildingControl.CDL.Continuous.MinMax minMax(nin=sizOfVec)
...
equation
  for i in 1:sizOfVec loop
    connect(con[i].y, minMax.u[i])
    annotation (Line(points={{-37,0},{-24.5,0},{-12,0}}, color={0,0,127}));
  end for;
  annotation (
experiment(StopTime=1.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/OpenBuildingControl/CDL/Continuous/Validation/MinMax.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
Validation test for the block
<a href=\"modelica://Buildings.Experimental.OpenBuildingControl.CDL.Continuous.MinMax\">
Buildings.Experimental.OpenBuildingControl.CDL.Continuous.MinMax</a>.
</p>
<p>
