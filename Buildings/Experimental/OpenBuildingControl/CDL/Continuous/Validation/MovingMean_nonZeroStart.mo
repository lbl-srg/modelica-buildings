...
equation
  connect(sinInpNoDel.y, movingMean_3.u) annotation (Line(points={{-79,60},{-60,
          60},{-60,0},{-42,0}}, color={0,0,127}));
  connect(sinInpNoDel.y, movingMean_1.u)
    annotation (Line(points={{-79,60},{-60,60},{-42,60}}, color={0,0,127}));
  connect(sinInpNoDel.y, movingMean_2.u) annotation (Line(points={{-79,60},{-79,
          60},{-60,60},{-60,30},{-42,30}}, color={0,0,127}));
  connect(sinInpNoDel.y, movingMean_5.u) annotation (Line(points={{-79,60},{-60,
          60},{-60,-60},{-42,-60}}, color={0,0,127}));
  connect(sinInpNoDel.y, movingMean_4.u) annotation (Line(points={{-79,60},{-60,
