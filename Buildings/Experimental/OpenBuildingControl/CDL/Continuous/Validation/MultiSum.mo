...
equation
  connect(ramp1.y, mulSum_5.u[1]) annotation (Line(points={{-39,60},{-39,60},{
          20,60},{20,-24.4},{40,-24.4}}, color={0,0,127}));
  connect(ramp2.y, mulSum_5.u[2]) annotation (Line(points={{-39,30},{-39,30},{
          10,30},{10,-27.2},{40,-27.2}}, color={0,0,127}));
