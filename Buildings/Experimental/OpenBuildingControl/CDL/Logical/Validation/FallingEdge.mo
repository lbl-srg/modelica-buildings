...
extends Modelica.Icons.Example;
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.Logical.FallingEdge Fedge1
...
equation
  ...
  connect(Fedge1.y, triggeredSampler.trigger) annotation (Line(points={{23,2},{38,
