...
model SampleTrigger "Validation model for the SampleTrigger block"
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.Logical.Sources.SampleTrigger samTri(
    period = 0.5)
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/OpenBuildingControl/CDL/Logical/Sources/Validation/SampleTrigger.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
Validation test for the block
<a href=\"modelica://Buildings.Experimental.OpenBuildingControl.CDL.Logical.Sources.SampleTrigger\">
Buildings.Experimental.OpenBuildingControl.CDL.Logical.Sources.SampleTrigger</a>.
</p>
