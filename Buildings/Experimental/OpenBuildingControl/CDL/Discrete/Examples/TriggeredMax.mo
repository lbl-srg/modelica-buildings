...
model TriggeredMax "Example model for the TriggeredMax block"
  ...
  Buildings.Experimental.OpenBuildingControl.CDL.Discrete.TriggeredMax triggeredMax(
    samplePeriod = 0.2)
...
<a href=\"modelica://Buildings.Experimental.OpenBuildingControl.CDL.Discrete.TriggeredMax\">
Buildings.Experimental.OpenBuildingControl.CDL.Discrete.TriggeredMax</a>.
</p>
</html>",
revisions="<html>
<ul>
