...
equation
  ...
  connect(sin1.y, triggeredSampler1.u)
    annotation (Line(points={{11,0},{30,0},{30,50},{58,50}}, color={0,0,127}));
  connect(booPul.y, triggeredSampler1.trigger) annotation (Line(points={{11,-40},
          {70,-40},{70,38},{70,38.2}}, color={255,0,255}));
  annotation (
