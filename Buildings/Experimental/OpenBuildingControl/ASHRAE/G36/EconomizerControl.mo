...
block EconomizerControl "Economizer control sequence"
  ...
  parameter Real yHeaMax(min=0, max=1, unit="1") = 0.5
    "Maximum fan speed for heating"
    annotation (Dialog(group="Speed"));

  parameter Real yMin(min=0, max=1, unit="1") = 0.5
    "Minimum fan speed"
    annotation (Dialog(group="Speed"));
