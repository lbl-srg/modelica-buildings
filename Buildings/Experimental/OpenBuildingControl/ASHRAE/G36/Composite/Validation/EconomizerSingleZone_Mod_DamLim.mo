...
equation
  ...
  connect(hOutCut.y, economizer1.hOutCut)
    annotation (Line(points={{-99,-20},{-20,-20},{-20,-24},{99,-24}},
                                                                  color={0,0,127}));
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/OpenBuildingControl/ASHRAE/G36/Composite/Validation/EconomizerSingleZone_Mod_DamLim.mos"
    "Simulate and plot"),
  Icon(graphics={
