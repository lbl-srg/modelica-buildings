...
block OperationModeSelection "Block to specify system operation mode"
  ...
  CDL.Logical.Or3 or3 "If it is in \"Occupied\"/\"Cool-down\"/\"Warm-up\" mode"
  ...
  CDL.Continuous.Gain setUpInd(k=setUpRan) "Setup mode: 3th rank"
  ...
  CDL.Conversions.BooleanToReal booToRea8
  ...
  CDL.Interfaces.RealInput THeaSet "Occupied heating setpoint temperature"
    annotation (Placement(transformation(extent={{-260,70},{-220,110}}),
        iconTransformation(extent={{-120,-32},{-100,-12}})));
  CDL.Interfaces.RealInput TCooSet "Occupied cooling setpoint temperature"
  ...
  CDL.Interfaces.RealInput tNexOcc "Time to next occupied period" annotation (
  ...
  CDL.Continuous.Add add2(k1=+1, k2=-1)
  ...
  CDL.Continuous.Add add5(k1=-1, k2=+1)
  ...
  CDL.Continuous.Add add6(k1=-1, k2=+1)
    annotation (Placement(transformation(extent={{60,140},{80,160}})));
  CDL.Continuous.Add add7(k1=+1, k2=-1)
  ...
  CDL.Continuous.Add add8(k1=-1, k2=+1)
  ...
  CDL.Continuous.AddParameter addPar(p=freProThrVal, k=-1)
  ...
  CDL.Continuous.AddParameter addPar1(p=(-1)*freProThrVal, k=1)
...
protected
  parameter Integer occModRan = 1 "Occupied mode index";
  parameter Integer cooDowRan = 2 "Cool-down mode index";
  parameter Integer setUpRan =  3 "Set-up mode index";
  parameter Integer warUpRan =  4 "Warm-up mode index";
  parameter Integer setBacRan = 5 "Set-back mode index";
  parameter Integer freProRan = 6 "Freeze protection mode index";
  parameter Integer unoModRan = 7 "Unoccupied mode index";

public
  CDL.Logical.Not not1[numOfZon]
    annotation (Placement(transformation(extent={{-200,20},{-180,40}})));
  CDL.Continuous.AddParameter addPar2(p=preWarCooTim, k=-1)
    annotation (Placement(transformation(extent={{-80,170},{-60,190}})));
  CDL.Continuous.AddParameter addPar3(p=preWarCooTim, k=-1)
    annotation (Placement(transformation(extent={{-80,130},{-60,150}})));
  CDL.Continuous.Constant maxWarCooTime(k=preWarCooTim)
    "Allowed maximum warm-up/cool-down time"
    annotation (Placement(transformation(extent={{-140,150},{-120,170}})));
equation
  connect(swi.y, occMod.u)  annotation (Line(points={{281,250},{290,250},{298,250}},
                                                   color={0,0,127}));
  connect(occModInd.y, swi.u1)  annotation (Line(points={{161,300},{200,300},{200,258},{258,258}},
                               color={0,0,127}));
  connect(unoPerInd.y, swi.u3)  annotation (Line(points={{-139,230},{182,230},{182,242},{258,242}},
                           color={0,0,127},
      pattern=LinePattern.Dash));
  connect(minMax.yMax, corCooDowTim.u1) annotation (Line(points={{-119,200},{-12,
          200},{-12,188},{-2,188}},
                             color={0,0,127}));
  connect(booToRea1.y,cooDowInd. u)  annotation (Line(points={{221,190},{238,190}},        color={0,0,127}));
  connect(booToRea.y,warUpInd. u)  annotation (Line(points={{221,150},{221,150},{238,150}},color={0,0,127}));

  for i in 1:numOfZon loop
    connect(booToRea2[i].y, sum1.u[i]) annotation (Line(points={{-19,-10},{-19,-10},
            {-2,-10}},      color={0,0,127}));
    connect(booToRea5[i].y, sum2.u[i]) annotation (Line(points={{-59,-210},{-59,
            -210},{-2,-210}},
                            color={0,0,127}));
    ...
    connect(warUpTim[i], pro1[i].u1) annotation (Line(points={{-240,116},{-240,116},
            {-182,116}},                    color={0,0,127}));
    connect(pro[i].y, minMax.u[i]) annotation (Line(points={{-159,190},{-150,190},
            {-150,194},{-142,194}},
                           color={0,0,127}));
    connect(pro1[i].y, minMax1.u[i]) annotation (Line(points={{-159,110},{-150,110},
            {-150,114},{-142,114}},
                                color={0,0,127}));
    connect(booToRea9[i].y, pro[i].u2) annotation (Line(points={{-139,30},{-139,
            30},{-120,30},{-120,80},{-200,80},{-200,184},{-182,184}},
                                                                color={0,0,127}));
    connect(booToRea9[i].y, pro1[i].u2) annotation (Line(points={{-139,30},{-120,
            30},{-120,80},{-200,80},{-200,104},{-182,104}},
                                                      color={0,0,127}));
    ...
    connect(add9[i].y, hys8[i].u) annotation (Line(points={{-119,-10},{-82,-10}},
                 color={0,0,127}));
    connect(hys8[i].y, booToRea2[i].u) annotation (Line(points={{-59,-10},{-50,-10},
    ...
    connect(hys11[i].y, booToRea5[i].u) annotation (Line(points={{-99,-210},{-82,
            -210}},    color={255,0,255}));
    connect(uWinSta[i], not1[i].u) annotation (Line(points={{-240,30},{-222,30},
            {-222,30},{-202,30}},
                          color={255,0,255}));
    connect(not1[i].y, booToRea9[i].u) annotation (Line(points={{-179,30},{-162,30},
          {-162,30}}, color={255,0,255}));
  end for;

  connect(sum1.y, greEquThr.u)  annotation (Line(points={{21,-10},{38,-10}},   color={0,0,127}));
  connect(sum1.y, greEquThr1.u) annotation (Line(points={{21,-10},{30,-10},{30,
          -40},{38,-40}},   color={0,0,127}));
  connect(greEquThr.y, or1.u1) annotation (Line(points={{61,-10},{69.5,-10},{78,
          -10}},  color={255,0,255}));
  ...
  connect(or1.y, lat.u) annotation (Line(points={{101,-10},{110,-10},{120,-10},
          {139,-10}},           color={255,0,255}));
  connect(falEdg.y, lat.u0) annotation (Line(points={{201,-50},{220,-50},{220,-30},
          {120,-30},{120,-16},{139,-16}},      color={255,0,255}));
  connect(lat.y, booToRea3.u) annotation (Line(points={{161,-10},{169.5,-10},{
          178,-10}},
                 color={255,0,255}));
  connect(booToRea3.y,setBacInd. u) annotation (Line(points={{201,-10},{209.5,
          -10},{218,-10}},
                      color={0,0,127}));
  connect(unoPerInd.y, swi3.u1) annotation (Line(
      points={{-139,230},{-139,230},{182,230},{182,30},{252,30},{252,-2},{258,-2}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(or3.y, swi3.u2) annotation (Line(points={{101,32},{101,32},{250,32},{
          250,-10},{258,-10}},       color={255,0,255}));
  connect(setBacInd.y, swi3.u3) annotation (Line(points={{241,-10},{248,-10},{
          248,-18},{258,-18}},
                           color={0,0,127}));
  connect(lat1.y, booToRea4.u) annotation (Line(points={{161,-110},{178,-110}},
                  color={255,0,255}));
  connect(booToRea4.y, freProSetBacInd.u)   annotation (Line(points={{201,-110},{210,-110},{218,-110}},
                                                             color={0,0,127}));
  connect(freProSetBacInd.y, swi4.u3) annotation (Line(points={{241,-110},{246,
          -110},{246,-118},{258,-118}},
                                color={0,0,127}));
  connect(or3.y, swi4.u2) annotation (Line(points={{101,32},{101,32},{112,32},{
          112,-80},{248,-80},{248,-110},{258,-110}},         color={255,0,255}));
  connect(unoPerInd.y, swi4.u1) annotation (Line(
      points={{-139,230},{-139,230},{182,230},{182,30},{114,30},{114,-78},{250,-78},
          {250,-102},{258,-102}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(sum2.y, greEquThr2.u)   annotation (Line(points={{21,-210},{38,-210}},           color={0,0,127}));
  connect(sum2.y, greEquThr3.u) annotation (Line(points={{21,-210},{30,-210},{
          30,-240},{38,-240}},
                            color={0,0,127}));
  connect(greEquThr2.y, or4.u1)   annotation (Line(points={{61,-210},{78,-210}}, color={255,0,255}));
  connect(greEquThr3.y, or4.u2) annotation (Line(points={{61,-240},{68,-240},{
          68,-218},{78,-218}},
                            color={255,0,255}));
  connect(hys1.y, falEdg1.u)   annotation (Line(points={{161,-250},{178,-250}}, color={255,0,255}));
  connect(or4.y, lat2.u)   annotation (Line(points={{101,-210},{139,-210}}, color={255,0,255}));
  connect(falEdg1.y, lat2.u0) annotation (Line(points={{201,-250},{220,-250},{220,
          -228},{120,-228},{120,-216},{139,-216}}, color={255,0,255}));
  connect(lat2.y, booToRea6.u) annotation (Line(points={{161,-210},{170,-210},{
          178,-210}},
                  color={255,0,255}));
  connect(booToRea6.y, setUpInd.u) annotation (Line(points={{201,-210},{210,
          -210},{218,-210}},
                       color={0,0,127}));
  connect(setUpInd.y, swi5.u3) annotation (Line(points={{241,-210},{248,-210},{
          248,-218},{258,-218}},
                             color={0,0,127}));
  connect(or3.y, swi5.u2) annotation (Line(points={{101,32},{101,32},{112,32},{
          112,-180},{250,-180},{250,-210},{258,-210}},  color={255,0,255}));
  connect(unoPerInd.y, swi5.u1) annotation (Line(
      points={{-139,230},{-139,230},{182,230},{182,30},{114,30},{114,-182},{252,
          -182},{252,-202},{258,-202}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(swi3.y, setBacMod.u)    annotation (Line(points={{281,-10},{289.5,-10},{298,-10}},
                                                            color={0,0,127}));
  connect(swi4.y, freProSetBacMod.u)   annotation (Line(points={{281,-110},{298,-110}},
                                                   color={0,0,127}));
  connect(swi5.y, setUpMod.u) annotation (Line(points={{281,-210},{289.5,-210},
          {298,-210}},color={0,0,127}));
  connect(lat.y, or5.u1) annotation (Line(points={{161,-10},{168,-10},{168,20},
          {112,20},{112,-302},{138,-302}},
                                      color={255,0,255}));
  connect(lat1.y, or5.u2) annotation (Line(points={{161,-110},{168,-110},{168,
          -90},{112,-90},{112,-310},{138,-310}},
                                            color={255,0,255}));
  connect(lat2.y, or5.u3) annotation (Line(points={{161,-210},{166,-210},{166,
          -190},{112,-190},{112,-318},{138,-318}},
                                             color={255,0,255}));
  connect(or5.y, or6.u1) annotation (Line(points={{161,-310},{166,-310},{166,
          -332},{114,-332},{114,-350},{128,-350},{138,-350}},
                                                        color={255,0,255}));
  connect(or3.y, or6.u2) annotation (Line(points={{101,32},{101,32},{112,32},{
          112,-358},{138,-358}},  color={255,0,255}));
  connect(or6.y, not2.u) annotation (Line(points={{161,-350},{170,-350},{178,
          -350}},
        color={255,0,255}));
  connect(not2.y, booToRea7.u) annotation (Line(points={{201,-350},{220,-350},{
          220,-332},{172,-332},{172,-310},{178,-310}},
                                                   color={255,0,255}));
  connect(booToRea7.y, unoInd.u)  annotation (Line(points={{201,-310},{218,-310}}, color={0,0,127}));
  connect(unoInd.y, unoMod.u) annotation (Line(points={{241,-310},{269.5,-310},
          {298,-310}},color={0,0,127}));
  connect(occMod.y, add3Int.u1) annotation (Line(points={{321,250},{340,250},{
          340,198},{358,198}},
                           color={255,127,0}));
  connect(cooDowMod.y, add3Int.u2) annotation (Line(points={{321,190},{340,190},
          {358,190}}, color={255,127,0}));
  connect(warUpMod.y, add3Int.u3) annotation (Line(points={{321,150},{330,150},
          {340,150},{340,182},{358,182}},color={255,127,0}));
  connect(setBacMod.y, addInt1.u1) annotation (Line(points={{321,-10},{340,-10},
          {340,-54},{358,-54}},
                           color={255,127,0}));
  connect(freProSetBacMod.y, addInt1.u2) annotation (Line(points={{321,-110},{
          330,-110},{340,-110},{340,-66},{358,-66}},
                                               color={255,127,0}));
  connect(setUpMod.y, addInt2.u1) annotation (Line(points={{321,-210},{340,-210},
          {340,-254},{358,-254}}, color={255,127,0}));
  connect(unoMod.y, addInt2.u2) annotation (Line(points={{321,-310},{340,-310},
          {340,-266},{358,-266}},color={255,127,0}));
  connect(add3Int.y, add3Int1.u1) annotation (Line(points={{381,190},{400,190},
          {400,-52},{418,-52}},color={255,127,0}));
  connect(addInt1.y, add3Int1.u2) annotation (Line(points={{381,-60},{394,-60},
          {418,-60}},color={255,127,0}));
  connect(addInt2.y, add3Int1.u3) annotation (Line(points={{381,-260},{400,-260},
          {400,-68},{418,-68}}, color={255,127,0}));
  connect(add3Int1.y, opeMod) annotation (Line(points={{441,-60},{444,-60},{450,
          -60},{450,-20},{470,-20}}, color={255,127,0}));
  connect(lat1.y, booToRea8.u) annotation (Line(points={{161,-110},{168,-110},{
          168,-150},{178,-150}},
                             color={255,0,255}));
  connect(booToRea8.y, freProAlaInd.u) annotation (Line(points={{201,-150},{
          209.5,-150},{218,-150}},
                             color={0,0,127}));
  connect(freProAlaInd.y, freProAla.u) annotation (Line(points={{241,-150},{270,
          -150},{298,-150}}, color={0,0,127}));
  connect(freProAla.y, freProAlaLev) annotation (Line(points={{321,-150},{330,-150},
          {340,-150},{340,-140},{470,-140}}, color={255,127,0}));
  connect(cooDowInd.y, cooDowMod.u)  annotation (Line(points={{261,190},{261,190},{298,190}}, color={0,0,127}));
  connect(warUpInd.y, warUpMod.u)  annotation (Line(points={{261,150},{280,150},{298,150}}, color={0,0,127}));
  connect(and2.y, booToRea1.u)  annotation (Line(points={{161,190},{198,190}}, color={255,0,255}));
  connect(and1.y, booToRea.u)  annotation (Line(points={{161,150},{198,150}}, color={255,0,255}));
  connect(and2.y, or3.u2) annotation (Line(points={{161,190},{161,190},{176,190},
          {176,60},{40,60},{40,32},{78,32}}, color={255,0,255}));
  connect(and1.y, or3.u1) annotation (Line(points={{161,150},{161,150},{178,150},
          {178,58},{42,58},{42,40},{78,40}}, color={255,0,255}));
  connect(uOcc, swi.u2) annotation (Line(points={{-240,300},{-240,300},{38,300},
          {38,250},{258,250}}, color={255,0,255}));
  connect(uOcc, or3.u3) annotation (Line(points={{-240,300},{-240,300},{38,300},
          {38,24},{78,24}},color={255,0,255}));

  connect(minMaxZonTem.yMin, add2.u2) annotation (Line(points={{-119,-86},{0,-86},
  ...
  connect(hys.y, falEdg.u)   annotation (Line(points={{161,-50},{178,-50}}, color={255,0,255}));
  connect(hys2.y, corCooDowTim.u2) annotation (Line(points={{-19,180},{-19,180},
          {-2,180}}, color={255,0,255}));
  connect(hys3.y, corWarUpTim.u2) annotation (Line(points={{-19,140},{-19,140},{
          -2,140}}, color={255,0,255}));
  connect(add5.y, hys4.u)   annotation (Line(points={{81,190},{89.5,190},{98,190}}, color={0,0,127}));
  connect(hys4.y, and2.u1) annotation (Line(points={{121,190},{129.5,190},{138,190}},
        color={255,0,255}));
  connect(tNexOcc, add5.u1) annotation (Line(points={{-240,260},{-240,260},{36,260},
          {36,196},{58,196}}, color={0,0,127}));
  connect(corCooDowTim.y, add5.u2) annotation (Line(points={{21,180},{40,180},{40,
          184},{58,184}}, color={0,0,127}));
  connect(tNexOcc, add6.u1) annotation (Line(points={{-240,260},{-240,260},{36,260},
          {36,156},{58,156}}, color={0,0,127}));
  connect(corWarUpTim.y, add6.u2) annotation (Line(points={{21,140},{40,140},{40,
          144},{58,144}}, color={0,0,127}));
  connect(add6.y, hys5.u)  annotation (Line(points={{81,150},{89.5,150},{98,150}}, color={0,0,127}));
  connect(hys5.y, and1.u1) annotation (Line(points={{121,150},{129.5,150},{138,150}},
        color={255,0,255}));
  connect(minMaxZonTem.yMin, add7.u2) annotation (Line(points={{-119,-86},{-100,
          -86},{-100,84},{-82,84}}, color={0,0,127}));
  connect(add7.y, hys6.u)   annotation (Line(points={{-59,90},{-59,90},{-42,90}}, color={0,0,127}));
  connect(hys6.y, and1.u2) annotation (Line(points={{-19,90},{-19,90},{130,90},{
          130,124},{130,142},{138,142}}, color={255,0,255}));
  connect(THeaSet, add7.u1) annotation (Line(points={{-240,90},{-170,90},{-100,90},
          {-100,96},{-82,96}}, color={0,0,127}));
  connect(minMaxZonTem.yMax, add8.u2) annotation (Line(points={{-119,-74},{-96,-74},
          {-96,54},{-82,54}}, color={0,0,127}));
  connect(add8.y, hys7.u)   annotation (Line(points={{-59,60},{-54,60},{-42,60}}, color={0,0,127}));
  connect(hys7.y, and2.u2) annotation (Line(points={{-19,60},{-2,60},{-2,92},{128,
          92},{128,182},{138,182}}, color={255,0,255}));
  connect(TCooSet, add8.u1) annotation (Line(points={{-240,60},{-240,60},{-96,60},
          {-96,66},{-82,66}}, color={0,0,127}));
  connect(minMaxZonTem.yMax, addPar.u) annotation (Line(points={{-119,-74},{-119,
          -74},{-40,-74},{-40,-110},{-2,-110}}, color={0,0,127}));
  connect(addPar.y, hys9.u)  annotation (Line(points={{21,-110},{21,-110},{38,-110}}, color={0,0,127}));
  connect(hys9.y, lat1.u)  annotation (Line(points={{61,-110},{139,-110}}, color={255,0,255}));
  connect(minMaxZonTem.yMin, addPar1.u) annotation (Line(points={{-119,-86},{-119,
          -86},{-36,-86},{-36,-148},{-36,-150},{-2,-150}}, color={0,0,127}));
  connect(addPar1.y, hys10.u)  annotation (Line(points={{21,-150},{38,-150}},           color={0,0,127}));
  connect(hys10.y, lat1.u0) annotation (Line(points={{61,-150},{80,-150},{80,-116},
          {139,-116}}, color={255,0,255}));
  connect(minMax1.yMax, addPar3.u) annotation (Line(points={{-119,120},{-119,
  ...
  connect(minMax.yMax, addPar2.u) annotation (Line(points={{-119,200},{-110,200},
          {-100,200},{-100,180},{-82,180}}, color={0,0,127}));
  connect(maxWarCooTime.y, corCooDowTim.u3) annotation (Line(points={{-119,160},
          {-66,160},{-12,160},{-12,172},{-2,172}}, color={0,0,127}));
  connect(minMax1.yMax, corWarUpTim.u1) annotation (Line(points={{-119,120},{
          -119,120},{-12,120},{-12,132},{-2,132}}, color={0,0,127}));
  connect(maxWarCooTime.y, corWarUpTim.u3) annotation (Line(points={{-119,160},
