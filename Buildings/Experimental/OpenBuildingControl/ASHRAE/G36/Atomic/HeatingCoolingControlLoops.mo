...
equation
  ...
  connect(TRoo, conCooVal.u_m)
    annotation (Line(points={{-100,-60},{-30,-60},{-30,-32}},color={0,0,127}));
  ...
  connect(conCooInv.y, yCoo)
    annotation (Line(points={{71,-20},{90,-20}}, color={0,0,127}));
  connect(conCooVal.y, conCooInv.u)
    annotation (Line(points={{-19,-20},{20,-20},{48,-20}}, color={0,0,127}));
  connect(conSigMinSig.y, conCooInv.x1)
    annotation (Line(points={{31,0},{40,0},{40,-12},{48,-12}}, color={0,0,127}));
  ...
  connect(conSigMinSig.y, conCooInv.f2)
    annotation (Line(points={{31,0},{40,0},{40,-28},{48,-28}}, color={0,0,127}));
