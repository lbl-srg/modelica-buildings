...
block OutdoorAirFlowSetpoint_MultiZone
  ...
  CDL.Interfaces.RealOutput yDesOutMin(min=0, unit="m3/s")
...
equation
  for i in 1:numOfZon loop
    connect(breZonAre[i].y, breZon[i].u1) annotation (Line(points={{-99,70},{-90,
            70},{-90,36},{-82,36}}, color={0,0,127}));
    connect(gai[i].y, swi[i].u1) annotation (Line(points={{-139,60},{-128,60},{-128,
            28},{-122,28}},
                         color={0,0,127}));
    connect(breZonPop[i].y, swi[i].u3) annotation (Line(points={{-139,-10},{-134,
            -10},{-134,12},{-122,12}},
                                    color={0,0,127}));
    connect(gai[i].u, occCou[i]) annotation (Line(points={{-162,60},{-200,60}},
                       color={0,0,127}));
    connect(swi[i].y, breZon[i].u2) annotation (Line(points={{-99,20},{-99,20},{
            -90,20},{-90,24},{-82,24}},
                                color={0,0,127}));
    connect(disEffCoo[i].y, swi1[i].u1) annotation (Line(points={{-99,-30},{-92,
            -30},{-92,-52},{-82,-52}},
                              color={0,0,127}));
    connect(disEffHea[i].y, swi1[i].u3) annotation (Line(points={{-99,-90},{-92,
            -90},{-92,-68},{-82,-68}},
                              color={0,0,127}));
    connect(breZon[i].y, zonOutAirRate[i].u1) annotation (Line(points={{-59,30},
            {-50,30},{-50,36},{-42,36}},color={0,0,127}));
    connect(swi1[i].y, zonOutAirRate[i].u2) annotation (Line(points={{-59,-60},{
            -50,-60},{-50,24},{-42,24}},
                                    color={0,0,127}));
    connect(greThr.y, swi1[i].u2) annotation (Line(points={{-99,-60},{-99,-60},{
            -82,-60}},           color={255,0,255}));
    connect(uWindow[i], swi2[i].u2) annotation (Line(points={{-200,-120},{-40,-120},
            {-40,-54},{-8,-54},{-8,-10},{18,-10}},
                              color={255,0,255}));
    connect(zerOutAir[i].y, swi2[i].u1) annotation (Line(points={{-19,-18},{0,-18},
            {18,-18}},        color={0,0,127}));
    connect(zonOutAirRate[i].y, swi2[i].u3) annotation (Line(points={{-19,30},{0,
            30},{0,-2},{18,-2}},         color={0,0,127}));
    connect(swi2[i].y, swi3[i].u3) annotation (Line(points={{41,-10},{48,-10},{48,
            -42},{58,-42}},     color={0,0,127}));
    connect(zerOutAir[i].y, swi3[i].u1) annotation (Line(points={{-19,-18},{-19,
            -18},{0,-18},{0,-58},{58,-58}},
                             color={0,0,127}));
    connect(not1.y, swi3[i].u2) annotation (Line(points={{-99,-150},{-38,-150},{
            -38,-56},{-6,-56},{-6,-50},{58,-50}},
                        color={255,0,255}));
    connect(swi3[i].y, priOutAirFra[i].u1) annotation (Line(points={{81,-50},{90,
            -50},{90,-76},{-20,-76},{-20,-174},{-2,-174}},
                                             color={0,0,127}));
    connect(swi3[i].y,sysUncOutAir. u[i])
    annotation (Line(points={{81,-50},{81,-50},{98,-50}},
                                                color={0,0,127}));
    connect(priAirflow[i], priOutAirFra[i].u2)   annotation (Line(points={{-200,
            -186},{-200,-186},{-2,-186}}, color={0,0,127}));
    connect(priAirflow[i],sysPriAirRate. u[i]) annotation (Line(points={{-200,-186},
            {-200,-185},{-26,-185},{-26,-110},{-2,-110}},color={0,0,127}));
    connect(breZonAre[i].y, desBreZon[i].u2) annotation (Line(points={{-99,70},{
            -90,70},{-90,100},{-140,100},{-140,144},{-122,144}},
                                           color={0,0,127}));
    connect(desBreZonPer[i].y, desBreZon[i].u1) annotation (Line(points={{-159,190},
            {-140,190},{-140,156},{-122,156}},   color={0,0,127}));
    connect(desDisEff[i].y, desZonOutAirRate[i].u2) annotation (Line(points={{-99,190},
            {-88,190},{-88,164},{-62,164}},    color={0,0,127}));
    connect(desBreZon[i].y, desZonOutAirRate[i].u1) annotation (Line(points={{-99,150},
            {-80,150},{-80,176},{-62,176}},    color={0,0,127}));
    connect(desZonOutAirRate[i].y, desZonPriOutAirRate[i].u1) annotation (Line(
        points={{-39,170},{-30,170},{-30,176},{-22,176}},   color={0,0,127}));
    connect(minZonFlo[i].y, desZonPriOutAirRate[i].u2) annotation (Line(points={{-39,130},
            {-30,130},{-30,164},{-22,164}},    color={0,0,127}));
    connect(desZonPopulation[i].y, sumDesZonPop.u[i]) annotation (Line(points={{-159,
            230},{-148,230},{-142,230}},             color={0,0,127}));
    connect(desBreZonPer[i].y, sumDesBreZonPop.u[i]) annotation (Line(points={{-159,
            190},{-140,190},{-140,210},{-62,210}},
                                               color={0,0,127}));
    connect(breZonAre[i].y, sumDesBreZonAre.u[i]) annotation (Line(points={{-99,70},
            {-40,70},{-40,110},{-22,110}},   color={0,0,127}));
    connect(desZonPriOutAirRate[i].y, zonVenEff[i].u2) annotation (Line(points={{1,170},
            {60,170},{60,144},{98,144}},            color={0,0,127}));
    connect(addPar1.y, zonVenEff[i].u1) annotation (Line(points={{121,190},{128,
            190},{128,170},{90,170},{90,156},{98,156}},
                                     color={0,0,127}));
    connect(swi[i].u2, occSenor[i].y) annotation (Line(points={{-122,20},{-134,20},
            {-134,30},{-139,30}}, color={255,0,255}));
  end for;

  connect(uCoo, greThr.u) annotation (Line(points={{-200,-60},{-200,-60},{-122,-60}},
                    color={0,0,127}));
  connect(uSupFan, not1.u) annotation (Line(points={{-200,-149.5},{-178,-149.5},
          {-178,-150},{-122,-150}},
                 color={255,0,255}));

  connect(priOutAirFra.y, maxPriOutAirFra.u[1:5]) annotation (Line(points={{21,-180},
          {21,-180},{58,-180}},  color={0,0,127}));

  connect(sysPriAirRate.y, outAirFra.u2) annotation (Line(points={{21,-110},{30,
          -110},{30,-116},{38,-116}},
                                color={0,0,127}));
  connect(outAirFra.y, addPar.u)  annotation (Line(points={{61,-110},{61,-110},{
          78,-110}},                               color={0,0,127}));
  connect(addPar.y, sysVenEff.u1) annotation (Line(points={{101,-110},{101,-110},
          {100,-110},{102,-110},{110,-110},{110,-104},{118,-104}},
                              color={0,0,127}));
  connect(maxPriOutAirFra.yMax, sysVenEff.u2) annotation (Line(points={{81,-174},
          {110,-174},{110,-116},{118,-116}},
                                          color={0,0,127}));
  connect(sysVenEff.y, effMinOutAirInt.u2)    annotation (Line(points={{141,-110},
          {141,-110},{142,-110},{148,-110},{148,-116},{158,-116}}, color={0,0,127}));

  connect(sumDesZonPop.y, occDivFra.u2) annotation (Line(points={{-119,230},{-102,
          230},{-102,244}},          color={0,0,127}));
  connect(peaSysPopulation.y, occDivFra.u1) annotation (Line(points={{-159,270},
          {-110,270},{-110,256},{-102,256}},
                                          color={0,0,127}));

  connect(sumDesBreZonPop.y, pro.u2) annotation (Line(points={{-39,210},{-30,210},
          {-30,244},{-22,244}},
                            color={0,0,127}));
  connect(pro.y, unCorOutAirInk.u1) annotation (Line(points={{1,250},{10,250},{10,
          226.2},{18,226.2}}, color={0,0,127}));
  connect(sumDesBreZonAre.y, unCorOutAirInk.u2) annotation (Line(points={{1,110},
          {10,110},{10,214.8},{18,214.8}},
                                       color={0,0,127}));
  connect(unCorOutAirInk.y, aveOutAirFra.u1) annotation (Line(points={{41,220.5},
          {50,220.5},{50,196},{58,196}},
                                       color={0,0,127}));
  connect(maxSysPriFlow.y, aveOutAirFra.u2) annotation (Line(points={{41,150},{50,
          150},{50,184},{58,184}},     color={0,0,127}));
  connect(aveOutAirFra.y, addPar1.u)    annotation (Line(points={{81,190},{88,190},
          {98,190}},  color={0,0,127}));

  connect(zonVenEff.y, desSysVenEff.u[1:5]) annotation (Line(points={{121,150},{
          138,150}},                                color={0,0,127}));
  connect(unCorOutAirInk.y, desOutAirInt.u1) annotation (Line(points={{41,220.5},
          {180,220.5},{180,128},{120,128},{120,116},{138,116}},color={0,0,127}));
  connect(desSysVenEff.yMin, desOutAirInt.u2) annotation (Line(points={{161,144},
          {168,144},{168,134},{114,134},{114,104},{138,104}}, color={0,0,127}));
  connect(min1.y, effMinOutAirInt.u1) annotation (Line(points={{161,-50},{180,-50},
          {180,-80},{146,-80},{146,-104},{158,-104}},  color={0,0,127}));
  connect(sysUncOutAir.y, min1.u2) annotation (Line(points={{121,-50},{121,-50},
          {128,-50},{128,-56},{138,-56}},
                        color={0,0,127}));
  connect(min1.y, outAirFra.u1) annotation (Line(points={{161,-50},{180,-50},{180,
          -80},{128,-80},{26,-80},{26,-104},{38,-104}},
                    color={0,0,127}));
  connect(unCorOutAirInk.y, min1.u1) annotation (Line(points={{41,220.5},{180,220.5},
          {180,60},{128,60},{128,-44},{138,-44}},
                                             color={0,0,127}));
  connect(effMinOutAirInt.y, min.u2) annotation (Line(points={{181,-110},{181,-110},
          {188,-110},{188,-116},{198,-116}},
                              color={0,0,127}));
  connect(desOutAirInt.y, min.u1) annotation (Line(points={{161,110},{188,110},{
          188,56},{188,-104},{198,-104}},       color={0,0,127}));
  connect(unCorOutAirInk.y, yDesUncOutMin) annotation (Line(points={{41,220.5},{
          104,220.5},{104,220},{180,220},{180,180},{260,180}},
                                 color={0,0,127}));
  connect(min.y, yVOutMinSet) annotation (Line(points={{221,-110},{221,-110},{232,
          -110},{232,-70},{260,-70}}, color={0,0,127}));
  connect(desOutAirInt.y, yDesOutMin) annotation (Line(points={{161,110},{161,
          110},{188,110},{260,110}},      color={0,0,127}));
  connect(occDivFra.y, pro.u1) annotation (Line(points={{-79,250},{-68,250},{-68,
          256},{-22,256}}, color={0,0,127}));
 annotation (
