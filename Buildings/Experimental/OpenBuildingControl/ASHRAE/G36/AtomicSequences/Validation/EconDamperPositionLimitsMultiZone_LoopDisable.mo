...
model EconDamperPositionLimitsMultiZone_LoopDisable
  "Validation model for enabling/disabling minimum outdoor air control with a 
  single common damper for minimum outdoor air and economizer functions"
  ...
  CDL.Logical.Constant FanStatus1(k=false) "Fan is off"
  ...
  CDL.Logical.Constant FanStatus2(k=false) "Fan is off"
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/OpenBuildingControl/ASHRAE/G36/AtomicSequences/Validation/EconDamperPositionLimitsMultiZone_LoopDisable.mos"
    ...
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-220,-120},{
        ...
        Text(
          ...
          fillPattern=FillPattern.Solid,
          horizontalAlignment=TextAlignment.Left,
          textString="AHU Mode is other than \"Occupied\"",
          fontSize=16),
        Text(
