...
equation
  ...
  connect(uHea.y, setPoiVAV.uHea) annotation (Line(points={{-59,50},{-12,50},{-12,
          8},{-2,8}}, color={0,0,127}));
  connect(uCoo.y, setPoiVAV.uCoo) annotation (Line(points={{-59,20},{-44,20},{-16,
          20},{-16,4},{-2,4}}, color={0,0,127}));
  annotation (
