...
model CHWRetLim "Chilled water return lockout validation model"
  ...
  CHWReturnLimit cHWReturnLimit1(TWaLoSet=TempWaLoSet, TiCHW=TimeCHW)
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
equation
  connect(sin.y, cHWReturnLimit1.TWater) annotation (Line(points={{-58,
