...
model ControlPlusLockoutCoreRoom
...
equation
  ...
  connect(nitFluSig.y, conPluLoc.nitFluSig) annotation (Line(points={{-458,-128},
...
Chilled water and hot water are provided to the slab by constant temperature flow sources, at 10C (cooling) and 40 C (heating). 
   ...
   experiment(Tolerance=1e-6, StopTime=31536000),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/RadiantControl/Validation/ControlPlusLockoutCoreRoom.mos" "Simulate and plot"),
...
end ControlPlusLockoutCoreRoom;
