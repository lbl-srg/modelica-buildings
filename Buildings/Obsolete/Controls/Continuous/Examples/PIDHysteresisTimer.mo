...
model PIDHysteresisTimer
  ...
  Buildings.Obsolete.Controls.Continuous.PIDHysteresisTimer con(
    yMin=0.3,
    minOffTime=10000,
    Ti=60,
    Td=10)
...
equation
  ...
  connect(sine.y, TBC.T) annotation (Line(
      points={{-59,70},{-2,70}},
      color={0,0,127}));
 annotation (                      __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Obsolete/Controls/Continuous/Examples/PIDHysteresisTimer.mos"
        "Simulate and plot"),
...
<a href=\"modelica://Buildings.Obsolete.Controls.Continuous.Examples.PIDHysteresis\">
Buildings.Obsolete.Controls.Continuous.Examples.PIDHysteresis</a>,
...
<p align=\"center\">
<img src=\"modelica://Buildings/Resources/Images/Obsolete/Controls/Continuous/Examples/PIDHysteresisTimerError.png\" border=\"1\" alt=\"Control error.\"/><br/>
<img src=\"modelica://Buildings/Resources/Images/Obsolete/Controls/Continuous/Examples/PIDHysteresisTimerOutput.png\" border=\"1\" alt=\"Control signal.\"/>
</p>
</html>", revisions="<html>
<ul>
<li>
