within Buildings.Obsolete.Controls.OBC.CDL.Integers.Validation;
model Add
  "Validation model for the Add block"
  Buildings.Obsolete.Controls.OBC.CDL.Integers.Add add1
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Obsolete/Controls/OBC/CDL/Integers/Validation/Add.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://Buildings.Obsolete.Controls.OBC.CDL.Integers.Add\">
Buildings.Obsolete.Controls.OBC.CDL.Integers.Add</a>.
</p>
</html>",
      revisions="<html>
<ul>
