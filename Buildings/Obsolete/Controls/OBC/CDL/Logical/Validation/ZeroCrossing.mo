...
model ZeroCrossing "Validation model for the zero crossing block"
  ...
  Buildings.Obsolete.Controls.OBC.CDL.Logical.ZeroCrossing zeroCrossing
    "Zero crossing block"
...
equation
  ...
  connect(zeroCrossing.y,triggeredSampler.trigger)
    annotation (Line(points={{22,0},{70,0},{70,36},{70,38},{70,38},{70,38}},  color={255,0,255}));
  annotation (
    experiment(
      StopTime=5.0,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Obsolete/Controls/OBC/CDL/Logical/Validation/ZeroCrossing.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://Buildings.Obsolete.Controls.OBC.CDL.Logical.ZeroCrossing\">
Buildings.Obsolete.Controls.OBC.CDL.Logical.ZeroCrossing</a>.
</p>
</html>",
      revisions="<html>
<ul>
