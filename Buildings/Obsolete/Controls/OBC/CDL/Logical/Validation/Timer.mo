...
model Timer "Validation model for the Timer block"
  ...
  Buildings.Obsolete.Controls.OBC.CDL.Logical.Timer noThr
    "Timer that do not compare threshold"
    annotation (Placement(transformation(extent={{20,10},{40,30}})));
  Buildings.Obsolete.Controls.OBC.CDL.Logical.Timer thrTim(final t=0.3)
    "Timer that compares threshold"
    annotation (Placement(transformation(extent={{20,-30},{40,-10}})));

  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul(final width=0.7,
