...
model And3
  ...
  Buildings.Obsolete.Controls.OBC.CDL.Logical.And3 and1
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Obsolete/Controls/OBC/CDL/Logical/Validation/And3.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://Buildings.Obsolete.Controls.OBC.CDL.Logical.And3\">
Buildings.Obsolete.Controls.OBC.CDL.Logical.And3</a>.
</p>
</html>",
      revisions="<html>
<ul>
