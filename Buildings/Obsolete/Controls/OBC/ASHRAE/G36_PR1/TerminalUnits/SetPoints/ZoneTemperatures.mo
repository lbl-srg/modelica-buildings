...
protected
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant con(final k=0) "Zero adjustment"
    annotation (Placement(transformation(extent={{-340,280},{-320,300}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant con3(final k=0) if not (cooAdj or sinAdj)
    "Zero adjustment"
    annotation (Placement(transformation(extent={{-340,360},{-320,380}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant con4(final k=0) if not heaAdj
    "Zero adjustment"
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant con1(final k=0) "Zero adjustment"
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant cooSetWinOpe(final k=TZonCooSetWinOpe)
    "Cooling setpoint when window is open"
    annotation (Placement(transformation(extent={{-240,-480},{-220,-460}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant heaSetWinOpe(final k=TZonHeaSetWinOpe)
    "Heating setpoint when window is open"
    annotation (Placement(transformation(extent={{-120,-480},{-100,-460}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant alaZer(k=-0.2)
    "Alarm level 0"
    annotation (Placement(transformation(extent={{-180,-400},{-160,-380}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant alaFou(k=3.8)
    "Alarm level 4"
