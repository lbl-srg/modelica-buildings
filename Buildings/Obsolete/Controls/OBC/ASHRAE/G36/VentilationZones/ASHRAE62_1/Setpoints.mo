within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.VentilationZones.ASHRAE62_1;
block Setpoints
...
protected
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant cooSta(
    final k=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.ZoneStates.cooling)
    if have_CO2Sen and have_parFanPowUni
    "Cooling state"
