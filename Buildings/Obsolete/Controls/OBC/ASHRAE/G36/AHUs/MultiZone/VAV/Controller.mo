within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV;
block Controller "Multizone VAV air handling unit controller"
  ...
  parameter Types.VentilationStandard venSta=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24_2016
  ...
  parameter Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeStat freSta=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeStat.No_freeze_stat
    "Type of freeze stat";
  parameter Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection minOADes
    "Design of minimum outdoor air and economizer function"
    annotation (Dialog(group="Economizer design"));
  parameter
    Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes
    buiPreCon "Type of building pressure control system"
    annotation (Dialog(group="Economizer design"));
  ...
  parameter Real VUncDesOutAir_flow(unit="m3/s")=0
    ...
    annotation (Dialog(group="Minimum outdoor air setpoint",
                       enable=venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1_2016));
  ...
  parameter Real VAbsOutAir_flow(unit="m3/s")=0
    ...
    annotation (Dialog(group="Minimum outdoor air setpoint",
                       enable=venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24_2016));
  ...
  parameter Buildings.Controls.OBC.CDL.Types.SimpleController minOAConTyp=
    ...
    annotation (Dialog(tab="Economizer", group="Limits, separated with AFMS",
      enable=minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersAirflow
           or minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.SingleDamper));
  ...
  parameter Boolean have_CO2Sen=false
    ...
    annotation (Dialog(tab="Economizer", group="Limits, separated with DP",
      enable=(minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersPressure
           and venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24_2016)));
  parameter Real dpAbsOutDam_min=0
    ...
    annotation (Dialog(tab="Economizer", group="Limits, separated with DP",
      enable=(venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24_2016
           and minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersPressure)));
  ...
  parameter Real uRetDam_min(unit="1")=0.5
    ...
    annotation (Dialog(tab="Economizer", group="Limits, Common",
      enable=minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.SingleDamper));
  // Enable
  ...
  parameter Real delEntHis(unit="J/kg")=1000
    ...
    annotation (Dialog(tab="Economizer", group="Enable",
                       enable=ecoHigLimCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.DifferentialEnthalpyWithFixedDryBulb
  ...
  parameter Real dpBuiSet(
    ...
    annotation (Dialog(tab="Pressure control",
      enable=buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReliefDamper
           or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReliefFan
           or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanDp));
...
//       enable=buiPreCon == Buildings.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReliefFan));
  parameter Real difFloSet(unit="m3/s")=0.1
    ...
    annotation (Dialog(tab="Pressure control", group="Return fan",
      enable=buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanMeasuredAir
           or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanCalculatedAir));
  parameter Buildings.Controls.OBC.CDL.Types.SimpleController retFanCon=Buildings.Controls.OBC.CDL.Types.SimpleController.PID
    ...
    annotation (Dialog(tab="Pressure control", group="Return fan",
      enable=buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanCalculatedAir
           or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanMeasuredAir
           or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanDp));
  ...
  parameter Real dpDis_min(
    ...
    annotation (Dialog(tab="Pressure control", group="Return fan",
      enable=buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanDp));
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput VSumAdjPopBreZon_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate") if venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1_2016
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uOutAirFra_max(
    final min=0,
    final unit="1") if venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1_2016
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput VSumZonAbsMin_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate") if venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24_2016
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput VAirOut_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate") if (minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersAirflow
     or minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.SingleDamper)
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uSupFanSpe_actual(
    final min=0,
    final max=1,
    final unit="1") if (minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersAirflow
     or minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersPressure)
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uCO2Loo_max(final unit="1") if (
    have_CO2Sen and venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24_2016)
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput dpMinOutDam(
    final unit="Pa",
    displayUnit="Pa",
    final quantity="PressureDifference") if minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersPressure
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput hAirOut(
    final unit="J/kg",
    final quantity="SpecificEnergy") if (ecoHigLimCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.DifferentialEnthalpyWithFixedDryBulb
     or ecoHigLimCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.FixedEnthalpyWithFixedDryBulb)
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1FreSta if not freSta ==
    Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeStat.No_freeze_stat
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1SofSwiRes if not (freSta
     == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeStat.With_reset_switch_NO
     or freSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeStat.With_reset_switch_NC)
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1RelFan if buiPreCon ==
    Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReliefFan
    "Relief fan commanded on"
    annotation (Placement(transformation(extent={{-400,-270},{-360,-230}}),
        iconTransformation(extent={{-240,-250},{-200,-210}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uRelFan(
    final min=0,
    final max=1,
    final unit="1") if buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReliefFan
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput dpBui(
    final unit="Pa",
    displayUnit="Pa",
    final quantity="PressureDifference") if (buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReliefDamper
     or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReliefFan
     or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanDp)
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput VAirSup_flow(
    final min=0,
    final unit="m3/s",
    final quantity="VolumeFlowRate") if buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanMeasuredAir
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1MinOutAirDam if
    buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanDp
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput y1MinOutDam if minOADes
     == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersPressure
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yRelDam(
    final min=0,
    final max=1,
    final unit="1") if not (buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReliefFan
     or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.BarometricRelief)
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput y1RetFan if (buiPreCon
     == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanCalculatedAir
     or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanMeasuredAir
     or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanDp)
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yRetFan(
    final min=0,
    final max=1,
    final unit="1") if (buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanCalculatedAir
     or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanMeasuredAir
     or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanDp)
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yDpBui(
    final unit="Pa",
    displayUnit="Pa",
    final quantity="PressureDifference") if (buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReliefFan
     or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanDp)
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput dpDisSet(
    final unit="Pa",
    displayUnit="Pa",
    final quantity="PressureDifference") if buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanDp
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.FreezeProtection
    frePro(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.PlantRequests
    plaReq(
    final have_hotWatCoi=have_hotWatCoi,
    final Thys=Thys,
    final posHys=posHys) "Plant requests"
    annotation (Placement(transformation(extent={{-20,-540},{0,-520}})));
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Controller
    ecoCon(
    final minOADes=minOADes,
    final buiPreCon=buiPreCon,
    final eneSta=eneSta,
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.SupplyFan
    conSupFan(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.SupplySignals
    supSig(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.SupplyTemperature
    conTSupSet(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.ASHRAE62_1.AHU
    ashOutAirSet(
    final minOADes=minOADes,
    final VUncDesOutAir_flow=VUncDesOutAir_flow,
    final VDesTotOutAir_flow=VDesTotOutAir_flow) if venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1_2016
    "Minimum outdoor airflow setpoint, when complying with ASHRAE 62.1 requirements"
    annotation (Placement(transformation(extent={{-80,180},{-60,200}})));
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ReliefDamper
    relDam(final dpBuiSet=dpBuiSet, final k=kRelDam) if buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes
    .ReliefDamper
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ReturnFanDirectPressure
    retFanDpCon(
    ...
    final k=kRetFan,
    final Ti=TiRetFan,
    final Td=TdRetFan) if buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanDp
    "Return fan control with direct building pressure control"
    annotation (Placement(transformation(extent={{-160,-480},{-140,-460}})));
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ReturnFanAirflowTracking
    retFanAirTra(
    ...
    final minSpe=minSpeRetFan) if buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanMeasuredAir
     or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanCalculatedAir
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.AHU
    tit24OutAirSet(
    final minOADes=minOADes,
    final have_CO2Sen=have_CO2Sen,
    final VAbsOutAir_flow=VAbsOutAir_flow,
    final VDesOutAir_flow=VDesOutAir_flow) if venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24_2016
    "Minimum outdoor airflow setpoint, when complying with Title 24 requirements"
    annotation (Placement(transformation(extent={{-80,140},{-60,160}})));
  Buildings.Controls.OBC.CDL.Continuous.AddParameter addPar(
    final p=retFacB) if buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanCalculatedAir
    "Mapping commanded fan speed to return flow"
    annotation (Placement(transformation(extent={{-20,-440},{0,-420}})));
  Buildings.Controls.OBC.CDL.Continuous.MultiplyByParameter gai(
    final k=retFacA) if buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanCalculatedAir
    "Mapping commanded fan speed to return flow"
    annotation (Placement(transformation(extent={{-60,-440},{-40,-420}})));
  Buildings.Controls.OBC.CDL.Continuous.MultiplyByParameter gai1(
    final k=1) if buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanCalculatedAir
    "Gain factor"
...
equation
  ...
  connect(uCO2Loo_max, ecoCon.uCO2Loo_max) annotation (Line(points={{-380,-30},
          {-132,-30},{-132,-35},{60,-35}},color={0,0,127}));
