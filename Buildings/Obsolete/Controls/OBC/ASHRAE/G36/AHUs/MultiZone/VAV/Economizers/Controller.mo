within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers;
block Controller
  ...
  parameter Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.EnergyStandard eneSta=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.EnergyStandard
      .Not_Specified "Energy standard, ASHRAE 90.1 or Title 24";
  ...
  parameter Real TdMinOA(unit="s")=0.1
    ...
    annotation (Dialog(tab="Limits", group="With AFMS",
      enable=(minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersAirflow
           ...
           or minOAConTyp == Buildings.Controls.OBC.CDL.Types.SimpleController.PID)));
  parameter Types.VentilationStandard venSta=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.Not_Specified
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput effAbsOutAir_normalized(
    final unit="1") if (minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersPressure
     and venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24_2016)
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uCO2Loo_max(
    final unit="1") if (have_CO2Sen and venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24_2016)
     and minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersPressure
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithAFMS
    sepAFMS(
    final minSpe=minSpe,
    ...
    final minOutDamPhy_min=minOutDamPhy_min) if minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersAirflow
    "Damper position limits for units with separated minimum outdoor air damper and airflow measurement"
    annotation (Placement(transformation(extent={{-140,130},{-120,150}})));
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithDP
    sepDp(
    final venSta=venSta,
    ...
    final retDamPhy_min=retDamPhy_min,
    final outDamPhy_max=outDamPhy_max,
    final outDamPhy_min=outDamPhy_min) if minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersPressure
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.Common
    damLim(
    ...
    final retDamPhy_min=retDamPhy_min,
    final outDamPhy_max=outDamPhy_max,
    final outDamPhy_min=outDamPhy_min) if minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.SingleDamper
    "Damper position limits for units with common damper"
    annotation (Placement(transformation(extent={{-140,20},{-120,40}})));
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Enable
    enaDis(
    final use_enthalpy=ecoHigLimCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.DifferentialEnthalpyWithFixedDryBulb
         or ecoHigLimCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.FixedEnthalpyWithFixedDryBulb,
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Modulations.ReturnFan
    modRet(
    final have_dirCon=buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanDp,

    final uMin=uHeaMax,
    final uMax=uCooMin) if (buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanCalculatedAir
     or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanMeasuredAir
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Economizers.Subsequences.Modulations.Reliefs
    modRel(
    final uMin=uHeaMax,
    final uMax=uCooMin,
    final uOutDamMax=uOutDamMax,
    final uRetDamMin=uRetDamMin) if (buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReliefDamper
     or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReliefFan
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Generic.AirEconomizerHighLimits ecoHigLim(
    final eneSta=eneSta,
  ...
  Buildings.Controls.OBC.CDL.Continuous.AddParameter addPar(
    final p=-1) if eneSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.Not_Specified
    "Dummy block"
...
equation
  ...
  connect(uTSup, modRel.uTSup) annotation (Line(points={{-260,-30},{98,-30}},
                     color={0,0,127}));
  connect(damLim.yOutDam_min, modRel.uOutDam_min) annotation (Line(points={{-118,
  ...
  connect(modRel.yOutDam, yOutDam) annotation (Line(points={{122,-36},{160,-36},
          {160,-70},{280,-70}}, color={0,0,127}));
  connect(modRet.yRelDam, yRelDam) annotation (Line(points={{122,30},{180,30},
  ...
  connect(damLim.yOutDam_min, yOutDam_min) annotation (Line(points={{-118,38},{-80,
          38},{-80,240},{280,240}}, color={0,0,127}));
