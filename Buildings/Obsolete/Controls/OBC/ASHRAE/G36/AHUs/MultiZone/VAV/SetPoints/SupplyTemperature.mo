...
block SupplyTemperature
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Generic.TrimAndRespond maxSupTemRes(
    final delTim=delTim,
    final iniSet=iniSet,
    final minSet=minSet,
    final maxSet=maxSet,
...
protected
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TDea(final k=TDeaBan)
