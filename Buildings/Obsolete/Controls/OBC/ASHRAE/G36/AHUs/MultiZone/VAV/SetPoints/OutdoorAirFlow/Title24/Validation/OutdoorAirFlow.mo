within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.Validation;
model OutdoorAirFlow
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.AHU
    ahu(
    final minOADes=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersAirflow,

    final have_CO2Sen=have_CO2Sen,
    final VAbsOutAir_flow=0.5,
    final VDesOutAir_flow=1) "AHU level minimum outdoor airflow setpoint"
    annotation (Placement(transformation(extent={{60,-10},{80,10}})));
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.SumZone
    zonToAhu(
    final nZon=nZon,
...
protected
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant opeMod[nZonGro](
    final k={Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OperationModes.occupied,
        Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OperationModes.unoccupied})
