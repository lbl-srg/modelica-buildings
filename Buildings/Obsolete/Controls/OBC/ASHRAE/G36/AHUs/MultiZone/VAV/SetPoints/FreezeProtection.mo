...
block FreezeProtection
  ...
  parameter Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeStat freSta=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Without_reset_switch_NC
    "Type of freeze stat";
  ...
  Buildings.Controls.OBC.CDL.Continuous.Switch minOutDam2 if minOADes ==
    Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersAirflow
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant con2(
    final k=false) if freSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeStat.No_freeze_stat
    "Constant false"
  ...
  Buildings.Controls.OBC.CDL.Continuous.Switch relFan if buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes
    .ReliefFan
    "Relief fan speed"
  ...
  Buildings.Controls.OBC.CDL.Logical.Switch minOutDam3 if minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersPressure
    "Minimum outdoor air damper command on position"
    annotation (Placement(transformation(extent={{120,290},{140,310}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant con5(
    final k=false) if minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersPressure
    "False"
    annotation (Placement(transformation(extent={{-40,310},{-20,330}})));
  Buildings.Controls.OBC.CDL.Logical.Switch minOutDam1 if minOADes == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersPressure
    "Minimum outdoor air damper command on position"
    annotation (Placement(transformation(extent={{320,-140},{340,-120}})));
  Buildings.Controls.OBC.CDL.Logical.Not norFal if not freSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeStat.No_freeze_stat
  ...
  Buildings.Controls.OBC.CDL.Logical.Switch logSwi if not freSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeStat.No_freeze_stat
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant norOpe(
    final k=freSta ==Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeStat.With_reset_switch_NO
         or freSta ==Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeStat.Without_reset_switch_NO)
    if not freSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeStat.No_freeze_stat
    "Check if the freeze stat is normally open"
    annotation (Placement(transformation(extent={{-360,-60},{-340,-40}})));
  Buildings.Controls.OBC.CDL.Logical.FallingEdge falEdg if (freSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeStat.With_reset_switch_NO
     or freSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeStat.With_reset_switch_NC)
  ...
  Buildings.Controls.OBC.CDL.Logical.And and1 if (buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.
    ReturnFanCalculatedAir or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanMeasuredAir
     or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanDp)
    "Disable return fan when in stage 3"
    annotation (Placement(transformation(extent={{320,-270},{340,-250}})));
  Buildings.Controls.OBC.CDL.Logical.Not norSta3 if (buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes
    .ReturnFanCalculatedAir or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanMeasuredAir
     or buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReturnFanDp)
    "Not in stage 3"
  ...
  Buildings.Controls.OBC.CDL.Logical.Not norSta2 if buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes
    .ReliefFan
    "Not in stage 3"
    annotation (Placement(transformation(extent={{160,-380},{180,-360}})));
  Buildings.Controls.OBC.CDL.Logical.And and3 if buiPreCon == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReliefFan
