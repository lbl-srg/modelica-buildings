within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.Validation;
model FreezeProtection
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.FreezeProtection
    frePro(
    final buiPreCon=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReliefDamper,

    final minOADes=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OutdoorSection.DedicatedDampersAirflow,

    final freSta=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeStat.No_freeze_stat)
