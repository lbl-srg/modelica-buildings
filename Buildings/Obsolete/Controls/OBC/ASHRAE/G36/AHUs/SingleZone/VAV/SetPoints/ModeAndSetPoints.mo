within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints;
block ModeAndSetPoints
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.ZoneGroups.OperationMode opeModSel(
    final nZon=1,
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.ThermalZones.Setpoints TZonSet(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.ZoneGroups.ZoneStatus zonSta(
    final bouLim=bouLim,
    final have_winSen=have_winSen,
    final uLow=uLow,
