within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Validation;
model Controller_Disable
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Controller
    economizer(
    final eneSta=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.ASHRAE90_1_2016,

    final ecoHigLimCon=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.ControlEconomizer.FixedEnthalpyWithFixedDryBulb,

    final ashCliZon=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.ASHRAEClimateZone.Zone_1A,
...
protected
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant freProSta(
    final k=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeProtectionStages.stage0)
    "Freeze protection stage is 0"
    annotation (Placement(transformation(extent={{-80,-130},{-60,-110}})));
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant zonSta(
    final k=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.ZoneStates.heating)
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant freProSta2(
    final k=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeProtectionStages.stage2)
