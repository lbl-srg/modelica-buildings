...
model PlantRequests
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests
    plaReq "Calculate plant request"
    annotation (Placement(transformation(extent={{60,50},{80,70}})));
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.PlantRequests
    plaReq1(final have_hotWatCoi=false) "Calculate plant request"
