within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.Validation;
model FreezeProtection
  "Validate model for implementing freeze protection"

  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.FreezeProtection
    frePro(final buiPreCon=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.BuildingPressureControlTypes.ReliefDamper,
      freSta=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.FreezeStat.No_freeze_stat)
