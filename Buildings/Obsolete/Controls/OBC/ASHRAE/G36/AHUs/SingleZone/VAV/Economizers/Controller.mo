within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers;
block Controller "Single zone VAV AHU economizer control sequence"
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Subsequences.Enable
    enaDis(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Subsequences.Limits
    damLim(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.Economizers.Subsequences.Modulation
    mod(
  ...
  Buildings.Controls.OBC.CDL.Continuous.AddParameter addPar(final p=-1) if
    eneSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.EnergyStandard.Not_Specified
    "Dummy block"
