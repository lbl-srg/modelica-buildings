...
model CoolingCoil "Validation of cooling coil model"
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.CoolingCoil
    cooCoi(final controllerTypeCooCoi=Buildings.Controls.OBC.CDL.Types.SimpleController.P,
