within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.ThermalZones;
...
protected
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger booToIntHea(
    ...
    final integerTrue=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.ZoneStates.heating)
    "Convert Boolean to Integer number"
    annotation (Placement(transformation(extent={{0,30},{20,50}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger booToIntCoo(
    final integerFalse=0,
    final integerTrue=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.ZoneStates.cooling)
    "Convert Boolean to Integer number"
  ...
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger booToIntDea(
    final integerFalse=0,
    final integerTrue=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.ZoneStates.deadband)
    "Convert Boolean to Integer number"
