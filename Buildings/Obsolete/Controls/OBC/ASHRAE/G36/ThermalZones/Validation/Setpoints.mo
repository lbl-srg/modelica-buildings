within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.ThermalZones.Validation;
model Setpoints "Validate block for zone set point"

  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.ThermalZones.Setpoints TZonSet(final
      have_occSen=true, final have_winSen=true)
