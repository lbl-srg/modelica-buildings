within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanCVF.Validation;
model Controller
  "Validation of model that controls parallel-fan powered unit with constant volume fan"

  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanCVF.Controller
    parFanCon(
