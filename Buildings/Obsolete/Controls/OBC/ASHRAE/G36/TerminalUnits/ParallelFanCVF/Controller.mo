within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanCVF;
block Controller "Controller for constant-volume parallel fan-powered terminal unit"
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanCVF.Subsequences.ActiveAirFlow
    actAirSet(final VCooMax_flow=VCooMax_flow) "Active airflow setpoint"
    annotation (Placement(transformation(extent={{-40,90},{-20,110}})));
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanCVF.Subsequences.SystemRequests
    sysReq(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanCVF.Subsequences.Alarms
    ala(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanCVF.Subsequences.Overrides
    setOve "Override setpoints"
    annotation (Placement(transformation(extent={{80,-80},{100,-60}})));
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Generic.TimeSuppression timSup(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanCVF.Subsequences.DamperValves
    damVal(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.ThermalZones.ZoneStates zonSta(final
      uLow=looHys, final uHigh=2*looHys) if have_CO2Sen
...
equation
  ...
  connect(TCooSet, sysReq.TCooSet) annotation (Line(points={{-260,290},{-228,290},
          {-228,-143},{138,-143}}, color={0,0,127}));
  connect(TZon, sysReq.TZon) annotation (Line(points={{-260,320},{-222,320},{-222,
          -145},{138,-145}}, color={0,0,127}));
  connect(conLoo.yCoo, sysReq.uCoo) annotation (Line(points={{-180,266},{-154,266},
...
annotation (defaultComponentName="parFanCon",
  Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-200},
        ...
        Text(
          ...
          textString="TSupSet"),
        Text(
          extent={{-98,-122},{-44,-136}},
          textColor={0,0,127},
          pattern=LinePattern.Dash,
          textString="uDam_actual"),
        Text(
          extent={{-100,-140},{-38,-156}},
          textColor={0,0,127},
          pattern=LinePattern.Dash,
