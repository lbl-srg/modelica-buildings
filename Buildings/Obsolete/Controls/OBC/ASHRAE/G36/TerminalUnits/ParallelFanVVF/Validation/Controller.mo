within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanVVF.Validation;
model Controller
  "Validation of model that controls parallel-fan powered unit with variable volume fan"

  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanVVF.Controller
    parFanCon(
