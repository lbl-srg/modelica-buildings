within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Validation;
model Controller
  "Validation of model that controls series-fan powered unit with variable volume fan"

  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Controller
    serFanCon(
