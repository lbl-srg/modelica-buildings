within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.Validation;
model Alarms "Validation of model that generates alarms"

  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.Alarms
    ala(
...
equation
  ...
  connect(valPos.y, ala.uVal_actual) annotation (Line(points={{-38,-40},{44,-40},{44,48},
          {78,48}}, color={0,0,127}));
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.Alarms\">
