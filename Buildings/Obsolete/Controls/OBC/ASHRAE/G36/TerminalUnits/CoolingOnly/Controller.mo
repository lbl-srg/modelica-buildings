within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.CoolingOnly;
block Controller "Controller for cooling only VAV box"
  ...
  parameter Buildings.Controls.OBC.CDL.Types.SimpleController damCon=Buildings.Controls.OBC.CDL.Types.SimpleController.PI
...
// ---------------- Parameters for alarms ----------------
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.CoolingOnly.Subsequences.ActiveAirFlow
    actAirSet(final VCooMax_flow=VCooMax_flow) "Active airflow setpoint"
    annotation (Placement(transformation(extent={{-20,10},{0,30}})));
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.CoolingOnly.Subsequences.SystemRequests
    sysReq(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.CoolingOnly.Subsequences.Alarms
    ala(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.CoolingOnly.Subsequences.Dampers
    dam(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.ThermalZones.ZoneStates zonSta
