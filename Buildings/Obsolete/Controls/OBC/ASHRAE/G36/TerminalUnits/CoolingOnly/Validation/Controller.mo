within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.CoolingOnly.Validation;
model Controller
  "Validation of model that controls cooling only unit"

  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.CoolingOnly.Controller
    cooBoxCon(
