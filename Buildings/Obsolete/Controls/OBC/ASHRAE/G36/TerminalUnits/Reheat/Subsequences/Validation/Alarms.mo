within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.Reheat.Subsequences.Validation;
model Alarms "Validation of model that generates alarms"

  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.Reheat.Subsequences.Alarms
    ala(
