within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.Reheat.Validation;
model Controller
  "Validation of model that controls terminal unit with reheat"

  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.Reheat.Controller rehBoxCon(
