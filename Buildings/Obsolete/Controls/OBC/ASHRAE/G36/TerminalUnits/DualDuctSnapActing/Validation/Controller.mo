within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctSnapActing.Validation;
model Controller
  "Validation of model that controls dual-duct unit with snap-acting control"

  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctSnapActing.Controller
    duaDucCon(
