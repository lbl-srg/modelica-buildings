within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConDischargeSensor.Validation;
model Controller
  "Validation of model that controls dual-duct unit using mixing control with discharge flow sensor"

  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConDischargeSensor.Controller
    duaDucCon(
