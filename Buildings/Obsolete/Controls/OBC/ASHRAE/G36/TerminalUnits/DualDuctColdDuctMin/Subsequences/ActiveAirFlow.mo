within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctColdDuctMin.Subsequences;
block ActiveAirFlow
...
protected
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant occMod(
    final k=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OperationModes.occupied)
    "Occupied mode"
    annotation (Placement(transformation(extent={{-120,120},{-100,140}})));
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant cooDowMod(
    final k=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OperationModes.coolDown)
    "Cool down mode"
    annotation (Placement(transformation(extent={{-120,50},{-100,70}})));
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant setUpMod(
    final k=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OperationModes.setUp)
    "Setup mode"
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant setBacMod(
    final k=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OperationModes.setBack)
    "Setback mode"
    annotation (Placement(transformation(extent={{-120,-150},{-100,-130}})));
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant warUpMod(
    final k=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.OperationModes.warmUp)
    "Warm up mode"
...
equation
  ...
  connect(ifOcc.y, or3.u1) annotation (Line(points={{-58,130},{-30,130},{-30,148},
          {38,148}},  color={255,0,255}));
  connect(ifCooDow.y, or3.u2) annotation (Line(points={{-58,60},{-20,60},{-20,140},
          {38,140}},  color={255,0,255}));
  connect(ifSetUp.y, or3.u3) annotation (Line(points={{-58,-10},{-10,-10},{-10,132},
  ...
  connect(pro.y, VActMin_flow) annotation (Line(points={{122,90},{160,90}},
          color={0,0,127}));
  connect(ifOcc.y, or1.u1) annotation (Line(points={{-58,130},{-30,130},{-30,-102},
          {38,-102}},color={255,0,255}));
  connect(ifWarUp.y, or1.u2) annotation (Line(points={{-58,-80},{-40,-80},{-40,-110},
          {38,-110}}, color={255,0,255}));
  connect(ifSetBac.y, or1.u3) annotation (Line(points={{-58,-140},{-20,-140},{-20,
