within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctColdDuctMin;
block Controller "Controller for dual-duct terminal unit with cold-duct minimum control"
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctColdDuctMin.Subsequences.ActiveAirFlow
    actAirSet(
    final VCooMax_flow=VCooMax_flow,
    final VHeaMax_flow=VHeaMax_flow,
    final floHys=floHys) "Active airflow setpoint"
    annotation (Placement(transformation(extent={{-80,70},{-60,90}})));
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctColdDuctMin.Subsequences.SystemRequests
    sysReq(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctColdDuctMin.Subsequences.Alarms
    ala(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctColdDuctMin.Subsequences.Overrides
    setOve(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctColdDuctMin.Subsequences.Dampers
    damDuaSen(
...
annotation (defaultComponentName="duaDucCon",
  Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-200},{100,200}}), graphics={
        ...
        Text(
          extent={{-96,-162},{-26,-182}},
          textColor={0,0,127},
          pattern=LinePattern.Dash,
          textString="uCooDam_actual"),
        Text(
          extent={{-96,-182},{-26,-198}},
          textColor={0,0,127},
          pattern=LinePattern.Dash,
