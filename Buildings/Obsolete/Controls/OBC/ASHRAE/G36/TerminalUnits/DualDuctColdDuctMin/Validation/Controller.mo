within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctColdDuctMin.Validation;
model Controller
  "Validation of model that controls dual-duct unit with minimum cold duct control"

  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctColdDuctMin.Controller
    duaDucCon(
    final venSta=Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1_2016,
