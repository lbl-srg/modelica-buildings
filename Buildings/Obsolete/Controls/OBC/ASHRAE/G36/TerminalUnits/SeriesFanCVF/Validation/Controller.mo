within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanCVF.Validation;
model Controller
  "Validation of model that controls series-fan powered unit with constant volume fan"

  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanCVF.Controller
    serFanCon(
...
equation
  ...
  connect(CO2.y,serFanCon. ppmCO2) annotation (Line(points={{-58,80},{36,80},{36,
