within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanCVF;
block Controller "Controller for constant-volume series fan-powered terminal unit"
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanCVF.Subsequences.ActiveAirFlow
    actAirSet(final VCooMax_flow=VCooMax_flow) "Active airflow setpoint"
    annotation (Placement(transformation(extent={{-40,90},{-20,110}})));
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanCVF.Subsequences.SystemRequests
    sysReq(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanCVF.Subsequences.Alarms
    ala(
    final have_hotWatCoi=have_hotWatCoi,
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanCVF.Subsequences.Overrides
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanCVF.Subsequences.DamperValves
    damVal(
