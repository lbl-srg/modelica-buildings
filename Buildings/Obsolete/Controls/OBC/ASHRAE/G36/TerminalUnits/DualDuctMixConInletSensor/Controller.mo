within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor;
block Controller "Controller for dual-duct terminal unit using mixing control with inlet flow sensor"

  parameter
    Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard venSta
  ...
  parameter Boolean permit_occStandby=true
    ...
    annotation (Dialog(enable=venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1_2016
           and have_occSen));
  parameter Real VOccMin_flow=0
    "Zone minimum outdoor airflow for occupants"
    annotation (Dialog(enable=venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24_2016));
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput VAdjPopBreZon_flow(
    final quantity="VolumeFlowRate",
    final unit="m3/s") if venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1_2016
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput VZonAbsMin_flow(
    final quantity="VolumeFlowRate",
    final unit="m3/s") if venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24_2016
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yCO2(
    final unit="1") if venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24_2016
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.ActiveAirFlow
    actAirSet(final VCooMax_flow=VCooMax_flow, final VHeaMax_flow=VHeaMax_flow)
    "Active airflow setpoint"
    annotation (Placement(transformation(extent={{-80,70},{-60,90}})));
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.SystemRequests
    sysReq(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.ThermalZones.ControlLoops conLoo(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.Alarms
    ala(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.Overrides
    setOve(
    final VMin_flow=VMin_flow,
    final VCooMax_flow=VCooMax_flow,
    final VHeaMax_flow=VHeaMax_flow) "Override setpoints"
    annotation (Placement(transformation(extent={{60,-100},{80,-80}})));
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Generic.TimeSuppression timSupCoo(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.VentilationZones.ASHRAE62_1.Setpoints
    setPoi(
    ...
    final dTHys=dTHys) if venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.ASHRAE62_1_2016
    "Output the minimum outdoor airflow rate setpoint, when using ASHRAE 62.1"
    annotation (Placement(transformation(extent={{-160,140},{-140,160}})));
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.Dampers
    damDuaSen(
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Generic.TimeSuppression timSupHea(
    final samplePeriod=samplePeriod,
    final chaRat=chaRat,
    final maxTim=maxSupTim,
    final dTHys=dTHys)
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.VentilationZones.Title24.Setpoints
    minFlo(
    final have_winSen=have_winSen,
    final have_occSen=have_occSen,
    final have_CO2Sen=have_CO2Sen,
    ...
    final VMin_flow=VMin_flow,
    final VCooMax_flow=VCooMax_flow) if venSta == Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Types.VentilationStandard.California_Title_24_2016
...
equation
  ...
  connect(sysReq.yZonCooTemResReq, yZonCooTemResReq) annotation (Line(points={{122,
          -132},{140,-132},{140,-10},{260,-10}}, color={255,127,0}));
  connect(sysReq.yColDucPreResReq, yColDucPreResReq) annotation (Line(points={{122,
          -137},{146,-137},{146,-40},{260,-40}}, color={255,127,0}));
  ...
  connect(VColDucDis_flow, sysReq.VColDucDis_flow) annotation (Line(points={{-260,
          -20},{-52,-20},{-52,-135},{98,-135}}, color={0,0,127}));
  connect(uCooDam_actual, sysReq.uCooDam_actual) annotation (Line(points={{-260,
          -270},{36,-270},{36,-138},{98,-138}}, color={0,0,127}));
  ...
  connect(VHotDucDis_flow, sysReq.VHotDucDis_flow) annotation (Line(points={{-260,
          -110},{-48,-110},{-48,-154},{98,-154}}, color={0,0,127}));
  connect(uHeaDam_actual, sysReq.uHeaDam_actual) annotation (Line(points={{-260,
          -300},{40,-300},{40,-157},{98,-157}}, color={0,0,127}));
  connect(setOve.VSet_flow, ala.VActSet_flow) annotation (Line(points={{82,-84},
          {90,-84},{90,-221},{98,-221}}, color={0,0,127}));
  connect(VColDucDis_flow, ala.VColDucDis_flow) annotation (Line(points={{-260,-20},
          {-52,-20},{-52,-224},{98,-224}},color={0,0,127}));
  connect(u1CooAHU, ala.u1CooFan) annotation (Line(points={{-260,-50},{-44,-50},
          {-44,-226},{98,-226}}, color={255,0,255}));
  connect(uCooDam_actual, ala.uCooDam_actual) annotation (Line(points={{-260,-270},
          {36,-270},{36,-228},{98,-228}}, color={0,0,127}));
  connect(VHotDucDis_flow, ala.VHotDucDis_flow) annotation (Line(points={{-260,-110},
          {-48,-110},{-48,-232},{98,-232}},color={0,0,127}));
  connect(u1HeaAHU, ala.u1HeaFan) annotation (Line(points={{-260,-140},{-40,-140},
...
annotation (defaultComponentName="duaDucCon",
  Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-200},{100,200}}), graphics={
        ...
        Text(
          extent={{-96,-162},{-28,-180}},
          textColor={0,0,127},
          pattern=LinePattern.Dash,
          textString="uCooDam_actual"),
        Text(
          extent={{-96,-182},{-28,-200}},
          textColor={0,0,127},
          pattern=LinePattern.Dash,
