within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Validation;
model Controller
  "Validation of model that controls dual-duct unit using mixing control with inlet flow sensor"

  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Controller
    duaDucCon(
