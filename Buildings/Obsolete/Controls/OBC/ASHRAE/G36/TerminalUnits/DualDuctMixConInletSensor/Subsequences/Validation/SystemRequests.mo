within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.Validation;
...
equation
  ...
  connect(colDamPos.y, sysReq.uCooDam_actual)
  ...
  connect(hotDamPos.y, sysReq.uHeaDam_actual) annotation (Line(points={{-38,-150},
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixConInletSensor.Subsequences.SystemRequests\">
