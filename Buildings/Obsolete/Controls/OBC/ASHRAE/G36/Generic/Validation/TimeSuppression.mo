...
model TimeSuppression
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Generic.TimeSuppression timSupCooReq
    "Time suppression for generating cooling request"
    annotation (Placement(transformation(extent={{40,70},{60,90}})));
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.Generic.TimeSuppression timSupAla(final
      chaRat=1080, final maxTim=7200) "Time suppression for temperature alarm"
