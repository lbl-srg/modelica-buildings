within Buildings.Obsolete.Controls.OBC.ASHRAE.G36.ZoneGroups.Validation;
model OperationMode "Validate block for selecting operation mode"

  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.ZoneGroups.OperationMode opeModSel(final
      nZon=1) "Operation mode selection"
...
equation
  ...
  connect(occSch.occupied, opeModSel.uOcc) annotation (Line(points={{-99,144},{80,
          144},{80,118},{118,118}},  color={255,0,255}));
