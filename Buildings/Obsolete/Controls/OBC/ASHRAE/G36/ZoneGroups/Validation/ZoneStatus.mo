...
model ZoneStatus
  ...
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.ZoneGroups.ZoneStatus noWinZonSta(final
      have_winSen=false)
    "Status of zone when there is no window operation sensor"
    annotation (Placement(transformation(extent={{80,60},{100,88}})));
  Buildings.Obsolete.Controls.OBC.ASHRAE.G36.ZoneGroups.ZoneStatus witWinZonSta(final
