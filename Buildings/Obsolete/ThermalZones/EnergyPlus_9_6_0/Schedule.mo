...
block Schedule
  ...
  parameter String name
    "Name of schedule";
  parameter Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Types.Units unit
...
protected
  ...
  final parameter String unitString=Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.BaseClasses.getUnitAsString(unit)
    "Unit as a string";
...
See <a href=\"modelica://Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Types.Units\">Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Types.Units</a>
for the supported units.
If the value of the parameter <code>unit</code> is left at its default value of
<code>Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Types.Units.unspecified</code>, then
...
<pre>
  Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Schedule schInt(
    name = \"INTERMITTENT\",
    unit = Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Types.Units.Normalized)
    \"Block that writes to the EnergyPlus schedule INTERMITTENT\";
</pre>
<p>
The entry <code>units=Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Types.Units.Normalized</code>
