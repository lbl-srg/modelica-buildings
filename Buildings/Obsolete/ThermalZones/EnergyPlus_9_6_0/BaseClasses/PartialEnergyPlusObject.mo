...
protected
  ...
  final parameter Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Data.RunPeriod runPeriod=building.runPeriod
  ...
  final parameter String fmuName=building.fmuName
    ...
    annotation (Dialog(tab="Debug"));
  final parameter Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Types.LogLevels logLevel=building.logLevel
