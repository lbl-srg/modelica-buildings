...
model ThermalZoneAdapter
  ...
  parameter Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Data.RunPeriod runPeriod
  ...
  parameter Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Types.LogLevels logLevel=Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Types.LogLevels.Warning
...
initial equation
  ...
  {AFlo, V, mSenFac}=Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.BaseClasses.getParameters(
    adapter=adapter,
    nParOut=nParOut,
    isSynchronized=nObj);
