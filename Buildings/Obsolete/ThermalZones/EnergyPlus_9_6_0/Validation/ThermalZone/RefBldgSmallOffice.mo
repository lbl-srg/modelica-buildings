...
model RefBldgSmallOffice
  ...
  Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.ThermalZone att(
    redeclare package Medium=Medium,
    zoneName="Attic")
    "Thermal zone"
    annotation (Placement(transformation(extent={{40,74},{80,114}})));
  Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.ThermalZone cor(
    redeclare package Medium=Medium,
    zoneName="Core_ZN")
    "Thermal zone"
    annotation (Placement(transformation(extent={{40,28},{80,68}})));
  Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.ThermalZone sou(
    redeclare package Medium=Medium,
    zoneName="Perimeter_ZN_1")
    "Thermal zone"
    annotation (Placement(transformation(extent={{40,-18},{80,22}})));
  Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.ThermalZone eas(
    redeclare package Medium=Medium,
    zoneName="Perimeter_ZN_2")
    "Thermal zone"
    annotation (Placement(transformation(extent={{40,-64},{80,-24}})));
  Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.ThermalZone nor(
    redeclare package Medium=Medium,
    zoneName="Perimeter_ZN_3")
    "Thermal zone"
    annotation (Placement(transformation(extent={{40,-112},{80,-72}})));
  Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.ThermalZone wes(
    redeclare package Medium=Medium,
  ...
  Modelica.Blocks.Sources.CombiTimeTable datRea(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Buildings/Resources/Data/Obsolete/ThermalZones/EnergyPlus_9_6_0/Examples/RefBldgSmallOffice/RefBldgSmallOfficeNew2004_Chicago.dat"),
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Obsolete/ThermalZones/EnergyPlus_9_6_0/Validation/ThermalZone/RefBldgSmallOffice.mos" "Simulate and plot"),
    experiment(
      StopTime=604800,
      Tolerance=1e-06),
    Diagram(
