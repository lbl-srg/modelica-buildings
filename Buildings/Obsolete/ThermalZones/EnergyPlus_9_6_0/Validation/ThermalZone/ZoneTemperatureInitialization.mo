...
model ZoneTemperatureInitialization
  ...
  extends Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Examples.SingleFamilyHouse.Unconditioned(
    zon(
      T_start=303.15));
  Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.OutputVariable TRad(
    key="LIVING ZONE",
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Obsolete/ThermalZones/EnergyPlus_9_6_0/Validation/ThermalZone/ZoneTemperatureInitialization.mos" "Simulate and plot"),
    experiment(
      StopTime=86400,
      Tolerance=1e-06));
