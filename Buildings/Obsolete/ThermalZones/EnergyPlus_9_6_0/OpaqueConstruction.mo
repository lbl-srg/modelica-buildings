...
protected
  ...
  Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.BaseClasses.SpawnExternalObject adapter=Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.BaseClasses.SpawnExternalObject(
    objectType=6,
    startTime=startTime,
    ...
    fmuName=fmuName,
    buildingsRootFileLocation=Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.BaseClasses.buildingsRootFileLocation,
    logLevel=logLevel,
    printUnit=false,
...
initial equation
  ...
  nObj=Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.BaseClasses.initialize(
    adapter=adapter,
    isSynchronized=building.isSynchronized);
  {A}=Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.BaseClasses.getParameters(
    adapter=adapter,
    nParOut=nParOut,
    isSynchronized=nObj);
  assert(
...
equation
  ...
  when {initial(),time >= pre(tNext)} then
    ...
    yEP=Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.BaseClasses.exchange(
      adapter=adapter,
      nY=nY,
...
The model
<a href=\"modelica://Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Examples.SingleFamilyHouse.RadiantHeatingCooling_TRoom\">
Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Examples.SingleFamilyHouse.RadiantHeatingCooling_TRoom</a> illustrates the use of this model for a floor and ceiling slab.
</p>
<p>
...
Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.ZoneSurface</a>
can be used, as shown for the floor slab
in
<a href=\"modelica://Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Examples.SingleFamilyHouse.HeatPumpRadiantHeatingGroundHeatTransfer\">
Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Examples.SingleFamilyHouse.HeatPumpRadiantHeatingGroundHeatTransfer</a>.
</p>
<p>
...
<pre>
Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.OpaqueConstruction attFlo(surfaceName=\"Attic:LivingFloor\")
...
<a href=\"modelica://Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Examples.SingleFamilyHouse.RadiantHeatingCooling_TRoom\">
Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Examples.SingleFamilyHouse.RadiantHeatingCooling_TRoom</a>.
</p>
</html>",
      revisions="<html>
<ul>
