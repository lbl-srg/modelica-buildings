...
model HeatPumpRadiantHeatingGroundHeatTransfer
  ...
  Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.ZoneSurface livFlo(
...
equation
  ...
  annotation (
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Obsolete/ThermalZones/EnergyPlus_9_6_0/Examples/SingleFamilyHouse/HeatPumpRadiantHeatingGroundHeatTransfer.mos" "Simulate and plot"),
    experiment(
      StopTime=172800,
      Tolerance=1e-06),
    Documentation(
