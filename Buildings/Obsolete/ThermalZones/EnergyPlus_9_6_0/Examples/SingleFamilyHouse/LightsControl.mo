...
model LightsControl
  ...
  Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Actuator actLig(
    unit=Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Types.Units.Power,
    variableName="LIVING ZONE Lights",
    componentType="Lights",
    controlType="Electricity Rate")
    "Actuator for lights"
    annotation (Placement(transformation(extent={{100,100},{120,120}})));
  Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.OutputVariable ligPow(
...
equation
  ...
  annotation (
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Obsolete/ThermalZones/EnergyPlus_9_6_0/Examples/SingleFamilyHouse/LightsControl.mos" "Simulate and plot"),
    experiment(
      StopTime=172800,
      Tolerance=1e-06),
    Documentation(
