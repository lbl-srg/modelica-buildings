...
model Guideline36Winter
  ...
  extends Buildings.Examples.VAVReheat.BaseClasses.HVACBuilding(
    ...
    redeclare
      Buildings.Obsolete.ThermalZones.EnergyPlus_9_6_0.Examples.SmallOffice.BaseClasses.Floor
      flo);
  ...
  annotation (
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Obsolete/ThermalZones/EnergyPlus_9_6_0/Examples/SmallOffice/Guideline36Winter.mos" "Simulate and plot"),
    experiment(
      StartTime=432000,
      StopTime=864000,
      Tolerance=1e-07),
