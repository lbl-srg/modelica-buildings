...
initial algorithm
  ...
  (yR1,yI1) := Buildings.Obsolete.Utilities.IO.Python36.Functions.exchange(
    moduleName="testFunctions",
    functionName="i1_i1",
    pytObj=m[4].pytObj,
    passPythonObject=passPythonObject,
  ...
  (yR1,yI2) := Buildings.Obsolete.Utilities.IO.Python36.Functions.exchange(
    moduleName="testFunctions",
    functionName="i1_i2",
    pytObj=m[5].pytObj,
    passPythonObject=passPythonObject,
  ...
  (yR2,yI1) := Buildings.Obsolete.Utilities.IO.Python36.Functions.exchange(
    moduleName="testFunctions",
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Obsolete/Utilities/IO/Python36/Functions/Examples/Exchange.mos"
        "Simulate and plot"),
