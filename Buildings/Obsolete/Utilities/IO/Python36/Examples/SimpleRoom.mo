...
equation
  ...
  connect(onOff.y, mul.u3[1]) annotation (Line(points={{82,20},{90,20},{90,-10},
          {-48,-10},{-48,7},{-42,7}}, color={0,0,127}));
  connect(TAmb.y, mul.u2[1]) annotation (Line(points={{-59,40},{-52,40},{-52,13},
          {-42,13}}, color={0,0,127}));
  annotation (
experiment(Tolerance=1e-6, StopTime=86400),
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Obsolete/Utilities/IO/Python36/Examples/SimpleRoom.mos"
        "Simulate and plot"),
