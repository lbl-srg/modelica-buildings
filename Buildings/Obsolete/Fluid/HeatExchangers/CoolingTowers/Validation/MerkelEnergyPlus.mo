within Buildings.Obsolete.Fluid.HeatExchangers.CoolingTowers.Validation;
model MerkelEnergyPlus
  ...
  Buildings.Obsolete.Fluid.HeatExchangers.CoolingTowers.Merkel tow(
  ...
  Buildings.Controls.OBC.UnitConversions.From_degC TEntWat
    "Block that converts entering water temperature"
    annotation (Placement(transformation(extent={{-60,-56},{-40,-36}})));

  Buildings.Controls.OBC.UnitConversions.From_degC TAirWB
...
equation
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)),
    ...
    __Dymola_Commands(file=
        "modelica://Buildings/Resources/Scripts/Dymola/Obsolete/Fluid/HeatExchangers/CoolingTowers/Validation/MerkelEnergyPlus.mos"
        "Simulate and plot"),
    experiment(
      StartTime=0,
      StopTime=172800,
...
Buildings.Obsolete.Fluid.HeatExchangers.CoolingTowers.Merkel</a> by comparing against
