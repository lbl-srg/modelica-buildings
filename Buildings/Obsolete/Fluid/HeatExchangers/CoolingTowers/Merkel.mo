...
model Merkel "Cooling tower model based on Merkel's theory"
  ...
  replaceable parameter Buildings.Obsolete.Fluid.HeatExchangers.CoolingTowers.Data.UAMerkel UACor
...
protected
  ...
  Buildings.Obsolete.Fluid.HeatExchangers.CoolingTowers.BaseClasses.Merkel per(
