within Buildings.Obsolete.Fluid.HeatExchangers.CoolingTowers.Correlations.Examples;
...
equation
  x = 0.25+time;
  TApp_Wat=Buildings.Obsolete.Fluid.HeatExchangers.CoolingTowers.Correlations.yorkCalc(TRan=TRan,
                                                                    TWetBul=TAirInWB,
                                                                    FRWat=x,
                                                                    FRAir=1);
  TApp_Air=Buildings.Obsolete.Fluid.HeatExchangers.CoolingTowers.Correlations.yorkCalc(TRan=TRan,
                                                                    TWetBul=TAirInWB,
                                                                    FRWat=1,
                                                                    FRAir=x);

  annotation(experiment(Tolerance=1e-6, StopTime=1.0),
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Obsolete/Fluid/HeatExchangers/CoolingTowers/Correlations/Examples/YorkCalc.mos" "Simulate and plot"),
