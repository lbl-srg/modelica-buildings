within Buildings.Obsolete.Fluid.HeatExchangers.CoolingTowers.BaseClasses.Characteristics.Validation;
model NormalizedPower "Validation model for the normalized power calculation"
  extends Modelica.Icons.Example;
  parameter Buildings.Obsolete.Fluid.HeatExchangers.CoolingTowers.BaseClasses.Characteristics.fan fanRelPow(
       r_V = {0, 0.1,   0.3,   0.6,   1},
...
equation
  y = time;
  r_P = Buildings.Obsolete.Fluid.HeatExchangers.CoolingTowers.BaseClasses.Characteristics.normalizedPower(
    per=fanRelPow,
    r_V=y,
    d=fanRelPowDer);
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Obsolete/Fluid/HeatExchangers/CoolingTowers/BaseClasses/Characteristics/Validation/NormalizedPower.mos"
        "Simulate and plot"),
