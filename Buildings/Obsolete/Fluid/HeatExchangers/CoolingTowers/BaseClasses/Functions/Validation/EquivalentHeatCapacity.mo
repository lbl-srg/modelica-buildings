within Buildings.Obsolete.Fluid.HeatExchangers.CoolingTowers.BaseClasses.Functions.Validation;
...
equation
  deltaT = con*time;
  cpe10 = Buildings.Obsolete.Fluid.HeatExchangers.CoolingTowers.BaseClasses.Functions.equivalentHeatCapacity(
    TIn = TIn[1,1], TOut = TOut[1,1]);
  cpe15 = Buildings.Obsolete.Fluid.HeatExchangers.CoolingTowers.BaseClasses.Functions.equivalentHeatCapacity(
    TIn = TIn[1,2], TOut = TOut[1,2]);
  cpe20 = Buildings.Obsolete.Fluid.HeatExchangers.CoolingTowers.BaseClasses.Functions.equivalentHeatCapacity(
    TIn = TIn[1,3], TOut = TOut[1,3]);
  cpe25 = Buildings.Obsolete.Fluid.HeatExchangers.CoolingTowers.BaseClasses.Functions.equivalentHeatCapacity(
    TIn = TIn[1,4], TOut = TOut[1,4]);
  cpe30 = Buildings.Obsolete.Fluid.HeatExchangers.CoolingTowers.BaseClasses.Functions.equivalentHeatCapacity(
    TIn = TIn[1,5], TOut = TOut[1,5]);

  annotation (
    experiment(StartTime=10, Tolerance=1e-06, StopTime=20),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Obsolete/Fluid/HeatExchangers/CoolingTowers/BaseClasses/Functions/Validation/EquivalentHeatCapacity.mos"
        "Simulate and plot"),
