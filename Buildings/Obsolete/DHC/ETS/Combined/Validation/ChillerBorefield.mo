...
model ChillerBorefield
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Obsolete/DHC/ETS/Combined/Validation/ChillerBorefield.mos" "Simulate and plot"),
    experiment(
      StopTime=360000,
      Tolerance=1e-06),
    Documentation(
...
See
<a href=\"modelica://Buildings.Obsolete.DHC.ETS.Combined.Validation.ChillerOnly\">
Buildings.Obsolete.DHC.ETS.Combined.Validation.ChillerOnly</a>
