...
equation
  ...
  connect(u,mapVal.u)
    annotation (Line(points={{-240,40},{-180,40},{-180,60},{84,60},{84,20},{88,20}},
        color={0,0,127}));
  ...
  connect(and2.y,swiOff2.u2)
    annotation (Line(points={{-38,0},{-20,0},{-20,40},{130,40},{130,60},{158,60}},
        color={255,0,255}));
  connect(u, max1.u1)
    annotation (Line(points={{-240,40},{-200,40},{-200,-60},{80,-60},{80,-54},{88,-54}},
        color={0,0,127}));
  connect(yValIso[1], heaRej.u)
    annotation (Line(points={{-240,-45},{-240,-40},{-180,-40},{-180,0},{-172,0}},
        color={0,0,127}));
  connect(yValIso[2], cooRej.u)
    annotation (Line(points={{-240,-35},{-240,-40},{-172,-40}}, color={0,0,127}));
  annotation (
    Diagram(
      coordinateSystem(
...
<p>
The input signal <code>u</code> is yielded by the supervisory controller.
