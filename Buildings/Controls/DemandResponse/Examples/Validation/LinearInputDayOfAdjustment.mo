...
model LinearInputDayOfAdjustment
  ...
  extends Buildings.Controls.DemandResponse.Examples.Validation.LinearInput(
     baseLoad(use_dayOfAdj=true));

  annotation (
  experiment(StopTime=5270400),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/DemandResponse/Examples/Validation/LinearInputDayOfAdjustment.mos"
        "Simulate and plot"),
