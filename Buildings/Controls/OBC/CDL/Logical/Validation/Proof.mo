...
equation
  ...
  connect(latInp1.y, pro.uCom) annotation (Line(points={{-138,60},{-110,60},{-110,
          84},{-102,84}}, color={255,0,255}));
  connect(latInp1.y, pro1.uMea) annotation (Line(points={{-138,60},{-110,60},{-110,
          36},{-102,36}}, color={255,0,255}));
  connect(latInp2.y, pro1.uCom) annotation (Line(points={{-138,8},{-130,8},{-130,
          24},{-102,24}}, color={255,0,255}));
  connect(latInp1.y, pro2.uCom) annotation (Line(points={{-138,60},{-110,60},{-110,
          -28},{-102,-28}}, color={255,0,255}));
  connect(latInp2.y, pro2.uMea) annotation (Line(points={{-138,8},{-130,8},{-130,
