...
model TrueFalseHold
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold tru0FalHol(trueHoldDuration=
        0, falseHoldDuration=1000) "Case with 0 true hold duration"
    annotation (Placement(transformation(extent={{-40,110},{-20,130}})));
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold truHolFal0(trueHoldDuration=
        1000, falseHoldDuration=0) "Case with 0 false hold duration"
    annotation (Placement(transformation(extent={{-40,70},{-20,90}})));
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold tru0Fal0(trueHoldDuration=0)
...
equation
  ...
  connect(booPul1.y,truFalHol1.u)
    annotation (Line(points={{-118,-40},{-42,-40}},
                                                 color={255,0,255}));
  ...
  connect(booPul7.y,not4.u)
    annotation (Line(points={{42,-120},{68,-120}},
                                                color={255,0,255}));
  connect(not4.y,truFalHol7.u)
    annotation (Line(points={{92,-120},{118,-120}},
                                                 color={255,0,255}));
  connect(booPul.y,tru0FalHol. u) annotation (Line(points={{-118,0},{-80,0},{
          -80,120},{-42,120}}, color={255,0,255}));
  connect(booPul.y,truHolFal0. u) annotation (Line(points={{-118,0},{-80,0},{
          -80,80},{-42,80}},   color={255,0,255}));
  connect(booPul.y,tru0Fal0. u) annotation (Line(points={{-118,0},{-80,0},{-80,
