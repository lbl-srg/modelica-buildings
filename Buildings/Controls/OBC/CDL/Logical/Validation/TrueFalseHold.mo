...
extends Modelica.Icons.Example;
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol(duration=1000)
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol1(duration=1000)
    "The block introduces a minimal offset between the input signal rising and falling edge"
    annotation (Placement(transformation(extent={{-40,20},{-20,40}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul2(
      startTime=0, period=1500) "Boolean pulse input signal"
    annotation (Placement(transformation(extent={{-140,-20},{-120,0}})));
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol2(duration=1000)
    "The block introduces a minimal offset between the input signal rising and falling edge"
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol3(duration=1000)
    "The block introduces a minimal offset between the input signal rising and falling edge"
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol4(duration=1000)
    "The block introduces a minimal offset between the input signal rising and falling edge"
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol5(duration=1000)
    "The block introduces a minimal offset between the input signal rising and falling edge"
    annotation (Placement(transformation(extent={{120,20},{140,40}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul6(
      startTime=100, period=1500) "Boolean pulse input signal"
    annotation (Placement(transformation(extent={{20,-20},{40,0}})));
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol6(duration=1000)
    "The block introduces a minimal offset between the input signal rising and falling edge"
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol7(duration=1000)
    "The block introduces a minimal offset between the input signal rising and falling edge"
