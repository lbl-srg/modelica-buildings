...
model VariablePulse_new
  ...
  Buildings.Controls.OBC.CDL.Logical.VariablePulse_new conChaWid(
    final period=900)
...
annotation (experiment(
      ...
      Tolerance=1e-06),
  __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/VariablePulse_new.mos" "Simulate and plot"),
