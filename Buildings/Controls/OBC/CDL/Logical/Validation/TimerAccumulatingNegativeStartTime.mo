...
model TimerAccumulatingNegativeStartTime
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul(
    final width=0.5,
    final period=4,
    shift=-11)  "Block that outputs cyclic on and off"
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/TimerAccumulatingNegativeStartTime.mos"
        "Simulate and plot"),
