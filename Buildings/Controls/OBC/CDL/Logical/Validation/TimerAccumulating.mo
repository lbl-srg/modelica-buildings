...
equation
  ...
  connect(booPul.y, thrTim.u)
    annotation (Line(points={{-58,40},{-40,40},{-40,-20},{-22,-20}}, color={255,0,255}));
  connect(con.y, noThr.reset) annotation (Line(points={{-58,-60},{-48,-60},{-48,
          12},{-22,12}}, color={255,0,255}));
  connect(con.y, thrTim.reset) annotation (Line(points={{-58,-60},{-48,-60},{-48,
          -28},{-22,-28}}, color={255,0,255}));
  connect(booPul.y, noThrWitRes.u) annotation (Line(points={{-58,40},{20,40},{20,
          20},{38,20}}, color={255,0,255}));
  connect(booPul.y, thrTimWitRes.u) annotation (Line(points={{-58,40},{20,40},{20,
          -20},{38,-20}}, color={255,0,255}));
  connect(resTim.y, noThrWitRes.reset) annotation (Line(points={{2,-60},{12,-60},
          {12,12},{38,12}}, color={255,0,255}));
  connect(resTim.y, thrTimWitRes.reset) annotation (Line(points={{2,-60},{12,-60},
          {12,-28},{38,-28}}, color={255,0,255}));

annotation (
  experiment(StopTime=5.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/TimerAccumulating.mos"
        "Simulate and plot"),
