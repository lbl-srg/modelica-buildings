...
model HysteresisWithHold
  ...
  Buildings.Controls.OBC.CDL.Logical.HysteresisWithHold noHold(
    trueHoldDuration =  0,
    falseHoldDuration = 0,
    uLow =      0.05,
    uHigh =     0.15) "No true/false hold"
    annotation (Placement(transformation(extent={{20,50},{40,70}})));
  Buildings.Controls.OBC.CDL.Logical.HysteresisWithHold onHold_30s(
    trueHoldDuration =  30,
  ...
  Buildings.Controls.OBC.CDL.Logical.HysteresisWithHold offHold_300s(
    trueHoldDuration =  30,
  ...
  Buildings.Controls.OBC.CDL.Logical.HysteresisWithHold onHold_150s(
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/HysteresisWithHold.mos"
        "Simulate and plot"),
  Documentation(info="<html>
<p>
Validation test for the block
<a href=\"modelica://Buildings.Controls.OBC.CDL.Logical.HysteresisWithHold\">
Buildings.Controls.OBC.CDL.Logical.HysteresisWithHold</a>.
</p>
<p>
