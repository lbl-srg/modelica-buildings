...
model MultiOr "Model to validate the application of MultiOr block"
  ...
  Buildings.Controls.OBC.CDL.Logical.MultiOr  mulOr(   nu=1)
    "Logical 'MultiAnd': 1 input connection y=u"
    annotation (Placement(transformation(extent={{40,20},{60,40}})));
  Buildings.Controls.OBC.CDL.Logical.MultiOr  mulOr1(  nu=2)
    "Logical 'MultiAnd': 2 input connection y=and(u1, u2)"
    annotation (Placement(transformation(extent={{40,-10},{60,10}})));
  Buildings.Controls.OBC.CDL.Logical.MultiOr  mulOr2(  nu=5)
...
equation
  ...
  connect(booPul2.y, mulOr2.u[2]) annotation (Line(points={{-39,30},{14,30},{14,
          -27.2},{38,-27.2}}, color={255,0,255}));
  connect(booPul3.y, mulOr2.u[3]) annotation (Line(points={{-39,0},{0,0},{0,-30},
          {38,-30}}, color={255,0,255}));
  connect(booPul4.y, mulOr2.u[4]) annotation (Line(points={{-39,-30},{-39,-30},{
          -4,-30},{-4,-32},{-4,-32},{-4,-32.8},{38,-32.8}}, color={255,0,255}));
  connect(booPul5.y, mulOr2.u[5]) annotation (Line(points={{-39,-60},{-39,-60},{
          20,-60},{20,-35.6},{38,-35.6}}, color={255,0,255}));
  connect(booPul1.y, mulOr1.u[1]) annotation (Line(points={{-39,60},{-39,60},{20,
          60},{20,3.5},{38,3.5}}, color={255,0,255}));
  connect(booPul2.y, mulOr1.u[2]) annotation (Line(points={{-39,30},{-39,30},{14,
          30},{14,-3.5},{38,-3.5}}, color={255,0,255}));
  connect(booPul1.y, mulOr.u[1]) annotation (Line(points={{-39,60},{20,60},{20,30},
          {38,30}}, color={255,0,255}));
  annotation (
  experiment(StopTime=10.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/fixme.mos"
        "Simulate and plot"),
