...
block GreaterEqual
  ...
  Controls.OBC.CDL.Interfaces.RealInput u1 "Connector of first Boolean input signal"
    annotation (Placement(transformation(extent={{-140,-20},{-100,20}})));

  Controls.OBC.CDL.Interfaces.RealInput u2 "Connector of second Boolean input signal"
