...
block Proof "Verify two boolean inputs"
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueDelay truDel1(
    final delayTime=debounce, delayOnInit=true)
...
equation
  ...
  connect(uMea, not1.u) annotation (Line(points={{-160,90},{-130,90},{-130,40},
  ...
  connect(uCom, not2.u) annotation (Line(points={{-160,-20},{-130,-20},{-130,
          -90},{-122,-90}},
                       color={255,0,255}));
  ...
  connect(truDel3.y, botTru.u2) annotation (Line(points={{-98,-20},{-50,-20},{
          -50,82},{-22,82}},
                         color={255,0,255}));
  connect(botTru.y, not3.u)
    annotation (Line(points={{2,90},{18,90}}, color={255,0,255}));
  connect(truDel3.y, not5.u) annotation (Line(points={{-98,-20},{-50,-20},{-50,
          -50},{-42,-50}},
                      color={255,0,255}));
  ...
  connect(truDel3.y, falTru.u2) annotation (Line(points={{-98,-20},{90,-20},{90,
          82},{98,82}}, color={255,0,255}));
  connect(falTru.y, y1)
  ...
  connect(truFal.y, y2)
    annotation (Line(points={{122,-90},{160,-90}}, color={255,0,255}));
  connect(not5.y, truFal.u2) annotation (Line(points={{-18,-50},{90,-50},{90,
          -98},{98,-98}}, color={255,0,255}));
  connect(truDel1.y, booToInt.u)
    annotation (Line(points={{-58,40},{-42,40}}, color={255,0,255}));
  connect(truDel2.y, booToInt1.u)
  ...
  connect(booToInt1.y, equSta.u2) annotation (Line(points={{-18,-90},{-10,-90},
          {-10,32},{-2,32}}, color={255,127,0}));
  connect(equSta.y, botFal.u1)
    annotation (Line(points={{22,40},{38,40}}, color={255,0,255}));
  connect(not5.y, botFal.u2) annotation (Line(points={{-18,-50},{30,-50},{30,32},
          {38,32}}, color={255,0,255}));
  connect(botFal.y, notBotFal.u) annotation (Line(points={{62,40},{80,40},{80,0},
          {0,0},{0,-90},{18,-90}}, color={255,0,255}));
