...
protected
  ...
  LessNoHysteresis lesEquNoHys if not have_hysteresis
...
equation
  ...
  connect(u1,lesEquNoHys.u1)
    annotation (Line(points={{-120,0},{-66,0},{-66,-30},{-12,-30}},color={255,127,0}));
  connect(u2,lesEquNoHys.u2)
...
is less than or equal to the Integer input <code>u2</code>, optionally within a hysteresis <code>h</code>.
</p>
<p>
The parameter <code>h &ge; 0</code> is used to specify a hysteresis.
If <i>h &ne; 0</i>, then the output switches to <code>true</code> if <i>u<sub>1</sub> &le; u<sub>2</sub></i>,
and it switches to <code>false</code> if <i>u<sub>1</sub> &gt; u<sub>2</sub> + h</i>.
If <i>h = 0</i>, the output is <i>y = u<sub>1</sub> &le; u<sub>2</sub></i>.
</p>
</html>",
revisions="<html>
<ul>
