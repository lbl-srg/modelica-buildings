...
model TimeTableNegativeStartTime
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.TimeTable intTimTabPer(table=[0,1,
        4; 1.3,2,2; 2.9,0,-1; 4,3,7; 5,1,1], extrapolation=Buildings.Controls.OBC.CDL.Types.Extrapolation.Periodic)
