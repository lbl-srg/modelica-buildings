...
block GreaterEqualThreshold
  "Output y is true, if input u is greater than or equal to a threshold"
...
protected
  ...
  GreaterNoHysteresis greEquNoHys(
...
is greater than or equal to a threshold <code>t</code>, optionally within a hysteresis <code>h</code>.
</p>
<p>
The parameter <code>h &ge; 0</code> is used to specify a hysteresis.
If <i>h &ne; 0</i>, then the output switches to <code>true</code> if <i>u &ge; t</i>,
where <i>t</i> is the threshold,
and it switches to <code>false</code> if <i>u &lt; t - h</i>.
If <i>h = 0</i>, the output is <i>y = u &ge; t</i>.
</p>
</html>",
revisions="<html>
<ul>
