...
equation
  ...
  connect(greNoHys.y,y)
    annotation (Line(points={{12,-30},{60,-30},{60,0},{120,0}},color={255,0,255}));
  connect(u1, greNoHys.u1) annotation (Line(points={{-120,0},{-66,0},{-66,-30},{-12,-30}},
          color={255,127,0}));
  connect(u1, greHys.u1) annotation (Line(points={{-120,0},{-66,0},{-66,30},{-12,30}},
          color={255,127,0}));
  annotation (
...
is greater than the Integer input <code>u2</code>, optionally within a hysteresis <code>h</code>.
</p>
<p>
