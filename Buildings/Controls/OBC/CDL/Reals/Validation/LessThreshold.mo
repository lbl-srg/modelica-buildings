...
model LessThreshold
  ...
  Buildings.Controls.OBC.CDL.Reals.LessThreshold les(t=2)
    "Less block, without hysteresis"
    annotation (Placement(transformation(extent={{20,20},{40,40}})));
  Buildings.Controls.OBC.CDL.Reals.LessThreshold lesHys(t=2, h=1)
...
<a href=\"modelica://Buildings.Controls.OBC.CDL.Reals.LessThreshold\">
Buildings.Controls.OBC.CDL.Reals.LessThreshold</a>.
