...
model LimitSlewRate "Validation model for the LimitSlewRate block"
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Ramp ramp6(
    offset=0,
    height=1.5,
    startTime=240,
    duration=40)
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Ramp ramp7(
    offset=0,
    height=-1.5,
    duration=50,
    startTime=360+60)
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Ramp ramp8(
    offset=0,
    height=1.5,
    duration=50,
    startTime=360)
