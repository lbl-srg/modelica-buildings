...
model MatrixMin
  ...
  Buildings.Controls.OBC.CDL.Reals.MatrixMin matMin1(
    nCol=3,
    rowMin=false,
    nRow=2)
    "Matrix minimum"
    annotation (Placement(transformation(extent={{0,-10},{20,10}})));
  Buildings.Controls.OBC.CDL.Reals.MatrixMin matMin2(
    nCol=3,
    rowMin=true,
    nRow=2)
    "Matrix minimum"
...
<a href=\"modelica://Buildings.Controls.OBC.CDL.Reals.MatrixMin\">
Buildings.Controls.OBC.CDL.Reals.MatrixMin</a>.
</p>
</html>",
      revisions="<html>
<ul>
