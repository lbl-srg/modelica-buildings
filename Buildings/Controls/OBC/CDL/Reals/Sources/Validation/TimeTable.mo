...
model TimeTable
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.TimeTable timTabLinHol(
    smoothness=Buildings.Controls.OBC.CDL.Types.Smoothness.LinearSegments,
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.TimeTable timTabLinDer(
    smoothness=Buildings.Controls.OBC.CDL.Types.Smoothness.LinearSegments,
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.TimeTable timTabCon(
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.TimeTable timTabLinCon(
    smoothness=Buildings.Controls.OBC.CDL.Types.Smoothness.LinearSegments,
    table=[
      0,0;
      6*3600,0;
