block To_BtuPerh "Block that converts power from British thermal units per hour to watt"
...
protected
  parameter Real k = 1./0.2930711 "Multiplier";
...
equation
  ...
  annotation (
      defaultComponentName = "To_BtuPerh",
    Icon(graphics={
        Rectangle(
