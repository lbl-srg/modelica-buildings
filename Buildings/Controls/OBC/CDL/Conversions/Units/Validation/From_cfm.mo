...
protected
  ...
  Buildings.Controls.OBC.CDL.Conversions.Units.From_cfm From_cfm
  "Unit converter from cubic feet per minute to cubic meters per second "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  Buildings.Controls.OBC.CDL.Conversions.Units.From_cfm From_cfm1
  "Unit converter from cubic feet per minute to cubic meters per second "
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/Units/Validation/From_cfm.mos"
    "Simulate and plot"),
    Documentation(
    info="<html>
<p>
