model From_hp "Test power unit conversion from horsepowers to watt"
...
protected
  ...
  Buildings.Controls.OBC.CDL.Conversions.Units.From_hp From_hp
  "Unit converter from horsepowers to watt "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  Buildings.Controls.OBC.CDL.Conversions.Units.From_hp From_hp1
  "Unit converter from horsepowers to watt "
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/Units/Validation/From_hp.mos"
    "Simulate and plot"),
    Documentation(
    info="<html>
<p>
