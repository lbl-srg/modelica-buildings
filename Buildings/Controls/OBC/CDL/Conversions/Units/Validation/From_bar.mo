model From_bar "Test pressure unit conversion from bar to pascal"
  import Buildings.Controls.OBC.CDL.Conversions.Units;
...
protected
  ...
  parameter Real kin1 = .00025 "Validation input 1";
  parameter Real kout = 1.*100000. "Validation output";
  parameter Real kout1 = .00025*100000. "Validation output 1";

  Buildings.Controls.OBC.CDL.Conversions.Units.From_bar From_bar
  "Unit converter from bar to pascal "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  Buildings.Controls.OBC.CDL.Conversions.Units.From_bar From_bar1
  "Unit converter from bar to pascal "
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/Units/Validation/From_bar.mos"
    "Simulate and plot"),
    Documentation(
    info="<html>
<p>
