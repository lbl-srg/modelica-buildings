...
protected
  ...
  Buildings.Controls.OBC.CDL.Conversions.Units.To_inH2O To_inH2O
  "Unit converter from inch of water gauge (at 60 degF) to pascal "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  Buildings.Controls.OBC.CDL.Conversions.Units.To_inH2O To_inH2O1
  "Unit converter from inch of water gauge (at 60 degF) to pascal "
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/Units/Validation/To_inH2O.mos"
    "Simulate and plot"),
    Documentation(
    info="<html>
<p>
