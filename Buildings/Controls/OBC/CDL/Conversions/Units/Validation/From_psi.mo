...
protected
  ...
  Buildings.Controls.OBC.CDL.Conversions.Units.From_psi From_psi
  "Unit converter from pound-force per square inch to pascal "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  Buildings.Controls.OBC.CDL.Conversions.Units.From_psi From_psi1
  "Unit converter from pound-force per square inch to pascal "
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/Units/Validation/From_psi.mos"
    "Simulate and plot"),
    Documentation(
    info="<html>
<p>
