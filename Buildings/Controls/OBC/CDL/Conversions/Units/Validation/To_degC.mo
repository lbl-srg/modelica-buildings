...
protected
  ...
  Buildings.Controls.OBC.CDL.Conversions.Units.To_degC To_degC
  "Unit converter from degree celsius to kelvin "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  Buildings.Controls.OBC.CDL.Conversions.Units.To_degC To_degC1
  "Unit converter from degree celsius to kelvin "
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/Units/Validation/To_degC.mos"
    "Simulate and plot"),
    Documentation(
    info="<html>
<p>
