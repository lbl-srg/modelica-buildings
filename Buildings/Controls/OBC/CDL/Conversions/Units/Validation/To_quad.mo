...
protected
  ...
  Buildings.Controls.OBC.CDL.Conversions.Units.To_quad To_quad
  "Unit converter from quads to joule "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  Buildings.Controls.OBC.CDL.Conversions.Units.To_quad To_quad1
  "Unit converter from quads to joule "
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/Units/Validation/To_quad.mos"
    "Simulate and plot"),
    Documentation(
    info="<html>
<p>
