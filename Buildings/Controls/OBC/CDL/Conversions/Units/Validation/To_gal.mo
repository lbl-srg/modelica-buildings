...
protected
  ...
  Buildings.Controls.OBC.CDL.Conversions.Units.To_gal To_gal
  "Unit converter from gallon to cubic meter "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  Buildings.Controls.OBC.CDL.Conversions.Units.To_gal To_gal1
  "Unit converter from gallon to cubic meter "
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/Units/Validation/To_gal.mos"
    "Simulate and plot"),
    Documentation(
    info="<html>
<p>
