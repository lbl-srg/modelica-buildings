...
protected
  ...
  Buildings.Controls.OBC.CDL.Conversions.UnitConverters.From_gal From_gal
  "Unit converter from gallon to cubic meter "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  Buildings.Controls.OBC.CDL.Conversions.UnitConverters.From_gal From_gal1
  "Unit converter from gallon to cubic meter "
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/UnitConverters/Validation/From_gal.mos"
    "Simulate and plot"),
    Documentation(
    info="<html>
<p>
