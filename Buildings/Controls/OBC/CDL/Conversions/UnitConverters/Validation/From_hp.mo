...
protected
  ...
  Buildings.Controls.OBC.CDL.Conversions.UnitConverters.From_hp From_hp1
  "Unit converter from horsepowers to watt "
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/UnitConverters/Validation/From_hp.mos"
    "Simulate and plot"),
    Documentation(
    info="<html>
<p>
