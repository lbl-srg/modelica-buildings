...
protected
  ...
  Buildings.Controls.OBC.CDL.Conversions.UnitConverters.From_psi From_psi1
  "Unit converter from pound-force per square inch to pascal "
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/UnitConverters/Validation/From_psi.mos"
    "Simulate and plot"),
    Documentation(
    info="<html>
<p>
