...
protected
  ...
  Buildings.Controls.OBC.CDL.Conversions.UnitConverters.To_degF To_degF1
  "Unit converter from degree fahrenheit to kelvin "
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/UnitConverters/Validation/To_degF.mos"
    "Simulate and plot"),
    Documentation(
    info="<html>
<p>
