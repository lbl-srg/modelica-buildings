...
protected
  ...
  Buildings.Controls.OBC.CDL.Conversions.UnitConverters.To_bar To_bar
  "Unit converter from bar to pascal "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  Buildings.Controls.OBC.CDL.Conversions.UnitConverters.To_bar To_bar1
  "Unit converter from bar to pascal "
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/UnitConverters/Validation/To_bar.mos"
    "Simulate and plot"),
    Documentation(
    info="<html>
<p>
