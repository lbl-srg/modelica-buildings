...
protected
  ...
  Buildings.Controls.OBC.CDL.Conversions.UnitConverters.To_gal To_gal1
  "Unit converter from gallon to cubic meter "
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/UnitConverters/Validation/To_gal.mos"
    "Simulate and plot"),
    Documentation(
    info="<html>
<p>
