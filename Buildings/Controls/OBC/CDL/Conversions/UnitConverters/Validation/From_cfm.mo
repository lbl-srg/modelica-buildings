...
protected
  ...
  Buildings.Controls.OBC.CDL.Conversions.UnitConverters.From_cfm From_cfm1
  "Unit converter from cubic feet per minute to cubic meters per second "
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/UnitConverters/Validation/From_cfm.mos"
    "Simulate and plot"),
    Documentation(
    info="<html>
<p>
