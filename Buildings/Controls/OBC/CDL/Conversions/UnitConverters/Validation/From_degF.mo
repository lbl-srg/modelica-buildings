...
protected
  ...
  Buildings.Controls.OBC.CDL.Conversions.UnitConverters.From_degF From_degF
  "Unit converter from degree fahrenheit to kelvin "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  Buildings.Controls.OBC.CDL.Conversions.UnitConverters.From_degF From_degF1
  "Unit converter from degree fahrenheit to kelvin "
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/UnitConverters/Validation/From_degF.mos"
    "Simulate and plot"),
    Documentation(
    info="<html>
<p>
