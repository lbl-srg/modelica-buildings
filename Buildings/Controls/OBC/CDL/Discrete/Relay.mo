...
block Relay "Outputs a relay signal for PID tuning experiment"
  ...
  Interfaces.RealOutput dtON "Half-period length for the higher value" annotation (Placement(transformation(extent={{100,10},{120,30}})));
  Interfaces.RealOutput dtOFF "Half-period length for the lower value" annotation (Placement(transformation(extent={{100,-70},{120,-50}})));
  ...
  Modelica.Units.SI.Time tON_start(start=0) "Time when the output is the higher value";
  Modelica.Units.SI.Time tOFF_start(start=0) "Time when the output is the lower value";
