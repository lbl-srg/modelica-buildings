...
model TWetBul_TDryBulPhi
 ...
 // ============ Below blocks are from Buildings Library ============
  ...
  Controls.OBC.CDL.Continuous.Add add(k2=-1)    annotation (Placement(transformation(extent={{40,6},{60,26}})));
  Controls.OBC.CDL.Continuous.Add add1(k2=-1)    annotation (Placement(transformation(extent={{40,-34},{60,-14}})));
equation
