...
equation
  ...
  connect(TDryBul.y, wetBulPhi.TDryBul)
    annotation (Line(points={{-68,56},{-40,56},{-40,62},{-12,62}},
      color={0,0,127}));
  ...
  connect(phi.y, wetBulPhi.phi)
    annotation (Line(points={{-68,16},{-46,16},{-46,52},{-28,52},{-28,50},{-12,
          50}},
      color={0,0,127}));
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Psychrometrics/Validation/WetBulb_TDryBulPhi.mos"
        "Simulate and plot"),
