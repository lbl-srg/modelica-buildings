...
model BooleanArrayReplicator
  "Validation model for the BooleanArrayReplicator block"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Routing/Validation/BooleanArrayReplicator.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://Buildings.Controls.OBC.CDL.Routing.BooleanArrayReplicator\">
Buildings.Controls.OBC.CDL.Routing.BooleanArrayReplicator</a>.
</p>
</html>",
      revisions="<html>
<ul>
