...
equation
  ...
  connect(resVal.y, pla1.y_reset_in) annotation (Line(points={{-58,10},{30,10},{
          30,42},{38,42}}, color={0,0,127}));
  ...
  connect(gai.u, pulse.y) annotation (Line(points={{-42,-50},{-50,-50},{-50,50},
          {-60,50}}, color={0,0,127}));
...
__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Continuous/Validation/PIDScale.mos"
        "Simulate and plot"),
