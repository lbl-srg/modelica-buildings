...
equation
  ...
  connect(greEquThr.y, limPIDPar.trigger) annotation (Line(points={{-30,-60},{12,
          -60},{12,50},{24,50},{24,58}}, color={255,0,255}));
  ...
  connect(greEquThr.y, limPIPar.trigger) annotation (Line(points={{-30,-60},{12,
          -60},{12,-50},{24,-50},{24,-42}}, color={255,0,255}));
  ...
  connect(limPIDInp.trigger, greEquThr.y) annotation (Line(points={{24,18},{24,10},
          {12,10},{12,-60},{-30,-60}}, color={255,0,255}));
  connect(resVal.y, intWitRes1.y_reset_in) annotation (Line(points={{-58,0},{48,
          0},{48,62},{58,62}}, color={0,0,127}));
  connect(resVal.y, intWitRes2.y_reset_in) annotation (Line(points={{-58,0},{48,
          0},{48,22},{58,22}}, color={0,0,127}));
  connect(resVal.y, intWitRes3.y_reset_in) annotation (Line(points={{-58,0},{48,
          0},{48,-38},{58,-38}}, color={0,0,127}));
  connect(resVal.y, intWitRes4.y_reset_in) annotation (Line(points={{-58,0},{48,
          0},{48,-78},{58,-78}}, color={0,0,127}));
  connect(con.y, intWitRes1.trigger) annotation (Line(points={{-58,40},{-20,40},
          {-20,-6},{54,-6},{54,54},{70,54},{70,58}}, color={255,0,255}));
  connect(con.y, intWitRes2.trigger) annotation (Line(points={{-58,40},{-20,40},
          {-20,-6},{70,-6},{70,18}}, color={255,0,255}));
  connect(con.y, intWitRes3.trigger) annotation (Line(points={{-58,40},{-20,40},
          {-20,-6},{54,-6},{54,-46},{70,-46},{70,-42}}, color={255,0,255}));
  connect(con.y, intWitRes4.trigger) annotation (Line(points={{-58,40},{-20,40},
          {-20,-6},{54,-6},{54,-86},{70,-86},{70,-82}}, color={255,0,255}));
 annotation (
 experiment(
      StopTime=10,
      Tolerance=1e-06),
