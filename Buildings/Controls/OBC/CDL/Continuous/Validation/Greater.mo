...
model Greater "Validation model for the Greater block"
  ...
  Buildings.Controls.OBC.CDL.Continuous.Greater greHys(h=0.2)
...
equation
  connect(con.y, greHys.u2) annotation (Line(points={{-38,-10},{-26,-10},{-26,-28},
          {-12,-28}}, color={0,0,127}));
  connect(con.y, gre.u2) annotation (Line(points={{-38,-10},{-26,-10},{-26,22},{
          -12,22}}, color={0,0,127}));
  connect(ram.y[1], gre.u1)
    annotation (Line(points={{-38,30},{-12,30}}, color={0,0,127}));
  connect(ram.y[1], greHys.u1) annotation (Line(points={{-38,30},{-20,30},{-20,-20},
          {-12,-20}}, color={0,0,127}));
  annotation (
