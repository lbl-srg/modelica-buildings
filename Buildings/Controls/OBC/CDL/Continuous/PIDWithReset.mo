...
equation
  connect(trigger,I.trigger)
    annotation (Line(points={{-160,-220},{-160,-140},{-30,-140},{-30,-12}},color={255,0,255}));
  ...
  connect(addRes.u2,addPD.y)
    annotation (Line(points={{-70,-92},{-70,-108},{28,-108},{28,114},{22,114}},color={0,0,127}));
  connect(addRes.y,I.y_reset_in)
    annotation (Line(points={{-58,-80},{-52,-80},{-52,-8},{-42,-8}},color={0,0,127}));
  connect(divK.u,yResSig.y)
    annotation (Line(points={{-122,-80},{-158,-80}},color={0,0,127}));
  ...
  connect(trigger,Izero.u)
    annotation (Line(points={{-160,-220},{-160,-140},{-22,-140}},color={255,0,255}));
  connect(Izero.y,addPID.u2)
    annotation (Line(points={{2,-140},{34,-140},{34,84},{38,84}},color={0,0,127}));
  connect(errP.u1,uS_revAct.y)
    annotation (Line(points={{-102,120},{-170,120},{-170,40},{-178,40}},color={0,0,127}));
