model From_BtuPerh "Test power unit conversion from British thermal units per hour to watt"
...
protected
  ...
  Buildings.Controls.OBC.UnitConversions.From_BtuPerh From_BtuPerh
  "Unit converter from British thermal units per hour to watt "
    annotation (Placement(transformation(extent={{-20,40},{0,60}})));
  Buildings.Controls.OBC.UnitConversions.From_BtuPerh From_BtuPerh1
  "Unit converter from British thermal units per hour to watt "
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/UnitConversions/Validation/From_BtuPerh.mos"
    "Simulate and plot"),
    Documentation(
    info="<html>
<p>
