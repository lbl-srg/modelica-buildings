...
equation
  ...
  connect(con.y, nexCoi.uDXCoiAva[1]) annotation (Line(points={{-68,20},{-60,20},
          {-60,8},{18,8}}, color={255,0,255}));
  connect(truDel1.y, nexCoi.uDXCoiAva[2]) annotation (Line(points={{-18,-10},{-4,
          -10},{-4,6},{18,6},{18,8}}, color={255,0,255}));
  connect(nexCoi.yStaUp, chaSta1.uNexDXCoiSta) annotation (Line(points={{42,12},
          {50,12},{50,18},{58,18}}, color={255,0,255}));
  connect(nexCoi.yNexCoi, chaSta1.uNexDXCoi)
    annotation (Line(points={{42,8},{50,8},{50,6},{58,6}}, color={255,127,0}));
  connect(nexCoi.yNexCoi, chaSta1.uLasDXCoi)
    annotation (Line(points={{42,8},{50,8},{50,2},{58,2}}, color={255,127,0}));
  ...
  connect(truDel2.y, nexCoi.uDXCoiAva[3]) annotation (Line(points={{-68,-10},{-56,
          -10},{-56,10},{18,10},{18,8}}, color={255,0,255}));
  ...
  connect(nexCoi1.yStaUp, chaSta2.uNexDXCoiSta) annotation (Line(points={{42,-68},
          {50,-68},{50,-62},{58,-62}}, color={255,0,255}));
  connect(nexCoi1.yNexCoi, chaSta2.uNexDXCoi) annotation (Line(points={{42,-72},
          {50,-72},{50,-74},{58,-74}}, color={255,127,0}));
  connect(pre2.y, chaSta2.uDXCoil) annotation (Line(points={{116,-70},{120,-70},
          {120,-90},{54,-90},{54,-70},{58,-70}}, color={255,0,255}));
  connect(nexCoi1.yNexCoi, chaSta2.uLasDXCoi) annotation (Line(points={{42,-72},
          {50,-72},{50,-78},{58,-78}}, color={255,127,0}));
  ...
  connect(truDel3.y, nexCoi1.uDXCoiAva[2]) annotation (Line(points={{-18,-80},{-14,
          -80},{-14,-72},{18,-72}}, color={255,0,255}));
  ...
  connect(nexCoi.yStaUp, yStaUp.u) annotation (Line(points={{42,12},{50,12},{50,
          40},{58,40}}, color={255,0,255}));
  connect(nexCoi1.yStaUp, yStaUp1.u) annotation (Line(points={{42,-68},{48,-68},
