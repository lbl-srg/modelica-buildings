...
equation
  ...
  annotation (defaultComponentName="zerStaIndCor",
    ...
    Documentation(info="<html>
      ...
      Buildings.Controls.OBC.ChilledBeams.SecondaryPumps.Validation.Controller</a>.
      ...
      current index value, and <code>u</code> for the current signal. 
      It outputs a modified index signal <code>yIndMod</code> and a modified 
      signal <code>yMod</code>.
      <ul>
      <li>
      <code>yIndMod</code> is set to 1 and <code>yMod</code> is set to zero 
      when <code>uInd</code> is zero.
      </li>
      <li>
      <code>yIndMod</code> is set to <code>uInd</code> and <code>yMod</code> is
      set to <code>u</code> when <code>uInd</code> is not zero.
      </li>
      </ul>
      </p>
      <p>
      For an example of usage, check the
      <a href=\"modelica://Buildings.Controls.OBC.ChilledBeams.SecondaryPumps.Validation.Controller\">
      Controller</a> block.
      </p>
      </html>", revisions="<html>
      <ul>
