within Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Pumps.ChilledWater.Subsequences;
block EnableLag_primary_dP
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset tim(
    final t=timPer)
    "Check if it has passed the threhold time"
    annotation (Placement(transformation(extent={{80,110},{100,130}})));
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset tim1(
    final t=timPer)
    "Check if it has passed the threhold time"
