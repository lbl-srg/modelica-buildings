within Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Towers.FanSpeed.ReturnWaterTemperature.Validation;
model Controller
  "Validation sequence of controlling tower fan speed based on condenser water return temperature control"

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Towers.FanSpeed.ReturnWaterTemperature.Controller
    towFanSpe
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Towers.FanSpeed.ReturnWaterTemperature.Controller
    ...
    annotation (Placement(transformation(extent={{98,180},{138,220}})));
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Towers.FanSpeed.ReturnWaterTemperature.Controller
    towFanSpe2(
    have_WSE=false)
...
equation
  ...
  connect(wseSta.y, towFanSpe1.uWse)
    annotation (Line(points={{-338,60},{32,60},{32,212},{96,212}},
      color={255,0,255}));
  ...
  connect(add3.y, towFanSpe1.TConWatRet)
    annotation (Line(points={{-278,-180},{74,-180},{74,188},{96,188}},
      color={0,0,127}));
  connect(add1.y, towFanSpe1.TConWatSup)
    annotation (Line(points={{-278,-260},{86,-260},{86,182},{96,182}},
      color={0,0,127}));
  ...
  connect(chiSta2.y, towFanSpe1.uChi[2])
    annotation (Line(points={{-338,90},{26,90},{26,215},{96,215}},
      color={255,0,255}));
  ...
  connect(or3.y, towFanSpe1.uPla)
    annotation (Line(points={{-238,-140},{68,-140},{68,191},{96,191}},
      color={255,0,255}));
  ...
  connect(not1.y, towFanSpe1.uChi[1])
    annotation (Line(points={{-298,120},{26,120},{26,215},{96,215}},
      color={255,0,255}));
  ...
  connect(not2.y, towFanSpe.uConWatPum) annotation (Line(points={{-218,-220},{
          -140,-220},{-140,185},{-122,185}}, color={255,0,255}));
  connect(not2.y, towFanSpe1.uConWatPum) annotation (Line(points={{-218,-220},{
          80,-220},{80,185},{96,185}}, color={255,0,255}));
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Towers.FanSpeed.ReturnWaterTemperature.Controller\">
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Towers.FanSpeed.ReturnWaterTemperature.Controller</a>.
</p>
<p>
