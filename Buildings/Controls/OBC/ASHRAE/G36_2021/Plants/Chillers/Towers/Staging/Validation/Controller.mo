within Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Towers.Staging.Validation;
model Controller "Validation sequence of tower cell controller"

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Towers.Staging.Controller
    towSta(
    final nTowCel=2,
    final nConWatPum=2,
    final nPlaSta=5,
...
annotation (experiment(
      StopTime=3600,
      Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2021/Plants/Chillers/Towers/Staging/Validation/Controller.mos"
    "Simulate and plot"),
  Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Towers.Staging.Controller\">
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Towers.Staging.Controller</a>.
