within Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Towers.FanSpeed.EnabledWSE.Validation;
model Controller
  "Validation sequence of controlling tower fan speed when waterside economizer is enabled"

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Towers.FanSpeed.EnabledWSE.Controller
    wseOpe(
    kWSE=0.1,
    TiWSE=5)
...
annotation (experiment(StopTime=3600.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2021/Plants/Chillers/Towers/FanSpeed/EnabledWSE/Validation/Controller.mos"
    "Simulate and plot"),
  Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Towers.FanSpeed.EnabledWSE.Controller\">
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Towers.FanSpeed.EnabledWSE.Controller</a>.
</p>
<p>
