within Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Towers.Staging.Subsequences.Validation;
model CellsNumber
  "Validation sequence of identifying total number of enabling cells"

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Towers.Staging.Subsequences.CellsNumber
    enaTowCel(
    nConWatPum=2,
...
annotation (experiment(StopTime=3600.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2021/Plants/Chillers/Towers/Staging/Subsequences/Validation/CellsNumber.mos"
    "Simulate and plot"),
