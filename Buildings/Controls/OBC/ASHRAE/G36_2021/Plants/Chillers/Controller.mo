...
block Controller "Chiller plant controller"
  ...
  final parameter Boolean have_chiHeaPreCon= chiHeaPreCon==Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.HeadPressureControl.ByChiller
    "True: the chiller head pressure is controlled by the chiller itself"
    annotation(Dialog(tab="General", group="Chillers configuration"));
  final parameter Boolean have_plaHeaPreCon= chiHeaPreCon==Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.HeadPressureControl.ByPlant
    "True: the chiller head pressure is controlled by the plant controller"
    annotation(Dialog(tab="General", group="Chillers configuration"));
  final parameter Boolean need_heaPreCon= not chiHeaPreCon==Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.HeadPressureControl.NotRequired
    "True: the plant requires chiller head pressure control"
    annotation(Dialog(tab="General", group="Chillers configuration"));

  parameter Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.HeadPressureControl chiHeaPreCon=
    Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.HeadPressureControl.ByPlant
  ...
  parameter Boolean have_modPosChiVal=false
    ...
    annotation (Dialog(tab="General", group="Chillers configuration",
                       enable=chiIsoValTyp==Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.Actuator.Modulating));
  ...
  final parameter Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.TowerSpeedControl fanSpeCon=
    Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.TowerSpeedControl.CondenserWaterReturnTemperaure
    "Tower fan speed control type"
    annotation (Dialog(tab="Cooling towers", group="Fan speed", enable=not have_airCoo));

  final parameter Boolean have_conWatRetCon = fanSpeCon==Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.TowerSpeedControl.CondenserWaterReturnTemperaure
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uChiWatIsoVal[nChi](
    ...
    min=fill(0, nChi),
    max=fill(1, nChi)) if have_modPosChiVal and chiIsoValTyp == Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.Actuator.Modulating
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput y1ChiWatIsoVal[nChi] if
    chiIsoValTyp == Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.Actuator.TwoPosition
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Economizers.Controller wseSta(
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.PlantEnable.Enable plaEna(
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.HeadPressure.Controller heaPreCon[nChi](
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.MinimumFlowBypass.Controller minBypValCon(
    final nChi=nChi,
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Pumps.ChilledWater.Controller chiWatPumCon(
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.SetPoints.ChilledWaterPlantReset chiWatPlaRes(
    final nPum=nChiWatPum,
    final holTim=holTim,
    final iniSet=iniSet,
    final minSet=minSet,
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.SetPoints.ChilledWaterSupply chiWatSupSet(
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.SetpointController staSetCon(
    final have_WSE=have_WSE and not have_airCoo,
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Towers.Controller towCon(
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.Processes.Down dowProCon(
    final nChi=nChi,
    final nConWatPum=nConWatPum,
    final nPlaSta=nPlaSta,
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.PlantEnable.DisableChillers disChi(
    final have_airCoo=have_airCoo,
    final have_WSE=have_WSE,
    final nChi=nChi,
    final nChiWatPum=nChiWatPum,
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.IdentifyStage ideSta(
    final nSta=nSta,
    final nChi=nChi,
    final staMat=staMat)
...
protected
  ...
  final parameter Boolean anyVsdCen = sum({
    if chiTyp[i]==Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.ChillersAndStages.VariableSpeedCentrifugal
  ...
  Buildings.Controls.OBC.CDL.Reals.Multiply chiIso[nChi] if have_modPosChiVal
     and chiIsoValTyp == Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.Actuator.Modulating
  ...
  Buildings.Controls.OBC.CDL.Reals.MultiplyByParameter gai3[nChi](
    final k=fill(1, nChi))
    if not (have_modPosChiVal and chiIsoValTyp == Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.Actuator.Modulating)
    "Dummy block"
    annotation (Placement(transformation(extent={{-420,-240},{-400,-220}})));

  Buildings.Controls.OBC.CDL.Logical.Sources.Constant con3(
    final k=not (have_modPosChiVal and chiIsoValTyp == Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.Actuator.TwoPosition))
...
annotation (
    ...
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-400},{100,400}}),
        ...
        Text(
          ...
          visible=chiIsoValTyp == Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.Actuator.TwoPosition),
        Text(
        ...
        Text(
          ...
          visible=have_modPosChiVal and chiIsoValTyp==Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.Actuator.Modulating),
        Text(
          extent={{-98,-36},{-42,-64}},
          textColor={0,0,127},
...
<tbody>
    <tr>
      ...
      <td style=\"vertical-align: middle;\">
        ...
        and
        <a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.SetPoints.ChilledWaterSupply\">
    ...
    <tr>
      ...
      <td style=\"text-align: center; vertical-align: middle;\">yes</td>
      <td style=\"vertical-align: middle;\">
        <a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.HeadPressure.Controller\">
    ...
    <tr>
      ...
      <td style=\"text-align: center; vertical-align: middle;\">yes</td>
      <td style=\"vertical-align: middle;\">
        <a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.MinimumFlowBypass.Controller\">
    ...
    <td>Primary chilled</br>water pumps</td>
      ...
      <td style=\"text-align: center; vertical-align: middle;\">yes</td>
      <td style=\"vertical-align: middle;\">
        <a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Pumps.ChilledWater.Controller\">
    ...
    <tr>
      ...
      <td style=\"vertical-align: middle;\">
        ...
        Staging up</a></br>
        and
        <a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.Processes.Down\">
        Staging down</a>
      </td>
    </tr>
    <tr>
