within Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints;
block SetpointController
  ...
  parameter Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.ChillersAndStages
    chiTyp[nChi]={Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.ChillersAndStages.PositiveDisplacement,
                  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.ChillersAndStages.VariableSpeedCentrifugal}
    "Chiller type"
    annotation (Dialog(tab="General", group="Chiller configuration parameters"));
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Up staUp(
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Down staDow(
    final have_WSE=have_WSE,
    final have_serChi=have_serChi,
    final have_senDpChiWatRemWir=have_senDpChiWatRemWir,
    final nRemSen=nRemSen,
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.CapacityRequirement capReq(
    final avePer = avePer,
    final holPer = delStaCha) "Capacity requirement"
    annotation (Placement(transformation(extent={{-320,300},{-300,320}})));

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Capacities cap(
...
protected
  ...
  final parameter Integer chiTypInt[nChi] = {
    if chiTyp[i] == Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.ChillersAndStages.PositiveDisplacement then 1
    else if chiTyp[i] == Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.ChillersAndStages.VariableSpeedCentrifugal then 2
    else 3 for i in 1:nChi}
    "Convert chiller type to integer";

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Initial iniSta(
    final have_WSE=have_WSE) "Initia stage"
    annotation (Placement(transformation(extent={{-80,100},{-60,120}})));

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Configurator conf(
    final nSta = nSta,
    final nChi = nChi,
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Status sta(
    final nSta=nSta,
    final nChi=nChi,
    final staMat=staMat)
    "First higher and lower available stage index, end stage boolean flags and chiller status setpoints"
    annotation (Placement(transformation(extent={{-320,-220},{-300,-200}})));

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.PartLoadRatios PLRs(
    ...
    "Operative and staging part load ratios"
    annotation (Placement(transformation(extent={{-182,-200},{-162,-160}})));

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Change cha(
    final nSta=nSta,
    final delStaCha=delStaCha) "Stage change assignment"
    annotation (Placement(transformation(extent={{-20,-180},{0,-160}})));

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.ChillerIndices chiInd(
    final nSta=nSta,
    final nChi=nChi,
...
equation
  ...
  connect(PLRs.yOpe, staUp.uOpe) annotation (Line(points={{-160,-172},{-136,
          -172},{-136,-99},{-102,-99}}, color={0,0,127}));
  ...
  connect(staDow.y, cha.uDow) annotation (Line(points={{-78,-230},{-60,-230},{
          -60,-176},{-22,-176}}, color={255,0,255}));
  connect(uPla, cha.uPla) annotation (Line(points={{-420,-100},{-280,-100},{
          -280,-140},{-70,-140},{-70,-180},{-22,-180}}, color={255,0,255}));
...
<ul>
<li>
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.CapacityRequirement\">
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.CapacityRequirement</a> to calculate
the capacity requirement
</li>
<li>
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Configurator\">
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Configurator</a> to allow the user
...
<li>
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Status\">
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Status</a> to calculate
for instance the next higher and lower available stages
</li>
<li>
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Capacities\">
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Capacities</a> to calculate
design and minimal stage capacities for current and next available higher and lower stage
</li>
<li>
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.PartLoadRatios\">
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.PartLoadRatios</a> to calculate
operating and staging part load ratios for current and next available higher and lower stage
</li>
<li>
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Up\">
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Up</a> to generate
a stage up signal
</li>
<li>
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Down\">
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Down</a> to generate
a stage down signal
</li>
<li>
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Change\">
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Change</a> to set the stage
based on the initial stage signal and stage up and down signals
</li>
<li>
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.ChillerIndices\">
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.ChillerIndices</a> to generate
