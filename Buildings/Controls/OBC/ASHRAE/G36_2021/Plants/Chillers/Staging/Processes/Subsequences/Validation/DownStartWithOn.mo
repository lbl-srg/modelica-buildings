within Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.Processes.Subsequences.Validation;
model DownStartWithOn
  "Validate sequence of starting the staging down process which requires enabling a chiller"

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.Processes.Subsequences.DownStart
    staStaDow1(
    final nChi=2,
...
equation
  ...
  connect(chiLoa1.y, chiTwoLoa.u1) annotation (Line(points={{142,160},{150,160},
          {150,90},{-120,90},{-120,78},{-102,78}}, color={0,0,127}));
  connect(chiOneSta.y, or2.u1)
    annotation (Line(points={{102,60},{138,60}}, color={255,0,255}));
  connect(chiTwoSta.y, or2.u2) annotation (Line(points={{102,30},{110,30},{110,52},
...
annotation (
 experiment(StopTime=1200, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2021/Plants/Chillers/Staging/Processes/Subsequences/Validation/DownStartWithOn.mos"
    "Simulate and plot"),
  Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.Processes.Subsequences.DownStart\">
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.Processes.Subsequences.DownStart</a>.
