within Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Validation;
model PartLoadRatios_u_uTyp
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.PartLoadRatios PLRs0(
    final anyVsdCen=false,
    final nSta=3)
    "Stage and operative part load ratios"
    annotation (Placement(transformation(extent={{-260,170},{-240,210}})));

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.PartLoadRatios PLRs1(
    final anyVsdCen=false,
    final nSta=3)
    "Stage and operative part load ratios"
    annotation (Placement(transformation(extent={{-40,170},{-20,210}})));

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.PartLoadRatios PLRs2(
    final anyVsdCen=false,
    final nSta=3)
    "Stage and operative part load ratios"
    annotation (Placement(transformation(extent={{180,170},{200,210}})));

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.PartLoadRatios PLRs3(
    final anyVsdCen=false,
    final nSta=3)
    "Stage and operative part load ratios"
    annotation (Placement(transformation(extent={{420,170},{440,210}})));

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.PartLoadRatios PLRs4(
    final anyVsdCen=true,
    final nSta=3)
    "Stage and operative part load ratios"
    annotation (Placement(transformation(extent={{-260,-170},{-240,-130}})));

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.PartLoadRatios PLRs5(
    final anyVsdCen=true,
    final nSta=3)
    "Stage and operative part load ratios"
    annotation (Placement(transformation(extent={{-40,-170},{-20,-130}})));

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.PartLoadRatios PLRs6(
    final anyVsdCen=true,
    final nSta=3)
    "Stage and operative part load ratios"
    annotation (Placement(transformation(extent={{180,-170},{200,-130}})));

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.PartLoadRatios PLRs7(
    final anyVsdCen=true,
    final nSta=3)
    "Stage and operative part load ratios"
...
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.PartLoadRatios</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
