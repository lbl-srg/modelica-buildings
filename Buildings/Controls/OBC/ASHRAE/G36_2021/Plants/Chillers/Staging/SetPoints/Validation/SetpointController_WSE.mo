within Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Validation;
model SetpointController_WSE
  "Validates chiller stage status setpoint signal generation for plants with WSE"

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.SetpointController
    staSetCon(
    final have_WSE=true,
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.SetpointController
    ...
    final chiTyp={Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.ChillersAndStages.PositiveDisplacement,
                  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.ChillersAndStages.PositiveDisplacement,
                  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Types.ChillersAndStages.ConstantSpeedCentrifugal})
    "Chiller stage setpoint controller"
...
protected
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Ramp TConWatRet(
    final height=5.5,
    final duration=300,
    final offset=273.15 + 25,
    final startTime=1500) "Condenser water return temperature ramp"
...
equation
  ...
  connect(dpChiWat.y, staSetCon.dpChiWat_local) annotation (Line(points={{-98,
          30},{-90,30},{-90,157.143},{58,157.143}}, color={0,0,127}));
  ...
  connect(staSetCon.VChiWat_flow,max. y) annotation (Line(points={{58,140.952},
          {-130,140.952},{-130,110},{-138,110}},color={0,0,127}));
  ...
  connect(zerOrdHol.y,reaToInt. u)
    annotation (Line(points={{162,150},{178,150}}, color={0,0,127}));
  ...
  connect(staSetCon.yChaEdg, truFalHol.u) annotation (Line(points={{82,166.667},
          {90,166.667},{90,70},{98,70}}, color={255,0,255}));
  ...
  connect(maxTowFanSpe.y, staSetCon.uTowFanSpeMax) annotation (Line(points={{-138,
          190},{34,190},{34,147.619},{58,147.619}}, color={0,0,127}));
  ...
  connect(chiAva1.y, staSetCon1.uChiAva) annotation (Line(points={{-98,-30},{-40,
          -30},{-40,-64.7619},{58,-64.7619}}, color={255,0,255}));
  ...
  connect(TChiWatRet1.y, staSetCon1.TChiWatRet) annotation (Line(points={{-178,
          -90},{-130,-90},{-130,-95.2381},{58,-95.2381}}, color={0,0,127}));
  ...
  connect(reaToInt1.y, staSetCon1.uSta) annotation (Line(points={{202,-90},{210,
          -90},{210,-140},{50,-140},{50,-69.5238},{58,-69.5238}}, color={255,127,0}));
  ...
  connect(maxTowFanSpe1.y, staSetCon1.uTowFanSpeMax) annotation (Line(points={{-138,
          -50},{34,-50},{34,-92.381},{58,-92.381}}, color={0,0,127}));
  ...
  connect(TCWSupSet1.y, staSetCon1.TChiWatSupSet) annotation (Line(points={{-98,-70},
          {-20,-70},{-20,-71.4286},{58,-71.4286}}, color={0,0,127}));
  connect(TCWSup1.y, staSetCon1.TChiWatSup) annotation (Line(points={{-98,-130},
          {-70,-130},{-70,-73.3333},{58,-73.3333}}, color={0,0,127}));
  ...
  connect(tunPar.y, staSetCon1.uTunPar) annotation (Line(points={{-38,100},{40,
          100},{40,-90.4762},{58,-90.4762}}, color={0,0,127}));
  ...
  connect(TOutWet1.y, staSetCon1.TOutWet) annotation (Line(points={{-38,-120},{
          28,-120},{28,-88.5714},{58,-88.5714}},
                                              color={0,0,127}));
  connect(TConWatRet.y, staSetCon.TConWatRet) annotation (Line(points={{-178,0},
          {-30,0},{-30,164.762},{58,164.762}}, color={0,0,127}));
  connect(TConWatRet.y, staSetCon1.TConWatRet) annotation (Line(points={{-178,0},
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.SetpointController\">
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.SetpointController</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
