...
model Initial_WSE "Validate initial stage sequence for a plant with WSE"
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Initial iniStaCol(
    final have_WSE=true) "Initial stage is the WSE only stage"
    annotation (Placement(transformation(extent={{0,-10},{20,10}})));

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Initial iniStaHot(
    final have_WSE=true)
...
annotation (
 experiment(StopTime=86400.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2021/Plants/Chillers/Staging/SetPoints/Subsequences/Validation/Initial_WSE.mos"
    "Simulate and plot"),
