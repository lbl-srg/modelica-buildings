...
model Status_u_uAva "Validates chiller stage status subsequence"
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Status sta1(
    final nSta=4,
    final nChi=3,
    final staMat={{1,0,0},{1,1,0},{0,1,1},{1,1,1}})
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Status sta2(
    final nSta=4,
    final nChi=3,
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Status sta3(
    final nSta=4,
    final nChi=3,
    final staMat={{0,1,0},{1,1,0},{0,1,1},{1,1,1}})
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Status sta4(
    final nSta=4,
    final nChi=3,
    final staMat={{1,0,0},{1,1,0},{0,1,1},{1,1,1}})
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Status sta6(
    final nSta=4,
    final nChi=3,
    final staMat={{1,0,0},{1,1,0},{0,1,1},{1,1,1}})
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Status sta7(
    final nSta=4,
    final nChi=3,
    final staMat={{1,0,0},{1,1,0},{0,1,1},{1,1,1}})
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Staging.SetPoints.Subsequences.Status sta5(
    final nSta=4,
    final nChi=3,
    final staMat={{1,0,0},{1,1,0},{0,1,1},{1,1,1}})
...
annotation (
 experiment(StopTime=10.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2021/Plants/Chillers/Staging/SetPoints/Subsequences/Validation/Status_u_uAva.mos"
    "Simulate and plot"),
