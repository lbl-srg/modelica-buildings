within Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.MinimumFlowBypass.Validation;
model FlowSetpoint
...
annotation (
 experiment(StopTime=4.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2021/Plants/Chillers/MinimumFlowBypass/Validation/FlowSetpoint.mos"
    "Simulate and plot"),
