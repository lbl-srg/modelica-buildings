...
model Controller "Validate control of minimum bypass valve"
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.MinimumFlowBypass.Controller
    minBypValCon(
    nChi=3,
...
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.MinimumFlowBypass.Controller</a>.
