within Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.Validation;
model TimerWithReset "Validation model for the Timer block"
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset noThr
    "Timer that do not compare threshold – No Reset"
    annotation (Placement(transformation(extent={{20,10},{40,30}})));
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset thrTim(
    final t=0.3) "Timer that compares threshold – No Reset"
    annotation (Placement(transformation(extent={{20,-30},{40,-10}})));
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset thrTim1(
    final t=0.3) "Timer that compares threshold – No Reset"
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset noThrRes
    "Timer that do not compare threshold – With Reset"
    annotation (Placement(transformation(extent={{70,30},{90,50}})));
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset thrTimRes(
    final t=0.3)
    "Timer that compares threshold – With Reset"
    annotation (Placement(transformation(extent={{72,-10},{92,10}})));
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset thrTim1Res(
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold res(
    trueHoldDuration=0.01,
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset\">
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.TimerWithReset</a>.
</p>
</html>",
revisions="<html>
<ul>
