within Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.PlantEnable.Validation;
model EnableDevices "Validation sequence for enabling plant devices"

  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.PlantEnable.EnableDevices enaDev
    "Enable valves and pumps"
    annotation (Placement(transformation(extent={{60,20},{80,40}})));

  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul(
    final width=0.1, final period=4000)
    "Enabled plant"
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul1(
    final width=0.3, final period=4000)
    "Proven on pumps"
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul2(
    final width=0.7,
    final period=4000) "Change stage"
...
equation
  ...
  connect(conInt.y, enaDev.uIni) annotation (Line(points={{-58,40},{28,40},{28,34},
          {58,34}}, color={255,127,0}));
  connect(booPul1.y, not2.u)
    annotation (Line(points={{-58,-60},{-2,-60}},  color={255,0,255}));
  connect(not2.y, enaDev.uChiWatPum[1]) annotation (Line(points={{22,-60},{30,-60},
          {30,26},{58,26}}, color={255,0,255}));
  connect(not2.y, enaDev.uConWatPum[1]) annotation (Line(points={{22,-60},{30,-60},
          {30,22},{58,22}}, color={255,0,255}));
  ...
  connect(booPul2.y, intSwi.u2)
    annotation (Line(points={{-58,0},{-22,0}}, color={255,0,255}));
  connect(conInt.y, intSwi.u1) annotation (Line(points={{-58,40},{-30,40},{-30,8},
          {-22,8}}, color={255,127,0}));
  connect(conInt1.y, intSwi.u3) annotation (Line(points={{-38,-30},{-30,-30},{-30,
          -8},{-22,-8}}, color={255,127,0}));
  connect(intSwi.y, enaDev.uChiSta) annotation (Line(points={{2,0},{20,0},{20,30},
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.PlantEnable.EnableDevices\">
Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.PlantEnable.EnableDevices</a>.
...
From 400 seconds to 2800 seconds, the chiller stage <code>uChiSta</code>
equals the initial plant stage <code>uIni</code> thus it is
in the plant enabling process.
</li>
<li>
At 1200 seconds, which it is still in the plant enabling process,
the chilled water and condenser water pumps are proven on.
Thus, the lead chiller becomes enabled.
</li>
<li>
At 2800 seconds, the plant enabling process is ended.
