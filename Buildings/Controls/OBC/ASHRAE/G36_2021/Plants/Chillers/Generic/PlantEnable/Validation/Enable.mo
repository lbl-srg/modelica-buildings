...
model Enable
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2021.Plants.Chillers.Generic.PlantEnable.Enable
    disPlaSch(
    ignReq=1)
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2021/Plants/Chillers/Generic/PlantEnable/Validation/Enable.mos"
    "Simulate and plot"),
