...
block SupplyAirTemperature
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant con(k=273.15 + 21)
    "Zone heating temperature setpoint"
    annotation (Placement(transformation(extent={{-90,120},{-70,140}})));

  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant con1(k=273.15 + 25)
    "Zone cooling temperature setpoint"
    annotation (Placement(transformation(extent={{-90,0},{-70,20}})));

  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant con2(k=273.15 + 21)
    "Zone heating temperature setpoint"
    annotation (Placement(transformation(extent={{40,120},{60,140}})));

  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant con3(k=273.15 + 25)
    "Zone cooling temperature setpoint"
    annotation (Placement(transformation(extent={{40,0},{60,20}})));

  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant con4(k=273.15 + 21)
    "Zone heating temperature setpoint"
    annotation (Placement(transformation(extent={{-90,-40},{-70,-20}})));

  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant con6(k=273.15 + 25)
    "Zone cooling temperature setpoint"
    annotation (Placement(transformation(extent={{20,-130},{40,-110}})));

  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant con5(k=0.25)
    "Heating loop signal"
    annotation (Placement(transformation(extent={{-90,90},{-70,110}})));

  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant con7(k=0)
    "Heating loop signal"
    annotation (Placement(transformation(extent={{40,90},{60,110}})));

  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant con8(k=0)
    "Cooling loop signal"
    annotation (Placement(transformation(extent={{-90,30},{-70,50}})));

  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant con9(k=0.25)
    "Cooling loop signal"
