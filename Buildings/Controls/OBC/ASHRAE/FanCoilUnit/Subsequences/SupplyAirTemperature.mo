...
//       enable = have_coolingCoil));
  ...
  CDL.Interfaces.RealInput uCoo if have_coolingCoil "Cooling loop signal"
  ...
  CDL.Continuous.Sources.Constant con1(k=THeaSupAirHi)
  ...
  CDL.Continuous.Sources.Constant con3(k=TCooSupAirHi)
    "Cooling supply air temperature setpoint limit signals"
    annotation (Placement(transformation(extent={{-80,-30},{-60,-10}})));
  CDL.Continuous.Sources.Constant con4[2](k={cooPerMin,cooPerMax})
    "Cooling loop signal support points"
    annotation (Placement(transformation(extent={{-80,-90},{-60,-70}})));
  CDL.Continuous.PID conPID
    annotation (Placement(transformation(extent={{40,50},{60,70}})));
  CDL.Continuous.PID conPID1(reverseActing=false)
  ...
  CDL.Interfaces.RealInput TZonSetHea if
                                   have_heatingCoil
    "Zone heating temperature setpoint" annotation (Placement(transformation(
          extent={{-140,60},{-100,100}}), iconTransformation(extent={{-140,60},{
            -100,100}})));
  CDL.Interfaces.RealInput TZonSetCoo if
                                   have_coolingCoil
