...
block FanSpeed
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.FanCoilUnits.Subsequences.FanSpeed fanSpe2(
    have_cooCoi=true,
    have_heaCoi=true)
    "Instance demonstrating variation of operating mode"
    annotation (Placement(transformation(extent={{80,120},{100,140}})));

  Buildings.Controls.OBC.ASHRAE.G36_2018.FanCoilUnits.Subsequences.FanSpeed fanSpe1(
    have_cooCoi=true,
    have_heaCoi=true)
    "Instance demonstrating variation of cooling loop signal"
    annotation (Placement(transformation(extent={{-40,-10},{-20,10}})));

  Buildings.Controls.OBC.ASHRAE.G36_2018.FanCoilUnits.Subsequences.FanSpeed fanSpe3(
    have_cooCoi=true,
    have_heaCoi=false)
    "Instance demonstrating variation of cooling loop signal with no heating coil"
    annotation (Placement(transformation(extent={{80,-10},{100,10}})));

  Buildings.Controls.OBC.ASHRAE.G36_2018.FanCoilUnits.Subsequences.FanSpeed fanSpe4(
    have_cooCoi=false,
    have_heaCoi=true)
    "Instance demonstrating variation of heating loop signal with no cooling coil"
    annotation (Placement(transformation(extent={{-40,-140},{-20,-120}})));

  Buildings.Controls.OBC.ASHRAE.G36_2018.FanCoilUnits.Subsequences.FanSpeed fanSpe5(
    have_cooCoi=false,
    have_heaCoi=false)
...
experiment(StopTime=100, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2018/FanCoilUnits/Subsequences/Validation/FanSpeed.mos"
    "Simulate and plot"),
Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2018.FanCoilUnits.Subsequences.FanSpeed\">
Buildings.Controls.OBC.ASHRAE.G36_2018.FanCoilUnits.Subsequences.FanSpeed</a>. 
