within Buildings.Controls.OBC.ASHRAE.G36_2018.Generic.Validation;
model TimeSuppressionNegativeStartTime
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.Generic.TimeSuppression timSupCooReq
    "Time suppression for generating cooling request"
    annotation (Placement(transformation(extent={{40,70},{60,90}})));
  Buildings.Controls.OBC.ASHRAE.G36_2018.Generic.TimeSuppression timSupAla(
    final chaRat=1080,
...
annotation (experiment(
      ...
      StopTime=7200,
      Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2018/Generic/Validation/TimeSuppressionNegativeStartTime.mos"
    "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2018.Generic.TimeSuppression\">
Buildings.Controls.OBC.ASHRAE.G36_2018.Generic.TimeSuppression</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
