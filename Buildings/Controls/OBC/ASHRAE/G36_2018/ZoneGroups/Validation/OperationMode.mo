...
model OperationMode "Validate block for selecting operation mode"
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.ZoneGroups.OperationMode
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2018/ZoneGroups/Validation/OperationMode.mos"
        "Simulate and plot"),
