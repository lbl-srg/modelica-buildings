...
model GroupStatus
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.ZoneGroups.GroupStatus zonGroSta(
    final nBuiZon=3,
    final nGroZon=2,
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2018/ZoneGroups/Validation/GroupStatus.mos"
        "Simulate and plot"),
