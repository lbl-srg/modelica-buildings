...
protected
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger booToIntHea(
    ...
    final integerTrue=Buildings.Controls.OBC.ASHRAE.G36_2018.Types.ZoneStates.heating)
    "Convert Boolean to Integer number"
    annotation (Placement(transformation(extent={{0,30},{20,50}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger booToIntCoo(
    final integerFalse=0,
    final integerTrue=Buildings.Controls.OBC.ASHRAE.G36_2018.Types.ZoneStates.cooling)
    "Convert Boolean to Integer number"
  ...
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger booToIntDea(
    final integerFalse=0,
    final integerTrue=Buildings.Controls.OBC.ASHRAE.G36_2018.Types.ZoneStates.deadband)
    "Convert Boolean to Integer number"
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2018.Types.ZoneStates\">
Buildings.Controls.OBC.ASHRAE.G36_2018.Types.ZoneStates</a>.
</p>
<p>
