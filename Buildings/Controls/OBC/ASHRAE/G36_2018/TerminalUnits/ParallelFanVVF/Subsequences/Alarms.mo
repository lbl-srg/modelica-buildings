within Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.ParallelFanVVF.Subsequences;
block Alarms "Generate alarms of parallel fan-powered terminal unit with variable-volume fan"
  ...
  parameter Real hotWatRes
    ...
    annotation (Dialog(enable=heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased));
  ...
  parameter Real lowTemTim(
    ...
    annotation (__cdl(ValueInReference=true), Dialog(enable=heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased));
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TDisSet(
    final unit="K",
    final displayUnit="degC",
    final quantity="ThermodynamicTemperature") if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
  ...
  Buildings.Controls.OBC.CDL.Reals.Less les1(
    final h=dTHys) if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
  ...
  Buildings.Controls.OBC.CDL.Reals.AddParameter addPar(
    final p=-17) if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueDelay truDel4(
    final delayTime=lowTemTim) if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
  ...
  Buildings.Controls.OBC.CDL.Logical.And and6 if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
  ...
  Buildings.Controls.OBC.CDL.Logical.And and7 if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
    "Logical and"
    annotation (Placement(transformation(extent={{0,-320},{20,-300}})));
  Buildings.Controls.OBC.CDL.Logical.Not not6 if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
    "Logical not"
  ...
  Buildings.Controls.OBC.CDL.Integers.Switch lowTemAla if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
    "Low discharge temperature alarm"
    annotation (Placement(transformation(extent={{140,-320},{160,-300}})));
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant conInt2(
    final k=2) if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
    "Level 2 alarm"
    annotation (Placement(transformation(extent={{80,-280},{100,-260}})));
  Buildings.Controls.OBC.CDL.Logical.And and8 if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
    "Discharge temperature has been less than threshold and the hot water plant is proven on"
  ...
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt4(
    final integerTrue=3) if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
    "Convert boolean true to level 3 alarm"
    annotation (Placement(transformation(extent={{80,-390},{100,-370}})));
  Buildings.Controls.OBC.CDL.Logical.And and9 if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
    "Logical and"
    annotation (Placement(transformation(extent={{0,-390},{20,-370}})));
  Buildings.Controls.OBC.CDL.Logical.Not not7 if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
    "Logical not"
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant conInt3(
    final k=hotWatRes) if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
  ...
  Buildings.Controls.OBC.CDL.Integers.Multiply proInt1 if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
    "Low discharge air temperature alarms"
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant occMod(
    final k=Buildings.Controls.OBC.ASHRAE.G36_2018.Types.OperationModes.occupied)
    "Occupied mode"
  ...
  Buildings.Controls.OBC.CDL.Logical.And and18 if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
    "Logical and"
    annotation (Placement(transformation(extent={{40,-390},{60,-370}})));
  Buildings.Controls.OBC.CDL.Logical.And and19 if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
    "Logical and"
