within Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.CoolingOnly.Validation;
model Controller
  "Validation of model that controls cooling only unit"

  Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.CoolingOnly.Controller cooBoxCon(
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2018/TerminalUnits/CoolingOnly/Validation/Controller.mos"
        "Simulate and plot"),
