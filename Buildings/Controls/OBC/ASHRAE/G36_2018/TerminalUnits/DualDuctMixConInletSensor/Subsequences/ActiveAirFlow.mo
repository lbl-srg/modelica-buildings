within Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.DualDuctMixConInletSensor.Subsequences;
block ActiveAirFlow
...
protected
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant setUpMod(
    final k=Buildings.Controls.OBC.ASHRAE.G36_2018.Types.OperationModes.setUp)
    "Setup mode"
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant setBacMod(
    final k=Buildings.Controls.OBC.ASHRAE.G36_2018.Types.OperationModes.setBack)
    "Setback mode"
