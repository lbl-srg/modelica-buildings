within Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.Reheat;
block Controller "Controller for room VAV box with reheat"
  ...
  parameter Boolean permit_occStandby=true
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(enable=venStd == Buildings.Controls.OBC.ASHRAE.G36_2018.Types.VentilationStandard.ASHRAE62_1
                              and have_occSen));
  parameter Real VOccMin_flow(unit="m3/s")
    "Zone minimum outdoor airflow for occupants"
    annotation (Dialog(enable=venStd == Buildings.Controls.OBC.ASHRAE.G36_2018.Types.VentilationStandard.California_Title_24));
  ...
  parameter Real thrTDis_1(unit="K")=17
    ...
    annotation (__cdl(ValueInReference=true),
                Dialog(tab="System requests", enable=heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased));
  ...
  parameter Real durTimDisAir(unit="s")=300
    ...
    annotation (__cdl(ValueInReference=true),
                Dialog(tab="System requests", group="Duration time", enable=heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased));
  ...
  parameter Real hotWatRes=1
    ...
    annotation (__cdl(ValueInReference=false), Dialog(tab="Alarms", enable=heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased));
  ...
  parameter Real lowTemTim(unit="s")=600
    ...
    annotation (__cdl(ValueInReference=true), Dialog(tab="Alarms", enable=heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased));
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1HotPla if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput VAdjPopBreZon_flow(
    final quantity="VolumeFlowRate",
    final unit="m3/s") if venStd == Buildings.Controls.OBC.ASHRAE.G36_2018.Types.VentilationStandard.ASHRAE62_1
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput VZonAbsMin_flow(
    final quantity="VolumeFlowRate",
    final unit="m3/s") if venStd == Buildings.Controls.OBC.ASHRAE.G36_2018.Types.VentilationStandard.California_Title_24
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yCO2(
    final unit="1") if venStd == Buildings.Controls.OBC.ASHRAE.G36_2018.Types.VentilationStandard.California_Title_24
...
protected
  final parameter Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil heaCoi=
    if have_hotWatCoi then Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
    else Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.Electric
    "Heating coil type"
    annotation (__cdl(ValueInReference=false));
  Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.Reheat.Subsequences.ActiveAirFlow actAirSet(
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.Reheat.Subsequences.SystemRequests sysReq(
    final heaCoi=heaCoi,
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.ThermalZones.ControlLoops conLoo(
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.Reheat.Subsequences.Alarms ala(
    final heaCoi=heaCoi,
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.Reheat.Subsequences.Overrides setOve
    "Override setpoints"
    annotation (Placement(transformation(extent={{60,-100},{80,-80}})));
  Buildings.Controls.OBC.ASHRAE.G36_2018.Generic.TimeSuppression timSup(
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.VentilationZones.ASHRAE62_1.Setpoints setPoi(
    ...
    final dTHys=dTHys) if venStd == Buildings.Controls.OBC.ASHRAE.G36_2018.Types.VentilationStandard.ASHRAE62_1
    "Output the minimum outdoor airflow rate setpoint, when using ASHRAE 62.1"
    annotation (Placement(transformation(extent={{-100,120},{-80,140}})));
  Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.Reheat.Subsequences.DamperValves damVal(
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2018.ThermalZones.ZoneStates\">
Buildings.Controls.OBC.ASHRAE.G36_2018.ThermalZones.ZoneStates</a> to generate the
...
See <a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.Reheat.Subsequences.ActiveAirFlow\">
Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.Reheat.Subsequences.ActiveAirFlow</a>.
</p>
...
See <a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.Reheat.Subsequences.DamperValves\">
Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.Reheat.Subsequences.DamperValves</a>.
</p>
...
See <a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.Reheat.Subsequences.SystemRequests\">
Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.Reheat.Subsequences.SystemRequests</a>.
</p>
<h4>e. Alarms</h4>
<p>
...
alarm.
See <a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.Reheat.Subsequences.Alarms\">
Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.Reheat.Subsequences.Alarms</a>.
</p>
...
See <a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.Reheat.Subsequences.Overrides\">
Buildings.Controls.OBC.ASHRAE.G36_2018.TerminalUnits.Reheat.Subsequences.Overrides</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
