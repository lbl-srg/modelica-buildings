within Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.SetPoints.Validation;
model FreezeProtection
  "Validate model for implementing freeze protection"

  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.SetPoints.FreezeProtection
    frePro(
    ...
    final freSta=Buildings.Controls.OBC.ASHRAE.G36_2018.Types.FreezeStat.No_freeze_stat)
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant minOutDamPos(
    final k=0.15)
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2018/AHUs/MultiZone/VAV/SetPoints/Validation/FreezeProtection.mos"
        "Simulate and plot"),
