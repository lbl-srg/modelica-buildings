...
model SupplyFan "Validate SupplyFan"
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.SetPoints.SupplyFan conSupFan1(
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.SetPoints.SupplyFan conSupFan2(
    final Td=1,
    final controllerType=Buildings.Controls.OBC.CDL.Types.SimpleController.PI,
    final maxSet=400,
    final k=0.001,
...
annotation (experiment(StopTime=28800.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2018/AHUs/MultiZone/VAV/SetPoints/Validation/SupplyFan.mos"
    "Simulate and plot"),
