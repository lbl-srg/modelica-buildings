...
model ReturnFanDirectPressure
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.SetPoints.ReturnFanDirectPressure retFanPre(
    final disSpe_min=0.1,
    final disSpe_max=0.9,
    final k=0.1) "Return fan control with direct building pressure"
    annotation (Placement(transformation(extent={{20,60},{40,80}})));

  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.SetPoints.ReturnFanDirectPressure retFanPre1(
    final disSpe_min=0.1,
    final disSpe_max=0.9,
    final k=0.5) "Return fan control with direct building pressure"
    annotation (Placement(transformation(extent={{20,20},{40,40}})));

  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.SetPoints.ReturnFanDirectPressure retFanPre2(final
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2018/AHUs/MultiZone/VAV/SetPoints/Validation/ReturnFanDirectPressure.mos"
        "Simulate and plot"),
