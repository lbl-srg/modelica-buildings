within Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.SetPoints;
block PlantRequests "Output plant requests for multizone air handling unit"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uHeaCoiSet(
    final unit="1",
    final min=0,
    final max=1) if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
...
protected
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueDelay truDel2(
    final delayTime=300) if heaCoi==Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.WaterBased
    "Check if the input has been true for a certain time"
