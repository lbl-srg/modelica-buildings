...
block SumZone "Sum of the zone level setpoints calculation"
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant occMod[nGro](
    final k=fill(Buildings.Controls.OBC.ASHRAE.G36_2018.Types.OperationModes.occupied,nGro))
    "Occupied mode index"
...
Buildings.Controls.OBC.ASHRAE.G36_2018.VentilationZones.Title24.Setpoints</a> for the detailed
description.
</p>
</html>", revisions="<html>
<ul>
