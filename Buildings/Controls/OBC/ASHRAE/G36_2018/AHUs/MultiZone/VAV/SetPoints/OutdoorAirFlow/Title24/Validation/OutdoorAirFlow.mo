within Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.Validation;
model OutdoorAirFlow
  "Validate the sequences of setting AHU level minimum outdoor airflow rate"

  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.AHU
    ahu(
    final minOADes=Buildings.Controls.OBC.ASHRAE.G36_2018.Types.OutdoorAirSection.DedicatedDampersAirflow,
    final have_CO2Sen=have_CO2Sen,
    final VAbsOutAir_flow=0.5,
    final VDesOutAir_flow=1) "AHU level minimum outdoor airflow setpoint"
    annotation (Placement(transformation(extent={{60,-10},{80,10}})));
  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.SumZone zonToAhu(
    final nZon=nZon,
    final nGro=nGro,
...
protected
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant opeMod[nGro](
    final k={Buildings.Controls.OBC.ASHRAE.G36_2018.Types.OperationModes.occupied,
             Buildings.Controls.OBC.ASHRAE.G36_2018.Types.OperationModes.unoccupied})
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2018/AHUs/MultiZone/VAV/SetPoints/OutdoorAirFlow/Title24/Validation/OutdoorAirFlow.mos"
    "Simulate and plot"),
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.SumZone\">
Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.SumZone</a>,
...
See <a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.AHU\">
