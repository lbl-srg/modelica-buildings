within Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.Economizers.Subsequences.Modulations.Validation;
model ReturnFan
  "Validation model for modulating dampers of units with return fan"

  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.Economizers.Subsequences.Modulations.ReturnFan ecoMod
    "Multi zone VAV AHU minimum outdoor air control - damper modulation"
    annotation (Placement(transformation(extent={{60,-10},{80,10}})));

  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.Economizers.Subsequences.Modulations.ReturnFan ecoMod1(
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2018/AHUs/MultiZone/VAV/Economizers/Subsequences/Modulations/Validation/ReturnFan.mos"
    "Simulate and plot"),
