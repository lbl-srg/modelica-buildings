within Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.Validation;
model SeparateWithDP
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithDP disMinCon(
    final venStd=Buildings.Controls.OBC.ASHRAE.G36_2018.Types.VentilationStandard.ASHRAE62_1,
    final dpDesMinOutDam=300,
    final minSpe=0.1)
    "Disable the minimum outdoor air control due to that the supply fan is not proven on"
    annotation (Placement(transformation(extent={{-140,10},{-120,30}})));

  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithDP disMinCon1(
    final venStd=Buildings.Controls.OBC.ASHRAE.G36_2018.Types.VentilationStandard.ASHRAE62_1,
    final dpDesMinOutDam=300,
    final minSpe=0.1)
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithDP minCon(
    final venStd=Buildings.Controls.OBC.ASHRAE.G36_2018.Types.VentilationStandard.ASHRAE62_1,
    final dpDesMinOutDam=300,
    final minSpe=0.1)
...
protected
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant opeMod1(
    final k=Buildings.Controls.OBC.ASHRAE.G36_2018.Types.OperationModes.warmUp)
    "AHU operation mode is Occupied"
...
annotation (experiment(StopTime=1800.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2018/AHUs/MultiZone/VAV/Economizers/Subsequences/Limits/Validation/SeparateWithDP.mos"
    "Simulate and plot"),
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithDP\">
Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithDP</a>
