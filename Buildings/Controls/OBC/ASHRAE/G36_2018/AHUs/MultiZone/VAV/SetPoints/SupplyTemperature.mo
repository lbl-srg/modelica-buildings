...
block SupplyTemperature
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.Generic.TrimAndRespond maxSupTemRes(
    final delTim=delTim,
    final iniSet=iniSet,
    final minSet=minSet,
    final maxSet=maxSet,
...
src=\"modelica://Buildings/Resources/Images/Controls/OBC/ASHRAE/G36_2018/AHUs/MultiZone/VAV/SetPoints/VAVSupTempSet.png\"/>
</p>
