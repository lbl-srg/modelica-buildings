within Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.SingleZone.VAV.SetPoints.Validation;
model FreezeProtection
  "Validate model for implementing freeze protection"

  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.SingleZone.VAV.SetPoints.FreezeProtection
    frePro(final buiPreCon=Buildings.Controls.OBC.ASHRAE.G36_2018.Types.PressureControl.ReliefDamper,
      freSta=Buildings.Controls.OBC.ASHRAE.G36_2018.Types.FreezeStat.No_freeze_stat)
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2018/AHUs/SingleZone/VAV/SetPoints/Validation/FreezeProtection.mos"
        "Simulate and plot"),
