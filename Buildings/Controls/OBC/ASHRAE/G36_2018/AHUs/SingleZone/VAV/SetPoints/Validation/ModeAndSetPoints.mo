...
model ModeAndSetPoints
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.SingleZone.VAV.SetPoints.ModeAndSetPoints
    modSetPoi(
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2018/AHUs/SingleZone/VAV/SetPoints/Validation/ModeAndSetPoints.mos"
        "Simulate and plot"),
