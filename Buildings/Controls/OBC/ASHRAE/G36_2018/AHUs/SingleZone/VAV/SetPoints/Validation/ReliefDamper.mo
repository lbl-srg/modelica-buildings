...
model ReliefDamper "Validation of relief damper control"
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.SingleZone.VAV.SetPoints.ReliefDamper relDam(final
...
annotation (
    ...
    experiment(StopTime=3600, Tolerance=1e-06),
      __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2018/AHUs/SingleZone/VAV/SetPoints/Validation/ReliefDamper.mos"
    "Simulate and plot"),
