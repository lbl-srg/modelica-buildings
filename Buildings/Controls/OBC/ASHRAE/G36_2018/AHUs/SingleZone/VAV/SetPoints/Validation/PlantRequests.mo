...
model PlantRequests
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.SingleZone.VAV.SetPoints.PlantRequests plaReq1(
    heaCoi=Buildings.Controls.OBC.ASHRAE.G36_2018.Types.HeatingCoil.None)
    "Calculate plant request"
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2018/AHUs/SingleZone/VAV/SetPoints/Validation/PlantRequests.mos"
        "Simulate and plot"),
