...
model CoolingCoil "Validation of cooling coil model"
  ...
  Buildings.Controls.OBC.ASHRAE.G36_2018.AHUs.SingleZone.VAV.SetPoints.CoolingCoil cooCoi(
...
annotation (
    ...
    experiment(
      ...
      Interval=600,
      Tolerance=1e-06),
      __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_2018/AHUs/SingleZone/VAV/SetPoints/Validation/CoolingCoil.mos"
    "Simulate and plot"),
