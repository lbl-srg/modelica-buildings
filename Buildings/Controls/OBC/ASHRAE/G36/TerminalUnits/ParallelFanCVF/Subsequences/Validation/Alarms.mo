...
model Alarms "Validation of model that generates alarms"
  ...
  Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanCVF.Subsequences.Alarms ala(
...
equation
  ...
  connect(valPos.y, ala.uVal) annotation (Line(points={{-38,-50},{44,-50},{44,47},
          {78,47}},         color={0,0,127}));
  connect(TSup.y, ala.TSup) annotation (Line(points={{-78,-70},{48,-70},{48,45},
          {78,45}}, color={0,0,127}));
  connect(hotPla.y, ala.u1HotPla) annotation (Line(points={{-38,-90},{52,-90},{52,
          43},{78,43}},    color={255,0,255}));
  connect(TDis.y, ala.TDis) annotation (Line(points={{-78,-110},{56,-110},{56,41},
          {78,41}}, color={0,0,127}));
  connect(TDisSet.y, ala.TDisSet) annotation (Line(points={{-38,-130},{60,-130},
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.ParallelFanCVF.Subsequences.Alarms\">
