...
block Controller "Controller for room VAV box with reheat"
  ...
  Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixColdDuct.Subsequences.Alarms
    ala(
  ...
  Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixColdDuct.Subsequences.Overrides
    setOve(
  ...
  Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.DualDuctMixColdDuct.Subsequences.DamperValves
    damVal(
