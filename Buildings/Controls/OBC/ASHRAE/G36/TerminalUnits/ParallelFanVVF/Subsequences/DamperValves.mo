...
equation
  ...
  connect(conDam.y, swi3.u3) annotation (Line(points={{262,280},{280,280},{280,102},
          {298,102}}, color={0,0,127}));
  connect(conZer3.y, swi3.u1) annotation (Line(points={{-258,110},{20,110},{20,118},
          {298,118}},color={0,0,127}));
