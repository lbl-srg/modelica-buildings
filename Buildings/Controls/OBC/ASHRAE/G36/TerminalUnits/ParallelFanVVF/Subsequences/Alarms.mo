...
block Alarms "Generate alarms of parallel fan-powered terminal unit with variable-volume fan"
  ...
  Buildings.Controls.OBC.CDL.Logical.And and18 if heaCoi==Buildings.Controls.OBC.ASHRAE.G36.Types.Coil.WaterBasedHeating
    "Logical and"
    annotation (Placement(transformation(extent={{40,-390},{60,-370}})));
  Buildings.Controls.OBC.CDL.Logical.And and19 if heaCoi==Buildings.Controls.OBC.ASHRAE.G36.Types.Coil.WaterBasedHeating
    "Logical and"
