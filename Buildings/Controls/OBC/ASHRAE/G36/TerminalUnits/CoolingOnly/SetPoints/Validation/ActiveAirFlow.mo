within Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.CoolingOnly.SetPoints.Validation;
model ActiveAirFlow
  "Validate the model for calculating active airflow setpoint for VAV terminal unit with reheat"
  Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.CoolingOnly.SetPoints.ActiveAirFlow
    actAirSet_RehBox(
