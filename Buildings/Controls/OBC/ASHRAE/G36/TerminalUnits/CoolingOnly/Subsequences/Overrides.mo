...
equation
  ...
  connect(conInt.y, forZerFlo.u2) annotation (Line(points={{-98,120},{-90,120},{
          -90,132},{-82,132}}, color={255,127,0}));
  connect(oveFloSet, forCooMax.u1) annotation (Line(points={{-160,140},{-130,140},
          {-130,100},{-82,100}}, color={255,127,0}));
  connect(conInt1.y, forCooMax.u2) annotation (Line(points={{-98,80},{-90,80},{-90,
          92},{-82,92}}, color={255,127,0}));
  connect(oveFloSet, forMinFlo.u1) annotation (Line(points={{-160,140},{-130,140},
          {-130,60},{-82,60}}, color={255,127,0}));
  connect(conInt2.y, forMinFlo.u2) annotation (Line(points={{-98,40},{-90,40},{-90,
  ...
  connect(cooMax.y, add2.u1) annotation (Line(points={{-18,100},{-10,100},{-10,86},
          {-2,86}}, color={0,0,127}));
  connect(minFlo.y, add2.u2) annotation (Line(points={{-18,60},{-10,60},{-10,74},
          {-2,74}}, color={0,0,127}));
  connect(zerFlo.y, add1.u1) annotation (Line(points={{-18,140},{20,140},{20,126},
          {38,126}}, color={0,0,127}));
  connect(add2.y, add1.u2) annotation (Line(points={{22,80},{30,80},{30,114},{38,
          114}}, color={0,0,127}));
  connect(forZerFlo.y, or3.u1) annotation (Line(points={{-58,140},{-50,140},{-50,
          38},{-2,38}}, color={255,0,255}));
  connect(forCooMax.y, or3.u2) annotation (Line(points={{-58,100},{-50,100},{-50,
          30},{-2,30}}, color={255,0,255}));
  connect(forMinFlo.y, or3.u3) annotation (Line(points={{-58,60},{-50,60},{-50,22},
          {-2,22}}, color={255,0,255}));
  connect(or3.y, swi.u2)
    annotation (Line(points={{22,30},{98,30}}, color={255,0,255}));
  connect(add1.y, swi.u1) annotation (Line(points={{62,120},{80,120},{80,38},{98,
          38}}, color={0,0,127}));
  connect(VActSet_flow, swi.u3) annotation (Line(points={{-160,10},{80,10},{80,22},
          {98,22}}, color={0,0,127}));
...
<p>
This block considers the overrides to the setpoints for the cooling only terminal
unit. The implementation is according to the Section 5.5.7 of ASHRAE Guideline 36,
May 2020.
</p>
<p>
