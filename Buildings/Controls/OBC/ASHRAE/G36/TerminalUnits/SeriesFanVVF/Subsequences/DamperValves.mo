...
equation
  ...
  connect(conZer3.y, swi3.u1) annotation (Line(points={{-258,110},{20,110},{20,128},
          {278,128}},color={0,0,127}));
  ...
  connect(isUno.y, swi3.u2) annotation (Line(points={{42,-330},{130,-330},{130,120},
          {278,120}},      color={255,0,255}));
  ...
  connect(conDam.y, swi3.u3) annotation (Line(points={{262,280},{270,280},{270,112},
          {278,112}},                     color={0,0,127}));
  connect(swi3.y, mul.u1) annotation (Line(points={{302,120},{310,120},{310,106},
