...
model DamperValves
  ...
  Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanVVF.Subsequences.DamperValves damValFan(
    ...
    annotation (Placement(transformation(extent={{80,-20},{100,20}})));
...
equation
  ...
  connect(THeaSet.y, damValFan.THeaSet) annotation (Line(points={{-78,-20},{36,-20},
          {36,-2},{78,-2}},          color={0,0,127}));
  ...
  connect(round2.y,reaToInt2. u)
    annotation (Line(points={{-38,-110},{-22,-110}},
      color={0,0,127}));
  connect(reaToInt2.y, damValFan.uOpeMod) annotation (Line(points={{2,-110},{20,
          -110},{20,-14},{78,-14}}, color={255,127,0}));
  connect(reaToInt2.y, damValFan1.uOpeMod) annotation (Line(points={{2,-110},{20,
          -110},{20,-114},{78,-114}}, color={255,127,0}));
  connect(terFan.y, damValFan.u1Fan) annotation (Line(points={{-78,-140},{16,-140},
  ...
  connect(reaToInt1.y, damValFan.oveFloSet) annotation (Line(points={{2,160},{68,
          160},{68,19},{78,19}}, color={255,127,0}));
