...
model Overrides "Validation of model that overrides control"
  ...
  Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanCVF.Subsequences.Overrides ove(
    final VZonMin_flow=0.1,
    final VCooZonMax_flow=0.9) "Block outputs system requests"
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.SeriesFanCVF.Subsequences.Overrides\">
