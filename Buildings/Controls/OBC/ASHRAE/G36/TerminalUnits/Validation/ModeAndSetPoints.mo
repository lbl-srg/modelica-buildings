...
model ModeAndSetPoints
  ...
  Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.ModeAndSetPoints setPoi(cooAdj=
        true, heaAdj=true) "Output resetted zone setpoint remperature"
    annotation (Placement(transformation(extent={{20,70},{40,90}})));
  Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.ModeAndSetPoints setPoi1(
  ...
  Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.ModeAndSetPoints setPoi3(
      have_occSen=true, have_winSen=true)
    "Output resetted zone setpoint remperature"
    annotation (Placement(transformation(extent={{20,-60},{40,-40}})));
  Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.ModeAndSetPoints setPoi2(cooAdj=
        true, heaAdj=true) "Output resetted zone setpoint remperature"
