...
equation
  ...
  connect(supCooFan.y, ala.u1CooFan) annotation (Line(points={{-18,40},{36,40},{
          36,41},{58,41}},  color={255,0,255}));
  connect(mul.y, ala.uCooDam) annotation (Line(points={{22,0},{36,0},{36,38},{58,
          38}},            color={0,0,127}));
  ...
  connect(intPul.y, ala.uOpeMod) annotation (Line(points={{-58,70},{36,70},{36,43},
          {58,43}}, color={255,127,0}));
annotation (
