within Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.SetPoints.Validation;
model ZoneTemperatures "Validate block for zone set point"
  Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.SetPoints.ZoneTemperatures TZonSet(
...
equation
  ...
  connect(winSta.y, swi2.u2)
    annotation (Line(points={{62,-20},{86,-20},{86,0},{-60,0},{-60,20},
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/TerminalUnits/SetPoints/Validation/ZoneTemperatures.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.SetPoints.ZoneTemperatures\">
Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.SetPoints.ZoneTemperatures</a>
