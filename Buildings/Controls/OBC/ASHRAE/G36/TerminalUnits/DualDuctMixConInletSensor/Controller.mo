...
equation
  ...
  connect(uWin, setPoi.uWin) annotation (Line(points={{-260,190},{-180,190},{
          -180,159},{-162,159}},
                            color={255,0,255}));
  connect(uOcc, setPoi.uOcc) annotation (Line(points={{-260,160},{-184,160},{
          -184,157},{-162,157}},
                            color={255,0,255}));
  ...
  connect(ppmCO2Set, setPoi.ppmCO2Set) annotation (Line(points={{-260,100},{
          -196,100},{-196,153},{-162,153}},
                                       color={0,0,127}));
  connect(uWin, minFlo.uWin) annotation (Line(points={{-260,190},{-180,190},{-180,
          119},{-162,119}}, color={255,0,255}));
  connect(uOcc, minFlo.uOcc) annotation (Line(points={{-260,160},{-184,160},{-184,
  ...
  connect(minFlo.VOccZonMin_flow, actAirSet.VOccZonMin_flow) annotation (Line(
        points={{-138,104},{-120,104},{-120,88},{-82,88}}, color={0,0,127}));
