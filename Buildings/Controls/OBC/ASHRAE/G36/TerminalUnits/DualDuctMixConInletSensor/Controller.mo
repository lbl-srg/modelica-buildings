...
block Controller "Controller for dual-duct terminal unit using mixing control with inlet flow sensor"
  ...
  parameter Real kCooCon=0.1
    ...
    annotation (__cdl(ValueInReference=false, InstanceInReference=false), Dialog(tab="Control loops", group="Cooling"));
  ...
  parameter Real kHeaCon=0.1
    ...
    annotation (__cdl(ValueInReference=false, InstanceInReference=false), Dialog(tab="Control loops", group="Heating"));
