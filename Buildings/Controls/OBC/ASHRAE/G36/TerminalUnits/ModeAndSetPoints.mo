...
block ModeAndSetPoints
  ...
  parameter Real decTSetDem_3(
    ...
    annotation (Dialog(tab="Setpoint adjust", group="Demands settings"));
  parameter Integer cooDemLimLevCon=Buildings.Controls.OBC.ASHRAE.G36.Types.DemandLimitLevels.cooling0
    "Cooling demand limit level"
    annotation (Dialog(tab="Setpoint adjust"));
  parameter Integer heaDemLimLevCon=Buildings.Controls.OBC.ASHRAE.G36.Types.DemandLimitLevels.heating0
...
protected
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Generic.SetPoints.ZoneStatus zonSta(final
      have_winSen=have_winSen) "Check zone temperature status"
