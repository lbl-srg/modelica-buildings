...
block EconModulationMultiZone
  ...
  parameter Real retDamConSigMin(
    ...
    final max=1,
    final unit="1") = 0.5
    "Minimum control loop signal for the RA damper - maximum for the OA damper"
    annotation(Evaluate=true, Dialog(tab="Commissioning", group="Controller"));
...
protected
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant outDamMaxLimSig(
    final k=outDamConSigMax)
    "Maximum control loop signal for the outdoor air damper"
    annotation (Placement(transformation(extent={{-20,-60},{0,-40}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant retDamMinLimSig(
...
Buildings.Controls.OBC.ASHRAE.G36.Atomic.EconDamperPositionLimitsMultiZone</a> and
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36.Atomic.EconEnableDisableMultiZone\">
Buildings.Controls.OBC.ASHRAE.G36.Atomic.EconEnableDisableMultiZone</a>
sequences.
</p>
<p>
...
src=\"modelica://Buildings/Resources/Images/Controls/OBC/ASHRAE/G36/Atomic/EconModulationControlDiagramMultiZone.png\"/>
</p>
<p>
...
src=\"modelica://Buildings/Resources/Images/Controls/OBC/ASHRAE/G36/Atomic/EconModulationControlChartMultiZone.png\"/>
</p>
