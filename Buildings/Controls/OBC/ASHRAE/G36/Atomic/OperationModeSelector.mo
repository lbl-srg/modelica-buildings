...
block OperationModeSelector "Block that outputs the operation mode"
  ...
  CDL.Continuous.Sources.Constant occModInd(
    k=Buildings.Controls.OBC.ASHRAE.G36.Constants.OperationModes.occModInd)
    "Occupied mode index"
  ...
  CDL.Continuous.Gain setBacInd(
    final k=Buildings.Controls.OBC.ASHRAE.G36.Constants.OperationModes.setBacInd)
  ...
  CDL.Continuous.Gain freProSetBacInd(
    final k=Buildings.Controls.OBC.ASHRAE.G36.Constants.OperationModes.freProInd)
  ...
  CDL.Continuous.Gain setUpInd(
    final k=Buildings.Controls.OBC.ASHRAE.G36.Constants.OperationModes.setUpInd)
    "Setup mode: 3th rank"
  ...
  CDL.Continuous.Gain unoInd(
    final k=Buildings.Controls.OBC.ASHRAE.G36.Constants.OperationModes.unoModInd)
