...
model EconEnableDisableMultiZone_TOut_hOut
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Atomic.EconEnableDisableMultiZone ecoEnaDis2(
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/Atomic/Validation/EconEnableDisableMultiZone_TOut_hOut.mos"
    "Simulate and plot"),
  Icon(graphics={
        Ellipse(
          lineColor={75,138,73},
