...
equation
  ...
  connect(coCon.y, occMinAir_RehBox.ppmCO2) annotation (Line(points={{41,70},{
          52,70},{52,76},{79,76}}, color={0,0,127}));
  connect(booToInt.y, occMinAir_RehBox.uOpeMod) annotation (Line(points={{41,
          -10},{60,-10},{60,67},{79,67}}, color={255,127,0}));
  connect(winSta.y, occMinAir_RehBox.uWin) annotation (Line(points={{41,-50},{
          64,-50},{64,63},{79,63}}, color={255,0,255}));
  connect(sine.y, occMinAir_RehBox.nOcc) annotation (Line(points={{41,30},{56,
          30},{56,72},{79,72}}, color={0,0,127}));
