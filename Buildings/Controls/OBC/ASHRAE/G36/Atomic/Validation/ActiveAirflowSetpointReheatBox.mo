...
model ActiveAirflowSetpointReheatBox
  "Validate the model for calculating active airflow setpoint for VAV terminal unit with reheat"
  extends Modelica.Icons.Example;
  Buildings.Controls.OBC.ASHRAE.G36.Atomic.ActiveAirflowSetpointReheatBox
    actAirSet_RehBox(
    VCooMax=0.075,
    VMin=0.017,
    VHeaMax=0.05,
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/Atomic/Validation/ActiveAirflowSetpointReheatBox.mos"
        "Simulate and plot"),
