...
model DamperValveReheatBox
  "Validate model for controlling damper and valve position of VAV reheat terminal unit"
  extends Modelica.Icons.Example;

  Buildings.Controls.OBC.ASHRAE.G36.Atomic.DamperValveReheatBox damVal_RehBox(
    kDam=0.8)
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/Atomic/Validation/DamperValveReheatBox.mos"
        "Simulate and plot"),
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36.Atomic.DamperValveReheatBox\">
Buildings.Controls.OBC.ASHRAE.G36.Atomic.DamperValveReheatBox</a>
