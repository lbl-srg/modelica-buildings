within Buildings.Controls.OBC.ASHRAE.G36.AHU.SingleZone.Economizer.Subsequences.Validation;
model DamperLimits_FanSpe_VOut_flow
  ...
  Buildings.Controls.OBC.ASHRAE.G36.AHU.SingleZone.Economizer.Subsequences.DamperLimits ecoDamLim1(
    final minFanSpe=minFanSpe,
    final maxFanSpe=maxFanSpe,
    final minVOut_flow=minVOut_flow,
    final desVOut_flow=desVOut_flow)
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/AHU/SingleZone/Economizer/Subsequences/Validation/DamperLimits_FanSpe_VOut_flow.mos"
    "Simulate and plot"),
