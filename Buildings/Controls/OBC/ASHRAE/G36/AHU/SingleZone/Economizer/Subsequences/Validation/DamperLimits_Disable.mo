...
model DamperLimits_Disable
  ...
  Buildings.Controls.OBC.ASHRAE.G36.AHU.SingleZone.Economizer.Subsequences.DamperLimits ecoDamLim2(
    final minFanSpe=minFanSpe,
    final maxFanSpe=maxFanSpe,
    final minVOut_flow=minVOut_flow,
    final desVOut_flow=desVOut_flow)
  ...
  Buildings.Controls.OBC.ASHRAE.G36.AHU.SingleZone.Economizer.Subsequences.DamperLimits ecoDamLim3(
    final minFanSpe=minFanSpe,
    final maxFanSpe=maxFanSpe,
    final minVOut_flow=minVOut_flow,
    final desVOut_flow=desVOut_flow)
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/AHU/SingleZone/Economizer/Subsequences/Validation/DamperLimits_Disable.mos"
    "Simulate and plot"),
