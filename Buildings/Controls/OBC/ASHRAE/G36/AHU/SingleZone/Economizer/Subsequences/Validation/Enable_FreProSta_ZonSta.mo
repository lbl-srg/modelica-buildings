...
model Enable_FreProSta_ZonSta
  ...
  Buildings.Controls.OBC.ASHRAE.G36.AHU.SingleZone.Economizer.Subsequences.Enable ecoEnaDis1
    "Single zone VAV AHU enable disable sequence"
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/AHU/SingleZone/Economizer/Subsequences/Validation/Enable_FreProSta_ZonSta.mos"
    "Simulate and plot"),
  Icon(graphics={
        Ellipse(
          lineColor={75,138,73},
