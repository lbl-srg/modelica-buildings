within Buildings.Controls.OBC.ASHRAE.G36.AHU.SingleZone.SetPoints.Validation;
model OutsideAirFlow
  "Validate the model of calculating minimum outdoor airflow setpoint"
  extends Modelica.Icons.Example;

  Buildings.Controls.OBC.ASHRAE.G36.AHU.SingleZone.SetPoints.OutsideAirFlow
...
equation
  ...
  connect(TSup.y, outAirSet_SinZon.TSup)
    annotation (Line(points={{-39,-10},{-20,-10},{-20,0},{18,0}},
      color={0,0,127}));

annotation (
  experiment(StopTime=3600.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/AHU/SingleZone/SetPoints/Validation/OutsideAirFlow.mos"
    "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36.AHU.SingleZone.SetPoints.OutsideAirFlow\">
Buildings.Controls.OBC.ASHRAE.G36.AHU.SingleZone.SetPoints.OutsideAirFlow</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
