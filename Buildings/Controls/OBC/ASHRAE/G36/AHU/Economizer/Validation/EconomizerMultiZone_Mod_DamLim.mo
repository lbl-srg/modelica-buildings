...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/AHU/Economizer/Validation/EconomizerMultiZone_Mod_DamLim.mos"
    "Simulate and plot"),
  Icon(graphics={
...
Buildings.Controls.OBC.ASHRAE.G36.AHU.Economizer.EconomizerMultiZone</a> control loops:
