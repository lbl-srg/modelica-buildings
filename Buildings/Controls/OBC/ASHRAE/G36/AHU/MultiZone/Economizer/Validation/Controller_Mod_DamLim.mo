...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/AHU/MultiZone/Economizer/Validation/Controller_Mod_DamLim.mos"
    "Simulate and plot"),
  Icon(graphics={
...
Buildings.Controls.OBC.ASHRAE.G36.AHU.MultiZone.Economizer.Controller</a> control loops:
