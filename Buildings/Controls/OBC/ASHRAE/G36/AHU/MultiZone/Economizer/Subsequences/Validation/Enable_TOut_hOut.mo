...
model Enable_TOut_hOut
  ...
  Buildings.Controls.OBC.ASHRAE.G36.AHU.MultiZone.Economizer.Subsequences.Enable ecoEnaDis1
    "Multizone VAV AHU economizer enable disable sequence"
    annotation (Placement(transformation(extent={{80,-40},{100,-20}})));
  Buildings.Controls.OBC.ASHRAE.G36.AHU.MultiZone.Economizer.Subsequences.Enable ecoEnaDis2(
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/AHU/MultiZone/Economizer/Subsequences/Validation/Enable_TOut_hOut.mos"
    "Simulate and plot"),
  Icon(graphics={
        Ellipse(
          lineColor={75,138,73},
