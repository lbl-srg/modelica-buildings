...
model TrimAndRespond "Model validates TrimAndRespondLogic block"
  extends Modelica.Icons.Example;
  Buildings.Controls.OBC.ASHRAE.G36.AHU.SetPoints.TrimAndRespond trimRespondLogic(
    iniSet=120,
    minSet=37,
    maxSet=370,
    delTim=300,
  ...
  Buildings.Controls.OBC.ASHRAE.G36.AHU.SetPoints.TrimAndRespond trimRespondLogic1(
    iniSet=120,
    minSet=37,
    maxSet=370,
    delTim=300,
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/AHU/SetPoints/Validation/TrimAndRespond.mos"
    "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36.AHU.SetPoints.TrimAndRespond\">
Buildings.Controls.OBC.ASHRAE.G36.AHU.SetPoints.TrimAndRespond</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
