...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/Composite/Validation/EconomizerMultiZone_Disable.mos"
    "Simulate and plot"),
  Icon(graphics={
...
Buildings.Controls.OBC.ASHRAE.G36.Composite.EconomizerMultiZone</a>
