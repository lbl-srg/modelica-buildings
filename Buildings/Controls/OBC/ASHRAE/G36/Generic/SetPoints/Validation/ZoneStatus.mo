...
model ZoneStatus
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Generic.SetPoints.ZoneStatus noWinZonSta
    "Status of zone when there is no window operation sensor"
    annotation (Placement(transformation(extent={{120,120},{140,140}})));
  Buildings.Controls.OBC.ASHRAE.G36.Generic.SetPoints.ZoneStatus witWinZonSta(final
