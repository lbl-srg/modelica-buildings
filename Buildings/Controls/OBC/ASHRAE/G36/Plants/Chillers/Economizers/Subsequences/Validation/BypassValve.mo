within Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Economizers.Subsequences.Validation;
...
annotation (
 experiment(StopTime=3600.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/Plants/Chillers/Economizers/Subsequences/Validation/BypassValve.mos"
    "Simulate and plot"),
