...
model Tuning_uEcoSta_uTowFanSpeMax
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Economizers.Subsequences.Tuning wseTun1
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Economizers.Subsequences.Tuning wseTun2
    "Tests tuning parameter decrease due to WSE being on for a long time before disable"
    annotation (Placement(transformation(extent={{-40,60},{-20,80}})));

  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Economizers.Subsequences.Tuning wseTun3
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Economizers.Subsequences.Tuning wseTun4
    "Tests anti-windup"
...
annotation (
 experiment(
      StopTime=150000,
      Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/Plants/Chillers/Economizers/Subsequences/Validation/Tuning_uEcoSta_uTowFanSpeMax.mos"
    "Simulate and plot"),
