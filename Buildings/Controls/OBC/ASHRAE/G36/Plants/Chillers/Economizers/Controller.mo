...
block Controller "Waterside economizer (WSE) enable/disable status"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uChiIsoVal[nChi](
    ...
    have_modPosChiVal and chiIsoValTyp == Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Types.Actuator.Modulating
...
protected
  ...
  Buildings.Controls.OBC.CDL.Logical.MultiOr anyOpeVal(
    ...
    chiIsoValTyp == Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Types.Actuator.Modulating
