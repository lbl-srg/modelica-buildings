within Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Towers.FanSpeed.Validation;
model Controller "Validation sequence of controlling tower fan speed"

  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Towers.FanSpeed.Controller
    cloCouWitWse
