within Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Towers.FanSpeed.EnabledWSE.Validation;
model Controller
...
equation
  ...
  connect(con.y, wseOpe.uPla) annotation (Line(points={{-78,-60},{50,-60},{50,-1},
