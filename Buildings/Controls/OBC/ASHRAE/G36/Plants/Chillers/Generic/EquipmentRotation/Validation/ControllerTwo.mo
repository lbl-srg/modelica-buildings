...
equation
  ...
  connect(pre2.y, conLeaSch.uDevSta) annotation (Line(points={{82,-70},{90,-70},
   ...
   experiment(StopTime=100000.0, Tolerance=1e-06),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/Plants/Chillers/Generic/EquipmentRotation/Validation/ControllerTwo.mos"
    "Simulate and plot"),
