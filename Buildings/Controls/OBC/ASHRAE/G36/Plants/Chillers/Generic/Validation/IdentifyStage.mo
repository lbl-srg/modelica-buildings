...
model IdentifyStage "Validation identifying stage index"
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.IdentifyStage ideSta1(
    nChi=3,
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/Plants/Chillers/Generic/Validation/IdentifyStage.mos"
    "Simulate and plot"),
