...
model PIDWithEnable "Test model for PID controller with enable"
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.PIDWithEnable limPIDPar(
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.PIDWithEnable limPIDInp(
    controllerType=Buildings.Controls.OBC.CDL.Types.SimpleController.PID,
    k=1,
    Ti=1,
    Td=1,
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.PIDWithEnable limPIPar(
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.PIDWithEnable limPIInp(
    controllerType=Buildings.Controls.OBC.CDL.Types.SimpleController.PI,
    k=1,
    Ti=1,
    Td=1,
...
equation
  ...
  connect(greEquThr.y,limPIDPar.uEna)
    annotation (Line(points={{-30,-60},{12,-60},{12,50},{26,50},{26,58}},color={255,0,255}));
  ...
  connect(greEquThr.y,limPIPar.uEna)
    annotation (Line(points={{-30,-60},{12,-60},{12,-50},{26,-50},{26,-42}},color={255,0,255}));
  ...
  connect(limPIInp.u_s,setPoi.y)
    annotation (Line(points={{18,-70},{6,-70},{6,-30},{2,-30}},color={0,0,127}));
  connect(greEquThr.y,limPIInp.uEna)
    annotation (Line(points={{-30,-60},{12,-60},{12,-90},{26,-90},{26,-82}},color={255,0,255}));
  connect(limPIDInp.uEna,greEquThr.y)
    annotation (Line(points={{26,18},{26,10},{12,10},{12,-60},{-30,-60}},color={255,0,255}));
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/Plants/Chillers/Generic/Validation/PIDWithEnable.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.PIDWithEnable\">
Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.PIDWithEnable</a>.
</p>
<p>
