within Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.EquipmentRotation.Subsequences.Validation;
model ContinuousLeadSwapTwo_uDevSta
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.EquipmentRotation.Subsequences.ContinuousLeadSwapTwo leaSwa
    "Makes sure the new lead device is proven on before passing on the lead role"
    annotation (Placement(transformation(extent={{-40,40},{-20,60}})));

  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.EquipmentRotation.Subsequences.ContinuousLeadSwapTwo leaSwa1
    "A way to switch two signals and invert their values"
    annotation (Placement(transformation(extent={{-40,-30},{-20,-10}})));

  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.EquipmentRotation.Subsequences.ContinuousLeadSwapTwo leaSwa2
    "Makes sure the new lead device is proven on before passing on the lead role"
    annotation (Placement(transformation(extent={{180,40},{200,60}})));

  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.EquipmentRotation.Subsequences.ContinuousLeadSwapTwo leaSwa3
    "Makes sure the new lead device is proven on before passing on the lead role"
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/Plants/Chillers/Generic/EquipmentRotation/Subsequences/Validation/ContinuousLeadSwapTwo_uDevSta.mos"
    "Simulate and plot"),
...
Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.EquipmentRotation.Subsequences.ContinuousLeadSwapTwo</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
