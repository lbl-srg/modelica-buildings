within Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.EquipmentRotation.Validation;
model ControllerTwo_MinimumLeadRuntime
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Generic.EquipmentRotation.ControllerTwo
    leaLag(
    final lag=true,
    minLim=true,
...
equation
  ...
  connect(pre1.y, leaSta.uDevSta) annotation (Line(points={{82,-30},{90,-30},{90,
   ...
   experiment(StopTime=100000.0, Tolerance=1e-06),
    __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/Plants/Chillers/Generic/EquipmentRotation/Validation/ControllerTwo_MinimumLeadRuntime.mos"
    "Simulate and plot"),
