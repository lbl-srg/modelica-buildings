...
model Initial_noWSE
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Staging.SetPoints.Subsequences.Initial iniSta(
    final have_WSE=false)
    "Tests if initial stage is the lowest available stage"
    annotation (Placement(transformation(extent={{20,20},{40,40}})));

  Buildings.Controls.OBC.ASHRAE.G36.Plants.Chillers.Staging.SetPoints.Subsequences.Initial iniSta1(
    final have_WSE=false)
    "Tests if initial stage is the lowest available stage"
