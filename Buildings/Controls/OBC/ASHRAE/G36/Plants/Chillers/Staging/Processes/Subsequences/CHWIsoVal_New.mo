...
equation
  ...
  connect(and2.y, lat.u)
    annotation (Line(points={{-118,-100},{-100,-100},{-100,-140},{-82,-140}},
          color={255,0,255}));
  connect(uStaPro, not1.u) annotation (Line(points={{-240,-150},{-150,-150},{-150,
          -180},{-142,-180}},color={255,0,255}));
  connect(not1.y, lat.clr)
    annotation (Line(points={{-118,-180},{-100,-180},{-100,-146},{-82,-146}},
      color={255,0,255}));
  connect(intRep.y, intEqu.u1)
    annotation (Line(points={{-98,170},{-62,170}},  color={255,127,0}));
  connect(lat.y, tim.u)
    annotation (Line(points={{-58,-140},{18,-140}}, color={255,0,255}));
  connect(conInt.y, intEqu.u2)
    annotation (Line(points={{-98,130},{-80,130},{-80,162},{-62,162}},
      color={255,127,0}));
  connect(lat1.y, and5.u2)
    annotation (Line(points={{42,-80},{80,-80},{80,-118},{178,-118}},
      color={255,0,255}));
  connect(uUpsDevSta, lat1.u) annotation (Line(points={{-240,-100},{-200,-100},{
          -200,-80},{18,-80}},  color={255,0,255}));
  connect(not1.y, truDel.u) annotation (Line(points={{-118,-180},{-82,-180}},
         color={255,0,255}));
  connect(truDel.y, lat1.clr) annotation (Line(points={{-58,-180},{0,-180},{0,-86},
          {18,-86}}, color={255,0,255}));
  connect(tim.passed, lat2.u) annotation (Line(points={{42,-148},{120,-148},{120,
  ...
  connect(intEqu.y, booToRea.u)
    annotation (Line(points={{-38,170},{18,170}},  color={255,0,255}));
  connect(uChi, booToRea1.u)
    annotation (Line(points={{-240,90},{-82,90}}, color={255,0,255}));
  connect(booToRea1.y, sub.u1) annotation (Line(points={{-58,90},{-40,90},{-40,126},
          {78,126}}, color={0,0,127}));
  connect(booToRea.y, sub.u2) annotation (Line(points={{42,170},{60,170},{60,114},
          {78,114}}, color={0,0,127}));
  connect(sub.y, abs1.u)
    annotation (Line(points={{102,120},{118,120}}, color={0,0,127}));
  connect(abs1.y, greThr.u)
    annotation (Line(points={{142,120},{178,120}}, color={0,0,127}));
  ...
  connect(triSam1.y, sub1[1].u1) annotation (Line(points={{-58,30},{-20,30},{-20,
          6},{-2,6}}, color={0,0,127}));
  connect(triSam.y, sub1[2].u1) annotation (Line(points={{-58,-30},{-20,-30},{-20,
          6},{-2,6}}, color={0,0,127}));
  connect(mulSum.y, sub1[1].u2) annotation (Line(points={{-138,30},{-120,30},{-120,
          -6},{-2,-6}}, color={0,0,127}));
  connect(mulSum1.y, sub1[2].u2) annotation (Line(points={{-138,-30},{-120,-30},
          {-120,-6},{-2,-6}}, color={0,0,127}));
  ...
  connect(zer.y, intSwi.u3) annotation (Line(points={{-178,120},{-170,120},{-170,
          162},{-162,162}}, color={255,127,0}));
  connect(nexChaChi, intSwi.u1)
    annotation (Line(points={{-240,178},{-162,178}}, color={255,127,0}));
  connect(lat.y, intSwi.u2) annotation (Line(points={{-58,-140},{-40,-140},{-40,
  ...
  connect(enaVal.y, isoValCha.u2) annotation (Line(points={{102,60},{130,60},{130,
  ...
  connect(intEqu.y, and1.u1) annotation (Line(points={{-38,170},{-20,170},{-20,60},
          {-2,60}}, color={255,0,255}));
  connect(uChi, and1.u2) annotation (Line(points={{-240,90},{-100,90},{-100,52},
