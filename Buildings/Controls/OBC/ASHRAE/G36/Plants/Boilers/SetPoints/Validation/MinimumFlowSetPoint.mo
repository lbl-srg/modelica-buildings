within Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.SetPoints.Validation;
...
protected
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Generic.ZeroIndexCorrection
    zerStaIndCor
