within Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.SetPoints.Subsequences.Validation;
model ProportionalRegulator
    "Validation model for ProportionalRegulator sequence"

  Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.SetPoints.Subsequences.ProportionalRegulator
    proReg(
    final TRetSet=60,
...
equation
  ...
  annotation (
    ...
    experiment(
      ...
      Interval=1,
      Tolerance=1e-06),
      __Dymola_Commands(file="./Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/Plants/Boilers/SetPoints/Subsequences/Validation/ProportionalRegulator.mos"
        "Simulate and plot"),
