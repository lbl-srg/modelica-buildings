...
protected
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.SetPoints.Subsequences.ProportionalRegulator proReg(
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.SetPoints.Subsequences.PumpSpeedLimits pumSpeLim(
