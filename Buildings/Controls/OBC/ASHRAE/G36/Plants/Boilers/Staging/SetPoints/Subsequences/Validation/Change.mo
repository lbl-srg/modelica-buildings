...
model Change
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Staging.SetPoints.Subsequences.Change
    cha(
    final nSta=10,
    final delStaCha=600)
...
Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Staging.SetPoints.Subsequences.Change</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
