within Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Staging.SetPoints.Subsequences.Validation;
model Status
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Staging.SetPoints.Subsequences.Status sta1(
    final nSta=4,
    final nBoi=3,
    final staMat={{1,0,0},{1,1,0},{0,1,1},{1,1,1}})
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Staging.SetPoints.Subsequences.Status sta2(
    final nSta=4,
    final nBoi=3,
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Staging.SetPoints.Subsequences.Status sta3(
    final nSta=4,
    final nBoi=3,
    final staMat={{0,1,0},{1,1,0},{0,1,1},{1,1,1}})
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Staging.SetPoints.Subsequences.Status sta4(
    final nSta=4,
    final nBoi=3,
    final staMat={{1,0,0},{1,1,0},{0,1,1},{1,1,1}})
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Staging.SetPoints.Subsequences.Status sta6(
    final nSta=4,
    final nBoi=3,
    final staMat={{1,0,0},{1,1,0},{0,1,1},{1,1,1}})
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Staging.SetPoints.Subsequences.Status sta7(
    final nSta=4,
    final nBoi=3,
    final staMat={{1,0,0},{1,1,0},{0,1,1},{1,1,1}})
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Staging.SetPoints.Subsequences.Status sta5(
    final nSta=4,
    final nBoi=3,
    final staMat={{1,0,0},{1,1,0},{0,1,1},{1,1,1}})
...
annotation (
  experiment(StopTime=10.0,
    Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/Plants/Boilers/Staging/SetPoints/Subsequences/Validation/Status.mos"
    "Simulate and plot"),
  Documentation(info="<html>
  <p>
  This example validates
  <a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Staging.SetPoints.Subsequences.Status\">
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Staging.SetPoints.Subsequences.Status</a>.
  </p>
  </html>",
  revisions="<html>
  <ul>
