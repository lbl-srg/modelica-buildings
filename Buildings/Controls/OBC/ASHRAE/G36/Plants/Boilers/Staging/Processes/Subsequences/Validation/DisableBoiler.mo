...
model DisableBoiler
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Staging.Processes.Subsequences.DisableBoiler
    boiOnOff(
    final nBoi=3,
    final proOnTim=300)
...
annotation (
 experiment(StopTime=3600, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/Plants/Boilers/Staging/Processes/Subsequences/Validation/DisableBoiler.mos"
    "Simulate and plot"),
