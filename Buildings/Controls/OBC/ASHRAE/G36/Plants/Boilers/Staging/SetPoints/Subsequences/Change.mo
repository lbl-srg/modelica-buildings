...
equation
  ...
  annotation (defaultComponentName = "cha",
    ...
    Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Generic.PlantEnable</a> subsequence. 
    </li>
    <li>
    ...
    from
    <a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Staging.Processes\">
    Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Staging.Processes</a>
    subsequences.
    </li>
    </ul>
    <p>
