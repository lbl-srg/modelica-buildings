...
model EnableBoiler
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Staging.Processes.Subsequences.EnableBoiler
    enaDisBoi(
    final nBoi=3)
...
annotation (
 experiment(StopTime=3600, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/Plants/Boilers/Staging/Processes/Subsequences/Validation/EnableBoiler.mos"
    "Simulate and plot"),
