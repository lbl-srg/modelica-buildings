...
model EnableLag_flowrate
  ...
  Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Pumps.Generic.EnableLag_flowrate
    enaLagPriPum(
    final nPum=3)
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/Plants/Boilers/Pumps/Generic/Validation/EnableLag_flowrate.mos"
    "Simulate and plot"),
  Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Pumps.Generic.EnableLag_flowrate\">
Buildings.Controls.OBC.ASHRAE.G36.Plants.Boilers.Pumps.Generic.EnableLag_flowrate</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
