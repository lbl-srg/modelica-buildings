...
model DamperLimits_LoopDisable
  ...
  Buildings.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.Economizers.Subsequences.DamperLimits ecoDamLim1
    "Multiple zone VAV AHU minimum outdoor air control - damper position limits"
      annotation (Placement(transformation(extent={{20,-20},{40,0}})));
  Buildings.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.Economizers.Subsequences.DamperLimits ecoDamLim2
    "Multiple zone VAV AHU minimum outdoor air control - damper position limits"
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/AHUs/MultiZone/Economizers/Subsequences/Validation/DamperLimits_LoopDisable.mos"
    "Simulate and plot"),
