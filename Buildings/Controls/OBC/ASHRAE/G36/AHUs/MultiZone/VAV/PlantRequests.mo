...
block PlantRequests "Output plant requests for multizone air handling unit"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uChiWatValPos(
    final unit="1",
    final min=0,
    final max=1)
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uHotWatValPos(
    final unit="1",
    final min=0,
...
equation
  ...
  connect(uChiWatValPos, greThr2.u)
  ...
  connect(uChiWatValPos, lesThr.u) annotation (Line(points={{-220,100},{-140,100},
  ...
  connect(uChiWatValPos, lesThr1.u) annotation (Line(points={{-220,100},{-140,100},
  ...
  connect(uHotWatValPos, greThr5.u)
  ...
  connect(uHotWatValPos, lesThr2.u) annotation (Line(points={{-220,-140},{-140,-140},
  ...
  connect(uHotWatValPos, lesThr3.u) annotation (Line(points={{-220,-140},{-140,-140},
  ...
  Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
    graphics={
        ...
        Text(
          ...
          lineColor={0,0,127},
          pattern=LinePattern.Dash,
          textString="uChiWatValPos"),
        Text(
          extent={{-98,-70},{-34,-88}},
          lineColor={0,0,127},
          pattern=LinePattern.Dash,
          textString="uHotWatValPos",
...
<li>
Else if the chilled water valve position <code>uChiWatValPos</code> is greater than
95%, send 1 request until the <code>uChiWatValPos</code> is less than 85%.
</li>
<li>
Else if the chilled water valve position <code>uChiWatValPos</code> is less than 95%,
send 0 request.
</li>
</ol>
...
<ol>
<li>
If the chilled water valve position <code>uChiWatValPos</code> is greater than
95%, send 1 request until the <code>uChiWatValPos</code> is less than 10%.
</li>
<li>
Else if the chilled water valve position <code>uChiWatValPos</code> is less than 95%,
send 0 request.
...
<li>
Else if the hot water valve position <code>uHotWatValPos</code> is greater than
95%, send 1 request until the <code>uHotWatValPos</code> is less than 85%.
</li>
<li>
Else if the hot water valve position <code>uHotWatValPos</code> is less than 95%,
send 0 request.
</li>
</ol>
...
<ol>
<li>
If the hot water valve position <code>uHotWatValPos</code> is greater than 95%, send 1
request until the hot water valve position is less than 10%.
</li>
<li>
If the hot water valve position <code>uHotWatValPos</code> is less than 95%, send 0 requests.
</li>
</ol>
</html>", revisions="<html>
<ul>
