...
model ExhaustDamper
  ...
  Buildings.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ExhaustDamper exhDamPos(k=0.1)
  ...
  Buildings.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ExhaustDamper exhDamPos1(k=0.5)
    "Block of controlling actuated exhaust damper without fan"
    annotation (Placement(transformation(extent={{0,0},{20,20}})));
  Buildings.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.SetPoints.ExhaustDamper exhDamPos2(k=1)
    "Block of controlling actuated exhaust damper without fan"
