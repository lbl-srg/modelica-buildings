...
equation
  connect(TSupSet.y,supSig.TSupSet)
    annotation (Line(points={{-58,80},{-40,80},{-40,70},{18,70}},
      color={0,0,127}));
  connect(TSup.y, supSig.TSup)
    annotation (Line(points={{-58,40},{-30,40},{-30,64},{18,64}},
      color={0,0,127}));
  connect(supFanSta.y, supSig.uSupFan)
    annotation (Line(points={{-58,0},{-20,0},{-20,76},{18,76}},
      color={255,0,255}));
  connect(TSupSet.y,supSig1.TSupSet)
    annotation (Line(points={{-58,80},{-40,80},{-40,10},{18,10}},
      color={0,0,127}));
  connect(TSup.y, supSig1.TSup)
    annotation (Line(points={{-58,40},{-30,40},{-30,4},{18,4}},
      color={0,0,127}));
  connect(fanOn.y, supSig1.uSupFan)
    annotation (Line(points={{-58,-40},{0,-40},{0,16},{18,16}},
      color={255,0,255}));
