...
model OutsideAirFlow
  ...
  Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.SetPoints.OutsideAirFlow
...
equation
  connect(numOfOcc.y, outAirSet_SinZon.nOcc)
    annotation (Line(points={{-38,50},{0,50},{0,36},{16,36}}, color={0,0,127}));
  connect(winSta.y, outAirSet_SinZon.uWin)
    annotation (Line(points={{-38,-40},{-9.75,-40},{-9.75,28},{16,28}}, color={255,0,255}));
  connect(TZon.y, outAirSet_SinZon.TZon)
    annotation (Line(points={{-38,20},{-20,20},{-20,20},{16,20}},  color={0,0,127}));
  connect(outAirSet_SinZon.uOpeMod, opeMod.y)
    annotation (Line(points={{16,2},{10,2},{10,-70},{2,-70}}, color={255,127,0}));
  connect(supFan.y, outAirSet_SinZon.uSupFan)
    annotation (Line(points={{-38,-70},{-30,-70},{-30,8},{16,8}}, color={255,0,255}));
  connect(TDis.y, outAirSet_SinZon.TDis)
    annotation (Line(points={{-38,-10},{0,-10},{0,14},{16,14}},  color={0,0,127}));
  connect(winSta.y, outAirSet_SinZon_noOccSen.uWin)
    annotation (Line(points={{-38,-40},{-9.75,-40},{-9.75,-32},{16,-32}}, color={255,0,255}));
  connect(TZon.y, outAirSet_SinZon_noOccSen.TZon)
    annotation (Line(points={{-38,20},{-20,20},{-20,-40},{16,-40}},  color={0,0,127}));
  connect(outAirSet_SinZon_noOccSen.uOpeMod, opeMod.y)
    annotation (Line(points={{16,-58},{10,-58},{10,-70},{2,-70}}, color={255,127,0}));
  connect(supFan.y, outAirSet_SinZon_noOccSen.uSupFan)
    annotation (Line(points={{-38,-70},{-30,-70},{-30,-52},{16,-52}}, color={255,0,255}));
  connect(TDis.y, outAirSet_SinZon_noOccSen.TDis)
    annotation (Line(points={{-38,-10},{0,-10},{0,-46},{16,-46}}, color={0,0,127}));
annotation (
