...
block Controller
  ...
  Buildings.Controls.OBC.ASHRAE.G36.TerminalUnits.ModeAndSetPoints modSetPoi(
  ...
  Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.VAV.CoolingCoil cooCoi(final
      controllerTypeCooCoi=controllerTypeCooCoi, kCooCoi=kCooCoi)
...
equation
  ...
  connect(setPoiVAV.TSupCoo, cooCoi.TSupCoo) annotation (Line(points={{62,184},
          {80,184},{80,-112},{118,-112}},color={0,0,127}));
  ...
  connect(TZon, setPoiVAV.TZon) annotation (Line(points={{-220,160},{-120,160},
          {-120,180},{-40,180},{-40,196.4},{38,196.4}},    color={0,0,127}));
