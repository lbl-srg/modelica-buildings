...
model Enable_TOut_hOut
  ...
  Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.Economizers.Subsequences.Enable ecoEnaDis1
    "Single zone VAV AHU economizer enable disable sequence"
    annotation (Placement(transformation(extent={{80,-80},{100,-60}})));
  Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.Economizers.Subsequences.Enable ecoEnaDis2(
    use_enthalpy=false)
    "Single zone VAV AHU economizer enable disable sequence"
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/AHUs/SingleZone/Economizers/Subsequences/Validation/Enable_TOut_hOut.mos"
    "Simulate and plot"),
  Icon(graphics={
        Ellipse(
          lineColor={75,138,73},
