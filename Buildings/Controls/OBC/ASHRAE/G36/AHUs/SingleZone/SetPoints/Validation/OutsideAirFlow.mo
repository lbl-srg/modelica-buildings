within Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.SetPoints.Validation;
model OutsideAirFlow
  "Validate the model of calculating minimum outdoor airflow setpoint"
  extends Modelica.Icons.Example;

  Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.SetPoints.OutsideAirFlow
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/AHUs/SingleZone/SetPoints/Validation/OutsideAirFlow.mos"
    "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.SetPoints.OutsideAirFlow\">
Buildings.Controls.OBC.ASHRAE.G36.AHUs.SingleZone.SetPoints.OutsideAirFlow</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
