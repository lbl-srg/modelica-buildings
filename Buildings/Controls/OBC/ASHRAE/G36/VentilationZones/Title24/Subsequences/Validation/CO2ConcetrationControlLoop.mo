within Buildings.Controls.OBC.ASHRAE.G36.VentilationZones.Title24.Subsequences.Validation;
model CO2ConcetrationControlLoop
  "Validate the model of calculating CO2 concentration control loop signal"
