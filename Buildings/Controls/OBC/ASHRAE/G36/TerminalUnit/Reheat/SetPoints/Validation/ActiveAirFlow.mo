within Buildings.Controls.OBC.ASHRAE.G36.TerminalUnit.Reheat.SetPoints.Validation;
model ActiveAirFlow
  "Validate the model for calculating active airflow setpoint for VAV terminal unit with reheat"
  extends Modelica.Icons.Example;
  Buildings.Controls.OBC.ASHRAE.G36.TerminalUnit.Reheat.SetPoints.ActiveAirFlow
    actAirSet_RehBox(
    VCooMax=0.075,
    VMin=0.017,
    VHeaMax=0.05,
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/TerminalUnit/Reheat/SetPoints/Validation/ActiveAirFlow.mos"
        "Simulate and plot"),
  Diagram(coordinateSystem(preserveAspectRatio=false)),
  Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36.TerminalUnit.Reheat.SetPoints.ActiveAirFlow\">
Buildings.Controls.OBC.ASHRAE.G36.TerminalUnit.Reheat.SetPoints.ActiveAirFlow</a>
