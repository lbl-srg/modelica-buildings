within Buildings.Controls.OBC.ASHRAE.G36.TerminalUnit.SetPoints.Validation;
model ZoneTemperatures "Validate block for zone set point"
  extends Modelica.Icons.Example;
  Buildings.Controls.OBC.ASHRAE.G36.TerminalUnit.SetPoints.ZoneTemperatures zonSetpoint(
    occSen=true,
    sinAdj=false,
    cooAdj=true,
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36/TerminalUnit/SetPoints/Validation/ZoneTemperatures.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36.TerminalUnit.SetPoints.ZoneTemperatures\">
Buildings.Controls.OBC.ASHRAE.G36.TerminalUnit.SetPoints.ZoneTemperatures</a>
