...
equation
  ...
  connect(not5.y, conDam.trigger) annotation (Line(points={{222,-250},{240,-250},
          {240,108},{284,108},{284,218}}, color={255,0,255}));
  ...
  connect(not5.y, conVal.trigger) annotation (Line(points={{222,-250},{240,-250},
          {240,-132},{38,-132},{38,-92}},  color={255,0,255}));
