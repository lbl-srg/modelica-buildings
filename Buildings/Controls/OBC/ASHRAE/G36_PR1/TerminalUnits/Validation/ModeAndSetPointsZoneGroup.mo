...
equation
  connect(zonSta.yCooTim, zonGroSta.uCooTim) annotation (Line(points={{-38,19},
          {-26,19},{-26,20},{-12,20}},color={0,0,127}));
  connect(zonSta.yWarTim, zonGroSta.uWarTim) annotation (Line(points={{-38,17},
          {-26,17},{-26,18},{-12,18}},color={0,0,127}));
  ...
  connect(zonSta.yHigOccCoo, zonGroSta.uHigOccCoo) annotation (Line(points={{-38,13},
          {-26,13},{-26,16},{-12,16}},     color={255,0,255}));
  ...
  connect(zonSta.yHigUnoCoo, zonGroSta.uHigUnoCoo) annotation (Line(points={{-38,5},
          {-26,5},{-26,8},{-12,8}},    color={255,0,255}));
