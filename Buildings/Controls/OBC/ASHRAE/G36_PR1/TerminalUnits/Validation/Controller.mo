...
equation
  ...
  connect(zerOrdHol.y, con.uDam) annotation (Line(points={{102,68},{110,68},{110,
          100},{20,100},{20,66},{38,66}}, color={0,0,127}));
  connect(zerOrdHol1.y, con1.uDam) annotation (Line(points={{102,10},{110,10},{110,
          40},{30,40},{30,6},{38,6}}, color={0,0,127}));
