...
equation
  ...
  connect(supFan.y, exhDamPos1.uFan) annotation (Line(points={{-59,-30},{-20,-30},
          {-20,4},{-1,4}}, color={255,0,255}));
  connect(supFan.y, exhDamPos2.uFan) annotation (Line(points={{-59,-30},{-20,-30},
          {-20,-36},{-1,-36}}, color={255,0,255}));
