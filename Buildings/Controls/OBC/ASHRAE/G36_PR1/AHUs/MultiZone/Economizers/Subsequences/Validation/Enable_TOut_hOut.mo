...
equation
  connect(TOutCut.y, enaDis.TOutCut)
    annotation (Line(points={{-139,90},{-112,90},{-112,-21.7857},{-80.7143,
          -21.7857}},                                                   color={0,0,127}));
  connect(hOutCut.y, enaDis.hOutCut)
    annotation (Line(points={{-219,90},{-186,90},{-186,58},{-138,58},{-138,
          -24.6429},{-80.7143,-24.6429}},                               color={0,0,127}));
  connect(freProSta.y, enaDis.uFreProSta)
    annotation (Line(points={{-179,30},{-120,30},{-120,-28.2143},{-80.7143,
          -28.2143}},                                                   color={255,127,0}));
  connect(outDamPosMax.y, enaDis.uOutDamPosMax)
    annotation (Line(points={{-219,-70},{-150,-70},{-150,-34.2857},{-80.7143,
          -34.2857}},                                                     color={0,0,127}));
  connect(outDamPosMin.y, enaDis.uOutDamPosMin)
    annotation (Line(points={{-219,-110},{-210,-110},{-210,-60},{-140,-60},{
          -140,-35.7143},{-80.7143,-35.7143}},                                                    color={0,0,127}));
  connect(retDamPhyPosMax.y, enaDis.uRetDamPhyPosMax)
    annotation (Line(points={{-139,-110},{-110,-110},{-110,-37.1429},{-80.7143,
          -37.1429}},                                                       color={0,0,127}));
  connect(retDamPosMax.y, enaDis.uRetDamPosMax)
    annotation (Line(points={{-139,-150},{-106,-150},{-106,-38.5714},{-80.7143,
          -38.5714}},                                                       color={0,0,127}));
  connect(retDamPosMin.y, enaDis.uRetDamPosMin)
    annotation (Line(points={{-139,-190},{-100,-190},{-100,-40},{-80.7143,-40}},
                                                                            color={0,0,127}));
  connect(TOutCut1.y, enaDis1.TOutCut)
    annotation (Line(points={{21,90},{30,90},{30,-21.7857},{79.2857,-21.7857}},
                                                                 color={0,0,127}));
  connect(hOutCut1.y, enaDis1.hOutCut)
    annotation (Line(points={{-19,50},{10,50},{10,-24.6429},{79.2857,-24.6429}},
                                                                  color={0,0,127}));
  connect(hOutBelowCutoff.y, enaDis.hOut)
    annotation (Line(points={{-219,128},{-180,128},{-180,66},{-130,66},{-130,
          -23.2143},{-80.7143,-23.2143}},                                                   color={0,0,127}));
  connect(TOutBelowCutoff.y, enaDis1.TOut)
    annotation (Line(points={{61,90},{70,90},{70,-20},{79.2857,-20},{79.2857,
          -20.3571}},                                                     color={0,0,127}));
  connect(booPul.y, TOut.u)
    annotation (Line(points={{-179,160},{-162,160}}, color={255,0,255}));
  connect(TOut.y, enaDis.TOut)
    annotation (Line(points={{-139,160},{-110,160},{-110,-20.3571},{-80.7143,
          -20.3571}},                                                     color={0,0,127}));
  connect(booPul1.y, hOut.u) annotation (Line(points={{-59,90},{-50,90},{-42,90}}, color={255,0,255}));
  connect(hOut.y, enaDis1.hOut)
    annotation (Line(points={{-19,90},{-10,90},{-10,60},{20,60},{20,-23.2143},{
          79.2857,-23.2143}},                                                       color={0,0,127}));
  connect(freProSta.y, enaDis1.uFreProSta)
    annotation (Line(points={{-179,30},{-46,30},{-46,-28.2143},{79.2857,
          -28.2143}},                                                color={255,127,0}));
  connect(outDamPosMax.y, enaDis1.uOutDamPosMax)
    annotation (Line(points={{-219,-70},{8,-70},{8,-34.2857},{79.2857,-34.2857}},
                                                                   color={0,0,127}));
  connect(outDamPosMin.y, enaDis1.uOutDamPosMin)
    annotation (Line(points={{-219,-110},{-190,-110},{-190,-64},{12,-64},{12,
          -35.7143},{79.2857,-35.7143}},                                                     color={0,0,127}));
  connect(retDamPhyPosMax.y, enaDis1.uRetDamPhyPosMax)
    annotation (Line(points={{-139,-110},{16,-110},{16,-37.1429},{79.2857,
          -37.1429}},                                                  color={0,0,127}));
  connect(retDamPosMax.y, enaDis1.uRetDamPosMax)
    annotation (Line(points={{-139,-150},{20,-150},{20,-38.5714},{79.2857,
          -38.5714}},                                                  color={0,0,127}));
  connect(retDamPosMin.y, enaDis1.uRetDamPosMin)
    annotation (Line(points={{-139,-190},{30,-190},{30,-40},{79.2857,-40}},
                                                                       color={0,0,127}));
  connect(TOut.y, enaDis2.TOut)
    annotation (Line(points={{-139,160},{200,160},{200,-20.3571},{219.286,
          -20.3571}},                                                             color={0,0,127}));
  connect(TOutCut.y, enaDis2.TOutCut)
    annotation (Line(points={{-139,90},{-120,90},{-120,120},{188,120},{188,
          -21.7857},{219.286,-21.7857}},                                                    color={0,0,127}));
  connect(freProSta.y, enaDis2.uFreProSta)
    annotation (Line(points={{-179,30},{170,30},{170,-28.2143},{219.286,
          -28.2143}},                                                 color={255,127,0}));
  connect(outDamPosMax.y, enaDis2.uOutDamPosMax)
    annotation (Line(points={{-219,-70},{178,-70},{178,-34.2857},{219.286,
          -34.2857}},                                                   color={0,0,127}));
  connect(outDamPosMin.y, enaDis2.uOutDamPosMin) annotation (Line(points={{-219,
          -110},{-180,-110},{-180,-70},{188,-70},{188,-38},{188,-35.7143},{
          219.286,-35.7143}},             color={0,0,127}));
  connect(retDamPhyPosMax.y, enaDis2.uRetDamPhyPosMax)
    annotation (Line(points={{-139,-110},{192,-110},{192,-37.1429},{219.286,
          -37.1429}},                                                     color={0,0,127}));
  connect(retDamPosMax.y, enaDis2.uRetDamPosMax)
    annotation (Line(points={{-139,-150},{196,-150},{196,-38.5714},{219.286,
          -38.5714}},                                                     color={0,0,127}));
  connect(retDamPosMin.y, enaDis2.uRetDamPosMin)
    annotation (Line(points={{-139,-190},{198,-190},{198,-40},{219.286,-40}},
                                                                          color={0,0,127}));
  connect(supFanSta.y, enaDis.uSupFan)
    annotation (Line(points={{-179,-32},{-160,-32},{-160,-26},{-80,-26},{-80,
          -26.4286},{-80.7143,-26.4286}},                      color={255,0,255}));
  connect(supFanSta.y, enaDis1.uSupFan)
    annotation (Line(points={{-179,-32},{-160,-32},{-160,-12},{-20,-12},{-20,
          -26.4286},{79.2857,-26.4286}},                                                     color={255,0,255}));
  connect(supFanSta.y, enaDis2.uSupFan)
    annotation (Line(points={{-179,-32},{-160,-32},{-160,-12},{140,-12},{140,
          -26.4286},{219.286,-26.4286}},                                                      color={255,0,255}));
  connect(zonSta.y, enaDis.uZonSta)
    annotation (Line(points={{-179,0},{-132,0},{-132,-30.3571},{-80.7143,
          -30.3571}},                                                 color={255,127,0}));
  connect(zonSta.y, enaDis1.uZonSta)
    annotation (Line(points={{-179,0},{-48,0},{-48,-30.3571},{79.2857,-30.3571}},
                                                                   color={255,127,0}));
  connect(zonSta.y, enaDis2.uZonSta)
    annotation (Line(points={{-179,0},{160,0},{160,-30},{219.286,-30},{219.286,
          -30.3571}},                                                         color={255,127,0}));
  connect(enaDis.TMix, TMixMea.y) annotation (Line(points={{-80.7143,-32.1429},
          {-142,-32.1429},{-142,50},{-219,50}}, color={0,0,127}));
  connect(enaDis1.TMix, TMixMea.y) annotation (Line(points={{79.2857,-32.1429},
          {-50,-32.1429},{-50,50},{-219,50}}, color={0,0,127}));
  connect(enaDis2.TMix, TMixMea.y) annotation (Line(points={{219.286,-32.1429},
          {219.286,-34},{136,-34},{136,2},{-50,2},{-50,50},{-219,50}}, color={0,
          0,127}));
  annotation (
