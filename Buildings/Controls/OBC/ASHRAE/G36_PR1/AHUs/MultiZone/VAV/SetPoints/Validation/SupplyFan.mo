...
model SupplyFan "Validate SupplyFan"
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.VAV.MultiZone.SetPoints.SupplyFan
    conSupFan(
    numZon=4,
    Td=1,
...
equation
  connect(vavBoxFlo1.y, conSupFan.VDis_flow[1]) annotation (Line(points={{-59,
          40},{-46,40},{-46,0},{34,0},{34,1.5},{58,1.5}}, color={0,0,127}));
  connect(vavBoxFlo2.y, conSupFan.VDis_flow[2]) annotation (Line(points={{-19,
          50},{30,50},{30,2.5},{58,2.5}}, color={0,0,127}));
  connect(vavBoxFlo3.y, conSupFan.VDis_flow[3]) annotation (Line(points={{-59,
          10},{-50,10},{-50,-2},{28,-2},{28,3.5},{58,3.5}}, color={0,0,127}));
  connect(vavBoxFlo4.y, conSupFan.VDis_flow[4]) annotation (Line(points={{9,20},
          {28,20},{28,4.5},{58,4.5}}, color={0,0,127}));
