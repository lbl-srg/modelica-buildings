...
block OutsideAirFlow
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput nOcc[numZon](
    final unit=fill("1",numZon)) if have_occSen
    "Number of occupants"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TZon[numZon](
    ...
    final quantity=fill("ThermodynamicTemperature",numZon)) "Measured zone air temperature"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TDis[numZon](
    final unit=fill("K",numZon),
    final displayUnit=fill("degC",numZon),
    final quantity=fill("ThermodynamicTemperature",numZon)) "Measured discharge air temperature"
...
protected
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant occMod(
    ...
    "Occupied mode index"
    annotation (Placement(transformation(extent={{-170,-240},{-150,-220}})));
...
equation
  connect(breZonAre.y, breZon.u1)
    annotation (Line(points={{-149,120},{-140,120},{-140,110},{-60,110},
 ...
 connect(swi.y, breZon.u2)
  ...
  connect(swi2.y, swi3.u3)
    annotation (Line(points={{41,-20},{48,-20},{48,-72},{58,-72}},
      color={0,0,127}));
  connect(zerOutAir.y, swi3.u1)
    annotation (Line(points={{-19,-40},{0,-40},{0,-88},{58,-88}},
      color={0,0,127}));
  connect(swi3.y, priOutAirFra.u1)
    annotation (Line(points={{81,-80},{90,-80},{90,-108},{-8,-108},{-8,-214},{-2,
          -214}}, color={0,0,127}));
  ...
  connect(max.y, priOutAirFra.u2)
    annotation (Line(points={{-19,-230},{-12,-230},{-12,-226},{-2,-226}},
      color={0,0,127}));
  connect(max.y, sysPriAirRate.u)
    annotation (Line(points={{-19,-230},{-12,-230},{-12,-142},{-2,-142}},
      color={0,0,127}));
  connect(priOutAirFra.y, maxPriOutAirFra.u)
    annotation (Line(points={{21,-220},{38,-220}}, color={0,0,127}));
  connect(sysPriAirRate.y, outAirFra.u2)
    annotation (Line(points={{21,-142},{30,-142},{30,-148},{38,-148}},
      color={0,0,127}));
  connect(maxPriOutAirFra.y, sysVenEff.u2)
    annotation (Line(points={{61,-220},{80,-220},{80,-202},{60,-202},{60,-186},{
          78,-186}},        color={0,0,127}));
  connect(sumDesZonPop.y, occDivFra.u2)
    annotation (Line(points={{-119,230},{-112,230},{-112,248},{-100,248}},
      color={0,0,127}));
  ...
  connect(sysUncOutAir.y, min1.u2)
    annotation (Line(points={{121,-80},{128,-80},{128,-88},{138,-88}},
      color={0,0,127}));
  ...
  connect(desOutAirInt.y, min.u1)
    annotation (Line(points={{161,110},{188,110},{188,-94},{198,-94}},
      color={0,0,127}));
  ...
  connect(uOpeMod, intEqu1.u1)
    annotation (Line(points={{-200,-210},{-122,-210}}, color={255,127,0}));
  connect(occMod.y, intEqu1.u2)
    annotation (Line(points={{-149,-230},{-140,-230},{-140,-218},{-122,-218}},
      color={255,127,0}));
  connect(intEqu1.y, and1.u2)
    annotation (Line(points={{-99,-210},{-80,-210},{-80,-190},{-170,-190},{-170,
          -178},{-162,-178}},   color={255,0,255}));
  connect(max.u2, VDis_flow)
    annotation (Line(points={{-42,-224},{-130,-224},{-130,-252},{-200,-252}},
      color={0,0,127}));
  connect(reaRepDivZer.y, max.u1)
    annotation (Line(points={{-59,-260},{-50,-260},{-50,-236},{-42,-236}},
      color={0,0,127}));
  connect(gaiDivZer.y, reaRepDivZer.u)
    annotation (Line(points={{-99,-260},{-82,-260}}, color={0,0,127}));
  connect(gaiDivZer.u, unCorOutAirInk.y)
    annotation (Line(points={{-122,-260},{-140,-260},{-140,-280},{180,-280},{180,
          220.5},{41,220.5}},  color={0,0,127}));
  ...
  connect(VOutMinSet_flow, min.y)
    annotation (Line(points={{260,-100},{221,-100}}, color={0,0,127}));
  connect(effMinOutAirInt.y, min.u2)
    annotation (Line(points={{163,-140},{170,-140},{170,-106},{198,-106}},
      color={0,0,127}));
  connect(norVOutMin.u1, min.y)
    annotation (Line(points={{198,-184},{188,-184},{188,-128},{230,-128},{230,-100},
          {221,-100}},                   color={0,0,127}));
  connect(desOutAirInt.y, norVOutMin.u2)
    annotation (Line(points={{161,110},{184,110},{184,-196},{198,-196}},
                                    color={0,0,127}));
  connect(norVOutMin.y, VOutMinSet_flow_normalized)
    annotation (Line(points={{221,-190},{230,-190},{230,-171},{259,-171}},
                                                       color={0,0,127}));

  connect(not1.y, booRep.u)
    annotation (Line(points={{-99,-170},{-82,-170}}, color={255,0,255}));
  connect(and1.y, not1.u)
    annotation (Line(points={{-139,-170},{-122,-170}}, color={255,0,255}));
  connect(uSupFan, and1.u1)
    annotation (Line(points={{-200,-170},{-162,-170}}, color={255,0,255}));
annotation (
