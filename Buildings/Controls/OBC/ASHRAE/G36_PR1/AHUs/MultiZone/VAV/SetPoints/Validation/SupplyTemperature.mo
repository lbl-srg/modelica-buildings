...
model SupplyTemperature
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.VAV.MultiZone.SetPoints.SupplyTemperature
...
equation
  ...
  connect(outTem.y, conTSetSup.TOut)
    annotation (Line(points={{-59,40},{40,40},{40,4},{69,4}},
      color={0,0,127}));
  connect(setZonTem.y, conTSetSup.TZonSetAve) annotation (Line(points={{-59,70},
