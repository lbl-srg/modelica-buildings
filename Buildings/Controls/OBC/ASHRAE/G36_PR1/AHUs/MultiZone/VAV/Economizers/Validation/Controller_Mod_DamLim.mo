...
equation
  ...
  connect(opeMod.y, economizer.uOpeMod) annotation (Line(points={{-99,-100},{-4,
          -100},{-4,3.125},{19.375,3.125}}, color={255,127,0}));
  ...
  connect(TOutBelowCutoff.y, economizer1.TOut) annotation (Line(points={{-99,110},
          {86,110},{86,-20.625},{99.375,-20.625}},      color={0,0,127}));
  connect(TOutCut1.y, economizer1.TOutCut) annotation (Line(points={{-99,70},{80,
          70},{80,-21.875},{99.375,-21.875}},    color={0,0,127}));
  connect(VOutMinSet_flow.y, economizer1.VOutMinSet_flow_normalized)
    annotation (Line(points={{-19,50},{-12,50},{-12,-30},{99.375,-30}},
      color={0,0,127}));
  connect(fanSta.y, economizer1.uSupFan) annotation (Line(points={{-59,-80},{-14,
          -80},{-14,-34.375},{99.375,-34.375}},color={255,0,255}));
  connect(freProSta.y, economizer1.uFreProSta) annotation (Line(points={{-59,-120},
          {0,-120},{0,-39.375},{99.375,-39.375}},   color={255,127,0}));
  connect(opeMod.y, economizer1.uOpeMod) annotation (Line(points={{-99,-100},{-4,
          -100},{-4,-36.875},{99.375,-36.875}},  color={255,127,0}));
  ...
  connect(economizer1.TMix, TMixMea.y) annotation (Line(points={{99.375,-31.875},
          {-20,-31.875},{-20,0},{-59,0}},  color={0,0,127}));
  ...
  connect(VOut_flow.y, economizer1.VOut_flow_normalized) annotation (Line(
        points={{-19,90},{-8,90},{-8,-28.75},{99.375,-28.75}}, color={0,0,127}));
