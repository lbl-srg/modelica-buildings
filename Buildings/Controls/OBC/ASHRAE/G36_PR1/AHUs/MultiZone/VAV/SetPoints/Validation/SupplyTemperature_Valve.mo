...
model SupplyTemperature_Valve
  "Validate model for controlling coil valve postion of multi zone VAV AHU"

  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.VAV.MultiZone.SetPoints.SupplySignals
    AHUValve
...
equation
  connect(TSupSet.y,AHUValve.TSupSet)
  ...
  connect(supFanSta.y, AHUValve.uSupFan)
    annotation (Line(points={{-59,0},{-20,0},{-20,65},{19,65}},
      color={255,0,255}));
  connect(TSupSet.y,AHUValve1.TSupSet)
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/MultiZone/VAV/SetPoints/Validation/SupplyTemperature_Valve.mos"
        "Simulate and plot"),
