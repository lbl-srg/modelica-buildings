...
model VAVSupply_u "Validation model for control input"
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TZon(k=273.15 + 28)
    ...
    annotation (Placement(transformation(extent={{-80,-4},{-60,4}})));

  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TOut(k=273.15 + 22)
    "Outdoor temperature"
    annotation (Placement(transformation(extent={{-80,-24},{-60,-16}})));
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TSetZon(k=273.15 + 23)
    ...
    annotation (Placement(transformation(extent={{-80,10},{-60,18}})));

  CDL.Continuous.Sources.Constant TZon1(k=273.15 + 23)
    "Zone air temperature"
    annotation (Placement(transformation(extent={{-80,-64},{-60,-56}})));
equation
  connect(TZon.y, setPoiVAV.TZon) annotation (Line(
      points={{-59,0},{-31.5,0},{-31.5,46},{-2,46}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(TOut.y, setPoiVAV.TOut) annotation (Line(points={{-59,-20},{-24,-20},
          {-24,42},{-2,42}},color={0,0,127}));
  connect(uHea.y, setPoiVAV.uHea) annotation (Line(points={{-59,80},{-12,80},{-12,
          58},{-2,58}}, color={0,0,127}));
  connect(uCoo.y, setPoiVAV.uCoo) annotation (Line(points={{-59,50},{-16,50},{-16,
          54},{-2,54}}, color={0,0,127}));
  connect(TSetZon.y, setPoiVAV.TSetZon) annotation (Line(points={{-59,14},{-10,14},
          {-10,50},{-2,50}}, color={0,0,127}));
  connect(TOut.y, setPoiVAV1.TOut) annotation (Line(points={{-59,-20},{-24,-20},
          {-24,2},{-2,2}}, color={0,0,127}));
  connect(uHea.y, setPoiVAV1.uHea) annotation (Line(points={{-59,80},{-12,80},{-12,
          18},{-2,18}}, color={0,0,127}));
  connect(uCoo.y, setPoiVAV1.uCoo) annotation (Line(points={{-59,50},{-16,50},{-16,
          14},{-2,14}}, color={0,0,127}));
  connect(TSetZon.y, setPoiVAV1.TSetZon) annotation (Line(points={{-59,14},{-10,
          14},{-10,10},{-2,10}}, color={0,0,127}));
  connect(TOut.y, setPoiVAV2.TOut)
    annotation (Line(points={{-59,-20},{-24,-20},{-24,-38},{-2,-38}},
                                                  color={0,0,127}));
  connect(uHea.y, setPoiVAV2.uHea) annotation (Line(points={{-59,80},{-12,80},{-12,
          -22},{-2,-22}}, color={0,0,127}));
  connect(uCoo.y, setPoiVAV2.uCoo) annotation (Line(points={{-59,50},{-16,50},{-16,
          -26},{-2,-26}}, color={0,0,127}));
  connect(TSetZon.y, setPoiVAV2.TSetZon) annotation (Line(points={{-59,14},{-10,
          14},{-10,-30},{-2,-30}}, color={0,0,127}));
  connect(TOut.y, setPoiVAV1.TZon) annotation (Line(
      points={{-59,-20},{-24,-20},{-24,6},{-2,6}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(TZon1.y, setPoiVAV2.TZon) annotation (Line(
      points={{-59,-60},{-20,-60},{-20,-34},{-2,-34}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  annotation (
