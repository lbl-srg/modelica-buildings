...
equation
  ...
  connect(TOut.y, setPoiVAV2.TOut) annotation (Line(points={{-59,-40},{-24,-40},
          {-24,-38},{-2,-38}}, color={0,0,127}));
  connect(uHea.y, setPoiVAV2.uHea) annotation (Line(points={{-59,80},{-12,80},{
          -12,-22},{-2,-22}}, color={0,0,127}));
  connect(uCoo.y, setPoiVAV2.uCoo) annotation (Line(points={{-59,50},{-16,50},{
          -16,-26},{-2,-26}}, color={0,0,127}));
  ...
  connect(TOut.y, setPoiVAV1.TZon) annotation (Line(
      points={{-59,-40},{-28,-40},{-28,6},{-2,6}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(TZon1.y, setPoiVAV2.TZon) annotation (Line(
      points={{-59,-70},{-26,-70},{-26,-34},{-2,-34}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  annotation (
