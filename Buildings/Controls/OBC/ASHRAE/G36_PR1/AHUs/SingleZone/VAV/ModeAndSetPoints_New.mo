...
protected
  Buildings.Controls.OBC.ASHRAE.G36_PR1.TerminalUnits.SetPoints.ZoneTemperatures_New TZonSet(
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.Generic.SetPoints.OperationMode_New opeModSel(
    final numZon=1,
...
equation
  connect(TZonSet.uCooDemLimLev,cooDemLimLev. y)
    annotation (Line(points={{78,-104},{36,-104},{36,-140},{22,-140}},
      color={255,127,0}));
  connect(heaDemLimLev.y,TZonSet. uHeaDemLimLev)
    annotation (Line(points={{22,-200},{40,-200},{40,-108},{78,-108}},
      color={255,127,0}));
  connect(TZonSet.TZonCooSet, TZonCooSet)
    annotation (Line(points={{122,-82},{132,-82},{132,110},{180,110}},
      color={0,0,127}));
  connect(TZonSet.TZonHeaSet, TZonHeaSet)
    annotation (Line(points={{122,-90},{140,-90},{140,60},{180,60}},
      color={0,0,127}));
  connect(setAdj, TZonSet.setAdj)
    annotation (Line(points={{-180,-80},{-100,-80},{-100,-93},{78,-93}},
      color={0,0,127}));
  connect(heaSetAdj, TZonSet.heaSetAdj)
    annotation (Line(points={{-180,-120},{-100,-120},{-100,-97},{78,-97}},
      color={0,0,127}));
  connect(TZonSet.uOccSen, uOccSen)
    annotation (Line(points={{94,-112},{94,-160},{-180,-160}},
      color={255,0,255}));
  connect(TZonSet.uWinSta, uWinSta)
    annotation (Line(points={{106,-112},{106,-170},{-72,-170},{-72,-200},{-180,-200}},
      color={255,0,255}));
  ...
  connect(uOcc, opeModSel.uOcc) annotation (Line(points={{-180,10.25},{-136,10.25},
          {-136,1},{38,1}}, color={255,0,255}));
  connect(tNexOcc, opeModSel.tNexOcc) annotation (Line(points={{-180,140},{-140,
          140},{-140,-1},{38,-1}}, color={0,0,127}));
  connect(zonSta.yCooTim, opeModSel.maxCooDowTim) annotation (Line(points={{-38,
          59},{30,59},{30,-3},{38,-3}}, color={0,0,127}));
  connect(zonSta.yWarTim, opeModSel.maxWarUpTim) annotation (Line(points={{-38,57},
          {28,57},{28,-5},{38,-5}}, color={0,0,127}));
  connect(zonSta.yOccHeaHigMin, opeModSel.occHeaHigMin) annotation (Line(points=
         {{-38,53},{26,53},{26,-7},{38,-7}}, color={255,0,255}));
  connect(zonSta.yMaxHigOccCoo, opeModSel.maxHigOccCoo) annotation (Line(points=
         {{-38,51},{24,51},{24,-9},{38,-9}}, color={255,0,255}));
  connect(zonSta.yUnoHeaHigMin, opeModSel.unoHeaHigMin) annotation (Line(points=
         {{-38,45},{22,45},{22,-13},{38,-13}}, color={255,0,255}));
  connect(TZon, opeModSel.TZonMax) annotation (Line(points={{-180,-50},{-68,-50},
          {-68,-15},{38,-15}}, color={0,0,127}));
  connect(TZon, opeModSel.TZonMin) annotation (Line(points={{-180,-50},{-68,-50},
          {-68,-17},{38,-17}}, color={0,0,127}));
  connect(zonSta.yMaxHigUnoCoo, opeModSel.maxHigUnoCoo) annotation (Line(points=
         {{-38,43},{20,43},{20,-21},{38,-21}}, color={255,0,255}));
  ...
  connect(TSetRooCooOn.y, TZonSet.TZonCooSetOcc) annotation (Line(points={{-98,110},
          {-78,110},{-78,-77},{78,-77}}, color={0,0,127}));
  connect(TSetRooCooOff.y, TZonSet.TZonCooSetUno) annotation (Line(points={{-98,
          30},{-74,30},{-74,-81.2},{78,-81.2}}, color={0,0,127}));
  connect(TSetRooHeaOn.y, TZonSet.TZonHeaSetOcc) annotation (Line(points={{-98,150},
          {-76,150},{-76,-85.2},{78,-85.2}}, color={0,0,127}));
  connect(TSetRooHeaOff.y, TZonSet.TZonHeaSetUno) annotation (Line(points={{-98,
          70},{-80,70},{-80,-89},{78,-89}}, color={0,0,127}));
