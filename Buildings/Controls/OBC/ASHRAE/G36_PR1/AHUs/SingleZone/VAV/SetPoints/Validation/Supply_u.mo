...
model Supply_u "Validation model for control input"
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.VAV.SingleZone.SetPoints.Supply
    setPoiVAV(
    yHeaMax=0.7,
    yMin=0.3,
    TSupSetMax=303.15,
...
equation
  ...
  connect(uCoo.y, setPoiVAV.uCoo) annotation (Line(points={{-59,50},{-16,50},{
          -16,54},{-2,54}},
                        color={0,0,127}));
  connect(TSetZon.y,setPoiVAV.TZonSet)  annotation (Line(points={{-59,20},{-10,
          20},{-10,50},{-2,50}},
                             color={0,0,127}));
  ...
  connect(uCoo.y, setPoiVAV1.uCoo) annotation (Line(points={{-59,50},{-16,50},{
          -16,14},{-2,14}},
                        color={0,0,127}));
  connect(TSetZon.y,setPoiVAV1.TZonSet)  annotation (Line(points={{-59,20},{-10,
  ...
  connect(uCoo.y, setPoiVAV2.uCoo) annotation (Line(points={{-59,50},{-16,50},{
          -16,-26},{-2,-26}},
                          color={0,0,127}));
  connect(TSetZon.y,setPoiVAV2.TZonSet)  annotation (Line(points={{-59,20},{-10,
