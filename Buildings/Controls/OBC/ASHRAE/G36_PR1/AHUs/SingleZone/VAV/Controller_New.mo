...
block Controller_New
  ...
  Buildings.Controls.OBC.CDL.Continuous.LimPI cooPI(
  ...
  Buildings.Controls.OBC.CDL.Continuous.LimPI heaPI(
    final reset=Buildings.Controls.OBC.CDL.Types.Reset.Parameter,
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZone.VAV.ModeAndSetPoints_New modSetPoi(
...
equation
  connect(modSetPoi.tNexOcc, tNexOcc) annotation (Line(points={{-182,199},{-200,
          199},{-200,200},{-220,200}},      color={0,0,127}));
  connect(ave.y, setPoiVAV.TZonSet) annotation (Line(points={{-78,190},{-14,190},
          {-14,191.667},{38,191.667}}, color={0,0,127}));
  ...
  connect(modSetPoi.TZonHeaSet, ave.u2) annotation (Line(points={{-158,190},{
          -134,190},{-134,184},{-102,184}},color={0,0,127}));
  connect(modSetPoi.TZonHeaSet, heaPI.u_s) annotation (Line(points={{-158,190},
          {-124,190},{-124,210},{-50,210}}, color={0,0,127}));
  connect(modSetPoi.TZonCooSet, ave.u1) annotation (Line(points={{-158,197},{
  ...
  connect(modSetPoi.uOcc, uOcc) annotation (Line(points={{-182,196.025},{-184,
          196.025},{-184,120},{-220,120}}, color={255,0,255}));
  connect(TZon, modSetPoi.TZon) annotation (Line(points={{-220,160},{-198,160},
          {-198,193},{-182,193}}, color={0,0,127}));
  connect(TZon, cooPI.u_m) annotation (Line(points={{-220,160},{-180,160},{-180,
          132},{-38,132},{-38,148}}, color={0,0,127}));
  connect(setPoiVAV.TZon, cooPI.u_m) annotation (Line(points={{38,188.333},{4,
          188.333},{4,132},{-38,132},{-38,148}},
                                        color={0,0,127}));
  ...
  connect(modSetPoi.yOpeMod, conEco.uOpeMod) annotation (Line(points={{-158,183},
          {-152,183},{-152,-45},{117,-45}}, color={255,127,0}));
  connect(modSetPoi.TZonHeaSet, TZonHeaSet) annotation (Line(points={{-158,190},
          {-140,190},{-140,100},{146,100},{146,60},{210,60}}, color={0,0,127}));
  ...
  connect(intEqu.u1, modSetPoi.yOpeMod) annotation (Line(points={{-112,-230},{
          -120,-230},{-120,-60},{-152,-60},{-152,183},{-158,183}}, color={255,
          127,0}));
  connect(outAirSetPoi.uOpeMod, modSetPoi.yOpeMod) annotation (Line(points={{38,41},
          {34,41},{34,30},{-152,30},{-152,183},{-158,183}},     color={255,127,
          0}));
