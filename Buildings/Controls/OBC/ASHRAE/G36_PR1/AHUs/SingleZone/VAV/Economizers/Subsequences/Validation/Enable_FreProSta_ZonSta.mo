...
equation
  ...
  connect(hOutCut.y, enaDis.hCut)
    annotation (Line(points={{-79,70},{-70,70},{-70,52},{81,52}}, color={0,0,127}));
  connect(hOutBelowCutoff.y, enaDis1.hOut)
    annotation (Line(points={{-79,110},{-60,110},{-60,56},{10,56},{10,-26},{81,-26}},
    color={0,0,127}));
  connect(hOutCut.y, enaDis1.hCut)
    annotation (Line(points={{-79,70},{-70,70},{-70,54},{6,54},{6,-28},{81,-28}},
    color={0,0,127}));
  connect(zonSta.y, enaDis.uZonSta)
    annotation (Line(points={{-139,10},{-120,10},{-120,48},{81,48}}, color={255,127,0}));
  connect(freProSta.y, enaDis.uFreProSta)
    annotation (Line(points={{-139,50},{-130,50},{-130,50},{81,50}}, color={255,127,0}));
  connect(freProSta1.y, enaDis1.uFreProSta)
    annotation (Line(points={{61,-110},{70,-110},{70,-30},{81,-30}}, color={255,127,0}));
  connect(zonSta1.y, enaDis1.uZonSta)
    annotation (Line(points={{61,-70},{72,-70},{72,-32},{81,-32}}, color={255,127,0}));
  connect(outDamPosMax.y, enaDis.uOutDamPosMax)
    annotation (Line(points={{-39,-110},{-30,-110},{-30,44},{81,44}}, color={0,0,127}));
  connect(outDamPosMin.y, enaDis.uOutDamPosMin)
    annotation (Line(points={{-39,-150},{-28,-150},{-28,42},{81,42}}, color={0,0,127}));
  connect(outDamPosMin.y, enaDis1.uOutDamPosMin)
    annotation (Line(points={{-39,-150},{22,-150},{22,-38},{81,-38}}, color={0,0,127}));
  connect(outDamPosMax.y, enaDis1.uOutDamPosMax)
    annotation (Line(points={{-39,-110},{20,-110},{20,-36},{81,-36}}, color={0,0,127}));
  connect(supFanSta.y, enaDis.uSupFan)
    annotation (Line(points={{-139,-30},{-34,-30},{-34,46},{81,46}}, color={255,0,255}));
  connect(supFanSta.y, enaDis1.uSupFan)
    annotation (Line(points={{-139,-30},{-34,-30},{-34,-34},{81,-34}}, color={255,0,255}));
    annotation (
