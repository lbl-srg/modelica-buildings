...
block GroupStatus "Block that outputs the zone group status"
  ...
  parameter Integer numZon(
    final min=1)=5 "Number of zones";
  parameter Integer nZonGro(
    final min=1)=numZon "Number of zones in zone group";
  parameter Boolean inZon[numZon]=fill(true, numZon)
  ...
  CDL.Routing.BooleanArrayFilter booleanArrayFilter(
    nin=numZon,
    nout=nZonGro,
    fil=inZon)
    annotation (Placement(transformation(extent={{-120,290},{-100,310}})));
  CDL.Routing.BooleanArrayFilter booleanArrayFilter1(
    nin=numZon,
    nout=nZonGro,
    fil=inZon)
    annotation (Placement(transformation(extent={{-120,250},{-100,270}})));
  CDL.Routing.RealArrayFilter realArrayFilter(
    nin=numZon,
    nout=nZonGro,
    fil=inZon)
    annotation (Placement(transformation(extent={{-120,210},{-100,230}})));
  CDL.Routing.RealArrayFilter realArrayFilter1(
    nin=numZon,
    nout=nZonGro,
    fil=inZon)
    annotation (Placement(transformation(extent={{-120,170},{-100,190}})));
  CDL.Routing.RealArrayFilter realArrayFilter2(
    nin=numZon,
    nout=nZonGro,
    fil=inZon)
    annotation (Placement(transformation(extent={{-120,130},{-100,150}})));
  CDL.Routing.BooleanArrayFilter booleanArrayFilter5(
    nin=numZon,
    nout=nZonGro,
    fil=inZon)
    annotation (Placement(transformation(extent={{-120,90},{-100,110}})));
  CDL.Routing.BooleanArrayFilter booleanArrayFilter6(
    nin=numZon,
    nout=nZonGro,
    fil=inZon)
    annotation (Placement(transformation(extent={{-120,50},{-100,70}})));
  CDL.Routing.BooleanArrayFilter booleanArrayFilter7(
    nin=numZon,
    nout=nZonGro,
    fil=inZon)
    annotation (Placement(transformation(extent={{-120,10},{-100,30}})));
  CDL.Routing.RealArrayFilter realArrayFilter3(
    nin=numZon,
    nout=nZonGro,
    fil=inZon)
    annotation (Placement(transformation(extent={{-120,-30},{-100,-10}})));
  CDL.Routing.BooleanArrayFilter booleanArrayFilter9(
    nin=numZon,
    nout=nZonGro,
    fil=inZon)
    annotation (Placement(transformation(extent={{-120,-70},{-100,-50}})));
  CDL.Routing.BooleanArrayFilter booleanArrayFilter10(
    nin=numZon,
    nout=nZonGro,
    fil=inZon)
    annotation (Placement(transformation(extent={{-120,-100},{-100,-80}})));
  CDL.Routing.RealArrayFilter realArrayFilter4(
    nin=numZon,
    nout=nZonGro,
    fil=inZon)
    annotation (Placement(transformation(extent={{-120,-160},{-100,-140}})));
  CDL.Routing.BooleanArrayFilter booleanArrayFilter12(
    nin=numZon,
    nout=nZonGro,
    fil=inZon)
    annotation (Placement(transformation(extent={{-120,-190},{-100,-170}})));
  CDL.Routing.RealArrayFilter realArrayFilter5(
    nin=numZon,
    nout=nZonGro,
    fil=inZon)
    annotation (Placement(transformation(extent={{-120,-230},{-100,-210}})));
  CDL.Routing.BooleanArrayFilter booleanArrayFilter14(
    nin=numZon,
    nout=nZonGro,
    fil=inZon)
    annotation (Placement(transformation(extent={{-120,-310},{-100,-290}})));
protected
  Buildings.Controls.OBC.CDL.Continuous.MultiMax cooDowTim(nin=nZonGro)
    "Longest cooldown time"
    annotation (Placement(transformation(extent={{40,170},{60,190}})));
  Buildings.Controls.OBC.CDL.Continuous.MultiMax warUpTim(nin=nZonGro)
    "Longest warm up time"
    annotation (Placement(transformation(extent={{40,130},{60,150}})));
  Buildings.Controls.OBC.CDL.Logical.MultiOr mulOr(nu=nZonGro)
    "Check if there is any zone that the zone temperature is lower than its occupied heating setpoint"
    annotation (Placement(transformation(extent={{40,90},{60,110}})));
  Buildings.Controls.OBC.CDL.Logical.MultiOr mulOr1(nu=nZonGro)
    "Check if there is any zone that the zone temperature is higher than its occupied cooling setpoint"
    annotation (Placement(transformation(extent={{40,50},{60,70}})));
  Buildings.Controls.OBC.CDL.Continuous.MultiMax maxTem(nin=nZonGro)
                       "Maximum zone temperature in the zone group"
    annotation (Placement(transformation(extent={{0,-230},{20,-210}})));
  Buildings.Controls.OBC.CDL.Continuous.MultiMin minTem(nin=nZonGro)
                       "Minimum zone temperature in the zone group"
    annotation (Placement(transformation(extent={{0,-270},{20,-250}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt[nZonGro]
    "Convert boolean to integer"
    annotation (Placement(transformation(extent={{-80,10},{-60,30}})));
  Buildings.Controls.OBC.CDL.Integers.MultiSum totColZon(
    final nin=nZonGro) "Total number of cold zone"
    annotation (Placement(transformation(extent={{40,10},{60,30}})));
  Buildings.Controls.OBC.CDL.Logical.MultiAnd endSetBac(nu=nZonGro)
    "Check if all zones have ended the setback mode"
    annotation (Placement(transformation(extent={{40,-70},{60,-50}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt1[nZonGro]
    "Convert boolean to integer"
    annotation (Placement(transformation(extent={{-80,-100},{-60,-80}})));
  Buildings.Controls.OBC.CDL.Integers.MultiSum totHotZon(
    final nin=nZonGro) "Total number of hot zones"
    annotation (Placement(transformation(extent={{40,-100},{60,-80}})));
  Buildings.Controls.OBC.CDL.Logical.MultiAnd endSetUp(nu=nZonGro)
    "Check if all zones have ended the setup mode"
    annotation (Placement(transformation(extent={{0,-190},{20,-170}})));
  Buildings.Controls.OBC.CDL.Continuous.MultiSum sumUnoHea(nin=nZonGro)
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant totZon(
    final k=nZonGro) "Total number of zones"
    annotation (Placement(transformation(extent={{-80,110},{-60,130}})));
  Buildings.Controls.OBC.CDL.Conversions.IntegerToReal intToRea "Convert integer to real"
    annotation (Placement(transformation(extent={{-40,110},{-20,130}})));
  Buildings.Controls.OBC.CDL.Continuous.MultiSum sumUnoCoo(nin=nZonGro)
    "Sum of all zones unoccupied cooling setpoint"
    annotation (Placement(transformation(extent={{-80,-160},{-60,-140}})));
  Buildings.Controls.OBC.CDL.Continuous.MultiSum sumTem(nin=nZonGro)
  ...
  Buildings.Controls.OBC.CDL.Continuous.MultiMin minToNexOcc(nin=nZonGro)
    "Minimum time to next occupied period"
    annotation (Placement(transformation(extent={{-60,210},{-40,230}})));
  Buildings.Controls.OBC.CDL.Logical.MultiOr schOcc(nu=nZonGro)
  ...
  Buildings.Controls.OBC.CDL.Logical.MultiOr oveRidOcc(nu=nZonGro)
  ...
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt2[nZonGro]
    "Convert boolean to integer"
...
equation
  ...
  connect(endSetUp.y, yEndSetUp)
    annotation (Line(points={{22,-180},{120,-180}}, color={255,0,255}));
  ...
  connect(zonOcc, booleanArrayFilter.u)
    annotation (Line(points={{-160,300},{-122,300}}, color={255,0,255}));
  connect(booleanArrayFilter.y, oveRidOcc.u)
    annotation (Line(points={{-98,300},{-62,300}}, color={255,0,255}));
  connect(uOcc, booleanArrayFilter1.u)
    annotation (Line(points={{-160,260},{-122,260}}, color={255,0,255}));
  connect(booleanArrayFilter1.y, schOcc.u)
    annotation (Line(points={{-98,260},{-62,260}}, color={255,0,255}));
  connect(tNexOcc, realArrayFilter.u)
    annotation (Line(points={{-160,220},{-122,220}}, color={0,0,127}));
  connect(realArrayFilter.y, minToNexOcc.u)
    annotation (Line(points={{-98,220},{-62,220}}, color={0,0,127}));
  connect(uCooTim, realArrayFilter1.u)
    annotation (Line(points={{-160,180},{-122,180}}, color={0,0,127}));
  connect(realArrayFilter1.y, cooDowTim.u)
    annotation (Line(points={{-98,180},{38,180}}, color={0,0,127}));
  connect(uWarTim, realArrayFilter2.u)
    annotation (Line(points={{-160,140},{-122,140}}, color={0,0,127}));
  connect(realArrayFilter2.y, warUpTim.u)
    annotation (Line(points={{-98,140},{38,140}}, color={0,0,127}));
  connect(uOccHeaHig, booleanArrayFilter5.u)
    annotation (Line(points={{-160,100},{-122,100}}, color={255,0,255}));
  connect(booleanArrayFilter5.y, mulOr.u)
    annotation (Line(points={{-98,100},{38,100}}, color={255,0,255}));
  connect(uHigOccCoo, booleanArrayFilter6.u)
    annotation (Line(points={{-160,60},{-122,60}}, color={255,0,255}));
  connect(booleanArrayFilter6.y, mulOr1.u)
    annotation (Line(points={{-98,60},{38,60}}, color={255,0,255}));
  connect(uUnoHeaHig, booleanArrayFilter7.u)
    annotation (Line(points={{-160,20},{-122,20}}, color={255,0,255}));
  connect(booleanArrayFilter7.y, booToInt.u)
    annotation (Line(points={{-98,20},{-82,20}}, color={255,0,255}));
  connect(THeaSetOff, realArrayFilter3.u)
    annotation (Line(points={{-160,-20},{-122,-20}}, color={0,0,127}));
  connect(realArrayFilter3.y, sumUnoHea.u)
    annotation (Line(points={{-98,-20},{-82,-20}}, color={0,0,127}));
  connect(uEndSetBac, booleanArrayFilter9.u)
    annotation (Line(points={{-160,-60},{-122,-60}}, color={255,0,255}));
  connect(booleanArrayFilter9.y, endSetBac.u)
    annotation (Line(points={{-98,-60},{38,-60}}, color={255,0,255}));
  connect(uHigUnoCoo, booleanArrayFilter10.u)
    annotation (Line(points={{-160,-90},{-122,-90}}, color={255,0,255}));
  connect(booleanArrayFilter10.y, booToInt1.u)
    annotation (Line(points={{-98,-90},{-82,-90}}, color={255,0,255}));
  connect(TCooSetOff, realArrayFilter4.u)
    annotation (Line(points={{-160,-150},{-122,-150}}, color={0,0,127}));
  connect(realArrayFilter4.y, sumUnoCoo.u)
    annotation (Line(points={{-98,-150},{-82,-150}}, color={0,0,127}));
  connect(uEndSetUp, booleanArrayFilter12.u)
    annotation (Line(points={{-160,-180},{-122,-180}}, color={255,0,255}));
  connect(booleanArrayFilter12.y, endSetUp.u)
    annotation (Line(points={{-98,-180},{-2,-180}}, color={255,0,255}));
  connect(TZon, realArrayFilter5.u)
    annotation (Line(points={{-160,-220},{-122,-220}}, color={0,0,127}));
  connect(realArrayFilter5.y, sumTem.u) annotation (Line(points={{-98,-220},{-90,
          -220},{-90,-200},{-82,-200}}, color={0,0,127}));
  connect(realArrayFilter5.y, maxTem.u)
    annotation (Line(points={{-98,-220},{-2,-220}}, color={0,0,127}));
  connect(realArrayFilter5.y, minTem.u) annotation (Line(points={{-98,-220},{-90,
          -220},{-90,-260},{-2,-260}}, color={0,0,127}));
  connect(uWin, booleanArrayFilter14.u)
    annotation (Line(points={{-160,-300},{-122,-300}}, color={255,0,255}));
  connect(booleanArrayFilter14.y, booToInt2.u)
    annotation (Line(points={{-98,-300},{-62,-300}}, color={255,0,255}));
annotation (
