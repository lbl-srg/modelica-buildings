...
model GroupStatus
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant warUpTim[3](final k={1800,
        1700,1900})      "Warm-up time"
    annotation (Placement(transformation(extent={{-98,-28},{-78,-8}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant cooDowTim[3](final k={1600,
        1700,1800})      "Cooling down time"
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant uOccOve[3](final k=fill(false,
        3))
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse zonOcc1(
    final width=0.8,
    final period=7200,
    shift=1800)           "Zone 1 occupied status"
 ...
 Buildings.Controls.OBC.CDL.Logical.Sources.Pulse zonOcc3(
  ...
  Buildings.Controls.OBC.CDL.Continuous.AddParameter addPar1(final p=1800,
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse lowOccHea[3](
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
      origin={-128,-38})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant higOccCoo[3](final k=fill(
         false, 3))
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse lowUnoHea1[3](final width=
        fill(0.1, 3), final period=fill(3600, 3))
                                "Lower than unoccupied heating setpoint"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}}, origin={-128,-78})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant heaSetOff[3](final k={285.15,
        282.15,283.15})
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse endSetBac[3](
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}}, origin={-128,
            -118})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant higUnoCoo[3](final k=fill(
         false, 3))
    "HIgher than unoccupied cooling setpoint"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}}, origin={-88,-138})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant cooSetOff[3](final k={303.15,
        304.15,305.15})
    "Unoccupied cooling setpoint"
    annotation (Placement(transformation(extent={{-138,-168},{-118,-148}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant endSetUp[3](final k=fill(false,
        3))
    "End setup mode"
  ...
  CDL.Continuous.Sources.Constant                     zonTem2(k=273.15 + 20)
    "Zone 2 temperature"
    annotation (Placement(transformation(extent={{-118,-258},{-98,-238}})));
 CDL.Logical.Sources.Constant                     zonOcc2(k=true)
  ...
  CDL.Continuous.Sources.Constant tNexOcc2(k=0) "Zone 2 next occupancy time"
...
equation
  ...
  connect(lowOccHea.y, and2.u1)
    annotation (Line(points={{-116,-38},{-20,-38}},
                                                  color={255,0,255}));
