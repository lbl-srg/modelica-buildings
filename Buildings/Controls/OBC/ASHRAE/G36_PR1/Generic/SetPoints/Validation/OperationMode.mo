...
equation
  ...
  connect(occHeaSet.y, opeModSel.TOccZonHeaSet) annotation (Line(points={{-39,-30},
          {-20,-30},{-20,-12},{34,-12},{34,-2.2},{71,-2.2}}, color={0,0,127}));
  connect(occCooSet.y, opeModSel.TOccZonCooSet) annotation (Line(points={{21,-30},
          {36,-30},{36,-4.6},{71,-4.6}}, color={0,0,127}));
  connect(unoHeaSet.y, opeModSel.TUnoZonHeaSet) annotation (Line(points={{-39,-70},
          {-20,-70},{-20,-48},{38,-48},{38,-6.8},{71,-6.8}}, color={0,0,127}));
  connect(unoCooSet.y, opeModSel.TUnoZonCooSet) annotation (Line(points={{21,-70},
