...
block OperationModeNew "Block that outputs the operation mode"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput occHeaHig
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput HigOccCoo
...
equation
  ...
  connect(HigOccCoo, and2.u2) annotation (Line(points={{-280,80},{-120,80},{-120,
  ...
  connect(occHeaHig, and5.u2) annotation (Line(points={{-280,110},{38,110},{38,142},
          {46,142}}, color={255,0,255}));
