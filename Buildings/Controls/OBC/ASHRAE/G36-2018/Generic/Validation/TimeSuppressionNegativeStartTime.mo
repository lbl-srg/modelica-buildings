...
annotation (experiment(
      ...
      StopTime=7200,
      Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/Generic/Validation/TimeSuppressionNegativeStartTime.mos"
    "Simulate and plot"),
