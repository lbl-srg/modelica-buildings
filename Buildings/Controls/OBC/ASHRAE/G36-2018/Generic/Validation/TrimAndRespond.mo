within Buildings.Controls.OBC.ASHRAE.G36-2018.Generic.Validation;
model TrimAndRespond "Model validates the trim and respond block"
  Buildings.Controls.OBC.ASHRAE.G36-2018.Generic.TrimAndRespond trimRespondLogic(
    final iniSet=120,
    final minSet=37,
    final maxSet=370,
    final delTim=300,
  ...
  Buildings.Controls.OBC.ASHRAE.G36-2018.Generic.TrimAndRespond trimRespondLogic1(
    final iniSet=120,
    final minSet=37,
    final maxSet=370,
    final delTim=300,
  ...
  Buildings.Controls.OBC.ASHRAE.G36-2018.Generic.TrimAndRespond trimRespondLogic2(
    final iniSet=120,
    final minSet=37,
    final maxSet=370,
    final delTim=300,
  ...
  Buildings.Controls.OBC.ASHRAE.G36-2018.Generic.TrimAndRespond trimRespondLogicHold(
    have_hol=true,
    final iniSet=120,
    final minSet=37,
    final maxSet=370,
...
annotation (experiment(StopTime=7200.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/Generic/Validation/TrimAndRespond.mos"
    "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36-2018.Generic.TrimAndRespond\">
Buildings.Controls.OBC.ASHRAE.G36-2018.Generic.TrimAndRespond</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
