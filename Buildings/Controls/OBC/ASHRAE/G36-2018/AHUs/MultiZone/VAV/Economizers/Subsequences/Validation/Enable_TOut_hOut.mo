within Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.MultiZone.VAV.Economizers.Subsequences.Validation;
model Enable_TOut_hOut
  ...
  Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.MultiZone.VAV.Economizers.Subsequences.Enable enaDis1
    "Multi zone VAV AHU economizer enable disable sequence"
    annotation (Placement(transformation(extent={{80,-44},{100,-16}})));
  Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.MultiZone.VAV.Economizers.Subsequences.Enable enaDis2(
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/AHUs/MultiZone/VAV/Economizers/Subsequences/Validation/Enable_TOut_hOut.mos"
    "Simulate and plot"),
  Icon(graphics={
        Ellipse(
          lineColor={75,138,73},
