...
model SeparateWithDP
  ...
  Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithDP disMinCon(
  ...
  Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithDP disMinCon1(
    final venStd=Buildings.Controls.OBC.ASHRAE.G36-2018.Types.VentilationStandard.ASHRAE62_1,
    final dpDesMinOutDam=300,
    final minSpe=0.1)
  ...
  Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits.SeparateWithDP minCon(
    final venStd=Buildings.Controls.OBC.ASHRAE.G36-2018.Types.VentilationStandard.ASHRAE62_1,
    final dpDesMinOutDam=300,
    final minSpe=0.1)
...
annotation (experiment(StopTime=1800.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/AHUs/MultiZone/VAV/Economizers/Subsequences/Limits/Validation/SeparateWithDP.mos"
    "Simulate and plot"),
