...
model PlantRequests
  ...
  Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.MultiZone.VAV.SetPoints.PlantRequests plaReq
    "Calculate plant request"
    annotation (Placement(transformation(extent={{60,50},{80,70}})));
  Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.MultiZone.VAV.SetPoints.PlantRequests plaReq1(
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/AHUs/MultiZone/VAV/SetPoints/Validation/PlantRequests.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.MultiZone.VAV.SetPoints.PlantRequests\">
Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.MultiZone.VAV.SetPoints.PlantRequests</a>
