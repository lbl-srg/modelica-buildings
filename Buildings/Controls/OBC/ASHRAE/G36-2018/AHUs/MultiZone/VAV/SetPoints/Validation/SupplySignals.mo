...
model SupplySignals
  ...
  Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.MultiZone.VAV.SetPoints.SupplySignals supSig1
    "Output valve position and supply air temperature control loop signal"
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/AHUs/MultiZone/VAV/SetPoints/Validation/SupplySignals.mos"
        "Simulate and plot"),
