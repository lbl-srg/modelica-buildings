within Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits;
block SeparateWithDP
  ...
  parameter Boolean have_CO2Sen=false
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(enable=venStd==Buildings.Controls.OBC.ASHRAE.G36-2018.Types.VentilationStandard.California_Title_24));
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uCO2Loo_max(final unit="1")
    if have_CO2Sen and venStd == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.VentilationStandard.California_Title_24
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput VOutMinSet_flow_normalized(
    final unit="1")
    if venStd == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.VentilationStandard.ASHRAE62_1
  ...
  Buildings.Controls.OBC.CDL.Reals.Multiply minDp if venStd == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.VentilationStandard.ASHRAE62_1
...
protected
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant one2(
    final k=1)
    if not have_CO2Sen and venStd == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.VentilationStandard.California_Title_24
    "Design fan speed"
...
annotation (
  ...
  Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
        ...
        Text(
          ...
          textColor={0,0,127},
          pattern=LinePattern.Dash,
          visible=have_CO2Sen and venStd == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.VentilationStandard.California_Title_24,
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.ASHRAE62_1.AHU\">
Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.ASHRAE62_1.AHU</a>
if complying with ASHRAE 62.1 requirements. Otherwise, see the set points in
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.AHU\">
Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.Title24.AHU</a>
