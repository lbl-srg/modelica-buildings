...
model Enable_FreProSta
  ...
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger freProSta1(
    integerTrue=Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeProtectionStages.stage0,
    integerFalse=Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeProtectionStages.stage1)
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/AHUs/MultiZone/VAV/Economizers/Subsequences/Validation/Enable_FreProSta.mos"
    "Simulate and plot"),
  Icon(graphics={
        Ellipse(
          lineColor={75,138,73},
