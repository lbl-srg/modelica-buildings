...
model SupplyTemperature "Validation model for supply temperature"
  ...
  Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.SingleZone.VAV.SetPoints.SupplyTemperature temSet(
...
equation
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/AHUs/SingleZone/VAV/SetPoints/Validation/SupplyTemperature.mos"
        "Simulate and plot"),
