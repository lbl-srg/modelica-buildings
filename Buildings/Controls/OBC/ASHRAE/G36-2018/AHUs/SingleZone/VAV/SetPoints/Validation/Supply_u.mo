...
model Supply_u "Validation model for temperature and fan speed"
  ...
  Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.SingleZone.VAV.SetPoints.Supply
    setPoiVAV(
    final maxHeaSpe=0.7,
    final maxCooSpe=1,
    final minSpe=0.3,
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/AHUs/SingleZone/VAV/SetPoints/Validation/Supply_u.mos"
        "Simulate and plot"),
