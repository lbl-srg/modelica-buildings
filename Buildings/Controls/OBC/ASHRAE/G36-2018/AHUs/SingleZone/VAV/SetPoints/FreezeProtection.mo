within Buildings.Controls.OBC.ASHRAE.G36-2018.AHUs.SingleZone.VAV.SetPoints;
block FreezeProtection
  ...
  parameter Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl buiPreCon=
      Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReliefDamper
    "Type of building pressure control system"
    annotation (__cdl(ValueInReference=false), Dialog(enable=have_frePro));
  parameter Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat freSta=Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.No_freeze_stat
    "Type of freeze stat"
    annotation (__cdl(ValueInReference=false), Dialog(enable=have_frePro));
  parameter Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil heaCoi=Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil.WaterBased
    "Heating coil type"
    annotation (__cdl(ValueInReference=false), Dialog(enable=have_frePro));
  parameter Integer minHotWatReq=2
    "Minimum heating hot-water plant request to active the heating plant"
    annotation (__cdl(ValueInReference=true),
                Dialog(enable=heaCoi==Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil.WaterBased and have_frePro));
  parameter Buildings.Controls.OBC.CDL.Types.SimpleController heaCoiCon=
    Buildings.Controls.OBC.CDL.Types.SimpleController.PI
    "Heating coil controller"
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Heating coil controller", enable=heaCoi==Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil.WaterBased and have_frePro));
  ...
  parameter Real Ti(unit="s")=0.5
    ...
    annotation (__cdl(ValueInReference=false),
                Dialog(group="Heating coil controller",
                       enable=heaCoi==Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil.WaterBased and have_frePro and
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uHeaCoi(
    final min=0,
    final max=1,
    final unit="1") if heaCoi==Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil.WaterBased "Heating coil valve commanded position"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1FreSta if freSta ==
    Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_BAS and
    have_frePro
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1SofSwiRes if (freSta ==
    Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.No_freeze_stat or freSta ==
    Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_equipment)
     and have_frePro
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1RetFan if (buiPreCon ==
    Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReturnFanDp)
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uRetFan(
    final min=0,
    final max=1,
    final unit="1") if (buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReturnFanDp)
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput u1RelFan if buiPreCon ==
    Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReliefFan
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uRelFan(
    final min=0,
    final max=1,
    final unit="1") if (buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReliefFan)
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TAirMix(
    final unit="K",
    final displayUnit="degC",
    final quantity="ThermodynamicTemperature") if heaCoi==Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil.WaterBased and
    have_frePro
  ...
  Buildings.Controls.OBC.CDL.Interfaces.IntegerOutput yHotWatPlaReq
    if heaCoi==Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil.WaterBased
...
protected
  ...
  Buildings.Controls.OBC.CDL.Integers.Switch hotWatPlaReq
    if heaCoi==Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil.WaterBased and have_frePro
    "Hot water plant request in stage 1 mode"
    annotation (Placement(transformation(extent={{60,652},{80,672}})));
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant conInt(
    final k=minHotWatReq) if heaCoi==Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil.WaterBased and have_frePro
  ...
  Buildings.Controls.OBC.CDL.Reals.PID heaCoiCon1(
    ...
    final Td=Td,
    final yMax=yMax,
    final yMin=yMin) if heaCoi==Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil.WaterBased and have_frePro
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant conInt2(
    final k=0) if heaCoi==Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil.WaterBased and have_frePro
    "Zero request"
  ...
  Buildings.Controls.OBC.CDL.Reals.Switch retFan if (buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReturnFanDp)
     and not freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Return fan speed"
    annotation (Placement(transformation(extent={{120,-270},{140,-250}})));
  Buildings.Controls.OBC.CDL.Reals.Switch relFan if (buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReliefFan)
     and not freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Relief fan speed"
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant con4(
    final k=273.15 + 27) if heaCoi==Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil.WaterBased and have_frePro
    "Setpoint temperature"
    annotation (Placement(transformation(extent={{-140,-530},{-120,-510}})));
  Buildings.Controls.OBC.CDL.Reals.Switch heaCoiPos if heaCoi==Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil.WaterBased and
    not freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Heating coil position"
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant supTemSet(
    final k=273.15+ 6) if heaCoi==Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil.WaterBased and have_frePro
  ...
  Buildings.Controls.OBC.CDL.Logical.FallingEdge falEdg1 if freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_BAS
     and have_frePro
    "Reset the freeze protection by the physical reset switch in freeze stat"
    annotation (Placement(transformation(extent={{-220,40},{-200,60}})));
  Buildings.Controls.OBC.CDL.Logical.Not norFal if freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_BAS
     and have_frePro
    "The output is normally false"
    annotation (Placement(transformation(extent={{-360,40},{-340,60}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant con2(
    final k=false) if not freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_BAS
     and have_frePro
    "Constant false"
    annotation (Placement(transformation(extent={{-320,-10},{-300,10}})));
  Buildings.Controls.OBC.CDL.Logical.Not norSta1 if buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReliefFan
     and have_frePro
    "Not in stage 3"
    annotation (Placement(transformation(extent={{120,-350},{140,-330}})));
  Buildings.Controls.OBC.CDL.Logical.And and2 if (buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReliefFan)
     and not freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Disable relief fan when in stage 3"
    annotation (Placement(transformation(extent={{320,-330},{340,-310}})));
  Buildings.Controls.OBC.CDL.Logical.And and1 if (buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReturnFanDp)
     and not freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Disable return fan when in stage 3"
    annotation (Placement(transformation(extent={{320,-210},{340,-190}})));
  Buildings.Controls.OBC.CDL.Logical.Not norSta2 if (buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReturnFanDp)
     and have_frePro
    "Not in stage 3"
  ...
  Buildings.Controls.OBC.CDL.Logical.And and3 if not freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
 ...
 if freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
 ...
 if freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_equipment
  ...
  Buildings.Controls.OBC.CDL.Logical.Or or1 if freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_equipment
     or not have_frePro
 ...
 if freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_equipment
  ...
  Buildings.Controls.OBC.CDL.Logical.Or or4 if (buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReturnFanDp)
     and (freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_equipment
     or not have_frePro)
    "Dummy block for enabling and disabling conditional connection"
  ...
  Buildings.Controls.OBC.CDL.Reals.MultiplyByParameter gai3(final k=1) if (
    buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReturnFanMeasuredAir
     or buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReturnFanDp)
     and freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Dummy block for enabling and disabling the conditional connection"
    annotation (Placement(transformation(extent={{120,-300},{140,-280}})));
  Buildings.Controls.OBC.CDL.Logical.Or or5 if (buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReliefFan)
     and (freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_equipment
     or not have_frePro)
    "Dummy block for enabling and disabling conditional connection"
  ...
  Buildings.Controls.OBC.CDL.Reals.MultiplyByParameter gai5(final k=1) if (
    buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReliefFan)
     and freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_equipment
     and have_frePro
    "Dummy block for enabling and disabling the conditional connection"
 ...
 if heaCoi==Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil.WaterBased and (freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_equipment
     or not have_frePro)
    "Dummy block for enabling and disabling the conditional connection"
...
annotation (defaultComponentName="sinAHUFrePro",
  Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-200},{100,200}}),
        ...
        Text(
          ...
          textColor={255,0,255},
          textString="u1FreSta",
          visible=freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_BAS
               and have_frePro),
        Text(
        ...
        Text(
          ...
          textColor={0,0,127},
          textString="uHeaCoi",
          visible=heaCoi==Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil.WaterBased),
        Text(
        ...
        Text(
          ...
          textColor={0,0,127},
          visible=buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReliefFan,
          textString="uRelFan"),
        Text(
          extent={{-100,-70},{-50,-86}},
          textColor={0,0,127},
          visible=(buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReturnFanMeasuredAir
               or buiPreCon == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.PressureControl.ReturnFanDp),
          textString="uRetFan"),
        Text(
          extent={{-98,-20},{-50,-36}},
        ...
        Text(
          ...
          textColor={0,0,127},
          visible=heaCoi==Buildings.Controls.OBC.ASHRAE.G36-2018.Types.HeatingCoil.WaterBased and have_frePro,
          textString="TAirMix"),
        Text(
        ...
        Text(
          extent={{-94,32},{-32,8}},
          textColor={255,0,255},
          visible=(freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.No_freeze_stat
               or freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.Hardwired_to_equipment)
               and have_frePro,
        ...
        Text(
          extent={{-96,2},{-54,-18}},
          textColor={255,0,255},
          visible=not freSta == Buildings.Controls.OBC.ASHRAE.G36-2018.Types.FreezeStat.No_freeze_stat,
          textString="u1SupFan"),
        Text(
          extent={{-96,-48},{-54,-68}},
          textColor={255,0,255},
