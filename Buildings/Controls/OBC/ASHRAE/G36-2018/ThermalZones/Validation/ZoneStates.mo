...
annotation (experiment(StopTime=3, Interval=300, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/ThermalZones/Validation/ZoneStates.mos"
    "Simulate and plot"),
...
Buildings.Controls.OBC.ASHRAE.G36-2018.ThermalZones.ZoneStates</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
