...
model Setpoints "Validate block for zone set point"
  ...
  Buildings.Controls.OBC.ASHRAE.G36-2018.ThermalZones.Setpoints TZonSet(
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/ThermalZones/Validation/Setpoints.mos"
        "Simulate and plot"),
