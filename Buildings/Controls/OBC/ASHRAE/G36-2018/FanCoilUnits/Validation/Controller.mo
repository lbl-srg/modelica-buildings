within Buildings.Controls.OBC.ASHRAE.G36-2018.FanCoilUnits.Validation;
model Controller
    "Validation of the top-level controller"

  Buildings.Controls.OBC.ASHRAE.G36-2018.FanCoilUnits.Controller conFCU(
...
annotation (experiment(StopTime=86400, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/FanCoilUnits/Validation/Controller.mos"
    "Simulate and plot"),
