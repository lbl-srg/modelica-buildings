within Buildings.Controls.OBC.ASHRAE.G36-2018.FanCoilUnits.Subsequences.Validation;
model PlantRequests
  "Validation model for subsequence for calculating the plant requests"

  Buildings.Controls.OBC.ASHRAE.G36-2018.FanCoilUnits.Subsequences.PlantRequests plaReq
    "Calculate plant request"
    annotation (Placement(transformation(extent={{60,50},{80,70}})));

  Buildings.Controls.OBC.ASHRAE.G36-2018.FanCoilUnits.Subsequences.PlantRequests plaReq1(
    have_hotWatCoi=false)
    "Calculate plant request"
    annotation (Placement(transformation(extent={{60,-80},{80,-60}})));

  Buildings.Controls.OBC.ASHRAE.G36-2018.FanCoilUnits.Subsequences.PlantRequests plaReq2(
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/FanCoilUnits/Subsequences/Validation/PlantRequests.mos"
        "Simulate and plot"),
