within Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.SeriesFanCVF.Subsequences.Validation;
model SystemRequests
  "Validation of model that generates system requests"

  Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.SeriesFanCVF.Subsequences.SystemRequests sysReq(
    final floHys=0.01,
    final looHys=0.01,
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/TerminalUnits/SeriesFanCVF/Subsequences/Validation/SystemRequests.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.SeriesFanCVF.Subsequences.SystemRequests\">
