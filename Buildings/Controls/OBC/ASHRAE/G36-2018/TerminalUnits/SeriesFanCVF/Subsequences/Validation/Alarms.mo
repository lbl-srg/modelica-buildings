...
model Alarms "Validation of model that generates alarms"
  ...
  Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.SeriesFanCVF.Subsequences.Alarms ala(
    final staPreMul=1,
    final hotWatRes=1,
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/TerminalUnits/SeriesFanCVF/Subsequences/Validation/Alarms.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.SeriesFanCVF.Subsequences.Alarms\">
