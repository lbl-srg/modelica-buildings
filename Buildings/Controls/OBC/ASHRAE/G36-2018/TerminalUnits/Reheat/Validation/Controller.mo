within Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.Reheat.Validation;
model Controller
  "Validation of model that controls terminal unit with reheat"

  Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.Reheat.Controller rehBoxCon(
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/TerminalUnits/Reheat/Validation/Controller.mos"
        "Simulate and plot"),
