within Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.Reheat.Subsequences;
block ActiveAirFlow
...
protected
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant cooDowMod(
    final k=Buildings.Controls.OBC.ASHRAE.G36-2018.Types.OperationModes.coolDown)
    "Cool down mode"
    annotation (Placement(transformation(extent={{-160,80},{-140,100}})));
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant setUpMod(
    final k=Buildings.Controls.OBC.ASHRAE.G36-2018.Types.OperationModes.setUp)
    "Setup mode"
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant setBacMod(
    final k=Buildings.Controls.OBC.ASHRAE.G36-2018.Types.OperationModes.setBack)
    "Setback mode"
