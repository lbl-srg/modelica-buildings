within Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.Reheat.Subsequences.Validation;
model DamperValves
  "Validate model for controlling damper and valve position"

  Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.Reheat.Subsequences.DamperValves damValFan1(
  ...
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant VActCooMin_flow(
    final k=0.015) "Active cooling minimum flow"
    annotation (Placement(transformation(extent={{-60,120},{-40,140}})));
  Buildings.Controls.OBC.CDL.Reals.Sources.Constant VActHeaMin_flow(
    final k=0.015)
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/TerminalUnits/Reheat/Subsequences/Validation/DamperValves.mos"
        "Simulate and plot"),
  Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.Reheat.Subsequences.DamperValves\">
BBuildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.Reheat.Subsequences.DamperValves</a>
