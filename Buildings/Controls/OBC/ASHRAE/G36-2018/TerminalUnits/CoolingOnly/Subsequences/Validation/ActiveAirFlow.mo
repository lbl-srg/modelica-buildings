within Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.CoolingOnly.Subsequences.Validation;
model ActiveAirFlow
  "Validate the model for calculating active airflow setpoint for VAV cooling only unit"
  Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.CoolingOnly.Subsequences.ActiveAirFlow actAirSet(final
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/TerminalUnits/CoolingOnly/Subsequences/Validation/ActiveAirFlow.mos"
        "Simulate and plot"),
  Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.CoolingOnly.Subsequences.ActiveAirFlow\">
