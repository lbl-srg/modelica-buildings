...
model Overrides "Validation of model that overrides control"
  ...
  Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.DualDuctColdDuctMin.Subsequences.Overrides ove(
    final VMin_flow=0.1,
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/TerminalUnits/DualDuctColdDuctMin/Subsequences/Validation/Overrides.mos"
        "Simulate and plot"),
    Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.DualDuctColdDuctMin.Subsequences.Overrides\">
