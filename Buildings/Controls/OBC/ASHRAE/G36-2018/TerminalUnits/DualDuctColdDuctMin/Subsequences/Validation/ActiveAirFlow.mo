within Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.DualDuctColdDuctMin.Subsequences.Validation;
model ActiveAirFlow
  "Validate the model for calculating active airflow setpoint for dual-duct terminal unit with cold-duct minimum control"
  Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.DualDuctColdDuctMin.Subsequences.ActiveAirFlow actAirSet(
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/TerminalUnits/DualDuctColdDuctMin/Subsequences/Validation/ActiveAirFlow.mos"
        "Simulate and plot"),
  Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.G36-2018.TerminalUnits.DualDuctColdDuctMin.Subsequences.ActiveAirFlow\">
