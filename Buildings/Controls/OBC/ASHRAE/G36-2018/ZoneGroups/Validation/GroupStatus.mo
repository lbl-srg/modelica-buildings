within Buildings.Controls.OBC.ASHRAE.G36-2018.ZoneGroups.Validation;
model GroupStatus
  "Validate block for checking temperatures in the group"

  Buildings.Controls.OBC.ASHRAE.G36-2018.ZoneGroups.GroupStatus zonGroSta(
    final nBuiZon=3,
    final nGroZon=2,
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/ZoneGroups/Validation/GroupStatus.mos"
        "Simulate and plot"),
