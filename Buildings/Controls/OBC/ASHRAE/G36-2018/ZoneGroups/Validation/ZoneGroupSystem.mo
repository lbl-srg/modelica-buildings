...
model ZoneGroupSystem
  ...
  Buildings.Controls.OBC.ASHRAE.G36-2018.ZoneGroups.ZoneGroupSystem ahuMod(
    final nGro=3)
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/ZoneGroups/Validation/ZoneGroupSystem.mos"
        "Simulate and plot"),
