...
model ZoneStatus
  ...
  Buildings.Controls.OBC.ASHRAE.G36-2018.ZoneGroups.ZoneStatus noWinZonSta(
  ...
  Buildings.Controls.OBC.ASHRAE.G36-2018.ZoneGroups.ZoneStatus witWinZonSta(
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36-2018/ZoneGroups/Validation/ZoneStatus.mos"
        "Simulate and plot"),
