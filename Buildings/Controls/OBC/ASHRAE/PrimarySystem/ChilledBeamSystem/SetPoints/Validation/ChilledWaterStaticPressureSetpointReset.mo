...
model ChilledWaterStaticPressureSetpointReset
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeamSystem.SetPoints.ChilledWaterStaticPressureSetpointReset
    chiWatStaPreSetRes(
    final nVal=2)
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/ChilledBeamSystem/SetPoints/Validation/ChilledWaterStaticPressureSetpointReset.mos"
    "Simulate and plot"),
