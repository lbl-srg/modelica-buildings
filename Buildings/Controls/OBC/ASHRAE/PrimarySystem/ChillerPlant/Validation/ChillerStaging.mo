...
model ChillerStaging "Validate model of controlling chiller stage"
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.ChillerStaging upZerToOne(
    chiOnHou=5,
    chiOffHou=22,
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.ChillerStaging upOneToTwo(
    chiOffHou=22,
    chiOnHou=0,
    TLocChi=288.71)
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.ChillerStaging upOneToTwo1(
    chiOffHou=22,
    chiOnHou=0,
    TLocChi=288.71)
