...
model ChilledTRef "Validate model of calculate chiller LIFT"

  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.ChillerdTRef chillerdTRef_Sim(
    APPROACH_nominal=5,
    cooTowEff=21,
    dTRefMin=5,
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.ChillerdTRef chillerdTRef(
    APPROACH_nominal=5,
    cooTowEff=21,
    dTRefMin=5,
    use_simCoe=false,
...
annotation (
 experiment(StopTime=3600.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/ChillerPlant/Validation/ChilledTRef.mos"
    "Simulate and plot"),
