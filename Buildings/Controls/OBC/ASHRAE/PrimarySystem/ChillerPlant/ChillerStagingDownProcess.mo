...
block ChillerStagingDownProcess
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.DisableLatest disLat(
    final num=num)
    "Disable latest chiller"
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.DisableLatest disLat2(
    final num=num)
    "Disable latest chilled water isolation valve"
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.DisableLatest disLat3(
    final num=num)
    "Disable latest condenser water isolation valve"
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.DisableLatest disLat4(
    final num=num) "Disable latest condenser water pump"
