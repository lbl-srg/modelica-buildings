...
block ChilledWaterPump "Sequences to control chilled water pumps"
  ...
  parameter Modelica.SIunits.PressureDifference dpChiWatPum_norminal(
    final min=0)=100000 "Norminal chilled water pump differential pressure"
...
equation
  ...
  connect(chiWatFloRat.y, hysChiWatFloRat.u)
    annotation (Line(points={{-159,-80},{-142,-80}},
                                                  color={0,0,127}));
  connect(hysChiWatFloRat.y, not1.u)
    annotation (Line(points={{-119,-80},{-110,-80},{-110,-100},{-160,-100},{-160,
          -120},{-142,-120}},
                   color={255,0,255}));
  connect(uPla, pumSpe.u2) annotation (Line(points={{-240,120},{-200,120},{-200,
          60},{-100,60},{-100,20},{-82,20}}, color={255,0,255}));
  ...
  connect(con.y, logSwi.u3)
    annotation (Line(points={{1,-120},{10,-120},{10,-88},{18,-88}},
      color={255,0,255}));
  connect(zerPum.y, pumSpe.u3) annotation (Line(points={{-119,-20},{-100,-20},{-100,
          12},{-82,12}}, color={0,0,127}));

  connect(conPID.y, pumSpe.u1) annotation (Line(points={{-139,20},{-120,20},{-120,
  ...
  connect(dpSetNor.y, conPID.u_s)
    annotation (Line(points={{-179,20},{-162,20}},
                                                 color={0,0,127}));
  connect(dpChiWatPum, dpNor.u)
    annotation (Line(points={{-240,-20},{-202,-20}}, color={0,0,127}));
  connect(dpNor.y, conPID.u_m)
    annotation (Line(points={{-179,-20},{-150,-20},{-150,8}},
                                                            color={0,0,127}));
  connect(uPla, conPID.trigger) annotation (Line(points={{-240,120},{-200,120},{
          -200,60},{-170,60},{-170,0},{-158,0},{-158,8}},
                                    color={255,0,255}));
  connect(booRep.y[1], swi2.u2)
    annotation (Line(points={{41,90},{58,90}}, color={255,0,255}));
  connect(swiLeaLag.y, swi2.u1) annotation (Line(points={{41,120},{50,120},{50,98},
          {58,98}}, color={0,0,127}));
  connect(iniLeaLag.y, swi2.u3) annotation (Line(points={{41,60},{50,60},{50,82},
          {58,82}}, color={0,0,127}));
  connect(swi2.y, pro.u1) annotation (Line(points={{81,90},{100,90},{100,96},{118,
          96}}, color={0,0,127}));
  ...
  connect(add2.y, add1.u2) annotation (Line(points={{81,10},{100,10},{100,4},{118,
          4}}, color={0,0,127}));
  connect(add1.y, swi3.u1) annotation (Line(points={{141,10},{150,10},{150,-2},{
          178,-2}}, color={0,0,127}));
  connect(logSwi.y, booRep1.u)
    annotation (Line(points={{41,-80},{78,-80}}, color={255,0,255}));
  connect(booRep1.y, swi3.u2) annotation (Line(points={{101,-80},{120,-80},{120,
          -10},{178,-10}}, color={255,0,255}));
  ...
  connect(shuLagPum.y, latLagPum.u0) annotation (Line(points={{-79,-120},{-38,-120},
          {-38,-86},{-21,-86}}, color={255,0,255}));
  connect(uPla, timLeaPum.u)
    annotation (Line(points={{-240,120},{-182,120}}, color={255,0,255}));
  connect(timLeaPum.y, mod.u1) annotation (Line(points={{-159,120},{-150,120},{-150,
          96},{-142,96}}, color={0,0,127}));
  connect(swiInt.y, mod.u2) annotation (Line(points={{-159,90},{-150,90},{-150,84},
          {-142,84}}, color={0,0,127}));
  connect(mod.y, lesEquThr.u) annotation (Line(points={{-119,90.2},{-114.5,90.2},
          {-114.5,90},{-102,90}}, color={0,0,127}));
  connect(timLeaPum.y, greEquThr.u)
    annotation (Line(points={{-159,120},{-102,120}}, color={0,0,127}));
  connect(lesEquThr.y, and2.u2) annotation (Line(points={{-79,90},{-70,90},{-70,
          112},{-62,112}}, color={255,0,255}));
  connect(greEquThr.y, and2.u1)
    annotation (Line(points={{-79,120},{-62,120}}, color={255,0,255}));
  connect(and2.y, tog.u) annotation (Line(points={{-39,120},{-30,120},{-30,110},
          {-21,110}}, color={255,0,255}));
  connect(tog.y, booRep.u) annotation (Line(points={{1,110},{10,110},{10,90},{18,
          90}}, color={255,0,255}));
  connect(con1.y, tog.u0) annotation (Line(points={{-39,90},{-30,90},{-30,104},{
          -21,104}}, color={255,0,255}));
  connect(reaRep.y, pro.u2) annotation (Line(points={{-19,20},{0,20},{0,40},{100,
          40},{100,84},{118,84}}, color={0,0,127}));
  connect(pro.y, add2.u1) annotation (Line(points={{141,90},{160,90},{160,36},{20,
          36},{20,16},{58,16}}, color={0,0,127}));
  connect(pro.y, add1.u1) annotation (Line(points={{141,90},{160,90},{160,36},{100,
          36},{100,16},{118,16}}, color={0,0,127}));
  connect(pro.y, swi3.u3) annotation (Line(points={{141,90},{160,90},{160,-18},{
          178,-18}}, color={0,0,127}));
  connect(uPla, logSwi.u2) annotation (Line(points={{-240,120},{-200,120},{-200,
          60},{-4,60},{-4,-60},{10,-60},{10,-80},{18,-80}}, color={255,0,255}));
annotation (
