...
equation
  ...
  connect(not1.y,enaChi. u2)
    annotation (Line(points={{-79,200},{-60,200},{-60,100},{-42,100}},
      color={255,0,255}));
  connect(not1.y, staUpMinFlo.uStaUp)
    annotation (Line(points={{-79,200},{68,200},{68,189},{119,189}},
      color={255,0,255}));
  connect(not2.y, staUpMinFlo.uUpsDevSta)
    annotation (Line(points={{-79,170},{72,170},{72,186},{119,186}},
      color={255,0,255}));
  ...
  connect(not2.y, staDowMinFlo.uUpsDevSta)
    annotation (Line(points={{-79,170},{72,170},{72,-154},{119,-154}},
      color={255,0,255}));
  connect(not1.y, staDowMinFlo.uStaDow)
    annotation (Line(points={{-79,200},{68,200},{68,-169},{119,-169}},
      color={255,0,255}));
  connect(not1.y, onOffStaUpMinFlo.uStaUp)
    annotation (Line(points={{-79,200},{68,200},{68,9},{119,9}},
      color={255,0,255}));
  ...
  connect(con1.y, disChi.u1)
    annotation (Line(points={{-119,-100},{-100,-100},{-100,-112},{-42,-112}},
      color={0,0,127}));
  connect(zer.y, enaChi.u3)
    annotation (Line(points={{-119,-180},{-64,-180},{-64,92},{-42,92}},
      color={0,0,127}));
  connect(zer.y, disChi.u3)
    annotation (Line(points={{-119,-180},{-64,-180},{-64,-128},{-42,-128}},
      color={0,0,127}));
  connect(enaChi.y, reaToInt.u)
    annotation (Line(points={{-19,100},{-2,100}}, color={0,0,127}));
