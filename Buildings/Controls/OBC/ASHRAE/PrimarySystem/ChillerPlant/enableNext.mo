...
block enableNext "Sequence to enable next device"
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant conInt1(k=num)
  ...
  Buildings.Controls.OBC.CDL.Integers.MultiSum mulSumInt(nin=num)
  ...
  Buildings.Controls.OBC.CDL.Routing.BooleanReplicator booRep(nout=num) if
       num==2
  ...
  Buildings.Controls.OBC.CDL.Logical.MultiAnd mulAnd1(nu=num) if num==3
  ...
  Buildings.Controls.OBC.CDL.Logical.MultiAnd mulAnd2(nu=num) if num==3
  ...
  Buildings.Controls.OBC.CDL.Routing.BooleanReplicator booRep5(nout=num) if num==3
    "Replicate boolean input"
    annotation (Placement(transformation(extent={{80,30},{100,50}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant con10[num](
    k={true,true,true}) if num==3
    "Logical constant"
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant con14(k=true)
    "Logical constant"
    annotation (Placement(transformation(extent={{-140,230},{-120,250}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant con15(k=false)
    "Logical constant"
...
equation
  ...
  connect(con7.y, logSwi1.u1) annotation (Line(points={{101,120},{140,120},{140,
          98},{158,98}},     color={255,0,255}));
  connect(booRep2.y, logSwi1.u2)
    annotation (Line(points={{101,90},{158,90}},     color={255,0,255}));
  connect(oneOpeDev.y, and3.u2) annotation (Line(points={{-59,90},{-40,90},{-40,
  ...
  connect(not2.y, and4.u2) annotation (Line(points={{-159,-30},{-140,-30},{-140,
          -38},{-102,-38}},
                       color={255,0,255}));
  connect(con8.y, and7.u2) annotation (Line(points={{-199,-30},{-190,-30},{-190,
          -8},{-102,-8}},    color={255,0,255}));
  connect(con9.y, and8.u2) annotation (Line(points={{-199,-120},{-190,-120},{-190,
          -98},{-102,-98}},  color={255,0,255}));
  connect(not3.y, and5.u2) annotation (Line(points={{-159,-120},{-140,-120},{-140,
          -128},{-102,-128}},
                       color={255,0,255}));
  connect(and7.y, or2.u1) annotation (Line(points={{-79,0},{-70,0},{-70,-20},{-62,
          -20}},       color={255,0,255}));
  connect(and4.y, or2.u2) annotation (Line(points={{-79,-30},{-70,-30},{-70,-28},
          {-62,-28}},  color={255,0,255}));
  connect(and8.y, or1.u1) annotation (Line(points={{-79,-90},{-70,-90},{-70,-110},
          {-62,-110}}, color={255,0,255}));
  connect(and5.y, or1.u2) annotation (Line(points={{-79,-120},{-70,-120},{-70,-118},
          {-62,-118}}, color={255,0,255}));
  connect(or2.y, mulAnd1.u) annotation (Line(points={{-39,-20},{-22,-20}},
                                     color={255,0,255}));
  connect(or1.y, mulAnd2.u) annotation (Line(points={{-39,-110},{-22,-110}},
                                     color={255,0,255}));
  connect(con11.y, logSwi2.u1) annotation (Line(points={{81,0},{88,0},{88,-12},{
  ...
  connect(con12.y, logSwi3.u1) annotation (Line(points={{81,-90},{88,-90},{88,-102},
          {98,-102}},       color={255,0,255}));
  connect(logSwi3.y, logSwi2.u3) annotation (Line(points={{121,-110},{130,-110},
          {130,-80},{90,-80},{90,-28},{98,-28}},     color={255,0,255}));
  connect(uDevSta, and7.u1) annotation (Line(points={{-280,160},{-240,160},{-240,
          10},{-130,10},{-130,0},{-102,0}}, color={255,0,255}));
  connect(uDevSta, and8.u1) annotation (Line(points={{-280,160},{-240,160},{-240,
          10},{-130,10},{-130,-90},{-102,-90}}, color={255,0,255}));
  connect(con13.y, logSwi3.u3) annotation (Line(points={{81,-130},{90,-130},{90,
          -118},{98,-118}}, color={255,0,255}));
  ...
  connect(logSwi2.y, logSwi4.u1) annotation (Line(points={{121,-20},{130,-20},{130,
          48},{158,48}},          color={255,0,255}));
  connect(logSwi4.y, logSwi1.u3) annotation (Line(points={{181,40},{190,40},{190,
          60},{140,60},{140,82},{158,82}},              color={255,0,255}));
  connect(con10.y, logSwi4.u3) annotation (Line(points={{121,-190},{140,-190},{140,
          32},{158,32}},     color={255,0,255}));
  connect(twoDev.y, logSwi5.u2)
    annotation (Line(points={{-159,220},{-82,220}},  color={255,0,255}));
  connect(con14.y, logSwi5.u1) annotation (Line(points={{-119,240},{-100,240},{-100,
          228},{-82,228}},   color={255,0,255}));
  connect(con15.y, logSwi5.u3) annotation (Line(points={{-119,200},{-100,200},{-100,
          212},{-82,212}},   color={255,0,255}));
  connect(logSwi5.y, and2.u1) annotation (Line(points={{-59,220},{-20,220},{-20,
          200},{38,200}},
                      color={255,0,255}));
  connect(logSwi5.y, not4.u) annotation (Line(points={{-59,220},{-20,220},{-20,100},
          {-2,100}},                        color={255,0,255}));
  connect(not4.y, and1.u1) annotation (Line(points={{21,100},{30,100},{30,90},{38,
          90}},       color={255,0,255}));
  connect(not4.y, and3.u1) annotation (Line(points={{21,100},{30,100},{30,40},{38,
          40}},       color={255,0,255}));
  connect(uDevSta, not5.u) annotation (Line(points={{-280,160},{-240,160},{-240,
          40},{-222,40}}, color={255,0,255}));
  connect(not5.y, and4.u1) annotation (Line(points={{-199,40},{-120,40},{-120,-30},
          {-102,-30}},        color={255,0,255}));
  connect(not5.y, and5.u1) annotation (Line(points={{-199,40},{-120,40},{-120,-120},
          {-102,-120}},       color={255,0,255}));
  connect(logSwi.y, logSwi6.u1) annotation (Line(points={{181,200},{200,200},{200,
          -212},{218,-212}},
                           color={255,0,255}));
  connect(logSwi1.y, logSwi6.u1) annotation (Line(points={{181,90},{200,90},{200,
          -212},{218,-212}},
                           color={255,0,255}));
...
<p>When total number of device is two:</p>
<ul>
<li>
...
<p>When total number of devices is three:</p>
<ul>
<li>
