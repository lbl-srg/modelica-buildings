...
block Capacities
  ...
  CDL.Utilities.Assert staExc(message="The provided chiller stage is higher than the number of stages available")
...
equation
  ...
  connect(uChiSta, intLesEqu.u1) annotation (Line(points={{-180,0},{-108,0},{
          -108,-30},{-20,-30},{-20,-70},{-2,-70}}, color={255,127,0}));
  ...
  connect(chiSta1.y, swiLowSta1.u3) annotation (Line(points={{-99,70},{-36,70},
          {-36,-48},{78,-48}},
                          color={0,0,127}));
  connect(pro.u2, minPlrSta1.y) annotation (Line(points={{38,-16},{30,-16},{30,
          -30},{21,-30}}, color={0,0,127}));
  connect(chiSta1.y, pro.u1) annotation (Line(points={{-99,70},{-80,70},{-80,40},
          {-20,40},{-20,-4},{38,-4}},
                     color={0,0,127}));
  connect(swiLowSta1.u1, pro.y) annotation (Line(points={{78,-32},{70,-32},{70,
          -10},{61,-10}}, color={0,0,127}));
  connect(yCapNomLowSta, swiLowSta0.y) annotation (Line(points={{170,-40},{150,
          -40},{150,-70},{141,-70}}, color={0,0,127}));
  connect(swiLowSta1.y, swiLowSta0.u3) annotation (Line(points={{101,-40},{110,
          -40},{110,-78},{118,-78}}, color={0,0,127}));
  ...
  connect(intEqu.y, swi0.u2) annotation (Line(points={{-59,-90},{-10,-90},{-10,
