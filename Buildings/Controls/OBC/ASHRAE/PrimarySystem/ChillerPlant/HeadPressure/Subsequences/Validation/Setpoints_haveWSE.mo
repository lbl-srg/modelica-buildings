...
equation
  ...
  connect(desPumSpe.y, witWSE.uConWatPumSpeSet)
  ...
  connect(desPumSpe.y, noWSE.uConWatPumSpeSet)
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/ChillerPlant/HeadPressure/Subsequences/Validation/Setpoints_haveWSE.mos"
    "Simulate and plot"),
