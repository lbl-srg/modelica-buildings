...
block Controller "Head pressure controller"
  ...
  parameter Modelica.SIunits.TemperatureDifference minChiLif=25
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.HeadPressure.Subsequences.Setpoints_noWSE
    noWSE(
...
equation
  ...
  connect(withWSE.yConWatPumSpe, yConWatPumSpe)
    annotation (Line(points={{61,-30},{70,-30},{70,-40},{110,-40}},
      color={0,0,127}));
  connect(uConWatPumSpeSet, noWSE.uConWatPumSpeSet)
    annotation (Line(points={{-120,20},{0,20},{0,52},{38,52}}, color={0,0,127}));
  connect(uConWatPumSpeSet, withWSE.uConWatPumSpeSet)
...
<code>yMaxTowSpeSet</code> and depending on if the plant has constant speed condenser
water pump, resetting head pressure control valve position 
<code>yHeaPreConVal</code> when <code>fixSpePum</code>=true, or reseting condenser
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.HeadPressure.Subsequences.Setpoints_haveWSE\">
Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.HeadPressure.Subsequences.Setpoints_haveWSE</a>
for a description.
</li>
</ul>
</html>",
