...
equation
  ...
  connect(heaAppDes.y, pro.u2) annotation (Line(points={{-39,30},{-32,30},{-32,
          48},{-22,48}}, color={0,0,127}));
  connect(TOutWet, add1.u1) annotation (Line(points={{-180,140},{-130,140},{
          -130,-44},{-62,-44}}, color={0,0,127}));
  connect(TWetDes.y, add1.u2) annotation (Line(points={{-79,-70},{-72,-70},{-72,
          -56},{-62,-56}}, color={0,0,127}));
  connect(add1.y, pro1.u1) annotation (Line(points={{-39,-50},{-30,-50},{-30,
          -44},{-22,-44}}, color={0,0,127}));
  connect(uTunPar, pro1.u2) annotation (Line(points={{-180,-140},{-30,-140},{
          -30,-56},{-22,-56}}, color={0,0,127}));
  connect(TOutWet, mulSum.u[1]) annotation (Line(points={{-180,140},{46,140},{
          46,5.25},{78,5.25}}, color={0,0,127}));
  connect(pro.y, mulSum.u[2]) annotation (Line(points={{1,54},{30,54},{30,1.75},
          {78,1.75}}, color={0,0,127}));
  connect(pro1.y, mulSum.u[3]) annotation (Line(points={{1,-50},{30,-50},{30,
          -1.75},{78,-1.75}}, color={0,0,127}));
  ...
  connect(pro.u1, lim.y) annotation (Line(points={{-22,60},{-26,60},{-26,70},{
          -29,70}}, color={0,0,127}));
