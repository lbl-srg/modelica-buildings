...
model Speed_noWSE
  "Validate sequence for controlling condenser water pump of plants without waterside economizer"

  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Pumps.CondenserWater.Subsequences.Speed_noWSE
    conPumSpe(
    nChi=2,
    conWatPumSpeSet={0,0.5,0.75})  "Condenser water pump speed"
...
equation
  ...
  connect(reaToInt.y, conPumSpe.uOpeChiNum)
...
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Pumps.CondenserWater.Subsequences.Speed_noWSE\">
Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Pumps.CondenserWater.Subsequences.Speed_noWSE</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
