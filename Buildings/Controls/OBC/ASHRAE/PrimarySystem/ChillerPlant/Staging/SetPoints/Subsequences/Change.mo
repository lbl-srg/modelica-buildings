...
chiller status setpoint indices <span style=\"font-family: monospace;\">y</span>
for the <span style=\"font-family: monospace;\">ySta</span> stage.
</p>
<p>
...
<li>
Integer index of initial chiller stage <span style=\"font-family: monospace;\">uIni</span>
...
<li>
Stage up <span style=\"font-family: monospace;\">uUp</span> and down <span style=\"font-family: monospace;\">uDow</span>
...
and lower <span style=\"font-family: monospace;\">uAvaDow</span> chiller stage,
as calculated by
...
of <span style=\"font-family: monospace;\">delayStaCha</span>.
</p>
</html>",
revisions="<html>
<ul>
