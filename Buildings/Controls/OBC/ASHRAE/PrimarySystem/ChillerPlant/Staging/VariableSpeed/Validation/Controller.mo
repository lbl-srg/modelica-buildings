within Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Staging.VariableSpeed.Validation;
model Controller "Validates stage status for fixed speed chillers"
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Staging.VariableSpeed.Controller
