within Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Staging.FixedSpeed.Subsequences.Validation;
model Change "Validates stage change for fixed speed chillers"
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Staging.FixedSpeed.Subsequences.Change
