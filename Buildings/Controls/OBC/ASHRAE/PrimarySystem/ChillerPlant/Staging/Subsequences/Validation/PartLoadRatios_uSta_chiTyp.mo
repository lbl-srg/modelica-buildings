...
//protected
  ...
  CDL.Integers.Sources.Constant staSig2(k=2) "Stage 2"
  ...
  CDL.Integers.Sources.Constant staSig3(k=1) "Stage 1"
    annotation (Placement(transformation(extent={{-160,-60},{-140,-40}})));
  CDL.Continuous.Sources.Constant capReq2(k=5) "Capacity requirement"
