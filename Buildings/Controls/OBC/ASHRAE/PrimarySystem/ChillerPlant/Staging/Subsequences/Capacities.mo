...
equation
  connect(extStaCap.y, lesThr.u) annotation (Line(points={{-19,110},{-2,110}},
     color={0,0,127}));
  ...
  connect(staCap.y,extStaCap. u)
    annotation (Line(points={{-59,110},{-42,110}},
                                                 color={0,0,127}));
  connect(staCap.y, extStaLowCap.u) annotation (Line(points={{-59,110},{-50,110},
          {-50,60},{-22,60}},     color={0,0,127}));
  connect(one.y, intEqu.u2) annotation (Line(points={{-119,-20},{0,-20},{0,22},
          {48,22}},color={255,127,0}));
  connect(maxInt.y, extStaLowCap.index) annotation (Line(points={{-39,10},{-10,
          10},{-10,48}},  color={255,127,0}));
  connect(extStaCap.y, yStaNom) annotation (Line(points={{-19,110},{-10,110},{
          -10,80},{170,80}},
                         color={0,0,127}));
  connect(intEqu.y, swi.u2)
    annotation (Line(points={{71,30},{84,30},{84,20},{118,20}},
                                                  color={255,0,255}));
  connect(extStaLowCap.y, swi.u3) annotation (Line(points={{1,60},{80,60},{80,
          12},{118,12}},  color={0,0,127}));
  connect(swi.y, yStaDowNom)
    annotation (Line(points={{141,20},{150,20},{150,0},{170,0}},
                                               color={0,0,127}));
  connect(uSta, intEqu.u1) annotation (Line(points={{-180,0},{-100,0},{-100,30},
          {48,30}}, color={255,127,0}));
  connect(uSta, maxInt.u1) annotation (Line(points={{-180,0},{-100,0},{-100,16},
          {-62,16}},       color={255,127,0}));
  connect(addInt.y, extStaCap.index) annotation (Line(points={{-79,70},{-30,70},
          {-30,98}},     color={255,127,0}));
  connect(uSta, addInt.u1) annotation (Line(points={{-180,0},{-120,0},{-120,76},
          {-102,76}},     color={255,127,0}));
  connect(one.y, addInt.u2) annotation (Line(points={{-119,-20},{-110,-20},{
          -110,64},{-102,64}},
                          color={255,127,0}));
  ...
  connect(extMinUnlCap.y, yStaUpMin)
    annotation (Line(points={{-39,-90},{70,-90},{70,-80},{170,-80}},
                                                   color={0,0,127}));
  connect(one.y, maxInt.u2) annotation (Line(points={{-119,-20},{-70,-20},{-70,
          4},{-62,4}},
                     color={255,127,0}));
  connect(addInt.y, addInt1.u1) annotation (Line(points={{-79,70},{-30,70},{-30,
          -34},{-22,-34}}, color={255,127,0}));
  connect(one.y, addInt1.u2) annotation (Line(points={{-119,-20},{-70,-20},{-70,
          -46},{-22,-46}}, color={255,127,0}));
  connect(addInt1.y, extMinUnlCap.index) annotation (Line(points={{1,-40},{10,
          -40},{10,-120},{-50,-120},{-50,-102}},
                                           color={255,127,0}));
  connect(staCap.y, extStaUpCap.u) annotation (Line(points={{-59,110},{-50,110},
          {-50,40},{30,40},{30,0},{48,0}},     color={0,0,127}));
  connect(extStaUpCap.y, yStaUpNom) annotation (Line(points={{71,0},{90,0},{90,
          40},{170,40}},        color={0,0,127}));
  connect(staMax.y, minInt.u2) annotation (Line(points={{1,-70},{20,-70},{20,
          -46},{28,-46}},
                     color={255,127,0}));
  connect(addInt1.y, minInt.u1) annotation (Line(points={{1,-40},{10,-40},{10,
          -34},{28,-34}},
                     color={255,127,0}));
  connect(minInt.y, extStaUpCap.index)
    annotation (Line(points={{51,-40},{60,-40},{60,-12}}, color={255,127,0}));
  connect(addInt.y, extStaCapMin.index) annotation (Line(points={{-79,70},{-74,
          70},{-74,-130},{50,-130},{50,-122}},
                                           color={255,127,0}));
  connect(minStaUnl.y, extStaCapMin.u) annotation (Line(points={{-99,-90},{-90,
          -90},{-90,-110},{38,-110}},                color={0,0,127}));
