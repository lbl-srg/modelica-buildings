...
model Status_u_uAva "Validates chiller stage status subsequence"
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Staging.Subsequences.Status sta4(
    final nSta=4,
    final nChi=3,
    final staMat={{1,0,0},{1,1,0},{0,1,1},{1,1,1}})
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Staging.Subsequences.Status sta7(
    final nSta=4,
    final nChi=3,
    final staMat={{1,0,0},{1,1,0},{0,1,1},{1,1,1}})
