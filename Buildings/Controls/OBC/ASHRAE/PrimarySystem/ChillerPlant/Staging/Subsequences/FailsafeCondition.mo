...
block FailsafeCondition
  ...
  CDL.Continuous.Hysteresis hysdpSup(final uLow=-dpOffset - dpOffset/4, final
      uHigh=-dpOffset)
...
protected
  ...
  CDL.Continuous.Add add1(
    final k1=-1,
    final k2=1) "Adder for differetial pressures"
...
equation
  ...
  connect(truDel.y, and2.u2) annotation (Line(points={{81,-10},{90,-10},{90,-8},
