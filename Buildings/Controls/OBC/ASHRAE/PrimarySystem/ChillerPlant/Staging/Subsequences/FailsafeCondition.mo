...
block FailsafeCondition
  ...
  CDL.Continuous.Add add0(k2=-1) "Adder for temperatures"
    annotation (Placement(transformation(extent={{-100,-20},{-80,0}})));

  CDL.Continuous.Add add1(k2=-1) "Adder for differetial pressures"
...
equation
  ...
  connect(hys.y, and2.u1) annotation (Line(points={{-39,90},{10,90},{10,10},{90,
          10},{90,0},{98,0}},
                color={255,0,255}));
  ...
  connect(not1.y, or2.u2) annotation (Line(points={{1,-90},{10,-90},{10,-18},{18,
          -18}},     color={255,0,255}));
  connect(hys2.y, or2.u1)
    annotation (Line(points={{-39,-10},{18,-10}}, color={255,0,255}));
  connect(add0.y, hys2.u)
