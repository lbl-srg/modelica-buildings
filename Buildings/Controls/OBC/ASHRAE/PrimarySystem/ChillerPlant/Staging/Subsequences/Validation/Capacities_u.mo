...
equation
  connect(stage0.y, staCap0.u)
    annotation (Line(points={{-118,30},{-110,30},{-110,16},{-102,16}},
    color={255,127,0}));
  connect(stage1.y, staCap1.u)
    annotation (Line(points={{-38,30},{-30,30},{-30,16},{-22,16}},
    color={255,127,0}));
  connect(stage2.y, staCap2.u)
    annotation (Line(points={{42,30},{50,30},{50,16},{58,16}}, color={255,127,0}));
  connect(stage3.y, staCap3.u) annotation (Line(points={{122,30},{130,30},{130,
          16},{138,16}}, color={255,127,0}));
  connect(stage0.y, staCap0.uDown) annotation (Line(points={{-118,30},{-110,30},
          {-110,10},{-102,10}}, color={255,127,0}));
  connect(staCap0.uUp, stage7.y) annotation (Line(points={{-102,13},{-116,13},{
          -116,-10},{-118,-10}}, color={255,127,0}));
  connect(stage0.y, staCap1.uDown) annotation (Line(points={{-118,30},{-70,30},
          {-70,10},{-22,10}},  color={255,127,0}));
  connect(stage6.y, staCap1.uUp) annotation (Line(points={{-38,-10},{-30,-10},{
          -30,13},{-22,13}}, color={255,127,0}));
  connect(stage1.y, staCap2.uDown) annotation (Line(points={{-38,30},{10,30},{
          10,10},{58,10}}, color={255,127,0}));
  connect(staCap2.uUp, stage5.y) annotation (Line(points={{58,13},{50,13},{50,
          -10},{42,-10}}, color={255,127,0}));
  connect(stage2.y, staCap3.uDown) annotation (Line(points={{42,30},{90,30},{90,
          10},{138,10}}, color={255,127,0}));
  connect(staCap3.uUp, stage4.y) annotation (Line(points={{138,13},{130,13},{
          130,-10},{122,-10}}, color={255,127,0}));
  connect(desStaCap.y, staCap0.uDesCap) annotation (Line(points={{-118,110},{
          -106,110},{-106,19},{-102,19}}, color={0,0,127}));
  connect(minStaCap.y, staCap0.uMinCap) annotation (Line(points={{-118,70},{
          -108,70},{-108,1},{-102,1}},  color={0,0,127}));
  ...
  connect(minStaCap.y, staCap1.uMinCap) annotation (Line(points={{-118,70},{-26,
          70},{-26,1},{-22,1}},   color={0,0,127}));
  connect(desStaCap.y, staCap2.uDesCap) annotation (Line(points={{-118,110},{54,
          110},{54,19},{58,19}}, color={0,0,127}));
  connect(minStaCap.y, staCap2.uMinCap) annotation (Line(points={{-118,70},{52,
          70},{52,1},{58,1}}, color={0,0,127}));
