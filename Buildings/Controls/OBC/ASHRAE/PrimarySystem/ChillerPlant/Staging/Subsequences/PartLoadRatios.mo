...
block PartLoadRatios
  ...
  final parameter Integer numSta = nPosDis + nVsdCen + nConCen
  "Number of stages";

  final parameter Integer chiStaTyp[numSta] = cat(1, {1 for i in 1:nPosDis}, {2 for j in 1:nVsdCen}, {3 for k in 1:nConCen})
...
equation
  ...
  connect(extStaTyp.y, curStaTyp.u)
    annotation (Line(points={{-219,270},{-122,270}},
                                                   color={0,0,127}));
  ...
  connect(swi3.y, swi2.u3) annotation (Line(points={{41,-230},{50,-230},{50,
          -188},{58,-188}},
                      color={0,0,127}));
  ...
  connect(opePlrUp.y, yUp) annotation (Line(points={{-219,-140},{-40,-140},{-40,
          -120},{270,-120}},
                       color={0,0,127}));
  connect(minOpePlrUp.y, yUpMin) annotation (Line(points={{-219,-200},{-120,-200},
  ...
  connect(conSpeCenTypMult.y, swi2.u1) annotation (Line(points={{-139,-30},{0,
          -30},{0,-172},{58,-172}},
                               color={0,0,127}));
  ...
  connect(curStaTyp.y, intEqu3.u1) annotation (Line(points={{-99,270},{-32,270},
          {-32,210},{-22,210}},
                           color={255,127,0}));
  connect(intEqu3.y, swi2.u2) annotation (Line(points={{1,210},{30,210},{30,
          -180},{58,-180}},
                     color={255,0,255}));
  ...
  connect(const4.y, swi3.u3) annotation (Line(points={{-19,-270},{0,-270},{0,-238},
          {18,-238}}, color={0,0,127}));
  connect(const3.y, swi1.u3) annotation (Line(points={{71,10},{80,10},{80,62},{98,
          62}}, color={0,0,127}));
  connect(add3.y, swi3.u3) annotation (Line(points={{141,-472},{150,-472},{150,
          -260},{10,-260},{10,-238},{18,-238}},
                                        color={0,0,127}));
  connect(add3.y, swi1.u3) annotation (Line(points={{141,-472},{150,-472},{150,20},
          {88,20},{88,62},{98,62}}, color={0,0,127}));
  connect(intEqu1.y, swi4.u2) annotation (Line(points={{1,108},{20,108},{20,
          -160},{118,-160}}, color={255,0,255}));
  connect(swi4.y, yStaDow)
    annotation (Line(points={{141,-160},{270,-160}}, color={0,0,127}));
  connect(swi2.y, swi4.u3) annotation (Line(points={{81,-180},{100,-180},{100,
          -168},{118,-168}}, color={0,0,127}));
  connect(const5.y, swi4.u1) annotation (Line(points={{101,-142},{110,-142},{
