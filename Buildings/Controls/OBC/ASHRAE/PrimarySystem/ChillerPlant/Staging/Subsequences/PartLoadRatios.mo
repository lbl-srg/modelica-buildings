...
equation
  ...
  connect(swi3.y, swi2.u3) annotation (Line(points={{41,-230},{50,-230},{50,-178},
  ...
  connect(swi.y, yStaUp) annotation (Line(points={{163,150},{220,150},{220,0},{270,
          0}}, color={0,0,127}));
  connect(swi2.y, yStaDow) annotation (Line(points={{81,-170},{220,-170},{220,-160},
  ...
  connect(intEqu3.y, swi2.u2) annotation (Line(points={{1,210},{30,210},{30,-170},
