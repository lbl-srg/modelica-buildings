...
block Centrifugal "Sequences to control chiller staging"
...
equation
  ...
  connect(mulSum.y, staUp.u)
    annotation (Line(points={{-98.3,-200},{60,-200},{60,110},{78,110}},
      color={0,0,127}));
  connect(mulSum.y, higSta.u)
    annotation (Line(points={{-98.3,-200},{60,-200},{60,80},{78,80}},
      color={0,0,127}));
  ...
  connect(mulSum.y, staDow.u)
    annotation (Line(points={{-98.3,-200},{60,-200},{60,0},{78,0}},
      color={0,0,127}));
  connect(mulSum.y, staOneChe.u)
    annotation (Line(points={{-98.3,-200},{60,-200},{60,-30},{78,-30}},
      color={0,0,127}));
