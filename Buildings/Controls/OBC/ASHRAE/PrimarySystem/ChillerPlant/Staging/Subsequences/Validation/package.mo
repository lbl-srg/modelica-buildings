...
protected
  ...
  equation
    ...
    connect(staSig1.y, PLRs1.u) annotation (Line(points={{62,130},{90,130},{90,
          120},{139,120}},   color={255,127,0}));
    connect(capReq.y,PLRs1. uCapReq) annotation (Line(points={{102,100},{110,
          100},{110,143},{139,143}},
                                  color={0,0,127}));
    ...
    connect(staSig1.y, staCap.u) annotation (Line(points={{62,130},{70,130},{70,
          66},{78,66}},            color={255,127,0}));
    connect(staSig2.y, PLRs2.u) annotation (Line(points={{-138,-50},{-110,-50},
          {-110,-60},{-61,-60}},
                              color={255,127,0}));
    connect(capReq1.y,PLRs2. uCapReq) annotation (Line(points={{-98,-80},{-90,
          -80},{-90,-37},{-61,-37}},
                             color={0,0,127}));
    ...
    connect(staCap1.yStaMin,PLRs2. uStaCapMin) annotation (Line(points={{-99,-128},
            {-80,-128},{-80,-53},{-61,-53}},
                                      color={0,0,127}));
    connect(staSig2.y, staCap1.u) annotation (Line(points={{-138,-50},{-130,-50},
          {-130,-114},{-122,-114}},
                                  color={255,127,0}));
    connect(staSig3.y, PLRsNoWSE.u) annotation (Line(points={{62,-50},{90,-50},
          {90,-60},{139,-60}},    color={255,127,0}));
    connect(capReq2.y, PLRsNoWSE.uCapReq) annotation (Line(points={{102,-80},{
          110,-80},{110,-37},{139,-37}},
                                       color={0,0,127}));
    ...
    connect(staCap2.yStaMin, PLRsNoWSE.uStaCapMin) annotation (Line(points={{101,
            -128},{120,-128},{120,-53},{139,-53}},
                                           color={0,0,127}));
    connect(staSig3.y, staCap2.u) annotation (Line(points={{62,-50},{70,-50},{
          70,-114},{78,-114}},    color={255,127,0}));
    ...
    connect(staSig0.y, PLRs0.u) annotation (Line(points={{-138,130},{-110,130},
          {-110,120},{-61,120}},
                              color={255,127,0}));
    connect(capReq3.y, PLRs0.uCapReq) annotation (Line(points={{-98,100},{-90,
          100},{-90,143},{-61,143}},color={0,0,127}));
    ...
    connect(staSig0.y, staCap3.u) annotation (Line(points={{-138,130},{-130,130},
          {-130,66},{-122,66}},     color={255,127,0}));
