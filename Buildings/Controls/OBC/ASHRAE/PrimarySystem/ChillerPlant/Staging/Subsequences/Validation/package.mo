...
protected
    ...
    CDL.Integers.Sources.Constant                        curSta3(final k=3)
      "Current chiller stage"
    ...
    CDL.Integers.Sources.Constant                        staUp3(final k=3)
      "Next available chiller stage up"
      annotation (Placement(transformation(extent={{260,140},{280,160}})));
    CDL.Integers.Sources.Constant                        staDown3(final k=2)
      "Next available chiller stage down"
    ...
    CDL.Continuous.Sources.Constant                        capDes3[3](final k={
        10e5,15e5,25e5})
                      "Stage design capacities"
      annotation (Placement(transformation(extent={{300,300},{320,320}})));
    CDL.Continuous.Sources.Constant                        capMin3[3](final k={
        2e5,3e5,5e5})
      "Stage unload capacities"
...
protected
    ...
    CDL.Continuous.Sources.Constant                        capDes5[3](final k={
        10e5,15e5,25e5})
                      "Stage design capacities"
      annotation (Placement(transformation(extent={{-160,-60},{-140,-40}})));
    CDL.Continuous.Sources.Constant                        capMin5[3](final k={
        2e5,3e5,5e5})
      "Stage unload capacities"
    ...
    CDL.Continuous.Sources.Constant                        capDes6[3](final k={
        10e5,15e5,25e5})
                      "Stage design capacities"
      annotation (Placement(transformation(extent={{60,-60},{80,-40}})));
    CDL.Continuous.Sources.Constant                        capMin6[3](final k={
        2e5,3e5,5e5})
      "Stage unload capacities"
      annotation (Placement(transformation(extent={{60,-100},{80,-80}})));
    CDL.Integers.Sources.Constant                        curSta7(final k=3)
      "Current chiller stage"
    ...
    CDL.Integers.Sources.Constant                        staUp7(final k=3)
      "Next available chiller stage up"
      annotation (Placement(transformation(extent={{260,-350},{280,-330}})));
    CDL.Integers.Sources.Constant                        staDown7(final k=2)
      "Next available chiller stage down"
    ...
    CDL.Continuous.Sources.Constant                        capDes7[3](final k={
        10e5,15e5,25e5})
                      "Stage design capacities"
      annotation (Placement(transformation(extent={{300,-60},{320,-40}})));
    CDL.Continuous.Sources.Constant                        capMin7[3](final k={
        2e5,3e5,5e5})
      "Stage unload capacities"
  ...
  equation
    ...
    connect(staDown.y, PLRs0.uDown) annotation (Line(points={{-398,110},{-310,
          110},{-310,186},{-261,186}},                color={255,127,0}));
    connect(max.y, PLRs0.uCapReq) annotation (Line(points={{-317.8,360},{-290,
          360},{-290,213},{-261,213}},
                                 color={0,0,127}));
    connect(capReq3.y, max.u1) annotation (Line(points={{-398,390},{-360,390},{
          -360,366},{-344.2,366}},
                                color={0,0,127}));
    connect(lowLim.y, max.u2) annotation (Line(points={{-398,350},{-360,350},{
          -360,354},{-344.2,354}},
                                color={0,0,127}));
    connect(capDes[1].y, PLRs0.uCapDes) annotation (Line(points={{-358,310},{
          -292,310},{-292,211},{-261,211}},
                                         color={0,0,127}));
    connect(capDes[2].y, PLRs0.uUpCapDes) annotation (Line(points={{-358,310},{
          -292,310},{-292,209},{-261,209}},
                                         color={0,0,127}));
    connect(capMin[1].y, PLRs0.uDowCapDes) annotation (Line(points={{-358,270},
          {-294,270},{-294,207},{-261,207}},
                                         color={0,0,127}));
    connect(capMin[1].y, PLRs0.uCapMin) annotation (Line(points={{-358,270},{
          -294,270},{-294,205},{-261,205}},
                                         color={0,0,127}));
    connect(capMin[2].y, PLRs0.uUpCapMin) annotation (Line(points={{-358,270},{
          -296,270},{-296,203},{-261,203}},
                                         color={0,0,127}));
    ...
    connect(staDown1.y, PLRs1.uDown) annotation (Line(points={{-178,110},{-90,
          110},{-90,186},{-41,186}},
                                 color={255,127,0}));
    connect(max1.y, PLRs1.uCapReq) annotation (Line(points={{-97.8,360},{-70,
          360},{-70,213},{-41,213}},
                                  color={0,0,127}));
    connect(capReq1.y, max1.u1) annotation (Line(points={{-178,390},{-140,390},
          {-140,366},{-124.2,366}},
                                color={0,0,127}));
    connect(lowLim1.y, max1.u2) annotation (Line(points={{-178,350},{-140,350},
          {-140,354},{-124.2,354}},
                                color={0,0,127}));
    connect(capDes1[2].y, PLRs1.uCapDes) annotation (Line(points={{-138,310},{
          -72,310},{-72,211},{-41,211}},
                                  color={0,0,127}));
    connect(capDes1[3].y, PLRs1.uUpCapDes) annotation (Line(points={{-138,310},
          {-72,310},{-72,209},{-41,209}},
                                       color={0,0,127}));
    connect(capDes1[1].y, PLRs1.uDowCapDes) annotation (Line(points={{-138,310},
          {-74,310},{-74,207},{-41,207}},
                                       color={0,0,127}));
    connect(capMin1[2].y, PLRs1.uCapMin) annotation (Line(points={{-138,270},{
          -74,270},{-74,205},{-41,205}},
                                  color={0,0,127}));
    connect(capMin1[3].y, PLRs1.uUpCapMin) annotation (Line(points={{-138,270},
          {-76,270},{-76,203},{-41,203}},
                                       color={0,0,127}));
    ...
    connect(capReq2.y,max2.u1) annotation (Line(points={{42,390},{80,390},{80,
          366},{95.8,366}},
                         color={0,0,127}));
    connect(lowLim2.y,max2. u2) annotation (Line(points={{42,350},{80,350},{80,
          354},{95.8,354}},
                         color={0,0,127}));
    connect(capDes2[3].y,PLRs2.uCapDes) annotation (Line(points={{82,310},{148,
          310},{148,211},{179,211}},
                                  color={0,0,127}));
    connect(capDes2[3].y,PLRs2.uUpCapDes) annotation (Line(points={{82,310},{
          148,310},{148,209},{179,209}},
                                       color={0,0,127}));
    connect(capDes2[2].y,PLRs2.uDowCapDes) annotation (Line(points={{82,310},{
          146,310},{146,207},{179,207}},
                                       color={0,0,127}));
    connect(capMin2[3].y,PLRs2.uCapMin) annotation (Line(points={{82,270},{146,
          270},{146,205},{179,205}},
                                  color={0,0,127}));
    connect(capMin2[3].y,PLRs2.uUpCapMin) annotation (Line(points={{82,270},{
          144,270},{144,203},{179,203}},
                                       color={0,0,127}));
    ...
    connect(capReq4.y,max3.u1) annotation (Line(points={{282,390},{320,390},{
          320,366},{335.8,366}},
                         color={0,0,127}));
    connect(lowLim3.y,max3. u2) annotation (Line(points={{282,350},{320,350},{
          320,354},{335.8,354}},
                         color={0,0,127}));
    connect(capDes3[3].y,PLRs3.uCapDes) annotation (Line(points={{322,310},{388,
          310},{388,211},{419,211}},
                                  color={0,0,127}));
    connect(capDes3[3].y,PLRs3.uUpCapDes) annotation (Line(points={{322,310},{
          388,310},{388,209},{419,209}},
                                       color={0,0,127}));
    connect(capDes3[2].y,PLRs3.uDowCapDes) annotation (Line(points={{322,310},{
          386,310},{386,207},{419,207}},
                                       color={0,0,127}));
    connect(capMin3[3].y,PLRs3.uCapMin) annotation (Line(points={{322,270},{386,
          270},{386,205},{419,205}},
                                  color={0,0,127}));
    connect(capMin3[3].y,PLRs3.uUpCapMin) annotation (Line(points={{322,270},{
          384,270},{384,203},{419,203}},
                                       color={0,0,127}));
  ...
  connect(staDown4.y, PLRs4.uDown) annotation (Line(points={{-398,-380},{-310,
          -380},{-310,-174},{-261,-174}}, color={255,127,0}));
  connect(max4.y, PLRs4.uCapReq) annotation (Line(points={{-317.8,0},{-290,0},{
          -290,-147},{-261,-147}}, color={0,0,127}));
  connect(capReq5.y, max4.u1) annotation (Line(points={{-398,30},{-360,30},{
          -360,6},{-344.2,6}}, color={0,0,127}));
  connect(lowLim4.y, max4.u2) annotation (Line(points={{-398,-10},{-360,-10},{
          -360,-6},{-344.2,-6}}, color={0,0,127}));
  connect(capDes4[1].y, PLRs4.uCapDes) annotation (Line(points={{-358,-50},{
          -292,-50},{-292,-149},{-261,-149}}, color={0,0,127}));
  connect(capDes4[2].y, PLRs4.uUpCapDes) annotation (Line(points={{-358,-50},{
          -292,-50},{-292,-151},{-261,-151}}, color={0,0,127}));
  connect(capMin4[1].y, PLRs4.uDowCapDes) annotation (Line(points={{-358,-90},{
          -294,-90},{-294,-153},{-261,-153}}, color={0,0,127}));
  connect(capMin4[1].y, PLRs4.uCapMin) annotation (Line(points={{-358,-90},{
          -294,-90},{-294,-155},{-261,-155}}, color={0,0,127}));
  connect(capMin4[2].y, PLRs4.uUpCapMin) annotation (Line(points={{-358,-90},{
          -296,-90},{-296,-157},{-261,-157}}, color={0,0,127}));
  connect(staTyp4.y, PLRs4.uTyp) annotation (Line(points={{-398,-260},{-340,
          -260},{-340,-167},{-261,-167}}, color={255,127,0}));
    ...
    connect(staDown5.y,PLRs5. uDown) annotation (Line(points={{-178,-380},{-90,
          -380},{-90,-174},{-41,-174}},
                                 color={255,127,0}));
    connect(max5.y,PLRs5. uCapReq) annotation (Line(points={{-97.8,0},{-70,0},{
          -70,-147},{-41,-147}},  color={0,0,127}));
    connect(capReq6.y,max5. u1) annotation (Line(points={{-178,30},{-140,30},{
          -140,6},{-124.2,6}},  color={0,0,127}));
    connect(lowLim5.y,max5. u2) annotation (Line(points={{-178,-10},{-140,-10},
          {-140,-6},{-124.2,-6}},
                                color={0,0,127}));
    connect(capDes5[2].y,PLRs5. uCapDes) annotation (Line(points={{-138,-50},{
          -72,-50},{-72,-149},{-41,-149}},
                                  color={0,0,127}));
    connect(capDes5[3].y,PLRs5. uUpCapDes) annotation (Line(points={{-138,-50},
          {-72,-50},{-72,-151},{-41,-151}},
                                       color={0,0,127}));
    connect(capDes5[1].y,PLRs5. uDowCapDes) annotation (Line(points={{-138,-50},
          {-74,-50},{-74,-153},{-41,-153}},
                                       color={0,0,127}));
    connect(capMin5[2].y,PLRs5. uCapMin) annotation (Line(points={{-138,-90},{
          -74,-90},{-74,-155},{-41,-155}},
                                  color={0,0,127}));
    connect(capMin5[3].y,PLRs5. uUpCapMin) annotation (Line(points={{-138,-90},
          {-76,-90},{-76,-157},{-41,-157}},
                                       color={0,0,127}));
    ...
    connect(staDown6.y,PLRs6.uDown) annotation (Line(points={{42,-380},{130,
          -380},{130,-174},{179,-174}},
                             color={255,127,0}));
    connect(max6.y,PLRs6.uCapReq) annotation (Line(points={{122.2,0},{150,0},{
          150,-147},{179,-147}},  color={0,0,127}));
    connect(capReq7.y,max6.u1) annotation (Line(points={{42,30},{80,30},{80,6},
          {95.8,6}},     color={0,0,127}));
    connect(lowLim6.y,max6. u2) annotation (Line(points={{42,-10},{80,-10},{80,
          -6},{95.8,-6}},color={0,0,127}));
    connect(capDes6[3].y,PLRs6.uCapDes) annotation (Line(points={{82,-50},{148,
          -50},{148,-149},{179,-149}},
                                  color={0,0,127}));
    connect(capDes6[3].y,PLRs6.uUpCapDes) annotation (Line(points={{82,-50},{
          148,-50},{148,-151},{179,-151}},
                                       color={0,0,127}));
    connect(capDes6[2].y,PLRs6.uDowCapDes) annotation (Line(points={{82,-50},{
          146,-50},{146,-153},{179,-153}},
                                       color={0,0,127}));
    connect(capMin6[3].y,PLRs6.uCapMin) annotation (Line(points={{82,-90},{146,
          -90},{146,-155},{179,-155}},
                                  color={0,0,127}));
    connect(capMin6[3].y,PLRs6.uUpCapMin) annotation (Line(points={{82,-90},{
          144,-90},{144,-157},{179,-157}},
                                       color={0,0,127}));
    ...
    connect(staDown7.y,PLRs7.uDown) annotation (Line(points={{282,-380},{370,
          -380},{370,-174},{419,-174}},
                             color={255,127,0}));
    connect(max7.y,PLRs7.uCapReq) annotation (Line(points={{362.2,0},{390,0},{
          390,-147},{419,-147}},  color={0,0,127}));
    connect(capReq8.y,max7.u1) annotation (Line(points={{282,30},{320,30},{320,
          6},{335.8,6}}, color={0,0,127}));
    connect(lowLim7.y,max7. u2) annotation (Line(points={{282,-10},{320,-10},{
          320,-6},{335.8,-6}},
                         color={0,0,127}));
    connect(capDes7[3].y,PLRs7.uCapDes) annotation (Line(points={{322,-50},{388,
          -50},{388,-149},{419,-149}},
                                  color={0,0,127}));
    connect(capDes7[3].y,PLRs7.uUpCapDes) annotation (Line(points={{322,-50},{
          388,-50},{388,-151},{419,-151}},
                                       color={0,0,127}));
    connect(capDes7[2].y,PLRs7.uDowCapDes) annotation (Line(points={{322,-50},{
          386,-50},{386,-153},{419,-153}},
                                       color={0,0,127}));
    connect(capMin7[3].y,PLRs7.uCapMin) annotation (Line(points={{322,-90},{386,
          -90},{386,-155},{419,-155}},
                                  color={0,0,127}));
    connect(capMin7[3].y,PLRs7.uUpCapMin) annotation (Line(points={{322,-90},{
          384,-90},{384,-157},{419,-157}},
                                       color={0,0,127}));
  connect(staTyp.y, PLRs1.uTyp) annotation (Line(points={{-398,230},{-90,230},{
          -90,193},{-41,193}}, color={255,127,0}));
  connect(staTyp.y, PLRs2.uTyp) annotation (Line(points={{-398,230},{130,230},{
          130,193},{179,193}}, color={255,127,0}));
  connect(staTyp4.y, PLRs5.uTyp) annotation (Line(points={{-398,-260},{-120,
          -260},{-120,-167},{-41,-167}}, color={255,127,0}));
...
First implementation.
  ...
  Icon(coordinateSystem(extent={{-480,-420},{480,420}}),
       graphics={
          ...
          coordinateSystem(preserveAspectRatio=false, extent={{-480,-420},{480,
            420}}), graphics={Text(
          extent={{-140,104},{158,32}},
          lineColor={127,127,127},
          textString=
              "Stage types: 1 - positive displacement, 2 and 3 - constant speed centrifugal"),
          Text(
          extent={{-140,-372},{158,-444}},
          lineColor={127,127,127},
          textString=
              "Stage types: 1 - positive displacement, 2 - variable speed centrifugal, 3 - constant speed centrifugal")}));
