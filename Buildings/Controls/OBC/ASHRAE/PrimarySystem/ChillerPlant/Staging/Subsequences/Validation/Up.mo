...
equation
  ...
  connect(splrUp.y, staUp.uSplrUp) annotation (Line(points={{-99,10},{-88,10},{
          -88,18},{-41,18}},
                    color={0,0,127}));
  connect(oplr.y, staUp.uOplr) annotation (Line(points={{-99,50},{-60,50},{-60,
          20},{-41,20}},
                   color={0,0,127}));
  connect(oplrUp.y, staUp.uOplrUp) annotation (Line(points={{-139,30},{-80,30},
          {-80,15},{-41,15}},
                        color={0,0,127}));
  connect(oplrUpMin.y, staUp.uOplrUpMin) annotation (Line(points={{-139,-10},{
          -80,-10},{-80,13},{-41,13}},
                            color={0,0,127}));
  connect(TCWSupSet.y, staUp.TChiWatSupSet) annotation (Line(points={{-139,-50},
          {-70,-50},{-70,10},{-41,10}},
                                    color={0,0,127}));
  connect(TCWSup.y, staUp.TChiWatSup) annotation (Line(points={{-139,-90},{-60,
          -90},{-60,8},{-41,8}},
                            color={0,0,127}));
  connect(dpChiWatSet.y, staUp.dpChiWatPumSet) annotation (Line(points={{-99,-30},
          {-56,-30},{-56,5},{-41,5}},color={0,0,127}));
  connect(dpChiWat.y, staUp.dpChiWatPum) annotation (Line(points={{-99,-70},{
          -52,-70},{-52,3},{-41,3}},
                            color={0,0,127}));
  connect(stage0.y, staUp.uChiSta) annotation (Line(points={{-139,70},{-50,70},
          {-50,0},{-41,0}},  color={255,127,0}));
  connect(splrUp1.y, staUp1.uSplrUp) annotation (Line(points={{81,10},{92,10},{
          92,18},{139,18}},
                         color={0,0,127}));
  connect(oplr1.y, staUp1.uOplr) annotation (Line(points={{81,50},{120,50},{120,
          20},{139,20}}, color={0,0,127}));
  connect(oplrUp1.y, staUp1.uOplrUp) annotation (Line(points={{41,30},{100,30},
          {100,15},{139,15}},color={0,0,127}));
  connect(oplrUpMin1.y, staUp1.uOplrUpMin) annotation (Line(points={{41,-10},{
          100,-10},{100,13},{139,13}},
                                  color={0,0,127}));
  connect(TCWSupSet1.y, staUp1.TChiWatSupSet) annotation (Line(points={{41,-50},
          {110,-50},{110,10},{139,10}}, color={0,0,127}));
  connect(TCWSup1.y, staUp1.TChiWatSup) annotation (Line(points={{41,-90},{120,
          -90},{120,8},{139,8}},
                              color={0,0,127}));
  connect(dpChiWatSet1.y, staUp1.dpChiWatPumSet) annotation (Line(points={{81,-30},
          {124,-30},{124,5},{139,5}},   color={0,0,127}));
  connect(dpChiWat1.y, staUp1.dpChiWatPum) annotation (Line(points={{81,-70},{
          128,-70},{128,3},{139,3}},
                                   color={0,0,127}));
  connect(stage1.y, staUp1.uChiSta) annotation (Line(points={{41,70},{130,70},{
          130,0},{139,0}},
                         color={255,127,0}));
  connect(higSta.y, staUp.uHigSta) annotation (Line(points={{-139,110},{-48,110},
          {-48,-2},{-41,-2}}, color={255,0,255}));
  connect(higSta1.y, staUp1.uHigSta) annotation (Line(points={{41,110},{132,110},
