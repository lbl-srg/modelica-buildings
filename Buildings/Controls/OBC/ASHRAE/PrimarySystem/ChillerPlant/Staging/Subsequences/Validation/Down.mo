...
equation
  ...
  connect(dpChiWat.y, staDow.dpChiWatPum) annotation (Line(points={{-98,-30},{
          -72,-30},{-72,52},{-61,52}}, color={0,0,127}));
  ...
  connect(oplr.y, staDow.uOpe) annotation (Line(points={{-98,90},{-76,90},{-76,
          58},{-61,58}}, color={0,0,127}));
  connect(oplrMin.y, staDow.uOpeMin) annotation (Line(points={{-138,70},{-80,
  ...
  connect(oplrDown1.y, staDow1.uOpeDow) annotation (Line(points={{102,130},{
          130,130},{130,62},{139,62}}, color={0,0,127}));
  connect(splrDown1.y, staDow1.uStaDow) annotation (Line(points={{62,110},{128,
          110},{128,60},{139,60}}, color={0,0,127}));
  connect(oplr1.y, staDow1.uOpe) annotation (Line(points={{102,90},{124,90},{
          124,58},{139,58}}, color={0,0,127}));
  connect(oplrMin1.y, staDow1.uOpeMin) annotation (Line(points={{62,70},{120,
          70},{120,56},{139,56}}, color={0,0,127}));
  connect(WSESta1.y, staDow1.uWseSta) annotation (Line(points={{102,-70},{134,
          -70},{134,42},{139,42}}, color={255,0,255}));
  ...
  connect(oplr.y, noWSE.uOpe) annotation (Line(points={{-98,90},{-60,90},{-60,
  ...
  connect(dpChiWat.y, noWSE.dpChiWatPum) annotation (Line(points={{-98,-30},{
          -86,-30},{-86,84},{-54,84},{-54,92},{-41,92}}, color={0,0,127}));
