...
equation
  ...
  connect(dpChiWat.y, staDow.dpChiWatPum) annotation (Line(points={{-98,-30},{
          -72,-30},{-72,52},{-61,52}},
                                   color={0,0,127}));
  connect(oplrDown.y, staDow.uOplrDow) annotation (Line(points={{-98,130},{-70,
          130},{-70,62},{-61,62}}, color={0,0,127}));
  connect(splrDown.y, staDow.uSplrDow) annotation (Line(points={{-138,110},{-72,
          110},{-72,60},{-61,60}}, color={0,0,127}));
  connect(oplr.y, staDow.uOplr) annotation (Line(points={{-98,90},{-76,90},{-76,
          58},{-61,58}}, color={0,0,127}));
  connect(oplrMin.y, staDow.uOplrMin) annotation (Line(points={{-138,70},{-80,
          70},{-80,56},{-61,56}}, color={0,0,127}));
  ...
  connect(oplrDown1.y, staDow1.uOplrDow) annotation (Line(points={{102,130},{
          130,130},{130,62},{139,62}},
                                   color={0,0,127}));
  connect(splrDown1.y, staDow1.uSplrDow) annotation (Line(points={{62,110},{128,
          110},{128,60},{139,60}}, color={0,0,127}));
  connect(oplr1.y, staDow1.uOplr) annotation (Line(points={{102,90},{124,90},{
          124,58},{139,58}}, color={0,0,127}));
  connect(oplrMin1.y, staDow1.uOplrMin) annotation (Line(points={{62,70},{120,
          70},{120,56},{139,56}}, color={0,0,127}));
  connect(WSESta1.y, staDow1.uWseSta) annotation (Line(points={{102,-70},{134,
          -70},{134,42},{139,42}},
                              color={255,0,255}));
  ...
  connect(oplrDown.y, noWSE.uOplrDow) annotation (Line(points={{-98,130},{-70,
          130},{-70,102},{-41,102}}, color={0,0,127}));
  connect(splrDown.y, noWSE.uSplrDow) annotation (Line(points={{-138,110},{-72,
          110},{-72,100},{-41,100}}, color={0,0,127}));
  connect(oplr.y, noWSE.uOplr) annotation (Line(points={{-98,90},{-60,90},{-60,
          98},{-41,98}}, color={0,0,127}));
  connect(oplrMin.y, noWSE.uOplrMin) annotation (Line(points={{-138,70},{-80,70},
