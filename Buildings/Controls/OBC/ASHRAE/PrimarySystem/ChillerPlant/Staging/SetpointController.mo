...
equation
  ...
  annotation (defaultComponentName = "staSetCon",
        ...
        Text(
          ...
          textString="%name"),
        Text(
          extent={{-96,182},{-38,158}},
          lineColor={0,0,127},
          pattern=LinePattern.Dash,
          textString="TChiWatSupSet"),
        Text(
          extent={{-96,160},{-50,140}},
          lineColor={0,0,127},
          pattern=LinePattern.Dash,
        ...
        Text(
          ...
          textString="u"),
        Text(
          extent={{-100,-114},{-76,-106}},
          lineColor={244,125,35},
          pattern=LinePattern.Dash,
          textString="uIni"),
        Text(
          extent={{-96,-122},{-62,-136}},
          lineColor={217,67,180},
          pattern=LinePattern.Dash,
          textString="uWseSta"),
        Text(
          extent={{-96,-142},{-70,-154}},
          lineColor={217,67,180},
          pattern=LinePattern.Dash,
          textString="chaPro"),
        Text(
          extent={{-96,-186},{-76,-194}},
          lineColor={217,67,180},
          pattern=LinePattern.Dash,
          textString="uPla"),
        Text(
          extent={{-96,-164},{-64,-176}},
          lineColor={217,67,180},
          pattern=LinePattern.Dash,
          textString="uChiAva"),
        Text(
