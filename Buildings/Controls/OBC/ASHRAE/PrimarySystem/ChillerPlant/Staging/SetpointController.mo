...
block SetpointController
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput uPla "Plant enable signal"
                          annotation (Placement(
        transformation(extent={{-118,40},{-78,80}}),      iconTransformation(
  ...
  Buildings.Controls.OBC.CDL.Interfaces.IntegerInput uIni(final min=0, final max=nSta)
    "Initial chiller stage (at plant enable)" annotation (Placement(
        transformation(extent={{60,80},{100,120}}),      iconTransformation(
...
equation
  ...
  connect(staDow.y, lat.clr) annotation (Line(points={{-80,-230},{-32,-230},{
          -32,-46},{-2,-46}},
                           color={255,0,255}));
  connect(sta.yAvaUp, intToRea1.u) annotation (Line(points={{-298,-203},{-292,-203},
          {-292,0},{-2,0}}, color={255,127,0}));
  connect(sta.yAvaDow, intToRea.u) annotation (Line(points={{-298,-206},{-292,-206},
          {-292,-80},{-2,-80}}, color={255,127,0}));
  connect(lat.y, switch1.u2)
    annotation (Line(points={{22,-40},{56,-40}},   color={255,0,255}));
  connect(uPla, edg.u) annotation (Line(points={{-98,60},{-62,60}},
                     color={255,0,255}));
  ...
  connect(uIni, intToRea2.u) annotation (Line(points={{80,100},{116,100}},
                         color={255,127,0}));
  ...
  connect(reaToInt.y, chiInd.u) annotation (Line(points={{342,60},{366,60},{366,
