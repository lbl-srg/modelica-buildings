...
model ContinuousLeadSwapTwo_uDevSta
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul2(width=0.5, period=10)
    annotation (Placement(transformation(extent={{-200,-20},{-180,0}})));

  Buildings.Controls.OBC.CDL.Logical.Not not4 "Not"
    annotation (Placement(transformation(extent={{-160,-40},{-140,-20}})));

  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul4(width=0.5, period=11)
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul6(width=0.5, period=10)
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol(trueHoldDuration=0, falseHoldDuration=6)
    annotation (Placement(transformation(extent={{-100,-60},{-80,-40}})));

  Buildings.Controls.OBC.CDL.Logical.TrueFalseHold truFalHol1(trueHoldDuration=0, falseHoldDuration=6)
