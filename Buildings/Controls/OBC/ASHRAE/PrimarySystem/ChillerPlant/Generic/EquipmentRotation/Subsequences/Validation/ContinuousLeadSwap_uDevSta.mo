...
model ContinuousLeadSwap_uDevSta
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Generic.EquipmentRotation.Subsequences.ContinuousLeadSwap
    leaSwa
...
equation
  ...
  connect(not4.y, leaSwa1.uLeaRolSet[2]) annotation (Line(points={{-138,-30},{-110,
          -30},{-110,-16},{-42,-16}}, color={255,0,255}));
annotation (
  experiment(StopTime=180, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/ChillerPlant/Generic/EquipmentRotation/Subsequences/Validation/ContinuousLeadSwap_uDevSta.mos"
    "Simulate and plot"),
  Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Generic.EquipmentRotation.Subsequences.ContinuousLeadSwap\">
Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Generic.EquipmentRotation.Subsequences.ContinuousLeadSwap</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
...
end ContinuousLeadSwap_uDevSta;
