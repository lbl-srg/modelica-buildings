...
model Multiple_uDevRol "Validate lead/lag and lead/standby switching"
...
equation
  connect(leadLoad.y, leaLag.uLeaSta) annotation (Line(points={{-58,20},{-40,20},
          {-40,-4},{-22,-4}}, color={255,0,255}));
  connect(lagLoad.y, leaLag.uLagSta) annotation (Line(points={{-58,-40},{-40,
          -40},{-40,-16},{-22,-16}},color={255,0,255}));
  connect(leadLoad.y, leaSta.uLeaSta) annotation (Line(points={{-58,20},{30,20},
