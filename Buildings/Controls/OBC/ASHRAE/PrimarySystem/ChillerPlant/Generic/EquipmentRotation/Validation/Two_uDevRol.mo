...
model Two_uDevRol "Validate lead/lag and lead/standby switching"
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Generic.EquipmentRotationTwo
    leaLag(final stagingRuntime=5*60*61)
...
equation
  ...
  connect(lagLoad.y, leaLag.uLagStaSet) annotation (Line(points={{-58,10},{-40,10},
          {-40,34},{-22,34}}, color={255,0,255}));
  connect(leadLoad.y, leaSta.uLeaStaSet) annotation (Line(points={{-58,70},{30,70},
  ...
  connect(lagLoad1.y, leaLag1.uLagStaSet) annotation (Line(points={{-58,-50},{-40,
