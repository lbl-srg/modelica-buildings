...
equation
  ...
  connect(leadLoad.y, leaLag.uLeaSta) annotation (Line(points={{-59,80},{-42,80},
          {-42,56},{-22,56}}, color={255,0,255}));
  connect(lagLoad.y, leaLag.uLagSta) annotation (Line(points={{-59,20},{-40,20},
          {-40,44},{-22,44}}, color={255,0,255}));
  connect(leadLoad1.y, leaSta.uLeaSta) annotation (Line(points={{-59,-20},{-42,
          -20},{-42,-44},{-22,-44}}, color={255,0,255}));
