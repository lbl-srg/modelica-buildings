...
equation
  connect(leadLoad.y, leaLag.uLeaStaSet) annotation (Line(points={{-58,70},{-40,
          70},{-40,46},{-22,46}}, color={255,0,255}));
  connect(lagLoad.y, leaLag.uLagStaSet) annotation (Line(points={{-58,10},{-40,
          10},{-40,34},{-22,34}}, color={255,0,255}));
  connect(leadLoad.y, leaSta.uLeaStaSet) annotation (Line(points={{-58,70},{30,
          70},{30,46},{38,46}}, color={255,0,255}));
  connect(leadLoad.y, leaLag1.uLeaStaSet) annotation (Line(points={{-58,70},{10,
          70},{10,-24},{18,-24}}, color={255,0,255}));
  connect(lagLoad1.y, leaLag1.uLagStaSet) annotation (Line(points={{-58,-50},{
          -40,-50},{-40,-36},{18,-36}}, color={255,0,255}));
          annotation (
