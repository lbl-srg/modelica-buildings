...
model Fan "Validate cooling tower fan control sequence"

  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Tower.Fan towFan(
    minFanSpe=0.1)
...
annotation (
 experiment(StopTime=3600.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/ChillerPlant/Tower/Validation/Fan.mos"
    "Simulate and plot"),
  Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Tower.Fan\">
Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Tower.Fan</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
