...
model WaterLevel
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChillerPlant.Tower.WaterLevel
    makUpWat(
    final watLevMin=0.7,
...
annotation (experiment(StopTime=3600.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/ChillerPlant/Tower/Validation/WaterLevel.mos"
    "Simulate and plot"),
