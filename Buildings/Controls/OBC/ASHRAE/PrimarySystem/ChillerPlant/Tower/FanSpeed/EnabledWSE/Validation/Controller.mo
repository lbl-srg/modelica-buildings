...
equation
  ...
  connect(wseSta.y, wseOpe.uWseSta) annotation (Line(points={{22,10},{40,10},{
          40,2},{98,2}}, color={255,0,255}));
...
annotation (experiment(StopTime=3600.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/ChillerPlant/Tower/FanSpeed/EnabledWSE/Validation/Controller.mos"
    "Simulate and plot"),
