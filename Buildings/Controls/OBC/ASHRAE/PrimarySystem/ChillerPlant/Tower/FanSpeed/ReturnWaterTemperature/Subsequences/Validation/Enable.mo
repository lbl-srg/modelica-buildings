...
equation
  ...
  connect(conRetSet.y, enaTow.TTowSet)
    annotation (Line(points={{-198,0},{-174,0},{-174,52},{-142,52}},
      color={0,0,127}));
  ...
  connect(conRetSet2.y, disTow1.TTowSet)
    annotation (Line(points={{162,0},{186,0},{186,52},{218,52}}, color={0,0,127}));
...
annotation (experiment(StopTime=3600.0, Tolerance=1e-06),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/ChillerPlant/Tower/FanSpeed/ReturnWaterTemperature/Subsequences/Validation/Enable.mos"
    "Simulate and plot"),
