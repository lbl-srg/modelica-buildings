...
equation
  ...
  connect(zer.y, CWRTSpd.x1)
    annotation (Line(points={{42,120},{60,120},{60,88},{78,88}}, color={0,0,127}));
  connect(minTowSpe.y, CWRTSpd.f1)
    annotation (Line(points={{-58,120},{-20,120},{-20,84},{78,84}}, color={0,0,127}));
  connect(one.y, CWRTSpd.x2)
    annotation (Line(points={{2,60},{40,60},{40,76},{78,76}},
      color={0,0,127}));
  connect(one.y, CWRTSpd.f2)
    annotation (Line(points={{2,60},{40,60},{40,72},{78,72}},
      color={0,0,127}));
  ...
  connect(zer.y, swi.u3)
    annotation (Line(points={{42,120},{60,120},{60,-48},{78,-48}},
      color={0,0,127}));
