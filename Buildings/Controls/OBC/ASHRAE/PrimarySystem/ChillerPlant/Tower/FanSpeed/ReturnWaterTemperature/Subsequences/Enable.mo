...
equation
  ...
  connect(hys1.y, swi.u2)
    annotation (Line(points={{-118,180},{-112,180},{-112,160},{-102,160}},
      color={255,0,255}));
  connect(uMaxTowSpeSet, swi.u1)
    annotation (Line(points={{-200,180},{-160,180},{-160,168},{-102,168}}, color={0,0,127}));
  connect(one.y, swi.u3)
    annotation (Line(points={{-118,130},{-110,130},{-110,152},{-102,152}}, color={0,0,127}));
  ...
  connect(minSpe[1].y, feedback1.u2)
    annotation (Line(points={{-118,80},{-80,80},{-80,88}}, color={0,0,127}));
  ...
  connect(hys3.y, and2.u2)
    annotation (Line(points={{-18,40},{40,40},{40,92},{58,92}}, color={255,0,255}));
  connect(greEquThr.y, or2.u1)
    annotation (Line(points={{142,160},{160,160},{160,140},{100,140},{100,120},
          {118,120}},
                  color={255,0,255}));
  connect(and2.y, or2.u2)
    annotation (Line(points={{82,100},{100,100},{100,112},{118,112}},
      color={255,0,255}));
  ...
  connect(feedback3.y, hys4.u)
    annotation (Line(points={{-68,-40},{-60,-40},{-60,-60},{-42,-60}}, color={0,0,127}));
  connect(mulAnd.y, and3.u1)
    annotation (Line(points={{42,-30},{60,-30},{60,-52},{78,-52}},   color={255,0,255}));
  connect(hys4.y, and3.u2)
    annotation (Line(points={{-18,-60},{78,-60}}, color={255,0,255}));
  ...
  connect(intEqu.y, or1.u2) annotation (Line(points={{-78,-160},{110,-160},{110,
          -68},{118,-68}}, color={255,0,255}));
  connect(or2.y, logSwi.u2) annotation (Line(points={{142,120},{160,120},{160,
          80},{120,80},{120,40},{138,40}},
                                       color={255,0,255}));
  connect(disFan.y, logSwi.u1) annotation (Line(points={{82,50},{100,50},{100,
          48},{138,48}},
                     color={255,0,255}));
  connect(enaFan.y, logSwi1.u1) annotation (Line(points={{82,10},{100,10},{100,
          8},{138,8}},
                    color={255,0,255}));
  connect(logSwi1.y, logSwi.u3) annotation (Line(points={{162,0},{170,0},{170,
          20},{120,20},{120,32},{138,32}},
                                       color={255,0,255}));
  connect(mulOr1.y, logSwi1.u3) annotation (Line(points={{-118,-120},{-110,-120},
          {-110,-8},{138,-8}}, color={255,0,255}));
  connect(or1.y, logSwi1.u2) annotation (Line(points={{142,-60},{160,-60},{160,
          -20},{120,-20},{120,0},{138,0}},
                                      color={255,0,255}));
  ...
  connect(addPar.y, feedback3.u2) annotation (Line(points={{-118,-60},{-80,-60},
          {-80,-52}}, color={0,0,127}));
