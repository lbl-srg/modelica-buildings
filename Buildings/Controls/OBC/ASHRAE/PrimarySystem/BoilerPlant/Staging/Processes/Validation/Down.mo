...
equation
  ...
  connect(dowProCon.yPumChaPro, yPumChaPro.u) annotation (Line(points={{-138,169},
  ...
  connect(dowProCon1.yPumChaPro, yPumChaPro1.u) annotation (Line(points={{232,169},
          {240,169},{240,160},{248,160}}, color={255,0,255}));
