...
block CapacityRequirement "Heating capacity requirement"
  ...
  parameter Real avePer(final unit="s",
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TRet(
    final unit="K",
    final quantity="ThermodynamicTemperature")
    "Measured hot water return temperature" annotation (Placement(
...
protected
  constant Real rhoWat(final unit="kg/m3",
                       final quantity="Density") = 1000
  "Water density";

  constant Real cpWat(final unit="J/(kg.K)",
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant density(final k = rhoWat)
    "Water density"
    annotation (Placement(transformation(extent={{-100,-40},{-80,-20}})));

  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant speHeaCap(final k = cpWat)
    "Specific heat capacity of water"
...
equation
  connect(TRet, add2.u2) annotation (Line(points={{-140,0},{-110,0},{-110,34},{
          -102,34}}, color={0,0,127}));
  connect(add2.u1, TSupSet) annotation (Line(points={{-102,46},{-110,46},{-110,
          70},{-140,70}}, color={0,0,127}));
  connect(add2.y, pro.u1) annotation (Line(points={{-78,40},{10,40},{10,0},{18,
          0}},      color={0,0,127}));
  ...
  annotation (defaultComponentName = "capReq",
    ...
    Documentation(info="<html>
      ...
      March 23rd, 2020, section 5.3.3.5 and 5.3.3.6.
      </p>
      <p align=\"center\">
