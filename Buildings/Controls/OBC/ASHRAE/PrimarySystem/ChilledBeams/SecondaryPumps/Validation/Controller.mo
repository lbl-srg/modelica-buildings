within Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeams.SecondaryPumps.Validation;
model Controller
  "Validate chilled beam chilled water pump control sequence"

  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeams.SecondaryPumps.Controller
    pumCon(
    final nPum=2,
    final minPumSpe=0.1,
    final maxPumSpe=1,
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/ChilledBeams/SecondaryPumps/Validation/Controller.mos"
    "Simulate and plot"),
  Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeams.SecondaryPumps.Controller\">
Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeams.SecondaryPumps.Controller</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
