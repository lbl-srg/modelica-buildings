...
model Speed_remoteDp
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeams.SecondaryPumps.Subsequences.Speed_remoteDp
    chiPumSpe(
    final nSen=2,
    final nPum=2)
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/ChilledBeams/SecondaryPumps/Subsequences/Validation/Speed_remoteDp.mos"
    "Simulate and plot"),
  Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeams.SecondaryPumps.Subsequences.Speed_remoteDp\">
Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeams.SecondaryPumps.Subsequences.Speed_remoteDp</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
