...
protected
  parameter Integer modInt[3]={Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeams.Types.OperationModes.occupied,
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant conInt(final k=Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeams.Types.OperationModes.occupied)
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant conInt1(
    final k=Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeams.Types.OperationModes.unoccupiedScheduled)
    "Constant integer for unoccupiedScheduled mode"
    annotation (Placement(transformation(extent={{-20,-30},{0,-10}})));

  Buildings.Controls.OBC.CDL.Integers.Sources.Constant conInt2(
    final k=Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeams.Types.OperationModes.unoccupiedUnscheduled)
