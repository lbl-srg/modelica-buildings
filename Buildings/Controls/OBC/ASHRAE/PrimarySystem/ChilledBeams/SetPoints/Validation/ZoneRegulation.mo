...
model ZoneRegulation
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeams.SetPoints.ZoneRegulation
    zonRegCon(
    final VDes_occ=0.5,
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/ChilledBeams/SetPoints/Validation/ZoneRegulation.mos"
    "Simulate and plot"),
  Documentation(info="<html>
<p>
This example validates
<a href=\"modelica://Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeams.SetPoints.ZoneRegulation\">
Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeams.SetPoints.ZoneRegulation</a>.
</p>
</html>", revisions="<html>
<ul>
<li>
