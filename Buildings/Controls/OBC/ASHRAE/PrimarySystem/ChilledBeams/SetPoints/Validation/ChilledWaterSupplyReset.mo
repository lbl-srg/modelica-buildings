...
model ChilledWaterSupplyReset
  ...
  Buildings.Controls.OBC.ASHRAE.PrimarySystem.ChilledBeams.SetPoints.ChilledWaterSupplyReset
    chiWatSupRes
...
annotation (
  ...
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/PrimarySystem/ChilledBeams/SetPoints/Validation/ChilledWaterSupplyReset.mos"
    "Simulate and plot"),
