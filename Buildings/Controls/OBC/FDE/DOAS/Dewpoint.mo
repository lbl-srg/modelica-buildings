...
block Dewpoint
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput relHum(
    final min=0,
    final max=100) "Relative humidity sensor"
...
equation
  ...
  connect(div.u2, con100.y) annotation (Line(points={{-64,60},{-68,60},{-68,56},
          {-70,56}}, color={0,0,127}));
  connect(div.y, log.u)
    annotation (Line(points={{-40,66},{-34,66}}, color={0,0,127}));
  connect(con1727.y, pro.u2) annotation (Line(points={{-40,0},{-36,0},{-36,20},{
          -32,20}}, color={0,0,127}));
  connect(con2373.y, add2.u2) annotation (Line(points={{-40,-42},{-36,-42},{-36,
          -30},{-32,-30}}, color={0,0,127}));
  connect(pro.y, div1.u1)
    annotation (Line(points={{-8,26},{-2,26}},  color={0,0,127}));
  connect(add2.y, div1.u2) annotation (Line(points={{-8,-24},{-6,-24},{-6,14},{-2,
          14}},    color={0,0,127}));
  connect(div1.y, add1.u2)
    annotation (Line(points={{22,20},{28,20}}, color={0,0,127}));
  connect(log.y, add1.u1) annotation (Line(points={{-10,66},{24,66},{24,32},{28,
          32}}, color={0,0,127}));
  connect(add1.y, div2.u1)
    annotation (Line(points={{52,26},{60,26}}, color={0,0,127}));
  connect(con1727.y, div2.u2) annotation (Line(points={{-40,0},{54,0},{54,14},{60,
          14}}, color={0,0,127}));
  connect(div2.y, pro1.u1) annotation (Line(points={{84,20},{82,20},{82,-6},{-2,
          -6},{-2,-30},{2,-30}},
                             color={0,0,127}));
  ...
  connect(div2.y, add3.u2) annotation (Line(points={{84,20},{82,20},{82,-6},{-2,
          -6},{-2,-76},{30,-76}},
                             color={0,0,127}));
  connect(add3.u1, con1.y) annotation (Line(points={{30,-64},{28,-64},{28,-62},{
          26,-62}}, color={0,0,127}));
  connect(add3.y, div3.u2) annotation (Line(points={{54,-70},{56,-70},{56,-48},{
          58,-48}}, color={0,0,127}));
  connect(con27315.y, add4.u2) annotation (Line(points={{-70,-4},{-70,14},{-98,14},
          {-98,20},{-94,20}}, color={0,0,127}));
  connect(dbT, add4.u1)
    annotation (Line(points={{-122,32},{-94,32}}, color={0,0,127}));
  connect(add4.y, pro.u1) annotation (Line(points={{-70,26},{-52,26},{-52,32},{-32,
          32}}, color={0,0,127}));
  connect(add4.y, add2.u1) annotation (Line(points={{-70,26},{-64,26},{-64,-18},
          {-32,-18}}, color={0,0,127}));
  connect(add5.y, dpT)
    annotation (Line(points={{92,-76},{122,-76}}, color={0,0,127}));
  connect(div3.y, add5.u1) annotation (Line(points={{82,-42},{86,-42},{86,-60},{
          64,-60},{64,-70},{68,-70}}, color={0,0,127}));
  connect(con27315.y, add5.u2) annotation (Line(points={{-70,-4},{-70,-68},{-22,
          -68},{-22,-82},{68,-82}}, color={0,0,127}));
