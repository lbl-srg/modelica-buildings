...
equation
  ...
  connect(retHum, les.u1) annotation (Line(points={{-122,0},{-56,0},{-56,-32},{-46,
          -32}}, color={0,0,127}));
  connect(conDset.y, les.u2)
    annotation (Line(points={{-66,-40},{-46,-40}}, color={0,0,127}));
  connect(conDset.y, gre.u2) annotation (Line(points={{-66,-40},{-60,-40},{-60,-8},
          {-46,-8}}, color={0,0,127}));
  connect(les.y, truDel.u)
    annotation (Line(points={{-22,-32},{-16,-32}}, color={255,0,255}));
  connect(gre.y, lat.u)
    annotation (Line(points={{-22,0},{20,0}}, color={255,0,255}));
  connect(truDel.y, lat.clr) annotation (Line(points={{8,-32},{14,-32},{14,-6},{
          20,-6}}, color={255,0,255}));
  ...
  connect(minimumRun.y, and2.u1) annotation (Line(points={{-22,38},{48,38},{48,8},
          {56,8}}, color={255,0,255}));
