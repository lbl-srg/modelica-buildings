...
block OperatingMode "Determine occupied or setback operating mode"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.IntegerInput sbhReq
    "Terminal unit setback heating requests" annotation (Placement(
        transformation(extent={{-160,-98},{-120,-58}}), iconTransformation(
...
equation
  ...
  connect(or2.y, yOcc)
    annotation (Line(points={{44,68},{50,68},{50,54},{160,54}},
                                               color={255,0,255}));
  connect(not1.y, and2.u1) annotation (Line(points={{80,-10},{86,-10},{86,-28},{
          92,-28}},  color={255,0,255}));
  connect(not1.u, yOcc) annotation (Line(points={{56,-10},{50,-10},{50,54},{160,
          54}},     color={255,0,255}));
  connect(and2.y, ySBC) annotation (Line(points={{116,-28},{160,-28}},
                           color={255,0,255}));
  connect(and1.u1, and2.u1) annotation (Line(points={{92,-70},{86,-70},{86,-28},
          {92,-28}},      color={255,0,255}));
  connect(and1.y, ySBH)
  ...
  connect(intGre.y, or2.u2) annotation (Line(points={{8,30},{14,30},{14,60},{20,
          60}}, color={255,0,255}));
  ...
  connect(TotalTU, intToRea.u)
    annotation (Line(points={{-140,-10},{-134,-10},{-134,-12},{-128,-12},{-128,-10},
          {-114,-10}},                            color={255,127,0}));
  ...
  connect(gai.y, reaToInt.u)
    annotation (Line(points={{-62,-10},{-58,-10}},
                                                 color={0,0,127}));
  connect(intGre.u2, reaToInt.y) annotation (Line(points={{-16,22},{-28,22},{-28,
          -10},{-34,-10}},
                     color={255,127,0}));
  connect(intGre1.u2, reaToInt.y) annotation (Line(points={{-14,-48},{-28,-48},{
          -28,-10},{-34,-10}},
                         color={255,127,0}));
  connect(intGre2.u2, reaToInt.y) annotation (Line(points={{-14,-86},{-28,-86},{
          -28,-10},{-34,-10}},
                         color={255,127,0}));
