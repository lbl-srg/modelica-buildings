...
protected
  Buildings.Controls.OBC.CDL.Reals.Switch swi2
    "When input variable 2 is true, output the input variable 3, otherwise output the input variable 1"
    annotation (Placement(transformation(extent={{20,-40},{40,-20}})));
  Buildings.Controls.OBC.CDL.Reals.Switch swi1
    "When input variable 2 is true, output the input variable 1, otherwise output the input variable 3"
    annotation (Placement(transformation(extent={{20,20},{40,40}})));
equation
  connect(swi1.y, y1)
    annotation (Line(points={{42,30},{80,30},{80,50},{120,50}},color={0,0,127}));
  connect(swi2.y, y2)
    annotation (Line(points={{42,-30},{80,-30},{80,-50},{120,-50}},color={0,0,127}));
  connect(u2, swi1.u2)
    annotation (Line(points={{-120,0},{0,0},{0,30},{18,30}},color={255,0,255}));
  connect(u2, swi2.u2)
    annotation (Line(points={{-120,0},{0,0},{0,-30},{18,-30}},color={255,0,255}));
  connect(u1, swi1.u1)
    annotation (Line(points={{-120,60},{-80,60},{-80,38},{18,38}}, color={0,0,127}));
  connect(u3, swi1.u3)
    annotation (Line(points={{-120,-60},{-40,-60},{-40,22},{18,22}},
      color={0,0,127}));
  connect(u1, swi2.u3)
    annotation (Line(points={{-120,60},{-80,60},{-80,-38},{18,-38}},
      color={0,0,127}));
  connect(u3, swi2.u1)
    annotation (Line(points={{-120,-60},{-40,-60},{-40,-22},{18,-22}},
      color={0,0,127}));
