...
block SingleStepSetpointChange "Single-step setpoint change"
  ...
  parameter Boolean ascSet
    "if ture, command the setpoint toward the allowed maximum setpoint, otherwise toward the allowed minimum setpoint";
...
<ul>
<li>
If the setpoint change enabling input <code>uEna</code> is <code>true</code>, the output <code>y</code> 
