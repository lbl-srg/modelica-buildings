...
block SingleStepSetpointChange "Single-step setpoint change"
  ...
  Subsequences.RealNumberEqual realNumberEqual
    annotation (Placement(transformation(extent={{40,140},{60,160}})));
  Subsequences.RealNumberEqual realNumberEqual1
    annotation (Placement(transformation(extent={{36,-162},{56,-142}})));
equation
  connect(uBasSet,max1. u2) annotation (Line(points={{-122,-116},{-78,-116},{-78,
          -44},{-26,-44},{-26,-6},{48,-6}},
                     color={0,0,127}));
  connect(uEna,swi. u2) annotation (Line(points={{-120,140},{-54,140},{-54,-74},
  ...
  connect(min2.y,max2. u2) annotation (Line(points={{114,-6},{130,-6}},
                    color={0,0,127}));
  connect(min1.y,max2. u1) annotation (Line(points={{62,70},{118,70},{118,6},{
          130,6}},        color={0,0,127}));
  ...
  connect(swi1.y, swi.u1) annotation (Line(points={{32,-36},{38,-36},{38,-66},{
          46,-66}}, color={0,0,127}));
  connect(min1.u2,uBasSet)  annotation (Line(points={{38,64},{-26,64},{-26,-44},
          {-78,-44},{-78,-116},{-122,-116}},
                                           color={0,0,127}));
  connect(uTarSet, max1.u1) annotation (Line(points={{-122,-28},{-42,-28},{-42,6},
          {48,6}},    color={0,0,127}));
  connect(uTarSet, min1.u1) annotation (Line(points={{-122,-28},{-42,-28},{-42,
          76},{38,76}}, color={0,0,127}));
  connect(realNumberEqual.yEquFla, reach_uTarSet) annotation (Line(points={{62,
          150},{134,150},{134,140},{220,140}}, color={255,0,255}));
  connect(uCurSet, realNumberEqual.u1) annotation (Line(points={{-120,60},{-82,
          60},{-82,156},{38,156}}, color={0,0,127}));
  connect(uTarSet, realNumberEqual.u2) annotation (Line(points={{-122,-28},{-74,
          -28},{-74,144},{38,144}}, color={0,0,127}));
  connect(uCurSet, realNumberEqual1.u1) annotation (Line(points={{-120,60},{-6,
          60},{-6,-146},{34,-146}}, color={0,0,127}));
  connect(uBasSet, realNumberEqual1.u2) annotation (Line(points={{-122,-116},{
          -14,-116},{-14,-158},{34,-158}}, color={0,0,127}));
  connect(realNumberEqual1.yEquFla, reach_uBasSet) annotation (Line(points={{58,
          -152},{130,-152},{130,-126},{220,-126}}, color={255,0,255}));
