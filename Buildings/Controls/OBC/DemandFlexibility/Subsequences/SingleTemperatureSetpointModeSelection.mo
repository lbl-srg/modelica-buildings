...
block SingleTemperatureSetpointModeSelection
...
equation
  ...
  connect(uRat, swi1.u1) annotation (Line(points={{-120,-32},{-6,-32},{-6,22},{
          16,22}}, color={0,0,127}));
...
end SingleTemperatureSetpointModeSelection;
