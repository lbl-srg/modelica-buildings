...
equation
  ...
  connect(swi.y, selectLargestValues.u) annotation (Line(points={{-20,42},{26,
          42},{26,22},{36,22}}, color={0,0,127}));
  connect(selectLargestValues.y, yAcnFla) annotation (Line(points={{60,22},{184,
