...
model single_zone_ratchet
  ...
  Buildings.Controls.OBC.DemandFlexibility.single_zone_ratchet
    single_zone_ratchet
...
equation
  connect(timTab.y[1], single_zone_ratchet.TZonHeaSetCur) annotation (Line(
        points={{-62,12},{-38,12},{-38,11},{-30.2,11}}, color={0,0,127}));
  connect(timTab1.y[1], single_zone_ratchet.TZonCooSetCur) annotation (Line(
        points={{-62,-26},{-40,-26},{-40,7.6},{-30.2,7.6}}, color={0,0,127}));
  connect(TZon.y, single_zone_ratchet.TZon) annotation (Line(points={{-64,52},{
          -40,52},{-40,14.2},{-30.2,14.2}}, color={0,0,127}));
