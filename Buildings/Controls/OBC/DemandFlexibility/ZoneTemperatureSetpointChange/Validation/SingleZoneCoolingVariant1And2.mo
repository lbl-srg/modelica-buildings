...
equation
  connect(zonSetGen.TPreTarCooSet, setChaConCooVar1.TPreTarSet[1])
    annotation (Line(points={{-78,-132},{-20,-132},{-20,62},{18,62}},
      color={0,0,127}));
  connect(zonSetGen.TSheTarCooSet, setChaConCooVar1.TSheTarSet[1])
    annotation (Line(points={{-78,-136},{-10,-136},{-10,58},{18,58}},
      color={0,0,127}));
  connect(zonSetGen.TDefCooSet, setChaConCooVar1.TDefSet[1])
    annotation (Line(points={{-78,-140},{0,-140},{0,54},{18,54}}, color={0,0,127}));
  connect(tabDemFleMod.y[1], setChaConCooVar1.demFleMod)
    annotation (Line(points={{-78,-10},{-40,-10},{-40,66},{18,66}},
      color={255,127,0}));
  connect(conRouZonFla.y, setChaConCooVar1.rouZonFla[1])
    annotation (Line(points={{-78,110},{-30,110},{-30,86},{18,86}},
      color={255,0,255}));
  connect(delTZonSetVar1.y, setChaConCooVar1.TCurZonSet[1])
    annotation (Line(points={{82,70},{100,70},{100,40},{10,40},{10,70},{18,70}},
      color={0,0,127}));
  connect(tabTCurZon.y[1], setChaConCooVar1.TCurZon[1])
    annotation (Line(points={{-78,50},{-60,50},{-60,74},{18,74}}, color={0,0,127}));
  connect(delTZonSetVar2.y, setChaConCooVar2.TCurZonSet[1])
    annotation (Line(points={{82,-70},{100,-70},{100,-100},{8,-100},{8,-70},
      {18,-70}}, color={0,0,127}));
  connect(zonSetGen.TPreTarCooSet, setChaConCooVar2.TPreTarSet[1])
    annotation (Line(points={{-78,-132},{-20,-132},{-20,-78},{18,-78}},
      color={0,0,127}));
  connect(zonSetGen.TSheTarCooSet, setChaConCooVar2.TSheTarSet[1])
    annotation (Line(points={{-78,-136},{-10,-136},{-10,-82},{18,-82}},
      color={0,0,127}));
  connect(zonSetGen.TDefCooSet, setChaConCooVar2.TDefSet[1])
    annotation (Line(points={{-78,-140},{0,-140},{0,-86},{18,-86}},
      color={0,0,127}));
  connect(conRouZonFla.y, setChaConCooVar2.rouZonFla[1])
    annotation (Line(points={{-78,110},{-30,110},{-30,-54},{18,-54}},
      color={255,0,255}));
  connect(tabTCurZon.y[1], setChaConCooVar2.TCurZon[1])
    annotation (Line(points={{-78,50},{-60,50},{-60,-66},{18,-66}},
      color={0,0,127}));
  connect(tabDemFleMod.y[1], setChaConCooVar2.demFleMod)
    annotation (Line(points={{-78,-10},{-40,-10},{-40,-74},{18,-74}},
      color={255,127,0}));
