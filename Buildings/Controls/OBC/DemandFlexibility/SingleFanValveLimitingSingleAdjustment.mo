...
block SingleFanValveLimitingSingleAdjustment
  ...
  Subsequences.SetpointSingleStepChange setReb(setChaMod=false, samPer=
        samPerReb)
...
equation
  ...
  connect(uSetTarShe, setReb.uSetTar) annotation (Line(points={{-172,-136},{-56,
          -136},{-56,-104.222},{180.667,-104.222}},
                                  color={0,0,127}));
  ...
  connect(setReb.ySetCom, chillerTemperatureModeSelection.uReb) annotation (
      Line(points={{203.333,-102.889},{203.333,-74.5},{214.261,-74.5}},
                                                                    color={0,0,127}));
  ...
  connect(uSetNom, setReb.uSetNom) annotation (Line(points={{-172,-184},{-28,
          -184},{-28,-110},{76,-110},{76,-107.926},{180.667,-107.926}}, color={
          0,0,127}));
  ...
  connect(con.y, setReb.have_pri) annotation (Line(points={{-52,96},{64,96},{64,
          -96.8148},{180.667,-96.8148}}, color={255,0,255}));
