...
equation
  ...
  connect(TSetNom, setPre.uSetNom) annotation (Line(points={{-120,-52},{22,-52},
          {22,82},{-32,82},{-32,102.2},{-22,102.2}},
                                                color={0,0,127}));
  connect(TSetTarShe, setRat.uSetTar) annotation (Line(points={{-120,-20},{-96,
          -20},{-96,-6.8},{-28,-6.8}},
                                color={0,0,127}));
