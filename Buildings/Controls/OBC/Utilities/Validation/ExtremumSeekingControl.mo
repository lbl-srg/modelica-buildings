...
model ExtremumSeekingControl
  ...
  Buildings.Controls.OBC.Utilities.ExtremumSeekingControl trimRespondLogic(
    final iniSet=120,
    final minSet=37,
    final maxSet=370,
    final delTim=300,
  ...
  Buildings.Controls.OBC.Utilities.ExtremumSeekingControl trimRespondLogic1(
    final iniSet=120,
    final minSet=37,
    final maxSet=370,
    final delTim=300,
  ...
  Buildings.Controls.OBC.Utilities.ExtremumSeekingControl trimRespondLogic2(
    final iniSet=120,
    final minSet=37,
    final maxSet=370,
    final delTim=300,
  ...
  Buildings.Controls.OBC.Utilities.ExtremumSeekingControl trimRespondLogicHold(
    have_hol=true,
    final iniSet=120,
    final minSet=37,
    final maxSet=370,
