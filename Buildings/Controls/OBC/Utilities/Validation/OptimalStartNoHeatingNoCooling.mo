...
equation
  ...
  connect(TSetCoo.y[1], add1.u2) annotation (Line(points={{122,-50},{134,-50},{
          134,4},{138,4}}, color={0,0,127}));
  ...
  connect(TSetHea.y[1], add2.u1) annotation (Line(points={{122,90},{130,90},{
          130,56},{138,56}}, color={0,0,127}));
