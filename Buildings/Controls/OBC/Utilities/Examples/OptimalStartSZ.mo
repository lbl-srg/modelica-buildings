...
model OptimalStartSZ
  ...
  Buildings.Controls.OBC.Utilities.OptimalStart optStaHea(heating_only=true,
      cooling_only=false) "Optimal start for heating system "
...
equation
  ...
  connect(gai1.y, add4.u2) annotation (Line(points={{-48,30},{-42,30},{-42,24},
          {-32,24}},color={0,0,127}));
  connect(TSetRooHea.y[1], add4.u1) annotation (Line(points={{-89,70},{-46,70},
          {-46,36},{-32,36}},color={0,0,127}));
  connect(gai.y, add3.u1) annotation (Line(points={{-48,-10},{-46,-10},{-46,-4},
          {-32,-4}},
                   color={0,0,127}));
  connect(TSetRooCoo.y[1], add3.u2) annotation (Line(points={{-89,-50},{-44,-50},
          {-44,-16},{-32,-16}},
                           color={0,0,127}));
