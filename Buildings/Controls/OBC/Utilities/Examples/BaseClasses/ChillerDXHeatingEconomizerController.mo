...
model ChillerDXHeatingEconomizerController
  ...
  Buildings.Controls.OBC.Utilities.Examples.BaseClasses.ControllerHeatingFan
    conSup(
    minAirFlo=minAirFlo,
    kHea=kHea,
    kFan=kFan) "Heating coil, cooling coil and fan controller"
    annotation (Placement(transformation(extent={{-40,70},{-20,90}})));
  Air.Systems.SingleZone.VAV.BaseClasses.ControllerEconomizer conEco(final kEco=
...
equation
  ...
  connect(conSup.TSetRooHea, TSetRooHea) annotation (Line(points={{-41,89},{-88,
          89},{-88,100},{-120,100}},
                                   color={0,0,127}));
  connect(conSup.TSetRooCoo, TSetRooCoo) annotation (Line(points={{-41,83},{-80,
          83},{-80,60},{-120,60}}, color={0,0,127}));
  connect(conSup.TRoo, TRoo) annotation (Line(points={{-41,77},{-74,77},{-74,
          -60},{-120,-60}},
                       color={0,0,127}));
