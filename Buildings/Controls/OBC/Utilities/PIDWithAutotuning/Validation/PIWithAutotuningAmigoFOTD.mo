...
equation
  ...
  connect(firstOrder1.y, PID.u_m) annotation (Line(points={{82,30},{90,30},{90,
          8},{-10,8},{-10,18}}, color={0,0,127}));
  ...
  connect(firstOrder2.T, firstOrder1.T) annotation (Line(points={{58,-16},{44,
          -16},{44,34},{58,34}}, color={0,0,127}));
  annotation (
    experiment(
      StopTime=10000,
      Tolerance=1e-06,
