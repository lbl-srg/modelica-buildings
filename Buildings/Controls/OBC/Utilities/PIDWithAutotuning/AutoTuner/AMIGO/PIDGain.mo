...
block PIDGain "Identify the control gain of a PID controller"
  ...
  Buildings.Controls.OBC.CDL.Continuous.Divide div1
    ...
    annotation (Placement(transformation(extent={{-40,40},{-20,80}})));
...
equation
  connect(div1.u2, kp) annotation (Line(points={{-40,48},{-94,48},{-94,60},{-120,
          60}},      color={0,0,127}));
  ...
  connect(div1.y, mul.u1) annotation (Line(points={{-16,60},{42,60},{42,6},{58,6}},
               color={0,0,127}));
