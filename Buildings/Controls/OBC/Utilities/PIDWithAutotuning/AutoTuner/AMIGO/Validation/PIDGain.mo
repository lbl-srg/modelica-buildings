...
equation
  connect(RefDat.y[1], PIDGai.kp) annotation (Line(points={{-38,0},{-20,0},{-20,
          6},{-12,6}}, color={0,0,127}));
  connect(PIDGai.T, RefDat.y[2])
    annotation (Line(points={{-12,0},{-38,0}}, color={0,0,127}));
  connect(PIDGai.L, RefDat.y[3]) annotation (Line(points={{-12,-6},{-20,-6},{-20,
