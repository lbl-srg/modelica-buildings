...
model PIDIntegralTime "Test model for PIDIntergralTime"
  Buildings.Controls.OBC.Utilities.PIDWithAutotuning.AutoTuner.AMIGO.PIDIntegralTime
    PIDIntTim "Calculate the integral time for a PID controller"
...
equation
  connect(RefDat.y[2], PIDIntTim.T) annotation (Line(points={{-38,0},{-20,0},{-20,
          6},{-12,6}}, color={0,0,127}));
  connect(PIDIntTim.L, RefDat.y[3]) annotation (Line(points={{-12,-6},{-20,-6},
...
Buildings.Controls.OBC.Utilities.PIDWithAutotuning.AutoTuner.AMIGO.PIDIntegralTime</a>.
</p>
<p>
