...
block TimeConstantDelay
  "Calculates the time constant and time delay of a first order time delayed model"
...
equation
  ...
  connect(relayDeaBan.y, div1.u1) annotation (Line(points={{22,40},{28,40},{28,0},
          {-20,0},{-20,-14},{-2,-14}}, color={0,0,127}));
  connect(div1.u2, absk.y) annotation (Line(points={{-2,-26},{-40,-26},{-40,0},{
          -58,0}}, color={0,0,127}));
  ...
  connect(exp.y, mul1.u1) annotation (Line(points={{-58,-60},{-6,-60},{-6,60},{
          54,60},{54,46},{58,46}}, color={0,0,127}));
  ...
  connect(sub1.u1, add2.u1) annotation (Line(points={{16,-64},{-52,-64},{-52,16},
          {38,16}}, color={0,0,127}));
  connect(sub1.y, div2.u2) annotation (Line(points={{40,-70},{48,-70},{48,-74},{
          58,-74}},  color={0,0,127}));
  connect(div2.u1, add1.y) annotation (Line(points={{58,-62},{54,-62},{54,-48},{
          84,-48},{84,-30},{82,-30}}, color={0,0,127}));
  connect(div2.y, log.u) annotation (Line(points={{82,-68},{84,-68},{84,-90},{
          -18,-90}}, color={0,0,127}));
  ...
  connect(mul2.u2, T) annotation (Line(points={{-2,78},{-12,78},{-12,70},{110,70}},
        color={0,0,127}));
  connect(mul2.u1, exp.u) annotation (Line(points={{-2,90},{-90,90},{-90,-60},{-82,
          -60}}, color={0,0,127}));
  connect(mul2.y, L) annotation (Line(points={{22,84},{90,84},{90,-60},{110,-60}},
        color={0,0,127}));
  connect(sub1.u2, div1.y) annotation (Line(points={{16,-76},{10,-76},{10,-34},{
...
<P> T = t<sub>on</sub>/(ln((&delta;/|k|-yLow+exp(L/T)(yHig + yLow))/(yHig-&delta;/|k|)))</p>
