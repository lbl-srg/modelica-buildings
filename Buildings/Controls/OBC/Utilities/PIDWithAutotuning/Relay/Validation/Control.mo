...
model Control "Test model for Control"
  ...
  Buildings.Controls.OBC.Utilities.PIDWithAutotuning.Relay.Control control(
    yHig=1,
    yLow=0.5,
...
equation
  ...
  annotation (
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/Utilities/PIDWithAutotuning/Relay/Validation/Control.mos" "Simulate and plot"),
