...
block HalfPeriodRatio
  ...
  CDL.Interfaces.BooleanOutput trigger
    "Relay tuning status, true if the tuning completes"
...
equation
  ...
  connect(tminSample.y, gretminChange.u2) annotation (Line(points={{22,0},{22,
          -56},{-60,-56},{-60,-48},{-42,-48}},
                                color={0,0,127}));
  ...
  connect(halfPeriodRatioCal.y, rho) annotation (Line(points={{82,0},{96,0},{96,
          60},{110,60}}, color={0,0,127}));
  connect(trigger, tOffSample.trigger) annotation (Line(points={{110,-60},{80,-60},
          {80,-40},{10,-40},{10,-58}}, color={255,0,255}));
