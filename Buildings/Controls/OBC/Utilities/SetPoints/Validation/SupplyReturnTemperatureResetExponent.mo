...
equation
  ...
  connect(TRoo.y, heaCur.TSetZon)
    annotation (Line(points={{-38,20},{-10,20},{-10,34},{18,34}},
      color={0,0,127}));

  connect(heaCurM.TOut, TOut.y) annotation (Line(points={{18,-4},{0,-4},{0,60},{
          -38,60}}, color={0,0,127}));
  connect(TRoo.y,heaCurM. TSetZon) annotation (Line(points={{-38,20},{-10,20},{-10,
          -16},{18,-16}}, color={0,0,127}));
annotation (experiment(Tolerance=1e-6, StopTime=1.0),
  __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/Utilities/SetPoints/Validation/SupplyReturnTemperatureResetExponent.mos"
      "Simulate and plot"),
