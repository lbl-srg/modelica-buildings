...
model SteamDerivativeCheck
  ...
  Modelica.SIunits.Temperature T
    "Temperature";
  Modelica.SIunits.SpecificEnthalpy hVapSym
    "Vapor phase specific enthalpy";
  Modelica.SIunits.SpecificEnthalpy hVapCod
    "Vapor phase specific enthalpy";
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1E-10),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Media/Examples/SteamDerivativeCheck.mos" "Simulate and plot"),
    Documentation(
      info="<html>
