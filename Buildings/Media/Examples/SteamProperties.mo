...
equation
  ...
  ddhp=Medium.density_derh_p(
    state_pTX);
  ddph=Medium.density_derp_h(
    state_pTX);
  ...
  annotation (
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Media/Examples/SteamProperties.mos" "Simulate and plot"),
    Documentation(
      info="<html>
