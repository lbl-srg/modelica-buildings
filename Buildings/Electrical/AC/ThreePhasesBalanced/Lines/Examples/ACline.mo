...
model ACline
  ...
  Loads.InductiveLoadP
               loadRL(                mode=Types.Assumption.FixedZ_steady_state,
    V_nominal=380,
  ...
  Line line2(
    ...
    P_nominal=5000,
    mode=Types.CableMode.commercial,
    commercialCable_low=Transmission.LowVoltageCables.Cu35(),
    l=500,
    voltageLevel=Types.VoltageLevel.Low)
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=0,
        origin={-10,30})));
  Loads.InductiveLoadP
               loadRL1(               mode=Types.Assumption.FixedZ_steady_state,
    V_nominal=380,
    P_nominal=5000)                   annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
  ...
  Loads.InductiveLoadP
               loadRL2(
                      P_nominal=2500, mode=Types.Assumption.FixedZ_steady_state,
