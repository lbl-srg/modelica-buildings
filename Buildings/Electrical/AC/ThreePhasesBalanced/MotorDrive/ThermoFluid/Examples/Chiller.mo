...
equation
  ...
  connect(TEva_in.y,sou2. T_in) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(sou1.ports[1], Chi.port_a1) annotation (Line(points={{-40,10},{-26,10},
          {-26,6},{-10,6}}, color={0,127,255}));
  connect(Chi.port_a2, sou2.ports[1]) annotation (Line(points={{10,-6},{26,-6},
          {26,-10},{40,-10}}, color={0,127,255}));
  connect(sin2.ports[1], Chi.port_b2) annotation (Line(points={{-40,-30},{-26,-30},
          {-26,-6},{-10,-6}}, color={0,127,255}));
  connect(Chi.port_b1, sin1.ports[1]) annotation (Line(points={{10,6},{26,6},{
