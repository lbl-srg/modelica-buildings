...
model HeatPump "This example shows how to use the motor coupled heat pump model"
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem(redeclare package Medium = MediumW,
    ...
    T_start=303.15)                 "Temperature sensor"
    annotation (Placement(transformation(extent={{40,20},{60,40}})));
  Modelica.Blocks.Sources.Step TSet(
    height=10,
    offset=273.15 + 30,
    startTime=200) "Condenser side leaving water temperature set point"
...
equation
  connect(hea.port_a2, sou2.ports[1]) annotation (Line(points={{10,-7.77778},{10,
          -6},{34,-6},{34,-20},{40,-20}},
                              color={0,127,255}));
