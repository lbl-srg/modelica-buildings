...
<p>
<i>R<sub>eq</sub></i> and <i>X<sub>eq</sub></i> are the equivalent resistance and 
reactance of induction motor per-phase equivalent circuit, can be calculated as follows: 
</p>
