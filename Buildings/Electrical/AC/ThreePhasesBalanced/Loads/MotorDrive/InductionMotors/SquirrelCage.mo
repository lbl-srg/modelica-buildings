...
equation
  ...
  connect(volAngFre.y, speBlo.omega) annotation (Line(points={{-19,80},{0,80},{0,
          40},{-40,40},{-40,-86},{-22,-86}},   color={0,0,127}));
  ...
  connect(volAngFre.y, gai.u) annotation (Line(points={{-19,80},{0,80},{0,40},{-40,
          40},{-40,0},{-22,0}},     color={0,0,127}));
