...
model MotorModel1
  ...
  StatorCurrent_q i_qs_block(
    ...
    Lm=Lm,
    Rs=Rs,
    Ls=Ls) annotation (Placement(transformation(extent={{12,80},{32,100}})));
  StatorCurrent_d i_ds_block(
    Lr=Lr,
    Rr=Rr,
    Lm=Lm,
    Rs=Rs,
    Ls=Ls) annotation (Placement(transformation(extent={{10,40},{30,60}})));
  RotorCurrent_q i_qr_block(
    Lr=Lr,
    Rr=Rr,
    Lm=Lm) annotation (Placement(transformation(extent={{8,-50},{28,-30}})));
  RotorCurrent_d i_dr_block(
    Lr=Lr,
    Rr=Rr,
    Lm=Lm) annotation (Placement(transformation(extent={{10,-110},{30,-90}})));
equation
  connect(i_qr_block.der_i_qr, int_qr.u)
    annotation (Line(points={{30,-40},{48,-40}}, color={238,46,47}));

  connect(i_dr, i_dr)
    annotation (Line(points={{160,-100},{160,-100}},
                                                   color={0,0,127}));
  connect(v_qs, i_qs_block.v_qs) annotation (Line(
      points={{-160,100},{-101,100},{-101,99.8},{10,99.8}},
      color={0,0,127},
      thickness=0.5));
  connect(omega, i_qs_block.omega) annotation (Line(
      points={{-160,0},{-80,0},{-80,88},{-40,88},{-40,87.8},{10,87.8}},
      color={244,125,35},
      thickness=0.5));
  ...
  connect(v_ds, i_ds_block.v_ds) annotation (Line(
      ...
      color={0,0,127},
      thickness=0.5));
  connect(i_qs_block.der_i_qs, int_qs.u) annotation (Line(points={{34.7,89.9},{
          39.35,89.9},{39.35,90},{48,90}},        color={238,46,47}));
  connect(i_dr_block.der_i_dr, int_dr.u) annotation (Line(points={{32.1,
          -100.1},{40.155,-100.1},{40.155,-100},{48,-100}},
                                                    color={238,46,47}));
  connect(i_ds_block.i_ds, i_qs_block.i_ds) annotation (Line(points={{8,56},{0,
          56},{0,80},{10,80}},      color={28,108,200}));
  ...
  connect(i_qr_block.omega_r, omega_r) annotation (Line(
      points={{6,-42.4},{-80,-42.4},{-80,-94},{-160,-94}},
      color={0,140,72},
      thickness=0.5));
  connect(int_ds.y, i_qs_block.i_ds) annotation (Line(points={{71,50},{80,50},{
          80,70},{0,70},{0,80},{10,80}},     color={28,108,200}));
  connect(i_qr_block.i_ds, i_qs_block.i_ds) annotation (Line(points={{6,-50},{0,
          -50},{0,80},{10,80}},   color={28,108,200}));
  connect(i_dr_block.i_qs, i_qs_block.i_qs) annotation (Line(points={{8,-110},{
          -10,-110},{-10,96},{10,96},{10,95.8}},      color={28,108,200}));
  connect(int_qs.y, i_qs_block.i_qs) annotation (Line(points={{71,90},{80,90},{
          80,114},{-10,114},{-10,96},{10,96},{10,95.8}},    color={28,108,
          200}));
  connect(i_qr_block.i_qr, i_dr_block.i_qr) annotation (Line(points={{6,-34.2},
          {-30,-34.2},{-30,-106},{8,-106}},        color={28,108,200}));
  connect(i_ds_block.i_qr, i_dr_block.i_qr) annotation (Line(points={{8,43.6},{
          8,44},{-30,44},{-30,-106},{8,-106}},        color={28,108,200}));
  connect(int_qr.y, i_dr_block.i_qr) annotation (Line(points={{71,-40},{80,
          -40},{80,0},{-30,0},{-30,-106},{8,-106}}, color={28,108,200}));
  connect(i_qr_block.i_dr, i_dr_block.i_dr) annotation (Line(points={{6,-46.2},
          {6,-46},{-20,-46},{-20,-94},{8,-94}},        color={28,108,200}));
  connect(i_qs_block.i_dr, i_dr_block.i_dr) annotation (Line(points={{10,84},{
  ...
  connect(i_qr_block.der_i_qr, i_qs_block.der_i_qr) annotation (Line(points={{30,-40},
          {40,-40},{40,-20},{-68,-20},{-68,91.8},{10,91.8}},         color=
          {238,46,47}));
  connect(i_ds_block.der_i_dr, int_dr.u) annotation (Line(points={{8,52.2},{8,
          52},{-60,52},{-60,-80},{40,-80},{40,-100.1},{38.155,-100.1},{38.155,
          -100},{48,-100}},        color={238,46,47}));
  connect(i_qr_block.der_i_qs, int_qs.u) annotation (Line(points={{6,-38.2},{6,
          -38.2},{6,-38},{-48,-38},{-48,108},{40,108},{40,90},{48,90}},
        color={238,46,47}));
  ...
  connect(int_dr.y, i_dr) annotation (Line(points={{71,-100},{160,-100}},
                      color={28,108,200},
      thickness=0.5));
  connect(i_ds_block.der_i_ds, int_ds.u) annotation (Line(points={{32.7,50.1},{
          34,50.1},{34,50},{48,50}},        color={238,46,47}));
  connect(i_ds_block.i_qs, i_qs_block.i_qs) annotation (Line(points={{8,40},{
          -10,40},{-10,96},{10,96},{10,95.8}},color={28,108,200}));
  connect(int_ds.u, i_ds_block.der_i_ds) annotation (Line(points={{48,50},{
          40.35,50},{40.35,50.1},{32.7,50.1}}, color={0,0,127}));
  annotation (
