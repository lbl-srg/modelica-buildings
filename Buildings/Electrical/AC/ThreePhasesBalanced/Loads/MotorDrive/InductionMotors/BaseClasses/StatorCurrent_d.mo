...
model StatorCurrent_d "d-axis stator current calculation block"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput der_i_dr "Derivative of D-axis rotore current"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput der_i_ds "Derivative of D-axis stator current"
