  ...
  protected
    Modelica.Blocks.Interfaces.RealOutput G_int
      "Total solar irradiation per unit area" annotation (Placement(
          ...
          rotation=270,
          origin={0,100})));
    Modelica.SIunits.Power P1,P2,P3 "Powers generated by the three PV panels";
  equation
    P = P1 + P2 + P3;
    ...
    if PlugPhase1 then
      ...
      connect(pv_phase1.G, G_int)
                               annotation (Line(
          points={{-28,62},{-28,80},{-46,80},{-46,20},{-66,20}},
          color={0,0,127},
          smooth=Smooth.None));
      P1 = pv_phase1.P;
    else
    ...
    if PlugPhase3 then
      ...
      connect(G_int, pv_phase3.G)
                               annotation (Line(
          points={{-66,20},{-46,20},{-46,-26},{-30,-26},{-30,-38}},
          color={0,0,127},
          smooth=Smooth.None));
      P3 = pv_phase3.P;
    else
