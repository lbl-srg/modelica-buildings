...
model AC_InHomeGrid
  ...
  AC.ThreePhasesUnbalanced.Lines.Network network(redeclare
  ...
  AC.ThreePhasesUnbalanced.Loads.Resistive load[20](
    each P_nominal=1000,
  ...
  AC.ThreePhasesUnbalanced.Sources.FixedVoltage source(
    f=50,
    Phi=0,
