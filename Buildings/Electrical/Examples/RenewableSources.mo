...
<p>
This image shows the ratio of the energy produced by renewable energy sources
and the energy consumed by the loads over one year. The red lines indicates the
Net-Zero Energy goal while the blue line indicates the actual ratio for the
small neighborhood represented by the model.
</p>
<p align=\"center\">
...
renewable sources and also with respect to the ratio of energy produced by renewables and 
energy consumed by the loads. As expected, when the power produced by the renewables (and thus the
ratio increases) the voltage deviation increase, causing possible damages and/or instabilities to the electrical grid.
</p>
<p align=\"center\">
