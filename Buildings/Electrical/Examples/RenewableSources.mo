...
renewable sources and also with respect to the ration of energy produced by renewables and 
energy consumed by the loads. As expected, when the power produced by the renewables (and thus the
ratio increases) the voltage deviation increase, causing possible damages to the electrical grid.
</p>
<p align=\"center\">
