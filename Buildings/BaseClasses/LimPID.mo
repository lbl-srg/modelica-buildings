  ...
  Utilities.Math.IntegratorWithReset I(
    ...
    final initType=if initType == Modelica.Blocks.Types.InitPID.SteadyState then
        Modelica.Blocks.Types.Init.SteadyState
             ...
             else Modelica.Blocks.Types.Init.NoInit)  "Integral term"
    ...
    final initType=if initType == Modelica.Blocks.Types.InitPID.SteadyState or
             ...
             then
               ...
               if initType == Modelica.Blocks.Types.InitPID.InitialState then
                 ...
                 Modelica.Blocks.Types.Init.NoInit)  "Derivative term"
                                                     annotation (Placement(
...
protected
  ...
  Modelica.Blocks.Sources.Constant Dzero(final k=0)
    "Zero input signal"
    annotation(Evaluate=true, HideResult=true,
               Placement(transformation(extent={{-42,26},{-32,36}})));

          //     if not with_D

  Modelica.Blocks.Sources.Constant Izero(final k=0)
    "Zero input signal"
    annotation(Evaluate=true, HideResult=true,
               Placement(transformation(extent={{-64,-27},{-54,-17}})));
...
public
  Modelica.Blocks.Sources.BooleanExpression booleanExpression(y=not with_D)
    annotation (Placement(transformation(extent={{-54,14},{-42,26}})));
  Modelica.Blocks.Logical.Switch switch1
    annotation (Placement(transformation(extent={{-24,14},{-14,24}})));
  Modelica.Blocks.Sources.BooleanExpression booleanExpression1(y=not with_I)
    annotation (Placement(transformation(extent={{-50,-36},{-38,-24}})));
  Modelica.Blocks.Logical.Switch switch2
    annotation (Placement(transformation(extent={{-20,-34},{-10,-24}})));
initial equation
...
equation
  ...
  connect(u_m, addI.u2) annotation (Line(
      ...
      color={0,0,127},
      thickness=0.5));
  connect(trigger, I.trigger) annotation (Line(points={{-80,-120},{-80,-88},{-40,
          -88},{-40,-62}}, color={255,0,255}));
  connect(intRes.y, I.y_reset_in) annotation (Line(points={{-59,-80},{-56,-80},{
          -56,-58},{-52,-58}}, color={0,0,127}));
  connect(booleanExpression.y, switch1.u2) annotation (Line(points={{-41.4,20},{
          -25,20},{-25,19}}, color={255,0,255}));
  connect(Dzero.y, switch1.u1) annotation (Line(points={{-31.5,31},{-28,31},{-28,
          23},{-25,23}}, color={0,0,127}));
  connect(D.y, switch1.u3) annotation (Line(points={{-29,0},{-28,0},{-28,15},{-25,
          15}}, color={0,0,127}));
  connect(addPID.u2, switch1.y) annotation (Line(points={{-2,0},{-12,0},{-12,19},
          {-13.5,19}}, color={0,0,127}));
  connect(booleanExpression1.y, switch2.u2) annotation (Line(points={{-37.4,-30},
          {-22,-30},{-22,-29},{-21,-29}}, color={255,0,255}));
  connect(Izero.y, switch2.u1) annotation (Line(points={{-53.5,-22},{-38,-22},{-38,
          -25},{-21,-25}}, color={0,0,127}));
  connect(I.y, switch2.u3) annotation (Line(points={{-29,-50},{-26,-50},{-26,-48},
          {-21,-48},{-21,-33}}, color={0,0,127}));
  connect(switch2.y, addPID.u3) annotation (Line(points={{-9.5,-29},{-8,-29},{-8,
          -8},{-2,-8}}, color={0,0,127}));
   annotation (
