...
model OnlyExteriorWallNoWindow "Test model for room model"
  ...
  extends BaseClasses.PartialTestModel(
   ...
   annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Rooms/Examples/TestConditionalConstructionsMixedAir/OnlyExteriorWallNoWindow.mos"
        "Simulate and plot"),
