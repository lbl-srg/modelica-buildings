...
record ModInsulExtWall =
  Buildings.HeatTransfer.Data.OpaqueConstructions.Generic(final material={
    ...
    final nLay = 4)
  "Moderately insulated exterior wall. Used on the North side of cell 90X3A. 24 mm of rigid insulation, 13 mm of plywood, 83 mm of rigid insulation, 16 mm of gypsum wallboard";
