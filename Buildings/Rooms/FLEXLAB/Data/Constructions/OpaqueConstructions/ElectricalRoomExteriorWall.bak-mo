...
record ElectricalRoomExteriorWall =
  Buildings.HeatTransfer.Data.OpaqueConstructions.Generic(final material={
    ...
    final nLay = 4) "Insulated wall used on the exterior of the electrical room. Used on the north side 
     of the electrical room in cell 90X3A. 127 mm insulation, 13 mm plywood, 203 mm 
