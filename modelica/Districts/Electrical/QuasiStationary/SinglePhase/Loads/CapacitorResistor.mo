...
model CapacitorResistor "Model of a capacitive and resistive load"
  extends
    Districts.Electrical.QuasiStationary.SinglePhase.Loads.BaseClasses.InductorResistor(
     lagging = false);
...
<a href=\"modelica://Districts.Electrical.QuasiStationary.SinglePhase.Loads.InductorResistor\">
Districts.Electrical.QuasiStationary.SinglePhase.Loads.InductorResistor</a>.</p>
<p>
