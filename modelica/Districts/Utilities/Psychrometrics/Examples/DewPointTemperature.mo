...
model DewPointTemperature "Unit test for dew point temperature calculation"
  ...
  Districts.Utilities.Psychrometrics.TDewPoi_pW TDewPoi
...
equation
  ...
  connect(TDewPoi.T, watVapPre.T) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  annotation(__Dymola_Commands(file="modelica://Districts/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/DewPointTemperature.mos" "Simulate and plot"), Diagram(
