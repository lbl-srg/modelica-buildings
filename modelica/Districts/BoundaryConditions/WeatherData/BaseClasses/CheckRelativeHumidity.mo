within Districts.BoundaryConditions.WeatherData.BaseClasses;
...
equation
  relHumOut = Districts.Utilities.Math.Functions.smoothLimit(
    relHumIn,
    relHumMin,
    relHumMax,
    delta/10);
...
First implementation.
    ...
    Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100},{100,
            100}}), graphics={Bitmap(extent={{-56,52},{62,-42}}, fileName=
              "modelica://Districts/Resources/Images/Utilities/IO/WeatherData/BaseClasses/RelativeHumidity.png")}));
