...
model ZenithAngle "Test model for zenith angle"
  ...
  import Districts;
  Districts.BoundaryConditions.SolarGeometry.ZenithAngle zen(lat = 0.2)
...
equation
  connect(weaDat.weaBus, zen.weaBus) annotation (Line(
      ...
      thickness=0.5,
      smooth=Smooth.None));
  annotation (Diagram(graphics), __Dymola_Commands(file="modelica://Districts/Resources/Scripts/Dymola/BoundaryConditions/SolarGeometry/Examples/ZenithAngle.mos"
        "Simulate and plot"));
end ZenithAngle;
