...
partial model PartialSurfaceInterface
  ...
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a conExt[NConExt]
    ...
    annotation (Placement(transformation(extent={{230,210},{250,230}}, rotation
          =0)));
  ...
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a conExtWin[NConExtWin]
    ...
    annotation (Placement(transformation(extent={{230,170},{250,190}}, rotation
          =0)));

  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a conExtWinFra[NConExtWin]
    "Heat port that connects to room-side surface of window frame" annotation (
      Placement(transformation(extent={{232,-10},{252,10}}, rotation=0)));
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a conPar_a[NConPar]
    ...
    annotation (Placement(transformation(extent={{232,-70},{252,-50}}, rotation
          =0)));
...
protected
  ...
  final parameter Modelica.SIunits.Area AConExtWinGla[NConExtWin]=(1 .-
      datConExtWin.fFra) .* datConExtWin.AWin
    "Glass areas of exterior construction that have a window";
  final parameter Modelica.SIunits.Area AConExtWinFra[NConExtWin]=datConExtWin.fFra
       .* datConExtWin.AWin
  ...
  parameter Modelica.SIunits.Emissivity epsConExtWinUns[NConExtWin]={(
      datConExtWin[i].glaSys.glass[datConExtWin[i].glaSys.nLay].absIR_b) for i
       in 1:NConExtWin} "Absorptivity of unshaded part of window constructions";
