...
scaM_flow*(5.196+2.8428+1.0044+0.9612+0.3624+0.1584);
  ...
  Modelica.Blocks.Interfaces.RealOutput dPRoo "Room pressurization" 
        ...
        320,160],                                                                        rotation=0);
equation
  connect(p, roo45.pAtm) annotation (points=[-118,180; -60,180; -60,40; -36,40;
        -36,27.5; -31.25,27.5], style(
      color=74,
      rgbcolor={0,0,127},
      fillColor=74,
      rgbfillColor={0,0,127},
      fillPattern=1));
  connect(p, roo46.pAtm) annotation (points=[-118,180; -60,180; -60,40; 24,40;
        24,27.5; 28.75,27.5], style(
      color=74,
      rgbcolor={0,0,127},
      fillColor=74,
      rgbfillColor={0,0,127},
      fillPattern=1));
  connect(p, roo47.pAtm) annotation (points=[-118,180; -60,180; -60,40; 84,40;
        84,27.5; 88.75,27.5], style(
      color=74,
      rgbcolor={0,0,127},
      fillColor=74,
      rgbfillColor={0,0,127},
      fillPattern=1));
  connect(p, roo48.pAtm) annotation (points=[-118,180; -60,180; -60,40; 144,40;
        144,27.5; 148.75,27.5], style(
      color=74,
      rgbcolor={0,0,127},
      fillColor=74,
      rgbfillColor={0,0,127},
      fillPattern=1));
  connect(p, roo49.pAtm) annotation (points=[-118,180; -60,180; -60,40; 204,40;
        204,27.5; 208.75,27.5], style(
      color=74,
      rgbcolor={0,0,127},
      fillColor=74,
      rgbfillColor={0,0,127},
      fillPattern=1));
  connect(p, roo50.pAtm) annotation (points=[-118,180; -60,180; -60,40; 262,40;
        262,27.5; 268.75,27.5], style(
      color=74,
      rgbcolor={0,0,127},
      fillColor=74,
      rgbfillColor={0,0,127},
  ...
  connect(mix54.port_2, mix53.port_1) annotation (Line(
      points={{50,-40},{72,-40},{72,-40},{90,-40}},
      color={0,127,255},
      smooth=Smooth.None));
