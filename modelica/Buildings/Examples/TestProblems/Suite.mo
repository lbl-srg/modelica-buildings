...
model Suite "Model of a suite consisting of five rooms of the MIT system model"
  ...
  Fluid.MixingVolumes.MixingVolume           ple(
    ...
    nPorts=2,
    m_flow_nominal=1,
    V=1) "Plenum volume"  annotation (extent=[-10,-70; 10,-50], Placement(
  ...
  Fluid.FixedResistances.FixedResistanceDpM r13(
    ...
    allowFlowReversal=true)
        ...
        rotation=0,
        origin={-10,140})));
  Fluid.FixedResistances.FixedResistanceDpM r21(
    redeclare package Medium = Medium,
    dp_nominal=20,
    from_dp=true,
    m_flow_nominal=1,
    ...
    allowFlowReversal=true)
        ...
        rotation=270,
        origin={20,-30})));
  Fluid.FixedResistances.FixedResistanceDpM r22(
    redeclare package Medium = Medium,
    dp_nominal=20,
    from_dp=true,
    m_flow_nominal=1,
    ...
    allowFlowReversal=true)
        ...
        rotation=180,
        origin={52,-40})));
  Fluid.FixedResistances.FixedResistanceDpM r23(
    redeclare package Medium = Medium,
    dp_nominal=20,
    from_dp=true,
    m_flow_nominal=1,
...
equation
  ...
  connect(r11.port_a, vol.ports[2]) annotation (Line(
      ...
      color={0,127,255},
      smooth=Smooth.None));
  connect(ple.ports[2], r21.port_a) annotation (Line(
      points={{18,2},{20,2},{20,-20}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(r23.port_a, r13.port_a) annotation (Line(
      points={{-20,-40},{-40,-40},{-40,140},{-20,140}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(r12.port_a, r22.port_a) annotation (Line(
      points={{62,140},{80,140},{80,-40},{62,-40}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(r21.port_b, r23.port_b) annotation (Line(
      points={{20,-40},{0,-40}},
      color={0,127,255},
      smooth=Smooth.None));
  connect(r21.port_b, r22.port_b) annotation (Line(
      points={{20,-40},{42,-40}},
      color={0,127,255},
      smooth=Smooth.None));
