...
package DoubleSpeed "Performance data for DoubleSpeed DXCoils"
 annotation(preferredView="info", Documentation(info="<html>Package with performance data for DX coils.</html>", revisions="<html>Generated on 11/21/2012 16:05 by tsnouidui.</html>"));
  record Generic "Generic data record for DoubleSpeed DXCoils"
    extends CoilData(final nSta=2, per);
...
First implementation.
  ...
  record  Lennox_KCA120S4 =
    Buildings.Fluid.HeatExchangers.DXCoils.Data.DoubleSpeed.Generic (per = {
     Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.Generic(spe = 1200,
     nomVal = Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.NominalValues(
      ...
      ffMin =                0.8,
      ffMax =                1.2)),
     Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.Generic(spe = 1200*35235.87/17193.23,
     nomVal = Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.NominalValues(
  ...
  record  Lennox_KCA240S4 =
    Buildings.Fluid.HeatExchangers.DXCoils.Data.DoubleSpeed.Generic (per = {
     ...
     nomVal = Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.NominalValues(
      ...
      ffMin =                0.8,
      ffMax =                1.2)),
     Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.Generic(spe = 1200*69944.52/46951.87,
     nomVal = Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.NominalValues(
  ...
  record  Lennox_SCA120H4B =
    Buildings.Fluid.HeatExchangers.DXCoils.Data.DoubleSpeed.Generic (per = {
     ...
     nomVal = Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.NominalValues(
      ...
      ffMin =                0.8,
      ffMax =                1.2)),
     Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.Generic(spe = 1200*36436.76/18218.38,
     nomVal = Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.NominalValues(
  ...
  record  Lennox_SCA240H4B =
    Buildings.Fluid.HeatExchangers.DXCoils.Data.DoubleSpeed.Generic (per = {
     ...
     nomVal = Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.NominalValues(
      ...
      ffMin =                0.8,
      ffMax =                1.2)),
     Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.Generic(spe = 1200*72873.52/35411.61,
     nomVal = Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.NominalValues(
  ...
  record  Lennox_TCA120S =
    Buildings.Fluid.HeatExchangers.DXCoils.Data.DoubleSpeed.Generic (per = {
     ...
     nomVal = Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.NominalValues(
      ...
      ffMin =                0.8,
      ffMax =                1.2)),
     Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.Generic(spe = 1200*37139.72/18276.96,
     nomVal = Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.NominalValues(
  ...
  record  Lennox_TCA240S =
    Buildings.Fluid.HeatExchangers.DXCoils.Data.DoubleSpeed.Generic (per = {
     ...
     nomVal = Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.NominalValues(
      ...
      ffMin =                0.8,
      ffMax =                1.2)),
     Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.Generic(spe = 1200*71174.7/49207.2,
     nomVal = Buildings.Fluid.HeatExchangers.DXCoils.Data.BaseClasses.NominalValues(
