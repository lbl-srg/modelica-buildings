...
protected
  ...
  Modelica.Blocks.Math.Gain gai_1(k=1/nEle)
    ...
    annotation (Placement(transformation(extent={{-18,84},{-6,96}}, rotation=0)));
  Modelica.Blocks.Math.Gain gai_2(k=1/nEle)
    "Gain medium-side 2 to take discretization into account"
    annotation (Placement(transformation(extent={{-18,62},{-6,74}}, rotation=0)));
...
equation
  ...
  connect(hA.hA_1, gai_1.u)
    annotation (Line(points={{-39,97},{-28,97},{-28,90},{-19.2,90}}, color={0,0,
          255}));
  connect(hA.hA_2, gai_2.u)             annotation (Line(points={{-39,83},{-27.5,
          83},{-27.5,68},{-19.2,68}},       color={0,0,255}));
