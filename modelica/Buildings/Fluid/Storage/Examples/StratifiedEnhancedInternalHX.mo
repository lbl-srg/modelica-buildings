...
model StratifiedEnhancedInternalHX
  ...
  Buildings.Fluid.Storage.StratifiedEnhancedInternalHX tan(
    ...
    redeclare package Medium_2 = Buildings.Media.ConstantPropertyLiquidWater,
    m_flow_nominal=0.1,
    VTan=0.15,
    hTan=1,
    dIns=0.01,
  ...
  Buildings.Fluid.Sources.Boundary_pT boundary(redeclare package Medium =
        Buildings.Media.ConstantPropertyLiquidWater, nPorts=1) annotation (
  ...
  Buildings.Fluid.Sources.Boundary_pT boundary3(nPorts=1, redeclare package
      Medium = Buildings.Media.ConstantPropertyLiquidWater) annotation (
      Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={60,42})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem(redeclare package Medium =
        Buildings.Media.ConstantPropertyLiquidWater, m_flow_nominal=0.1)
