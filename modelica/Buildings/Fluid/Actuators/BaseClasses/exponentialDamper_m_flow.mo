...
function exponentialDamper_m_flow
  "Pressure drop for damper with exponential opening characteristics"
...
<p>
This function computes the pressure drop as a function of the mass flow rate and
...
smoothOrder=1,
inverse(m_flow=Buildings.Fluid.Actuators.BaseClasses.exponentialDamper_dp(
            dp, m_flow_turbulent, linearized,
            y, a, b, cL, cU, yL, yU, rho, A, kFixed)));
end exponentialDamper_m_flow;
