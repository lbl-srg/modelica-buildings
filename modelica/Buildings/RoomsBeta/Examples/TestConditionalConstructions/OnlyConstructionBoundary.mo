...
equation
  connect(TBou1.port, roo.surf_conBou) annotation (Line(
      ...
      color={191,0,0},
      smooth=Smooth.None));
   annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/RoomsBeta/Examples/TestConditionalConstructions/OnlyConstructionBoundary.mos" "Simulate and plot"),
