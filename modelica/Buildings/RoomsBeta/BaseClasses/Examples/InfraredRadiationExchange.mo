...
model InfraredRadiationExchange "Test model for infrared radiation exchange"
  ...
  Buildings.RoomsBeta.BaseClasses.InfraredRadiationExchange irRadExc(
    nConExt=nConExt,
...
equation
  ...
  connect(radSou.JOut, irRadExc.JInConExtWin)     annotation (Line(
      ...
      color={0,127,0},
      smooth=Smooth.None));
  annotation (Diagram(graphics), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/RoomsBeta/BaseClasses/Examples/InfraredRadiationExchange.mos" "Simulate and plot"));
