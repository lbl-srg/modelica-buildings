model Printer "Model that prints values to a file" 
  ...
  annotation (Icon(Text(
        ...
        style(
          ...
          fillPattern=1),
        string="%fileName"),
      Polygon(points=[-56,76; -56,-72; 50,-72; 76,-50; 76,76; -56,76], style(
          color=0,
          rgbcolor={0,0,0},
          fillColor=7,
          rgbfillColor={255,255,255},
          fillPattern=1)),   Rectangle(extent=[-40,58; -4,50], style(
          color=0,
          rgbcolor={0,0,0},
          fillColor=0,
          rgbfillColor={0,0,0},
          fillPattern=1)),   Rectangle(extent=[12,58; 48,50], style(
          color=0,
          rgbcolor={0,0,0},
          fillColor=0,
          rgbfillColor={0,0,0},
          fillPattern=1)),   Rectangle(extent=[12,26; 48,18], style(
          color=0,
          rgbcolor={0,0,0},
          fillColor=0,
          rgbfillColor={0,0,0},
          fillPattern=1)),   Rectangle(extent=[-40,26; -4,18], style(
          color=0,
          rgbcolor={0,0,0},
          fillColor=0,
          rgbfillColor={0,0,0},
          fillPattern=1)),   Rectangle(extent=[12,-10; 48,-18], style(
          color=0,
          rgbcolor={0,0,0},
          fillColor=0,
          rgbfillColor={0,0,0},
          fillPattern=1)),   Rectangle(extent=[-40,-10; -4,-18], style(
          color=0,
          rgbcolor={0,0,0},
          fillColor=0,
          rgbfillColor={0,0,0},
          fillPattern=1)),   Rectangle(extent=[12,-44; 48,-52], style(
          color=0,
          rgbcolor={0,0,0},
          fillColor=0,
          rgbfillColor={0,0,0},
          fillPattern=1)),   Rectangle(extent=[-40,-44; -4,-52], style(
          color=0,
          rgbcolor={0,0,0},
          fillColor=0,
          rgbfillColor={0,0,0},
