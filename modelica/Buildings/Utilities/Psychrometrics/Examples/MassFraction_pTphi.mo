...
model MassFraction_pTphi "Unit test for dew point temperature calculation"
  ...
  annotation(Commands(file="MassFraction_pTphi.mos" "run"), Diagram(
  ...
  annotation (Diagram);
    ...
    height=1) "Relative humidity" 
                 annotation (Placement(transformation(extent={{-80,-60},{-60,-40}},
                   rotation=0)));
  Buildings.Utilities.Psychrometrics.MassFraction_pTphi masFra1(redeclare
    ...
    Modelica.Blocks.Sources.Constant P(k=101325) "Pressure" 
                 annotation (Placement(transformation(extent={{-80,20},{-60,40}},
                   rotation=0)));
  Buildings.Utilities.Psychrometrics.MassFraction_pTphi masFra2(redeclare
