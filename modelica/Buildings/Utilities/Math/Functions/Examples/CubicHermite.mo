...
model CubicHermite "Test problem for cubic hermite splines"
  ...
  parameter Real[size(xd,1)] d(fixed=false) "Derivatives at the support points";
...
algorithm
 ...
 yMonotone:=Buildings.Utilities.Math.Functions.cubicHermiteLinearExtrapolation(
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
            -100},{100,100}}),
                     graphics),
                      __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/CubicHermite.mos"
        "Simulate and plot"),
