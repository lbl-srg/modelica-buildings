...
model MediumColumn "Vertical shaft with no friction"
  ...
  parameter Buildings.Airflow.Multizone.Types.densitySelection density
...
initial equation
  ...
  assert(density > 0,
    "You need to set the parameter \"density\" for the model MediumColumn.");
equation
  // Design direction of mass flow rate
  m_flow = port_a.m_flow;

  // Pressure difference between ports
  rho = if (density == Buildings.Airflow.Multizone.Types.densitySelection.fromTop)
     then Medium.density(Medium.setState_phX(
    port_a.p,
    port_b.h_outflow,
    port_b.Xi_outflow)) else if (density == Buildings.Airflow.Multizone.Types.densitySelection.fromBottom)
     then Medium.density(Medium.setState_phX(
    port_b.p,
    port_a.h_outflow,
    port_a.Xi_outflow)) else Medium.density(Medium.setState_phX(
    port_a.p,
    actualStream(port_a.h_outflow),
  ...
  annotation (
    Icon(graphics={
        ...
        Rectangle(
          ...
          pattern=LinePattern.None),
        Rectangle(
          visible=density == Buildings.Airflow.Multizone.Types.densitySelection.fromTop,
        ...
        Text(
          ...
          textString="%name"),
        Rectangle(
          visible=density == Buildings.Airflow.Multizone.Types.densitySelection.actual,
          ...
          lineColor={0,0,0}),
        Rectangle(
          visible=density == Buildings.Airflow.Multizone.Types.densitySelection.fromBottom,
...
<p>
The parameter <code>h</code> must always be positive, and the port <code>port_a</code> must be
