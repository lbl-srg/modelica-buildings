...
First implementation.
  ...
  Modelica.Blocks.Interfaces.RealInput Gc_1
    ...
    annotation (Placement(transformation(extent={{-140,10},{-100,50}}, rotation=
           0)));
  Modelica.Blocks.Interfaces.RealInput Gc_2
    ...
    annotation (Placement(transformation(extent={{-140,-50},{-100,-10}},
          rotation=0)));
equation
  connect(Gc_1, con1.Gc) annotation (Line(points={{-120,30},{-70,30},{-70,44},{
          -46,44},{-46,30}}, color={0,0,127}));
  connect(Gc_2, con2.Gc) annotation (Line(points={{-120,-30},{-60,-30},{-60,-2},
          {-46,-2},{-46,-10}}, color={0,0,127}));
end DryHexHAInput;
