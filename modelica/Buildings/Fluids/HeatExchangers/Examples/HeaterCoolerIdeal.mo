...
First implementation.
 ...
 //package Medium = Modelica.Media.Air.SimpleAir;
  Buildings.Fluids.HeatExchangers.HeaterCoolerIdeal hea1(redeclare package
      Medium = 
        Medium, Q0_flow=5000,
    m0_flow=0.5) "Heater and cooler"              annotation (Placement(
  ...
  Modelica_Fluid.Sources.Boundary_pT sin_1(                       redeclare
    ...
    startTime=0) "Control signal" 
            ...
            194}}, rotation=0)));
  Buildings.Fluids.HeatExchangers.HeaterCoolerIdeal hea2(
  ...
  Buildings.Fluids.HeatExchangers.HeaterCoolerIdeal hea3(redeclare package
      Medium = 
        Medium, Q0_flow=5000,
    m0_flow=0.5) "Heater and cooler"              annotation (Placement(
    ...
    m0_flow=0.5) 
          ...
          rotation=0)));
  Buildings.Fluids.HeatExchangers.HeaterCoolerIdeal hea4(
                                                 redeclare package Medium = 
        Medium, Q0_flow=5000,
    m0_flow=0.5) "Heater and cooler"              annotation (Placement(
    ...
    m0_flow=0.5) 
        ...
        extent={{-10,-10},{10,10}},
        rotation=90)));
  Buildings.Fluids.MixingVolumes.MixingVolume mix1(
  ...
  Buildings.Utilities.Diagnostics.AssertEquality ass2(startTime=0.2, threShold=
    ...
    annotation (Placement(transformation(extent={{160,120},{180,140}}, rotation=
           0)));
  Buildings.Fluids.HeatExchangers.HeaterCoolerIdeal hea5(redeclare package
      Medium = 
        Medium, Q0_flow=5000,
    m0_flow=0.5) "Heater and cooler"              annotation (Placement(
    ...
    m0_flow=0.5) 
          ...
          rotation=0)));
  Buildings.Fluids.HeatExchangers.HeaterCoolerIdeal hea6(
                                                 redeclare package Medium = 
        Medium, Q0_flow=5000,
    m0_flow=0.5) "Heater and cooler"              annotation (Placement(
        transformation(extent={{-12,-130},{8,-110}},
                                                   rotation=0)));
  Buildings.Fluids.HeatExchangers.HeaterCoolerIdeal hea7(redeclare package
      Medium = 
        Medium, Q0_flow=5000,
    m0_flow=0.5) "Heater and cooler"              annotation (Placement(
    ...
    m0_flow=0.5) 
          ...
          rotation=0)));
  Buildings.Fluids.HeatExchangers.HeaterCoolerIdeal hea8(
                                                 redeclare package Medium = 
        Medium, Q0_flow=5000,
    m0_flow=0.5) "Heater and cooler"              annotation (Placement(
    ...
    m0_flow=0.5) 
        ...
        extent={{-10,-10},{10,10}},
        rotation=90)));
  Buildings.Fluids.MixingVolumes.MixingVolume mix2(
                                           redeclare package Medium = Medium, V=
       0.000001,
