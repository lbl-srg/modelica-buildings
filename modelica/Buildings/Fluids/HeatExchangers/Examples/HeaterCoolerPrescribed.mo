...
First implementation.
 ...
 //package Medium = Modelica.Media.Air.SimpleAir;
  Buildings.Fluids.HeatExchangers.HeaterCoolerPrescribed hea1(
                                                         redeclare package
      Medium = 
  ...
  Buildings.Fluids.HeatExchangers.HeaterCoolerPrescribed hea3(
                                                         redeclare package
      Medium = 
        Medium, Q_flow_nominal=5000,
    m_flow_nominal=0.5,
  ...
  Buildings.Utilities.Diagnostics.AssertEquality ass2(startTime=0.2, threShold=
    ...
    annotation (Placement(transformation(extent={{160,120},{180,140}}, rotation=
           0)));
  Buildings.Fluids.HeatExchangers.HeaterCoolerPrescribed hea5(
                                                         redeclare package
      Medium = 
        Medium, Q_flow_nominal=5000,
    m_flow_nominal=0.5,
