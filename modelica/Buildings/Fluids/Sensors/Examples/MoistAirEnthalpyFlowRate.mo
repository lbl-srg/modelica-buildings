...
model MoistAirEnthalpyFlowRate
  ...
  Modelica.Fluid.Sources.Boundary_pT sin(               redeclare package
      Medium = Medium,
    nPorts=1,
    T=313.15,
  ...
  Buildings.Fluids.Sensors.LatentEnthalpyFlowRate senHLat_flow(redeclare
      package Medium = Medium) "Sensor for latent enthalpy flow rate" 
    annotation (Placement(transformation(extent={{-60,-80},{-40,-60}})));
  Buildings.Fluids.Sensors.SensibleEnthalpyFlowRate senHSen_flow(redeclare
