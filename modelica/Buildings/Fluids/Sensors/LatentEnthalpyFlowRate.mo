...
<a href=\"Modelica:Buildings.Fluids.Sensors.EnthalpyFlowRate\">
Buildings.Fluids.Sensors.EnthalpyFlowRate</a>.<br>
For a sensor that measures 
<code>HSensible_flow</code>, use
<a href=\"Modelica:Buildings.Fluids.Sensors.SensibleEnthalpyFlowRate\">
Buildings.Fluids.Sensors.SensibleEnthalpyFlowRate</a>.
<p>
...
equation
  if allowFlowReversal then
     ...
     H_flow = port_a.m_flow * (hActual -
       (1-XiActual[iWat]) * Medium.enthalpyOfNonCondensingGas(Medium.temperature(sta)));
