...
//    "Medium in the component";
 package Medium = Buildings.Media.PerfectGases.MoistAir 
  ...
  Buildings.Fluids.Components.MixingVolumeLatent vol2(
    redeclare package Medium = Medium,
    initType=Modelica_Fluid.Types.Init.SteadyStateHydraulic,
    nP=2,
    V=0.1) 
...
equation 
  ...
  connect(entFloRat2.port_a, vol2.port[1]) annotation (points=[40,-30; 25,-30; 
      ...
      rgbfillColor={0,0,0},
      fillPattern=1));
  connect(zero.y, vol2.QLat_flow) annotation (points=[-31,-60; -16,-60; -16,-34; 
        -2,-34], style(color=74, rgbcolor={0,0,127}));
  connect(TLiq.y, vol2.TLiq) annotation (points=[-19,-90; -8,-90; -8,-40; -2,
