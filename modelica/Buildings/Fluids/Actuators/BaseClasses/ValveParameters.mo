...
<li><tt>CvData = Buildings.Fluids.Types.CvTypes.OpPoint</tt>: the flow is computed from the nominal operating point specified by <tt>dp_nominal</tt> and <tt>m_flow_nominal</tt>.
</ul>
</p>
<p>
