...
partial block RadiosityTwoSurfaces
  ...
  Buildings.HeatTransfer.Interfaces.RadiosityInflow JIn_a(start=A*0.8*293.15^4)
    "Incoming radiosity at surface a"
    annotation (Placement(transformation(extent={{-120,30},{-100,50}})));
  Buildings.HeatTransfer.Interfaces.RadiosityInflow JIn_b(start=A*0.8*293.15^4)
