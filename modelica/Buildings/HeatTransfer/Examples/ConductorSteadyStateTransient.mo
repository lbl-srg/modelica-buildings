...
model ConductorSteadyStateTransient "Test model for heat conductor"
  ...
  Buildings.HeatTransfer.InteriorConvection conv1(A=2, til=Buildings.RoomsBeta.Types.Tilt.Wall)
    "Convective heat transfer"
    annotation (Placement(transformation(extent={{-10,-20},{-30,0}})));
  Buildings.HeatTransfer.InteriorConvection conv2(A=2, til=Buildings.RoomsBeta.Types.Tilt.Wall)
    "Convective heat transfer"
