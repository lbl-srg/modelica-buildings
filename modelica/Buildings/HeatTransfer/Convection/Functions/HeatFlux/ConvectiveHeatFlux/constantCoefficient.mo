within Buildings.HeatTransfer.Convection.Functions.ConvectiveHeatFlux;
function constantCoefficient "Constant convective heat transfer coefficient"
  extends
    Buildings.HeatTransfer.Convection.Functions.ConvectiveHeatFlux.BaseClasses.PartialConvectiveHeatFlux;
